...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_300x250_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_icon = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x250_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.icon_teams = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-102.45,-72.35);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon_teams, new cjs.Rectangle(-102.4,-72.3,393,295), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-135,-1.7,163,122.4), null);
...
// stage content:
(lib.O365_FY20Q4_SMB_USA_300x250_BAN_Excel_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline8, 1.6, {alpha :0,x: "+=150", ease:Power4.easeInOut}, "-=1.4");
		...
		*/
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline11[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut}, "-=0.5");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_300x250_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584451018715", id:"O365_FY20Q4_SMB_USA_300x250_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
