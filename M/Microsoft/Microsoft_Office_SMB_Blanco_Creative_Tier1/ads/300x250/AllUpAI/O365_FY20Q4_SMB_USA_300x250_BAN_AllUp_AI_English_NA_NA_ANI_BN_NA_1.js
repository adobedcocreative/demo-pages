...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_300x250_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,218,164],[220,165,174,129],[880,0,95,73],[660,0,218,162],[660,164,210,168],[220,0,218,163],[0,166,174,129],[880,75,95,73],[396,165,174,129],[872,277,95,73],[176,296,174,129],[352,296,95,73],[440,0,218,163],[872,164,120,111],[0,297,174,129],[449,296,95,73]]}
];
...
(lib.Bookings = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x250_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.shad.name = "shad";
	this.shad.setTransform(217.5,216,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(112.5,129,210,171), null);
...
(lib.Teams_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(220.95,211.35,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Teams_1, new cjs.Rectangle(116,127.4,210,167.99999999999997), null);
...
(lib.Sharepoint_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,220,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Sharepoint_1, new cjs.Rectangle(112.5,129,210,175), null);
...
(lib.Outlook_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.95,210,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(114,126,210,168), null);
...
(lib.OneDrive_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.85,209.35,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.OneDrive_1, new cjs.Rectangle(113.9,125.4,209.99999999999997,167.99999999999997), null);
...
(lib.Exchange_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(220.7,211.85,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Exchange_1, new cjs.Rectangle(115.7,127.9,210,167.99999999999997), null);
...
(lib.Excel_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.15,208.45,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(113.2,124.5,210,168), null);
...
(lib.Bookings_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.5,210,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bookings_1, new cjs.Rectangle(113.5,126,210,168), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:-28.3,y:1},33,cjs.Ease.quadInOut).wait(1));
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.icon_teams.setTransform(282.15,-29.85,0.743,0.743,0,0,0,221,196.3);
	...
	this.icon_exchange.setTransform(224.2,-92.2,0.578,0.578,0,0,0,220.9,196.2);
	...
	this.icon_bookings.setTransform(304.2,-114.35,0.4573,0.4573,0,0,0,220.8,196.3);
	...
	this.icon_onedrive.setTransform(230.85,-159.75,0.4822,0.4822,0,0,0,221,196.5);
	...
	this.icon_outlook.setTransform(329.85,-12.3,0.38,0.38,0,0,0,220.7,196.6);
	...
	this.icon_powerpoint.setTransform(208.3,23.3,0.3799,0.3799,0,0,0,220.7,196.3);
	...
	this.icon_excel.setTransform(268.9,5.65,0.38,0.38,0,0,0,220.8,196.5);
	...
	this.icon_sharepoint.setTransform(327.9,-70.3,0.38,0.38,0,0,0,220.8,196.6);
	...
	this.icon_word.setTransform(206.9,-32.35,0.38,0.38,0,0,0,220.8,196.5);

	this.timeline.addTween(cjs.Tween.get(this.icon_word).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(163.4,-194,205.70000000000002,254.5), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(33.05,219.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(77.8,220,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.icons.setTransform(246.15,231.1,1.2104,1.2104,0,0,0,284,25);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-20,-34,369.2,307.9), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_300x250_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=2.4");
		...
		this.tlicons = new TimelineLite();
				...
				//exportRoot.tlicons.to(mc.icons.icon_powerpoint, 2, {scaleX:.38, scaleY:.38, x: 208,  y: 25,	ease:Quart.easeInOut}, "-=1.9");
...
p.nominalBounds = new cjs.Rectangle(130,91,219.2,182.89999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_300x250_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584612516880", id:"O365_FY20Q4_SMB_USA_300x250_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
