...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_160x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,400,266],[402,0,400,266],[0,268,400,266],[402,268,400,266],[0,536,400,266],[402,536,400,266],[0,804,400,266],[0,1258,264,153],[302,1238,265,154],[302,1072,275,164],[569,1238,265,154],[579,1072,275,164],[0,1072,300,184],[266,1394,264,153],[402,804,400,266],[804,0,120,111]]}
];
...
(lib.booking = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_160x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.bookings_screen.setTransform(359.35,-8.6,0.29,0.29,0,0,0,116.2,80.7);
	...
	this.teams_screen.setTransform(371.35,-57,0.29,0.29,0,0,0,116.2,80.7);
	...
	this.exchange_screen.setTransform(312.65,-83.15,0.29,0.29,0,0,0,116.2,80.7);
	...
	this.screen_word.setTransform(247.95,-63.45,0.29,0.29,0,0,0,116.2,80.7);
	...
	this.screen_excel.setTransform(304.35,-37.2,0.29,0.29,0,0,0,112.6,80.9);
	...
	this.screen_powerpoint.setTransform(238.6,-16.05,0.29,0.29,0,0,0,114.7,84.9);
	...
	this.screen_outlook.setTransform(291.8,9.05,0.29,0.29,0,0,0,120.9,70.5);
	...
	this.screen_onedrive.setTransform(248.9,-119.8,0.29,0.29,0,0,0,96.8,45.4);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(195.5,-145.7,229.3,183.7), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-13.5,229.39999999999998,627.6), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_160x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.tlicons = new TimelineLite();	
				...
				exportRoot.tlicons.from(mc.screens, 3, {scaleX: 1.2, scaleY:1.2, y: "-=50",	ease:Power4.easeOut}, "-=4");
				...
				exportRoot.tlicons.from(mc.screens.screen_excel, 4, {scaleX: 1.5, scaleY:1.5, x: "+=275",  y: "+=100",	ease:Quart.easeOut}, "-=3.9");
				...
				exportRoot.tlicons.from(mc.screens.screen_powerpoint, 4, {scaleX: 1.2, scaleY:1.2, x: "+=350",  y: "+=400",	ease:Quart.easeOut}, "-=3.8");
...
p.nominalBounds = new cjs.Rectangle(75.8,286.5,149.39999999999998,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_160x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584615105677", id:"O365_FY20Q4_SMB_USA_160x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
