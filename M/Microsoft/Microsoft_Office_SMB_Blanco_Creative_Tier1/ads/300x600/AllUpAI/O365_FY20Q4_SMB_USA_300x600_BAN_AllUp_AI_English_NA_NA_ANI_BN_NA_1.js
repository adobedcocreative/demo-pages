...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_300x600_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,218,164],[220,165,174,129],[880,0,95,73],[660,0,218,162],[660,164,210,168],[220,0,218,163],[0,166,174,129],[880,75,95,73],[396,165,174,129],[872,277,95,73],[176,296,174,129],[352,296,95,73],[440,0,218,163],[872,164,120,111],[0,297,174,129],[449,296,95,73]]}
];
...
(lib.Bookings = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x600_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Teams_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(221.3,211.65,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Teams_1, new cjs.Rectangle(116.3,127.7,210,168), null);
...
(lib.Outlook_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(219,209.5,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(114,125.5,210,168), null);
...
(lib.OneDrive_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.7,209.5,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.OneDrive_1, new cjs.Rectangle(113.7,125.5,210,168), null);
...
(lib.Exchange_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(220.45,212.25,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Exchange_1, new cjs.Rectangle(115.5,128.3,210,168), null);
...
(lib.Excel_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.45,208.5,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(113.5,124.5,210,168), null);
...
(lib.Bookings_1 = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(218.55,209.35,1,1,0,0,0,105,84);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bookings_1, new cjs.Rectangle(113.6,125.4,210.00000000000003,167.99999999999997), null);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.icon_powerpoint.setTransform(208.95,23.25,0.3799,0.3799,0,0,0,220.7,196.3);
...
}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(163.2,-193.9,205.90000000000003,254.3), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(200.8,515.35,1.67,1.67,0,0,0,283.9,25.1);
	...
	this.bg.name = "bg";
	this.bg.setTransform(150,300.95,1,2.4078,0,0,0,150,125);
	...
	this.txtCta.setTransform(251.65,554.7,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(296.4,554.95,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,344.1,602), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_300x600_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.tlicons = new TimelineLite();
				...
				exportRoot.tlicons.to(mc.icons, 2, {scaleX:1.44, scaleY:1.44, x: "-=8",  y: "-=35",	ease:Quart.easeInOut}, "-=1");
				exportRoot.tlicons.to(mc.icons.icon_onedrive, 2, {scaleX:.38, scaleY:.38, x: 222,  y: -152,	ease:Quart.easeInOut}, "-=1.9");
				exportRoot.tlicons.to(mc.icons.icon_exchange, 2, {scaleX:.38, scaleY:.38, x: 218,  y: -94,	ease:Quart.easeInOut}, "-=1.7");
				exportRoot.tlicons.to(mc.icons.icon_bookings, 2, {scaleX:.38, scaleY:.38, x: 278,  y: -113,	ease:Quart.easeInOut}, "-=1.8");
...
p.nominalBounds = new cjs.Rectangle(149,300,194.10000000000002,302);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_300x600_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584612875553", id:"O365_FY20Q4_SMB_USA_300x600_BAN_AllUp_AI_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
