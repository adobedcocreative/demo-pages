...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_iconpngcopy4 = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.bg_c, new cjs.Rectangle(0,0,300,600), null);
...
(lib.logo_mc = function(mode,startPosition,loop) {
	...
	this.tile_sub.setTransform(-62.65,61.2,0.474,0.474,0,0,0,77,79.1);

	this.timeline.addTween(cjs.Tween.get(this.tile_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-148.2,-10.3,186.29999999999998,139.8), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.bg.cache(-300,-600,600,1200,2)
	}
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.screen.setTransform(275.15,322.45,0.96,0.96,0,0,0,330,219);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-41.6,0,633.6,600.9), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				//Store					headline1
				exportRoot.tl1.from(exportRoot.headline1, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "+=0.2");
				...
				exportRoot.tl1.to(exportRoot.headline12, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.5");
				...
				exportRoot.tl1.to(cont3D, 1, {x:120, y:"+=25", z:-250 , ease:Power4.easeInOut}, "+=0.5");
		...
		*/
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline15[i], 0.8, { x: "+=300", alpha: 0, ease:Power4.easeOut}, "-=0.5");
...
p.nominalBounds = new cjs.Rectangle(108.4,300,483.6,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584449958949", id:"O365_FY20Q4_SMB_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
