...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_728x90_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_iconpngcopy4 = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_728x90_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.bg_c, new cjs.Rectangle(0,0,728,90), null);
...
(lib.logo_mc = function(mode,startPosition,loop) {
	...
	this.tile_sub.setTransform(-60.65,67.75,0.415,0.415,0,0,0,76.9,79.5);

	this.timeline.addTween(cjs.Tween.get(this.tile_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-135.5,5,163.1,122.4), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.bg.cache(-728,-90,1456,180,2)
	}
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap/ChIAAlBIT/AAIAAFBg");
	this.shape.setTransform(-33.6,-1.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-97.6,-17.3,128,32.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(712.6,4.3,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(646.5,59.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(700,60.5,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.screen.setTransform(219,42.8,0.3153,0.3153,0,0,0,330.4,219);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-26.2,728.6,138.1), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_728x90_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=200",y:"+=90", ease:Power4.easeInOut});
				exportRoot.tl1.to(s, 1.6, {x: "-=100", ease:Power4.easeInOut}, "-=1.6");
				exportRoot.tl1.to(exportRoot.headline12, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.3");
				...
				exportRoot.tl1.to(cont3D, 1, {x:208, y:"+=15", z:-1200 , ease:Power4.easeInOut}, "+=0.5");
				//exportRoot.tl1.to(cont3D, 1, {x:86, y:"+=25", z:-250 ,rotX: "+=35",rotY: "+=20",rotZ: "-=17", ease:Power4.easeInOut}, "+=0.5");
				exportRoot.tl1.from(screen, 0.8, {x: "+=200",y: "+=200", ease:Power3.easeInOut}, "-=1");
...
p.nominalBounds = new cjs.Rectangle(364,18.8,364.6,93.10000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_728x90_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584450009084", id:"O365_FY20Q4_SMB_USA_728x90_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
