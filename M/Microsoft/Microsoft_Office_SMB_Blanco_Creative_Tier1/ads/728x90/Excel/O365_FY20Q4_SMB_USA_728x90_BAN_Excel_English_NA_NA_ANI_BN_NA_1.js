...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_icon = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-137.45,4.2,0.4237,0.4237);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-137.4,4.2,166.5,124.99999999999999), null);
...
// stage content:
(lib.O365_FY20Q4_SMB_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline8, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.1");
				...
				exportRoot.tl1.to(cont3D, 1, {x:208, y:"+=15", z:-1200 , ease:Power4.easeInOut}, "+=0.2");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584451617395", id:"O365_FY20Q4_SMB_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
