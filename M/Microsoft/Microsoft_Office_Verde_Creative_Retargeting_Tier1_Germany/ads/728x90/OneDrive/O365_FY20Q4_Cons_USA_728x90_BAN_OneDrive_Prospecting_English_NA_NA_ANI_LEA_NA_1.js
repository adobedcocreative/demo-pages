...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[0,741,268,215],[270,741,138,108],[0,376,560,363],[270,851,138,108],[410,741,138,108],[0,0,610,374],[550,741,120,111],[410,851,138,108]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow11111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(98.7,112.4,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(98.7,112.4,231,180.79999999999998), null);
...
(lib.shadow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(2.4,34.15,1.5913,1.6562,0,0.2275,-2.1961);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.shadow, new cjs.Rectangle(0,0,892.9,635.3), null);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow11111();
...
(lib.Teams = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(95.95,92.6,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Excel_Shadow();
	this.instance_1.setTransform(210.35,214.15,0.95,0.95,0,0,0,134,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Teams, new cjs.Rectangle(83.1,90.6,255.4,225.70000000000002), null);
...
(lib.Screen_Shadow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(601.35,363,1,1,0,0,0,446.4,317.7);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-564.75,-207.7,0.0641,0.0639,0,0,0,219.3,195.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(184).to({_off:false},0).wait(1).to({regX:214.2,regY:202.8,scaleX:0.1075,scaleY:0.1073,x:-584.85,y:-210.05},0).wait(1).to({scaleX:0.1483,scaleY:0.1481,x:-603.5,y:-212.7},0).wait(1).to({scaleX:0.186,scaleY:0.1859,x:-620.75,y:-215.2},0).wait(1).to({scaleX:0.2207,scaleY:0.2206,x:-636.6,y:-217.45},0).wait(1).to({scaleX:0.2523,scaleY:0.2522,x:-650.95,y:-219.5},0).wait(1).to({scaleX:0.2809,scaleY:0.2808,x:-664.05,y:-221.35},0).wait(1).to({scaleX:0.3066,scaleY:0.3065,x:-675.8,y:-223.05},0).wait(1).to({scaleX:0.3296,scaleY:0.3296,x:-686.3,y:-224.55},0).wait(1).to({scaleX:0.3502,scaleY:0.3502,x:-695.7,y:-225.9},0).wait(1).to({scaleX:0.3685,scaleY:0.3685,x:-704.05,y:-227.1},0).wait(1).to({scaleX:0.3847,scaleY:0.3847,x:-711.45,y:-228.15},0).wait(1).to({scaleX:0.399,scaleY:0.3989,x:-717.95,y:-229.1},0).wait(1).to({scaleX:0.4114,scaleY:0.4114,x:-723.6,y:-229.9},0).wait(1).to({scaleX:0.4222,scaleY:0.4222,x:-728.55,y:-230.65},0).wait(1).to({scaleX:0.4315,scaleY:0.4315,x:-732.8,y:-231.25},0).wait(1).to({scaleX:0.4394,scaleY:0.4394,x:-736.45,y:-231.75},0).wait(1).to({scaleX:0.446,scaleY:0.446,x:-739.45,y:-232.15},0).wait(1).to({scaleX:0.4513,scaleY:0.4513,x:-741.9,y:-232.5},0).wait(1).to({scaleX:0.4555,scaleY:0.4555,x:-743.75,y:-232.75},0).wait(1).to({scaleX:0.4587,scaleY:0.4587,x:-745.25,y:-232.95},0).wait(1).to({scaleX:0.4609,scaleY:0.4609,x:-746.2,y:-233.15},0).wait(1).to({scaleX:0.4622,scaleY:0.4622,x:-746.8,y:-233.2},0).wait(1).to({regX:220.5,regY:196.6,scaleX:0.4626,scaleY:0.4626,x:-744.7,y:-236.6},0).wait(1));

	// Word Shadow
	this.instance_1 = new lib.Wordcopy();
	this.instance_1.setTransform(-564.8,-207.75,0.064,0.0639,0,0,0,218.7,195.7);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(184).to({_off:false},0).wait(1).to({regX:211.8,regY:232.2,scaleX:0.1074,scaleY:0.1073,x:-585.1,y:-206.95},0).wait(1).to({scaleX:0.1482,scaleY:0.1481,x:-603.8,y:-208.4},0).wait(1).to({scaleX:0.186,scaleY:0.1859,x:-621.1,y:-209.8},0).wait(1).to({scaleX:0.2207,scaleY:0.2206,x:-637,y:-211.05},0).wait(1).to({scaleX:0.2523,scaleY:0.2522,x:-651.45,y:-212.15},0).wait(1).to({scaleX:0.2808,scaleY:0.2808,x:-664.55,y:-213.15},0).wait(1).to({scaleX:0.3066,scaleY:0.3065,x:-676.3,y:-214.1},0).wait(1).to({scaleX:0.3296,scaleY:0.3296,x:-686.95,y:-214.95},0).wait(1).to({scaleX:0.3502,scaleY:0.3502,x:-696.35,y:-215.65},0).wait(1).to({scaleX:0.3685,scaleY:0.3685,x:-704.75,y:-216.35},0).wait(1).to({scaleX:0.3847,scaleY:0.3847,x:-712.15,y:-216.9},0).wait(1).to({scaleX:0.399,scaleY:0.3989,x:-718.7,y:-217.4},0).wait(1).to({scaleX:0.4114,scaleY:0.4114,x:-724.4,y:-217.85},0).wait(1).to({scaleX:0.4222,scaleY:0.4222,x:-729.3,y:-218.25},0).wait(1).to({scaleX:0.4315,scaleY:0.4315,x:-733.6,y:-218.55},0).wait(1).to({scaleX:0.4394,scaleY:0.4394,x:-737.2,y:-218.9},0).wait(1).to({scaleX:0.446,scaleY:0.446,x:-740.2,y:-219.1},0).wait(1).to({scaleX:0.4513,scaleY:0.4513,x:-742.65,y:-219.3},0).wait(1).to({scaleX:0.4555,scaleY:0.4555,x:-744.6,y:-219.4},0).wait(1).to({scaleX:0.4587,scaleY:0.4587,x:-746.05,y:-219.55},0).wait(1).to({scaleX:0.4609,scaleY:0.4609,x:-747.1,y:-219.65},0).wait(1).to({scaleX:0.4622,scaleY:0.4622,x:-747.65,y:-219.7},0).wait(1).to({regX:220.5,regY:196.6,scaleX:0.4626,scaleY:0.4626,x:-744.7,y:-236.6},0).wait(1));

	// Screen
	this.instance_2 = new lib.Screen();
	this.instance_2.setTransform(533.5,735.2,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:111.5,y:43.15},119).wait(1).to({regX:584.3,regY:321.9,x:111.4,y:1.9},0).wait(1).to({x:108.6,y:-3.5},0).wait(1).to({x:105.8,y:-8.85},0).wait(1).to({x:103,y:-14.15},0).wait(1).to({x:100.25,y:-19.5},0).wait(1).to({x:97.5,y:-24.75},0).wait(1).to({x:94.75,y:-29.95},0).wait(1).to({x:92.05,y:-35.1},0).wait(1).to({x:89.4,y:-40.2},0).wait(1).to({x:86.8,y:-45.2},0).wait(1).to({x:84.2,y:-50.15},0).wait(1).to({x:81.7,y:-54.95},0).wait(1).to({x:79.2,y:-59.7},0).wait(1).to({x:76.8,y:-64.3},0).wait(1).to({x:74.45,y:-68.8},0).wait(1).to({x:72.15,y:-73.15},0).wait(1).to({x:69.95,y:-77.4},0).wait(1).to({x:67.8,y:-81.5},0).wait(1).to({x:65.75,y:-85.45},0).wait(1).to({x:63.75,y:-89.25},0).wait(1).to({x:61.85,y:-92.9},0).wait(1).to({x:60,y:-96.4},0).wait(1).to({x:58.25,y:-99.75},0).wait(1).to({x:56.6,y:-103},0).wait(1).to({x:55,y:-106.05},0).wait(1).to({x:53.45,y:-108.95},0).wait(1).to({x:52,y:-111.75},0).wait(1).to({x:50.65,y:-114.35},0).wait(1).to({x:49.35,y:-116.85},0).wait(1).to({x:48.1,y:-119.2},0).wait(1).to({x:46.95,y:-121.45},0).wait(1).to({x:45.85,y:-123.55},0).wait(1).to({x:44.8,y:-125.5},0).wait(1).to({x:43.85,y:-127.4},0).wait(1).to({x:42.9,y:-129.15},0).wait(1).to({x:42.05,y:-130.75},0).wait(1).to({x:41.25,y:-132.3},0).wait(1).to({x:40.5,y:-133.7},0).wait(1).to({x:39.8,y:-135.05},0).wait(1).to({x:39.15,y:-136.3},0).wait(1).to({x:38.6,y:-137.45},0).wait(1).to({x:38,y:-138.5},0).wait(1).to({x:37.5,y:-139.45},0).wait(1).to({x:37.05,y:-140.35},0).wait(1).to({x:36.6,y:-141.2},0).wait(1).to({regX:581.6,regY:357.8,x:33.5,y:-106.05},0).wait(1).to({regX:584.3,regY:321.9,scaleX:0.9974,scaleY:0.9974,x:32.7,y:-142.3},0).wait(1).to({scaleX:0.994,scaleY:0.994,x:28.1,y:-142.8},0).wait(1).to({scaleX:0.9898,scaleY:0.9898,x:22.35,y:-143.35},0).wait(1).to({scaleX:0.9846,scaleY:0.9846,x:15.3,y:-144.05},0).wait(1).to({scaleX:0.9784,scaleY:0.9784,x:6.9,y:-144.9},0).wait(1).to({scaleX:0.9711,scaleY:0.9711,x:-3.05,y:-145.9},0).wait(1).to({scaleX:0.9625,scaleY:0.9625,x:-14.65,y:-147.1},0).wait(1).to({scaleX:0.9526,scaleY:0.9526,x:-28.1,y:-148.45},0).wait(1).to({scaleX:0.9413,scaleY:0.9413,x:-43.45,y:-150.05},0).wait(1).to({scaleX:0.9284,scaleY:0.9284,x:-60.9,y:-151.85},0).wait(1).to({scaleX:0.9139,scaleY:0.9139,x:-80.5,y:-153.8},0).wait(1).to({scaleX:0.8979,scaleY:0.8979,x:-102.35,y:-156.05},0).wait(1).to({scaleX:0.8802,scaleY:0.8802,x:-126.25,y:-158.5},0).wait(1).to({scaleX:0.8611,scaleY:0.8611,x:-152.15,y:-161.1},0).wait(1).to({scaleX:0.8409,scaleY:0.8409,x:-179.55,y:-163.9},0).wait(1).to({scaleX:0.8199,scaleY:0.8199,x:-208.1,y:-166.85},0).wait(1).to({scaleX:0.7985,scaleY:0.7985,x:-237.1,y:-169.8},0).wait(1).to({scaleX:0.7772,scaleY:0.7772,x:-265.9,y:-172.7},0).wait(1).to({scaleX:0.7566,scaleY:0.7566,x:-293.9,y:-175.6},0).wait(1).to({scaleX:0.7369,scaleY:0.7369,x:-320.65,y:-178.3},0).wait(1).to({scaleX:0.7184,scaleY:0.7184,x:-345.7,y:-180.85},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:-368.95,y:-183.2},0).wait(1).to({scaleX:0.6855,scaleY:0.6855,x:-390.3,y:-185.4},0).wait(1).to({scaleX:0.6712,scaleY:0.6712,x:-409.7,y:-187.4},0).wait(1).to({scaleX:0.6583,scaleY:0.6583,x:-427.3,y:-189.15},0).wait(1).to({scaleX:0.6466,scaleY:0.6466,x:-443.1,y:-190.8},0).wait(1).to({scaleX:0.6361,scaleY:0.6361,x:-457.3,y:-192.25},0).wait(1).to({scaleX:0.6268,scaleY:0.6268,x:-469.95,y:-193.55},0).wait(1).to({scaleX:0.6185,scaleY:0.6185,x:-481.2,y:-194.65},0).wait(1).to({scaleX:0.6111,scaleY:0.6111,x:-491.2,y:-195.65},0).wait(1).to({scaleX:0.6047,scaleY:0.6047,x:-499.95,y:-196.6},0).wait(1).to({scaleX:0.599,scaleY:0.599,x:-507.65,y:-197.35},0).wait(1).to({scaleX:0.5941,scaleY:0.5941,x:-514.25,y:-198.05},0).wait(1).to({scaleX:0.5899,scaleY:0.5899,x:-519.95,y:-198.6},0).wait(1).to({scaleX:0.5863,scaleY:0.5863,x:-524.85,y:-199.1},0).wait(1).to({scaleX:0.5834,scaleY:0.5834,x:-528.9,y:-199.5},0).wait(1).to({scaleX:0.5809,scaleY:0.5809,x:-532.15,y:-199.85},0).wait(1).to({scaleX:0.579,scaleY:0.579,x:-534.8,y:-200.1},0).wait(1).to({scaleX:0.5776,scaleY:0.5776,x:-536.7,y:-200.35},0).wait(1).to({scaleX:0.5766,scaleY:0.5766,x:-538.05,y:-200.45},0).wait(1).to({scaleX:0.576,scaleY:0.576,x:-538.85,y:-200.55},0).wait(1).to({regX:581.6,regY:357.7,scaleX:0.5758,scaleY:0.5758,x:-540.65,y:-179.95},0).wait(1));

	// Screen Shadow
	this.instance_3 = new lib.Screen_Shadow();
	this.instance_3.setTransform(533.5,735.2,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:111.5,y:43.15},119).wait(1).to({regX:601.4,regY:363,x:128.5,y:43},0).wait(1).to({x:125.7,y:37.6},0).wait(1).to({x:122.9,y:32.25},0).wait(1).to({x:120.1,y:26.95},0).wait(1).to({x:117.35,y:21.6},0).wait(1).to({x:114.6,y:16.35},0).wait(1).to({x:111.85,y:11.15},0).wait(1).to({x:109.15,y:6},0).wait(1).to({x:106.5,y:0.9},0).wait(1).to({x:103.9,y:-4.1},0).wait(1).to({x:101.3,y:-9.05},0).wait(1).to({x:98.8,y:-13.85},0).wait(1).to({x:96.3,y:-18.6},0).wait(1).to({x:93.9,y:-23.2},0).wait(1).to({x:91.55,y:-27.7},0).wait(1).to({x:89.25,y:-32.05},0).wait(1).to({x:87.05,y:-36.3},0).wait(1).to({x:84.9,y:-40.4},0).wait(1).to({x:82.85,y:-44.35},0).wait(1).to({x:80.85,y:-48.15},0).wait(1).to({x:78.95,y:-51.8},0).wait(1).to({x:77.1,y:-55.3},0).wait(1).to({x:75.35,y:-58.65},0).wait(1).to({x:73.7,y:-61.9},0).wait(1).to({x:72.1,y:-64.95},0).wait(1).to({x:70.55,y:-67.85},0).wait(1).to({x:69.1,y:-70.65},0).wait(1).to({x:67.75,y:-73.25},0).wait(1).to({x:66.45,y:-75.75},0).wait(1).to({x:65.2,y:-78.1},0).wait(1).to({x:64.05,y:-80.35},0).wait(1).to({x:62.95,y:-82.45},0).wait(1).to({x:61.9,y:-84.4},0).wait(1).to({x:60.95,y:-86.3},0).wait(1).to({x:60,y:-88.05},0).wait(1).to({x:59.15,y:-89.65},0).wait(1).to({x:58.35,y:-91.2},0).wait(1).to({x:57.6,y:-92.6},0).wait(1).to({x:56.9,y:-93.95},0).wait(1).to({x:56.25,y:-95.2},0).wait(1).to({x:55.7,y:-96.35},0).wait(1).to({x:55.1,y:-97.4},0).wait(1).to({x:54.6,y:-98.35},0).wait(1).to({x:54.15,y:-99.25},0).wait(1).to({x:53.7,y:-100.1},0).wait(1).to({regX:581.6,regY:357.8,x:33.5,y:-106.05},0).wait(1).to({regX:601.4,regY:363,scaleX:0.9974,scaleY:0.9974,x:49.75,y:-101.3},0).wait(1).to({scaleX:0.994,scaleY:0.994,x:45.1,y:-101.9},0).wait(1).to({scaleX:0.9898,scaleY:0.9898,x:39.25,y:-102.65},0).wait(1).to({scaleX:0.9846,scaleY:0.9846,x:32.15,y:-103.6},0).wait(1).to({scaleX:0.9784,scaleY:0.9784,x:23.65,y:-104.7},0).wait(1).to({scaleX:0.9711,scaleY:0.9711,x:13.55,y:-106},0).wait(1).to({scaleX:0.9625,scaleY:0.9625,x:1.8,y:-107.55},0).wait(1).to({scaleX:0.9526,scaleY:0.9526,x:-11.8,y:-109.3},0).wait(1).to({scaleX:0.9413,scaleY:0.9413,x:-27.35,y:-111.35},0).wait(1).to({scaleX:0.9284,scaleY:0.9284,x:-45,y:-113.7},0).wait(1).to({scaleX:0.9139,scaleY:0.9139,x:-64.85,y:-116.25},0).wait(1).to({scaleX:0.8979,scaleY:0.8979,x:-87,y:-119.15},0).wait(1).to({scaleX:0.8802,scaleY:0.8802,x:-111.2,y:-122.35},0).wait(1).to({scaleX:0.8611,scaleY:0.8611,x:-137.4,y:-125.7},0).wait(1).to({scaleX:0.8409,scaleY:0.8409,x:-165.2,y:-129.35},0).wait(1).to({scaleX:0.8199,scaleY:0.8199,x:-194.1,y:-133.15},0).wait(1).to({scaleX:0.7985,scaleY:0.7985,x:-223.45,y:-136.95},0).wait(1).to({scaleX:0.7772,scaleY:0.7772,x:-252.6,y:-140.75},0).wait(1).to({scaleX:0.7566,scaleY:0.7566,x:-281,y:-144.5},0).wait(1).to({scaleX:0.7369,scaleY:0.7369,x:-308.05,y:-148},0).wait(1).to({scaleX:0.7184,scaleY:0.7184,x:-333.4,y:-151.3},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:-356.95,y:-154.4},0).wait(1).to({scaleX:0.6855,scaleY:0.6855,x:-378.55,y:-157.25},0).wait(1).to({scaleX:0.6712,scaleY:0.6712,x:-398.25,y:-159.8},0).wait(1).to({scaleX:0.6583,scaleY:0.6583,x:-416,y:-162.1},0).wait(1).to({scaleX:0.6466,scaleY:0.6466,x:-432.05,y:-164.25},0).wait(1).to({scaleX:0.6361,scaleY:0.6361,x:-446.45,y:-166.1},0).wait(1).to({scaleX:0.6268,scaleY:0.6268,x:-459.25,y:-167.8},0).wait(1).to({scaleX:0.6185,scaleY:0.6185,x:-470.65,y:-169.25},0).wait(1).to({scaleX:0.6111,scaleY:0.6111,x:-480.75,y:-170.55},0).wait(1).to({scaleX:0.6047,scaleY:0.6047,x:-489.6,y:-171.75},0).wait(1).to({scaleX:0.599,scaleY:0.599,x:-497.4,y:-172.75},0).wait(1).to({scaleX:0.5941,scaleY:0.5941,x:-504.1,y:-173.65},0).wait(1).to({scaleX:0.5899,scaleY:0.5899,x:-509.85,y:-174.35},0).wait(1).to({scaleX:0.5863,scaleY:0.5863,x:-514.85,y:-175},0).wait(1).to({scaleX:0.5834,scaleY:0.5834,x:-518.9,y:-175.55},0).wait(1).to({scaleX:0.5809,scaleY:0.5809,x:-522.25,y:-175.95},0).wait(1).to({scaleX:0.579,scaleY:0.579,x:-524.9,y:-176.3},0).wait(1).to({scaleX:0.5776,scaleY:0.5776,x:-526.85,y:-176.6},0).wait(1).to({scaleX:0.5766,scaleY:0.5766,x:-528.2,y:-176.75},0).wait(1).to({scaleX:0.576,scaleY:0.576,x:-529,y:-176.85},0).wait(1).to({regX:581.6,regY:357.7,scaleX:0.5758,scaleY:0.5758,x:-540.65,y:-179.95},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-807.6,-430.7,1807.3000000000002,1488.7);
...
(lib.Outlook = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(97.45,111.85,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(210.85,229.55,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Outlook, new cjs.Rectangle(83.5,110.5,255.60000000000002,223.7), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({scaleX:2.2,scaleY:2.2,x:-715.8,y:264.45},41,cjs.Ease.quadInOut).wait(1));
...
(lib.Excel_1 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.OneDrive();
	this.instance.setTransform(112.4,125.05,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3 copy
	this.instance_1 = new lib.OneDrive_shadow();
	this.instance_1.setTransform(226.9,246.6,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(99,124.5,255.10000000000002,224.3), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AqGCeIAAk7IUOAAIAAE7g");
	this.shape.setTransform(-38.95,-0.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.7,-16.5,129.5,31.6), null);
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-229.1,y:-785.4},159).to({x:-317.05,y:-923.75},21).wait(71));

	// Word
	this.instance_1 = new lib.Outlook();
	this.instance_1.setTransform(313.95,355.4,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-253,y:-597.2},159).to({x:-340.95,y:-735.55},21).wait(71));

	// Excel
	this.instance_2 = new lib.Teams();
	this.instance_2.setTransform(511.6,312.75,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-71.6,y:-639.85},159).to({x:-159.55,y:-778.2},21).wait(71));

	// Powerpoint
	this.instance_3 = new lib.Powerpoint_1();
	this.instance_3.setTransform(498.4,491.3,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-68.55,y:-461.3},159).to({x:-156.5,y:-599.65},21).wait(71));

	// OneDrive_2
	this.instance_4 = new lib.Excel_1();
	this.instance_4.setTransform(677.9,412.35,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:110.95,y:-540.25},159).to({x:23,y:-678.6},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-478,-1010,1289.5,1642.5);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(497.35,122.95,0.34,0.34,0,0,0,284.2,24.9);
	...
	this.screen.setTransform(496.8,120.95,0.34,0.34,0,0,0,284.2,24.6);
	...
	this.txtCta.setTransform(661.75,60.25,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(706.5,60.5,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,740,472.3), null);


// stage content:
(lib.O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				for (var i = 0; i < exportRoot.headline1.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline1[i], 0.8, { alpha: 0, ease:Power4.easeIn}, "+=1.8");
				if (i!=0) exportRoot.tl1.to(exportRoot.headline1[i], 0.8, { alpha: 0, ease:Power4.easeIn}, "-=0.7");
				}
		
				for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=1.3");
...
p.nominalBounds = new cjs.Rectangle(364,45,376,427.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582635865367", id:"O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
