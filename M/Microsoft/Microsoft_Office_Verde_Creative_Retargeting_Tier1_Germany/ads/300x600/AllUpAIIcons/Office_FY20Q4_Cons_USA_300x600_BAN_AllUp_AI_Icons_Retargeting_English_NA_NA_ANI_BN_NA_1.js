...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,170,174,135],[0,0,210,168],[176,170,174,135],[212,0,174,135],[352,137,174,135],[388,0,174,135],[0,307,120,111],[352,274,174,135]]}
];
...
(lib.Excel_icon = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05,y:832.75},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:24.25,y:51.95},33,cjs.Ease.quadInOut).wait(1));
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.icon_outlook.setTransform(406.35,-55.65,0.5,0.5,0,0,0,220.5,196.7);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(147.3,477.75,1.2445,1.2445,0,0,0,284.1,24.9);
	...
	this.txtCta.setTransform(357.6,554.7,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(402.35,554.95,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-629.9,0,1052,643.2), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,300,273.1,343.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582802408289", id:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
