...
lib.ssMetadata = [
		{name:"M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1_atlas_", frames: [[302,0,300,534],[247,553,40,32],[139,553,52,37],[193,553,52,37],[247,587,38,30],[302,536,85,73],[0,553,85,73],[87,553,50,73],[0,0,300,551]]}
];
...
(lib._300x600 = function() {
	this.initialize(ss["M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.frame1b_300x60011 = function() {
	this.initialize(ss["M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1_atlas_"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Tween31 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(65.5879,-0.0847,3.7492,3.7492);
	...
	this.shape_1.setTransform(34.2822,0.009,3.7492,3.7492);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#373535").s().p("AgCArIAAhVIAFAAIAABVg");
	this.shape_2.setTransform(13.4742,-0.0847,3.7492,3.7492);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#373535").s().p("AgCArIAAhPIgaAAIAAgGIA5AAIAAAGIgaAAIAABPg");
	this.shape_3.setTransform(-4.8969,-0.0847,3.7492,3.7492);
	...
	this.shape_4.setTransform(-30.7663,0.009,3.7492,3.7492);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#373535").s().p("AAeArIAAhGIgaA6IgGAAIgbg6IAABGIgGAAIAAhVIAGAAIAeBBIAdhBIAGAAIAABVg");
	this.shape_5.setTransform(-63.8529,-0.0847,3.7492,3.7492);
...
(lib.scene_1 = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.frame1b_300x60011();
	this.instance.setTransform(547,168);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F0E9E5").s().p("A3dErIAApVMAu7AAAIAAJVg");
	this.shape.setTransform(697.075,149.875);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.scene_1, new cjs.Rectangle(546.9,120,300.4,599), null);
...
(lib.plus_btn = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("AAAg+IAAA+IA/AAAAAAAIAAA/Ag+AAIA+AA");
...
(lib.greyicons = function(mode,startPosition,loop) {
	...
	this.shape_7.setTransform(5.1562,5.8468,1.0996,1.0996);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#494846").s().p("AgRAUIAVgUIgVgTIAHgHIAbAaIgbAbg");
	this.shape_8.setTransform(1.885,5.8468,1.0996,1.0996);
...
(lib.scene4 = function(mode,startPosition,loop) {
	...
	this.logo_white.setTransform(123.05,487.65,0.2111,0.2111,0,0,0,434.4,2163.2);

	this.timeline.addTween(cjs.Tween.get(this.logo_white).wait(1));
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A3bIIIAAwPMAu3AAAIAAQPg");
	this.shape.setTransform(149.95,52.075);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.scene4, new cjs.Rectangle(0,0.1,300,599.9), null);
...
p.nominalBounds = new cjs.Rectangle(-0.5,0,450.5,604.7);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.5,0,450.5,604.7), null);


// stage content:
(lib.M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.from(mc.cta, 0.8, {x: "+=200", ease:Power4.easeOut}, "-=0.7");
...
p.nominalBounds = new cjs.Rectangle(149.5,300,300.5,304.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1_atlas_.png?1588089073660", id:"M365_FY20Q4_RemoteWork_GigWorker_USA_300x600_BAN_Designer_EasyRemote_English_NA_NA_SBAN_BN_NA_1_atlas_"}
	],
	preloads: []
};
