...
lib.ssMetadata = [
		{name:"M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1", frames: [[0,508,264,153],[579,0,265,154],[554,331,265,154],[0,352,265,154],[267,487,265,154],[0,0,300,184],[534,487,264,153],[267,352,120,111],[554,166,274,163],[0,186,275,164],[277,186,275,164],[302,0,275,164]]}
];
...
(lib.Screen_Excel1 = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Screen_OneDrive1_1 = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.WIN11_Excel_blur();
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.Screen_OneDrive1_1();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-38.425,-1.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-102.5,-17.4,128.2,32.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(94.3,570.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(139.05,570.85,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-15.8,-13.5,248.4,627.6), null);


// stage content:
(lib.M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(64.2,286.5,168.39999999999998,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1.png?1630676627006", id:"M365_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
