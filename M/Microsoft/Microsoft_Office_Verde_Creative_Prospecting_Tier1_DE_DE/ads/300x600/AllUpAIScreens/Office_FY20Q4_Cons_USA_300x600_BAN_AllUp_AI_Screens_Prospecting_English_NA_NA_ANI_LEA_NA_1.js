...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[0,204,290,168],[624,175,290,168],[332,0,290,173],[624,345,290,168],[624,0,290,173],[292,350,290,168],[332,175,290,173],[0,0,330,202],[0,374,290,168],[584,515,120,111]]}
];
...
(lib.Screen_Excel = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Screen_OneDrive_blur = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
(lib.Screen_Outlook_blur = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
(lib.Screen_Powerpoint_blur = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.screen_powerpoint_blur = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Screen_Powerpoint_blur();
...
(lib.screen_outlook_blur = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Screen_Outlook_blur();
...
(lib.screen_onedrive_blur = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Screen_OneDrive_blur();
...
}).prototype = getMCSymbolPrototype(lib.Excel_screen, new cjs.Rectangle(-33.9,-13.9,570.9,329.9), null);
...
// stage content:
(lib.Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582625755314", id:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
