...
lib.ssMetadata = [
		{name:"M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.pointeranimation = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:8.5,y:-6.5,alpha:1},14,cjs.Ease.quadInOut).wait(35).to({alpha:0},10,cjs.Ease.quadInOut).wait(1));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CA4925").ss(1,1,1).p("AjCgcIExhkIBUChIkzBgQhWidAEAAg");
	this.shape.setTransform(1.8661,-13.5);
...
p.nominalBounds = new cjs.Rectangle(-18.6,-27.4,178.7,73.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(1.5,0.75,0.85,0.85,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("Ap+CfIAAk9IT9AAIAAE9g");
	this.shape.setTransform(-42.8,-0.85);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-106.6,-16.7,127.69999999999999,31.799999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(663.5,59.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(708.25,60,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4,-24.9,734,648.3), null);


// stage content:
(lib.M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "+=100",	ease:Power4.easeOut}, "-=1.8");
				exportRoot.tl1.from(mc.cta, 0.7, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=1.8");
...
p.nominalBounds = new cjs.Rectangle(360,20.1,370,603.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1.png?1631631689130", id:"M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
