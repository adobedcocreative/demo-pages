...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(298.1,9.05,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(119.45,427.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(234.2,424.65,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY22Q3Opt_USA_320x480_BAN_FamilyShare_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,148.89999999999998,207.3);
// library properties:
lib.properties = {
