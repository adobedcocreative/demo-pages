...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoPC5QhjAAAAhjIAAirQAAhjBjAAIQfAAQBjAAAABjIAACrQAABjhjAAg");
	this.shape.setTransform(-64.751,1.775);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-127.4,-16.7,125.4,37), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(233.3,4.05,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(83.85,213.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(198.6,210.5,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY22Q3Opt_USA_250x250_BAN_FamilyShare_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(125,125,119.30000000000001,108.19999999999999);
// library properties:
lib.properties = {
