...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(109.5,215.55,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(224.25,212.55,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY22Q3Opt_USA_300x250_BAN_FamilyShare_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,144,110.30000000000001);
// library properties:
lib.properties = {
