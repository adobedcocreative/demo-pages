...
lib.ssMetadata = [
		{name:"M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_1", frames: [[0,376,268,215],[270,376,138,108],[410,376,138,108],[550,376,138,108],[612,0,138,108],[0,0,610,374],[612,110,138,108]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow111111 = function() {
	this.initialize(ss["M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
(lib.Word_Shadow = function(mode,startPosition,loop,reversed) {
...
(lib.Word_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(99.15,113,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(99.2,113,231,180.8), null);
...
(lib.tablet_shadow_sub = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],1.1,5,1.1,-5).s().p("AkLAyIAAAAIABAAIABAAIACAAIAAgCIAAhhIGwAAIBjAAIAABhIAAACIgCAAIAAAAIAAAAg");
	this.shape.setTransform(36.375,89.25);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["#000000","rgba(0,0,0,0)"],[0,1],4.9,-4.8,0,4.9,-4.8,10.2).s().p("AAwAyIgBAAIgCAAQgngBgagcQgdgbAAgoIAAgDIBhAAIACAAIAAABIAABhIAAABg");
	this.shape_1.setTransform(5,89.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],-4.9,0.1,5.1,0.1).s().p("AAwFyIhhAAIAArjIBhAAIACAAIAALjg");
	this.shape_2.setTransform(5,47.15);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.rf(["#000000","rgba(0,0,0,0)"],[0,1],4.9,4.8,0,4.9,4.8,10.2).s().p("AAwAzIhhAAIAAgCIAAgBQAAgpAdgbQAagcAngBIACAAIABAAIACAAIAABiIAAACg");
	this.shape_3.setTransform(5,5.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],1.1,-5,1.1,5).s().p("ACpAyImwAAIAAhiIgCAAIgBAAIgBAAIAAgBIIVAAIAAABIAAAAIACAAIAABig");
	this.shape_4.setTransform(36.375,5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],0,5,0,-5).s().p("AECAyIoVAAIgDAAIAAAAIAAAAIACAAIAAgCIAAhhIAWAAIB8AAIEgAAIB3AAIAABhIAAACIABAAIABAAIAAAAg");
	this.shape_5.setTransform(90.875,89.25);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.rf(["#000000","rgba(0,0,0,0)"],[0,1],-4.8,-4.8,0,-4.8,-4.8,10.2).s().p("AgwAyIgBAAIAAgBIAAhhIAAgBIACAAIBhAAIAAADQgBAogdAbQgaAdgpAAIgBAAg");
	this.shape_6.setTransform(123.6,89.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],0,-5,0,5).s().p("ACeAyIkgAAIh8AAIgWAAIAAhiIgCAAIAAAAIAAgBIItAAIAAABIgBAAIgBAAIAABig");
	this.shape_7.setTransform(90.875,5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AGoFzIkhAAIh9AAIgUAAIhjAAImxAAIAAgBIAArjIAAgBIGxAAIBjAAIAUAAIB9AAIEhAAIB3AAIAAABIAALjIAAABg");
	this.shape_8.setTransform(64.3,47.125);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],5,0.1,-5,0.1).s().p("AgvFyIgCAAIAArjIACAAIBhAAIAALjg");
	this.shape_9.setTransform(123.6,47.15);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.rf(["#000000","rgba(0,0,0,0)"],[0,1],-4.8,4.8,0,-4.8,4.8,10.2).s().p("AgvAzIgCAAIAAgCIAAhiIABAAIABAAQApAAAaAdQAdAbABApIAAABIAAACg");
	this.shape_10.setTransform(123.6,5.1);
...
(lib.Powerpoint_Shadow = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.pointer2_sub = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.pointer1_sub = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.098)").s().p("ArICYIAAkvIWRAAIAAEvg");
	this.shape.setTransform(71.3,15.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.overlay, new cjs.Rectangle(0,0,142.6,30.3), null);
...
(lib.OneDrive_shadow = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.menu_text = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	// this.txt1 = new cjs.Text("Learn more", "10px 'Segoe Pro'");
	...
	this.txt1.setTransform(0.5,2);

	// this.txt2 = new cjs.Text("Monthly subscription", "10px 'Segoe Pro'");
	...
	this.txt2.setTransform(0.5, (this.txt2.text.indexOf('\n') == -1 ? 32 : 25));

	// this.txt3 = new cjs.Text("SAVE 16%\nAnnual subscription", "10px 'Segoe Pro'", "#0078D3");
	...
	this.txt3.setTransform(0.5, (this.txt3.text.indexOf('\n') == -1 ? 61.5 : 54.5));

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.txt3},{t:this.txt2},{t:this.txt1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.menu_text, new cjs.Rectangle(-1.5,-1.2,141.1,86.10000000000001), null);


(lib.mainBtn = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EFEFEF").s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
...
(lib.dropDownMenuBtn = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CCFF").s().p("ArOCWIAAkrIWdAAIAAErg");
	this.shape.setTransform(71.875,15);
	this.shape._off = true;
...
p.nominalBounds = new cjs.Rectangle(0,0,143.8,30);


(lib.choice_text = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Aimes_Shadow = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Wordcopy2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_3
	this.instance = new lib.Excel();
	this.instance.setTransform(96.85,113.9,1.6738,1.6738);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(84.5,113.9,254.60000000000002,220.29999999999998), null);


(lib.Wordcopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Teams = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(93.6,92.15,1.6738,1.6738);
...
}).prototype = getMCSymbolPrototype(lib.Teams, new cjs.Rectangle(83.9,92.2,254.6,222.10000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow111111();
	...
	this.tablet_shadow.setTransform(617.15,353.65,5.5488,4.0676,0,-29.5121,-18.1864,64.3,47.4);
...
}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(121,33.1,929,597.8), null);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(93.15,109.45,1.6738,1.6738);
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(75.3,109.5,254.59999999999997,228.5), null);


(lib.pointer2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.pointer1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Outlook_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(97.95,111.8,1.6738,1.6738);
...
}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(84.5,111.8,254.60000000000002,222.39999999999998), null);


(lib.OneDrive_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regY:0.3,scaleX:2.3057,scaleY:2.3057,x:-712.2,y:264.8},41,cjs.Ease.quadInOut).wait(1));
...
(lib.menuChoice = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.setTransform(177.875,195.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Outline
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#292929").s().p("ArLCYIAAkvIAGAAIWRAAIAAEvgArFCSIWLAAIAAkgI2LAAg");
	this.shape_1.setTransform(125.025,195.625);
	...
	this.choice_text.setTransform(175.5,211.5,1,1,0,0,0,109.9,13.3);
	...
	this.txt2.parent = this;
	this.txt2.setTransform(67.6,200.2);

	this.timeline.addTween(cjs.Tween.get(this.txt2).wait(1));

	// bg
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ArICVIAAkpIWRAAIAAEpg");
	this.shape_2.setTransform(125.05,195.625);
...
p.nominalBounds = new cjs.Rectangle(53.4,180.4,231.99999999999997,44.400000000000006);
...
if (reversed == null) { reversed = false; }
	...
	// Outline
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#292929").s().p("ALGG+IAAgBI2LAAIAAABIgGAAIAAt7IWXAAIAAN7gArFG2IWLAAIAAkeI2LAAgArFCRIWLAAIAAkeI2LAAgArFiUIWLAAIAAkiI2LAAg");
	this.shape.setTransform(71.025,43.625);
	...
	this.menu_text.setTransform(82.2,59.5,1,1,0,0,0,70.5,42.5);
	...
	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ArHG6IAAtzIWPAAIAANzg");
	this.shape_1.setTransform(70.925,43.575);
...
p.nominalBounds = new cjs.Rectangle(-0.6,-0.9,151.9,102.80000000000001);


(lib.icon_anim = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(365.85,161.6,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-201.1,y:-791},159).to({x:-244.25,y:-929.35},21).wait(71));

	// Powerpoint
	this.instance_1 = new lib.Outlook_1();
	this.instance_1.setTransform(341.95,349.8,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-225,y:-602.8},159).to({x:-268.15,y:-741.15},21).wait(71));

	// Word
	this.instance_2 = new lib.Teams();
	this.instance_2.setTransform(539.6,307.15,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-43.6,y:-645.45},159).to({x:-86.75,y:-783.8},21).wait(71));

	// Outlook
	this.instance_3 = new lib.Powerpoint_1();
	this.instance_3.setTransform(358.4,541.7,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-208.55,y:-410.9},159).to({x:-251.7,y:-549.25},21).wait(71));

	// Excel
	this.instance_4 = new lib.Wordcopy2();
	this.instance_4.setTransform(546.6,471.45,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:-20.35,y:-481.15},159).to({x:-63.5,y:-619.5},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-404.1,-1015.6,1228.7,1765.4);


(lib.drop_menu = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ay1HhIAAvBMAlrAAAIAAPBg");
	mask.setTransform(133.4,199.775);

	// Menu copy
	this.menu = new lib.Menu();
	this.menu.name = "menu";
	this.menu.setTransform(16.5,248.05,1,1,0,0,0,-0.5,-0.7);
	...
	mask_1._off = true;
	mask_1.graphics.p("ArfCkIAAlHIW/AAIAAFHg");
	mask_1.setTransform(86.4,220.825);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(16.4,204.5,151.9,43.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(61).call(this.frame_61).wait(205).call(this.frame_266).wait(1));

	// Word
	this.instance = new lib.Word_1();
	this.instance.setTransform(-442.8,-199.6,0.064,0.064,0,0,0,220.2,196);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(236).to({_off:false},0).to({regX:220.3,regY:196.5,scaleX:0.534,scaleY:0.534,x:-732.35,y:-237.9},30,cjs.Ease.quadOut).wait(1));

	// Word Shadow
	this.instance_1 = new lib.Wordcopy();
	this.instance_1.setTransform(-442.8,-199.6,0.064,0.064,0,0,0,220.2,196);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(236).to({_off:false},0).to({regX:220.5,regY:196.6,scaleX:0.4626,scaleY:0.4626,x:-744.7,y:-236.6},30,cjs.Ease.quadOut).wait(1));

	// Screen
	this.instance_2 = new lib.Screen();
	this.instance_2.setTransform(1449.05,1001.55,1.2288,1.2288,0,0,0,581.7,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:357.7,x:930.5,y:151.1},119).to({regY:357.8,x:834.65,y:-32.15},80,cjs.Ease.cubicOut).wait(1).to({regX:585.5,regY:332,scaleX:1.2275,scaleY:1.2275,x:836.55,y:-64.05},0).wait(1).to({scaleX:1.2258,scaleY:1.2258,x:832.8,y:-64.4},0).wait(1).to({scaleX:1.2236,scaleY:1.2236,x:827.9,y:-64.85},0).wait(1).to({scaleX:1.2208,scaleY:1.2208,x:821.9,y:-65.4},0).wait(1).to({scaleX:1.2175,scaleY:1.2175,x:814.65,y:-66.05},0).wait(1).to({scaleX:1.2137,scaleY:1.2137,x:806.15,y:-66.8},0).wait(1).to({scaleX:1.2092,scaleY:1.2092,x:796.3,y:-67.65},0).wait(1).to({scaleX:1.204,scaleY:1.204,x:785,y:-68.65},0).wait(1).to({scaleX:1.1982,scaleY:1.1982,x:772.15,y:-69.85},0).wait(1).to({scaleX:1.1916,scaleY:1.1916,x:757.7,y:-71.15},0).wait(1).to({scaleX:1.1842,scaleY:1.1842,x:741.55,y:-72.6},0).wait(1).to({scaleX:1.176,scaleY:1.176,x:723.6,y:-74.2},0).wait(1).to({scaleX:1.167,scaleY:1.167,x:703.75,y:-75.95},0).wait(1).to({scaleX:1.1571,scaleY:1.1571,x:682,y:-77.9},0).wait(1).to({scaleX:1.1462,scaleY:1.1462,x:658.2,y:-80.05},0).wait(1).to({scaleX:1.1344,scaleY:1.1344,x:632.3,y:-82.4},0).wait(1).to({scaleX:1.1216,scaleY:1.1216,x:604.2,y:-84.9},0).wait(1).to({scaleX:1.1078,scaleY:1.1078,x:573.9,y:-87.6},0).wait(1).to({scaleX:1.093,scaleY:1.093,x:541.45,y:-90.5},0).wait(1).to({scaleX:1.0773,scaleY:1.0773,x:506.95,y:-93.6},0).wait(1).to({scaleX:1.0606,scaleY:1.0606,x:470.4,y:-96.85},0).wait(1).to({scaleX:1.0431,scaleY:1.0431,x:432,y:-100.35},0).wait(1).to({scaleX:1.0249,scaleY:1.0249,x:392.05,y:-103.9},0).wait(1).to({scaleX:1.0061,scaleY:1.0061,x:350.7,y:-107.6},0).wait(1).to({scaleX:0.9868,scaleY:0.9868,x:308.35,y:-111.4},0).wait(1).to({scaleX:0.9672,scaleY:0.9672,x:265.4,y:-115.25},0).wait(1).to({scaleX:0.9475,scaleY:0.9475,x:222.15,y:-119.15},0).wait(1).to({scaleX:0.9278,scaleY:0.9278,x:179,y:-122.95},0).wait(1).to({scaleX:0.9084,scaleY:0.9084,x:136.45,y:-126.8},0).wait(1).to({scaleX:0.8894,scaleY:0.8894,x:94.65,y:-130.55},0).wait(1).to({scaleX:0.8708,scaleY:0.8708,x:53.9,y:-134.2},0).wait(1).to({scaleX:0.8529,scaleY:0.8529,x:14.6,y:-137.7},0).wait(1).to({scaleX:0.8357,scaleY:0.8357,x:-23.25,y:-141.1},0).wait(1).to({scaleX:0.8192,scaleY:0.8192,x:-59.5,y:-144.35},0).wait(1).to({scaleX:0.8034,scaleY:0.8034,x:-94,y:-147.4},0).wait(1).to({scaleX:0.7885,scaleY:0.7885,x:-126.75,y:-150.35},0).wait(1).to({scaleX:0.7744,scaleY:0.7744,x:-157.7,y:-153.15},0).wait(1).to({scaleX:0.7611,scaleY:0.7611,x:-186.95,y:-155.8},0).wait(1).to({scaleX:0.7485,scaleY:0.7485,x:-214.5,y:-158.25},0).wait(1).to({scaleX:0.7368,scaleY:0.7368,x:-240.35,y:-160.55},0).wait(1).to({scaleX:0.7257,scaleY:0.7257,x:-264.55,y:-162.7},0).wait(1).to({scaleX:0.7154,scaleY:0.7154,x:-287.25,y:-164.75},0).wait(1).to({scaleX:0.7057,scaleY:0.7057,x:-308.45,y:-166.65},0).wait(1).to({scaleX:0.6967,scaleY:0.6967,x:-328.25,y:-168.4},0).wait(1).to({scaleX:0.6883,scaleY:0.6883,x:-346.65,y:-170.1},0).wait(1).to({scaleX:0.6805,scaleY:0.6805,x:-363.75,y:-171.6},0).wait(1).to({scaleX:0.6733,scaleY:0.6733,x:-379.6,y:-173.05},0).wait(1).to({scaleX:0.6666,scaleY:0.6666,x:-394.35,y:-174.35},0).wait(1).to({scaleX:0.6604,scaleY:0.6604,x:-407.9,y:-175.55},0).wait(1).to({scaleX:0.6547,scaleY:0.6547,x:-420.45,y:-176.65},0).wait(1).to({scaleX:0.6494,scaleY:0.6494,x:-431.9,y:-177.7},0).wait(1).to({scaleX:0.6447,scaleY:0.6447,x:-442.4,y:-178.65},0).wait(1).to({scaleX:0.6403,scaleY:0.6403,x:-452.05,y:-179.5},0).wait(1).to({scaleX:0.6363,scaleY:0.6363,x:-460.75,y:-180.3},0).wait(1).to({scaleX:0.6327,scaleY:0.6327,x:-468.65,y:-181},0).wait(1).to({scaleX:0.6295,scaleY:0.6295,x:-475.75,y:-181.6},0).wait(1).to({scaleX:0.6266,scaleY:0.6266,x:-482.1,y:-182.15},0).wait(1).to({scaleX:0.624,scaleY:0.624,x:-487.7,y:-182.65},0).wait(1).to({scaleX:0.6218,scaleY:0.6218,x:-492.6,y:-183.1},0).wait(1).to({scaleX:0.6199,scaleY:0.6199,x:-496.75,y:-183.5},0).wait(1).to({scaleX:0.6182,scaleY:0.6182,x:-500.35,y:-183.85},0).wait(1).to({scaleX:0.6169,scaleY:0.6169,x:-503.35,y:-184.1},0).wait(1).to({scaleX:0.6158,scaleY:0.6158,x:-505.75,y:-184.3},0).wait(1).to({scaleX:0.615,scaleY:0.615,x:-507.55,y:-184.5},0).wait(1).to({scaleX:0.6144,scaleY:0.6144,x:-508.8,y:-184.55},0).wait(1).to({scaleX:0.6141,scaleY:0.6141,x:-509.55,y:-184.65},0).wait(1).to({regX:581.6,regY:357.7,scaleX:0.614,scaleY:0.614,x:-512.15,y:-168.9},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-807.6,-431.1,2832.1,1768.1);
...
if (reversed == null) { reversed = false; }
	...
	this.icons.setTransform(571.75,123.05,0.389,0.389,0,0,0,285.1,25.4);
	...
	this.dropdown.setTransform(552.5,-159.45);
	...
	this.dropDownMenuBtn.setTransform(684.5,127.05,1,1,0,0,0,116,81.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-7.7,1088.4,574.8000000000001), null);


// stage content:
(lib.M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				for (var i = 0; i < exportRoot.headline1.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline1[i], 0.8, { alpha: 0, ease:Power4.easeIn}, "+=2.6");
				}

				for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=0.4");
		...
		this.showMenu = function() {
			TweenMax.to(theMenu, 0.4, {y:160, ease:Power4.easeOut, onComplete:function(){menuClosed = false}});
		...
		this.hideMenu = function() {
			TweenMax.to(theMenu, 0.4, {y:249.3, ease:Power4.easeOut, onComplete:function(){menuClosed = true}});
			exportRoot.btn1.enabled = false
			exportRoot.btn2.enabled = false
			exportRoot.btn3.enabled = false
		}
...
p.nominalBounds = new cjs.Rectangle(364,37.3,724.4000000000001,529.8000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_1.png?1594218913279", id:"M365_FY21Q1_Cons_USA_728x90_BAN_MoneyInExcel_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
