...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,0,138,108],[562,376,268,215],[752,0,138,108],[0,376,560,363],[612,110,138,108],[752,110,138,108],[612,220,138,108],[0,0,610,374],[752,220,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow11111111111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow11111111111();
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.instance_4.setTransform(691.55,598.45,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:121.8,y:-349},159).to({x:34.25,y:-488.65},21).wait(71));

	// Excel
	this.instance_5 = new lib.Wordcopy2();
	this.instance_5.setTransform(686.6,421.05,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:119.65,y:-531.55},159).to({x:31.7,y:-669.9},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-476.9,-1010,1301.5,1759.8);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582805622346", id:"O365_FY20Q4_Cons_USA_728x90_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
