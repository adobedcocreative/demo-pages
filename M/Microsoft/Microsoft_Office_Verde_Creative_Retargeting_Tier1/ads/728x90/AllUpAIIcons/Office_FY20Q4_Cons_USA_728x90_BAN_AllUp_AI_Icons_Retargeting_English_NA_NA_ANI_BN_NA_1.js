...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,170,174,135],[0,0,210,168],[176,170,174,135],[212,0,174,135],[352,137,174,135],[388,0,174,135],[0,307,120,111],[352,274,174,135]]}
];
...
(lib.Excel_icon = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Word = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(128.05,133.65);

	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,221,1,1,0,0,0,105,84);
	this.shad.alpha = 0.5;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shad},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word, new cjs.Rectangle(112.5,133.7,210,171.3), null);
...
(lib.Teams = function(mode,startPosition,loop) {
	...
	// OneDrive_icon.png
	this.instance = new lib.Onenote_icon();
	this.instance.setTransform(128.05,133.65);
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,222,1,1,0,0,0,105,84);
	this.shad.alpha = 0.5;
...
}).prototype = getMCSymbolPrototype(lib.Teams, new cjs.Rectangle(112.5,133.7,210,172.3), null);
...
(lib.Powerpoint = function(mode,startPosition,loop) {
	...
	// OneDrive_icon.png
	this.instance = new lib.Powerpoint_icon();
	this.instance.setTransform(128.05,133.65);
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,215,1,1,0,0,0,105,84);
	this.shad.alpha = 0.5;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint, new cjs.Rectangle(112.5,131,210,168), null);
...
(lib.Outlook = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.Outlook_icon();
	this.instance.setTransform(128.05,133.65);
...
}).prototype = getMCSymbolPrototype(lib.Outlook, new cjs.Rectangle(112.5,126,210,168), null);
...
(lib.OneDrive = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.OneDrive_icon();
	this.instance.setTransform(128.05,133.65);
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,226,1,1,0,0,0,105,84);
	this.shad.alpha = 0.5;
...
}).prototype = getMCSymbolPrototype(lib.OneDrive, new cjs.Rectangle(112.5,133.7,210,176.3), null);
...
(lib.Excel = function(mode,startPosition,loop) {
	...
	this.shad = new lib.icon_shadow_1();
	this.shad.name = "shad";
	this.shad.setTransform(217.5,214,1,1,0,0,0,105,84);
	this.shad.alpha = 0.5;
...
}).prototype = getMCSymbolPrototype(lib.Excel, new cjs.Rectangle(112.5,130,210,168), null);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	// OneDrive
	this.icon_onedrive = new lib.OneDrive();
	this.icon_onedrive.name = "icon_onedrive";
	this.icon_onedrive.setTransform(245.85,-161.05,0.5,0.5,0,0,0,220.5,196.7);

	this.timeline.addTween(cjs.Tween.get(this.icon_onedrive).wait(1));

	// Outlook
	this.icon_outlook = new lib.Outlook();
	this.icon_outlook.name = "icon_outlook";
	this.icon_outlook.setTransform(239.5,-86.6,0.5,0.5,0,0,0,220.5,196.7);

	this.timeline.addTween(cjs.Tween.get(this.icon_outlook).wait(1));

	// Aimes
	this.icon_onenote = new lib.Teams();
	this.icon_onenote.name = "icon_onenote";
	this.icon_onenote.setTransform(313,-35.85,0.5,0.5,0,0,0,220.5,196.6);

	this.timeline.addTween(cjs.Tween.get(this.icon_onenote).wait(1));

	// Powerpoint
	this.icon_powerpoint = new lib.Powerpoint();
	this.icon_powerpoint.name = "icon_powerpoint";
	this.icon_powerpoint.setTransform(400.85,-135.85,0.5,0.5,0,0,0,220.5,196.7);

	this.timeline.addTween(cjs.Tween.get(this.icon_powerpoint).wait(1));

	// Excel
	this.icon_excel = new lib.Excel();
	this.icon_excel.name = "icon_excel";
	this.icon_excel.setTransform(394.05,-61.4,0.5,0.5,0,0,0,220.5,196.7);

	this.timeline.addTween(cjs.Tween.get(this.icon_excel).wait(1));

	// Word
	this.icon_word = new lib.Word();
	this.icon_word.name = "icon_word";
	this.icon_word.setTransform(321.2,-112.55,0.5,0.5,0,0,0,220.5,196.7);

	this.timeline.addTween(cjs.Tween.get(this.icon_word).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(-207.7,-192.6,1817.8,1102.7), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(204.1,120.55,0.6167,0.6167,0,0,0,284.2,24.9);
	...
	this.txtCta.setTransform(790.35,59.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(835.1,60,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.bg_1.name = "bg_1";
	this.bg_1.setTransform(364,45,2.4267,0.36,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-13.5,855.9,204.7), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "+=1.7");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
				
				for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0.6");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		...
		//		exportRoot.tl1.from(mc.cta, 0.7, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=0.7");
				...
				exportRoot.tl1.from(mc.dropdown, 0.8, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=0.6");
		...
		this.tlicons = new TimelineLite();
				...
				exportRoot.tlicons.from(mc.icons.icon_onedrive, 4, { x: xIcon, y: yIcon,	ease:Quart.easeOut}, "-=1");
				exportRoot.tlicons.from(mc.icons.icon_onedrive.shad, 4, { y: "-=28",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.icons.icon_outlook, 3.7, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3.7");
				exportRoot.tlicons.from(mc.icons.icon_outlook.shad, 3.7, { y: "-=28",	ease:Quart.easeOut}, "-=3.7");
				exportRoot.tlicons.from(mc.icons.icon_word, 3.5, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3.5");
				exportRoot.tlicons.from(mc.icons.icon_word.shad, 3.5, { y: "-=28",	ease:Quart.easeOut}, "-=3.5");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint, 3.2, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3.2");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint.shad, 3.2, { y: "-=28",	ease:Quart.easeOut}, "-=3.2");
				exportRoot.tlicons.from(mc.icons.icon_onenote, 3, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_onenote.shad, 3, { y: "-=28",	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_excel, 2.7, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=2.7");
				exportRoot.tlicons.from(mc.icons.icon_excel.shad, 2.7, { y: "-=28",	ease:Quart.easeOut}, "-=2.7");
		
		/*		exportRoot.tlicons.from(mc.icons.icon_onedrive, 8, { y: "+=250",	ease:Power3.easeOut}, "=0");
				exportRoot.tlicons.from(mc.icons.icon_onedrive.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_onenote, 8, { y: "+=270",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_onenote.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_word, 8, { y: "+=276",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_word.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint, 8, { y: "+=290",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_excel, 8, { y: "+=296",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_excel.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_outlook, 8, { y: "+=310",	ease:Power3.easeOut}, "-=8");
				exportRoot.tlicons.from(mc.icons.icon_outlook.shad, 8, { y: "-=28",	ease:Power3.easeOut}, "-=8");
		*/
...
p.nominalBounds = new cjs.Rectangle(363,31.5,491.9,159.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582803175608", id:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
