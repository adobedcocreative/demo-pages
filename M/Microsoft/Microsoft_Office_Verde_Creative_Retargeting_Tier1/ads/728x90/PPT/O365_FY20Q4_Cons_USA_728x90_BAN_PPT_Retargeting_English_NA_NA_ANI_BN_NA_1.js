...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,0,138,108],[562,376,268,215],[752,0,138,108],[0,376,560,363],[612,110,138,108],[752,110,138,108],[612,220,138,108],[0,0,610,374],[752,220,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow1111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(100.5,112.45,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(100.5,112.5,231,180.7), null);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow1111();
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Powerpoint();
	this.instance.setTransform(100.5,112.85,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Powerpoint_Shadow();
	this.instance_1.setTransform(210.6,236.85,0.95,0.95,0,0,0,134.1,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(83.2,112.9,254.60000000000002,226.1), null);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(90.85,113.9,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(204.25,231.6,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(76.9,113.9,254.6,219.9), null);
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:130.5,y:-340.3},159).to({x:42.95,y:-479.95},21).wait(71));

	// Excel
	this.instance_5 = new lib.Excel_1();
	this.instance_5.setTransform(677.9,412.35,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:110.95,y:-540.25},159).to({x:23,y:-678.6},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-476.9,-1010,1294.5,1759.4);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582633946435", id:"O365_FY20Q4_Cons_USA_728x90_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
