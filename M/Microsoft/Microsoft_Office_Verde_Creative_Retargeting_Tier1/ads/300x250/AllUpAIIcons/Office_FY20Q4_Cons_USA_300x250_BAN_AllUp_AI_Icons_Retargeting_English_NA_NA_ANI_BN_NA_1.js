...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,170,174,135],[0,0,210,168],[176,170,174,135],[212,0,174,135],[352,137,174,135],[388,0,174,135],[0,307,120,111],[352,274,174,135]]}
];
...
(lib.Excel_icon = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.choice_text = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("BUY NOW", "11px 'Segoe Pro'", "#0078D3");
	this.txt.name = "txt";
...
(lib.menuChoice = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(189.025,195.375);
	...
	// bg
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ArqCVIAAkpIXVAAIAAEpg");
	this.shape_2.setTransform(128.425,195.625);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.icon_outlook.setTransform(306.7,54.45,0.5,0.5,0,0,0,220.5,196.7);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(253.35,213.5,1,1,0,0,0,284.2,24.8);
	...
	this.txtCta.setTransform(-73.2,219.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-28.45,220,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-126.3,-3.9,465.5,311.79999999999995), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut}, "+=1.4");
		...
		this.tlicons = new TimelineLite();
				...
				exportRoot.tlicons.from(mc.icons.icon_onenote, 3.7, { x: "+=100",  y: "+=250",	ease:Quart.easeOut}, "-=3.7");
				exportRoot.tlicons.from(mc.icons.icon_onenote.shad, 3.7, { y: "-=28",	ease:Quart.easeOut}, "-=3.7");
				exportRoot.tlicons.from(mc.icons.icon_word, 3.5, { x: "+=100",  y: "+=250",	ease:Quart.easeOut}, "-=3.5");
				exportRoot.tlicons.from(mc.icons.icon_word.shad, 3.5, { y: "-=28",	ease:Quart.easeOut}, "-=3.5");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint, 3.2, { x: "+=100",  y: "+=250",	ease:Quart.easeOut}, "-=3.2");
				exportRoot.tlicons.from(mc.icons.icon_powerpoint.shad, 3.2, { y: "-=28",	ease:Quart.easeOut}, "-=3.2");
				exportRoot.tlicons.from(mc.icons.icon_excel, 3, { x: "+=100",  y: "+=250",	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_excel.shad, 3, { y: "-=28",	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_outlook, 2.7, { x: "+=100",  y: "+=250",	ease:Quart.easeOut}, "-=2.7");
...
p.nominalBounds = new cjs.Rectangle(23.7,121.1,315.5,186.79999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582801746055", id:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
