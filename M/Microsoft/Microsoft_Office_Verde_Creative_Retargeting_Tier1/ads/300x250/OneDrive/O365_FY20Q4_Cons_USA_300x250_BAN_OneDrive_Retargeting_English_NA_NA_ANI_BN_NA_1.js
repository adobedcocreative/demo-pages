...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x250_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,492,268,215],[612,709,138,108],[752,709,138,108],[612,819,138,108],[752,819,138,108],[0,492,610,374],[0,0,739,490],[741,110,120,111],[741,0,138,108]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x250_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow1();
...
(lib.overlay = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.098)").s().p("ArsCYIAAkvIXZAAIAAEvg");
	this.shape.setTransform(74.925,15.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.overlay, new cjs.Rectangle(0,0,149.9,30.3), null);
...
(lib.dropDownMenuBtn = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CCFF").s().p("AryCWIAAkrIXlAAIAAErg");
	this.shape.setTransform(75.5,15);
	this.shape._off = true;
...
p.nominalBounds = new cjs.Rectangle(0,0,151,30);
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(98.2,112.45,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3 copy
	this.instance_1 = new lib.OneDrive_shadow();
	this.instance_1.setTransform(212.7,234,0.95,0.95,0,0,0,134.1,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(85.3,112.5,254.59999999999997,223.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(84.5,110.5,254.60000000000002,223.7), null);
...
(lib.Teams = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(95.5,93.6,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(208.9,211.3,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Teams, new cjs.Rectangle(81.5,93.6,254.60000000000002,219.9), null);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(119).call(this.frame_119).wait(93).call(this.frame_212).wait(1));

	// Word Shadow
	this.instance = new lib.Wordcopy();
	this.instance.setTransform(-21.4,-108.65,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(190).to({_off:false},0).to({regX:220.6,regY:196.6,scaleX:0.4711,scaleY:0.4711,x:115.2,y:-142},22,cjs.Ease.quadOut).wait(1));

	// Word
	this.instance_1 = new lib.Word_1();
	this.instance_1.setTransform(-21.4,-108.65,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(190).to({_off:false},0).to({regX:220.6,regY:196.6,scaleX:0.4711,scaleY:0.4711,x:115.2,y:-142},22,cjs.Ease.quadOut).wait(1));

	// Screen
	this.instance_2 = new lib.Screen();
	this.instance_2.setTransform(561.8,761.05,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:241.45,y:176.45},119).wait(1).to({regX:584.3,regY:321.9,x:241.5,y:135.5},0).wait(1).to({x:238.8,y:130.35},0).wait(1).to({x:236.05,y:125.2},0).wait(1).to({x:233.3,y:120},0).wait(1).to({x:230.55,y:114.75},0).wait(1).to({x:227.75,y:109.45},0).wait(1).to({x:224.95,y:104.2},0).wait(1).to({x:222.2,y:98.9},0).wait(1).to({x:219.4,y:93.65},0).wait(1).to({x:216.65,y:88.4},0).wait(1).to({x:213.9,y:83.2},0).wait(1).to({x:211.15,y:78.05},0).wait(1).to({x:208.5,y:72.95},0).wait(1).to({x:205.85,y:67.95},0).wait(1).to({x:203.25,y:63.05},0).wait(1).to({x:200.7,y:58.2},0).wait(1).to({x:198.25,y:53.5},0).wait(1).to({x:195.8,y:48.95},0).wait(1).to({x:193.45,y:44.5},0).wait(1).to({x:191.2,y:40.2},0).wait(1).to({x:189,y:36.05},0).wait(1).to({x:186.9,y:32},0).wait(1).to({x:184.85,y:28.15},0).wait(1).to({x:182.9,y:24.45},0).wait(1).to({x:181,y:20.9},0).wait(1).to({x:179.25,y:17.5},0).wait(1).to({x:177.5,y:14.25},0).wait(1).to({x:175.9,y:11.15},0).wait(1).to({x:174.35,y:8.25},0).wait(1).to({x:172.85,y:5.45},0).wait(1).to({x:171.45,y:2.75},0).wait(1).to({x:170.1,y:0.25},0).wait(1).to({x:168.85,y:-2.15},0).wait(1).to({x:167.65,y:-4.4},0).wait(1).to({x:166.55,y:-6.55},0).wait(1).to({x:165.5,y:-8.55},0).wait(1).to({x:164.45,y:-10.45},0).wait(1).to({x:163.55,y:-12.25},0).wait(1).to({x:162.65,y:-13.9},0).wait(1).to({x:161.8,y:-15.5},0).wait(1).to({x:161.05,y:-17},0).wait(1).to({x:160.3,y:-18.35},0).wait(1).to({x:159.6,y:-19.65},0).wait(1).to({x:159,y:-20.85},0).wait(1).to({x:158.4,y:-22},0).wait(1).to({x:157.85,y:-23},0).wait(1).to({x:157.35,y:-24},0).wait(1).to({x:156.85,y:-24.85},0).wait(1).to({x:156.45,y:-25.7},0).wait(1).to({x:156.05,y:-26.45},0).wait(1).to({regX:581.6,regY:357.8,x:152.95,y:8.75},0).wait(1).to({regX:584.3,regY:321.9,scaleX:0.9985,scaleY:0.9985,x:156.3,y:-27.45},0).wait(1).to({scaleX:0.9962,scaleY:0.9962,x:157.2,y:-27.85},0).wait(1).to({scaleX:0.993,scaleY:0.993,x:158.55,y:-28.45},0).wait(1).to({scaleX:0.9887,scaleY:0.9887,x:160.25,y:-29.25},0).wait(1).to({scaleX:0.9834,scaleY:0.9834,x:162.45,y:-30.25},0).wait(1).to({scaleX:0.977,scaleY:0.977,x:165.1,y:-31.45},0).wait(1).to({scaleX:0.9692,scaleY:0.9692,x:168.3,y:-32.95},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:172.05,y:-34.7},0).wait(1).to({scaleX:0.9492,scaleY:0.9492,x:176.4,y:-36.7},0).wait(1).to({scaleX:0.9369,scaleY:0.9369,x:181.45,y:-39.05},0).wait(1).to({scaleX:0.9229,scaleY:0.9229,x:187.15,y:-41.65},0).wait(1).to({scaleX:0.9072,scaleY:0.9072,x:193.55,y:-44.65},0).wait(1).to({scaleX:0.8899,scaleY:0.8899,x:200.65,y:-47.95},0).wait(1).to({scaleX:0.8711,scaleY:0.8711,x:208.3,y:-51.5},0).wait(1).to({scaleX:0.8511,scaleY:0.8511,x:216.5,y:-55.3},0).wait(1).to({scaleX:0.8303,scaleY:0.8303,x:224.95,y:-59.15},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,x:233.6,y:-63.2},0).wait(1).to({scaleX:0.7882,scaleY:0.7882,x:242.2,y:-67.15},0).wait(1).to({scaleX:0.7678,scaleY:0.7678,x:250.5,y:-71},0).wait(1).to({scaleX:0.7482,scaleY:0.7482,x:258.45,y:-74.7},0).wait(1).to({scaleX:0.7299,scaleY:0.7299,x:265.95,y:-78.15},0).wait(1).to({scaleX:0.7129,scaleY:0.7129,x:272.9,y:-81.4},0).wait(1).to({scaleX:0.6972,scaleY:0.6972,x:279.3,y:-84.35},0).wait(1).to({scaleX:0.6829,scaleY:0.6829,x:285.15,y:-87.05},0).wait(1).to({scaleX:0.6699,scaleY:0.6699,x:290.45,y:-89.5},0).wait(1).to({scaleX:0.6582,scaleY:0.6582,x:295.25,y:-91.7},0).wait(1).to({scaleX:0.6476,scaleY:0.6476,x:299.55,y:-93.7},0).wait(1).to({scaleX:0.6382,scaleY:0.6382,x:303.4,y:-95.45},0).wait(1).to({scaleX:0.6298,scaleY:0.6298,x:306.85,y:-97.05},0).wait(1).to({scaleX:0.6224,scaleY:0.6224,x:309.85,y:-98.45},0).wait(1).to({scaleX:0.6158,scaleY:0.6158,x:312.5,y:-99.7},0).wait(1).to({scaleX:0.6101,scaleY:0.6101,x:314.9,y:-100.85},0).wait(1).to({scaleX:0.6051,scaleY:0.6051,x:316.95,y:-101.75},0).wait(1).to({scaleX:0.6008,scaleY:0.6008,x:318.7,y:-102.55},0).wait(1).to({scaleX:0.5971,scaleY:0.5971,x:320.15,y:-103.25},0).wait(1).to({scaleX:0.5941,scaleY:0.5941,x:321.4,y:-103.8},0).wait(1).to({scaleX:0.5916,scaleY:0.5916,x:322.4,y:-104.25},0).wait(1).to({scaleX:0.5896,scaleY:0.5896,x:323.2,y:-104.65},0).wait(1).to({scaleX:0.5881,scaleY:0.5881,x:323.85,y:-104.95},0).wait(1).to({scaleX:0.5871,scaleY:0.5871,x:324.25,y:-105.15},0).wait(1).to({scaleX:0.5865,scaleY:0.5865,x:324.5,y:-105.25},0).wait(1).to({regX:581.6,regY:357.8,scaleX:0.5863,scaleY:0.5863,x:322.95,y:-84.25},0).wait(1));

	// Screen Shadow
	this.instance_3 = new lib.Screen_Shadow();
	this.instance_3.setTransform(561.8,761.05,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:241.45,y:176.45},119).wait(1).to({regX:587.3,regY:314.3,x:244.5,y:127.9},0).wait(1).to({x:241.8,y:122.75},0).wait(1).to({x:239.05,y:117.6},0).wait(1).to({x:236.3,y:112.4},0).wait(1).to({x:233.55,y:107.15},0).wait(1).to({x:230.75,y:101.85},0).wait(1).to({x:227.95,y:96.6},0).wait(1).to({x:225.2,y:91.3},0).wait(1).to({x:222.4,y:86.05},0).wait(1).to({x:219.65,y:80.8},0).wait(1).to({x:216.9,y:75.6},0).wait(1).to({x:214.15,y:70.45},0).wait(1).to({x:211.5,y:65.35},0).wait(1).to({x:208.85,y:60.35},0).wait(1).to({x:206.25,y:55.45},0).wait(1).to({x:203.7,y:50.6},0).wait(1).to({x:201.25,y:45.9},0).wait(1).to({x:198.8,y:41.35},0).wait(1).to({x:196.45,y:36.9},0).wait(1).to({x:194.2,y:32.6},0).wait(1).to({x:192,y:28.45},0).wait(1).to({x:189.9,y:24.4},0).wait(1).to({x:187.85,y:20.55},0).wait(1).to({x:185.9,y:16.85},0).wait(1).to({x:184,y:13.3},0).wait(1).to({x:182.25,y:9.9},0).wait(1).to({x:180.5,y:6.65},0).wait(1).to({x:178.9,y:3.55},0).wait(1).to({x:177.35,y:0.65},0).wait(1).to({x:175.85,y:-2.15},0).wait(1).to({x:174.45,y:-4.85},0).wait(1).to({x:173.1,y:-7.35},0).wait(1).to({x:171.85,y:-9.75},0).wait(1).to({x:170.65,y:-12},0).wait(1).to({x:169.55,y:-14.15},0).wait(1).to({x:168.5,y:-16.15},0).wait(1).to({x:167.45,y:-18.05},0).wait(1).to({x:166.55,y:-19.85},0).wait(1).to({x:165.65,y:-21.5},0).wait(1).to({x:164.8,y:-23.1},0).wait(1).to({x:164.05,y:-24.6},0).wait(1).to({x:163.3,y:-25.95},0).wait(1).to({x:162.6,y:-27.25},0).wait(1).to({x:162,y:-28.45},0).wait(1).to({x:161.4,y:-29.6},0).wait(1).to({x:160.85,y:-30.6},0).wait(1).to({x:160.35,y:-31.6},0).wait(1).to({x:159.85,y:-32.45},0).wait(1).to({x:159.45,y:-33.3},0).wait(1).to({x:159.05,y:-34.05},0).wait(1).to({regX:581.6,regY:357.8,x:152.95,y:8.75},0).wait(1).to({regX:587.3,regY:314.3,scaleX:0.9985,scaleY:0.9985,x:159.25,y:-35},0).wait(1).to({scaleX:0.9962,scaleY:0.9962,x:160.2,y:-35.4},0).wait(1).to({scaleX:0.993,scaleY:0.993,x:161.5,y:-36},0).wait(1).to({scaleX:0.9887,scaleY:0.9887,x:163.25,y:-36.8},0).wait(1).to({scaleX:0.9834,scaleY:0.9834,x:165.4,y:-37.7},0).wait(1).to({scaleX:0.977,scaleY:0.977,x:168,y:-38.9},0).wait(1).to({scaleX:0.9692,scaleY:0.9692,x:171.2,y:-40.3},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:174.95,y:-42},0).wait(1).to({scaleX:0.9492,scaleY:0.9492,x:179.25,y:-43.9},0).wait(1).to({scaleX:0.9369,scaleY:0.9369,x:184.25,y:-46.2},0).wait(1).to({scaleX:0.9229,scaleY:0.9229,x:189.9,y:-48.7},0).wait(1).to({scaleX:0.9072,scaleY:0.9072,x:196.3,y:-51.55},0).wait(1).to({scaleX:0.8899,scaleY:0.8899,x:203.3,y:-54.7},0).wait(1).to({scaleX:0.8711,scaleY:0.8711,x:210.95,y:-58.1},0).wait(1).to({scaleX:0.8511,scaleY:0.8511,x:219.05,y:-61.75},0).wait(1).to({scaleX:0.8303,scaleY:0.8303,x:227.45,y:-65.5},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,x:236.05,y:-69.35},0).wait(1).to({scaleX:0.7882,scaleY:0.7882,x:244.55,y:-73.15},0).wait(1).to({scaleX:0.7678,scaleY:0.7678,x:252.8,y:-76.85},0).wait(1).to({scaleX:0.7482,scaleY:0.7482,x:260.7,y:-80.4},0).wait(1).to({scaleX:0.7299,scaleY:0.7299,x:268.15,y:-83.7},0).wait(1).to({scaleX:0.7129,scaleY:0.7129,x:275.05,y:-86.8},0).wait(1).to({scaleX:0.6972,scaleY:0.6972,x:281.4,y:-89.65},0).wait(1).to({scaleX:0.6829,scaleY:0.6829,x:287.2,y:-92.25},0).wait(1).to({scaleX:0.6699,scaleY:0.6699,x:292.45,y:-94.6},0).wait(1).to({scaleX:0.6582,scaleY:0.6582,x:297.25,y:-96.7},0).wait(1).to({scaleX:0.6476,scaleY:0.6476,x:301.5,y:-98.6},0).wait(1).to({scaleX:0.6382,scaleY:0.6382,x:305.3,y:-100.3},0).wait(1).to({scaleX:0.6298,scaleY:0.6298,x:308.75,y:-101.85},0).wait(1).to({scaleX:0.6224,scaleY:0.6224,x:311.7,y:-103.2},0).wait(1).to({scaleX:0.6158,scaleY:0.6158,x:314.35,y:-104.4},0).wait(1).to({scaleX:0.6101,scaleY:0.6101,x:316.75,y:-105.45},0).wait(1).to({scaleX:0.6051,scaleY:0.6051,x:318.75,y:-106.35},0).wait(1).to({scaleX:0.6008,scaleY:0.6008,x:320.5,y:-107.15},0).wait(1).to({scaleX:0.5971,scaleY:0.5971,x:321.95,y:-107.8},0).wait(1).to({scaleX:0.5941,scaleY:0.5941,x:323.2,y:-108.35},0).wait(1).to({scaleX:0.5916,scaleY:0.5916,x:324.2,y:-108.75},0).wait(1).to({scaleX:0.5896,scaleY:0.5896,x:325,y:-109.15},0).wait(1).to({scaleX:0.5881,scaleY:0.5881,x:325.6,y:-109.4},0).wait(1).to({scaleX:0.5871,scaleY:0.5871,x:326,y:-109.6},0).wait(1).to({scaleX:0.5865,scaleY:0.5865,x:326.25,y:-109.7},0).wait(1).to({regX:581.6,regY:357.8,scaleX:0.5863,scaleY:0.5863,x:322.95,y:-84.25},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-400.5,-409.8,1527.2,1502.3999999999999);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(93.35,111.25,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Powerpoint_Shadow();
	this.instance_1.setTransform(203.45,235.25,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(76.1,111.3,254.6,226.09999999999997), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({scaleX:2.2,scaleY:2.2,x:-28.3,y:1},41,cjs.Ease.quadInOut).to({_off:true},1).wait(9));
...
(lib.menuChoice = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(186.175,195.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Outline
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#292929").s().p("Ar1CYIAAkvIAHAAIXkAAIAAEvgAruCSIXdAAIAAkgI3dAAg");
	this.shape_1.setTransform(129.15,195.625);
	...
	this.choice_text.setTransform(174.7,211.5,1,1,0,0,0,109.9,13.3);
	...
	this.txt2.parent = this;
	this.txt2.setTransform(66.8,200.2);

	this.timeline.addTween(cjs.Tween.get(this.txt2).wait(1));

	// bg
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ArxCVIAAkpIXjAAIAAEpg");
	this.shape_2.setTransform(129.175,195.625);
...
p.nominalBounds = new cjs.Rectangle(53.4,180.4,231.20000000000002,44.400000000000006);
...
(lib.Menu = function(mode,startPosition,loop) {
	...
	// Outline
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#292929").s().p("ALvG+IAAgBI3dAAIAAABIgHAAIAAt7IXrAAIAAN7gAruG2IXdAAIAAkeI3dAAgAruCRIXdAAIAAkeI3dAAgAruiUIXdAAIAAkiI3dAAg");
	this.shape.setTransform(75.15,43.625);
	...
	this.menu_text.setTransform(81.5,59.5,1,1,0,0,0,70.5,42.5);
	...
	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ArvG6IAAtzIXfAAIAANzg");
	this.shape_1.setTransform(74.925,43.575);
...
p.nominalBounds = new cjs.Rectangle(-0.6,-0.9,152.7,102.80000000000001);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(16.4,204.5,152.7,40), null);
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-229.1,y:-785.4},179).to({x:-317.05,y:-923.75},21).wait(71));

	// Outlook
	this.instance_1 = new lib.Outlook_1();
	this.instance_1.setTransform(313.95,355.4,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-253,y:-597.2},179).to({x:-340.95,y:-735.55},21).wait(71));

	// Word
	this.instance_2 = new lib.Teams();
	this.instance_2.setTransform(511.6,312.75,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-71.6,y:-639.85},179).to({x:-159.55,y:-778.2},21).wait(71));

	// PowerPoint
	this.instance_3 = new lib.Powerpoint_1();
	this.instance_3.setTransform(498.4,491.3,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-68.55,y:-461.3},179).to({x:-156.5,y:-599.65},21).wait(71));

	// PowerPoint
	this.instance_4 = new lib.Wordcopy2();
	this.instance_4.setTransform(700.25,607.15,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:130.5,y:-340.3},179).to({x:42.95,y:-479.95},21).wait(71));

	// Excel
	this.instance_5 = new lib.Excel_1();
	this.instance_5.setTransform(677.9,412.35,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:110.95,y:-540.25},179).to({x:23,y:-678.6},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-476.9,-1010,1296.6,1756.5);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.dropDownMenuBtn.setTransform(132,286.5,1,1,0,0,0,116,81.5);
	...
	this.icons.setTransform(253.35,213.5,0.614,0.5401,0,0,0,284.1,24.7);
	...
	this.screen.setTransform(253.35,213.5,0.614,0.5401,0,0,0,284.1,24.7);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,771.6,790.3), null);


// stage content:
(lib.O365_FY20Q4_Cons_USA_300x250_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,125,621.6,665.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x250_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582637075106", id:"O365_FY20Q4_Cons_USA_300x250_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
