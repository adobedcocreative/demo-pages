...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-12.3,303.1,273.2), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x250_BAN_MoneyInExcel_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
		...
		this.runBanner = function() {
			...
			//out
				...
				for (var i = 0; i < exportRoot.headline14.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline14[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=11.1");
					...
					if (i==0) this.tlText.from(exportRoot.headline15[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.6");
