...
lib.ssMetadata = [
		{name:"M365_FY21Q2_ConsumerRefresh_USA_300x250_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q2_ConsumerRefresh_USA_300x250_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(195.45,148.25,0.4688,0.3752,0,-28.3369,-17.0376,108,-133.2);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(194.9,147.75,0.4687,0.4687,0,0,0,127,72);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.4,0,410.7,284.8), null);


// stage content:
(lib.M365_FY21Q2_ConsumerRefresh_USA_300x250_BAN_Editor_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.2, {x: "-=41",y: "-=17",scaleX: "0.52",scaleY: "0.42", ease:Power4.easeInOut}, "-=0.7");
				exportRoot.tl1.to(shadow, 1.2, {x: "-=41",y: "-=17",scaleX: "0.52",scaleY: "0.52", ease:Power4.easeInOut}, "-=1.2");
				...
				exportRoot.tl1.to(screen, 1.2, {x: "+=33",y: "+=53",scaleX: "0.42",scaleY: "0.336", ease:Power4.easeInOut}, "-=0.7");
				exportRoot.tl1.to(shadow, 1.2, {x: "+=33",y: "+=53",scaleX: "0.42",scaleY: "0.42", ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(148.6,125,260.70000000000005,159.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2_ConsumerRefresh_USA_300x250_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1599126915024", id:"M365_FY21Q2_ConsumerRefresh_USA_300x250_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
