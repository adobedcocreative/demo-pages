...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhRABCXMAAAiEtMCiAAAAMAAACEtg");
	this.shape.setTransform(300.65,343.625);

	this.instance = new lib.MSFT_logo_sq();
	this.instance.setTransform(298.45,338.35,0.2981,0.2981,0,0,0,-39.9,1.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},13).to({state:[{t:this.instance}]},12).to({state:[]},1).wait(74));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:-0.1,regY:0.4,scaleX:2.408,scaleY:2.408,x:-12,y:7.9},41,cjs.Ease.quadInOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-217.8,-81,1036.9,849.3);
...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(117.7,218.5,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-9.2,-7.3,320,267.2), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x250_BAN_PowerPoint_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				for (var i = 0; i < exportRoot.headline5.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline5[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.5");
				}	
				for (var i = 0; i < exportRoot.headline6.length; i++) {
				...
				for (var i = 0; i < exportRoot.headline10.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline10[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.6");
				}
				...
				for (var i = 0; i < exportRoot.headline11.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline11[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.5");
				}
				for (var i = 0; i < exportRoot.headline12.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline12[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "-=0.1");
				}
				for (var i = 0; i < exportRoot.headline13.length; i++) {
				...
				for (var i = 0; i < exportRoot.headline14.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline14[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.6");
				}
				
				// any device
				for (var i = 0; i < exportRoot.headline15.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline15[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "-=0.1");
				}
				...
				for (var i = 0; i < exportRoot.headline15.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline15[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.5");
				}
				for (var i = 0; i < exportRoot.headline16.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline16[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "-=0.1");
				}
				for (var i = 0; i < exportRoot.headline17.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline17[i], 0.1, { alpha: 0, ease:Power4.easeOut, onComplete:function(){exportRoot.videoState="playing"; vid.play(); }}, "-=0.1");
				}
				
				//final frame
		
						for (var i = 0; i < exportRoot.headline22.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline22[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=13.1");
...
p.nominalBounds = new cjs.Rectangle(140.8,121,169,137);
// library properties:
lib.properties = {
