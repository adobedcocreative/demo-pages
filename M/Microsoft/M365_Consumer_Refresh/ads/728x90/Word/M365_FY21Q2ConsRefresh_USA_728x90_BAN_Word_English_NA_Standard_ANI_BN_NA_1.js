...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_728x90_BAN_Word_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
		...
		this.runBanner = function() {
			...
			//out
				...
				for (var i = 0; i < exportRoot.headline13.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline13[i], 0.8, { x: "+=150", alpha: 0, ease:Power4.easeOut}, "+=8.4");
