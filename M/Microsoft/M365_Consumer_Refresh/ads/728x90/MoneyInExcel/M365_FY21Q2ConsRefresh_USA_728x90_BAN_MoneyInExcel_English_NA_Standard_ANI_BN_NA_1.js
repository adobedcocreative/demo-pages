...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AnqB7IAAj1IPVAAIAAD1g");
	this.shape.setTransform(-54.65,2.175);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.7,-10.1,98.2,24.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(677.05,62.55,0.867,0.867,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(740.5,60.05,0.9849,0.9849,0,0,0,0.3,0.4);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,734.8,90.1), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_728x90_BAN_MoneyInExcel_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//out
				...
				for (var i = 0; i < exportRoot.headline7.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline7[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "-=0.1");
				}
				for (var i = 0; i < exportRoot.headline8.length; i++) {
			...
			//out
				...
				for (var i = 0; i < exportRoot.headline14.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline14[i], 0.8, { x: "+=150", alpha: 0, ease:Power4.easeOut}, "+=8.5");
...
p.nominalBounds = new cjs.Rectangle(364,45,368.4,45.099999999999994);
// library properties:
lib.properties = {
