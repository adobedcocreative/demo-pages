...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AmGBqIAAjSIMMAAIAADSg");
	this.shape.setTransform(-52.2287,2.5,1.0238,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-92.2,-8,80,21.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(714.65,2.55,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(674.2,62.35,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(744.8,59.45,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.4,-2.5,730.3000000000001,94.3), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_728x90_BAN_PowerPoint_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				for (var i = 0; i < exportRoot.headline16.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline16[i], 0.1, { alpha: 0, ease:Power4.easeOut, onComplete:function(){exportRoot.videoState="playing"; vid.play(); }}, "-=0.1");
				}
				for (var i = 0; i < exportRoot.headline17.length; i++) {
				...
				for (var i = 0; i < exportRoot.headline22.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline22[i], 0.8, { x: "+=150", alpha: 0, ease:Power4.easeOut}, "+=13.5");
...
p.nominalBounds = new cjs.Rectangle(364,45,364.29999999999995,45.099999999999994);
// library properties:
lib.properties = {
