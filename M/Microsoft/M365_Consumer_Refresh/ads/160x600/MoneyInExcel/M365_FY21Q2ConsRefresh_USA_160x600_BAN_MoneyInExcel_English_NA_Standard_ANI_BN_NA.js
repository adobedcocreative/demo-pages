...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_MoneyInExcel_English_NA_Standard_ANI_BN_NA = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//out
				for (var i = 0; i < exportRoot.headline2.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline2[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}
				for (var i = 0; i < exportRoot.headline3.length; i++) {
			...
			//out
				for (var i = 0; i < exportRoot.headline5.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline5[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}
				for (var i = 0; i < exportRoot.headline6.length; i++) {
			...
			// financial
				...
				for (var i = 0; i < exportRoot.headline8.length; i++) {
					...
					//out
						for (var i = 0; i < exportRoot.headline8.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline8[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}
			...
			// Get
				...
				for (var i = 0; i < exportRoot.headline11.length; i++) {
					...
					//out
				for (var i = 0; i < exportRoot.headline11.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline11[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}
			//  personalized
				...
				//out 
						for (var i = 0; i < exportRoot.headline12.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline12[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}
			// alerts
					...
					//out 
						for (var i = 0; i < exportRoot.headline13.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline13[i], 0.6, { alpha: 0, ease:Power4.easeOut, onStart:function(){exportRoot.videoState="playing"; vid.play(); }}, "+=0.4");
				}
				...
				for (var i = 0; i < exportRoot.headline14.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline14[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=7.5");
