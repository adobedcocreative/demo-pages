...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-13.5,169.29999999999998,627.6), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_PowerPoint_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(75.8,286.5,88.8,327.29999999999995);
// library properties:
lib.properties = {
