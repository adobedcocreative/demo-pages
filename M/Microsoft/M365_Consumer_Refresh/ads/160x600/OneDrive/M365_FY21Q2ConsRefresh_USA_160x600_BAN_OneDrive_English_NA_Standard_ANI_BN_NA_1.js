...
lib.ssMetadata = [
		{name:"M365_FY21Q2ConsRefresh_USA_160x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[1160,0,484,423],[0,0,1158,754]]}
];
...
(lib.mobileonly = function() {
	this.initialize(ss["M365_FY21Q2ConsRefresh_USA_160x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.4,regY:0.1,scaleX:3.4145,scaleY:3.4145,x:177.4,y:-923.65},41,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(143.6,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.screens.setTransform(-11,288.3,0.4279,0.4279,0,0,0,191.8,96.4);
	...
	this.txtCta.setTransform(102.7,570.6,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-13.5,286,627.6), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//Share Memories
				...
				this.tlText.from(mobile, 1, { alpha:0, x: "+=250", ease:Power4.easeOut}, "-=0.6");
				this.tlText.from(desktop, 1, { alpha:0, x: "+=250", ease:Power4.easeOut}, "-=0.85");
...
p.nominalBounds = new cjs.Rectangle(75.8,286.5,205.09999999999997,327.29999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2ConsRefresh_USA_160x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600342494789", id:"M365_FY21Q2ConsRefresh_USA_160x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
