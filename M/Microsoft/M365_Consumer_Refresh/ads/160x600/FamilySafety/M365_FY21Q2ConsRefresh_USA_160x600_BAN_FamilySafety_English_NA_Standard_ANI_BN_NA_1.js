...
lib.ssMetadata = [
		{name:"M365_FY21Q2ConsRefresh_USA_160x600_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,788,639]]}
];
...
(lib.FSTessellatedScreen = function() {
	this.initialize(ss["M365_FY21Q2ConsRefresh_USA_160x600_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
