...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[0,0,788,639]]}
];
...
(lib.FSTessellatedScreen11111111 = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.FSTessellatedScreen11111111();
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.7,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	this.cta_glare.setTransform(-70.5,-2.45,1,1,0,0,0,57.4,15.1);
	...
	this.shape.setTransform(-65.8,2.175);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-119,-10.1,106.4,24.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(281.8,469.25,0.7273,0.7273,0,0,0,393.9,319.7);
	...
	this.txtCta.setTransform(95.9,570.6,1,1,0,0,0,0.7,0.1);
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1613146191722", id:"M365_FY21Q3ConsOpt_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
