...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("An1CHIAAkNIPrAAIAAENg");
	this.shape.setTransform(-60.7826,0.5768,0.9791,1.0905);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.9,-14.1,98.30000000000001,29.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(236.9,558.4,1,1,0,0,0,0.7,0.1);
...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x600_BAN_MoneyInExcel_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
