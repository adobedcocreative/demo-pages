...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_300x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[0,0,788,639]]}
];
...
(lib.FSTessellatedScreen111111111 = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_300x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.FSTessellatedScreen111111111();
...
}).prototype = getMCSymbolPrototype(lib.screen, new cjs.Rectangle(0,0,394,319.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.3,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	this.cta_glare.setTransform(-76.15,-2.45,1,1,0,0,0,57.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_glare).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("ApOCSIAAkjISdAAIAAEjg");
	this.shape.setTransform(-70.75,2.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-129.8,-12.3,118.20000000000002,29.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(407.4,512.6,1,1,0,0,0,394,319.5);
	...
	this.txtCta.setTransform(227.8,558.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(314.5,555.65,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0.1,408.4,600.3), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_300x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				exportRoot.tlText.to([exportRoot.headline1, exportRoot.headline2], 0.05, {alpha: 0, ease:Power4.easeOut}, "+=.5");
				...
				this.tlText.from(mc.txtCta, 0.6, { x: "+=250", ease:Power4.easeOut, onComplete:function(){exportRoot.videoState="reset"}}, "-=0.6");
				this.tlText.from(mc.cta, 0.6, { x: "+=250", ease:Power4.easeOut}, "-=0.6");
...
p.nominalBounds = new cjs.Rectangle(149,300,257.1,300.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_300x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1613123004786", id:"M365_FY21Q3ConsOpt_USA_300x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
