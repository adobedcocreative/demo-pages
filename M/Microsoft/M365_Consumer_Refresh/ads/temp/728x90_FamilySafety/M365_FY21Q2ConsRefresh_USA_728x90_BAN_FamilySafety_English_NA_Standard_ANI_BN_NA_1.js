...
lib.ssMetadata = [
		{name:"M365_FY21Q2ConsRefresh_USA_728x90_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,788,639]]}
];
...
(lib.FSTessellatedScreen = function() {
	this.initialize(ss["M365_FY21Q2ConsRefresh_USA_728x90_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-21.8,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("ApzB/IAAj9ITnAAIAAD9g");
	this.shape.setTransform(-62.475,1.75);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-125.2,-11,125.5,25.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(660.7,61.15,0.867,0.867,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(731.9,58.65,0.9849,0.9849,0,0,0,0.3,0.4);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.4,-2.5,731.5,125), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_728x90_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,365.6,77.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2ConsRefresh_USA_728x90_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600854102885", id:"M365_FY21Q2ConsRefresh_USA_728x90_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
