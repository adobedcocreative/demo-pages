...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,102,153,0.8)").s().p("EgXbAvMMAAAheXMAu3AAAMAAABeXg");
	this.shape.setTransform(-150,2);
	this.shape._off = true;
...
p.nominalBounds = new cjs.Rectangle(-300,-300,300,604);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap2DUIAAmnITtAAIAAGng");
	this.shape.setTransform(-38.025,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-101.1,-21.3,126.19999999999999,42.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitCTA.setTransform(257.35,564.05,0.9015,1.0816,0,0,0,-66,0.1);
	...
	this.txtCta.setTransform(239.75,564.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(293,564.3,0.9433,0.9433,0,0,0,0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,316.9,604), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(151.9,304.4,165.9,281.1);
// library properties:
lib.properties = {
