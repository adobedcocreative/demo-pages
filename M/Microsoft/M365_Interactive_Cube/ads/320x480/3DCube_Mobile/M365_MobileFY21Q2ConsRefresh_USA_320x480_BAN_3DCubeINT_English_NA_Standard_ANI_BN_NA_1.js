...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("ApqDSIAAmkITVAAIAAGkg");
	this.shape.setTransform(-36.775,-0.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-98.6,-21.2,123.69999999999999,42.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitCTA.setTransform(269.1,444.3,0.7674,1.0838,0,0,0,-66,0);
	...
	this.txtCta.setTransform(257.7,444.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(311.4,444.5,0.9433,0.9433,0,0,0,0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,335,480), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_320x480_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(377.7,541.4,-41.80000000000001,-76);
// library properties:
lib.properties = {
