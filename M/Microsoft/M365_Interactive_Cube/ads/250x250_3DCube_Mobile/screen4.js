...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,206,516]]}
];
...
(lib.Productivity_Word_16x9_250x250_1_img = function() {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Productivity_Word_16x9_250x250_1_img();
...
if (reversed == null) { reversed = false; }
	...
	this.static4.setTransform(421,208,1,1,0,0,0,114,208);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1600694404882", id:"screen4_atlas_1"}
	],
	preloads: []
};
