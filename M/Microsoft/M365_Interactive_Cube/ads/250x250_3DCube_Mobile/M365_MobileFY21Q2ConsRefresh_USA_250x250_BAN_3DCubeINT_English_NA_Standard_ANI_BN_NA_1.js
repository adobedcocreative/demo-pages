...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.55,-0.5,0.7,0.7,0,0,0,13.5,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.hitCTA.setTransform(199.5,213.15,0.8259,1.2424,0,0,0,-66,0.1);
	...
	this.txtCta.setTransform(201.9,215.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(271.4,214.75,1.2189,1.2189,0,0,0,0.1,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,301.9,250), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(273.9,319.4,28.900000000000034,-18);
// library properties:
lib.properties = {
