...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap2CsIAAlXITtAAIAAFXg");
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-101.1,-18.4,126.19999999999999,34.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitCTA.setTransform(678.15,60.1,0.8174,0.8174,0,0,0,-65.9,0.1);
	...
	this.txtCta.setTransform(662.7,60.1,0.8701,0.8701,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(709.15,60.25,0.8207,0.8207,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_728x90_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364.9,46.4,368,28.199999999999996);
// library properties:
lib.properties = {
