...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-27.6,0.25,0.75,0.75,0,0,0,13.6,10.8);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hitCTA.setTransform(248.7,213.8,0.7992,1.2432,0,0,0,-66,0.1);
	...
	this.txtCta.setTransform(252.05,215.25,1.2856,1.2856,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(321.25,215.25,1.2127,1.2127,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,351.5,250), null);
