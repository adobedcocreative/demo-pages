...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,228,416]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("Egn/AjAMAAAhF/MBP/AAAMAAABF/g");
	this.shape.setTransform(256.0016,208.998,1.1186,1.067);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1600454846196", id:"screen2_atlas_1"}
	],
	preloads: []
};
