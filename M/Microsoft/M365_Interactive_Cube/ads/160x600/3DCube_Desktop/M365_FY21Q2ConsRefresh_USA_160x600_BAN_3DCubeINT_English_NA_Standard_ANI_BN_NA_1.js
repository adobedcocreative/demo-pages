...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hitCTA.setTransform(111.05,569.5,0.8356,0.8716,0,0,0,-66,0.1);
	...
	this.txtCta.setTransform(95.05,570.55,0.8803,0.8803,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(142.35,570.25,0.8304,0.8304,0,0,0,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,166.2,600), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(139,601.4,161.89999999999998,-17.399999999999977);
// library properties:
lib.properties = {
