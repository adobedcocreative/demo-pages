...
lib.ssMetadata = [
		{name:"screen4_atlas_", frames: [[0,0,256,608],[0,610,256,256]]}
];
...
(lib.static4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_.png?1601369339799", id:"screen4_atlas_"}
	],
	preloads: []
};
