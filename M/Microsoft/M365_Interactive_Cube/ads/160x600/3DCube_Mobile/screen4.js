...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib.Productivity_Word_16x9_160x600_1_img();
	...
	this.instance_2.setTransform(143.8,806.2,1,1,0,0,0,149.8,152.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.static4}]}).wait(1));
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("EgT/BTwMAAAinfMAn/AAAMAAACnfg");
	this.shape.setTransform(128,536);
...
p.nominalBounds = new cjs.Rectangle(128,512,129,560);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1600685827788", id:"screen4_atlas_1"}
	],
	preloads: []
};
