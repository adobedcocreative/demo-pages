...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap2CTIAAklITtAAIAAElg");
	this.shape.setTransform(-38.025,-0.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-101.1,-15.1,126.19999999999999,29.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitCTA.setTransform(263.85,569.7,1,0.7581,0,0,0,-66,0.1);
	...
	this.txtCta.setTransform(239.75,570.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(293,570.3,0.9433,0.9433,0,0,0,0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,329.9,604), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x600_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(151.9,304.4,178.9,280.6);
// library properties:
lib.properties = {
