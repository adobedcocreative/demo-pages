...
lib.ssMetadata = [
		{name:"screen4_atlas_", frames: [[0,0,600,462],[0,464,600,338]]}
];
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.static4.setTransform(258.1,163,0.9589,0.9589,0,0,0,287.5,162);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-31,-24,636.5,1174.7), null);
...
p.nominalBounds = new cjs.Rectangle(225,488,380.5,560);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_.png?1601374583418", id:"screen4_atlas_"}
	],
	preloads: []
};
