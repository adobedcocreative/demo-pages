...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("ApnDuIAAncITPAAIAAHcg");
	this.shape.setTransform(-50.6,-0.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-112.2,-24.5,123.2,47.7), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hitCTA.setTransform(108.75,564,0.7692,1.079,0,0,0,-65.8,0.1);
	...
	this.txtCta.setTransform(104.1,565,0.8803,0.8803,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(151.4,564.7,0.8304,0.8304,0,0,0,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,160.3,600), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_160x600_BAN_3DCubeINT_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(138.9,601.4,161.99999999999997,-16.299999999999955);
// library properties:
lib.properties = {
