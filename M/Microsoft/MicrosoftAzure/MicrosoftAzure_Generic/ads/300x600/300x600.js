...
lib.ssMetadata = [
		{name:"300x600_atlas_P_1", frames: [[0,0,150,150],[0,152,150,150],[0,304,150,150],[0,456,150,150],[0,608,150,150],[0,760,150,150],[152,0,150,150],[152,152,150,150],[152,304,150,150],[152,456,150,150],[152,608,150,150],[152,760,150,150],[304,0,150,150],[304,152,150,150],[304,304,150,150],[304,456,150,150]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.Text = new cjs.Text("Try Azure freeeee", "14px 'Segoe Pro Semibold'", "#FFFFFF");
	this.Text.name = "Text";
	this.Text.textAlign = "center";
	this.Text.lineHeight = 19;
	this.Text.lineWidth = 119;
	this.Text.parent = this;
	this.Text.setTransform(62.5,2);

	this.timeline.addTween(cjs.Tween.get(this.Text).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(1,0,123.1,22.9), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,143,20.8);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(137.2,34.45,1.4736,1.4736,0,0,0,11,10.5);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("ArPDDIAAmFIWfAAIAAGFg");
	this.shape.setTransform(72,19.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(0,0,144,39), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function loadData() {
			...
			var contentD = [
				{
					"name": "Generic",
					"description": "Explore Azure Cognitive Services|25",//"Manage your app with 12 months of free services including compute, storage, and database",//"Code, experiment, and build your next great web app",
	...
	this.Serverless.setTransform(212.15,552.3,0.3049,0.2986,38.2245,0,0,388.8,395.9);
	...
	this.StaticDataBrick.setTransform(154.95,495.9,0.2096,0.2093,0,0,0,610.6,450.8);

	this.DataBrick = new lib.DataBrick();
	this.DataBrick.name = "DataBrick";
	this.DataBrick.setTransform(155.25,495.95,0.2093,0.209,0,0,0,610.9,451.6);
	...
	this.Square.setTransform(155.55,433.4,0.2083,0.2083,0,0,0,602.6,144.2);
...
p.nominalBounds = new cjs.Rectangle(-491,71,1078.4,644.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_atlas_P_1.png?1599614209732", id:"300x600_atlas_P_1"}
	],
	preloads: []
};
