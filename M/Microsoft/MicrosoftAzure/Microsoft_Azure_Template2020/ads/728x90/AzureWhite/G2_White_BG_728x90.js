...
(lib.Cube_1_00200 = function() {
	this.initialize(ss["G2_White_BG_728x90_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(2.7256,-2.0443,0.1744,0.1744);
	...
	this.shape_6.setTransform(-1.4035,-2.101,0.1744,0.1744);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(3.4,-7.95,0.8596,0.8596,0,0,0,13.4,10.6);
	...
	this.cta_glare.setTransform(-50.35,-14.7,1,0.6457,0,0,0,57.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_glare).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AqgCTIAAklIVBAAIAAElg");
	this.shape.setTransform(-48.625,-7.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.9,-22.4,134.6,29.5), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(713.4,2.5,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(635.35,38.05,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(692.3,45.9,1,1,0,0,0,0.1,0.3);
	...
	this.boxAnim.setTransform(175.35,67.75,0.4447,0.4447,0,0,0,377.8,276);
...
// stage content:
(lib.G2_White_BG_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(364,45,361.20000000000005,363.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/G2_White_BG_728x90_atlas_.png?1591201809408", id:"G2_White_BG_728x90_atlas_"}
	],
	preloads: []
};
