...
(lib.Cube_1_00200 = function() {
	this.initialize(ss["G2_White_BG_300x250_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Tween7 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#333333").s().p("AgiBMQgbgQgLgfQgKgdALgeQALgdAbgRQAbgQAfAEQAfAFAWAXIgWAUQgOgPgVgDQgVgDgSALQgSALgHAUQgHATAGAUQAHAUASALQASALAUgCQAWgDAOgPIAWAVQgWAXggADIgMABQgYAAgVgOg");
	this.shape.setTransform(2.0202,-0.7048,0.8766,0.8766,135.0007);//adChange(#333333-#FFFFFF)

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgmgTIBNAAIgnAmg");
	this.shape_1.setTransform(-5.3,2.05);//adChange(#333333-#FFFFFF)
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-35.157,-7.857,0.1966,0.1966);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_1.setTransform(-42.5882,-7.857,0.1966,0.1966);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_2.setTransform(-35.157,-15.2882,0.1966,0.1966);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_3.setTransform(-42.5882,-15.2882,0.1966,0.1966);

	//Microsoft Logo Shape
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#78788A").s().p("");
	this.shape_4.setTransform(-3.475,-11.8);//adChange(#78787F-FFFFFF)

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#78787F").s().p("AhmB4QgngpAAhMQAAhHAqguQAqgvA/AAQBBAAAjAoQAkAnAABFIAAAiIjTAAQAFAvAZATQAZASAnAAQAbAAAXgIQAYgIASgNIAAA8QgTAMgdAHQgeAHggAAQhFAAgogqgAgohWQgUASgHAlICJAAQABgjgSgUQgQgTgfAAQgYAAgWATg");
	this.shape_5.setTransform(50.5829,-10.3574,0.1966,0.1966);//adChange(#78787F-FFFFFF)

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#78787F").s().p("AhZCdIAAk0IBJAAIAAAwIABAAQAKgZATgOQAVgPAcABQAJAAAGABIAMADIAABKQgFgEgMgEQgKgEgQAAQgbAAgTAXQgRAWAAAuIAACcg");
	this.shape_6.setTransform(45.9278,-10.4213,0.1966,0.1966);//adChange(#78787F-FFFFFF)

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#78787F").s().p("AhuB+QgcgdAAhCIAAi7IBKAAIAACzQAAAmAPAVQAQATAfAAQAeAAATgWQASgWAAgjIAAiyIBKAAIAAE1IhKAAIAAgpIgBAAQgOAVgYAMQgYAMgeAAQg2AAgcgfg");
	this.shape_7.setTransform(40.1127,-10.3279,0.1966,0.1966);//adChange(#78787F-FFFFFF)

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#78787F").s().p("AiBCbIAAgjICfjYIiTAAIAAg6ID2AAIAAAdIihDeICiAAIAAA6g");
	this.shape_8.setTransform(34.1795,-10.3672,0.1966,0.1966);//adChange(#78787F-FFFFFF)

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#78787F").s().p("AB6DYIgmhrIipAAIglBrIhSAAICjmvIBTAAICjGvgAhBAuICAAAIg/i1IgBAAg");
	this.shape_9.setTransform(27.0912,-11.5715,0.1966,0.1966);//adChange(#78787F-FFFFFF)

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-45.9,-18.6,99.3,14.100000000000001), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-58.15,0.6,0.8134,0.8134,0,0,0,13.3,10.6);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AvKCZIAAkxIeVAAIAAExg");
	this.shape.setTransform(-110.4605,0.25,0.6833,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-176.8,-15,132.70000000000002,30.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(70.2,169.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(193.05,170.35,1,1,0,0,0,0.1,0.2);
	...
	this.logo_1.setTransform(8.2,10.75,1.0853,1.0784,0,0,0,-53,-23.4);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","rgba(255,255,255,0)"],[0,0.631],-14.9,-20.8,-14.9,73.2).s().p("A5JS8MAAAgl2MAyTAAAMAAAAl2g");
	this.shape.setTransform(153.8,119.05);//adChange(#FFFFFF-#000000)(rgba(255,255,255,0) - rgba(255,255,255,0)rgba(0,0,0,0))
	...
	this.boxAnim.setTransform(244.3,232.6,0.5862,0.5863,0,0,0,377.7,276.4);

	this.timeline.addTween(cjs.Tween.get(this.boxAnim).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-7.2,-2.1,322,261.6), null);


// stage content:
(lib.G2_White_BG_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(142.8,122.9,172,285.79999999999995);
// library properties:
lib.properties = {
	...
	height: 250,
	fps: 40,
	color: "#FFFFFF", //adChange(#FFFFFF-#000000)
	opacity: 1.00,
	manifest: [
		{src:"images/G2_White_BG_300x250_atlas_.png?1591182632897", id:"G2_White_BG_300x250_atlas_"}
	],
	preloads: []
};
