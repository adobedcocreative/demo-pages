...
(lib.Cube_1_00200 = function() {
	this.initialize(ss["G2_White_BG_160x600_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-31.7681,-3.5181,0.2683,0.2683);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_1.setTransform(-41.9114,-3.5181,0.2683,0.2683);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_2.setTransform(-31.7681,-13.6614,0.2683,0.2683);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_3.setTransform(-41.9114,-13.6614,0.2683,0.2683);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#76767F").s().p("");
	this.shape_4.setTransform(-0.325,-13.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#76767F").s().p("AhmB4QgngpAAhMQAAhHAqguQAqgvA/AAQBBAAAjAoQAkAnAABFIAAAiIjTAAQAFAvAZATQAZASAnAAQAbAAAXgIQAYgIASgNIAAA8QgTAMgdAHQgeAHggAAQhFAAgogqgAgohWQgUASgHAlICJAAQABgjgSgUQgQgTgfAAQgYAAgWATg");
	this.shape_5.setTransform(2.7556,-2.0418,0.1745,0.1745);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#76767F").s().p("AhZCdIAAk0IBJAAIAAAwIABAAQAKgZATgOQAVgPAcABQAJAAAGABIAMADIAABKQgFgEgMgEQgKgEgQAAQgbAAgTAXQgRAWAAAuIAACcg");
	this.shape_6.setTransform(-1.375,-2.0985,0.1745,0.1745);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#76767F").s().p("AhuB+QgcgdAAhCIAAi7IBKAAIAACzQAAAmAPAVQAQATAfAAQAeAAATgWQASgWAAgjIAAiyIBKAAIAAE1IhKAAIAAgpIgBAAQgOAVgYAMQgYAMgeAAQg2AAgcgfg");
	this.shape_7.setTransform(-6.5349,-2.0156,0.1745,0.1745);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#76767F").s().p("AiBCbIAAgjICfjYIiTAAIAAg6ID2AAIAAAdIihDeICiAAIAAA6g");
	this.shape_8.setTransform(-11.7995,-2.0505,0.1745,0.1745);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#76767F").s().p("AB6DYIgmhrIipAAIglBrIhSAAICjmvIBTAAICjGvgAhBAuICAAAIg/i1IgBAAg");
	this.shape_9.setTransform(-18.0891,-3.1191,0.1745,0.1745);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-46.5,-18.2,67.5,19.3), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(2.5,0.05,0.8596,0.8596,0,0,0,13.4,10.6);
	...
	this.cta_glare.setTransform(-50.35,-1.65,1,1,0,0,0,57.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_glare).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AqBCWIAAkrIUDAAIAAErg");
	this.shape.setTransform(-41.73,-0.2318,0.9391,1.4636);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-102,-22.2,120.6,43.9), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(73.6,404.9,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(123.35,405.7,1,1,0,0,0,0.1,0.3);
	...
	this.logo_1.setTransform(14.8,14.95,1.0645,1.0577,0,0,0,-52.8,-23.3);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","rgba(255,255,255,0)"],[0,0.631],57.1,66,57.1,160).s().p("EgN5AggMAAAhA/IbzAAMAAAA2fIgIAAIAAKgg");
	this.shape.setTransform(79,290.025);
	...
	this.boxAnim.setTransform(99.95,568.3,0.6017,0.6017,0,0,0,377.5,276.2);

	this.timeline.addTween(cjs.Tween.get(this.boxAnim).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-10,5.3,178,590.7), null);


// stage content:
(lib.G2_White_BG_160x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(mc.boxAnim.cube7, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.5")
				exportRoot.tl1.from(mc.boxAnim.cube6, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")
				exportRoot.tl1.from(mc.boxAnim.cube5, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")
				exportRoot.tl1.from(mc.boxAnim.cube4, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")
				exportRoot.tl1.from(mc.boxAnim.cube3, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")
				exportRoot.tl1.from(mc.boxAnim.cube2, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")		
				exportRoot.tl1.from(mc.boxAnim.cube1, 2.5, { y:"-=450", ease:Elastic.easeInOut.config(0.65, 0.45)}, "-=2.4")
...
p.nominalBounds = new cjs.Rectangle(70,300,99.30000000000001,296);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/G2_White_BG_160x600_atlas_.png?1590402521190", id:"G2_White_BG_160x600_atlas_"}
	],
	preloads: []
};
