...
(lib.Cube_1_00200 = function() {
	this.initialize(ss["G2_Black_BG_160x600_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(2.7481,-2.0424,0.1745,0.1745);
	...
	this.shape_6.setTransform(-1.3821,-2.0991,0.1745,0.1745);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("ApaDbIAAm2IS1AAIAAG2g");
	this.shape.setTransform(-41.725,-0.25);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.631],57.1,66,57.1,160).s().p("EgN5AggMAAAhA/IbzAAMAAAA2fIgIAAIAAKgg");
	this.shape.setTransform(79,264.025);
...
// stage content:
(lib.G2_Black_BG_160x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/G2_Black_BG_160x600_atlas_.png?1590401713529", id:"G2_Black_BG_160x600_atlas_"}
	],
	preloads: []
};
