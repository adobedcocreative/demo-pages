...
(lib.Cube_1_00200 = function() {
	this.initialize(ss["G2_Black_BG_300x250_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-35.1578,-7.8578,0.1966,0.1966);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_1.setTransform(-42.5885,-7.8578,0.1966,0.1966);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_2.setTransform(-35.1578,-15.2885,0.1966,0.1966);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_3.setTransform(-42.5885,-15.2885,0.1966,0.1966);
	...
	this.shape_4.setTransform(-3.4936,-11.8028,0.1969,0.1969);
	...
	this.shape_5.setTransform(50.5605,-10.3593,0.1966,0.1966);
	...
	this.shape_6.setTransform(45.9064,-10.4232,0.1966,0.1966);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.631],-14.9,-20.8,-14.9,73.2).s().p("A5JS8MAAAgl2MAyTAAAMAAAAl2g");
	this.shape.setTransform(153.8,119.05);
...
// stage content:
(lib.G2_Black_BG_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/G2_Black_BG_300x250_atlas_.png?1591186921006", id:"G2_Black_BG_300x250_atlas_"}
	],
	preloads: []
};
