...
(lib._086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4Migration300x600F4 = function() {
	this.initialize(img._086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4Migration300x600F4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4Migration300x600F4();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.screen2, new cjs.Rectangle(0,0,600,1200), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(82).to({_off:false},0).to({scaleY:0.032,startPosition:13},13).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(69).to({_off:false},0).to({scaleY:1,startPosition:26},13,cjs.Ease.cubicOut).to({_off:true},1).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(56).to({_off:false},0).to({scaleY:0.032,startPosition:13},13).to({_off:true},1).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(43).to({_off:false},0).to({scaleY:1,startPosition:26},13,cjs.Ease.cubicOut).to({_off:true},1).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(30).to({_off:false},0).to({scaleY:0.032,startPosition:13},13).to({_off:true},1).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(17).to({_off:false},0).to({scaleY:1,startPosition:26},13,cjs.Ease.cubicOut).to({_off:true},1).wait(66));

	// tile1
	this.instance_7 = new lib.screen1Tile("single",0);
	this.instance_7.setTransform(150,250,1,1,0,0,0,150,250);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:320.1,regY:302.2,x:320.1,y:302.2,mode:"synched",loop:false},1).to({regY:302,scaleY:0.0187,startPosition:16},16).to({_off:true},1).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},82).wait(15));
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(156.2,578.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(208.75,576.25,1.1404,1.1404,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300.3,600), null);


// stage content:
(lib.Template_V4_Illustration_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.mainMC.setTransform(0,0.1,0.9993,1,0,0,0,0,0.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4Migration300x600F4.png?1606136332385", id:"_086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4Migration300x600F4"},
		{src:"images/_086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4MigrationF1.png?1606136332385", id:"_086E0069_FY21_AzureDirect_Creative_Refresh_BSV4_Illustration_MigrationV4MigrationF1"},
		{src:"images/Microsoftlogo_rgb_cgray1.png?1606136332385", id:"Microsoftlogo_rgb_cgray1"}
	],
	preloads: []
};
