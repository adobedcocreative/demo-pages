...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,400,266],[402,0,400,266],[0,268,400,266],[402,268,400,266],[0,536,400,266],[402,536,400,266],[0,804,400,266],[0,1258,264,153],[302,1238,265,154],[302,1072,275,164],[569,1238,265,154],[579,1072,275,164],[0,1072,300,184],[266,1394,264,153],[402,804,400,266],[804,0,120,111]]}
];
...
(lib.booking = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.screen_booking_blur = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.bookings_screen = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.screen_word.setTransform(378.35,-364.85,0.2,0.2,0,0,0,116.3,80.5);
	...
	this.screen_outlook.setTransform(410.15,-314.95,0.2,0.2,0,0,0,130.8,77.3);
...
// stage content:
(lib.O365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584615590708", id:"O365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
