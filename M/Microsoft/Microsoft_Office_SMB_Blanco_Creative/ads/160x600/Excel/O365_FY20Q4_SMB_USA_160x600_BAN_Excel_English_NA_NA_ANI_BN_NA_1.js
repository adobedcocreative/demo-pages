...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_icon = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.icon_teams = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.instance = new lib.teams_icon();
	this.instance.setTransform(-102.8,-72.85);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon_teams, new cjs.Rectangle(-102.8,-72.8,393,295), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-106.2,25.5,102.2,76.7), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-15.1,-13.5,296.3,627.6), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline9, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.3");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584450939666", id:"O365_FY20Q4_SMB_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
