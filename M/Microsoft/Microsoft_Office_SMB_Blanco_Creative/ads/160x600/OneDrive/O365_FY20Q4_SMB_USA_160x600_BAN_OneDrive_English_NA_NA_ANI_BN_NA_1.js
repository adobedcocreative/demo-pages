...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_iconpngcopy4 = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo_mc = function(mode,startPosition,loop) {
	...
	this.tile_sub.setTransform(-59.65,65.2,0.26,0.26,0,0,0,76.4,80);

	this.timeline.addTween(cjs.Tween.get(this.tile_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-106.4,25.8,102.2,76.7), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-15.1,-13.5,362.70000000000005,627.6), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(64.9,286.5,216.29999999999998,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584449817756", id:"O365_FY20Q4_SMB_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
