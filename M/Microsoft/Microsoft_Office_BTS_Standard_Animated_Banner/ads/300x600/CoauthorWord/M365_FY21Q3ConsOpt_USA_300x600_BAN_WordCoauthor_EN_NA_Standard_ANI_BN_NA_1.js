...
(lib.basicUI = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_300x600_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(319.75,549.7,1.2871,1.2871,0,0,0,0.2,0.4);
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_300x600_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.to(screen, 1.5, {x: "-=0"}, "+=0");
...
p.nominalBounds = new cjs.Rectangle(116.1,300,268.20000000000005,317.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_300x600_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1613667307583", id:"M365_FY21Q3ConsOpt_USA_300x600_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
