...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.ondrive = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.Powerpoint_screen = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-65.95,-83.2,0.8515,0.8515);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Powerpoint_screen, new cjs.Rectangle(-65.9,-83.2,681.1999999999999,452.2), null);
...
(lib.pointer = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.handpointercursor();
	this.instance.setTransform(0,6.85,0.1343,0.1343,-24.3287);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.pointer, new cjs.Rectangle(0,0,23.8,26), null);
...
(lib.pointeranimation = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(148.2,33.3,1,1,0,0,0,11.9,13);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-1.5,y:4.8,alpha:1},14,cjs.Ease.quadInOut).wait(35).to({alpha:0},10,cjs.Ease.quadInOut).wait(1));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CA4925").ss(1,1,1).p("AjCgcIExhkIBUChIkzBgQhWidAEAAg");
	this.shape.setTransform(-8.1339,-2.2);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(19).to({_off:false},0).wait(41));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28.6,-16.1,188.7,62.4);
...
(lib.onedrive = function(mode,startPosition,loop) {
	...
	// pointer
	this.pointer = new lib.pointeranimation();
	this.pointer.name = "pointer";
	this.pointer.setTransform(257.7,153.15,1,1,0,0,0,11.9,13);

	this.timeline.addTween(cjs.Tween.get(this.pointer).wait(1));

	// Layer_1
	this.instance = new lib.ondrive();
	this.instance.setTransform(0,0,0.5379,0.5379);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.onedrive, new cjs.Rectangle(0,0,430.3,285.7), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:949.5,y:74},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:-24.05,y:6.65},33,cjs.Ease.quadInOut).wait(1));
	...
	this.instance_2.setTransform(987.8,290.4,2.4491,0.8798,0,0,0,485.4,406.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(77).to({regY:406.9,scaleY:0.8724,y:287.5},0).to({alpha:0},21,cjs.Ease.quadIn).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-201.1,-67.5,2378.1,300.9);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.screen_powerpoint.setTransform(273.8,-131.55,0.061,0.061,0,0,0,316.3,140.1);
	this.screen_powerpoint.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.screen_powerpoint).wait(1));

	// OneDrive
	this.screen_onedrive = new lib.onedrive();
	this.screen_onedrive.name = "screen_onedrive";
	this.screen_onedrive.setTransform(258.4,-129.5,0.5891,0.5891,0,0,0,215.1,142.8);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(131.7,-213.6,253.5,168.3), null);
...
(lib.drop_menu = function(mode,startPosition,loop) {
	...
	// pointer
	this.pointer = new lib.pointercopy();
	this.pointer.name = "pointer";
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.screens.setTransform(253.35,213.5,1,1,0,0,0,284.2,24.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F5F5F5").s().p("AgEALIgCgBIgEgFQgCgEABgCQABgEAEgDIACgCIAIAAIACACQAFAEABAEQABACgDADIgEAFIgCABg");
	this.shape.setTransform(440.7071,622.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.screens}]}).wait(1));
	...
	this.replay_btn.setTransform(713.25,4.3,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.bg = new lib.bg();
	this.bg.name = "bg";
	this.bg.setTransform(364.4,45.55,2.4293,0.3643,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4,-24.9,810.5,648.3), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				for (var i = 0; i < exportRoot.headline1.length; i++) {
					if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "+=0.5");
					if (i!=0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
				exportRoot.tl1.from(mc.screens.screen_onedrive, 0.8, { x:"+=0", onStart:function(){exportRoot.tl1.stop();}}, "-=0");
				for (var i = 0; i < exportRoot.headline2.length; i++) {
					if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0");
					if (i!=0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=80", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		
				exportRoot.tl1.from(mc.screens.screen_onedrive, 2, { x:"+=0", onStart:function(){exportRoot.tl1.stop();}}, "-=1");
		...
		this.tlicons2 = new TimelineLite();
			
				
				
				exportRoot.tlicons.from(mc.screens, 1.4, {
					x: "+=80",
					alpha: 0,
					ease:Quart.easeOut, 
					onStart:function()
					...
					onComplete:function()
					{
						mc.screens.screen_onedrive.pointer.gotoAndPlay(1);
					}
				}, "+=0.5");
		
				
				
				exportRoot.tlicons2.to(mc.screens.screen_powerpoint, 1, { 
					x: "-=1",
					y: "-=36",
					scaleX:"0.234", 
					scaleY:"0.234", 
				...
				exportRoot.tlicons2.to(mc.screens.screen_onedrive, 1.4, 
				{
					x:"-=11.8", 
					y:"+=2.65", 
					scaleX:"0.368", 
				...
				exportRoot.tlicons2.to(mc.screens.screen_powerpoint, 1.4, {
					x:"+=0", 
		/*			y:"-=12.45", 
					scaleX:"0.467", 
					scaleY:"0.467", 
		*/			ease:Quart.easeOut,
				...
				//exportRoot.tlicons.from(mc.screens.screen_powerpoint.shad, 1.4, {alpha:60, x: "+=70",  y: "+=140",	ease:Quart.easeOut}, "-=1.4");
		
		
		
		exportRoot.tlicons.stop();
		exportRoot.tlicons2.stop();
...
p.nominalBounds = new cjs.Rectangle(360,20.1,446.5,603.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582915455081", id:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
