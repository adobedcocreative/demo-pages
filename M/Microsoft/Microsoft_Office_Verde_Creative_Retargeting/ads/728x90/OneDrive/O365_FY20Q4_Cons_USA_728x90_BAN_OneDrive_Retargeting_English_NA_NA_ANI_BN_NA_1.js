...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,741,268,215],[270,741,138,108],[0,376,560,363],[270,851,138,108],[410,741,138,108],[0,0,610,374],[550,741,120,111],[410,851,138,108]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-553.3,-210.8,0.064,0.064,0,0,0,220.2,196);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(184).to({_off:false},0).to({regX:220.5,regY:196.6,scaleX:0.4626,scaleY:0.4626,x:-744.7,y:-236.6},23,cjs.Ease.quadOut).wait(1));

	// Word Shadow
	this.instance_1 = new lib.Wordcopy();
	this.instance_1.setTransform(-553.3,-210.8,0.064,0.064,0,0,0,220.2,196);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(184).to({_off:false},0).to({regX:220.5,regY:196.6,scaleX:0.4626,scaleY:0.4626,x:-744.7,y:-236.6},23,cjs.Ease.quadOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-0.6,-0.9,153.4,102.80000000000001);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(16.4,204.5,153.4,43.400000000000006), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-7.7,806.5,480), null);


// stage content:
(lib.O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(364,37.3,442.5,435);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582637551410", id:"O365_FY20Q4_Cons_USA_728x90_BAN_OneDrive_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
