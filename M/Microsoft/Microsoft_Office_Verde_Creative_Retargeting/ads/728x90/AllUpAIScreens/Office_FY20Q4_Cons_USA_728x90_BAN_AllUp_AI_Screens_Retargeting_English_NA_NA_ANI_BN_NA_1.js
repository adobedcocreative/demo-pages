...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,186,264,153],[302,0,265,154],[569,0,265,154],[302,156,265,154],[0,0,300,184],[569,156,264,153]]}
];
...
(lib.Screen_Excel11 = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-7.7,806.5,198.89999999999998), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=2.6");
...
p.nominalBounds = new cjs.Rectangle(364,37.3,442.5,153.89999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582732814269", id:"Office_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
