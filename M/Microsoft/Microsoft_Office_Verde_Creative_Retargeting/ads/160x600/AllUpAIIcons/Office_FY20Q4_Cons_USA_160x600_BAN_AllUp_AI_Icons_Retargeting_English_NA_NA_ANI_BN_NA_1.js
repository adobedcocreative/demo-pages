...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,170,174,135],[0,0,210,168],[176,170,174,135],[212,0,174,135],[352,137,174,135],[388,0,174,135],[0,307,120,111],[352,274,174,135]]}
];
...
(lib.Excel_icon = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:24.8,y:835.45},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:-24.15,y:6.55},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhMtCYcMAAAkw3MCZbAAAMAAAEw3g");
	this.shape.setTransform(299.85,907.525);
	...
	this.instance_2.setTransform(299.45,910.45,3.2498,7.8002,0,0,0,150,124.9);
...
p.nominalBounds = new cjs.Rectangle(-191.1,-68,982,1954.3);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.icon_outlook.setTransform(305.8,49.85,0.5,0.5,0,0,0,220.5,196.7);
	...
	this.icon_onenote.setTransform(318.55,-109.45,0.5,0.5,0,0,0,220.5,196.6);
	...
	this.icon_powerpoint.setTransform(319.1,-29.8,0.5,0.5,0,0,0,220.5,196.7);
	...
	this.icon_excel.setTransform(233.85,-3.2,0.5,0.5,0,0,0,220.5,196.7);
	...
	this.icon_word.setTransform(236.85,-83.4,0.5,0.5,0,0,0,220.5,196.7);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(100.55,422.8,0.919,0.919,0,0,0,284,25.1);
	...
	this.replay_btn.setTransform(145.1,4.3,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(222,569.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(266.75,569.75,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.bg_1.name = "bg_1";
	this.bg_1.setTransform(150,301.5,1,2.4118,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-555.2,0,857.3000000000001,657.2), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut}, "+=1.7");
		...
		this.tlicons = new TimelineLite();
				...
				exportRoot.tlicons.from(mc.icons.icon_onenote, 3.7, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3.7");
				exportRoot.tlicons.from(mc.icons.icon_onenote.shad, 3.7, { y: "-=28",	ease:Quart.easeOut}, "-=3.7");
				...
				exportRoot.tlicons.from(mc.icons.icon_excel, 3, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_excel.shad, 3, { y: "-=28",	ease:Quart.easeOut}, "-=3");
				exportRoot.tlicons.from(mc.icons.icon_outlook, 2.7, { x: xIcon,  y: yIcon,	ease:Quart.easeOut}, "-=2.7");
				exportRoot.tlicons.from(mc.icons.icon_outlook.shad, 2.7, { y: "-=28",	ease:Quart.easeOut}, "-=2.7");
...
p.nominalBounds = new cjs.Rectangle(79,300,223.10000000000002,357.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582802155642", id:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_AI_Icons_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
