...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Menu = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.menu_text.cache(0,-10,150,90,1.6)
	}
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.screens.setTransform(254.4,214.9,1,1,0,0,0,284.2,24.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-28.7,-1.7,470.7,658.9000000000001), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		//mc.dropdown.visible=false
		
		this.runBanner = function() {
			//mc.dropdown.visible=true
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(mc.screens.screen_onedrive, 0.8, { alpha: 1}, "-=0");
...
p.nominalBounds = new cjs.Rectangle(51.3,298.3,390.7,358.90000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582914599795", id:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
