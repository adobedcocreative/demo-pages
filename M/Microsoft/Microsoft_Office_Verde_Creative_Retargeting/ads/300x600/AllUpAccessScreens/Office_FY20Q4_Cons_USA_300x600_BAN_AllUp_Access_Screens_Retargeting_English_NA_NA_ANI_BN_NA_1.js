...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.screens.setTransform(251.75,221.45,1,1,0,0,0,284.2,24.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-26.9,0,498.5,643.2), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				for (var i = 0; i < exportRoot.headline1.length; i++) {
					if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "+=200", alpha: 0, ease:Power4.easeOut}, "+=0.5");
				...
				for (var i = 0; i < exportRoot.headline2.length; i++) {
					if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "+=200", alpha: 0, ease:Power4.easeOut}, "-=0.5");
		...
		//		exportRoot.tl1.from(mc.cta, 0.7, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=1.8");
				exportRoot.tl1.from(mc.dropdown, 0.8, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=1.7");
				exportRoot.tl1.to(mc.dropdown, 0.1, {alpha: 1, ease:Power4.easeOut}, "-=1.7");
...
p.nominalBounds = new cjs.Rectangle(123.1,300,348.5,343.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582736613001", id:"Office_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
