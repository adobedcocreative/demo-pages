...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x600_BAN_Word_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_Word_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-35.55,y:-461.3},179).wait(1).to({regX:202.6,regY:224.9,x:-56.25,y:-438.3},0).wait(1).to({x:-59.15,y:-443.55},0).wait(1).to({x:-62.1,y:-448.9},0).wait(1).to({x:-65.1,y:-454.3},0).wait(1).to({x:-68.15,y:-459.85},0).wait(1).to({x:-71.25,y:-465.45},0).wait(1).to({x:-74.4,y:-471.2},0).wait(1).to({x:-77.65,y:-477.05},0).wait(1).to({x:-80.95,y:-483.05},0).wait(1).to({x:-84.35,y:-489.15},0).wait(1).to({x:-87.8,y:-495.4},0).wait(1).to({x:-91.3,y:-501.8},0).wait(1).to({x:-94.95,y:-508.35},0).wait(1).to({x:-98.65,y:-515.05},0).wait(1).to({x:-102.45,y:-521.95},0).wait(1).to({x:-106.35,y:-529},0).wait(1).to({x:-110.35,y:-536.25},0).wait(1).to({x:-114.45,y:-543.75},0).wait(1).to({x:-118.7,y:-551.45},0).wait(1).to({x:-123.1,y:-559.35},0).wait(1).to({x:-127.6,y:-567.5},0).wait(1).to({x:-132.25,y:-575.95},0).wait(1).to({x:-137.1,y:-584.7},0).wait(1).to({x:-142.05,y:-593.7},0).wait(1).to({x:-147.2,y:-603.05},0).wait(1).to({x:-152.6,y:-612.75},0).wait(1).to({x:-158.15,y:-622.8},0).wait(1).to({x:-163.9,y:-633.25},0).wait(1).to({x:-169.9,y:-644.15},0).wait(1).to({x:-176.15,y:-655.5},0).wait(1).to({x:-182.7,y:-667.3},0).wait(1).to({x:-189.5,y:-679.6},0).wait(1).to({x:-196.6,y:-692.5},0).wait(1).to({x:-204,y:-705.9},0).wait(1).to({x:-211.75,y:-719.95},0).wait(1).to({x:-219.85,y:-734.65},0).wait(1).to({x:-228.35,y:-749.95},0).wait(1).to({x:-237.15,y:-765.95},0).wait(1).to({regX:220.5,regY:196.8,x:-228.5,y:-810.75},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:161.85,y:-339.8},179).wait(1).to({regX:211.8,regY:224.3,x:150.4,y:-317.3},0).wait(1).to({x:147.55,y:-322.45},0).wait(1).to({x:144.65,y:-327.65},0).wait(1).to({x:141.7,y:-332.95},0).wait(1).to({x:138.7,y:-338.4},0).wait(1).to({x:135.65,y:-343.9},0).wait(1).to({x:132.5,y:-349.5},0).wait(1).to({x:129.35,y:-355.25},0).wait(1).to({x:126.1,y:-361.1},0).wait(1).to({x:122.75,y:-367.1},0).wait(1).to({x:119.35,y:-373.2},0).wait(1).to({x:115.9,y:-379.5},0).wait(1).to({x:112.35,y:-385.9},0).wait(1).to({x:108.7,y:-392.45},0).wait(1).to({x:104.95,y:-399.2},0).wait(1).to({x:101.1,y:-406.1},0).wait(1).to({x:97.2,y:-413.25},0).wait(1).to({x:93.1,y:-420.55},0).wait(1).to({x:88.95,y:-428.1},0).wait(1).to({x:84.65,y:-435.85},0).wait(1).to({x:80.2,y:-443.85},0).wait(1).to({x:75.6,y:-452.1},0).wait(1).to({x:70.9,y:-460.65},0).wait(1).to({x:66,y:-469.45},0).wait(1).to({x:60.9,y:-478.65},0).wait(1).to({x:55.65,y:-488.1},0).wait(1).to({x:50.2,y:-498},0).wait(1).to({x:44.5,y:-508.2},0).wait(1).to({x:38.6,y:-518.9},0).wait(1).to({x:32.45,y:-529.95},0).wait(1).to({x:26,y:-541.55},0).wait(1).to({x:19.3,y:-553.6},0).wait(1).to({x:12.35,y:-566.2},0).wait(1).to({x:5.05,y:-579.35},0).wait(1).to({x:-2.6,y:-593.1},0).wait(1).to({x:-10.55,y:-607.45},0).wait(1).to({x:-18.9,y:-622.5},0).wait(1).to({x:-27.55,y:-638.15},0).wait(1).to({regX:220.5,regY:196.8,x:-27.95,y:-682},0).to({_off:true},1).wait(1));
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_300x600_BAN_Word_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x600_BAN_Word_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582638624870", id:"O365_FY20Q4_Cons_USA_300x600_BAN_Word_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
