...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[741,516,268,215],[810,0,209,162],[810,164,209,162],[810,328,209,162],[741,733,209,162],[741,897,209,162],[0,0,808,514],[0,516,739,490],[0,1008,209,161]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.PPT_screen_300x600 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.Word = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(114,120.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word, new cjs.Rectangle(101.1,112.4,231.00000000000003,180.70000000000002), null);
...
(lib.Screen_Shadow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(28.1,-48.55,1.4999,1.4999,-0.7881);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen_Shadow, new cjs.Rectangle(28.1,-63.8,1118.4,750.0999999999999), null);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.PPT_screen_300x600();
	this.instance.setTransform(203.85,78.65,1,1,-0.8);
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.Powerpoint_300x600();
	this.instance.setTransform(114.1,120.5);
...
(lib.Teams = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(110,101);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:161.5,y:43.15},119).wait(1).to({regX:611.4,regY:330,x:188.9,y:10.75},0).wait(1).to({x:186.45,y:6.05},0).wait(1).to({x:183.95,y:1.25},0).wait(1).to({x:181.4,y:-3.6},0).wait(1).to({x:178.85,y:-8.5},0).wait(1).to({x:176.25,y:-13.45},0).wait(1).to({x:173.65,y:-18.4},0).wait(1).to({x:171.05,y:-23.45},0).wait(1).to({x:168.4,y:-28.45},0).wait(1).to({x:165.8,y:-33.5},0).wait(1).to({x:163.15,y:-38.5},0).wait(1).to({x:160.55,y:-43.5},0).wait(1).to({x:157.95,y:-48.4},0).wait(1).to({x:155.45,y:-53.3},0).wait(1).to({x:152.95,y:-58.05},0).wait(1).to({x:150.5,y:-62.75},0).wait(1).to({x:148.1,y:-67.3},0).wait(1).to({x:145.8,y:-71.75},0).wait(1).to({x:143.55,y:-76},0).wait(1).to({x:141.4,y:-80.1},0).wait(1).to({x:139.35,y:-84.05},0).wait(1).to({x:137.35,y:-87.85},0).wait(1).to({x:135.5,y:-91.45},0).wait(1).to({x:133.7,y:-94.9},0).wait(1).to({x:132,y:-98.15},0).wait(1).to({x:130.4,y:-101.2},0).wait(1).to({x:128.85,y:-104.1},0).wait(1).to({x:127.45,y:-106.85},0).wait(1).to({x:126.1,y:-109.4},0).wait(1).to({x:124.85,y:-111.8},0).wait(1).to({x:123.65,y:-114.05},0).wait(1).to({x:122.55,y:-116.2},0).wait(1).to({x:121.5,y:-118.15},0).wait(1).to({x:120.55,y:-120},0).wait(1).to({x:119.65,y:-121.7},0).wait(1).to({x:118.8,y:-123.3},0).wait(1).to({x:118.05,y:-124.8},0).wait(1).to({x:117.35,y:-126.15},0).wait(1).to({x:116.65,y:-127.45},0).wait(1).to({x:116.05,y:-128.6},0).wait(1).to({x:115.5,y:-129.7},0).wait(1).to({x:115,y:-130.65},0).wait(1).to({x:114.5,y:-131.55},0).wait(1).to({x:114.05,y:-132.4},0).wait(1).to({x:113.7,y:-133.15},0).wait(1).to({regX:581.6,regY:357.8,x:83.5,y:-106.05},0).wait(1).to({regX:611.4,regY:330,scaleX:0.9979,scaleY:0.9979,x:114.25,y:-134.25},0).wait(1).to({scaleX:0.9951,scaleY:0.9951,x:115.45,y:-134.9},0).wait(1).to({scaleX:0.9916,scaleY:0.9916,x:117,y:-135.6},0).wait(1).to({scaleX:0.9873,scaleY:0.9873,x:118.8,y:-136.5},0).wait(1).to({scaleX:0.9824,scaleY:0.9824,x:120.95,y:-137.55},0).wait(1).to({scaleX:0.9766,scaleY:0.9766,x:123.4,y:-138.75},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:126.25,y:-140.15},0).wait(1).to({scaleX:0.9627,scaleY:0.9627,x:129.4,y:-141.7},0).wait(1).to({scaleX:0.9544,scaleY:0.9544,x:132.95,y:-143.5},0).wait(1).to({scaleX:0.9454,scaleY:0.9454,x:136.85,y:-145.35},0).wait(1).to({scaleX:0.9355,scaleY:0.9355,x:141.1,y:-147.5},0).wait(1).to({scaleX:0.9249,scaleY:0.9249,x:145.7,y:-149.7},0).wait(1).to({scaleX:0.9135,scaleY:0.9135,x:150.6,y:-152.1},0).wait(1).to({scaleX:0.9015,scaleY:0.9015,x:155.8,y:-154.65},0).wait(1).to({scaleX:0.8889,scaleY:0.8889,x:161.25,y:-157.35},0).wait(1).to({scaleX:0.8758,scaleY:0.8758,x:166.8,y:-160.1},0).wait(1).to({scaleX:0.8625,scaleY:0.8625,x:172.55,y:-162.95},0).wait(1).to({scaleX:0.849,scaleY:0.849,x:178.4,y:-165.8},0).wait(1).to({scaleX:0.8355,scaleY:0.8355,x:184.2,y:-168.65},0).wait(1).to({scaleX:0.8222,scaleY:0.8222,x:189.95,y:-171.45},0).wait(1).to({scaleX:0.8091,scaleY:0.8091,x:195.55,y:-174.2},0).wait(1).to({scaleX:0.7965,scaleY:0.7965,x:201.05,y:-176.85},0).wait(1).to({scaleX:0.7843,scaleY:0.7843,x:206.3,y:-179.45},0).wait(1).to({scaleX:0.7728,scaleY:0.7728,x:211.25,y:-181.9},0).wait(1).to({scaleX:0.762,scaleY:0.762,x:215.9,y:-184.15},0).wait(1).to({scaleX:0.7518,scaleY:0.7518,x:220.3,y:-186.3},0).wait(1).to({scaleX:0.7424,scaleY:0.7424,x:224.35,y:-188.3},0).wait(1).to({scaleX:0.7337,scaleY:0.7337,x:228.1,y:-190.1},0).wait(1).to({scaleX:0.7258,scaleY:0.7258,x:231.5,y:-191.85},0).wait(1).to({scaleX:0.7186,scaleY:0.7186,x:234.55,y:-193.35},0).wait(1).to({scaleX:0.7122,scaleY:0.7122,x:237.35,y:-194.7},0).wait(1).to({scaleX:0.7064,scaleY:0.7064,x:239.85,y:-195.95},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:242.05,y:-197},0).wait(1).to({scaleX:0.6969,scaleY:0.6969,x:243.95,y:-197.95},0).wait(1).to({scaleX:0.6931,scaleY:0.6931,x:245.6,y:-198.75},0).wait(1).to({scaleX:0.6898,scaleY:0.6898,x:247,y:-199.4},0).wait(1).to({scaleX:0.6872,scaleY:0.6872,x:248.15,y:-200},0).wait(1).to({scaleX:0.6851,scaleY:0.6851,x:249.05,y:-200.45},0).wait(1).to({scaleX:0.6834,scaleY:0.6834,x:249.75,y:-200.75},0).wait(1).to({scaleX:0.6823,scaleY:0.6823,x:250.2,y:-201.05},0).wait(1).to({scaleX:0.6817,scaleY:0.6817,x:250.5,y:-201.15},0).wait(1).to({regX:581.7,regY:357.6,scaleX:0.6815,scaleY:0.6815,x:230.3,y:-182.3},0).wait(1));

	// Screen Shadow
	this.instance_3 = new lib.Screen_Shadow();
	this.instance_3.setTransform(504.5,592.55,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:161.5,y:43.15},119).wait(1).to({regX:587.3,regY:311.3,x:164.8,y:-7.95},0).wait(1).to({x:162.35,y:-12.65},0).wait(1).to({x:159.85,y:-17.45},0).wait(1).to({x:157.3,y:-22.3},0).wait(1).to({x:154.75,y:-27.2},0).wait(1).to({x:152.15,y:-32.15},0).wait(1).to({x:149.55,y:-37.1},0).wait(1).to({x:146.95,y:-42.15},0).wait(1).to({x:144.3,y:-47.15},0).wait(1).to({x:141.7,y:-52.2},0).wait(1).to({x:139.05,y:-57.2},0).wait(1).to({x:136.45,y:-62.2},0).wait(1).to({x:133.85,y:-67.1},0).wait(1).to({x:131.35,y:-72},0).wait(1).to({x:128.85,y:-76.75},0).wait(1).to({x:126.4,y:-81.45},0).wait(1).to({x:124,y:-86},0).wait(1).to({x:121.7,y:-90.45},0).wait(1).to({x:119.45,y:-94.7},0).wait(1).to({x:117.3,y:-98.8},0).wait(1).to({x:115.25,y:-102.75},0).wait(1).to({x:113.25,y:-106.55},0).wait(1).to({x:111.4,y:-110.15},0).wait(1).to({x:109.6,y:-113.6},0).wait(1).to({x:107.9,y:-116.85},0).wait(1).to({x:106.3,y:-119.9},0).wait(1).to({x:104.75,y:-122.8},0).wait(1).to({x:103.35,y:-125.55},0).wait(1).to({x:102,y:-128.1},0).wait(1).to({x:100.75,y:-130.5},0).wait(1).to({x:99.55,y:-132.75},0).wait(1).to({x:98.45,y:-134.9},0).wait(1).to({x:97.4,y:-136.85},0).wait(1).to({x:96.45,y:-138.7},0).wait(1).to({x:95.55,y:-140.4},0).wait(1).to({x:94.7,y:-142},0).wait(1).to({x:93.95,y:-143.5},0).wait(1).to({x:93.25,y:-144.85},0).wait(1).to({x:92.55,y:-146.15},0).wait(1).to({x:91.95,y:-147.3},0).wait(1).to({x:91.4,y:-148.4},0).wait(1).to({x:90.9,y:-149.35},0).wait(1).to({x:90.4,y:-150.25},0).wait(1).to({x:89.95,y:-151.1},0).wait(1).to({x:89.6,y:-151.85},0).wait(1).to({regX:581.6,regY:357.8,x:83.5,y:-106.05},0).wait(1).to({regX:587.3,regY:311.3,scaleX:0.9979,scaleY:0.9979,x:90.2,y:-152.9},0).wait(1).to({scaleX:0.9951,scaleY:0.9951,x:91.5,y:-153.5},0).wait(1).to({scaleX:0.9916,scaleY:0.9916,x:93.1,y:-154.15},0).wait(1).to({scaleX:0.9873,scaleY:0.9873,x:95,y:-154.95},0).wait(1).to({scaleX:0.9824,scaleY:0.9824,x:97.3,y:-155.95},0).wait(1).to({scaleX:0.9766,scaleY:0.9766,x:99.85,y:-157.05},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:102.85,y:-158.25},0).wait(1).to({scaleX:0.9627,scaleY:0.9627,x:106.2,y:-159.7},0).wait(1).to({scaleX:0.9544,scaleY:0.9544,x:109.95,y:-161.35},0).wait(1).to({scaleX:0.9454,scaleY:0.9454,x:114.1,y:-163.05},0).wait(1).to({scaleX:0.9355,scaleY:0.9355,x:118.6,y:-164.95},0).wait(1).to({scaleX:0.9249,scaleY:0.9249,x:123.4,y:-167},0).wait(1).to({scaleX:0.9135,scaleY:0.9135,x:128.6,y:-169.2},0).wait(1).to({scaleX:0.9015,scaleY:0.9015,x:134.05,y:-171.55},0).wait(1).to({scaleX:0.8889,scaleY:0.8889,x:139.8,y:-173.95},0).wait(1).to({scaleX:0.8758,scaleY:0.8758,x:145.7,y:-176.45},0).wait(1).to({scaleX:0.8625,scaleY:0.8625,x:151.8,y:-179.05},0).wait(1).to({scaleX:0.849,scaleY:0.849,x:157.95,y:-181.65},0).wait(1).to({scaleX:0.8355,scaleY:0.8355,x:164.1,y:-184.25},0).wait(1).to({scaleX:0.8222,scaleY:0.8222,x:170.15,y:-186.8},0).wait(1).to({scaleX:0.8091,scaleY:0.8091,x:176.05,y:-189.35},0).wait(1).to({scaleX:0.7965,scaleY:0.7965,x:181.85,y:-191.75},0).wait(1).to({scaleX:0.7843,scaleY:0.7843,x:187.4,y:-194.1},0).wait(1).to({scaleX:0.7728,scaleY:0.7728,x:192.6,y:-196.35},0).wait(1).to({scaleX:0.762,scaleY:0.762,x:197.55,y:-198.4},0).wait(1).to({scaleX:0.7518,scaleY:0.7518,x:202.2,y:-200.35},0).wait(1).to({scaleX:0.7424,scaleY:0.7424,x:206.45,y:-202.2},0).wait(1).to({scaleX:0.7337,scaleY:0.7337,x:210.4,y:-203.85},0).wait(1).to({scaleX:0.7258,scaleY:0.7258,x:214,y:-205.4},0).wait(1).to({scaleX:0.7186,scaleY:0.7186,x:217.25,y:-206.8},0).wait(1).to({scaleX:0.7122,scaleY:0.7122,x:220.2,y:-208},0).wait(1).to({scaleX:0.7064,scaleY:0.7064,x:222.8,y:-209.15},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:225.15,y:-210.15},0).wait(1).to({scaleX:0.6969,scaleY:0.6969,x:227.15,y:-210.95},0).wait(1).to({scaleX:0.6931,scaleY:0.6931,x:228.9,y:-211.7},0).wait(1).to({scaleX:0.6898,scaleY:0.6898,x:230.4,y:-212.3},0).wait(1).to({scaleX:0.6872,scaleY:0.6872,x:231.55,y:-212.85},0).wait(1).to({scaleX:0.6851,scaleY:0.6851,x:232.55,y:-213.25},0).wait(1).to({scaleX:0.6834,scaleY:0.6834,x:233.3,y:-213.55},0).wait(1).to({scaleX:0.6823,scaleY:0.6823,x:233.75,y:-213.8},0).wait(1).to({scaleX:0.6817,scaleY:0.6817,x:234.1,y:-213.9},0).wait(1).to({regX:581.7,regY:357.6,scaleX:0.6815,scaleY:0.6815,x:230.3,y:-182.3},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-470,-527.6,1539.4,1448.7);
...
(lib.Powerpoint = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(106.2,122.05);
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint, new cjs.Rectangle(76.7,113.5,254.60000000000002,219.89999999999998), null);
...
(lib.Outlook = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(112,119.5);
...
(lib.OneDrive = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(112,120);
...
(lib.Excel = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(127,134.4);
...
}).prototype = getMCSymbolPrototype(lib.Excel, new cjs.Rectangle(99,124.5,254.60000000000002,223.7), null);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-196.1,y:-785.4},179).wait(1).to({regX:211.8,regY:227.1,x:-207.6,y:-760.2},0).wait(1).to({x:-210.5,y:-765.45},0).wait(1).to({x:-213.45,y:-770.8},0).wait(1).to({x:-216.45,y:-776.2},0).wait(1).to({x:-219.5,y:-781.75},0).wait(1).to({x:-222.6,y:-787.35},0).wait(1).to({x:-225.75,y:-793.1},0).wait(1).to({x:-229,y:-798.95},0).wait(1).to({x:-232.3,y:-804.95},0).wait(1).to({x:-235.7,y:-811.05},0).wait(1).to({x:-239.15,y:-817.3},0).wait(1).to({x:-242.65,y:-823.7},0).wait(1).to({x:-246.3,y:-830.25},0).wait(1).to({x:-250,y:-836.95},0).wait(1).to({x:-253.8,y:-843.85},0).wait(1).to({x:-257.7,y:-850.9},0).wait(1).to({x:-261.7,y:-858.15},0).wait(1).to({x:-265.8,y:-865.65},0).wait(1).to({x:-270.05,y:-873.35},0).wait(1).to({x:-274.45,y:-881.25},0).wait(1).to({x:-278.95,y:-889.4},0).wait(1).to({x:-283.6,y:-897.85},0).wait(1).to({x:-288.45,y:-906.6},0).wait(1).to({x:-293.4,y:-915.6},0).wait(1).to({x:-298.55,y:-924.95},0).wait(1).to({x:-303.95,y:-934.65},0).wait(1).to({x:-309.5,y:-944.7},0).wait(1).to({x:-315.25,y:-955.15},0).wait(1).to({x:-321.25,y:-966.05},0).wait(1).to({x:-327.5,y:-977.4},0).wait(1).to({x:-334.05,y:-989.2},0).wait(1).to({x:-340.85,y:-1001.5},0).wait(1).to({x:-347.95,y:-1014.4},0).wait(1).to({x:-355.35,y:-1027.8},0).wait(1).to({x:-363.1,y:-1041.85},0).wait(1).to({x:-371.2,y:-1056.55},0).wait(1).to({x:-379.7,y:-1071.85},0).wait(1).to({x:-388.5,y:-1087.85},0).wait(1).to({regX:220.5,regY:196.8,x:-389.05,y:-1134.85},0).to({_off:true},1).wait(1));

	// Outlook
	this.instance_1 = new lib.Outlook();
	this.instance_1.setTransform(313.95,355.4,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-220,y:-597.2},179).wait(1).to({regX:211.8,regY:226.8,x:-231.5,y:-572.3},0).wait(1).to({x:-234.4,y:-577.55},0).wait(1).to({x:-237.35,y:-582.9},0).wait(1).to({x:-240.35,y:-588.3},0).wait(1).to({x:-243.4,y:-593.85},0).wait(1).to({x:-246.5,y:-599.45},0).wait(1).to({x:-249.65,y:-605.2},0).wait(1).to({x:-252.9,y:-611.05},0).wait(1).to({x:-256.2,y:-617.05},0).wait(1).to({x:-259.6,y:-623.15},0).wait(1).to({x:-263.05,y:-629.4},0).wait(1).to({x:-266.55,y:-635.8},0).wait(1).to({x:-270.2,y:-642.35},0).wait(1).to({x:-273.9,y:-649.05},0).wait(1).to({x:-277.7,y:-655.95},0).wait(1).to({x:-281.6,y:-663},0).wait(1).to({x:-285.6,y:-670.25},0).wait(1).to({x:-289.7,y:-677.75},0).wait(1).to({x:-293.95,y:-685.45},0).wait(1).to({x:-298.35,y:-693.35},0).wait(1).to({x:-302.85,y:-701.5},0).wait(1).to({x:-307.5,y:-709.95},0).wait(1).to({x:-312.35,y:-718.7},0).wait(1).to({x:-317.3,y:-727.7},0).wait(1).to({x:-322.45,y:-737.05},0).wait(1).to({x:-327.85,y:-746.75},0).wait(1).to({x:-333.4,y:-756.8},0).wait(1).to({x:-339.15,y:-767.25},0).wait(1).to({x:-345.15,y:-778.15},0).wait(1).to({x:-351.4,y:-789.5},0).wait(1).to({x:-357.95,y:-801.3},0).wait(1).to({x:-364.75,y:-813.6},0).wait(1).to({x:-371.85,y:-826.5},0).wait(1).to({x:-379.25,y:-839.9},0).wait(1).to({x:-387,y:-853.95},0).wait(1).to({x:-395.1,y:-868.65},0).wait(1).to({x:-403.6,y:-883.95},0).wait(1).to({x:-412.4,y:-899.95},0).wait(1).to({regX:220.5,regY:196.8,x:-412.95,y:-946.65},0).to({_off:true},1).wait(1));

	// Aimes
	this.instance_2 = new lib.Teams();
	this.instance_2.setTransform(511.6,312.75,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-38.6,y:-639.85},179).wait(1).to({regX:211.1,regY:207.6,x:-50.8,y:-634.15},0).wait(1).to({x:-53.7,y:-639.4},0).wait(1).to({x:-56.65,y:-644.75},0).wait(1).to({x:-59.65,y:-650.15},0).wait(1).to({x:-62.7,y:-655.7},0).wait(1).to({x:-65.8,y:-661.3},0).wait(1).to({x:-68.95,y:-667.05},0).wait(1).to({x:-72.2,y:-672.9},0).wait(1).to({x:-75.5,y:-678.9},0).wait(1).to({x:-78.9,y:-685},0).wait(1).to({x:-82.35,y:-691.25},0).wait(1).to({x:-85.85,y:-697.65},0).wait(1).to({x:-89.5,y:-704.2},0).wait(1).to({x:-93.2,y:-710.9},0).wait(1).to({x:-97,y:-717.8},0).wait(1).to({x:-100.9,y:-724.85},0).wait(1).to({x:-104.9,y:-732.1},0).wait(1).to({x:-109,y:-739.6},0).wait(1).to({x:-113.25,y:-747.3},0).wait(1).to({x:-117.65,y:-755.2},0).wait(1).to({x:-122.15,y:-763.35},0).wait(1).to({x:-126.8,y:-771.8},0).wait(1).to({x:-131.65,y:-780.55},0).wait(1).to({x:-136.6,y:-789.55},0).wait(1).to({x:-141.75,y:-798.9},0).wait(1).to({x:-147.15,y:-808.6},0).wait(1).to({x:-152.7,y:-818.65},0).wait(1).to({x:-158.45,y:-829.1},0).wait(1).to({x:-164.45,y:-840},0).wait(1).to({x:-170.7,y:-851.35},0).wait(1).to({x:-177.25,y:-863.15},0).wait(1).to({x:-184.05,y:-875.45},0).wait(1).to({x:-191.15,y:-888.35},0).wait(1).to({x:-198.55,y:-901.75},0).wait(1).to({x:-206.3,y:-915.8},0).wait(1).to({x:-214.4,y:-930.5},0).wait(1).to({x:-222.9,y:-945.8},0).wait(1).to({x:-231.7,y:-961.8},0).wait(1).to({regX:220.5,regY:196.8,x:-231.55,y:-989.3},0).to({_off:true},1).wait(1));

	// Word
	this.instance_3 = new lib.Powerpoint();
	this.instance_3.setTransform(498.4,491.3,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-35.55,y:-461.3},179).wait(1).to({regX:203.9,regY:227.7,x:-54.95,y:-435.5},0).wait(1).to({x:-57.85,y:-440.75},0).wait(1).to({x:-60.8,y:-446.1},0).wait(1).to({x:-63.8,y:-451.5},0).wait(1).to({x:-66.85,y:-457.05},0).wait(1).to({x:-69.95,y:-462.65},0).wait(1).to({x:-73.1,y:-468.4},0).wait(1).to({x:-76.35,y:-474.25},0).wait(1).to({x:-79.65,y:-480.25},0).wait(1).to({x:-83.05,y:-486.35},0).wait(1).to({x:-86.5,y:-492.6},0).wait(1).to({x:-90,y:-499},0).wait(1).to({x:-93.65,y:-505.55},0).wait(1).to({x:-97.35,y:-512.25},0).wait(1).to({x:-101.15,y:-519.15},0).wait(1).to({x:-105.05,y:-526.2},0).wait(1).to({x:-109.05,y:-533.45},0).wait(1).to({x:-113.15,y:-540.95},0).wait(1).to({x:-117.4,y:-548.65},0).wait(1).to({x:-121.8,y:-556.55},0).wait(1).to({x:-126.3,y:-564.7},0).wait(1).to({x:-130.95,y:-573.15},0).wait(1).to({x:-135.8,y:-581.9},0).wait(1).to({x:-140.75,y:-590.9},0).wait(1).to({x:-145.9,y:-600.25},0).wait(1).to({x:-151.3,y:-609.95},0).wait(1).to({x:-156.85,y:-620},0).wait(1).to({x:-162.6,y:-630.45},0).wait(1).to({x:-168.6,y:-641.35},0).wait(1).to({x:-174.85,y:-652.7},0).wait(1).to({x:-181.4,y:-664.5},0).wait(1).to({x:-188.2,y:-676.8},0).wait(1).to({x:-195.3,y:-689.7},0).wait(1).to({x:-202.7,y:-703.1},0).wait(1).to({x:-210.45,y:-717.15},0).wait(1).to({x:-218.55,y:-731.85},0).wait(1).to({x:-227.05,y:-747.15},0).wait(1).to({x:-235.85,y:-763.15},0).wait(1).to({regX:220.5,regY:196.8,x:-228.5,y:-810.75},0).to({_off:true},1).wait(1));

	// Excel
	this.instance_4 = new lib.Excel();
	this.instance_4.setTransform(677.9,412.35,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:143.95,y:-540.25},179).wait(1).to({regX:226.2,regY:241.3,x:146.85,y:-500.85},0).wait(1).to({x:143.95,y:-506.1},0).wait(1).to({x:141,y:-511.45},0).wait(1).to({x:138,y:-516.85},0).wait(1).to({x:134.95,y:-522.4},0).wait(1).to({x:131.85,y:-528},0).wait(1).to({x:128.7,y:-533.75},0).wait(1).to({x:125.45,y:-539.6},0).wait(1).to({x:122.15,y:-545.6},0).wait(1).to({x:118.75,y:-551.7},0).wait(1).to({x:115.3,y:-557.95},0).wait(1).to({x:111.8,y:-564.35},0).wait(1).to({x:108.15,y:-570.9},0).wait(1).to({x:104.45,y:-577.6},0).wait(1).to({x:100.65,y:-584.5},0).wait(1).to({x:96.75,y:-591.55},0).wait(1).to({x:92.75,y:-598.8},0).wait(1).to({x:88.65,y:-606.3},0).wait(1).to({x:84.4,y:-614},0).wait(1).to({x:80,y:-621.9},0).wait(1).to({x:75.5,y:-630.05},0).wait(1).to({x:70.85,y:-638.5},0).wait(1).to({x:66,y:-647.25},0).wait(1).to({x:61.05,y:-656.25},0).wait(1).to({x:55.9,y:-665.6},0).wait(1).to({x:50.5,y:-675.3},0).wait(1).to({x:44.95,y:-685.35},0).wait(1).to({x:39.2,y:-695.8},0).wait(1).to({x:33.2,y:-706.7},0).wait(1).to({x:26.95,y:-718.05},0).wait(1).to({x:20.4,y:-729.85},0).wait(1).to({x:13.6,y:-742.15},0).wait(1).to({x:6.5,y:-755.05},0).wait(1).to({x:-0.9,y:-768.45},0).wait(1).to({x:-8.65,y:-782.5},0).wait(1).to({x:-16.75,y:-797.2},0).wait(1).to({x:-25.25,y:-812.5},0).wait(1).to({x:-34.05,y:-828.5},0).wait(1).to({regX:220.5,regY:196.8,x:-49,y:-889.7},0).to({_off:true},1).wait(1));

	// PowerPoint
	this.instance_5 = new lib.Wordcopy2();
	this.instance_5.setTransform(698.85,608.5,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:161.85,y:-339.8},179).wait(1).to({regX:211,regY:228.8,x:149.6,y:-312.8},0).wait(1).to({x:146.75,y:-317.95},0).wait(1).to({x:143.85,y:-323.15},0).wait(1).to({x:140.9,y:-328.45},0).wait(1).to({x:137.9,y:-333.9},0).wait(1).to({x:134.85,y:-339.4},0).wait(1).to({x:131.7,y:-345},0).wait(1).to({x:128.55,y:-350.75},0).wait(1).to({x:125.3,y:-356.6},0).wait(1).to({x:121.95,y:-362.6},0).wait(1).to({x:118.55,y:-368.7},0).wait(1).to({x:115.1,y:-375},0).wait(1).to({x:111.55,y:-381.4},0).wait(1).to({x:107.9,y:-387.95},0).wait(1).to({x:104.15,y:-394.7},0).wait(1).to({x:100.3,y:-401.6},0).wait(1).to({x:96.4,y:-408.75},0).wait(1).to({x:92.3,y:-416.05},0).wait(1).to({x:88.15,y:-423.6},0).wait(1).to({x:83.85,y:-431.35},0).wait(1).to({x:79.4,y:-439.35},0).wait(1).to({x:74.8,y:-447.6},0).wait(1).to({x:70.1,y:-456.15},0).wait(1).to({x:65.2,y:-464.95},0).wait(1).to({x:60.1,y:-474.15},0).wait(1).to({x:54.85,y:-483.6},0).wait(1).to({x:49.4,y:-493.5},0).wait(1).to({x:43.7,y:-503.7},0).wait(1).to({x:37.8,y:-514.4},0).wait(1).to({x:31.65,y:-525.45},0).wait(1).to({x:25.2,y:-537.05},0).wait(1).to({x:18.5,y:-549.1},0).wait(1).to({x:11.55,y:-561.7},0).wait(1).to({x:4.25,y:-574.85},0).wait(1).to({x:-3.4,y:-588.6},0).wait(1).to({x:-11.35,y:-602.95},0).wait(1).to({x:-19.7,y:-618},0).wait(1).to({x:-28.35,y:-633.65},0).wait(1).to({regX:220.5,regY:196.8,x:-27.95,y:-682},0).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-548.9,-1211.6,1564.1,2069.6);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,987.9,1277.4), null);


// stage content:
(lib.O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,300,837.9,977.4000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582723955150", id:"O365_FY20Q4_Cons_USA_300x600_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
