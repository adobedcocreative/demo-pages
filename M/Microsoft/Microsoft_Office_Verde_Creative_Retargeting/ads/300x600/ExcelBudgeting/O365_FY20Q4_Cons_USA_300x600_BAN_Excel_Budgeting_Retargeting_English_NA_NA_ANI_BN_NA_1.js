...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[741,516,268,215],[811,0,209,162],[0,0,809,514],[811,164,209,162],[811,328,209,162],[741,733,209,162],[741,897,209,162],[0,516,739,490],[0,1008,209,161]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Excel_budget_screen_300x600 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
(lib.ScreenShadow111111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.Word = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(114.4,122.05);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word, new cjs.Rectangle(100.1,113.2,231.00000000000003,180.7), null);
...
(lib.Screen_Shadow = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.ScreenShadow111111();
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Excel_budget_screen_300x600();
	this.instance.setTransform(207.45,79.15,1,1,-0.8);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(516.15,691.5,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:196.7,x:-456.6,y:-894.2},179).to({regX:220.4,regY:196.8,x:-567.95,y:-1069.2},21).wait(13));

	// Outlook
	this.instance_1 = new lib.Outlook();
	this.instance_1.setTransform(485.9,929.6,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-486.85,y:-656},179).to({regX:220.4,x:-598.2,y:-831.05},21).wait(13));

	// Aimes
	this.instance_2 = new lib.Teams();
	this.instance_2.setTransform(736,875.65,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-257.3,y:-709.95},179).to({x:-368.6,y:-885},21).wait(13));

	// Powerpoint
	this.instance_3 = new lib.Powerpoint();
	this.instance_3.setTransform(719.3,1101.6,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:196.7,x:-253.45,y:-484.1},179).to({regX:220.4,regY:196.8,x:-364.8,y:-659.1},21).wait(13));

	// Excel
	this.instance_4 = new lib.Wordcopy2();
	this.instance_4.setTransform(974.75,1248.15,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:220.4,x:-1.65,y:-330.9},179).to({regX:220.5,regY:196.7,x:-112.35,y:-507.7},21).wait(13));

	// Word
	this.instance_5 = new lib.Excel();
	this.instance_5.setTransform(946.45,1001.65,1.2654,1.2654,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:196.7,x:-26.3,y:-584},179).to({regY:196.8,x:-137.6,y:-759},21).wait(13));

	// Word
	this.instance_6 = new lib.Word();
	this.instance_6.setTransform(-223.95,181,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(190).to({_off:false},0).to({regX:220.6,regY:196.6,scaleX:0.8571,scaleY:0.8571,x:-15.3,y:155.8},22,cjs.Ease.quadOut).wait(1));

	// Word Shadow
	this.instance_7 = new lib.Wordcopy();
	this.instance_7.setTransform(-223.95,181,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(190).to({_off:false},0).to({regX:220.6,regY:196.6,scaleX:0.8571,scaleY:0.8571,x:-15.3,y:155.8},22,cjs.Ease.quadOut).wait(1));

	// Screen
	this.instance_8 = new lib.Screen();
	this.instance_8.setTransform(938.5,1571.2,1.615,1.615,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regY:357.7,x:312.95,y:530.3},119,cjs.Ease.none).wait(1).to({regX:615.5,regY:330.5,x:363.75,y:480.65},0).wait(1).to({x:359.75,y:474.85},0).wait(1).to({x:355.7,y:469.05},0).wait(1).to({x:351.65,y:463.15},0).wait(1).to({x:347.55,y:457.25},0).wait(1).to({x:343.4,y:451.3},0).wait(1).to({x:339.3,y:445.35},0).wait(1).to({x:335.2,y:439.4},0).wait(1).to({x:331.05,y:433.45},0).wait(1).to({x:326.95,y:427.55},0).wait(1).to({x:322.9,y:421.65},0).wait(1).to({x:318.9,y:415.85},0).wait(1).to({x:314.9,y:410.1},0).wait(1).to({x:311,y:404.5},0).wait(1).to({x:307.15,y:398.95},0).wait(1).to({x:303.4,y:393.5},0).wait(1).to({x:299.7,y:388.2},0).wait(1).to({x:296.15,y:383.05},0).wait(1).to({x:292.65,y:378.05},0).wait(1).to({x:289.3,y:373.2},0).wait(1).to({x:286.05,y:368.5},0).wait(1).to({x:282.9,y:363.95},0).wait(1).to({x:279.9,y:359.6},0).wait(1).to({x:277,y:355.45},0).wait(1).to({x:274.25,y:351.45},0).wait(1).to({x:271.6,y:347.6},0).wait(1).to({x:269.05,y:343.95},0).wait(1).to({x:266.65,y:340.45},0).wait(1).to({x:264.35,y:337.15},0).wait(1).to({x:262.15,y:334},0).wait(1).to({x:260.1,y:331},0).wait(1).to({x:258.1,y:328.15},0).wait(1).to({x:256.25,y:325.45},0).wait(1).to({x:254.5,y:322.9},0).wait(1).to({x:252.8,y:320.5},0).wait(1).to({x:251.25,y:318.2},0).wait(1).to({x:249.75,y:316.1},0).wait(1).to({x:248.35,y:314.05},0).wait(1).to({x:247.05,y:312.15},0).wait(1).to({x:245.8,y:310.4},0).wait(1).to({x:244.65,y:308.7},0).wait(1).to({x:243.55,y:307.15},0).wait(1).to({x:242.55,y:305.7},0).wait(1).to({x:241.6,y:304.35},0).wait(1).to({x:240.75,y:303.1},0).wait(1).to({x:239.95,y:301.9},0).wait(1).to({x:239.2,y:300.8},0).wait(1).to({x:238.5,y:299.8},0).wait(1).to({x:237.85,y:298.9},0).wait(1).to({x:237.25,y:298.05},0).wait(1).to({regX:581.6,regY:357.7,x:181.95,y:341.2},0).wait(1).to({regX:615.5,regY:330.5,scaleX:1.6129,scaleY:1.6129,x:237.3,y:297},0).wait(1).to({scaleX:1.6098,scaleY:1.6098,x:238.2,y:296.65},0).wait(1).to({scaleX:1.6054,scaleY:1.6054,x:239.4,y:296.15},0).wait(1).to({scaleX:1.5996,scaleY:1.5996,x:241.05,y:295.45},0).wait(1).to({scaleX:1.5924,scaleY:1.5924,x:243.1,y:294.6},0).wait(1).to({scaleX:1.5836,scaleY:1.5836,x:245.55,y:293.55},0).wait(1).to({scaleX:1.573,scaleY:1.573,x:248.5,y:292.25},0).wait(1).to({scaleX:1.5605,scaleY:1.5605,x:252.05,y:290.8},0).wait(1).to({scaleX:1.5459,scaleY:1.5459,x:256.15,y:289},0).wait(1).to({scaleX:1.5291,scaleY:1.5291,x:260.85,y:287},0).wait(1).to({scaleX:1.51,scaleY:1.51,x:266.2,y:284.75},0).wait(1).to({scaleX:1.4887,scaleY:1.4887,x:272.2,y:282.2},0).wait(1).to({scaleX:1.4651,scaleY:1.4651,x:278.8,y:279.35},0).wait(1).to({scaleX:1.4395,scaleY:1.4395,x:286,y:276.3},0).wait(1).to({scaleX:1.4123,scaleY:1.4123,x:293.65,y:273.05},0).wait(1).to({scaleX:1.384,scaleY:1.384,x:301.55,y:269.7},0).wait(1).to({scaleX:1.3553,scaleY:1.3553,x:309.7,y:266.25},0).wait(1).to({scaleX:1.3267,scaleY:1.3267,x:317.7,y:262.9},0).wait(1).to({scaleX:1.2989,scaleY:1.2989,x:325.5,y:259.55},0).wait(1).to({scaleX:1.2724,scaleY:1.2724,x:332.95,y:256.35},0).wait(1).to({scaleX:1.2474,scaleY:1.2474,x:339.95,y:253.4},0).wait(1).to({scaleX:1.2242,scaleY:1.2242,x:346.45,y:250.65},0).wait(1).to({scaleX:1.2029,scaleY:1.2029,x:352.45,y:248.1},0).wait(1).to({scaleX:1.1834,scaleY:1.1834,x:357.95,y:245.75},0).wait(1).to({scaleX:1.1657,scaleY:1.1657,x:362.9,y:243.6},0).wait(1).to({scaleX:1.1498,scaleY:1.1498,x:367.35,y:241.75},0).wait(1).to({scaleX:1.1355,scaleY:1.1355,x:371.35,y:240},0).wait(1).to({scaleX:1.1226,scaleY:1.1226,x:374.95,y:238.55},0).wait(1).to({scaleX:1.1112,scaleY:1.1112,x:378.2,y:237.15},0).wait(1).to({scaleX:1.1011,scaleY:1.1011,x:381.05,y:235.95},0).wait(1).to({scaleX:1.0922,scaleY:1.0922,x:383.55,y:234.85},0).wait(1).to({scaleX:1.0843,scaleY:1.0843,x:385.75,y:233.9},0).wait(1).to({scaleX:1.0775,scaleY:1.0775,x:387.65,y:233.1},0).wait(1).to({scaleX:1.0717,scaleY:1.0717,x:389.25,y:232.45},0).wait(1).to({scaleX:1.0667,scaleY:1.0667,x:390.65,y:231.85},0).wait(1).to({scaleX:1.0626,scaleY:1.0626,x:391.85,y:231.35},0).wait(1).to({scaleX:1.0592,scaleY:1.0592,x:392.8,y:230.9},0).wait(1).to({scaleX:1.0565,scaleY:1.0565,x:393.55,y:230.65},0).wait(1).to({scaleX:1.0545,scaleY:1.0545,x:394.1,y:230.35},0).wait(1).to({scaleX:1.0531,scaleY:1.0531,x:394.5,y:230.2},0).wait(1).to({scaleX:1.0523,scaleY:1.0523,x:394.75,y:230.1},0).wait(1).to({regX:581.6,regY:357.8,scaleX:1.052,scaleY:1.052,x:359.15,y:258.7},0).wait(1));

	// Screen Shadow
	this.instance_9 = new lib.Screen_Shadow();
	this.instance_9.setTransform(938.5,1571.2,1.615,1.615,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regY:357.7,x:312.95,y:530.3},119,cjs.Ease.none).wait(1).to({regX:587.3,regY:314.3,x:318.2,y:454.5},0).wait(1).to({x:314.2,y:448.7},0).wait(1).to({x:310.15,y:442.9},0).wait(1).to({x:306.1,y:437},0).wait(1).to({x:302,y:431.1},0).wait(1).to({x:297.85,y:425.15},0).wait(1).to({x:293.75,y:419.2},0).wait(1).to({x:289.65,y:413.25},0).wait(1).to({x:285.5,y:407.3},0).wait(1).to({x:281.4,y:401.4},0).wait(1).to({x:277.35,y:395.5},0).wait(1).to({x:273.35,y:389.7},0).wait(1).to({x:269.35,y:383.95},0).wait(1).to({x:265.45,y:378.35},0).wait(1).to({x:261.6,y:372.8},0).wait(1).to({x:257.85,y:367.35},0).wait(1).to({x:254.15,y:362.05},0).wait(1).to({x:250.6,y:356.9},0).wait(1).to({x:247.1,y:351.9},0).wait(1).to({x:243.75,y:347.05},0).wait(1).to({x:240.5,y:342.35},0).wait(1).to({x:237.35,y:337.8},0).wait(1).to({x:234.35,y:333.45},0).wait(1).to({x:231.45,y:329.3},0).wait(1).to({x:228.7,y:325.3},0).wait(1).to({x:226.05,y:321.45},0).wait(1).to({x:223.5,y:317.8},0).wait(1).to({x:221.1,y:314.3},0).wait(1).to({x:218.8,y:311},0).wait(1).to({x:216.6,y:307.85},0).wait(1).to({x:214.55,y:304.85},0).wait(1).to({x:212.55,y:302},0).wait(1).to({x:210.7,y:299.3},0).wait(1).to({x:208.95,y:296.75},0).wait(1).to({x:207.25,y:294.35},0).wait(1).to({x:205.7,y:292.05},0).wait(1).to({x:204.2,y:289.95},0).wait(1).to({x:202.8,y:287.9},0).wait(1).to({x:201.5,y:286},0).wait(1).to({x:200.25,y:284.25},0).wait(1).to({x:199.1,y:282.55},0).wait(1).to({x:198,y:281},0).wait(1).to({x:197,y:279.55},0).wait(1).to({x:196.05,y:278.2},0).wait(1).to({x:195.2,y:276.95},0).wait(1).to({x:194.4,y:275.75},0).wait(1).to({x:193.65,y:274.65},0).wait(1).to({x:192.95,y:273.65},0).wait(1).to({x:192.3,y:272.75},0).wait(1).to({x:191.7,y:271.9},0).wait(1).to({regX:581.6,regY:357.7,x:181.95,y:341.2},0).wait(1).to({regX:587.3,regY:314.3,scaleX:1.6129,scaleY:1.6129,x:191.8,y:270.9},0).wait(1).to({scaleX:1.6098,scaleY:1.6098,x:192.8,y:270.55},0).wait(1).to({scaleX:1.6054,scaleY:1.6054,x:194.15,y:270.1},0).wait(1).to({scaleX:1.5996,scaleY:1.5996,x:195.9,y:269.5},0).wait(1).to({scaleX:1.5924,scaleY:1.5924,x:198.2,y:268.8},0).wait(1).to({scaleX:1.5836,scaleY:1.5836,x:200.9,y:267.85},0).wait(1).to({scaleX:1.573,scaleY:1.573,x:204.15,y:266.8},0).wait(1).to({scaleX:1.5605,scaleY:1.5605,x:208.05,y:265.5},0).wait(1).to({scaleX:1.5459,scaleY:1.5459,x:212.55,y:263.95},0).wait(1).to({scaleX:1.5291,scaleY:1.5291,x:217.75,y:262.25},0).wait(1).to({scaleX:1.51,scaleY:1.51,x:223.6,y:260.3},0).wait(1).to({scaleX:1.4887,scaleY:1.4887,x:230.2,y:258.1},0).wait(1).to({scaleX:1.4651,scaleY:1.4651,x:237.5,y:255.65},0).wait(1).to({scaleX:1.4395,scaleY:1.4395,x:245.45,y:253},0).wait(1).to({scaleX:1.4123,scaleY:1.4123,x:253.8,y:250.2},0).wait(1).to({scaleX:1.384,scaleY:1.384,x:262.55,y:247.3},0).wait(1).to({scaleX:1.3553,scaleY:1.3553,x:271.45,y:244.3},0).wait(1).to({scaleX:1.3267,scaleY:1.3267,x:280.3,y:241.4},0).wait(1).to({scaleX:1.2989,scaleY:1.2989,x:288.85,y:238.5},0).wait(1).to({scaleX:1.2724,scaleY:1.2724,x:297.05,y:235.75},0).wait(1).to({scaleX:1.2474,scaleY:1.2474,x:304.75,y:233.2},0).wait(1).to({scaleX:1.2242,scaleY:1.2242,x:311.95,y:230.8},0).wait(1).to({scaleX:1.2029,scaleY:1.2029,x:318.55,y:228.6},0).wait(1).to({scaleX:1.1834,scaleY:1.1834,x:324.55,y:226.6},0).wait(1).to({scaleX:1.1657,scaleY:1.1657,x:330.05,y:224.75},0).wait(1).to({scaleX:1.1498,scaleY:1.1498,x:334.9,y:223.15},0).wait(1).to({scaleX:1.1355,scaleY:1.1355,x:339.35,y:221.6},0).wait(1).to({scaleX:1.1226,scaleY:1.1226,x:343.3,y:220.35},0).wait(1).to({scaleX:1.1112,scaleY:1.1112,x:346.85,y:219.15},0).wait(1).to({scaleX:1.1011,scaleY:1.1011,x:350,y:218.1},0).wait(1).to({scaleX:1.0922,scaleY:1.0922,x:352.75,y:217.15},0).wait(1).to({scaleX:1.0843,scaleY:1.0843,x:355.15,y:216.35},0).wait(1).to({scaleX:1.0775,scaleY:1.0775,x:357.3,y:215.65},0).wait(1).to({scaleX:1.0717,scaleY:1.0717,x:359.05,y:215.1},0).wait(1).to({scaleX:1.0667,scaleY:1.0667,x:360.6,y:214.55},0).wait(1).to({scaleX:1.0626,scaleY:1.0626,x:361.9,y:214.1},0).wait(1).to({scaleX:1.0592,scaleY:1.0592,x:362.9,y:213.75},0).wait(1).to({scaleX:1.0565,scaleY:1.0565,x:363.75,y:213.5},0).wait(1).to({scaleX:1.0545,scaleY:1.0545,x:364.35,y:213.3},0).wait(1).to({scaleX:1.0531,scaleY:1.0531,x:364.8,y:213.15},0).wait(1).to({scaleX:1.0523,scaleY:1.0523,x:365.05,y:213.05},0).wait(1).to({regX:581.6,regY:357.8,scaleX:1.052,scaleY:1.052,x:359.15,y:258.7},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-770.1,-1166.6,2620.9,3273.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,1216.2,1337.9), null);


// stage content:
(lib.O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,300,1066.2,1037.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582805396808", id:"O365_FY20Q4_Cons_USA_300x600_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
