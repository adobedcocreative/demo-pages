...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow1111111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(100.1,113.15,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(100.1,113.2,231.00000000000003,180.7), null);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow1111111();
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Excel();
	this.instance.setTransform(98.75,112.35,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Excel_Shadow();
	this.instance_1.setTransform(200.4,227.15,0.95,0.95,0,0,0,134,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(73.1,112.4,256.70000000000005,216.9), null);
...
(lib.Excel_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(112,126.5,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(225.4,244.2,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(98,126.5,254.60000000000002,219.89999999999998), null);
...
p.nominalBounds = new cjs.Rectangle(-476.9,-1010,1286.9,1749.7);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582804891886", id:"O365_FY20Q4_Cons_USA_300x250_BAN_Excel_Budgeting_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
