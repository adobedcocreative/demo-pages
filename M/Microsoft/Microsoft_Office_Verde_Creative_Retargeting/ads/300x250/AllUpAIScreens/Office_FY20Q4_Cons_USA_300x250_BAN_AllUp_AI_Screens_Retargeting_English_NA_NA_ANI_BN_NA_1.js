...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,409,316,183],[693,198,328,195],[693,395,317,184],[362,0,329,196],[0,223,317,184],[693,0,329,196],[319,396,317,184],[362,198,329,196],[0,0,360,221],[638,581,316,183]]}
];
...
(lib.Screen_Excel111 = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.pointer2 = function(mode,startPosition,loop) {
	...
	this.pointerSub.setTransform(11.25,8.3,1,1,-3.4817,0,0,11.2,8.3);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(39).call(this.frame_39).wait(26).call(this.frame_65).wait(33).call(this.frame_98).wait(12));
...
(lib.menuChoice = function(mode,startPosition,loop) {
	...
	this.choice_text.setTransform(174.7,211.4,1,1,0,0,0,109.9,13.2);
...
(lib.drop_menu = function(mode,startPosition,loop) {
	...
	this.selectorBox.setTransform(138.35,114.6,1,1,0,0,0,175.2,90.5);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.screen_powerpoint.setTransform(256.25,31.95,0.44,0.44,0,0,0,201.7,141.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-13,415.8,320.9), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,112,265.8,195.89999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582555252584", id:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_AI_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
