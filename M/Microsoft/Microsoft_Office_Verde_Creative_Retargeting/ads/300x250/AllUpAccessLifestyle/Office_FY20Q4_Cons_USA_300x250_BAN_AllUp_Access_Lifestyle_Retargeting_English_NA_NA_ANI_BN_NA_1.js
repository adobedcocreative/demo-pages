...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Lifestyle_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,443,382],[790,0,149,310],[445,0,201,277],[648,0,140,338],[941,0,68,341],[445,279,120,111]]}
];
...
(lib.BG_300x250 = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Lifestyle_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.white_bg = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ar7T/MAAAgn9IX3AAMAAAAn9g");
	this.shape.setTransform(76.425,127.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.white_bg, new cjs.Rectangle(0,0,152.9,255.8), null);
...
}).prototype = getMCSymbolPrototype(lib.menu_text, new cjs.Rectangle(0,-0.8,141.5,85.3), null);
...
(lib.Man_02_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.Man_02();
	this.instance.setTransform(0,0,1.1465,1.1465);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Man_02_1, new cjs.Rectangle(0,0,78,391), null);
...
}).prototype = getMCSymbolPrototype(lib.Man_01_1, new cjs.Rectangle(0,0,160.5,387.5), null);
...
(lib.Lady_02_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.Lady_02_1, new cjs.Rectangle(0,0,230.5,317.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Lady_01_1, new cjs.Rectangle(0,0,170.8,355.4), null);
...
}).prototype = getMCSymbolPrototype(lib.CityBg, new cjs.Rectangle(0,0,507.9,438), null);
...
(lib.menuChoice = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(173.025,195.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Outline
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#292929").s().p("Aq4CYIAAkvIAGAAIVrAAIAAEvgAqyCSIVlAAIAAkgI1lAAg");
	this.shape_1.setTransform(123.075,195.625);
	...
	this.choice_text.setTransform(175.3,211.5,1,1,0,0,0,109.9,13.3);
	...
	this.txt2.parent = this;
	this.txt2.setTransform(54.45,183,0.6344,1.1224);

	this.timeline.addTween(cjs.Tween.get(this.txt2).wait(1));

	// bg
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AqzCVIAAkpIVoAAIAAEpg");
	this.shape_2.setTransform(123.05,195.625);
...
p.nominalBounds = new cjs.Rectangle(53.2,180.4,232,44.400000000000006);
...
(lib.Menu = function(mode,startPosition,loop) {
	...
	// Outline
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#292929").s().p("AKyG+IAAgBI1jAAIAAABIgGAAIAAt7IVvAAIAAN7gAqxG2IVjAAIAAkeI1jAAgAqxCRIVjAAIAAkeI1jAAgAqxiUIVjAAIAAkiI1jAAg");
	this.shape.setTransform(69.025,43.725);
	...
	this.menu_text.setTransform(82.15,59.5,1,1,0,0,0,70.5,42.5);
	...
	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AqxG6IAAtzIVjAAIAANzg");
	this.shape_1.setTransform(68.725,43.575);
...
p.nominalBounds = new cjs.Rectangle(-0.5,-0.8,153.6,102.3);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.l1.name = "l1";
	this.l1.setTransform(46.7,-77.3,1,1,0,0,0,85.4,177.7);

	this.timeline.addTween(cjs.Tween.get(this.l1).wait(1));

	// Lady_02
	this.l2 = new lib.Lady_02_1();
	this.l2.name = "l2";
	this.l2.setTransform(214.25,-57.25,1,1,0,0,0,115.2,158.8);
	...
	this.m1.name = "m1";
	this.m1.setTransform(131.4,-91,1,1,0,0,0,80.3,193.8);

	this.timeline.addTween(cjs.Tween.get(this.m1).wait(1));

	// Man_02
	this.m2 = new lib.Man_02_1();
	this.m2.name = "m2";
	this.m2.setTransform(324.65,-93.85,1,1,0,0,0,39,195.5);
	...
	this.bg.name = "bg";
	this.bg.setTransform(109.15,-118,1,1,0,0,0,254,219);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(-144.8,-337,508.40000000000003,439.7), null);
...
(lib.drop_menu = function(mode,startPosition,loop) {
	...
	this.pointer.setTransform(124.8,212.6,0.6379,0.6379,0,0,0,14.8,18.8);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Aq9CkIAAlHIV7AAIAAFHg");
	mask.setTransform(83.825,200.825);

	// Menu
	this.selectorBox = new lib.menuChoice();
	this.selectorBox.name = "selectorBox";
	this.selectorBox.setTransform(135.95,96.25,0.9989,0.9989,0,0,0,175.3,90.5);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("Aq8HhIAAvBIV5AAIAAPBg");
	mask_1.setTransform(83.75,139.025);

	// Menu copy
	this.menu = new lib.Menu();
	this.menu.name = "menu";
	this.menu.setTransform(14.3,186.3,1,1,0,0,0,-0.5,-0.7);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(14,186.1,140,38.400000000000006), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.dropdown.setTransform(141.8,18.25,1,1,0,0,0,0.1,0);
	...
	this.dropDownMenuBtn.setTransform(263.15,286.5,0.9238,1,0,0,0,116,81.5);
	...
	this.logo_1.setTransform(165.65,14.8,0.9568,0.9568,0,0,0,-52.6,-23.8);

	this.timeline.addTween(cjs.Tween.get(this.logo_1).wait(1));

	// whiteSquare
	this.whiteBg = new lib.white_bg();
	this.whiteBg.name = "whiteBg";
	this.whiteBg.setTransform(226.25,124.85,1,1,0,0,0,76.4,127.9);

	this.timeline.addTween(cjs.Tween.get(this.whiteBg).wait(1));

	// people
	this.people = new lib.laptop_anim();
	this.people.name = "people";
	this.people.setTransform(253.35,213.55,0.614,0.614,0,0,0,284.2,24.8);

	this.timeline.addTween(cjs.Tween.get(this.people).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-10,-8.6,397.4,315.3), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Lifestyle_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(140,116.4,247.39999999999998,190.29999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Lifestyle_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582909183178", id:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Lifestyle_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
