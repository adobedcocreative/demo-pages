...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.pointer2_subcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.pointer2_subcopy, new cjs.Rectangle(0,2.4,29.6,35), null);


(lib.pointer1_subcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.pointer1_subcopy, new cjs.Rectangle(0,0,29.6,37.4), null);
...
(lib.pointeranimation = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(92.45,16.2,1,1,0,0,0,11.9,13);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-1.5,y:4.8},14,cjs.Ease.quadInOut).wait(35).to({alpha:0},10,cjs.Ease.quadInOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-28.6,-16.1,133,45.3);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(65).call(this.frame_65).wait(33).call(this.frame_98).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:-28.3,y:1},33,cjs.Ease.quadInOut).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).wait(1).to({regX:-40,regY:1.4,scaleX:0.9589,scaleY:0.9589,x:298.35,y:338.25},0).wait(1).to({scaleX:1.5937,scaleY:1.5937,x:298.25,y:338.2},0).wait(1).to({scaleX:2.1799,scaleY:2.1799,x:298.2,y:338.1},0).wait(1).to({scaleX:2.7037,scaleY:2.7037,x:298.15,y:338.05},0).wait(1).to({scaleX:3.1601,scaleY:3.1601,x:298.1,y:338},0).wait(1).to({scaleX:3.5503,scaleY:3.5503,x:298.05,y:337.95},0).wait(1).to({scaleX:3.8789,scaleY:3.8789,x:298},0).wait(1).to({scaleX:4.1518,scaleY:4.1518,y:337.9},0).wait(1).to({scaleX:4.3753,scaleY:4.3753,x:297.95},0).wait(1).to({scaleX:4.5552,scaleY:4.5552},0).wait(1).to({scaleX:4.6966,scaleY:4.6966,x:297.9},0).wait(1).to({scaleX:4.8041,scaleY:4.8041,y:337.85},0).wait(1).to({scaleX:4.8816,scaleY:4.8816},0).wait(1).to({scaleX:4.9325,scaleY:4.9325,x:298.4,y:338.35},0).to({x:24.15},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));

	// white
	this.instance_2 = new lib.white();
	this.instance_2.setTransform(297.95,903.5,1,2.3867,0,0,0,485.4,406.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(75).to({scaleY:2.3668,y:895.45},0).to({alpha:0},21,cjs.Ease.quadIn).to({_off:true},3).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-187.4,-67.6,970.9,816.3000000000001);
...
(lib.Menu = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.menu_text.cache(0,-10,150,90,1.7)
	}
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.screen_powerpoint.setTransform(255.1,-73.2,0.1043,0.1043,0,0,0,335.2,144.3);
	...
	this.screen_onedrive.setTransform(231.3,-68.5,1,1,0,0,0,215.2,142.8);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(16.1,-211.3,430.29999999999995,285.70000000000005), null);
...
(lib.pointer2copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.pointerSub = new lib.pointer2_subcopy();
...
}).prototype = getMCSymbolPrototype(lib.pointer2copy, new cjs.Rectangle(-0.3,1.3,31.6,36.7), null);


(lib.pointer1copy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.pointerSub = new lib.pointer1_subcopy();
	this.pointerSub.name = "pointerSub";
...
}).prototype = getMCSymbolPrototype(lib.pointer1copy, new cjs.Rectangle(0,0,29.6,37.4), null);


(lib.pointercopy2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.instance = new lib.pointer1copy();
	this.instance.setTransform(14.8,18.7,1,1,0,0,0,14.8,18.7);

	this.instance_1 = new lib.pointer2copy();
...
(lib.drop_menu = function(mode,startPosition,loop) {
	...
	// pointer
	this.pointer = new lib.pointercopy2();
	this.pointer.name = "pointer";
	this.pointer.setTransform(124.8,229.6,0.6379,0.6379,0,0,0,14.8,18.8);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(16.4,204.5,152.7,37), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.dropdown.setTransform(-2.25,0);
	...
	this.dropDownMenuBtn.setTransform(129.75,286.5,1,1,0,0,0,116,81.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-14.7,-22.6,430.3,330.5), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.from(mc.replay_btn, 0.7, {alpha: 0, onStart:function(){exportRoot.isReplay = true;}}, "+=0.5");
			exportRoot.tl1.from(mc.dropdown.pointer, 1, {x: "+=50", y: "+=200", ease:Power4.easeOut}, "-=0.8");
			exportRoot.tl1.to(mc.dropdown.pointer, 1, {alpha:1, onStart:function(){mc.dropdown.pointer.gotoAndPlay(1);exportRoot.menuClick()}}, "+=0.2");
		...
		this.tlicons2 = new TimelineLite();
				...
				exportRoot.tlicons.from(mc.screens, 1.4, {x: "+=300", ease:Quart.easeOut, onComplete:function()
				{
				...
				exportRoot.tlicons2.to(mc.screens.screen_powerpoint, 1, {alpha :1,x: "+=14",y: "-=55",scaleX:"0.416", scaleY:"0.416", ease:Quart.easeOut}, "0");
				...
				exportRoot.tlicons2.to(mc.screens.screen_powerpoint, 1.4, {x:"+=63.35", y:"+=27.2", scaleX:"0.426", scaleY:"0.426", ease:Quart.easeOut},"-=1.4");
...
p.nominalBounds = new cjs.Rectangle(135.3,102.4,280.3,205.49999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582911665034", id:"Office_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
