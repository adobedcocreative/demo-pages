...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x250_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x250_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(99.9,112.3,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Powerpoint_Shadow();
	this.instance_1.setTransform(210,236.3,0.95,0.95,0,0,0,134.1,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(82.6,112.3,254.6,226.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(82.6,112.3,254.6,226.2), null);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(91.95,112.95,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(205.35,230.65,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(78,113,254.60000000000002,219.8), null);
...
p.nominalBounds = new cjs.Rectangle(-0.6,-0.9,152.2,102.80000000000001);
...
}).prototype = getMCSymbolPrototype(lib.drop_menu, new cjs.Rectangle(16.4,204.5,152.2,40), null);
...
p.nominalBounds = new cjs.Rectangle(-476.9,-1010,1293.9,1758.8);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_300x250_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x250_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_.png?1582633535182", id:"O365_FY20Q4_Cons_USA_300x250_BAN_PPT_Retargeting_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
