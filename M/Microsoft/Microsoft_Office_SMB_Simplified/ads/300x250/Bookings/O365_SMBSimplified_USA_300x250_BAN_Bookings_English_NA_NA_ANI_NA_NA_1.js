...
(lib.booking_mobile_laptop = function() {
	this.initialize(ss["O365_SMBSimplified_USA_300x250_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-48.0932,-1.225,0.8624,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-102.5,-17.5,108.9,32.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.logo_1.setTransform(49.85,23.1,1.1275,1.1275,0,0,0,0.4,0.8);
	...
	this.txtCta.setTransform(43.05,219.7,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(96.15,220.25,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.phone.name = "phone";
	this.phone.parent = this;
	this.phone.setTransform(164.25,193.65,0.6396,0.6396,0,0,0,36.4,66.8);
	...
	this.laptop.setTransform(253.45,213.85,0.6146,0.5408,0,0,0,284,24.7);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-19.9,0.1,526,256.59999999999997), null);


// stage content:
(lib.O365_SMBSimplified_USA_300x250_BAN_Bookings_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(cont3D, 1, {x:222, y:"+=40", z:-1100, ease:Power4.easeInOut}, "+=0.5");
...
p.nominalBounds = new cjs.Rectangle(130.1,125,376,131.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_300x250_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574945203084", id:"O365_SMBSimplified_USA_300x250_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
