...
(lib.basicUIhalf = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_728x90_BAN_InteractiveParent_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ribbon = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(88.7944,327.9037,0.7593,0.7252,0,-29.6753,-31.2351);
	this.shape._off = true;
...
(lib.Background_img = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(35.5,207.95);
...
(lib.option_btn_menu = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(146.2749,13.1817);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#505050").ss(1,2,0,3).p("AgggRIAgAjIAhgj");
	this.shape_1.setTransform(146.2749,13.8183);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hit_opts.setTransform(652.95,77,0.6329,0.7256,0,0,0,134.6,14.4);
	...
	this.hit3.setTransform(653.2,55.45,0.6329,0.7256,0,0,0,134.6,14.3);
	...
	this.hit2.setTransform(653.2,33.95,0.6329,0.7256,0,0,0,134.6,14.3);
	...
	this.hit1.setTransform(653.2,11.5,0.6329,0.7256,0,0,0,134.6,14.4);
	...
	this.popup_menu.setTransform(647.75,18.2,1,1,0,0,0,79.5,35.9);
	...
	this.opts.setTransform(702.75,81,1,1,0,0,0,134.5,14.3);
...
// stage content:
(lib.M365_FY21Q1_BTS_USA_728x90_BAN_InteractiveParent_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_728x90_BAN_InteractiveParent_English_NA_NA_ANI_BN_NA_1_atlas_.png?1593188272987", id:"M365_FY21Q1_BTS_USA_728x90_BAN_InteractiveParent_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
