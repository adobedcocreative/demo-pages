...
lib.ssMetadata = [
		{name:"M365_FY21Q1_BTS_USA_728x90_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_728x90_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(48).call(this.frame_48).wait(3));

	// mask copy (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_30 = new cjs.Graphics().p("AljJlICwgyIC6KHIivAzg");
	var mask_graphics_31 = new cjs.Graphics().p("AmlJjIKRi9IC6KIIqRC9g");
	var mask_graphics_32 = new cjs.Graphics().p("Ap6JiIQ6k4IC7KIIw6E3g");
	var mask_graphics_33 = new cjs.Graphics().p("As0JgIWvmjIC6KII2vGjg");
	var mask_graphics_34 = new cjs.Graphics().p("AvWJfIbyoAIC7KII7yH/g");
	var mask_graphics_35 = new cjs.Graphics().p("AxgJeMAgGgJQIC7KIMggGAJPg");
	var mask_graphics_36 = new cjs.Graphics().p("AzVJdMAjxgKSIC6KGMgjxAKTg");
	var mask_graphics_37 = new cjs.Graphics().p("A03JcMAm0gLKIC7KGMgm0ALMg");
	var mask_graphics_38 = new cjs.Graphics().p("A2HJcMApUgL5IC7KGMgpUAL6g");
	var mask_graphics_39 = new cjs.Graphics().p("A3HJbMArUgMeIC7KHMgrUAMfg");
	var mask_graphics_40 = new cjs.Graphics().p("A35JbMAs4gM7IC7KGMgs4AM8g");
	var mask_graphics_41 = new cjs.Graphics().p("A4eJaMAuDgNQIC6KHMguDANRg");
	var mask_graphics_42 = new cjs.Graphics().p("A45JaMAu4gNgIC7KHMgu4ANhg");
	var mask_graphics_43 = new cjs.Graphics().p("A5LJaMAvcgNqIC7KGMgvcANsg");
	var mask_graphics_44 = new cjs.Graphics().p("A5WJaMAvygNxIC7KHMgvyANxg");
	var mask_graphics_45 = new cjs.Graphics().p("A5bJaMAv9gN0IC6KHMgv9AN0g");
	var mask_graphics_46 = new cjs.Graphics().p("A5eJaMAwCgN1IC7KGMgwCAN2g");
	var mask_graphics_47 = new cjs.Graphics().p("A5eJkMAwCgN2IC7KHMgwCAN2g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(30).to({graphics:mask_graphics_30,x:-35.55,y:126.0707}).wait(1).to({graphics:mask_graphics_31,x:-27.4724,y:125.8826}).wait(1).to({graphics:mask_graphics_32,x:-4.9546,y:125.7162}).wait(1).to({graphics:mask_graphics_33,x:14.7513,y:125.5705}).wait(1).to({graphics:mask_graphics_34,x:31.833,y:125.4441}).wait(1).to({graphics:mask_graphics_35,x:46.4782,y:125.3357}).wait(1).to({graphics:mask_graphics_36,x:58.8747,y:125.2438}).wait(1).to({graphics:mask_graphics_37,x:69.21,y:125.1672}).wait(1).to({graphics:mask_graphics_38,x:77.6716,y:125.1045}).wait(1).to({graphics:mask_graphics_39,x:84.447,y:125.0543}).wait(1).to({graphics:mask_graphics_40,x:89.7236,y:125.0151}).wait(1).to({graphics:mask_graphics_41,x:93.6888,y:124.9857}).wait(1).to({graphics:mask_graphics_42,x:96.5299,y:124.9647}).wait(1).to({graphics:mask_graphics_43,x:98.4344,y:124.9505}).wait(1).to({graphics:mask_graphics_44,x:99.5896,y:124.9419}).wait(1).to({graphics:mask_graphics_45,x:100.1828,y:124.9375}).wait(1).to({graphics:mask_graphics_46,x:100.4014,y:124.9359}).wait(1).to({graphics:mask_graphics_47,x:93.3315,y:125.8957}).wait(4));

	// top_orange
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDE200").s().p("AsIj9IYRBGI3DG1g");
	this.shape.setTransform(42.7,217.225);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(30).to({_off:false},0).wait(21));

	// mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_30 = new cjs.Graphics().p("AljJTICwgyIC6KHIivAzg");
	var mask_1_graphics_31 = new cjs.Graphics().p("AmmJRIKSi9IC7KHIqSC+g");
	var mask_1_graphics_32 = new cjs.Graphics().p("Ap7JQIQ8k4IC7KHIw8E4g");
	var mask_1_graphics_33 = new cjs.Graphics().p("As2JOIWymjIC7KHI2yGkg");
	var mask_1_graphics_34 = new cjs.Graphics().p("AvXJNIb1oBIC6KHI71IBg");
	var mask_1_graphics_35 = new cjs.Graphics().p("AxiJMMAgLgJQIC6KGMggLAJRg");
	var mask_1_graphics_36 = new cjs.Graphics().p("AzYJLMAj2gKUIC7KHMgj2AKUg");
	var mask_1_graphics_37 = new cjs.Graphics().p("A05JKMAm5gLMIC6KGMgm5ALOg");
	var mask_1_graphics_38 = new cjs.Graphics().p("A2KJKMApagL7IC7KHMgpaAL7g");
	var mask_1_graphics_39 = new cjs.Graphics().p("A3KJJMAragMfIC7KGMgraAMhg");
	var mask_1_graphics_40 = new cjs.Graphics().p("A38JJMAs+gM9IC7KHMgs+AM9g");
	var mask_1_graphics_41 = new cjs.Graphics().p("A4hJIMAuJgNSIC6KHMguJANTg");
	var mask_1_graphics_42 = new cjs.Graphics().p("A48JIMAu/gNhIC6KGMgu/ANjg");
	var mask_1_graphics_43 = new cjs.Graphics().p("A5OJIMAvjgNsIC6KGMgvjANtg");
	var mask_1_graphics_44 = new cjs.Graphics().p("A5ZJIMAv5gNyIC6KGMgv5ANzg");
	var mask_1_graphics_45 = new cjs.Graphics().p("A5fJIMAwEgN2IC7KHMgwEAN2g");
	var mask_1_graphics_46 = new cjs.Graphics().p("A5hJIMAwIgN3IC7KGMgwIAN4g");
	var mask_1_graphics_47 = new cjs.Graphics().p("A5hJSMAwJgN3IC6KGMgwJAN4g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(30).to({graphics:mask_1_graphics_30,x:-35.55,y:124.2707}).wait(1).to({graphics:mask_1_graphics_31,x:-27.4155,y:124.0822}).wait(1).to({graphics:mask_1_graphics_32,x:-4.8473,y:123.9155}).wait(1).to({graphics:mask_1_graphics_33,x:14.9025,y:123.7695}).wait(1).to({graphics:mask_1_graphics_34,x:32.0224,y:123.6429}).wait(1).to({graphics:mask_1_graphics_35,x:46.7004,y:123.5343}).wait(1).to({graphics:mask_1_graphics_36,x:59.1246,y:123.4423}).wait(1).to({graphics:mask_1_graphics_37,x:69.483,y:123.3655}).wait(1).to({graphics:mask_1_graphics_38,x:77.9635,y:123.3027}).wait(1).to({graphics:mask_1_graphics_39,x:84.754,y:123.2524}).wait(1).to({graphics:mask_1_graphics_40,x:90.0424,y:123.2131}).wait(1).to({graphics:mask_1_graphics_41,x:94.0165,y:123.1837}).wait(1).to({graphics:mask_1_graphics_42,x:96.864,y:123.1626}).wait(1).to({graphics:mask_1_graphics_43,x:98.7728,y:123.1484}).wait(1).to({graphics:mask_1_graphics_44,x:99.9305,y:123.1398}).wait(1).to({graphics:mask_1_graphics_45,x:100.5251,y:123.1354}).wait(1).to({graphics:mask_1_graphics_46,x:100.7441,y:123.1338}).wait(1).to({graphics:mask_1_graphics_47,x:93.6589,y:124.0957}).wait(4));

	// top
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FEF000").s().p("A9tFfMA7bgVGIAAK8Mg5XAUTg");
	this.shape_1.setTransform(113.8088,172.2576,0.7756,0.7756,2.9141);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(30).to({_off:false},0).wait(21));

	// mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_14 = new cjs.Graphics().p("AOJUAIAkqhIAnACIglKhg");
	var mask_2_graphics_15 = new cjs.Graphics().p("AOHUAIAkqhIApACIglKhg");
	var mask_2_graphics_16 = new cjs.Graphics().p("AN6T/IAkqgIA2ACIglKhg");
	var mask_2_graphics_17 = new cjs.Graphics().p("ANWT+IAlqhIBZAEIglKhg");
	var mask_2_graphics_18 = new cjs.Graphics().p("AMQT7IAlqhICfAHIgkKhg");
	var mask_2_graphics_19 = new cjs.Graphics().p("AKeT1IAkqhIETANIglKhg");
	var mask_2_graphics_20 = new cjs.Graphics().p("AHzTtIAkqgIG/AUIglKhg");
	var mask_2_graphics_21 = new cjs.Graphics().p("AEETiIAlqhIKuAgIgkKhg");
	var mask_2_graphics_22 = new cjs.Graphics().p("Ag4TUIAkqhIPtAvIglKgg");
	var mask_2_graphics_23 = new cjs.Graphics().p("Am4TCIAkqgIVvBAIglKgg");
	var mask_2_graphics_24 = new cjs.Graphics().p("Ar2S0IAlqhIauBPIglKgg");
	var mask_2_graphics_25 = new cjs.Graphics().p("AvhSpIAlqgIeeBZIglKhg");
	var mask_2_graphics_26 = new cjs.Graphics().p("Aw3SiIAlqhMAhKABhIglKhg");
	var mask_2_graphics_27 = new cjs.Graphics().p("AxwSdIAkqhMAi9ABmIgkKhg");
	var mask_2_graphics_28 = new cjs.Graphics().p("AyTSaIAkqhMAkDABpIgkKhg");
	var mask_2_graphics_29 = new cjs.Graphics().p("AylSYIAkqhMAknABrIgkKhg");
	var mask_2_graphics_30 = new cjs.Graphics().p("AysSYIAlqhMAk0ABrIglKhg");
	var mask_2_graphics_31 = new cjs.Graphics().p("AytSWIAlqgMAk2ABrIglKhg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_2_graphics_14,x:97.9782,y:128.2}).wait(1).to({graphics:mask_2_graphics_15,x:97.9792,y:128.2004}).wait(1).to({graphics:mask_2_graphics_16,x:97.9863,y:128.2008}).wait(1).to({graphics:mask_2_graphics_17,x:98.0056,y:128.202}).wait(1).to({graphics:mask_2_graphics_18,x:98.0431,y:128.2043}).wait(1).to({graphics:mask_2_graphics_19,x:98.1049,y:128.208}).wait(1).to({graphics:mask_2_graphics_20,x:98.1972,y:128.2135}).wait(1).to({graphics:mask_2_graphics_21,x:98.3259,y:128.2209}).wait(1).to({graphics:mask_2_graphics_22,x:98.4973,y:128.2304}).wait(1).to({graphics:mask_2_graphics_23,x:98.7044,y:128.2415}).wait(1).to({graphics:mask_2_graphics_24,x:98.8758,y:128.2501}).wait(1).to({graphics:mask_2_graphics_25,x:98.634,y:128.2564}).wait(1).to({graphics:mask_2_graphics_26,x:90.2218,y:128.2608}).wait(1).to({graphics:mask_2_graphics_27,x:84.5828,y:128.2636}).wait(1).to({graphics:mask_2_graphics_28,x:81.1624,y:128.2653}).wait(1).to({graphics:mask_2_graphics_29,x:79.4059,y:128.2662}).wait(1).to({graphics:mask_2_graphics_30,x:78.7588,y:128.2665}).wait(1).to({graphics:mask_2_graphics_31,x:74.8761,y:128.15}).wait(20));

	// bot_orange
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FDE200").s().p("Ar9C5IWym3IBIH9g");
	this.shape_2.setTransform(106,215.875);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(14).to({_off:false},0).to({_off:true},35).wait(2));

	// mask copy 2 (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_14 = new cjs.Graphics().p("AOJUAIAkqhIAnACIglKhg");
	var mask_3_graphics_15 = new cjs.Graphics().p("AOHUAIAkqhIApACIglKhg");
	var mask_3_graphics_16 = new cjs.Graphics().p("AN6T/IAkqgIA2ACIglKhg");
	var mask_3_graphics_17 = new cjs.Graphics().p("ANWT+IAlqhIBZAEIglKhg");
	var mask_3_graphics_18 = new cjs.Graphics().p("AMQT7IAlqhICfAHIgkKhg");
	var mask_3_graphics_19 = new cjs.Graphics().p("AKeT1IAkqhIETANIglKhg");
	var mask_3_graphics_20 = new cjs.Graphics().p("AHzTtIAkqgIG/AUIglKhg");
	var mask_3_graphics_21 = new cjs.Graphics().p("AEETiIAlqhIKuAgIgkKhg");
	var mask_3_graphics_22 = new cjs.Graphics().p("Ag4TUIAkqhIPtAvIglKgg");
	var mask_3_graphics_23 = new cjs.Graphics().p("Am4TCIAkqgIVvBAIglKgg");
	var mask_3_graphics_24 = new cjs.Graphics().p("Ar2S0IAlqhIauBPIglKgg");
	var mask_3_graphics_25 = new cjs.Graphics().p("AvhSpIAlqgIeeBZIglKhg");
	var mask_3_graphics_26 = new cjs.Graphics().p("Aw3SiIAlqhMAhKABhIglKhg");
	var mask_3_graphics_27 = new cjs.Graphics().p("AxwSdIAkqhMAi9ABmIgkKhg");
	var mask_3_graphics_28 = new cjs.Graphics().p("AyTSaIAkqhMAkDABpIgkKhg");
	var mask_3_graphics_29 = new cjs.Graphics().p("AylSYIAkqhMAknABrIgkKhg");
	var mask_3_graphics_30 = new cjs.Graphics().p("AysSYIAlqhMAk0ABrIglKhg");
	var mask_3_graphics_31 = new cjs.Graphics().p("AytSWIAlqgMAk2ABrIglKhg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_3_graphics_14,x:97.9782,y:128.2}).wait(1).to({graphics:mask_3_graphics_15,x:97.9792,y:128.2004}).wait(1).to({graphics:mask_3_graphics_16,x:97.9863,y:128.2008}).wait(1).to({graphics:mask_3_graphics_17,x:98.0056,y:128.202}).wait(1).to({graphics:mask_3_graphics_18,x:98.0431,y:128.2043}).wait(1).to({graphics:mask_3_graphics_19,x:98.1049,y:128.208}).wait(1).to({graphics:mask_3_graphics_20,x:98.1972,y:128.2135}).wait(1).to({graphics:mask_3_graphics_21,x:98.3259,y:128.2209}).wait(1).to({graphics:mask_3_graphics_22,x:98.4973,y:128.2304}).wait(1).to({graphics:mask_3_graphics_23,x:98.7044,y:128.2415}).wait(1).to({graphics:mask_3_graphics_24,x:98.8758,y:128.2501}).wait(1).to({graphics:mask_3_graphics_25,x:98.634,y:128.2564}).wait(1).to({graphics:mask_3_graphics_26,x:90.2218,y:128.2608}).wait(1).to({graphics:mask_3_graphics_27,x:84.5828,y:128.2636}).wait(1).to({graphics:mask_3_graphics_28,x:81.1624,y:128.2653}).wait(1).to({graphics:mask_3_graphics_29,x:79.4059,y:128.2662}).wait(1).to({graphics:mask_3_graphics_30,x:78.7588,y:128.2665}).wait(1).to({graphics:mask_3_graphics_31,x:74.8761,y:128.15}).wait(20));

	// mid
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FEF000").s().p("Aw+j2MAg1gAOIBIH9MggvAAMg");
	this.shape_3.setTransform(182.85,241.3,1,1,0,0,0,109,24.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(14).to({_off:false},0).to({_off:true},35).wait(2));

	// mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AqlQtIHTiGIC6KDInUCHg");
	var mask_4_graphics_1 = new cjs.Graphics().p("AqlQtIOHkEIC6KDIuIEFg");
	var mask_4_graphics_2 = new cjs.Graphics().p("ArhQuIUJl0IC6KDI0JF0g");
	var mask_4_graphics_3 = new cjs.Graphics().p("AuKQuIZbnVIC6KDI5bHVg");
	var mask_4_graphics_4 = new cjs.Graphics().p("AwcQuId/oqIC6KEI9/Ipg");
	var mask_4_graphics_5 = new cjs.Graphics().p("AyZQuMAh6gJyIC5KDMgh6AJyg");
	var mask_4_graphics_6 = new cjs.Graphics().p("A0DQuMAlOgKvIC5KDMglOAKvg");
	var mask_4_graphics_7 = new cjs.Graphics().p("A1cQuMAoAgLiIC5KDMgoAALig");
	var mask_4_graphics_8 = new cjs.Graphics().p("A2kQuMAqQgMMIC5KEMgqQAMLg");
	var mask_4_graphics_9 = new cjs.Graphics().p("A3eQuMAsEgMtIC5KDMgsEAMtg");
	var mask_4_graphics_10 = new cjs.Graphics().p("A4MQuMAtfgNHIC6KDMgtfANHg");
	var mask_4_graphics_11 = new cjs.Graphics().p("A4uQuMAujgNbIC6KEMgujANag");
	var mask_4_graphics_12 = new cjs.Graphics().p("A5GQuMAvUgNpIC5KEMgvUANog");
	var mask_4_graphics_13 = new cjs.Graphics().p("A5WQuMAv0gNyIC5KDMgv0ANyg");
	var mask_4_graphics_14 = new cjs.Graphics().p("A5gQuMAwIgN4IC5KEMgwIAN3g");
	var mask_4_graphics_15 = new cjs.Graphics().p("A5lQuMAwSgN7IC5KEMgwSAN6g");
	var mask_4_graphics_16 = new cjs.Graphics().p("A5nQuMAwWgN8IC5KEMgwWAN7g");
	var mask_4_graphics_17 = new cjs.Graphics().p("A5nQtMAwWgN8IC5KEMgwWAN7g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:-67.8,y:171.2618}).wait(1).to({graphics:mask_4_graphics_1,x:-67.821,y:171.2728}).wait(1).to({graphics:mask_4_graphics_2,x:-61.9014,y:171.2821}).wait(1).to({graphics:mask_4_graphics_3,x:-45.0574,y:171.2904}).wait(1).to({graphics:mask_4_graphics_4,x:-30.4556,y:171.2975}).wait(1).to({graphics:mask_4_graphics_5,x:-17.936,y:171.3036}).wait(1).to({graphics:mask_4_graphics_6,x:-7.3384,y:171.3088}).wait(1).to({graphics:mask_4_graphics_7,x:1.4974,y:171.3131}).wait(1).to({graphics:mask_4_graphics_8,x:8.7315,y:171.3166}).wait(1).to({graphics:mask_4_graphics_9,x:14.5242,y:171.3194}).wait(1).to({graphics:mask_4_graphics_10,x:19.0355,y:171.3216}).wait(1).to({graphics:mask_4_graphics_11,x:22.4257,y:171.3233}).wait(1).to({graphics:mask_4_graphics_12,x:24.8549,y:171.3245}).wait(1).to({graphics:mask_4_graphics_13,x:26.4832,y:171.3253}).wait(1).to({graphics:mask_4_graphics_14,x:27.4709,y:171.3257}).wait(1).to({graphics:mask_4_graphics_15,x:27.9781,y:171.326}).wait(1).to({graphics:mask_4_graphics_16,x:28.165,y:171.3261}).wait(1).to({graphics:mask_4_graphics_17,x:28.591,y:171.2368}).wait(34));

	// bottom
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FEF000").s().p("Egm0AIAMBLqgbAIB/KJMhNpAb4g");
	this.shape_4.setTransform(-12.1639,275.5864,0.7756,0.7756,2.9141);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_4).to({_off:true},49).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-209.4,102.3,474.5,257.8);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(395,94,0.4306,0.3446,0,-28.3375,-17.0388);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(394.95,93.75,0.4305,0.4305,0,0,0,73,202.9);
	...
	this.txtCta.setTransform(673.6,60.65,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-40.4,-97.1,768.6999999999999,280.2), null);


// stage content:
(lib.M365_FY21Q1_BTS_USA_728x90_BAN_Editor_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.4, {scaleX: "0.438",scaleY: "0.351", x: "-=53",y: "+=18", ease:Power4.easeOut}, "-=0.5");
				exportRoot.tl1.to(shadow, 1.4, {scaleX: "0.438",scaleY: "0.438", x: "-=53",y: "+=18", ease:Power4.easeOut}, "-=1.4");
				...
				exportRoot.tl1.to(screen.popup.popup_shdw, 1.4, {x: "-=10",y: "+=10",alpha :0.25,ease:Power4.easeInOut}, "-=1.4");
				...
				exportRoot.tl1.to(screen.popup.popup_shdw, 1.4, {x: "+=10",y: "-=10",alpha :0,ease:Power4.easeInOut}, "-=1.4");
				exportRoot.tl1.to(pencil, 1.4, {rotation: 0,scaleX: "0.21",scaleY: "0.21", x: "+=70",y: "-=180",ease:Power4.easeInOut}, "-=1.4");
			
				exportRoot.tl1.to(screen, 1.2, {x: "-=124",y: "-=20",scaleX: "0.349",scaleY: "0.279", ease:Power4.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, {x: "-=124",y: "-=20",scaleX: "0.349",scaleY: "0.349", ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(323.6,-52.1,404.69999999999993,235.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_728x90_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1.png?1593017165538", id:"M365_FY21Q1_BTS_USA_728x90_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
