...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,220,120,111],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ScreenNoShadow1111111111 = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(98.8,112.05,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(98.5,112.1,231.3,183.00000000000003), null);
...
(lib.Screen_Shadow = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.ScreenShadow111();
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.ScreenNoShadow1111111111();
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Excel();
	this.instance.setTransform(98.2,112.35,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Excel_Shadow();
	this.instance_1.setTransform(185.25,213.55,0.95,0.95,0,0,0,134,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(58,111.5,271.2,204.2), null);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(90.25,113.8,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(203.65,231.5,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(76.3,113.8,254.59999999999997,219.89999999999998), null);
...
(lib.Excel_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(113.65,124.5,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.Powerpoint_Shadow();
	this.instance_1.setTransform(223.75,248.5,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(96.4,124.5,254.6,226.2), null);
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-68.55,y:-461.3},149).wait(1).to({regX:203.5,regY:223.7,x:-88.45,y:-439.45},0).wait(1).to({x:-91.4,y:-444.6},0).wait(1).to({x:-94.35,y:-449.75},0).wait(1).to({x:-97.35,y:-454.95},0).wait(1).to({x:-100.35,y:-460.15},0).wait(1).to({x:-103.4,y:-465.45},0).wait(1).to({x:-106.45,y:-470.75},0).wait(1).to({x:-109.55,y:-476.15},0).wait(1).to({x:-112.7,y:-481.55},0).wait(1).to({x:-115.85,y:-487.05},0).wait(1).to({x:-119.05,y:-492.6},0).wait(1).to({x:-122.3,y:-498.25},0).wait(1).to({x:-125.55,y:-503.95},0).wait(1).to({x:-128.9,y:-509.7},0).wait(1).to({x:-132.25,y:-515.6},0).wait(1).to({x:-135.7,y:-521.55},0).wait(1).to({x:-139.2,y:-527.6},0).wait(1).to({x:-142.75,y:-533.75},0).wait(1).to({x:-146.35,y:-540.05},0).wait(1).to({x:-150.05,y:-546.45},0).wait(1).to({x:-153.8,y:-553},0).wait(1).to({x:-157.65,y:-559.7},0).wait(1).to({x:-161.6,y:-566.55},0).wait(1).to({x:-165.6,y:-573.55},0).wait(1).to({x:-169.75,y:-580.75},0).wait(1).to({x:-174,y:-588.15},0).wait(1).to({x:-178.4,y:-595.75},0).wait(1).to({x:-182.9,y:-603.6},0).wait(1).to({x:-187.55,y:-611.65},0).wait(1).to({x:-192.4,y:-620.05},0).wait(1).to({x:-197.35,y:-628.7},0).wait(1).to({x:-202.55,y:-637.7},0).wait(1).to({x:-207.9,y:-647},0).wait(1).to({x:-213.5,y:-656.7},0).wait(1).to({x:-219.3,y:-666.85},0).wait(1).to({x:-225.4,y:-677.4},0).wait(1).to({x:-231.75,y:-688.45},0).wait(1).to({x:-238.4,y:-700},0).wait(1).to({x:-245.4,y:-712.15},0).wait(1).to({x:-252.75,y:-724.9},0).wait(1).to({x:-260.45,y:-738.35},0).wait(1).to({x:-268.6,y:-752.5},0).wait(1).to({x:-277.2,y:-767.45},0).wait(1).to({x:-286.3,y:-783.25},0).wait(1).to({x:-295.9,y:-799.95},0).wait(1).to({x:-306.1,y:-817.6},0).wait(1).to({x:-316.85,y:-836.3},0).wait(1).to({x:-328.25,y:-856.1},0).wait(1).to({x:-340.3,y:-877.05},0).wait(1).to({regX:220.5,regY:196.8,x:-336.05,y:-926.1},0).to({_off:true},1).wait(1));

	// Excel
	this.instance_4 = new lib.Wordcopy2();
	this.instance_4.setTransform(700.25,607.15,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:130.5,y:-340.3},149).wait(1).to({regX:193.6,regY:213.6,x:100.7,y:-328.6},0).wait(1).to({x:97.75,y:-333.7},0).wait(1).to({x:94.8,y:-338.9},0).wait(1).to({x:91.8,y:-344.1},0).wait(1).to({x:88.8,y:-349.35},0).wait(1).to({x:85.75,y:-354.6},0).wait(1).to({x:82.7,y:-359.95},0).wait(1).to({x:79.6,y:-365.35},0).wait(1).to({x:76.5,y:-370.8},0).wait(1).to({x:73.35,y:-376.3},0).wait(1).to({x:70.15,y:-381.9},0).wait(1).to({x:66.9,y:-387.5},0).wait(1).to({x:63.65,y:-393.25},0).wait(1).to({x:60.35,y:-399.05},0).wait(1).to({x:56.95,y:-404.9},0).wait(1).to({x:53.55,y:-410.9},0).wait(1).to({x:50.05,y:-416.95},0).wait(1).to({x:46.5,y:-423.15},0).wait(1).to({x:42.9,y:-429.45},0).wait(1).to({x:39.2,y:-435.85},0).wait(1).to({x:35.45,y:-442.45},0).wait(1).to({x:31.6,y:-449.15},0).wait(1).to({x:27.7,y:-456},0).wait(1).to({x:23.65,y:-463.05},0).wait(1).to({x:19.5,y:-470.25},0).wait(1).to({x:15.25,y:-477.65},0).wait(1).to({x:10.9,y:-485.3},0).wait(1).to({x:6.4,y:-493.15},0).wait(1).to({x:1.75,y:-501.25},0).wait(1).to({x:-3.05,y:-509.65},0).wait(1).to({x:-8.05,y:-518.35},0).wait(1).to({x:-13.2,y:-527.35},0).wait(1).to({x:-18.55,y:-536.7},0).wait(1).to({x:-24.15,y:-546.45},0).wait(1).to({x:-29.95,y:-556.6},0).wait(1).to({x:-36.05,y:-567.2},0).wait(1).to({x:-42.4,y:-578.25},0).wait(1).to({x:-49.05,y:-589.85},0).wait(1).to({x:-56,y:-602.05},0).wait(1).to({x:-63.35,y:-614.85},0).wait(1).to({x:-71.05,y:-628.3},0).wait(1).to({x:-79.2,y:-642.5},0).wait(1).to({x:-87.8,y:-657.5},0).wait(1).to({x:-96.85,y:-673.3},0).wait(1).to({x:-106.45,y:-690.05},0).wait(1).to({x:-116.6,y:-707.75},0).wait(1).to({x:-127.35,y:-726.5},0).wait(1).to({x:-138.7,y:-746.35},0).wait(1).to({x:-150.75,y:-767.35},0).wait(1).to({regX:220.5,regY:196.8,x:-136.6,y:-806.4},0).to({_off:true},1).wait(1));

	// PowerPoint
	this.instance_5 = new lib.Excel_1();
	this.instance_5.setTransform(677.9,412.35,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:110.95,y:-540.25},149).wait(1).to({regX:223.6,regY:237.6,x:111.15,y:-504.5},0).wait(1).to({x:108.2,y:-509.65},0).wait(1).to({x:105.25,y:-514.8},0).wait(1).to({x:102.25,y:-520},0).wait(1).to({x:99.25,y:-525.2},0).wait(1).to({x:96.2,y:-530.5},0).wait(1).to({x:93.15,y:-535.8},0).wait(1).to({x:90.05,y:-541.2},0).wait(1).to({x:86.9,y:-546.6},0).wait(1).to({x:83.75,y:-552.1},0).wait(1).to({x:80.55,y:-557.65},0).wait(1).to({x:77.3,y:-563.3},0).wait(1).to({x:74.05,y:-569},0).wait(1).to({x:70.7,y:-574.75},0).wait(1).to({x:67.35,y:-580.65},0).wait(1).to({x:63.9,y:-586.6},0).wait(1).to({x:60.4,y:-592.65},0).wait(1).to({x:56.85,y:-598.8},0).wait(1).to({x:53.25,y:-605.1},0).wait(1).to({x:49.55,y:-611.5},0).wait(1).to({x:45.8,y:-618.05},0).wait(1).to({x:41.95,y:-624.75},0).wait(1).to({x:38,y:-631.6},0).wait(1).to({x:34,y:-638.6},0).wait(1).to({x:29.85,y:-645.8},0).wait(1).to({x:25.6,y:-653.2},0).wait(1).to({x:21.2,y:-660.8},0).wait(1).to({x:16.7,y:-668.65},0).wait(1).to({x:12.05,y:-676.7},0).wait(1).to({x:7.2,y:-685.1},0).wait(1).to({x:2.25,y:-693.75},0).wait(1).to({x:-2.95,y:-702.75},0).wait(1).to({x:-8.3,y:-712.05},0).wait(1).to({x:-13.9,y:-721.75},0).wait(1).to({x:-19.7,y:-731.9},0).wait(1).to({x:-25.8,y:-742.45},0).wait(1).to({x:-32.15,y:-753.5},0).wait(1).to({x:-38.8,y:-765.05},0).wait(1).to({x:-45.8,y:-777.2},0).wait(1).to({x:-53.15,y:-789.95},0).wait(1).to({x:-60.85,y:-803.4},0).wait(1).to({x:-69,y:-817.55},0).wait(1).to({x:-77.6,y:-832.5},0).wait(1).to({x:-86.7,y:-848.3},0).wait(1).to({x:-96.3,y:-865},0).wait(1).to({x:-106.5,y:-882.65},0).wait(1).to({x:-117.25,y:-901.35},0).wait(1).to({x:-128.65,y:-921.15},0).wait(1).to({x:-140.7,y:-942.1},0).wait(1).to({regX:220.5,regY:196.8,x:-156.55,y:-1005.05},0).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-656.5,-1336.5,1465.5,2062.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(144.2,4.3,0.3475,0.3475,0,0,180,-0.3,0);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582631510626", id:"O365_FY20Q4_Cons_USA_160x600_BAN_Excel_Budgeting_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
