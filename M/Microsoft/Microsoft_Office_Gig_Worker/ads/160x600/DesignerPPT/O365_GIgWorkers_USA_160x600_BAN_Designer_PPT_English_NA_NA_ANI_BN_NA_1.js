...
lib.ssMetadata = [
		{name:"O365_GIgWorkers_USA_160x600_BAN_Designer_PPT_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[52,722,52,37],[106,722,52,37],[160,722,38,30],[0,722,50,73],[0,0,192,720],[194,0,192,720]]}
];
...
(lib.Add_UI_morph = function() {
	this.initialize(ss["O365_GIgWorkers_USA_160x600_BAN_Designer_PPT_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.scene_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(547,119,0.8333,0.8333);
...
(lib.Ready_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Ready", "9px 'Segoe Pro'", "#626262");
	this.txt.name = "txt";
...
}).prototype = getMCSymbolPrototype(lib.Ready_txt, new cjs.Rectangle(0,0,28.2,16.2), null);
...
(lib.PageLayout_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Draw", "10px 'Segoe Pro'", "#494846");
	this.txt.name = "txt";
...
}).prototype = getMCSymbolPrototype(lib.PageLayout_txt, new cjs.Rectangle(0,0,27,17.5), null);
...
(lib.Notes_txtcopy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Notes", "9px 'Segoe Pro'", "#626262");
	this.txt.name = "txt";
	this.txt.lineHeight = 13;
	this.txt.lineWidth = 22;
	this.txt.parent = this;
	this.txt.setTransform(2,1.85);

	this.timeline.addTween(cjs.Tween.get(this.txt).wait(1));

}).prototype = getMCSymbolPrototype(lib.Notes_txtcopy, new cjs.Rectangle(0,-0.1,25.9,15.4), null);
...
(lib.Insert_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Insert", "10px 'Segoe Pro'", "#494846");
	this.txt.name = "txt";
	this.txt.lineHeight = 15;
	this.txt.parent = this;
	this.txt.setTransform(2,2);
...
}).prototype = getMCSymbolPrototype(lib.Insert_txt, new cjs.Rectangle(0,0,28.4,17.5), null);
...
(lib.Home_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Home", "10px 'Segoe Pro'", "#494846");
	this.txt.name = "txt";
	this.txt.lineHeight = 15;
	this.txt.parent = this;
	this.txt.setTransform(2,2);
...
}).prototype = getMCSymbolPrototype(lib.Home_txt, new cjs.Rectangle(0,0,30.9,17.5), null);
...
(lib.greyicons = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(5.4724,5.6911,1.1632,1.1632);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#494846").s().p("AgRAUIAVgUIgVgTIAHgHIAbAaIgbAbg");
	this.shape_1.setTransform(2.0119,5.6911,1.1632,1.1632);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.greyicons, new cjs.Rectangle(0,2.5,7.5,6.4), null);
...
(lib.Excel_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("PowerPoint", "12px 'Segoe Pro'", "#FFFFFF");
	this.txt.name = "txt";
	this.txt.lineHeight = 18;
	this.txt.parent = this;
	this.txt.setTransform(-5.4,2);

	this.timeline.addTween(cjs.Tween.get(this.txt).wait(1));

}).prototype = getMCSymbolPrototype(lib.Excel_txt, new cjs.Rectangle(-7.4,0,61.8,29.6), null);
...
(lib.bottomicons = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#606060").s().p("AgPAIIAPgPIAQAPg");
	this.shape.setTransform(4.7898,1.1442,1.4031,1.4031);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#606060").s().p("AgRACIAAgDIAjAAIAAADg");
	this.shape_1.setTransform(2.5449,8.7912,1.4031,1.4031);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#606060").s().p("AghACIAAgDIBDAAIAAADg");
	this.shape_2.setTransform(4.7898,6.476,1.4031,1.4031);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#606060").s().p("AghACIAAgDIBDAAIAAADg");
	this.shape_3.setTransform(4.7898,4.2311,1.4031,1.4031);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.bottomicons, new cjs.Rectangle(0,0,9.6,9.1), null);
...
(lib.Add_UI_Tile_3 = function(mode,startPosition,loop) {
	...
	this.shape_12.setTransform(30.2193,-25.4818,0.1459,0.1459);
	...
	this.shape_13.setTransform(-9.7064,-4.1224,0.1459,0.1459);
	...
	this.shape_35.setTransform(-14.3333,11.5844,0.1459,0.1459);
	...
	this.shape_36.setTransform(3.8808,-1.7977,0.1459,0.1459);
	...
	this.shape_47.setTransform(26.7386,0.4777,0.1459,0.1459);
	...
	this.shape_48.setTransform(-19.4623,22.2379,0.1459,0.1459);
	...
	this.shape_49.setTransform(6.383,29.1935,0.1459,0.1459);
	...
	this.shape_50.setTransform(16.1211,-25.3278,0.1459,0.1459);
	...
	this.shape_51.setTransform(6.3798,-22.1199,0.1459,0.1459);
	...
	this.shape_52.setTransform(2.1484,17.8406,0.1459,0.1459);
	...
	this.shape_53.setTransform(24.9213,-6.5652,0.1459,0.1459);
	...
	this.shape_54.setTransform(-4.6071,28.642,0.1459,0.1459);
	...
	this.shape_55.setTransform(19.0254,5.8601,0.1459,0.1459);
	...
	this.shape_56.setTransform(-19.8896,-5.1834,0.1459,0.1459);
	...
	this.shape_57.setTransform(-3.3493,-20.6734,0.1459,0.1459);
	...
	this.shape_58.setTransform(20.9946,-24.1657,0.1459,0.1459);
	...
	this.shape_59.setTransform(20.6822,29.8304,0.1459,0.1459);
	...
	this.shape_60.setTransform(33.0787,14.6062,0.1459,0.1459);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#00FED4").s().p("EgmZAmZMAAAhMyMBMzAAAMAAABMyg");
	this.shape_61.setTransform(11.0984,0.0948,0.1459,0.1459);
...
(lib.Add_UI_Tile_2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E43E24").ss(2,1,1).p("Ap2llITtAAIAALLIztAAg");
	...
	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#183C6C").s().p("Ah6h7ID1BHIi4Cwg");
	this.shape_1.setTransform(-1.7927,19.5474,0.2009,0.2009);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#183C6C").s().p("Ah5h7ID0BIIi5Cvg");
	this.shape_2.setTransform(-12.4328,8.1089,0.2009,0.2009);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AiYAdIAjg5IEOAAIAAA5g");
	this.shape_3.setTransform(-18.0416,1.7921,0.2009,0.2009);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FDCF08").s().p("AhgAdIAig5ICfAAIgiA5g");
	this.shape_4.setTransform(-22.3699,1.7921,0.2009,0.2009);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#183C6C").s().p("AiCAdIAAg5IEEAAIgiA5g");
	this.shape_5.setTransform(-26.2514,1.7921,0.2009,0.2009);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ah0AdIAjg5IDGAAIAAA5g");
	this.shape_6.setTransform(-17.3185,-0.6181,0.2009,0.2009);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FDCF08").s().p("AhgAdIAig5ICfAAIgiA5g");
	this.shape_7.setTransform(-20.9238,-0.6181,0.2009,0.2009);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#183C6C").s().p("AimAdIAAg5IFMAAIgiA5g");
	this.shape_8.setTransform(-25.5283,-0.6181,0.2009,0.2009);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhQAdIAjg5IB+AAIAAA5g");
	this.shape_9.setTransform(-16.6005,-3.0283,0.2009,0.2009);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FDCF08").s().p("AhgAdIAig5ICfAAIgiA5g");
	this.shape_10.setTransform(-19.4877,-3.0283,0.2009,0.2009);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#183C6C").s().p("AjJAdIAAg5IGTAAIgiA5g");
	this.shape_11.setTransform(-24.8103,-3.0283,0.2009,0.2009);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E43E24").s().p("AuELxIGwrTIHSAAIAAg4ImvAAIAlg+IGKAAIAAg6IlnAAIAlg/IFCAAIAAg5IkgAAIEinnIOFXig");
	this.shape_12.setTransform(-14.9083,1.757,0.2009,0.2009);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AlZAdIAAg5IKzAAIAAA5g");
	this.shape_13.setTransform(2.5557,-15.0392,0.2009,0.2009);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AlZAdIAAg5IKzAAIAAA5g");
	this.shape_14.setTransform(2.5557,-17.4494,0.2009,0.2009);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AlZAdIAAg5IKzAAIAAA5g");
	this.shape_15.setTransform(2.5557,-19.8596,0.2009,0.2009);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FDCF08").s().p("Ah6h7ID1BIIi4Cvg");
	this.shape_16.setTransform(-18.835,19.6328,0.2009,0.2009);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#2BBFE3").s().p("Ah6h7ID1BIIi4Cvg");
	this.shape_17.setTransform(-22.8922,19.4972,0.2009,0.2009);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FDCF08").s().p("Ah4h8IDyBPIi+Cqg");
	this.shape_18.setTransform(14.9131,10.5392,0.2009,0.2009);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#E43E24").s().p("AhuhuIDdA6IigCjg");
	this.shape_19.setTransform(0.4468,0.0297,0.2009,0.2009);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#183C6C").s().p("Ah0h0IDpA9IipCsg");
	this.shape_20.setTransform(4.1625,-2.5764,0.2009,0.2009);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_21.setTransform(20.773,-8.1476,0.1989,0.1989);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_22.setTransform(22.6475,-5.3633,0.1989,0.1989);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_23.setTransform(20.773,-5.3633,0.1989,0.1989);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_24.setTransform(18.9035,-5.3633,0.1989,0.1989);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_25.setTransform(24.5269,-2.5789,0.1989,0.1989);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_26.setTransform(22.6475,-2.5789,0.1989,0.1989);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_27.setTransform(20.773,-2.5789,0.1989,0.1989);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_28.setTransform(18.9035,-2.5789,0.1989,0.1989);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_29.setTransform(17.0241,-2.5789,0.1989,0.1989);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_30.setTransform(26.4014,0.2055,0.1989,0.1989);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_31.setTransform(24.5269,0.2055,0.1989,0.1989);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_32.setTransform(22.6475,0.2055,0.1989,0.1989);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_33.setTransform(20.773,0.2055,0.1989,0.1989);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_34.setTransform(18.9035,0.2055,0.1989,0.1989);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_35.setTransform(17.0241,0.2055,0.1989,0.1989);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_36.setTransform(15.1496,0.2055,0.1989,0.1989);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_37.setTransform(28.2759,2.9898,0.1989,0.1989);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_38.setTransform(26.4014,2.9898,0.1989,0.1989);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_39.setTransform(24.5269,2.9898,0.1989,0.1989);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_40.setTransform(22.6475,2.9898,0.1989,0.1989);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_41.setTransform(20.773,2.9898,0.1989,0.1989);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_42.setTransform(18.9035,2.9898,0.1989,0.1989);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_43.setTransform(17.0241,2.9898,0.1989,0.1989);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_44.setTransform(15.1496,2.9898,0.1989,0.1989);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_45.setTransform(13.2701,2.9898,0.1989,0.1989);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_46.setTransform(21.7127,-6.7505,0.1989,0.1989);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_47.setTransform(19.8383,-6.7505,0.1989,0.1989);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_48.setTransform(23.5872,-3.9661,0.1989,0.1989);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_49.setTransform(21.7127,-3.9661,0.1989,0.1989);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_50.setTransform(19.8383,-3.9661,0.1989,0.1989);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_51.setTransform(17.9638,-3.9661,0.1989,0.1989);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_52.setTransform(25.4666,-1.1817,0.1989,0.1989);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_53.setTransform(23.5872,-1.1817,0.1989,0.1989);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_54.setTransform(21.7127,-1.1817,0.1989,0.1989);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_55.setTransform(19.8383,-1.1817,0.1989,0.1989);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_56.setTransform(17.9638,-1.1817,0.1989,0.1989);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_57.setTransform(16.0893,-1.1817,0.1989,0.1989);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_58.setTransform(27.3411,1.6026,0.1989,0.1989);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_59.setTransform(25.4666,1.6026,0.1989,0.1989);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_60.setTransform(23.5872,1.6026,0.1989,0.1989);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_61.setTransform(21.7127,1.6026,0.1989,0.1989);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_62.setTransform(19.8383,1.6026,0.1989,0.1989);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_63.setTransform(17.9638,1.6026,0.1989,0.1989);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_64.setTransform(16.0893,1.6026,0.1989,0.1989);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_65.setTransform(14.2099,1.6026,0.1989,0.1989);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_66.setTransform(29.2156,4.387,0.1989,0.1989);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_67.setTransform(27.3411,4.387,0.1989,0.1989);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_68.setTransform(25.4666,4.387,0.1989,0.1989);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_69.setTransform(23.5872,4.387,0.1989,0.1989);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_70.setTransform(21.7127,4.387,0.1989,0.1989);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_71.setTransform(19.8383,4.387,0.1989,0.1989);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_72.setTransform(17.9638,4.387,0.1989,0.1989);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_73.setTransform(16.0893,4.387,0.1989,0.1989);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_74.setTransform(14.2099,4.387,0.1989,0.1989);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#183C6C").s().p("AguAjIAuhFIAvBFg");
	this.shape_75.setTransform(12.3354,4.387,0.1989,0.1989);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#FDCF08").s().p("AvFNFIPF6JIPGaJg");
	this.shape_76.setTransform(11.3731,-11.3938,0.2009,0.2009);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#2BBFE3").s().p("AqHodIUPAAIqIQ7g");
	this.shape_77.setTransform(3.9818,16.143,0.2009,0.2009);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#183C6C").s().p("AoFnAIQMAAIoHOBg");
	this.shape_78.setTransform(16.9417,12.0155,0.2009,0.2009);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#183C6C").s().p("AjTgwID9hWICqgYIiAE9g");
	this.shape_79.setTransform(-28.7419,17.8753,0.2009,0.2009);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#F4EFB8").s().p("Am1luINrAAIm2Ldg");
	this.shape_80.setTransform(-6.1713,12.8189,0.2009,0.2009);
	...
	this.shape_81.graphics.f("#FFFFFF").s().p("Ap1FnIAArMITrAAIAALMg");
	this.shape_81.setTransform(-0.5,0.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_81).wait(1));

}).prototype = getMCSymbolPrototype(lib.Add_UI_Tile_2, new cjs.Rectangle(-64.3,-36.7,128.2,73.5), null);
...
(lib.Add_UI_Tile_1 = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AmhFhIAArBINDAAIAALBg");
	this.shape_1.setTransform(-0.375,0.2);
...
(lib.add_preview_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Preview", "6px 'Segoe Pro'", "#626262");
	this.txt.name = "txt";
...
}).prototype = getMCSymbolPrototype(lib.add_preview_txt, new cjs.Rectangle(0,0,24.5,16.2), null);
...
(lib.add_none_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("None", "6px 'Segoe Pro'", "#626262");
	this.txt.name = "txt";
	this.txt.lineHeight = 10;
	this.txt.parent = this;
	this.txt.setTransform(2,2);
...
}).prototype = getMCSymbolPrototype(lib.add_none_txt, new cjs.Rectangle(0,0,18.7,16.2), null);
...
(lib.add_morph_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt = new cjs.Text("Morph", "6px 'Segoe Pro'", "#626262");
	this.txt.name = "txt";
	this.txt.lineHeight = 10;
	this.txt.parent = this;
	this.txt.setTransform(2,2);
...
}).prototype = getMCSymbolPrototype(lib.add_morph_txt, new cjs.Rectangle(0,0,22.1,16.2), null);
...
(lib.scene4 = function(mode,startPosition,loop) {
	...
	this.logo_white.setTransform(107.9,472.65,0.2111,0.2111,0,0,0,434.4,2163.2);
...
}).prototype = getMCSymbolPrototype(lib.scene4, new cjs.Rectangle(0,0,160,600), null);
...
(lib.motion_graphics_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-109.75,-86,0.0108,0.5425,-30.9997);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({regX:4.8,scaleX:0.5425,rotation:0,x:-126.75,y:-71.2},40,cjs.Ease.quadOut).wait(1));

	// Layer_6
	this.instance_1 = new lib.Tween23("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-139.95,-46.9,0.0062,0.0062,111.4896,0,0,10.4,4.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0,regY:0,scaleX:0.8129,scaleY:0.8129,rotation:111.5394,x:-235.05,y:-28.1},39,cjs.Ease.sineInOut).to({regY:0.1,scaleX:0.5425,scaleY:0.5425,rotation:0,x:-212.55,y:-57.45},40,cjs.Ease.sineInOut).wait(1));

	// Layer_7
	this.instance_2 = new lib.Tween24("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-209.15,10.95,0.0093,0.0093,106.4743);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:0.1,regY:0.3,scaleX:0.4405,scaleY:0.4405,rotation:144.1547,x:-234.1,y:-116.4},39).to({regX:0,regY:0.1,scaleX:0.5425,scaleY:0.5425,rotation:0,x:-228.6,y:-93.1},40).wait(1));

	// Layer_8
	this.instance_3 = new lib.Tween25("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-88.1,-5.1,0.5425,0.5425,-42.4649);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(39).to({_off:false},0).to({regY:0.1,rotation:0,x:-130.25,y:-28.4},40,cjs.Ease.sineInOut).wait(1));

	// Layer_10
	this.instance_4 = new lib.Tween27("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-291.85,8.9,0.0207,0.0196,-61.4394,0,0,-2.1,1.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:-1.4,regY:0.6,scaleX:0.2768,scaleY:0.2762,rotation:-113.071,x:-142.35,y:29.75},39,cjs.Ease.sineInOut).to({regX:0,regY:0,scaleX:0.5425,scaleY:0.5425,rotation:0,x:-177.9,y:-20.15},40,cjs.Ease.sineInOut).wait(1));

	// Layer_9
	this.instance_5 = new lib.Tween26("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-176.5,-120.3,0.0135,0.0135,-47.298,0,0,0.2,-5.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0,regY:-0.1,scaleX:0.455,scaleY:0.455,rotation:-50.5101,x:-122.6,y:-125.8},39,cjs.Ease.sineInOut).to({regX:-0.1,regY:0.1,scaleX:0.5425,scaleY:0.5425,rotation:0,x:-157.15,y:-54.8},40,cjs.Ease.sineInOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-293.4,-149.9,437.59999999999997,317.1);
...
(lib.motion_graphics_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-68,-263.6,0.01,0.01,-119.734,0,0,13.7,-3.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.1,regY:-0.1,scaleX:0.6039,scaleY:0.6039,rotation:7.5075,x:-45.85,y:-172.9},38,cjs.Ease.sineInOut).to({regX:0,regY:0,scaleX:0.5035,scaleY:0.5035,rotation:0,x:-70.6,y:-193.05},41,cjs.Ease.sineInOut).wait(1));

	// Layer_4
	this.instance_1 = new lib.motion_graphics_1_bars();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-112.4,-146.3,0.0452,0.5497,-17.7081,0,0,-3.6,-0.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(38).to({_off:false},0).to({regX:-0.2,regY:-0.2,scaleX:0.5497,rotation:0,x:-70.9,y:-162.8},41,cjs.Ease.sineOut).wait(1));

	// Layer_13
	this.instance_2 = new lib.Tween29("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(22.75,-100,0.0728,0.0728,59.4772,0,0,-1.1,-2.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:-0.1,regY:-0.7,scaleX:0.494,scaleY:0.494,rotation:-32.5806,x:-102.2,y:-206.35},38,cjs.Ease.sineInOut).to({regY:-0.2,scaleX:0.5497,scaleY:0.5497,rotation:0,x:-51.65,y:-156.25},41,cjs.Ease.sineInOut).wait(1));

	// Layer_16
	this.instance_3 = new lib.Tween30("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(11.1,-168.75,0.011,0.011,0,0,0,13.7,-9.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:2.6,regY:0.2,scaleX:0.6592,scaleY:0.6592,rotation:102.7709,x:-100.55,y:-141.8},38,cjs.Ease.sineInOut).to({regX:-0.3,regY:-0.2,scaleX:0.5497,scaleY:0.5497,rotation:0,x:-89.55,y:-112.15},41,cjs.Ease.sineInOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-122,-263.5,199.6,351.9);
...
(lib.Motion_clip = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-70.1,-19.45,0.2,0.2,0,0,0,0.3,0.3);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,scaleX:0.8328,scaleY:0.8328,x:-70.15,y:-22.3,alpha:1},19,cjs.Ease.cubicOut).to({startPosition:0},10,cjs.Ease.cubicInOut).to({regX:-0.1,regY:0.1,scaleX:0.6297,scaleY:0.6297,x:-70.2,y:47.3},40,cjs.Ease.cubicInOut).to({regY:0,scaleX:0.6298,scaleY:0.6288,x:-70.15,y:-107.75},40,cjs.Ease.cubicInOut).to({regX:0,scaleX:0.7553,scaleY:0.7553,y:-107.7},50).wait(1));

	// Layer_6
	this.instance_1 = new lib.motion_graphics_1("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-57,129.7,0.85,0.85,0,0,0,-0.2,0.1);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(92.9,13.8,0.85,0.85,0,0,0,0.2,0.1);
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#D7D7D7").ss(1,1,1).p("AMchSIAAf+I43AAMAAAg9XIY3AAIAAb2g");
	this.shape.setTransform(-69.9,9.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AsXesMAAAg9XIY3AAIAAb1IAABjIjuAAIAAhjIDuAAIjuAAIAABjIDuAAIAAf/gAsfesMAAAg9XIAIAAMAAAA9XgAsX+rg");
	this.shape_1.setTransform(-70.25,9.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(160));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-160.5,-188.2,205.3,394.7);
...
(lib.grey_icons = function(mode,startPosition,loop) {
	...
	this.icons.setTransform(3.1,5.9,1,1,0,0,0,3.1,5.9);

	this.timeline.addTween(cjs.Tween.get(this.icons).wait(1));

}).prototype = getMCSymbolPrototype(lib.grey_icons, new cjs.Rectangle(0,2.5,7.5,6.4), null);
...
(lib.bottom_icons = function(mode,startPosition,loop) {
	...
	this.icons.name = "icons";
	this.icons.parent = this;
	this.icons.setTransform(106.5,9.7,1,1,0,0,0,107.5,6.7);

	this.timeline.addTween(cjs.Tween.get(this.icons).wait(1));

}).prototype = getMCSymbolPrototype(lib.bottom_icons, new cjs.Rectangle(-1,3,9.6,9.1), null);
...
(lib.UI_layout = function(mode,startPosition,loop) {
	...
	// Top_bar
	this.instance = new lib.grey_icons();
	this.instance.parent = this;
	this.instance.setTransform(145.7,54.65,1,1,0,0,0,3.9,5.8);

	this.instance_1 = new lib.Excel_txt();
	this.instance_1.parent = this;
	this.instance_1.setTransform(67.25,29.1,1,1,0,0,0,13.5,8.6);

	this.instance_2 = new lib.Home_txt();
	this.instance_2.parent = this;
	this.instance_2.setTransform(25,63.25,1,1,0,0,0,12.4,7);

	this.instance_3 = new lib.Insert_txt();
	this.instance_3.parent = this;
	this.instance_3.setTransform(70.15,63.25,1,1,0,0,0,11.3,7);

	this.instance_4 = new lib.PageLayout_txt();
	this.instance_4.parent = this;
	this.instance_4.setTransform(121.75,63.25,1,1,0,0,0,22.4,7);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B7472A").s().p("AiSAJIAAgRIElAAIAAARg");
	this.shape.setTransform(28.775,60.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F1F1F1").s().p("AsfCVIAAkpIY/AAIAAEpg");
	this.shape_1.setTransform(80.0012,51.8758);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#B7472A").s().p("AsfC9IAAl5IY/AAIAAF5g");
	this.shape_2.setTransform(80,18.975);
	...
	// Bottom_bar
	this.instance_5 = new lib.bottom_icons();
	this.instance_5.parent = this;
	this.instance_5.setTransform(225.85,584.25,1,1,0,0,0,107.5,6.7);

	this.instance_6 = new lib.Notes_txtcopy();
	this.instance_6.parent = this;
	this.instance_6.setTransform(139.15,593.55,1,1,0,0,0,11.5,6.7);

	this.instance_7 = new lib.Ready_txt();
	this.instance_7.parent = this;
	this.instance_7.setTransform(21,593.4,1,1,0,0,0,11.5,6.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F3F2F1").s().p("AsfCGIAAkLIY/AAIAAELg");
	this.shape_3.setTransform(80,586.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.UI_layout, new cjs.Rectangle(0,0.1,160,602.8), null);
...
(lib.screenAnim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(46).to({_off:false},0).to({x:130,y:113.9},23,cjs.Ease.quadOut).wait(11).to({startPosition:0},0).wait(2).to({regX:14.1,x:130.1,startPosition:1},0).wait(4).to({regX:14,x:130,startPosition:0},0).wait(22).to({startPosition:0},0).to({x:264,y:176.9},15,cjs.Ease.quadInOut).wait(57).to({startPosition:0},0).to({x:373.75,y:231.1},21,cjs.Ease.cubicIn).to({_off:true},1).wait(4));
	...
	// Layer_6
	this.instance_2 = new lib.Add_UI_preview();
	this.instance_2.parent = this;
	this.instance_2.setTransform(6,71,0.5807,0.5807);

	this.instance_3 = new lib.Add_UI_none();
	this.instance_3.parent = this;
	this.instance_3.setTransform(60,71,0.5808,0.5808);

	this.instance_4 = new lib.Add_UI_morph();
	this.instance_4.parent = this;
	this.instance_4.setTransform(112,71,0.5807,0.5807);

	this.instance_5 = new lib.Add_UI_Tile_3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(169.85,529.85,0.9151,0.9151);

	this.instance_6 = new lib.Add_UI_Tile_2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(81.4,529.85,0.9151,0.9151);

	this.instance_7 = new lib.Add_UI_Tile_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-25.55,529.85,0.9151,0.9151);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(206));

	// Add_UI_txt
	this.instance_8 = new lib.add_morph_txt();
	this.instance_8.parent = this;
	this.instance_8.setTransform(126.3,102.15,1,1,0,0,0,11.5,6.7);

	this.instance_9 = new lib.add_none_txt();
	this.instance_9.parent = this;
	this.instance_9.setTransform(77.15,102.15,1,1,0,0,0,11.5,6.7);

	this.instance_10 = new lib.add_preview_txt();
	this.instance_10.parent = this;
	this.instance_10.setTransform(14.85,102.15,1,1,0,0,0,11.5,6.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(206));

	// Add_UI_highlight
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E43E24").ss(1,1,1).p("AjjiWIHHAAQAcAAAAAcIAAD1QAAAcgcAAInHAAQgcAAAAgcIAAj1QAAgcAcAAg");
	this.shape.setTransform(75.875,85.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F8C4B6").s().p("AjjCXQgcAAAAgcIAAj1QAAgcAcAAIHHAAQAcAAAAAcIAAD1QAAAcgcAAg");
	this.shape_1.setTransform(75.875,85.375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1,p:{x:75.875,y:85.375}},{t:this.shape,p:{x:75.875,y:85.375}}]}).to({state:[{t:this.shape_1,p:{x:127.075,y:84.725}},{t:this.shape,p:{x:127.075,y:84.725}}]},83).wait(123));

	// flash0.ai
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E4E6E4").s().p("AgECpIAAlRIAJAAIAAFRg");
	this.shape_2.setTransform(33.3,85.4503);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#E4E6E4").p("AKHClI0NAAQgIAAgGgFQgGgGAAgIIAAkiQAAgIAGgHQAGgFAIAAIUNAAQAIAAAGAFQAGAHAAAIIAAEiQAAAIgGAGQgGAFgIAAg");
	this.shape_3.setTransform(104.5266,85.3513);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AqGClQgIAAgGgFQgGgGAAgIIAAkiQAAgJAGgGQAGgFAIAAIUNAAQAIAAAGAFQAGAGAAAJIAAEiQAAAIgGAGQgGAFgIAAg");
	this.shape_4.setTransform(104.5266,85.3513);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#D7D7D7").ss(1,1,1).p("EgMZghxIY0AAIAAlvI40AAgEgMaAnhIY1AAIAAs3I41AAg");
	this.shape_5.setTransform(80.025,319.95);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F1F1F1").s().p("EgMaAnhIAAs3IY1AAIAAM3gEgMZghxIAAlvIY0AAIAAFvg");
	this.shape_6.setTransform(80.025,319.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2}]}).wait(206));

	// Layer_8 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AsfelMAAAg9KIY/AAMAAAA9Kg");
	mask.setTransform(80,294.15);
	...
	// ScreenBG
	this.instance_11 = new lib.ScreenBG();
	this.instance_11.parent = this;
	this.instance_11.setTransform(150,163,1,1,0,0,0,150,98);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(206));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-64.6,0,452.6,605);
...
(lib.anim = function(mode,startPosition,loop) {
	...
	this.wipe.setTransform(260.8,300.1,0.5,1,0,0,0,0,0.1);
...
p.nominalBounds = new cjs.Rectangle(-1110.1,-3554,1445.8999999999999,4799.3);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(103.8,569.25,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(152.8,570.8,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-64.6,-1.4,400.4,606.6999999999999), null);


// stage content:
(lib.O365_GIgWorkers_USA_160x600_BAN_Designer_PPT_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.animMC.wipe, 1,{x:"-=410", scaleX:1, ease:Power2.easeInOut},"-=1");
...
p.nominalBounds = new cjs.Rectangle(15.3,298.6,320.5,306.69999999999993);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_GIgWorkers_USA_160x600_BAN_Designer_PPT_English_NA_NA_ANI_BN_NA_1_atlas_.png?1566553673118", id:"O365_GIgWorkers_USA_160x600_BAN_Designer_PPT_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
