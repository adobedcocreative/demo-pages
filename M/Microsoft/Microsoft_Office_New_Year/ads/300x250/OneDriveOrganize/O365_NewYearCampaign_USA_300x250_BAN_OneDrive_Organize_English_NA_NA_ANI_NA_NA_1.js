...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_300x250_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[251,253,83,90],[369,348,99,140],[251,348,116,121],[365,0,135,214],[0,253,249,361],[365,216,113,130],[0,0,363,251]]}
];
...
(lib.Icon_OneDrive = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_300x250_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.bg_fade_cache = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["rgba(246,246,246,0)","#FFFFFF"],[0.267,0.525],121,85,0,121,85,382.6).s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
	this.shape.setTransform(150,125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg_fade_cache, new cjs.Rectangle(0,0,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_cache, new cjs.Rectangle(0,0,300,250), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:5.5415,scaleY:5.5415,x:298.05,y:338.5},13,cjs.Ease.quadOut).to({x:78.15},12,cjs.Ease.quadInOut).to({_off:true},1).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:300.35},12,cjs.Ease.quadInOut).to({_off:true},24).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({x:-674.6},21,cjs.Ease.quadIn).wait(3));
...
(lib.Devices_Isometric = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(108).call(this.frame_108).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.laptop).to({_off:true},109).wait(1));
...
(lib.BG = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.bg.cache(0,0,300,250,1)
		this.bg_fade.cache(0,0,300,250,1)
	}
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(1.55,0.2,0.85,0.85,0,0,0,13.6,10.7);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(39.35,219.2,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(80.5,219.75,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.logo_1.setTransform(46.2,22.35,0.62,0.62,0,0,0,0.3,0.6);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-15,-1.4,317.1,259.4), null);


// stage content:
(lib.O365_NewYearCampaign_USA_300x250_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl2.to(anim, 1.5, {x:"+=70", ease:Power3.easeInOut}, "+=0");
			exportRoot.tl2.from(mc.bg.bg_fade, 1.5, {alpha:0, ease:Power3.easeInOut}, "-=1.5");
		
			
			for (var i = 0; i < exportRoot.headline10.length; i++) {
			if (i==0) exportRoot.tl2.from(exportRoot.headline10[i], 0.8, { x: "-=300", alpha: 0, ease:Power4.easeOut}, "-=0.9");
...
p.nominalBounds = new cjs.Rectangle(135,123.6,167.10000000000002,134.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_300x250_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574689464687", id:"O365_NewYearCampaign_USA_300x250_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
