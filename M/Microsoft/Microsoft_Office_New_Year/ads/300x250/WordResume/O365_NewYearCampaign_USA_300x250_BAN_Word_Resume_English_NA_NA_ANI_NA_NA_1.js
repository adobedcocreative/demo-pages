...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_300x250_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[285,117,336,51],[0,0,757,115],[0,117,283,159],[759,0,45,45]]}
];
...
(lib.Bitmap3 = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_300x250_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.topbar_cache = function(mode,startPosition,loop) {
	...
	this.shape_8.setTransform(30.8573,105.4314,0.1369,0.1369);
	...
	this.shape_9.setTransform(30.8573,105.4314,0.1369,0.1369);
...
(lib.mobile_device = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0.4,0.6,0.8447,0.8447);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mobile_device, new cjs.Rectangle(0.4,0.6,239.1,134.3), null);
...
(lib.dropdown_menu = function(mode,startPosition,loop) {
	...
	// text_boxes
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#E0E0E0").ss(0.2,1,1).p("Ai4i7IFxAAIAADKIlxAAgAi4jxIFxAAIAAAhIlxAAgAi4AnIFxAAIAADLIlxAAg");
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E6E6E6").s().p("At8G4IAAtvIb5AAIAANvg");
	this.shape.setTransform(87.825,43.975);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-1.4,0,178.5,88), null);
...
(lib.screen = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(163).call(this.frame_163).wait(52).call(this.frame_215).wait(3));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1D60BF").s().p("Ap2CjIAAlFITtAAIAAFFg");
...
(lib.bottom_barc = function(mode,startPosition,loop) {
	...
	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#000000").s().p("AuCApIAAhRIcFAAIAABRg");
	this.shape_73.setTransform(155.075,-90.3);
	...
	this.shape_118.setTransform(155.606,-95.613,0.3972,0.3987);
...
}).prototype = getMCSymbolPrototype(lib.bottom_barc, new cjs.Rectangle(65.2,-97.7,179.8,12.100000000000009), null);
...
(lib.bottombar = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.bar.cache(-450,-450,900,900,2)
	}
...
}).prototype = getMCSymbolPrototype(lib.bottombar, new cjs.Rectangle(65.2,-114.7,179.8,12.100000000000009), null);
...
}).prototype = getMCSymbolPrototype(lib.Word, new cjs.Rectangle(56.7,-12.7,181.3,107.8), null);
...
(lib.devices = function(mode,startPosition,loop) {
	...
	this.screen.setTransform(181.5,189.75,0.9988,0.9988,0,0,0,68.6,-161.7);
	...
	this.scroll_bar.setTransform(221.2,204.45,1,1,0,0,0,1.2,40.7);
	...
	this.resume_1.setTransform(101.5,165.9,1,1,0,0,0,-53.8,-44.1);
...
}).prototype = getMCSymbolPrototype(lib.devices, new cjs.Rectangle(87.3,148.7,182.89999999999998,130.10000000000002), null);
...
(lib.anim_blue = function(mode,startPosition,loop) {
	...
	this.icon.setTransform(6.35,9.4,0.8902,0.8902,0,0,0,0.1,0.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("At5H9IAAv5IbzAAIAAP5g");
	mask.setTransform(149.775,142.275);
...
}).prototype = getMCSymbolPrototype(lib.anim_blue, new cjs.Rectangle(-39.6,72.4,375.6,155), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.mobile_device.setTransform(44.35,126);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-39.6,-1.4,375.6,262.29999999999995), null);


// stage content:
(lib.O365_NewYearCampaign_USA_300x250_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(exportRoot.headline10, 0.01, {alpha: 0, ease:Power4.easeOut,onComplete:function(){laptop.screen.gotoAndPlay(1)}}, "+=.25");
			
		
				exportRoot.tl1.to(exportRoot.headline4, 0.1, {alpha: 0, ease:Power4.easeIn}, "+=0.75");
				exportRoot.tl1.to(exportRoot.headline5, 0.1, {alpha: 0, ease:Power4.easeIn}, "-=0.1");
				exportRoot.tl1.to(exportRoot.headline10, 0.1, {alpha: 0, ease:Power4.easeIn}, "-=0.1");
...
p.nominalBounds = new cjs.Rectangle(110.4,123.6,225.6,137.29999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_300x250_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574940041646", id:"O365_NewYearCampaign_USA_300x250_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
