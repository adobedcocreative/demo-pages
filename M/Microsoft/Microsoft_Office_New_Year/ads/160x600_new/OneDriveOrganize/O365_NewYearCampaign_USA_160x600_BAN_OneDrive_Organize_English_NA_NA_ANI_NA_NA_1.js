...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_160x600_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[251,253,83,90],[369,348,99,140],[251,348,116,121],[365,0,135,214],[0,253,249,361],[365,216,113,130],[0,0,363,251]]}
];
...
(lib.Icon_OneDrive = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_160x600_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.bg_fade_cache = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","rgba(246,246,246,0)","rgba(246,246,246,0)","#FFFFFF"],[0.165,0.275,0.482,0.596],0.1,299.8,-0.1,-299.9).s().p("EgMfAu4MAAAhdvIY/AAMAAABdvg");
	this.shape.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg_fade_cache, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_cache, new cjs.Rectangle(0,0,160,600), null);
...
(lib.BG = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.bg.cache(0,0,160,600,1)
		this.bg_fade.cache(0,0,160,600,1)
	}
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(34).call(this.frame_34).wait(8).call(this.frame_42).wait(9).call(this.frame_51).wait(8).call(this.frame_59).wait(9).call(this.frame_68).wait(6).call(this.frame_74).wait(2));
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(103.5,570,0.95,0.95,0,0,0,0.8,0.1);
	...
	this.cta.setTransform(154.35,570.2,0.95,0.95,0,0,0,0.3,0.3);
	...
	this.logo_1.setTransform(47.3,24.1,0.6,0.6,0,0,0,0.9,1.1);
	...
	this.anim.setTransform(-30.35,231.2,0.66,0.66,0,0,0,-0.5,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-15.7,-1.4,193.6,604.6999999999999), null);


// stage content:
(lib.O365_NewYearCampaign_USA_160x600_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(anim, 2, {scaleX:1, scaleY:1, x:"-=37", y:"-=38", ease:Power3.easeInOut}, "-=2");
			...
			//Organize your
			exportRoot.tl2.from(exportRoot.headline1, 0.01, {alpha: 0, ease:Power4.easeOut}, "-=0.9");
			exportRoot.tl2.from(exportRoot.headline2, 0.01, {alpha: 0, ease:Power4.easeOut}, "+=0.2");
				
			exportRoot.tl2.to(exportRoot.headline1, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.6");
			exportRoot.tl2.to(exportRoot.headline2, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0.01");
		
			//photos
			exportRoot.tl2.from(exportRoot.headline3, 0.01, {alpha: 0, ease:Power4.easeOut}, "-=0.01");
		
			exportRoot.tl2.to(exportRoot.headline3, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.5");
		
			//and keep
			exportRoot.tl2.from(exportRoot.headline4, 0.01, {alpha: 0, ease:Power4.easeOut}, "-=0.01");
			exportRoot.tl2.from(exportRoot.headline5, 0.01, {alpha: 0, ease:Power4.easeOut}, "+=0.2");
			
			exportRoot.tl2.to(exportRoot.headline4, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.5");
			exportRoot.tl2.to(exportRoot.headline5, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0.01");
		
			//them secure
			exportRoot.tl2.from(exportRoot.headline6, 0.01, {alpha: 0, ease:Power4.easeOut}, "-=.01");
			exportRoot.tl2.from(exportRoot.headline7, 0.01, {alpha: 0, ease:Power4.easeOut}, "+=0.2");
				
			exportRoot.tl2.to(exportRoot.headline6, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.5");
			...
			exportRoot.tl2.to(anim, 1.5, {scaleX:.975, scaleY:.975, y:"+=6", x:"+=24", ease:Power3.easeInOut}, "+=0.0");
...
p.nominalBounds = new cjs.Rectangle(64.3,298.6,113.60000000000001,304.69999999999993);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_160x600_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574943526290", id:"O365_NewYearCampaign_USA_160x600_BAN_OneDrive_Organize_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
