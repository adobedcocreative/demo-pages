...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_300x250_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[0,117,336,51],[759,0,69,69],[0,0,757,115],[338,117,266,43]]}
];
...
(lib.Bitmap3 = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_300x250_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.topbar_2 = function(mode,startPosition,loop) {
	...
	this.shape_16.setTransform(17.8111,209.236,0.137,0.137);
	...
	this.shape_19.setTransform(7.6292,209.7447,0.1369,0.1369);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#207346").s().p("AgyAoIAAhPIAGAAIAABIIBZAAIAAgoIAFAAIAAAvg");
	this.shape_20.setTransform(7.3656,210.3542,0.1369,0.1369);
	...
	this.shape_21.setTransform(10.1628,210.0837,0.1369,0.1369);
	...
	this.shape_22.setTransform(10.1628,210.0837,0.1369,0.1369);
...
(lib.text = function(mode,startPosition,loop) {
	...
	this.txt.lineHeight = 17;
	this.txt.parent = this;
	this.txt.setTransform(27.65,15);
...
(lib.sleep_txt = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.txt9).wait(1));

	// Layer_4
	this.txt8 = new cjs.Text("10.7%", "4px 'Segoe Pro'", "#4354A4");
	this.txt8.name = "txt8";
	this.txt8.lineHeight = 7;
	this.txt8.parent = this;
	this.txt8.setTransform(1.6001,20.4);

	this.timeline.addTween(cjs.Tween.get(this.txt8).wait(1));

	// Layer_1
	this.txt7 = new cjs.Text("6.0 hours", "4px 'Segoe Pro'", "#4354A4");
	this.txt7.name = "txt7";
...
}).prototype = getMCSymbolPrototype(lib.sleep_txt, new cjs.Rectangle(-0.6,1.1,25,32.1), null);
...
(lib.sleep_hours = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt8 = new cjs.Text("0 hours", "4px 'Segoe Pro'", "#4354A4");
	this.txt8.name = "txt8";
	this.txt8.lineHeight = 7;
	this.txt8.lineWidth = 20;
	this.txt8.parent = this;
	this.txt8.setTransform(2,2);

	this.timeline.addTween(cjs.Tween.get(this.txt8).wait(7).to({text:"0.7 hours",lineWidth:22},0).wait(2).to({text:"1.5 hours"},0).wait(2).to({text:"2.3 hours",lineWidth:23},0).wait(2).to({text:"3.1 hours"},0).wait(2).to({text:"3.5 hours"},0).wait(2).to({text:"4.4 hours"},0).wait(2).to({text:"5.1 hours",lineWidth:24},0).wait(2).to({text:"5.3 hours",lineWidth:20},0).wait(2).to({text:"5.5 hours",lineWidth:23},0).wait(2).to({text:"6.0 hours",lineWidth:22},0).wait(14).to({lineWidth:23},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,28.3,10);
...
(lib.runtime_txt = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt5_1 = new cjs.Text("120 minutes", "4px 'Segoe Pro'", "#2680BE");
	this.txt5_1.name = "txt5_1";
	this.txt5_1.lineHeight = 7;
	this.txt5_1.lineWidth = 26;
	this.txt5_1.parent = this;
	this.txt5_1.setTransform(3.6,3.1);

	this.timeline.addTween(cjs.Tween.get(this.txt5_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.runtime_txt, new cjs.Rectangle(1.6,1.1,29.9,19), null);
...
(lib.minutes = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.txt5 = new cjs.Text("0 minutes", "4px 'Segoe Pro'", "#2680BE");
	this.txt5.name = "txt5";
	this.txt5.lineHeight = 7;
	this.txt5.lineWidth = 25;
	this.txt5.parent = this;
...
(lib.Me_time_txt = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.txt8 = new cjs.Text("10.7%", "4px 'Segoe Pro'", "#E42364");
	this.txt8.name = "txt8";
	this.txt8.lineHeight = 7;
	this.txt8.parent = this;
	this.txt8.setTransform(4.0501,20.4);
...
}).prototype = getMCSymbolPrototype(lib.Me_time_txt, new cjs.Rectangle(1.9,1.2,29.1,32), null);
...
(lib.Me_time = function(mode,startPosition,loop) {
	...
	this.txt7.name = "txt7";
	this.txt7.lineHeight = 7;
	this.txt7.lineWidth = 29;
	this.txt7.parent = this;
	this.txt7.setTransform(2,2);

	this.timeline.addTween(cjs.Tween.get(this.txt7).wait(7).to({text:"2 minutes"},0).wait(2).to({text:"4 minutes"},0).wait(2).to({text:"6 minutes",lineWidth:28},0).wait(2).to({text:"8 minutes",lineWidth:24},0).wait(2).to({text:"10 minutes",lineWidth:28},0).wait(2).to({text:"11 minutes",lineWidth:30},0).wait(2).to({text:"12 minutes",lineWidth:27},0).wait(2).to({text:"13 minutes",lineWidth:28},0).wait(2).to({text:"10 minutes",lineWidth:29},0).wait(2).to({text:"14 minutes",lineWidth:27},0).wait(2).to({text:"15 minutes"},0).wait(12).to({lineWidth:28},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,33.8,10);
...
(lib.phone_vector = function(mode,startPosition,loop) {
	...
	this.shape_7.setTransform(257.9423,22.8986,2.7405,2.5717);
...
(lib.icon = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(38.45,70.85,0.6053,0.6053);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(38.5,70.9,41.7,41.69999999999999), null);
...
(lib.ClipGroup = function(mode,startPosition,loop) {
	...
	this.topTxt3 = new cjs.Text("Personal-Budger-Sample", "15px 'Segoe Pro'", "#FFFFFF");
	...
	// grid
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#999999").ss(3.5,1,1).p("");
	this.shape.setTransform(445.675,858.625);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#999999").ss(2,1,1).p("EAlRhflIAAoWEgG+hflIAAoWEAYjhflIAAoWEguQhflIAAoWEg3dBV1IsFAAEAtIBn8IAAxyEBDjBV1Mh69AAA");
	this.shape_1.setTransform(445.675,918.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// icons
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#464646").s().p("ACBAgQgNgMAAgUQAAgSANgOQANgNAUAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgUAAgNgOgAggAgQgNgMAAgUQAAgSANgOQANgNATAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgTAAgNgOgAjCAgQgNgMAAgUQAAgSANgOQANgNAUAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgUAAgNgOg");
	this.shape_2.setTransform(809.425,1514.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#3F3F3F").p("AAOALIgbAAQgGAAAAgGIAAgJQAAgFAGAAIAbAAQAGAAAAAFIAAAJQAAAGgGAAg");
	this.shape_3.setTransform(71.1483,1531.932,5.4856,5.4856);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#3F3F3F").p("AAAgKIAAAV");
	this.shape_4.setTransform(82.6457,1529.17,5.4738,5.4738);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#3F3F3F").p("Ag1AAIBrAA");
	this.shape_5.setTransform(90.1721,1502.0749,5.4738,5.4738);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#3F3F3F").p("AAAgjIAABI");
	this.shape_6.setTransform(88.9405,1501.6644,5.4738,5.4738);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#3F3F3F").p("AAOALIgbAAQgFAAAAgFIAAgKQAAgFAFAAIAbAAQAFAAAAAFIAAAKQAAAFgFAAg");
	this.shape_7.setTransform(93.502,1531.932,5.4856,5.4856);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#92BCA6").s().p("AgNALQgGAAABgGIAAgJQgBgGAGABIAcAAQAEgBAAAGIAAAJQAAAGgEAAg");
	this.shape_8.setTransform(93.502,1531.932,5.4856,5.4856);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#3F3F3F").p("AAwAmIhgAAQgFAAAAgGIAAg/QAAgGAFAAIBgAAQAGAAAAAGIAAA/QAAAGgGAAg");
	this.shape_9.setTransform(90.7592,1504.9156,5.4856,5.4856);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgwAmQgFAAAAgGIAAg/QAAgGAFAAIBgAAQAGAAAAAGIAAA/QAAAGgGAAg");
	this.shape_10.setTransform(90.7592,1504.9156,5.4856,5.4856);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#525252").s().p("");
	this.shape_11.setTransform(220.7693,1509.8882,5.3745,5.3745);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#3F3F3F").ss(0.8).p("AANgJIgNAOIgMgN");
	this.shape_12.setTransform(250.511,1527.5876,5.3745,5.3745);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#3F3F3F").ss(0.8).p("AAAgpIAABT");
	this.shape_13.setTransform(250.5978,1505.7226,5.3745,5.3745);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#92BCA6").p("AAdAOIg4AAQgGAAAAgFIAAgQQAAgGAGAAIA4AAQAGAAAAAGIAAAQQAAAFgGAAg");
	this.shape_14.setTransform(220.7693,1492.8238,5.3745,5.3745);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#92BCA6").s().p("AgcAOQgFABAAgGIAAgQQAAgHAFAAIA5AAQAGAAgBAHIAAAQQABAGgGgBg");
	this.shape_15.setTransform(220.7693,1492.8238,5.3745,5.3745);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#525252").s().p("");
	this.shape_16.setTransform(220.7693,1510.4244,5.3745,5.3745);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#3F3F3F").p("AARAAIghAA");
	this.shape_17.setTransform(374.3128,1501.1097,5.38,5.38);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#3F3F3F").p("ABxjEQA3AAAEAfQAFATgRAXQgSAZgyA5QgJAJgJAKQgPAQgQARIAACbQAAAhgvgCQgVgDgJgOIgFgQIAAiVQhZhBgkhGQgOgYAJgTQAMgcA5gCg");
	this.shape_18.setTransform(375.85,1513.7,1.1412,1.1412,0,0,0,1,0.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#9E83BF").s().p("Ag1BKIAAgLIBRh4IAAAAIhKAAIAAgQIBjAAIAAALIhRB3IAAABIBSAAIAAAQg");
	this.shape_19.setTransform(335.625,1531.675);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#71A7D8").s().p("AAqBKIgQguIg0AAIgPAuIgUAAIAyiTIAWAAIAzCTgAAWANIgPgqIgEgOIgDgNIgDANIgEAOIgPAqIAsAAg");
	this.shape_20.setTransform(334.625,1504.225);
	...
	this.shape_21.setTransform(496.1768,1499.5619,5.3893,5.3893);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#3F3F3F").s().p("Ag2AOIAAgbIBtAAIAAAbg");
	this.shape_22.setTransform(494.5916,1530.877,5.3972,5.3972);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#3F3F3F").s().p("");
	this.shape_23.setTransform(619.6464,1507.7372,5.2288,5.2288);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2}]}).wait(1));

	// UI_BG
	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("ABVDfIjMjNQgHgIAAgKQAAgJAHgHIDMjOQAHgGAKgBQALABAHAGQAHAIAAAKQAAAKgHAHIi7C7IC7C8QAHAHAAALQAAAJgHAIQgHAGgLAAQgKAAgHgGg");
	this.shape_24.setTransform(49.2509,121.1021);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("ACBAgQgNgMAAgUQAAgSANgOQANgNAUAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgUAAgNgOgAggAgQgNgMAAgUQAAgSANgOQANgNATAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgTAAgNgOgAjCAgQgNgMAAgUQAAgSANgOQANgNAUAAQAUAAANANQANAOAAASQAAAUgNAMQgNAOgUAAQgUAAgNgOg");
	this.shape_25.setTransform(831.3877,126.5017);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#484B4B").ss(1.5,1,1).p("Ag9gbIA9A5IA+g7");
	this.shape_26.setTransform(832.0961,210.9596,1.961,1.961);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#C6C6C6").ss(1,2,1).p("AAAidIAAE7");
	this.shape_27.setTransform(113.9183,214.4405,1.961,1.961);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#777777").s().p("");
	this.shape_28.setTransform(65.0627,215.1262,1.6329,1.6329);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#777777").ss(0.8).p("");
	this.shape_29.setTransform(78.5474,223.2094,2.9431,2.9431);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#777777").s().p("");
	this.shape_30.setTransform(78.5235,223.2789,2.9431,2.9431);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#C6C6C6").ss(1,1,1).p("Egg/gCtMBB/AAAQAeAAAAAeIAAEfQAAAegeAAMhB/AAAQgeAAAAgeIAAkfQAAgeAeAAg");
	this.shape_31.setTransform(442.6224,214.4895,1.9612,1.961);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("Egg/ACuQgeAAAAgeIAAkfQAAgeAeAAMBB/AAAQAeAAAAAeIAAEfQAAAegeAAg");
	this.shape_32.setTransform(442.6224,214.4895,1.9612,1.961);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#FFFFFF").ss(1.5,1,0,3).p("Ahfg9ICMAAQAaAAANATQANARgBAZQgBAZgNASQgOATgXAAIgWAA");
	this.shape_33.setTransform(431.9408,135.6545,1.9603,1.9603);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("#FFFFFF").ss(1.5,1,0,3).p("AAhg9Ig+A9IA+A/");
	this.shape_34.setTransform(417.7599,123.7947,1.9603,1.9603);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#F2F2F2").s().p("");
	this.shape_35.setTransform(537.5514,134.9269,1.9461,1.9461);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#F2F2F2").s().p("ABUCWIgghfIhpAAIggBfIgnAAIBmkrIAuAAIBmErgAAtAaIgehWIgJgcIgGgbIAAAAIgIAbIgIAcIgdBWIBaAAg");
	this.shape_36.setTransform(522.4,133.05);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("#FFFFFF").ss(2.5,1,0,3).p("AA7A9Ih1h5");
	this.shape_37.setTransform(645.0348,140.6772);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f().s("#FFFFFF").ss(2.5,1,0,3).p("ACcAAQAABAguAuQguAuhAAAQg/AAguguQguguAAhAQAAg/AuguQAuguA/AAQBAAAAuAuQAuAuAAA/g");
	this.shape_38.setTransform(628.0346,123.7269);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#FFFFFF").s().p("AAGATQgHAAgHABIgOAEIgMAIQgGADgFAGIAAgHQAAgIACgGIAFgNQADgGAEgDIALgIQAEgDAIgDIAOgCIAAgWIAoAoIgoApgAgFgJIgGACIgJAGQgEABgEAFIgGAJQgCAEgBAGQAJgGALgDQALgEAMAAIAHAAIAAAMIAXgXIgXgWIAAAMIgGAAg");
	this.shape_39.setTransform(735.8216,121.2731,4.2475,4.2475);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#FFFFFF").s().p("AhYBAIAAh/IAMAAIAABzICaAAIAAglIALAAIAAAxg");
	this.shape_40.setTransform(725.0829,137.936,1.995,1.995);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#E6E6E6").s().p("EhEmALZIAA2xMCJNAAAIAAWxg");
	this.shape_41.setTransform(433.35,237.45);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#257247").s().p("EhEmAMOIAA4bMCJNAAAIAAYbg");
	this.shape_42.setTransform(433.3566,86.3513);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#FFFFFF").s().p("EgGiBa3MAAAi1tINFAAMAAAC1tg");
	this.shape_43.setTransform(48.375,886.475);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup, new cjs.Rectangle(-5.8,8.2,885.5999999999999,1576.1), null);
...
(lib.Calories_txt = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.txt8 = new cjs.Text("14.2%", "4px 'Segoe Pro'", "#F05824");
	this.txt8.name = "txt8";
	this.txt8.lineHeight = 7;
	this.txt8.parent = this;
	this.txt8.setTransform(-9.95,14.9);
...
}).prototype = getMCSymbolPrototype(lib.Calories_txt, new cjs.Rectangle(-12,-4.2,30.1,26.5), null);
...
(lib.Calories = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.txt6).wait(7).to({text:"125 calories",lineWidth:31},0).wait(2).to({text:"265 calories",lineWidth:30},0).wait(2).to({text:"706 calories"},0).wait(2).to({text:"995 calories"},0).wait(2).to({text:"1,271 calories"},0).wait(2).to({text:"1,526 calories"},0).wait(2).to({text:"1,755 calories"},0).wait(2).to({text:"1,950 calories",lineWidth:31},0).wait(2).to({text:"2,099 calories"},0).wait(2).to({text:"2,152 calories",lineWidth:30},0).wait(2).to({text:"2,187 calories"},0).wait(2).to({text:"2,200 calories",lineWidth:31},0).wait(12).to({lineWidth:32},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-5.2,35.6,10);
...
(lib.Spa_chart = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(306.4617,68.2892,2.4661,2.4661);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(298,338.75,0.3351,0.3351,0,0,0,-39.7,1.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:5.5415,scaleY:5.5415,x:298.05,y:338.5},13,cjs.Ease.quadOut).to({x:78.15},12,cjs.Ease.quadInOut).to({_off:true},1).wait(49));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(78.9,331.85,5.5415,5.5415,0,0,0,0.1,0.2);
...
p.nominalBounds = new cjs.Rectangle(-1160,-67.6,1943.5,816.4);
...
(lib.graphs = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#2680BE").s().p("");
	this.shape.setTransform(62.8202,516.7401,2.3917,2.3917);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2680BE").s().p("AgjAlQgKAAgHgHQgHgHAAgKQAAgKAHgGQAHgHAKAAIAwAAIALgaQAJAUATAMIAIAEIgGAPQgEAKgJAGQgJAGgLAAg");
	this.shape_1.setTransform(36.0088,527.9508,2.3917,2.3917);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#2680BE").s().p("AgYAZQgLgKAAgPQAAgOALgKQAKgLAOAAQAPAAAKALQALAKAAAOQAAAPgLAKQgKALgPAAQgOAAgKgLg");
	this.shape_2.setTransform(69.9715,471.2666,2.3917,2.3917);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AueT6QCriVDVhHQDPhEDaAOQDaAPDEBfQDLBiCWCrQCWCrBHDWQBEDPgODbQgPDahfDFQhiDKiqCVg");
	mask.setTransform(77.563,295.615);

	// Blue_circle
	this.instance = new lib.blue_circle();
	this.instance.parent = this;
	this.instance.setTransform(57.8,507.55,0.8879,0.8879,0,0,0,125.9,126);
	...
	this.instance_1 = new lib.grey_circle();
	this.instance_1.parent = this;
	this.instance_1.setTransform(57.8,507.55,0.8879,0.8879,0,0,0,125.9,126);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Exercise_Minutes
	this.instance_2 = new lib.runtime_txt("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(69.2,776.85,8.5532,8.5532,0,0,0,13.6,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Carrot
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F15925").s().p("AgpAwIgGgGQgZgaACgfQABghAcgXQAWASAGAZQAGAZgLAWQAWgLAZAGQAZAGASAWQgXAcghABIgEABQgdAAgYgYg");
	this.shape_3.setTransform(362.9239,475.2142,2.3969,2.3969);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#F15925").s().p("Ah+CJQgGgCgDgHQgDgHADgHIBgjEIAlAmQACADAGAAQAFAAADgDQAEgEAAgFQAAgEgEgEIgogpQAUgZAegHQAggHAdAOQAjARAMAkQANAlgRAiQgOAcgdAOIhMAlIgqgqQgDgEgFAAQgFAAgEAEQgDADAAAFQAAAFADADIAlAlIhkAxQgDACgEAAIgGgBg");
	this.shape_4.setTransform(321.3843,516.7876,2.3969,2.3969);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("EgAnAj9QAfjiBxjDQBvi8CviGQCviGDTg6QDbg9DiAeQDjAeDEB0QC9BvCGCuQCGCvA6DTQA7DagdDig");
	mask_1.setTransform(219.9663,259.5912);

	// orange_circles
	this.instance_3 = new lib.orange_circle();
	this.instance_3.parent = this;
	this.instance_3.setTransform(327.05,505.1,0.8927,0.8927,0,0,0,126.1,126);
	...
	// Grey_circle copy
	this.instance_4 = new lib.grey_circle();
	this.instance_4.parent = this;
	this.instance_4.setTransform(327.05,505.1,0.8927,0.8927,0,0,0,126.1,126);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

	// Calories
	this.instance_5 = new lib.Calories_txt("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(338.65,782.45,8.5532,8.5532);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	// Spa
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E52465").s().p("AglBlQgfgIgZgZQgZgXgKghQgHgSAAgUQAAgDAEAAQAUAAAVAGQAkAKAYAWQAVATAJAaQAMgbAUgSQAYgWAjgKQAVgGAUAAQABAAABAAQABAAAAABQABAAAAABQAAABAAAAQAAAUgGASQgLAhgZAXQgaAZgeAIQgRAFgVAAQgVAAgQgFgAgUgBQgNgMgPgJQALgzAjgfQACgDAEADQAhAeANA0QgQAJgNANQgMAJgJANQgKgOgKgJg");
	this.shape_5.setTransform(609.1935,508.243,3.0649,3.0649);
	...
	mask_2._off = true;
	mask_2.graphics.p("AbxTtQCtiSDXhDQDQhBDbASQDbATDCBiQDKBmCTCuQCTCuBDDYQBBDQgSDbQgSDahjDDQhmDJisCSg");
	mask_2.setTransform(361.8824,297.1271);

	// pink_circle
	this.instance_6 = new lib.pink_circle();
	this.instance_6.parent = this;
	this.instance_6.setTransform(609.95,507.8,0.8667,0.8667,0,0,0,126,126);
	...
	// Grey_circle copy 2
	this.instance_7 = new lib.grey_circle();
	this.instance_7.parent = this;
	this.instance_7.setTransform(609.95,507.8,0.8667,0.8667,0,0,0,126,126);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

	// Me_time
	this.instance_8 = new lib.Me_time_txt("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(621.7,777.75,8.5532,8.5532,0,0,0,12.5,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1));

	// Bed
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4355A5").s().p("AB4BVQgGAAAAgHIAAgVIjjAAIAAAVQAAAHgHAAIgOAAQgHAAAAgHIAAibQAAgHAHAAIAOAAQAHAAAAAHIAABbIBjAAIAAg/QAAgHAIAAIBiAAQAUAAAPAPQAPAOAAAVIAABUQAAAHgHAAgAhYgJQgLgLAAgPQAAgOALgLQAKgKAPAAQAPAAAKAKQALALAAAOQAAAPgLALQgKAJgPAAQgPAAgKgJg");
	this.shape_6.setTransform(889.9289,507.6639,2.4294,2.4294);
	...
	mask_3._off = true;
	mask_3.graphics.p("EA8RANLQDmgHDVBSQDOBQCiCZQCjCYBcDJQBgDQAHDnQAHDohTDVQhQDPiYCiQiYCijKBdQjPBfjmAIg");
	mask_3.setTransform(502.6471,311.4528);

	// purple_circle
	this.instance_9 = new lib.purple();
	this.instance_9.parent = this;
	this.instance_9.setTransform(889.6,508.1,0.8795,0.8795,0,0,0,126,126);
	...
	// Grey_circle copy 3
	this.instance_10 = new lib.grey_circle();
	this.instance_10.parent = this;
	this.instance_10.setTransform(889.6,508.1,0.8795,0.8795,0,0,0,126,126);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1));

	// sleep_hours
	this.instance_11 = new lib.sleep_txt("synched",0,false);
	this.instance_11.parent = this;
	this.instance_11.setTransform(894.1,777.75,8.5532,8.5532,0,0,0,10.8,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1));

	// Text
	this.instance_12 = new lib.txt();
	this.instance_12.parent = this;
	this.instance_12.setTransform(466.95,457.7,8.5532,8.5532,0,0,0,60.1,35.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1));

	// Bar
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4354A4").s().p("AuXDLIAAmVIcvAAIAAGVg");
	this.shape_7.setTransform(891.4738,707.8436,1.5531,1.6327);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E42364").s().p("AtuDLIAAmVIbdAAIAAGVg");
	this.shape_8.setTransform(612.1153,707.8436,1.5531,1.6327);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#F05824").s().p("At4DLIAAmVIbxAAIAAGVg");
	this.shape_9.setTransform(337.6102,707.8436,1.5531,1.6327);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#2680BE").s().p("A2EFLIAAqVMAsJAAAIAAKVg");
	this.shape_10.setTransform(58.3,707.85);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.graphs, new cjs.Rectangle(-83,254.6,1117.4,766.5), null);
...
(lib.bottombar_2 = function(mode,startPosition,loop) {
	...
	this.shape_97.setTransform(90.1905,2.8008,0.3974,0.5559);
...
}).prototype = getMCSymbolPrototype(lib.softwarevector, new cjs.Rectangle(0.9,10.5,767.4,1365.9), null);
...
(lib.screen = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(80).call(this.frame_80).wait(26).call(this.frame_106).wait(3));

	// Exercise
	this.instance = new lib.Run_chart("synched",0,false);
	this.instance.parent = this;
	this.instance.setTransform(19.3,-145.3,0.102,0.102,0,0,0,-226.5,66.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({startPosition:7},0).to({_off:true},107).wait(1));

	// Exercise_Minutes
	this.instance_1 = new lib.minutes("single",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(19.35,-113.8,1,1,0,0,0,13.6,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({mode:"synched",loop:false},0).to({_off:true},107).wait(1));

	// Carrots
	this.instance_2 = new lib.Carrot_chart("single",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(50.45,-143.6,0.102,0.102,0,0,0,30.4,83.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(23).to({mode:"synched",startPosition:7,loop:false},0).to({_off:true},85).wait(1));

	// Calories
	this.instance_3 = new lib.Calories("single",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(50.85,-113.15);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({mode:"synched",loop:false},0).to({_off:true},85).wait(1));

	// Spa
	this.instance_4 = new lib.Spa_chart("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(81.5,-144.9,0.102,0.102,0,0,0,306.4,70.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(45).to({mode:"synched",startPosition:7,loop:false},0).to({_off:true},63).wait(1));

	// Me_time
	this.instance_5 = new lib.Me_time("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(83.95,-113.7,1,1,0,0,0,12.5,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(45).to({mode:"synched",loop:false},0).to({_off:true},63).wait(1));

	// Bed
	this.instance_6 = new lib.bed_chart("single",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(112.75,-145.55,0.102,0.102,0,0,0,614.3,64.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(70).to({mode:"synched",startPosition:7,loop:false},0).to({_off:true},38).wait(1));

	// sleep_hours
	this.instance_7 = new lib.sleep_hours("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(115.8,-113.7,1,1,0,0,0,10.8,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(70).to({mode:"synched",loop:false},0).to({_off:true},38).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},108).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[]},108).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-166.5,133.3,58.2);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1A7041").s().p("Ap2CjIAAlFITtAAIAAFFg");
...
(lib.mobile_cache = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// screen_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AjZGKIAAsTIGzAAIAAMTg");
	mask.setTransform(42.4,45.925);

	// screen
	this.screen = new lib.screen_new();
	this.screen.name = "screen";
	this.screen.parent = this;
	this.screen.setTransform(47.55,16.8,0.0586,0.0586,0,0,0,469.9,182.5);
	...
	this.laptop.name = "laptop";
	this.laptop.parent = this;
	this.laptop.setTransform(42.5,17.2,0.1546,0.1518,0,0,0,156.9,107);
	...
	this.shadow.setTransform(41.3,85.05,0.1434,0.1434,0,0,0,294.2,48.1);

	this.timeline.addTween(cjs.Tween.get(this.shadow).wait(1));

}).prototype = getMCSymbolPrototype(lib.mobile_cache, new cjs.Rectangle(-0.9,0.8,84.4,91), null);
...
(lib.devices = function(mode,startPosition,loop) {
	...
	this.screen.name = "screen";
	this.screen.parent = this;
	this.screen.setTransform(181.1,189.75,0.9988,0.9988,0,0,0,68.6,-161.7);
...
}).prototype = getMCSymbolPrototype(lib.devices, new cjs.Rectangle(83.7,149.1,183.2,110.00000000000003), null);
...
(lib.anim_blue = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("ApKPXIAAwQIbzAAIAAQQg");
	mask.setTransform(119.3018,98.2674);

	// Devices
	this.devices = new lib.devices();
	this.devices.name = "devices";
	this.devices.parent = this;
	this.devices.setTransform(154.2,634.6,1,1,0,0,0,181.6,696.4);
...
}).prototype = getMCSymbolPrototype(lib.anim_blue, new cjs.Rectangle(-39.6,70.9,375.6,156.5), null);
...
(lib.mobile_device = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.mobile.cache(-90,-95,180,190,1.8)
	}
	...
	// mobile
	this.mobile = new lib.mobile_cache();
	this.mobile.name = "mobile";
	this.mobile.parent = this;
	this.mobile.setTransform(120.15,69.6,1,1,0,0,0,41.7,45.8);

	this.timeline.addTween(cjs.Tween.get(this.mobile).wait(1));

}).prototype = getMCSymbolPrototype(lib.mobile_device, new cjs.Rectangle(77.6,24.6,84.4,91), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(43.3,220.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(78.4,221.05,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.mobile_device.setTransform(160.85,198.5,1,1,0,0,0,116.5,72.5);
	...
	this.logo_1.setTransform(46.25,22.4,1,1,0,0,0,0.4,0.7);
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#ECEDEF","#FFFFFF"],[0,1],5.7,122.5,5.9,72.2).s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
	this.shape.setTransform(150,125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-39.6,-1.4,375.6,254.70000000000002), null);


// stage content:
(lib.O365_NewYearCampaign_USA_300x250_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(devices, 2, {x: "+=300", ease:Power3.easeOut}, "-=0.5");
				...
				exportRoot.tl1.to(exportRoot.headline5, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0");
		
				//in Excel
				exportRoot.tl1.from(exportRoot.headline6, 0.01, {alpha: 0, ease:Power4.easeOut}, "+=0");
				exportRoot.tl1.from(exportRoot.headline7, 0.01, {alpha: 0, ease:Power4.easeOut,onComplete:function(){laptop.screen.gotoAndPlay(1);exportRoot.tl1.stop()}}, "+=.2");
				
				exportRoot.tl1.to(exportRoot.headline6, 0.5, {alpha: 0, ease:Power4.easeIn}, "+=0.2");
				exportRoot.tl1.to(exportRoot.headline7, 0.5, {alpha: 0, ease:Power4.easeIn}, "-=0.5");
				
				//exportRoot.tl1.to(devices, 0.1, {scaleX: 1, scaleY: 1, ease:Power3.easeInOut,onComplete:function(){laptop.screen.gotoAndPlay(1);exportRoot.tl1.stop()}}, "-=1.3");
		
				
				exportRoot.tl1.to(devices, 1.75, {x:"+=105", y:"+=6", scaleX:1, scaleY:1, ease:Power3.easeInOut}, "-=.3");
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline11[i], 0.8, { x: "-=300", alpha: 0, ease:Power4.easeOut}, "-=0.6");
...
p.nominalBounds = new cjs.Rectangle(110.4,123.6,225.6,129.70000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_300x250_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574432962726", id:"O365_NewYearCampaign_USA_300x250_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
