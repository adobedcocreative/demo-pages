...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_300x600_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[355,117,336,51],[0,0,757,115],[0,117,353,196],[759,0,45,45]]}
];
...
(lib.Bitmap3 = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_300x600_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.topbar_cache = function(mode,startPosition,loop) {
	...
	this.shape_8.setTransform(30.8389,105.4306,0.1369,0.1369);
	...
	this.shape_9.setTransform(30.8389,105.4306,0.1369,0.1369);
...
(lib.mobile_device = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(37,36.7,0.8384,0.8384);
	...
	this.shape.setTransform(138.95,146.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mobile_device, new cjs.Rectangle(37,36.7,296,164.39999999999998), null);
...
(lib.lines = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#436AA6").ss(0.2,1,1).p("AitgjIFbAAAitAkIFbAA");
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1D60BF").s().p("ApwCjIAAlFIThAAIAAFFg");
	this.shape.setTransform(-21.025,-1.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-83.5,-17.5,125,32.6), null);
...
(lib.bottom_barc = function(mode,startPosition,loop) {
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(114.65,-91.5,0.1341,0.1341,0,0,0,5.6,7.9);
	...
	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#000000").s().p("AuCAdIAAg5IcFAAIAAA5g");
	this.shape_73.setTransform(155.075,-91.45);
	...
	this.shape_118.setTransform(155.4698,-95.6125,0.3973,0.3987);
...
(lib.bottombar = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.bar.cache(-300,-250,600,500,2)
	}
...
(lib.devices = function(mode,startPosition,loop) {
	...
	this.screen.setTransform(151.35,189.75,0.9988,0.9988,0,0,0,68.6,-161.7);
	...
	this.scroll_bar.setTransform(191.05,204.45,1,1,0,0,0,1.2,40.7);
	...
	this.resume_1.setTransform(96.35,167.4,0.8307,0.8307,0,0,0,-53.7,-44.1);
...
}).prototype = getMCSymbolPrototype(lib.devices, new cjs.Rectangle(87.2,148.7,181.5,112.5), null);
...
(lib.anim_blue = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("At5H1IAAvpIbzAAIAAPpg");
	mask.setTransform(149.775,142.525);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(226.05,555.45,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(261.15,556,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.mobile_device.setTransform(-117.8,301.6);
	...
	this.anim_1.setTransform(-22.85,119.3,1.5351,1.5351);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-83.6,-1.4,576.6,606.1), null);


// stage content:
(lib.O365_NewYearCampaign_USA_300x600_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline6, 0.5, {alpha: 0, ease:Power4.easeIn}, "+=0.1");
				exportRoot.tl1.to(exportRoot.headline7, 0.5, {alpha: 0, ease:Power4.easeIn}, "-=0.5");
				
				//exportRoot.tl1.to(devices, 0.1, {ease:Power3.easeInOut,onComplete:function(){laptop.screen.gotoAndPlay(1);exportRoot.tl1.stop()}}, "-=1");
...
p.nominalBounds = new cjs.Rectangle(66.4,298.6,426.6,306.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_300x600_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574940260614", id:"O365_NewYearCampaign_USA_300x600_BAN_Word_Resume_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
