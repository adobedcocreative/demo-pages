...
lib.ssMetadata = [
		{name:"O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[285,117,336,51],[759,0,69,69],[0,0,757,115],[0,117,283,148]]}
];
...
(lib.Bitmap3 = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.mobile_device_shadows = function() {
	this.initialize(ss["O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.topbar_2 = function(mode,startPosition,loop) {
	...
	this.shape_16.setTransform(17.7531,209.2337,0.1369,0.1369);
	...
	this.shape_19.setTransform(7.5201,209.7404,0.1369,0.1369);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#207346").s().p("AgyAoIAAhPIAGAAIAABIIBZAAIAAgoIAFAAIAAAvg");
	this.shape_20.setTransform(7.2566,210.3494,0.1369,0.1369);
	...
	this.shape_21.setTransform(10.0519,210.0791,0.1369,0.1369);
	...
	this.shape_22.setTransform(10.0519,210.0791,0.1369,0.1369);
...
(lib.sleep_hours = function(mode,startPosition,loop) {
	...
	this.txt8.lineWidth = 16;
	this.txt8.parent = this;
	this.txt8.setTransform(2,2);

	this.timeline.addTween(cjs.Tween.get(this.txt8).wait(7).to({text:"0.7 hours",lineWidth:19},0).wait(2).to({text:"1.5 hours",lineWidth:20},0).wait(2).to({text:"2.3 hours"},0).wait(2).to({text:"3.1 hours",lineWidth:22},0).wait(2).to({text:"3.5 hours",lineWidth:21},0).wait(2).to({text:"4.4 hours",lineWidth:20},0).wait(2).to({text:"5.1 hours",lineWidth:22},0).wait(2).to({text:"5.3 hours",lineWidth:21},0).wait(2).to({text:"5.5 hours",lineWidth:20},0).wait(2).to({text:"6.0 hours",lineWidth:21},0).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,26,10);
...
(lib.mobile_device = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.mobile_device_shadows();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.8482,0.8482);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mobile_device, new cjs.Rectangle(0,0,240.1,125.6), null);
...
(lib.Me_time = function(mode,startPosition,loop) {
	...
	this.txt7.lineWidth = 20;
	this.txt7.parent = this;
	this.txt7.setTransform(2,2);

	this.timeline.addTween(cjs.Tween.get(this.txt7).wait(7).to({text:"2 minutes"},0).wait(2).to({text:"4 minutes",lineWidth:21},0).wait(2).to({text:"6 minutes"},0).wait(2).to({text:"8 minutes"},0).wait(2).to({text:"10 minutes",lineWidth:22},0).wait(2).to({text:"11 minutes",lineWidth:21},0).wait(2).to({text:"12 minutes"},0).wait(2).to({text:"13 minutes"},0).wait(2).to({text:"10 minutes"},0).wait(2).to({text:"14 minutes"},0).wait(2).to({text:"15 minutes",lineWidth:22},0).wait(12).to({lineWidth:23},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,27.2,10);
...
(lib.Calories = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.txt6).wait(7).to({text:"125 calories"},0).wait(2).to({text:"265 calories"},0).wait(2).to({text:"706 calories",lineWidth:25},0).wait(2).to({text:"995 calories",lineWidth:26},0).wait(2).to({text:"1,271 calories",lineWidth:25},0).wait(2).to({text:"1,526 calories",lineWidth:26},0).wait(2).to({text:"1,755 calories",lineWidth:25},0).wait(2).to({text:"1,950 calories",lineWidth:26},0).wait(2).to({text:"2,099 calories"},0).wait(2).to({text:"2,152 calories"},0).wait(2).to({text:"2,187 calories",lineWidth:25},0).wait(2).to({text:"2,200 calories",lineWidth:26},0).wait(13));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-5.2,30.1,10);
...
(lib.shadows = function(mode,startPosition,loop) {
	...
	this.shadow.setTransform(187.75,28.55,0.3954,0.3954,0,0,0,474.9,72.2);

	this.instance = new lib.Bitmap3();
	this.instance.parent = this;
	this.instance.setTransform(86.45,30.95,0.6245,0.6245);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shadow}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.shadows, new cjs.Rectangle(0,0,375.6,62.8), null);
...
(lib.logocopyc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.logo.setTransform(32.75,1.05,1,1,0,0,0,170.6,-129.1);

	this.timeline.addTween(cjs.Tween.get(this.logo).wait(1));

}).prototype = getMCSymbolPrototype(lib.logocopyc, new cjs.Rectangle(-30.7,-6.5,127.8,15.1), null);
...
(lib.bottombar_2 = function(mode,startPosition,loop) {
	...
	this.shape_97.setTransform(90.1698,2.7994,0.3973,0.5558);
...
p.nominalBounds = new cjs.Rectangle(0,-166.5,132.2,58.2);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1A7041").s().p("AogCjIAAlFIRBAAIAAFFg");
	this.shape.setTransform(-26.675,-1.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-81.2,-17.5,109.1,32.6), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(49).call(this.frame_49).wait(26).call(this.frame_75).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.4931,scaleY:4.4931,x:981.05,y:80.85},13,cjs.Ease.quadOut).to({x:802.75},12,cjs.Ease.quadInOut).to({_off:true},1).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:982.9},12,cjs.Ease.quadInOut).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({x:-1361.35},21,cjs.Ease.quadIn).to({_off:true},3).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(53).to({x:-1361.35},21,cjs.Ease.quadIn).to({_off:true},1).wait(1));
...
(lib.anim_blue = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(148.2,194.8,1,1,0,0,0,187.8,31.4);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(711.35,4.3,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(668.9,60.2,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(704,60.75,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.mobile_device.setTransform(117.85,28.55,0.5024,0.5024,0,0,0,0,0.1);
	...
	this.anim_1.setTransform(224.4,44.8,0.51,0.51,0,0,0,152,148.6);

	this.timeline.addTween(cjs.Tween.get(this.anim_1).wait(1));

	// logo
	this.logo_1 = new lib.logocopyc();
	this.logo_1.name = "logo_1";
	this.logo_1.parent = this;
	this.logo_1.setTransform(47.05,23.4,1,1,0,0,0,0.4,0.7);

	this.timeline.addTween(cjs.Tween.get(this.logo_1).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#ECEDEF","#FFFFFF"],[0,1],-9.3,44.1,-8.8,26).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape.setTransform(364,45);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.9,-1.4,733.1,99), null);


// stage content:
(lib.O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				//exportRoot.tl1.from(mobile, 2, {x:"+=300", ease:Power3.easeOut}, "-=2.1");
				...
				exportRoot.tl1.to(exportRoot.headline1, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.8");
				...
				exportRoot.tl1.from(exportRoot.headline7, 0.01, {alpha: 0, ease:Power4.easeOut}, "+=.25");
				...
				exportRoot.tl1.to(mobile, 0.1, {ease:Power3.easeInOut,onComplete:function(){laptop.screen.gotoAndPlay(1);exportRoot.tl1.stop()}}, "-=1");
		
		
				
				//exportRoot.tl1.to(shadow, 1.75, {alpha: 0.2, ease:Power3.easeInOut}, "-=.75");
				exportRoot.tl1.from(mobile, 0.8, {x:"-=50",alpha: 0, ease:Power3.easeOut}, "-=0");
		
						
				for (var i = 0; i < exportRoot.headline11.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline11[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=0.1");
...
p.nominalBounds = new cjs.Rectangle(363.1,43.6,369.1,53.99999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574435153305", id:"O365_NewYearCampaign_USA_728x90_BAN_Excel_Fitness_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
