...
lib.ssMetadata = [
		{name:"M365_FY21Q1_BTS_USA_300x250_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_300x250_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(11.8002,1.8);
...
}).prototype = getMCSymbolPrototype(lib.stripes_c, new cjs.Rectangle(-1.1,-1,25.900000000000002,3.8), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AFnTFIBEi+INtE4IhEC/g");
	var mask_graphics_1 = new cjs.Graphics().p("AFnTFIBEi+INtE4IhEC/g");
	var mask_graphics_2 = new cjs.Graphics().p("AFnTFIBEjAINtE5IhEDAg");
	var mask_graphics_3 = new cjs.Graphics().p("AFmTFIBGjEINtE5IhGDEg");
	var mask_graphics_4 = new cjs.Graphics().p("AFlTFIBJjLINsE4IhJDMg");
	var mask_graphics_5 = new cjs.Graphics().p("AFjTFIBNjYINsE4IhNDZg");
	var mask_graphics_6 = new cjs.Graphics().p("AFfTFIBUjrINtE4IhUDsg");
	var mask_graphics_7 = new cjs.Graphics().p("AFbTFIBdkGINsE4IhdEGg");
	var mask_graphics_8 = new cjs.Graphics().p("AFUTFIBqkqINtE5IhqEpg");
	var mask_graphics_9 = new cjs.Graphics().p("AFMTFIB7lXINsE4Ih6FXg");
	var mask_graphics_10 = new cjs.Graphics().p("AFCTFICPmQINsE4IiOGQg");
	var mask_graphics_11 = new cjs.Graphics().p("AE2TEICnnVINtE4IioHWg");
	var mask_graphics_12 = new cjs.Graphics().p("AEnTEIDFopINtE5IjFIog");
	var mask_graphics_13 = new cjs.Graphics().p("AEWTEIDoqLINsE4IjoKLg");
	var mask_graphics_14 = new cjs.Graphics().p("AEBTDIERr9INtE4IkRL+g");
	var mask_graphics_15 = new cjs.Graphics().p("ADqTDIFAuCINsE4IlAOCg");
	var mask_graphics_16 = new cjs.Graphics().p("ADPTCIF2wZINtE4Il2Qag");
	var mask_graphics_17 = new cjs.Graphics().p("ACxTCIGzzEINsE4ImzTEg");
	var mask_graphics_18 = new cjs.Graphics().p("ACPTBIH32EINtE3In4WFg");
	var mask_graphics_19 = new cjs.Graphics().p("ABpTAIJE5bINsE4IpEZcg");
	var mask_graphics_20 = new cjs.Graphics().p("AA+S/IKa9LINsE5IqadLg");
	var mask_graphics_21 = new cjs.Graphics().p("AAPS+MAL4ghTINtE4MgL4AhUg");
	var mask_graphics_22 = new cjs.Graphics().p("AgjS9MANfgl2INsE5MgNgAl2g");
	var mask_graphics_23 = new cjs.Graphics().p("AhcS/MAPRgq1INsE4MgPRAq1g");
	var mask_graphics_24 = new cjs.Graphics().p("AibVsMARNgwQINsE5MgRNAwQg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:130.3595,y:153.3723}).wait(1).to({graphics:mask_graphics_1,x:130.3635,y:153.3723}).wait(1).to({graphics:mask_graphics_2,x:130.3898,y:153.3717}).wait(1).to({graphics:mask_graphics_3,x:130.4612,y:153.3704}).wait(1).to({graphics:mask_graphics_4,x:130.6003,y:153.3676}).wait(1).to({graphics:mask_graphics_5,x:130.8295,y:153.3631}).wait(1).to({graphics:mask_graphics_6,x:131.1716,y:153.3565}).wait(1).to({graphics:mask_graphics_7,x:131.649,y:153.3471}).wait(1).to({graphics:mask_graphics_8,x:132.2842,y:153.3347}).wait(1).to({graphics:mask_graphics_9,x:133.0998,y:153.3187}).wait(1).to({graphics:mask_graphics_10,x:134.1185,y:153.2988}).wait(1).to({graphics:mask_graphics_11,x:135.3627,y:153.2745}).wait(1).to({graphics:mask_graphics_12,x:136.855,y:153.2453}).wait(1).to({graphics:mask_graphics_13,x:138.618,y:153.2108}).wait(1).to({graphics:mask_graphics_14,x:140.6742,y:153.1705}).wait(1).to({graphics:mask_graphics_15,x:143.0463,y:153.1241}).wait(1).to({graphics:mask_graphics_16,x:145.7568,y:153.0711}).wait(1).to({graphics:mask_graphics_17,x:148.8284,y:153.011}).wait(1).to({graphics:mask_graphics_18,x:152.2835,y:152.9435}).wait(1).to({graphics:mask_graphics_19,x:156.1449,y:152.8679}).wait(1).to({graphics:mask_graphics_20,x:160.4351,y:152.784}).wait(1).to({graphics:mask_graphics_21,x:165.1768,y:152.6913}).wait(1).to({graphics:mask_graphics_22,x:170.3926,y:152.5893}).wait(1).to({graphics:mask_graphics_23,x:176.1052,y:152.2391}).wait(1).to({graphics:mask_graphics_24,x:182.2139,y:135.8056}).wait(24));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FEF000").ss(63,2,1).p("AlgQSMALCggj");
	this.shape.setTransform(262.25,132.175);
...
p.nominalBounds = new cjs.Rectangle(187,-12,150.60000000000002,288.4);
...
}).prototype = getMCSymbolPrototype(lib.stripes, new cjs.Rectangle(-0.9,-0.8,25.5,3.4000000000000004), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_26 = new cjs.Graphics().p("AAKhVIAAgaIALAAIAAAag");
	var mask_graphics_27 = new cjs.Graphics().p("AAJhVIAAgaIANAAIAAAag");
	var mask_graphics_28 = new cjs.Graphics().p("AAHhVIAAgaIARAAIAAAag");
	var mask_graphics_29 = new cjs.Graphics().p("AADhVIAAgaIAYAAIAAAag");
	var mask_graphics_30 = new cjs.Graphics().p("AgBhVIAAgaIAhAAIAAAag");
	var mask_graphics_31 = new cjs.Graphics().p("AgIhVIAAgaIAuAAIAAAag");
	var mask_graphics_32 = new cjs.Graphics().p("AgQhVIAAgaIA+AAIAAAag");
	var mask_graphics_33 = new cjs.Graphics().p("AgZhVIAAgaIBQAAIAAAag");
	var mask_graphics_34 = new cjs.Graphics().p("AgkhVIAAgaIBmAAIAAAag");
	var mask_graphics_35 = new cjs.Graphics().p("AgxhVIAAgaIB/AAIAAAag");
	var mask_graphics_36 = new cjs.Graphics().p("Ag/hVIAAgaICaAAIAAAag");
	var mask_graphics_37 = new cjs.Graphics().p("AhNhVIAAgaIC1AAIAAAag");
	var mask_graphics_38 = new cjs.Graphics().p("AhZhVIAAgaIDNAAIAAAag");
	var mask_graphics_39 = new cjs.Graphics().p("AhkhVIAAgaIDjAAIAAAag");
	var mask_graphics_40 = new cjs.Graphics().p("AhuhVIAAgaID2AAIAAAag");
	var mask_graphics_41 = new cjs.Graphics().p("Ah2hVIAAgaIEGAAIAAAag");
	var mask_graphics_42 = new cjs.Graphics().p("Ah8hVIAAgaIESAAIAAAag");
	var mask_graphics_43 = new cjs.Graphics().p("AiBhVIAAgaIEcAAIAAAag");
	var mask_graphics_44 = new cjs.Graphics().p("AiFhVIAAgaIEjAAIAAAag");
	var mask_graphics_45 = new cjs.Graphics().p("AiHhVIAAgaIEnAAIAAAag");
	var mask_graphics_46 = new cjs.Graphics().p("AiFhVIAAgaIEpAAIAAAag");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(26).to({graphics:mask_graphics_26,x:2.0991,y:-11.225}).wait(1).to({graphics:mask_graphics_27,x:2.1691,y:-11.225}).wait(1).to({graphics:mask_graphics_28,x:2.3791,y:-11.225}).wait(1).to({graphics:mask_graphics_29,x:2.7291,y:-11.225}).wait(1).to({graphics:mask_graphics_30,x:3.2192,y:-11.225}).wait(1).to({graphics:mask_graphics_31,x:3.8492,y:-11.225}).wait(1).to({graphics:mask_graphics_32,x:4.6193,y:-11.225}).wait(1).to({graphics:mask_graphics_33,x:5.5294,y:-11.225}).wait(1).to({graphics:mask_graphics_34,x:6.5794,y:-11.225}).wait(1).to({graphics:mask_graphics_35,x:7.7695,y:-11.225}).wait(1).to({graphics:mask_graphics_36,x:9.0996,y:-11.225}).wait(1).to({graphics:mask_graphics_37,x:10.4298,y:-11.225}).wait(1).to({graphics:mask_graphics_38,x:11.6199,y:-11.225}).wait(1).to({graphics:mask_graphics_39,x:12.6699,y:-11.225}).wait(1).to({graphics:mask_graphics_40,x:13.58,y:-11.225}).wait(1).to({graphics:mask_graphics_41,x:14.3501,y:-11.225}).wait(1).to({graphics:mask_graphics_42,x:14.9801,y:-11.225}).wait(1).to({graphics:mask_graphics_43,x:15.4702,y:-11.225}).wait(1).to({graphics:mask_graphics_44,x:15.8202,y:-11.225}).wait(1).to({graphics:mask_graphics_45,x:16.0302,y:-11.225}).wait(1).to({graphics:mask_graphics_46,x:16.4252,y:-11.225}).wait(15));
	...
	mask_1._off = true;
	var mask_1_graphics_22 = new cjs.Graphics().p("AAJhiIAAgbIALAAIAAAbg");
	var mask_1_graphics_23 = new cjs.Graphics().p("AAIhiIAAgbIANAAIAAAbg");
	var mask_1_graphics_24 = new cjs.Graphics().p("AAGhiIAAgbIARAAIAAAbg");
	var mask_1_graphics_25 = new cjs.Graphics().p("AAChiIAAgbIAZAAIAAAbg");
	var mask_1_graphics_26 = new cjs.Graphics().p("AgChiIAAgbIAhAAIAAAbg");
	var mask_1_graphics_27 = new cjs.Graphics().p("AgJhiIAAgbIAvAAIAAAbg");
	var mask_1_graphics_28 = new cjs.Graphics().p("AgRhiIAAgbIA+AAIAAAbg");
	var mask_1_graphics_29 = new cjs.Graphics().p("AgahiIAAgbIBRAAIAAAbg");
	var mask_1_graphics_30 = new cjs.Graphics().p("AglhiIAAgbIBmAAIAAAbg");
	var mask_1_graphics_31 = new cjs.Graphics().p("AgyhiIAAgbIB/AAIAAAbg");
	var mask_1_graphics_32 = new cjs.Graphics().p("Ag/hiIAAgbICZAAIAAAbg");
	var mask_1_graphics_33 = new cjs.Graphics().p("AhNhiIAAgbIC1AAIAAAbg");
	var mask_1_graphics_34 = new cjs.Graphics().p("AhahiIAAgbIDNAAIAAAbg");
	var mask_1_graphics_35 = new cjs.Graphics().p("AhlhiIAAgbIDjAAIAAAbg");
	var mask_1_graphics_36 = new cjs.Graphics().p("AhuhiIAAgbID1AAIAAAbg");
	var mask_1_graphics_37 = new cjs.Graphics().p("Ah2hiIAAgbIEFAAIAAAbg");
	var mask_1_graphics_38 = new cjs.Graphics().p("Ah9hiIAAgbIESAAIAAAbg");
	var mask_1_graphics_39 = new cjs.Graphics().p("AiChiIAAgbIEcAAIAAAbg");
	var mask_1_graphics_40 = new cjs.Graphics().p("AiGhiIAAgbIEjAAIAAAbg");
	var mask_1_graphics_41 = new cjs.Graphics().p("AiIhiIAAgbIEoAAIAAAbg");
	var mask_1_graphics_42 = new cjs.Graphics().p("AiGhiIAAgbIEqAAIAAAbg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(22).to({graphics:mask_1_graphics_22,x:2.0241,y:-12.575}).wait(1).to({graphics:mask_1_graphics_23,x:2.0941,y:-12.575}).wait(1).to({graphics:mask_1_graphics_24,x:2.3041,y:-12.575}).wait(1).to({graphics:mask_1_graphics_25,x:2.6541,y:-12.575}).wait(1).to({graphics:mask_1_graphics_26,x:3.1442,y:-12.575}).wait(1).to({graphics:mask_1_graphics_27,x:3.7742,y:-12.575}).wait(1).to({graphics:mask_1_graphics_28,x:4.5443,y:-12.575}).wait(1).to({graphics:mask_1_graphics_29,x:5.4544,y:-12.575}).wait(1).to({graphics:mask_1_graphics_30,x:6.5044,y:-12.575}).wait(1).to({graphics:mask_1_graphics_31,x:7.6945,y:-12.575}).wait(1).to({graphics:mask_1_graphics_32,x:9.0246,y:-12.575}).wait(1).to({graphics:mask_1_graphics_33,x:10.3548,y:-12.575}).wait(1).to({graphics:mask_1_graphics_34,x:11.5449,y:-12.575}).wait(1).to({graphics:mask_1_graphics_35,x:12.5949,y:-12.575}).wait(1).to({graphics:mask_1_graphics_36,x:13.505,y:-12.575}).wait(1).to({graphics:mask_1_graphics_37,x:14.2751,y:-12.575}).wait(1).to({graphics:mask_1_graphics_38,x:14.9051,y:-12.575}).wait(1).to({graphics:mask_1_graphics_39,x:15.3952,y:-12.575}).wait(1).to({graphics:mask_1_graphics_40,x:15.7452,y:-12.575}).wait(1).to({graphics:mask_1_graphics_41,x:15.9552,y:-12.575}).wait(1).to({graphics:mask_1_graphics_42,x:16.3502,y:-12.575}).wait(19));
...
if (reversed == null) { reversed = false; }
	...
	this.words.setTransform(145.05,-104.1,1.3504,1.3504,0,0,0,15.6,17.8);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(170.75,139.6,0.5308,0.4248,0,-28.3388,-17.0399,107.9,-133.7);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(170.85,139.75,0.5307,0.5307,0,0,0,126.9,71.9);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-19,-26,432.7,332.8), null);


// stage content:
(lib.M365_FY21Q1_BTS_USA_300x250_BAN_Editor_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.2, {x: "-=15",y: "-=4",scaleX: "0.551",scaleY: "0.451", ease:Power4.easeInOut}, "-=0.7");
				exportRoot.tl1.to(shadow, 1.2, {x: "-=15",y: "-=4",scaleX: "0.551",scaleY: "0.551", ease:Power4.easeInOut}, "-=1.2");
		
				
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "1.91",scaleY: "1.91", x: "-=7",y: "-=25",ease:Power4.easeInOut,onComplete:function(){screen.popup.gotoAndPlay(0);}}, "-=1.2");
				exportRoot.tl1.to(screen.popup.popup_shdw, 1.4, {x: "-=10",y: "+=10",alpha :0.5,ease:Power4.easeInOut}, "-=1.4");
				exportRoot.tl1.to(pencil, 1.4, {rotation: -15,scaleX: "1.2",scaleY: "1.2", x: "-=60",y: "+=80",ease:Power4.easeInOut}, "-=1.4");
				...
				exportRoot.tl1.to(pencil, 1.4, {y: "+=85",x: "-=20",ease:Power4.easeInOut}, "+=0.0");
			
				exportRoot.tl1.to(screen.words, 1.8, {y: "-=112",ease:Power4.easeInOut}, "-=0.8");		
				exportRoot.tl1.to(screen.words.communal, 0.1, {alpha :0,ease:Power1.easeInOut}, "-=1.1");
				exportRoot.tl1.to(screen.words.familiar, 0.1, {alpha :0,ease:Power1.easeInOut}, "-=0.9");
				exportRoot.tl1.to(screen.words.conversational, 0.8, {alpha :0,ease:Power1.easeInOut,onStart:function(){screen.popup.gotoAndPlay(50);}}, "-=0.6");
		
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "0.98",scaleY: "0.98", x: "+=7",y: "+=25",ease:Power4.easeInOut}, "-=0.4");
				...
				exportRoot.tl1.to(pencil, 1.4, {rotation: 0,scaleX: "0.21",scaleY: "0.21", x: "+=80",y: "-=165",ease:Power4.easeInOut}, "-=1.4");
		
				exportRoot.tl1.to(screen, 1.2, {x: "+=51",y: "+=31",scaleX: "0.56",scaleY: "0.448", ease:Power4.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "-=0.7");
				exportRoot.tl1.to(shadow, 1.2, {x: "+=51",y: "+=31",scaleX: "0.56",scaleY: "0.56", ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(131,99,282.7,207.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_300x250_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1.png?1593017275076", id:"M365_FY21Q1_BTS_USA_300x250_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
