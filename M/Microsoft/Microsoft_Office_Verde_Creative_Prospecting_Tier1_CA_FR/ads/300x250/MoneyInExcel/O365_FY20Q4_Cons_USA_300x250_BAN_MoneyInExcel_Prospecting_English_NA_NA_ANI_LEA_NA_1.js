...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_300x250_BAN_MoneyInExcel_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,220,120,111],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_300x250_BAN_MoneyInExcel_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:-0.1,regY:0.4,scaleX:2.4219,scaleY:2.4219,x:-17.75,y:2.25},41,cjs.Ease.quadInOut).to({_off:true},1).wait(9));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-41.3,-0.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.6,-16.5,124.69999999999999,31.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.cta.name = "cta";
	this.cta.setTransform(97.55,220,0.9433,0.9433,0,0,0,0.1,0.2);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_300x250_BAN_MoneyInExcel_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_300x250_BAN_MoneyInExcel_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582629444247", id:"O365_FY20Q4_Cons_USA_300x250_BAN_MoneyInExcel_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
