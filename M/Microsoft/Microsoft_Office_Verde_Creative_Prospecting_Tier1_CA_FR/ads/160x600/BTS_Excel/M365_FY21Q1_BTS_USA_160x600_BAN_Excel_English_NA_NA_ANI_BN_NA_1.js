...
lib.ssMetadata = [
		{name:"M365_FY21Q1_BTS_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,420,420],[422,0,420,420],[844,0,420,420],[0,1266,400,388],[0,422,420,420],[422,422,420,420],[754,1266,600,19],[844,422,420,420],[0,844,420,420],[402,1266,350,233],[422,844,420,420],[844,844,420,420],[1266,0,120,111]]}
];
...
(lib.b_depth = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.screenshadowpicture, new cjs.Rectangle(0,0,350,233), null);
...
(lib.ribbon = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AqPdbIEBk7IQeNgIkBE6g");
	var mask_graphics_1 = new cjs.Graphics().p("AqPdbIECk7IQdNgIkCE6g");
	var mask_graphics_2 = new cjs.Graphics().p("AqQdbIEDk9IQeNgIkDE8g");
	var mask_graphics_3 = new cjs.Graphics().p("AqSdbIEHlCIQeNgIkHFBg");
	var mask_graphics_4 = new cjs.Graphics().p("AqWdbIEPlLIQeNgIkPFKg");
	var mask_graphics_5 = new cjs.Graphics().p("AqcdbIEblaIQeNfIkbFag");
	var mask_graphics_6 = new cjs.Graphics().p("AqldbIEulxIQdNfIkuFxg");
	var mask_graphics_7 = new cjs.Graphics().p("AqydbIFImSIQdNgIlIGRg");
	var mask_graphics_8 = new cjs.Graphics().p("ArEdbIFsm9IQdNfIlsG9g");
	var mask_graphics_9 = new cjs.Graphics().p("AradaIGYnzIQdNfImYHzg");
	var mask_graphics_10 = new cjs.Graphics().p("Ar2daIHRo3IQcNeInRI4g");
	var mask_graphics_11 = new cjs.Graphics().p("AsYdaIIVqLIQcNeIoVKLg");
	var mask_graphics_12 = new cjs.Graphics().p("AtBdaIJnrwIQcNeIpnLwg");
	var mask_graphics_13 = new cjs.Graphics().p("AtxdZILItmIQbNdIrINng");
	var mask_graphics_14 = new cjs.Graphics().p("AuqdZIM6vxIQbNdIs6Pxg");
	var mask_graphics_15 = new cjs.Graphics().p("AvrdYIO9yQIQaNdIu9SQg");
	var mask_graphics_16 = new cjs.Graphics().p("Aw1dYIRR1HIQaNcIxRVHg");
	var mask_graphics_17 = new cjs.Graphics().p("AyJdXIT64VIQZNbIz6YVg");
	var mask_graphics_18 = new cjs.Graphics().p("AzodWIW47+IQZNbI24b+g");
	var mask_graphics_19 = new cjs.Graphics().p("A1SdVMAaNggAIQYNYMgaNAgCg");
	var mask_graphics_20 = new cjs.Graphics().p("A3HdUMAd5gkhIQWNYMgd5Akig");
	var mask_graphics_21 = new cjs.Graphics().p("A5JdTMAh+gpgIQVNXMgh+Aphg");
	var mask_graphics_22 = new cjs.Graphics().p("A7YdSMAmdgu/IQUNXMgmdAu/g");
	var mask_graphics_23 = new cjs.Graphics().p("A91dRMArYg0/IQTNVMgrYA0/g");
	var mask_graphics_24 = new cjs.Graphics().p("EggfAdPMAwvg7jIQQNUMgwvA7jg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-61.7898,y:274.6495}).wait(1).to({graphics:mask_graphics_1,x:-61.7798,y:274.6494}).wait(1).to({graphics:mask_graphics_2,x:-61.7099,y:274.6482}).wait(1).to({graphics:mask_graphics_3,x:-61.5203,y:274.6451}).wait(1).to({graphics:mask_graphics_4,x:-61.151,y:274.639}).wait(1).to({graphics:mask_graphics_5,x:-60.5422,y:274.629}).wait(1).to({graphics:mask_graphics_6,x:-59.634,y:274.614}).wait(1).to({graphics:mask_graphics_7,x:-58.3666,y:274.5931}).wait(1).to({graphics:mask_graphics_8,x:-56.6799,y:274.5654}).wait(1).to({graphics:mask_graphics_9,x:-54.5142,y:274.5297}).wait(1).to({graphics:mask_graphics_10,x:-51.8095,y:274.4851}).wait(1).to({graphics:mask_graphics_11,x:-48.5061,y:274.4307}).wait(1).to({graphics:mask_graphics_12,x:-44.544,y:274.3654}).wait(1).to({graphics:mask_graphics_13,x:-39.8633,y:274.2882}).wait(1).to({graphics:mask_graphics_14,x:-34.4041,y:274.1983}).wait(1).to({graphics:mask_graphics_15,x:-28.1067,y:274.0945}).wait(1).to({graphics:mask_graphics_16,x:-20.9111,y:273.9759}).wait(1).to({graphics:mask_graphics_17,x:-12.7574,y:273.8416}).wait(1).to({graphics:mask_graphics_18,x:-3.5859,y:273.6904}).wait(1).to({graphics:mask_graphics_19,x:6.6635,y:273.5215}).wait(1).to({graphics:mask_graphics_20,x:18.0505,y:273.3339}).wait(1).to({graphics:mask_graphics_21,x:30.6349,y:273.1265}).wait(1).to({graphics:mask_graphics_22,x:44.4767,y:272.8983}).wait(1).to({graphics:mask_graphics_23,x:59.6357,y:272.6485}).wait(1).to({graphics:mask_graphics_24,x:75.9869,y:272.2999}).wait(24));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEF000").s().p("A3IU2MAmtgv8IHkGAMgmgAwNg");
	this.shape.setTransform(79.875,336.425);
...
p.nominalBounds = new cjs.Rectangle(-68.2,163,296.2,346.9);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.3,scaleX:3.3981,scaleY:3.3981,x:179.7,y:-920.55},41,cjs.Ease.quadInOut).wait(1));
...
(lib.BG_gray = function(mode,startPosition,loop) {
	...
	this.bg.name = "bg";
	this.bg.setTransform(80,720,0.5333,2.4,0,0,0,150,300);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.shadow.setTransform(-90.05,-552.5,2.1256,2.663,0,25.6534,19.9431,0.8,0.1);

	this.timeline.addTween(cjs.Tween.get(this.shadow).wait(70));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-360.1,-553.3,967.9,813);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.td_graph.setTransform(102.1,304.55,0.6,0.5384,0,0,0,6.3,1.8);
	...
	this.icon.name = "icon";
	this.icon.setTransform(21.1,237.4,0.9689,0.9689,0,0,0,64.7,63);
	...
	this.overlay.setTransform(111.3,310.85,0.8674,0.8674,0,0,0,121.8,78.5);
	...
	this.screen.setTransform(165.25,263.2,0.5793,0.4637,0,-28.3412,-17.0398,107.7,-133.6);
	...
	this.replay_btn.setTransform(143.3,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.bg.name = "bg";
	this.bg.setTransform(80,297.1,1,1,0,0,0,80,297.1);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-127.4,-13.5,533.1,627.6), null);


// stage content:
(lib.M365_FY21Q1_BTS_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(screen, 1.4, {  x: "+=350",y: "+=350",	ease:Power4.easeOut,onComplete:function(){screen.gotoAndPlay(05);}}, "+=0.2");
				exportRoot.tl1.from(icon, 1.4, {  x: "+=350",y: "+=350",	ease:Power4.easeOut}, "-=1.4");
				
				
				exportRoot.tl1.to(screen, 1.2, {x: "-=60",y: "+=48",scaleX: "0.38",scaleY: "0.31", ease:Power4.easeInOut,onComplete:function(){ribbon.gotoAndPlay(0);}}, "+=1.4");
				exportRoot.tl1.to(icon, 1.2, {x: "-=7",y: "+=57",scaleX: "0.645",scaleY: "0.645", ease:Power4.easeInOut}, "-=1.2");
				exportRoot.tl1.to(mc.overlay, 0.7, {alpha :0.60, ease:Power2.easeInOut}, "-=0.7");
		
				
				//Start : 3D chart
				exportRoot.tl1.to(mask, 0.2, {alpha :1, ease:Power2.easeInOut}, "-=1");
				exportRoot.tl1.to(graph, 0.2, {alpha :1, ease:Power2.easeInOut}, "-=1");
				exportRoot.tl1.to(graph, 1.6, {x: "-=5",y: "+=7",scaleX: "0.81",scaleY: "0.81", ease:Power4.easeInOut}, "-=1.4");
...
p.nominalBounds = new cjs.Rectangle(-47.4,286.5,453.09999999999997,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_.png?1593013489501", id:"M365_FY21Q1_BTS_USA_160x600_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
