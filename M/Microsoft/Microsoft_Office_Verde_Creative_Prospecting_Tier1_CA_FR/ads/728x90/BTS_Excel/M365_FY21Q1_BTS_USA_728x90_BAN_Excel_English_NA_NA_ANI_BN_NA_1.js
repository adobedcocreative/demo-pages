...
lib.ssMetadata = [
		{name:"M365_FY21Q1_BTS_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,420,420],[422,0,420,420],[844,0,420,420],[754,1266,268,215],[0,1266,400,388],[0,422,420,420],[422,422,420,420],[754,1483,600,19],[844,422,420,420],[0,844,420,420],[402,1266,350,233],[422,844,420,420],[844,844,420,420],[1266,0,120,111]]}
];
...
(lib.b_depth = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.screenshadowpicture = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-7.5,-21.45,1.2957,1.4405,0,2.7504,-2.2455);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.screenshadowpicture, new cjs.Rectangle(-23.6,-39.2,469.3,353), null);
...
(lib.ribbon = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_29 = new cjs.Graphics().p("Ak6TeIB+iHIHxHQIh+CHg");
	var mask_graphics_30 = new cjs.Graphics().p("AmqTcIFkl9IHxHQIlkF9g");
	var mask_graphics_31 = new cjs.Graphics().p("AoPTbIItpXIHyHQIotJXg");
	var mask_graphics_32 = new cjs.Graphics().p("ApoTZILfsVIHyHQIrfMVg");
	var mask_graphics_33 = new cjs.Graphics().p("Aq1TYIN5u6IHyHQIt5O6g");
	var mask_graphics_34 = new cjs.Graphics().p("Ar2TXIP8xHIHxHPIv8RIg");
	var mask_graphics_35 = new cjs.Graphics().p("AsuTWIRry/IHyHQIxrS/g");
	var mask_graphics_36 = new cjs.Graphics().p("AtdTWITJ0jIHyHPIzJUkg");
	var mask_graphics_37 = new cjs.Graphics().p("AuDTVIUV10IHyHPI0VV1g");
	var mask_graphics_38 = new cjs.Graphics().p("AuhTVIVR22IHyHPI1RW3g");
	var mask_graphics_39 = new cjs.Graphics().p("Au5TUIWB3oIHyHPI2BXpg");
	var mask_graphics_40 = new cjs.Graphics().p("AvLTUIWl4PIHyHPI2lYQg");
	var mask_graphics_41 = new cjs.Graphics().p("AvYTUIW/4qIHyHPI2/Yrg");
	var mask_graphics_42 = new cjs.Graphics().p("AvgTUIXP49IHyHPI3PY+g");
	var mask_graphics_43 = new cjs.Graphics().p("AvlTUIXa5IIHxHPI3aZJg");
	var mask_graphics_44 = new cjs.Graphics().p("AvoTUIXf5OIHyHPI3fZPg");
	var mask_graphics_45 = new cjs.Graphics().p("AvpTUIXh5QIHyHPI3hZQg");
	var mask_graphics_46 = new cjs.Graphics().p("AvpTZIXh5QIHyHPI3hZRg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(29).to({graphics:mask_graphics_29,x:-31.5,y:170.9948}).wait(1).to({graphics:mask_graphics_30,x:-19.9989,y:170.821}).wait(1).to({graphics:mask_graphics_31,x:-9.5772,y:170.6676}).wait(1).to({graphics:mask_graphics_32,x:-0.4567,y:170.5334}).wait(1).to({graphics:mask_graphics_33,x:7.4493,y:170.417}).wait(1).to({graphics:mask_graphics_34,x:14.2278,y:170.3172}).wait(1).to({graphics:mask_graphics_35,x:19.9656,y:170.2327}).wait(1).to({graphics:mask_graphics_36,x:24.7493,y:170.1623}).wait(1).to({graphics:mask_graphics_37,x:28.6659,y:170.1047}).wait(1).to({graphics:mask_graphics_38,x:31.802,y:170.0585}).wait(1).to({graphics:mask_graphics_39,x:34.2444,y:170.0225}).wait(1).to({graphics:mask_graphics_40,x:36.0797,y:169.9955}).wait(1).to({graphics:mask_graphics_41,x:37.3948,y:169.9762}).wait(1).to({graphics:mask_graphics_42,x:38.2764,y:169.9632}).wait(1).to({graphics:mask_graphics_43,x:38.8111,y:169.9553}).wait(1).to({graphics:mask_graphics_44,x:39.0857,y:169.9513}).wait(1).to({graphics:mask_graphics_45,x:39.1868,y:169.9498}).wait(1).to({graphics:mask_graphics_46,x:38.2683,y:170.4948}).wait(4));

	// top_orange
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDE200").s().p("ApTDCISnoZIwpKwg");
	this.shape.setTransform(28.025,243.25);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(29).to({_off:false},0).wait(21));

	// mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_29 = new cjs.Graphics().p("Ak6TeIB+iHIHxHQIh+CHg");
	var mask_1_graphics_30 = new cjs.Graphics().p("AmqTcIFkl9IHxHQIlkF9g");
	var mask_1_graphics_31 = new cjs.Graphics().p("AoPTbIItpXIHyHQIotJXg");
	var mask_1_graphics_32 = new cjs.Graphics().p("ApoTZILfsVIHyHQIrfMVg");
	var mask_1_graphics_33 = new cjs.Graphics().p("Aq1TYIN5u6IHyHQIt5O6g");
	var mask_1_graphics_34 = new cjs.Graphics().p("Ar2TXIP8xHIHxHPIv8RIg");
	var mask_1_graphics_35 = new cjs.Graphics().p("AsuTWIRry/IHyHQIxrS/g");
	var mask_1_graphics_36 = new cjs.Graphics().p("AtdTWITJ0jIHyHPIzJUkg");
	var mask_1_graphics_37 = new cjs.Graphics().p("AuDTVIUV10IHyHPI0VV1g");
	var mask_1_graphics_38 = new cjs.Graphics().p("AuhTVIVR22IHyHPI1RW3g");
	var mask_1_graphics_39 = new cjs.Graphics().p("Au5TUIWB3oIHyHPI2BXpg");
	var mask_1_graphics_40 = new cjs.Graphics().p("AvLTUIWl4PIHyHPI2lYQg");
	var mask_1_graphics_41 = new cjs.Graphics().p("AvYTUIW/4qIHyHPI2/Yrg");
	var mask_1_graphics_42 = new cjs.Graphics().p("AvgTUIXP49IHyHPI3PY+g");
	var mask_1_graphics_43 = new cjs.Graphics().p("AvlTUIXa5IIHxHPI3aZJg");
	var mask_1_graphics_44 = new cjs.Graphics().p("AvoTUIXf5OIHyHPI3fZPg");
	var mask_1_graphics_45 = new cjs.Graphics().p("AvpTUIXh5QIHyHPI3hZQg");
	var mask_1_graphics_46 = new cjs.Graphics().p("AvpTZIXh5QIHyHPI3hZRg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(29).to({graphics:mask_1_graphics_29,x:-31.5,y:170.9948}).wait(1).to({graphics:mask_1_graphics_30,x:-19.9989,y:170.821}).wait(1).to({graphics:mask_1_graphics_31,x:-9.5772,y:170.6676}).wait(1).to({graphics:mask_1_graphics_32,x:-0.4567,y:170.5334}).wait(1).to({graphics:mask_1_graphics_33,x:7.4493,y:170.417}).wait(1).to({graphics:mask_1_graphics_34,x:14.2278,y:170.3172}).wait(1).to({graphics:mask_1_graphics_35,x:19.9656,y:170.2327}).wait(1).to({graphics:mask_1_graphics_36,x:24.7493,y:170.1623}).wait(1).to({graphics:mask_1_graphics_37,x:28.6659,y:170.1047}).wait(1).to({graphics:mask_1_graphics_38,x:31.802,y:170.0585}).wait(1).to({graphics:mask_1_graphics_39,x:34.2444,y:170.0225}).wait(1).to({graphics:mask_1_graphics_40,x:36.0797,y:169.9955}).wait(1).to({graphics:mask_1_graphics_41,x:37.3948,y:169.9762}).wait(1).to({graphics:mask_1_graphics_42,x:38.2764,y:169.9632}).wait(1).to({graphics:mask_1_graphics_43,x:38.8111,y:169.9553}).wait(1).to({graphics:mask_1_graphics_44,x:39.0857,y:169.9513}).wait(1).to({graphics:mask_1_graphics_45,x:39.1868,y:169.9498}).wait(1).to({graphics:mask_1_graphics_46,x:38.2683,y:170.4948}).wait(4));

	// top
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FEF000").s().p("A9tFfMA7bgVGIAAK8Mg5XAUTg");
	this.shape_1.setTransform(87.2014,168.2625,0.7833,0.7833,-28.0261);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(29).to({_off:false},0).wait(21));

	// mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_13 = new cjs.Graphics().p("AJzHpIAjgSIE9JaIgiASg");
	var mask_2_graphics_14 = new cjs.Graphics().p("AJxHqIAlgUIE9JaIgkATg");
	var mask_2_graphics_15 = new cjs.Graphics().p("AJlHtIAwgZIE+JZIgwAag");
	var mask_2_graphics_16 = new cjs.Graphics().p("AJFH1IBQgpIE9JZIhPAqg");
	var mask_2_graphics_17 = new cjs.Graphics().p("AIHIGICMhKIE+JaIiMBKg");
	var mask_2_graphics_18 = new cjs.Graphics().p("AGgIiIDxh/IE+JaIjxB/g");
	var mask_2_graphics_19 = new cjs.Graphics().p("AEGJLIGIjOIE9JaImHDOg");
	var mask_2_graphics_20 = new cjs.Graphics().p("AAwKFIJZk9IE+JaIpaE9g");
	var mask_2_graphics_21 = new cjs.Graphics().p("AjtLSINwnRIE+JaItxHRg");
	var mask_2_graphics_22 = new cjs.Graphics().p("ApGMvITBqDIE+JaIzBKDg");
	var mask_2_graphics_23 = new cjs.Graphics().p("AtjN8IXYsWIE+JaI3YMWg");
	var mask_2_graphics_24 = new cjs.Graphics().p("AvzO2IaquFIE9JaI6qOFg");
	var mask_2_graphics_25 = new cjs.Graphics().p("Aw/PgIdBvVIE+JaI9BPUg");
	var mask_2_graphics_26 = new cjs.Graphics().p("AxxP7IelwJIE+JZI+lQKg");
	var mask_2_graphics_27 = new cjs.Graphics().p("AyQQMIfjwpIE+JZI/jQqg");
	var mask_2_graphics_28 = new cjs.Graphics().p("AyfQVMAgCgQ6IE9JZMggCAQ7g");
	var mask_2_graphics_29 = new cjs.Graphics().p("AylQYMAgNgRAIE+JZMggNARBg");
	var mask_2_graphics_30 = new cjs.Graphics().p("AymQCMAgPgRBIE+JZMggPARCg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(13).to({graphics:mask_2_graphics_13,x:97.925,y:109.0867}).wait(1).to({graphics:mask_2_graphics_14,x:97.9213,y:109.1321}).wait(1).to({graphics:mask_2_graphics_15,x:97.8958,y:109.4509}).wait(1).to({graphics:mask_2_graphics_16,x:97.8264,y:110.3162}).wait(1).to({graphics:mask_2_graphics_17,x:97.6913,y:112.0012}).wait(1).to({graphics:mask_2_graphics_18,x:97.4685,y:114.7792}).wait(1).to({graphics:mask_2_graphics_19,x:97.1363,y:118.9238}).wait(1).to({graphics:mask_2_graphics_20,x:96.6725,y:124.7084}).wait(1).to({graphics:mask_2_graphics_21,x:96.0555,y:132.4067}).wait(1).to({graphics:mask_2_graphics_22,x:95.3098,y:141.712}).wait(1).to({graphics:mask_2_graphics_23,x:94.6928,y:149.4123}).wait(1).to({graphics:mask_2_graphics_24,x:87.2102,y:155.1994}).wait(1).to({graphics:mask_2_graphics_25,x:79.0278,y:159.3465}).wait(1).to({graphics:mask_2_graphics_26,x:73.543,y:162.1265}).wait(1).to({graphics:mask_2_graphics_27,x:70.2162,y:163.8128}).wait(1).to({graphics:mask_2_graphics_28,x:68.5079,y:164.6788}).wait(1).to({graphics:mask_2_graphics_29,x:67.8785,y:164.9978}).wait(1).to({graphics:mask_2_graphics_30,x:76.1572,y:162.7996}).wait(20));

	// bot_orange
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FDE200").s().p("AvKFFIcXqIIB/KIg");
	this.shape_2.setTransform(107.5569,227.1179,0.7833,0.7833,-28.0261);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(13).to({_off:false},0).to({_off:true},35).wait(2));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_13 = new cjs.Graphics().p("AJzHpIAjgSIE9JaIgiASg");
	var mask_3_graphics_14 = new cjs.Graphics().p("AJxHqIAlgUIE9JaIgkATg");
	var mask_3_graphics_15 = new cjs.Graphics().p("AJlHtIAwgZIE+JZIgwAag");
	var mask_3_graphics_16 = new cjs.Graphics().p("AJFH1IBQgpIE9JZIhPAqg");
	var mask_3_graphics_17 = new cjs.Graphics().p("AIHIGICMhKIE+JaIiMBKg");
	var mask_3_graphics_18 = new cjs.Graphics().p("AGgIiIDxh/IE+JaIjxB/g");
	var mask_3_graphics_19 = new cjs.Graphics().p("AEGJLIGIjOIE9JaImHDOg");
	var mask_3_graphics_20 = new cjs.Graphics().p("AAwKFIJZk9IE+JaIpaE9g");
	var mask_3_graphics_21 = new cjs.Graphics().p("AjtLSINwnRIE+JaItxHRg");
	var mask_3_graphics_22 = new cjs.Graphics().p("ApGMvITBqDIE+JaIzBKDg");
	var mask_3_graphics_23 = new cjs.Graphics().p("AtjN8IXYsWIE+JaI3YMWg");
	var mask_3_graphics_24 = new cjs.Graphics().p("AvzO2IaquFIE9JaI6qOFg");
	var mask_3_graphics_25 = new cjs.Graphics().p("Aw/PgIdBvVIE+JaI9BPUg");
	var mask_3_graphics_26 = new cjs.Graphics().p("AxxP7IelwJIE+JZI+lQKg");
	var mask_3_graphics_27 = new cjs.Graphics().p("AyQQMIfjwpIE+JZI/jQqg");
	var mask_3_graphics_28 = new cjs.Graphics().p("AyfQVMAgCgQ6IE9JZMggCAQ7g");
	var mask_3_graphics_29 = new cjs.Graphics().p("AylQYMAgNgRAIE+JZMggNARBg");
	var mask_3_graphics_30 = new cjs.Graphics().p("AymQCMAgPgRBIE+JZMggPARCg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(13).to({graphics:mask_3_graphics_13,x:97.925,y:109.0867}).wait(1).to({graphics:mask_3_graphics_14,x:97.9213,y:109.1321}).wait(1).to({graphics:mask_3_graphics_15,x:97.8958,y:109.4509}).wait(1).to({graphics:mask_3_graphics_16,x:97.8264,y:110.3162}).wait(1).to({graphics:mask_3_graphics_17,x:97.6913,y:112.0012}).wait(1).to({graphics:mask_3_graphics_18,x:97.4685,y:114.7792}).wait(1).to({graphics:mask_3_graphics_19,x:97.1363,y:118.9238}).wait(1).to({graphics:mask_3_graphics_20,x:96.6725,y:124.7084}).wait(1).to({graphics:mask_3_graphics_21,x:96.0555,y:132.4067}).wait(1).to({graphics:mask_3_graphics_22,x:95.3098,y:141.712}).wait(1).to({graphics:mask_3_graphics_23,x:94.6928,y:149.4123}).wait(1).to({graphics:mask_3_graphics_24,x:87.2102,y:155.1994}).wait(1).to({graphics:mask_3_graphics_25,x:79.0278,y:159.3465}).wait(1).to({graphics:mask_3_graphics_26,x:73.543,y:162.1265}).wait(1).to({graphics:mask_3_graphics_27,x:70.2162,y:163.8128}).wait(1).to({graphics:mask_3_graphics_28,x:68.5079,y:164.6788}).wait(1).to({graphics:mask_3_graphics_29,x:67.8785,y:164.9978}).wait(1).to({graphics:mask_3_graphics_30,x:76.1572,y:162.7996}).wait(20));

	// mid
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FEF000").s().p("A0EFFIiEqIMAqSAAAIB/KIg");
	this.shape_3.setTransform(76.7513,243.5156,0.7833,0.7833,-28.0261);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(13).to({_off:false},0).to({_off:true},35).wait(2));

	// mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AmhWKIFSlqIHxHQIlSFqg");
	var mask_4_graphics_1 = new cjs.Graphics().p("AoFWJIIZpBIHyHQIoZJBg");
	var mask_4_graphics_2 = new cjs.Graphics().p("ApdWIILJr/IHyHQIrJL/g");
	var mask_4_graphics_3 = new cjs.Graphics().p("AqrWHINlulIHyHQItlOlg");
	var mask_4_graphics_4 = new cjs.Graphics().p("AruWGIPrw1IHyHQIvrQ1g");
	var mask_4_graphics_5 = new cjs.Graphics().p("AsnWGIRdyxIHyHQIxdSxg");
	var mask_4_graphics_6 = new cjs.Graphics().p("AtYWFIS/0ZIHyHQIy/UZg");
	var mask_4_graphics_7 = new cjs.Graphics().p("AuBWFIUR1xIHyHQI0RVxg");
	var mask_4_graphics_8 = new cjs.Graphics().p("AuiWFIVT23IHyHPI1TW3g");
	var mask_4_graphics_9 = new cjs.Graphics().p("Au9WEIWJ3wIHyHPI2JXxg");
	var mask_4_graphics_10 = new cjs.Graphics().p("AvRWEIWx4cIHyHOI2xYeg");
	var mask_4_graphics_11 = new cjs.Graphics().p("AvhWEIXR4+IHyHPI3RY/g");
	var mask_4_graphics_12 = new cjs.Graphics().p("AvsWEIXn5WIHyHPI3nZXg");
	var mask_4_graphics_13 = new cjs.Graphics().p("AvzWEIX25mIHxHPI32Zng");
	var mask_4_graphics_14 = new cjs.Graphics().p("Av4WEIX/5wIHyHPI3/Zxg");
	var mask_4_graphics_15 = new cjs.Graphics().p("Av6WEIYD51IHyHPI4DZ2g");
	var mask_4_graphics_16 = new cjs.Graphics().p("Av7WEIYF53IHyHPI4FZ4g");
	var mask_4_graphics_17 = new cjs.Graphics().p("Av7WFIYF53IHyHPI4FZ4g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:37.2003,y:188.1948}).wait(1).to({graphics:mask_4_graphics_1,x:47.4187,y:188.0879}).wait(1).to({graphics:mask_4_graphics_2,x:56.4363,y:187.9935}).wait(1).to({graphics:mask_4_graphics_3,x:64.3281,y:187.911}).wait(1).to({graphics:mask_4_graphics_4,x:71.1693,y:187.8394}).wait(1).to({graphics:mask_4_graphics_5,x:77.0348,y:187.778}).wait(1).to({graphics:mask_4_graphics_6,x:81.9998,y:187.7261}).wait(1).to({graphics:mask_4_graphics_7,x:86.1394,y:187.6828}).wait(1).to({graphics:mask_4_graphics_8,x:89.5286,y:187.6473}).wait(1).to({graphics:mask_4_graphics_9,x:92.2424,y:187.6189}).wait(1).to({graphics:mask_4_graphics_10,x:94.356,y:187.5968}).wait(1).to({graphics:mask_4_graphics_11,x:95.9442,y:187.5802}).wait(1).to({graphics:mask_4_graphics_12,x:97.0823,y:187.5683}).wait(1).to({graphics:mask_4_graphics_13,x:97.8451,y:187.5603}).wait(1).to({graphics:mask_4_graphics_14,x:98.3079,y:187.5555}).wait(1).to({graphics:mask_4_graphics_15,x:98.5455,y:187.553}).wait(1).to({graphics:mask_4_graphics_16,x:98.633,y:187.5521}).wait(1).to({graphics:mask_4_graphics_17,x:98.3331,y:187.7198}).wait(33));

	// bottom
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FEF000").s().p("Egm0AIAMBLqgbAIB/KJMhNpAb4g");
	this.shape_4.setTransform(35.7779,344.5486,0.7833,0.7833,-28.0261);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_4).to({_off:true},48).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86.2,29.1,293.9,434.79999999999995);
...
(lib.overlay_c = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A0VkMMAgFgJSIImSEMggbAI5g");
	this.shape.setTransform(116.9,78.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.overlay_c, new cjs.Rectangle(-13.3,-7.3,260.4,172.60000000000002), null);
...
(lib.shadow_1 = function(mode,startPosition,loop) {
	...
	this.shadow.setTransform(166.5,53.6,1.8363,1.6837,0,0,0,208.1,138.3);

	this.timeline.addTween(cjs.Tween.get(this.shadow).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.shadow_1, new cjs.Rectangle(-259,-245.2,861.7,594.3), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regY:0.3,scaleX:2.3428,scaleY:2.3428,x:-711.2,y:264.7},41,cjs.Ease.quadInOut).wait(1));
...
(lib.icon = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(60.45,71,0.3161,0.3161,0,0,0,134.1,107.5);
...
(lib.blur = function(mode,startPosition,loop) {
	...
	this.overlayc.setTransform(126.15,76.2,1,1,0,0,0,121.8,78.5);

	this.timeline.addTween(cjs.Tween.get(this.overlayc).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.blur, new cjs.Rectangle(-8.9,-9.6,260.4,172.6), null);
...
(lib._3D_price = function(mode,startPosition,loop) {
	...
	this.percantage.setTransform(25,32,0.554,0.5298,0,0,0,209.8,210);
	...
	this.b_pie.setTransform(25.5,32,0.554,0.5298,0,0,0,209.8,210);
	...
	this.s_pie.setTransform(24.25,37.9,0.554,0.5298,0,0,0,209.8,210);
	...
	this.c_shadow.setTransform(24.8,31.45,0.554,0.5298,0,0,0,209.8,210);

	this.timeline.addTween(cjs.Tween.get(this.c_shadow).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._3D_price, new cjs.Rectangle(-92,-79.8,234,229), null);
...
(lib.screen_anim = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-109.2,6.7,0.7544,0.7544);
...
p.nominalBounds = new cjs.Rectangle(-109.4,-279.6,471.6,300.70000000000005);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.td_graph.setTransform(205.6,72.05,0.3568,0.3353,0,0,0,47.4,38.1);
	...
	this.icon.name = "icon";
	this.icon.setTransform(300.55,21.8,0.6257,0.6257,0,0,0,64.8,62.7);
	...
	this.overlay.setTransform(246.95,52.2,0.7025,0.6272,-1.6979,0,0,122.3,79);
	this.overlay.alpha = 0;
	this.overlay.filters = [new cjs.BlurFilter(8, 8, 1)];
	this.overlay.cache(-11,-12,264,177);
	...
	this.screen.setTransform(387.65,37.35,0.3538,0.2825,0,-28.3437,-17.047,107.4,-133.6);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(386.4,37.35,0.3481,0.3481,0,0,0,159.2,96.7);
	...
	this.ribbon.setTransform(169,-176.95);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-81.6,728.3,424.9), null);


// stage content:
(lib.M365_FY21Q1_BTS_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(screen, 1, {  x: "+=250",y: "+=250", ease:Power4.easeOut,onComplete:function(){screen.gotoAndPlay(05);}}, "+=0.2");
				exportRoot.tl1.from(icon, 1, {  x: "+=250",y: "+=250",	ease:Power4.easeOut}, "-=1");
				exportRoot.tl1.from(shadow, 1, { x: "+=250",y: "+=250",	ease:Power4.easeOut}, "-=1");
								
				
				exportRoot.tl1.to(screen, 1, {scaleX: "0.34",scaleY: "0.28",x: "-=145",y: "+=14", ease:Power4.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "+=1.5");
				exportRoot.tl1.to(icon, 1, {x: "-=140",y: "+=10", ease:Power4.easeInOut}, "-=1");
				exportRoot.tl1.to(shadow, 1, {x: "-=145",y: "+=14",scaleX: "0.34",scaleY: "0.34", ease:Power4.easeInOut}, "-=1");
				...
				//Start : 3D chart
				exportRoot.tl1.to(mask, 0.2, {alpha :1, ease:Power2.easeInOut}, "-=0.6");
				exportRoot.tl1.to(graph, 0.2, {alpha :1, ease:Power2.easeInOut}, "-=0.6");
				exportRoot.tl1.to(graph, 1.6, {x: "+=29",y: "-=29",scaleX: "0.75",scaleY: "0.75", ease:Power2.easeInOut}, "-=0.6");
				...
				exportRoot.tl1.from(graph.c_shadow, 0.3, {alpha :0,ease:Power2.easeInOut}, "-=1.6");
				exportRoot.tl1.from(graph.c_shadow, 1, {x: "+=6",y: "-=16", ease:Power2.easeInOut}, "-=1.4");
				//End : 3D chart
...
p.nominalBounds = new cjs.Rectangle(364,-36.6,364.29999999999995,379.90000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_.png?1593081253793", id:"M365_FY21Q1_BTS_USA_728x90_BAN_Excel_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
