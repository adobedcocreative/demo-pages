...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_iconpngcopy4 = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Teams_screen = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Teams_screen();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(0,0,660,438), null);
...
(lib.icon_teams = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.instance = new lib.teams_iconpngcopy4();
	this.instance.setTransform(-103.6,-71.75);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon_teams, new cjs.Rectangle(-103.6,-71.7,393,295), null);
...
(lib.bg_c = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F5F5F5").ss(1,1,1).p("A3bzhMAu3AAAMAAAAnDMgu3AAAg");
	this.shape.setTransform(150,125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F5F5F5").s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
...
}).prototype = getMCSymbolPrototype(lib.bg_c, new cjs.Rectangle(-1,-1,302,252), null);
...
(lib.logo_mc = function(mode,startPosition,loop) {
	...
	this.tile_sub.setTransform(-60.65,61.25,0.415,0.415,0,0,0,76.9,79.5);

	this.timeline.addTween(cjs.Tween.get(this.tile_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-135.5,-1.5,163.1,122.4), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:-0.1,regY:0.3,scaleX:2.214,scaleY:2.214,x:-28.35,y:1.35},41,cjs.Ease.quadInOut).to({_off:true},1).wait(9));
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.bg.cache(-300,-250,600,500,2)
	}
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-0.5,-0.5,301,251), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-48.8852,-0.7394,0.8725,0.9709);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.9,-16.6,110.10000000000001,31.700000000000003), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(44.25,219.45,1,1,0,0,0,0.7,0.1);
	...
	this.screen.setTransform(271.2,149,0.5517,0.5517,0,0,0,330.1,219);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.9,-0.5,455.09999999999997,270.4), null);


// stage content:
(lib.O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			for (var i = 0; i < exportRoot.headline12.length; i++) {
				exportRoot.headline12[i].mask = s
			}
		...
		this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=200",y:"+=50", ease:Power4.easeInOut});
				exportRoot.tl1.to(s, 1.6, {x: "-=100", ease:Power4.easeInOut}, "-=1.6");
				exportRoot.tl1.to(exportRoot.headline12, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.4");
				...
				exportRoot.tl1.to(cont3D, 1, {x:205, y:"+=48", z:-650 , ease:Power4.easeInOut}, "+=0.5");
				//exportRoot.tl1.to(cont3D, 1, {x:86, y:"+=25", z:-250 ,rotX: "+=35",rotY: "+=20",rotZ: "-=17", ease:Power4.easeInOut}, "+=0.5");
				exportRoot.tl1.from(screen, 0.8, {x: "+=400",y: "+=400", ease:Power3.easeInOut}, "-=1");
		...
		*/
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline15[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut}, "-=0.5");
		...
		*/
				...
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "-=150",	ease:Power4.easeOut}, "-=1");
				exportRoot.tl1.from(mc.cta, 0.7, {	alpha: 0, x: "-=150", ease:Power4.easeOut}, "-=1");
...
p.nominalBounds = new cjs.Rectangle(148.1,124.5,305.1,145.39999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584449906780", id:"O365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
