...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,623,800,470],[0,0,700,621]]}
];
...
(lib.Desktop = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.screen1, new cjs.Rectangle(0,0,350,310.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(168.2,178,0.4032,0.4032,0,0,0,175,155.2);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(150,56.8,0.7382,0.7382,0,0,0,0.7,1.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(113.25,218.25,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,445.8,252.1), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,125,294.4,127);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602667588635", id:"M365_FY21Q2Holiday_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
