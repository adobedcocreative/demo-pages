...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(81).call(this.frame_81).wait(16).call(this.frame_97).wait(1).call(this.frame_98).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(81).to({alpha:0},15).wait(3));
...
// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_AllUpAI_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
