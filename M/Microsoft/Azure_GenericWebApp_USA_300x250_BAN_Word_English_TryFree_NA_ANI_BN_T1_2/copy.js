	...
	bannerData.headline1 = ["<#505050>Code, experiment, |and build your next |great web app","27px",15,52,"27","350", "left"];



	bannerData.CTA = ["<#FFFFFF>Try Azure free","28px",0,0,"50","300", "center"];
