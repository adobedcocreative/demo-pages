...
lib.ssMetadata = [
		{name:"O365_MacUsrs_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_", frames: [[0,252,300,250],[0,0,300,250],[0,504,265,166]]}
];
...
(lib.IPhone = function() {
	this.initialize(ss["O365_MacUsrs_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_"]);
	this.gotoAndStop(0);
...
(lib.shapeMC = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgpSCXwMAAAkvgMBSkAAAMAAAEvgg");
	this.shape.setTransform(264.25,971.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.shapeMC, new cjs.Rectangle(0,0,528.5,1942.5), null);
...
(lib.white = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.shapeMC.cache(-529,-1943,1058,3886,2)
	}
	...
	// Layer_1
	this.shapeMC = new lib.shapeMC();
	this.shapeMC.name = "shapeMC";
	this.shapeMC.parent = this;
	this.shapeMC.setTransform(264.3,407,1,1,0,0,0,264.3,971.3);
...
(lib.logo_1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(67).call(this.frame_67).wait(4).call(this.frame_71).wait(7).call(this.frame_78).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:4.0861,scaleY:4.0861,x:76.45,y:341.8},13,cjs.Ease.quadOut).to({x:-85.75},12,cjs.Ease.quadInOut).to({_off:true},1).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({_off:true,x:78.1},12,cjs.Ease.quadInOut).wait(54));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},12,cjs.Ease.quadInOut).wait(25).to({scaleX:2.2943,scaleY:2.2943,x:-10.35,y:-546.1},22,cjs.Ease.quadInOut).to({_off:true},6).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(55).to({x:-254.25},21,cjs.Ease.quadIn).to({_off:true},3).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(57).to({x:-244},21,cjs.Ease.quadIn).to({_off:true},1).wait(1));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("AppCfIAAk9ITTAAIAAE9g");
	this.shape.setTransform(-0.375,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-62.1,-14.9,123.5,31.9), null);
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.iPhone.setTransform(152.95,127.2,1.2,1.2,0,0,0,88.5,73.9);
	...
	this.screenMC.setTransform(151,141.85,1.0601,1.0601,0,0,0,71.5,44.8);
	...
	this.laptopMC.setTransform(151.1,141.75,0.2438,0.2438,0,0,0,0.2,0.2);
	...
	this.laptop2.name = "laptop2";
	this.laptop2.parent = this;
	this.laptop2.setTransform(190.65,207.55,0.17,0.17,0,0,0,1.2,2.6);
	...
	this.macPro2.setTransform(126.25,174,1.1,1.1,0,0,0,100.5,84);
	...
	this.macPro.setTransform(145.8,144.2,1.3,1.3,0,0,0,100.7,84);

	this.timeline.addTween(cjs.Tween.get(this.macPro).wait(1));

}).prototype = getMCSymbolPrototype(lib.Intro, new cjs.Rectangle(14.9,35,261.3,230.89999999999998), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.logo.name = "logo";
	this.logo.parent = this;
	this.logo.setTransform(-84.45,194.5,0.312,0.312);
	...
	this.replay_btn.setTransform(4.15,3.5,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(-42.25,571.4,0.4964,0.4964);
	...
	this.cta.setTransform(-23.65,568.7,0.9433,0.9401,0,0,0,0.1,0.4);
	...
	this.anim.setTransform(-165.35,211.1,0.6977,0.6875);
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgMrAvHMAAAhdoQgFACgFgBQgKgBgFgIIgCgGQgBgEACgGQABgGAEgCQAGgFAIAAIgBgBQAGABAFAEQAFADACAEQAEALgGAJIZqAAMAAABdug");
	this.shape.setTransform(-61.1312,298.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-154.9,-3,189.10000000000002,606.5), null);


// stage content:
(lib.O365_MacUsrs_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			for (var i = 0; i < exportRoot.headline1.length; i++) {
				if (i==0) exportRoot.tlH1O.to(exportRoot.headline1[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn});
				if (i!=0) exportRoot.tlH1O.to(exportRoot.headline1[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn}, "-=0.35");
			}
			...
			for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tlH2O.to(exportRoot.headline2[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn});
				if (i!=0) exportRoot.tlH2O.to(exportRoot.headline2[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn}, "-=0.35");
			}
			...
			for (var i = 0; i < exportRoot.headline3.length; i++) {
				if (i==0) exportRoot.tlH3O.to(exportRoot.headline3[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn});
				if (i!=0) exportRoot.tlH3O.to(exportRoot.headline3[i], 0.6, { x: "-=50", alpha: 0, ease: Power2.easeIn}, "-=0.35");
			}
			...
			exportRoot.tl1.from(mc.txtCta, 0.7, {alpha: 0,	x: "+=300", ease: Power4.easeOut}, "-=0.6");
			...
			exportRoot.tl2.from(mc.replay_btn, 0.7, {alpha: 0,	x: "+=300",	ease: Power4.easeOut}, "-=0.5")
			...
			TweenLite.delayedCall(2.8, function(){mc.anim.laptopMC.play()})
			exportRoot.mainTimeline.from(mc.anim.screenMC, 0.5, {alpha:0, onStart: function(){exportRoot.tlH1I.play()}}, "+=1.7")
			exportRoot.mainTimeline.to(mc.anim.laptopMC, 0.7, {x:"-=100", alpha:0, ease: Power3.easeIn}, "+=1.7")
		    exportRoot.mainTimeline.to(mc.anim.screenMC, 0.7, {x:"-=100", alpha:0, ease: Power3.easeIn, onStart: function(){exportRoot.tlH1O.play()}}, "-=0.7")
			...
			exportRoot.mainTimeline.to(mc.anim.iPhone, 0.8, {x:76, y:220, scaleX:0.54, scaleY:0.54, alpha:1, ease: Power1.easeInOut, onStart: function(){exportRoot.tlH3O.play(), mc.anim.gotoAndStop(2)}}, "+=1.7")
			exportRoot.mainTimeline.from(mc.anim.macPro2, 0.8, {x:"+=330", y:"-=0", alpha:0, ease: Power1.easeInOut}, "-=0.8")
			exportRoot.mainTimeline.from(mc.anim.laptop2, 0.8, {x:"+=330", y:"-=0", alpha:0, ease: Power1.easeInOut}, "-=0.6")
		
			TweenLite.delayedCall(13.5, function(){exportRoot.tlH1.play()})
			TweenLite.delayedCall(13.5, function(){exportRoot.tl2.play()})
...
p.nominalBounds = new cjs.Rectangle(65.1,297,120.1,306.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_MacUsrs_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_.png?1542205157592", id:"O365_MacUsrs_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_"}
	],
	preloads: []
};
