...
p.nominalBounds = new cjs.Rectangle(0,0,150,113);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(170,-18,0.96,0.96);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(170,-18,144,108.5), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg5pAH2IAAvrMBzTAAAIAAPrg");
	this.shape.setTransform(365.5,47.2);
...
// stage content:
(lib.O365_CreateYourBestWork_USA_728x90_BAN_Excel_Ease_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537202560484", id:"Computer"}
	],
	preloads: []
};
