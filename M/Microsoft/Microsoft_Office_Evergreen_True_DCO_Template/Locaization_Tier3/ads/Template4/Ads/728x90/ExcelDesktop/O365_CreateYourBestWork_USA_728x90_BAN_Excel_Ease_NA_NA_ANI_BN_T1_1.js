...
p.nominalBounds = new cjs.Rectangle(0,0,140,122);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(178,-13,0.891,0.891);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(178,-13,124.8,108.8), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(41).call(this.frame_41).wait(22).call(this.frame_63).wait(40));

	// Layer_2
	this.instance = new lib.MSFT_logo_sq();
	this.instance.parent = this;
	this.instance.setTransform(983.4,84,0.272,0.272,0,0,0,-40,1.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.49,scaleY:4.49,x:983.5,y:83.9},13,cjs.Ease.quadOut).to({x:805.2},12,cjs.Ease.quadInOut).to({_off:true},1).wait(76));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EA0kAKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_15 = new cjs.Graphics().p("EAzZAKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_16 = new cjs.Graphics().p("EAyPAKYIAAvJMA5FAAAIAAPJg");
	var mask_graphics_17 = new cjs.Graphics().p("EAxEAKYIAAvJMA5FAAAIAAPJg");
	var mask_graphics_18 = new cjs.Graphics().p("EAv5AKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_19 = new cjs.Graphics().p("EAuuAKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_20 = new cjs.Graphics().p("EAtjAKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_21 = new cjs.Graphics().p("EAsZAKYIAAvJMA5FAAAIAAPJg");
	var mask_graphics_22 = new cjs.Graphics().p("EArOAKYIAAvJMA5FAAAIAAPJg");
	var mask_graphics_23 = new cjs.Graphics().p("EAqDAKYIAAvJMA5FAAAIAAPJg");
	var mask_graphics_24 = new cjs.Graphics().p("EAo4AKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_25 = new cjs.Graphics().p("EAntAKYIAAvJMA5GAAAIAAPJg");
	var mask_graphics_26 = new cjs.Graphics().p("EAmiAKYIAAvJMA5GAAAIAAPJg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:701.8,y:66.4}).wait(1).to({graphics:mask_graphics_15,x:694.3,y:66.4}).wait(1).to({graphics:mask_graphics_16,x:686.8,y:66.4}).wait(1).to({graphics:mask_graphics_17,x:679.3,y:66.4}).wait(1).to({graphics:mask_graphics_18,x:671.9,y:66.4}).wait(1).to({graphics:mask_graphics_19,x:664.4,y:66.4}).wait(1).to({graphics:mask_graphics_20,x:656.9,y:66.4}).wait(1).to({graphics:mask_graphics_21,x:649.4,y:66.4}).wait(1).to({graphics:mask_graphics_22,x:641.9,y:66.4}).wait(1).to({graphics:mask_graphics_23,x:634.4,y:66.4}).wait(1).to({graphics:mask_graphics_24,x:627,y:66.4}).wait(1).to({graphics:mask_graphics_25,x:619.5,y:66.4}).wait(1).to({graphics:mask_graphics_26,x:612,y:66.4}).wait(1).to({graphics:null,x:0,y:0}).wait(76));

	// Layer 3
	this.instance_1 = new lib.MSFT_Logo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(805.8,78.5,4.493,4.493,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.instance_2 = new lib.MSFT_Logo_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(985.4,78.5,4.493,4.493,0,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:985.4},12,cjs.Ease.quadInOut).wait(13).to({_off:false},0).wait(2).to({regX:0,regY:0,scaleX:2.25,scaleY:2.25,x:-16.4,y:11},22,cjs.Ease.quadInOut).to({_off:true},1).wait(39));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(68.2,1.2,0.92,0.92,0,0,0,10.9,10.6);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("AoeCTIAAklIQ9AAIAAElg");
	this.shape.setTransform(35.9,1.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-18.3,-13.3,108.5,29.4), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(670.2,45.8,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(662.2,3.1,1,1,0,0,0,2.5,-0.5);
	...
	this.cta.setTransform(643.7,43.8,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.image_1.setTransform(96.1,79.6,0.81,0.81,0,0,0,100.6,79.8);
	...
	this.shape.setTransform(365.5,47.2,2.392,0.337);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-3.5,-3,738,257.3), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_728x90_BAN_Excel_Ease_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			for (var i = 0; i < exportRoot.headline1.length; i++) {
				exportRoot.tlFH.from(exportRoot.headline1[i], 0.6, {	x: "+=75",	alpha: 0, ease:Power4.easeOut}, "-=0.4");
			}
			exportRoot.tlFH.stop()

				for (var i = 0; i < exportRoot.headline2.length; i++) {
				exportRoot.tlFH.from(exportRoot.headline2[i], 0.6, {	x: "+=75",	alpha: 0, ease:Power4.easeOut}, "-=0.4");
			}
			exportRoot.tlFH.stop()


			TweenLite.delayedCall(1.8, function(){exportRoot.tlFH.play()})


			exportRoot.tl1.to(mc.image_1, 0.8, { alpha: 1,scaleX:.81, scaleY:.81, x: "-=100", y: "-=0", ease:Power4.easeOut, onStart:function(){exportRoot.tl2.play()}}, "+=.6")


			this.tl1.stop()

			exportRoot.tl2.to(mc.replay_btn, 0.7, {alpha: 1,	x: "-=50",ease: Power4.easeOut}, "-=0.5")
			exportRoot.tl2.to(mc.txtCta, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=.3");
...
p.nominalBounds = new cjs.Rectangle(360.5,42,738,100.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537202808899", id:"Computer"}
	],
	preloads: []
};
