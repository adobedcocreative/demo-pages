...
lib.ssMetadata = [
		{name:"O365_CARTABNDMCOMM_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,463,280],[0,282,463,133],[376,625,67,18],[0,417,382,154],[500,166,10,9],[0,573,89,160],[500,91,7,12],[498,134,12,14],[465,201,15,10],[208,610,49,38],[465,134,31,30],[91,573,115,117],[309,573,65,52],[384,417,104,206],[465,0,43,89],[465,166,33,18],[445,625,57,11],[498,150,10,14],[490,186,19,19],[465,186,22,13],[465,91,33,41],[208,573,99,35]]}
];
...
(lib.BG3 = function() {
	this.initialize(ss["O365_CARTABNDMCOMM_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.bg_circle.setTransform(16.45,348.4);
	...
	this.image_0.setTransform(260.35,82.35,0.77,0.77,0,0,180,-0.7,0.7);
	...
	this.image_1.setTransform(130.25,94,0.77,0.7699,0,0,180,-2.5,-0.9);
	...
	this.image_2.setTransform(256.5,82.35,0.77,0.77,0,0,180,-0.7,0.7);
	...
	this.image_3.setTransform(244.95,83.1,0.77,0.77,0,0,180,-0.7,0.7);
	...
	this.image_4.setTransform(223.85,82.3,0.77,0.77,0,0,180,-0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.image_4).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-94.7,-185.4,389.2,702.1999999999999), null);


// stage content:
(lib.O365_CARTABNDMCOMM_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tlFH.from(exportRoot.headline2[i], 0.6, { x: "+=300", alpha: 0, ease:Sine.easeOut});
				if (i!=0) exportRoot.tlFH.from(exportRoot.headline2[i], 0.6, { x: "+=300", alpha: 0, ease:Sine.easeOut}, "-=0.5");
			...
			exportRoot.tl1.from(mc.image_0, 1.5, { scaleX:1.15, scaleY:1.15, x: "+=70", y: "-=70",ease:Sine.easeInOut}, "+=0.8")
			exportRoot.tl1.from(mc.image_1, 1.5, { scaleX:1.1, scaleY:1.1, x: "+=20", y: "-=70", ease:Sine.easeInOut, onStart:function(){mc.image_1.gotoAndPlay(1)}}, "-=1.5")
			exportRoot.tl1.from(mc.image_2, 1.5, { scaleX:1.1, scaleY:1.1, x: "+=70", y: "-=70", ease:Sine.easeInOut}, "-=1.5")	
			exportRoot.tl1.from(mc.image_3, 1.5, { scaleX:.9, scaleY:.9, x: "+=28", y: "-=15", ease:Sine.easeInOut}, "-=1.5")
			exportRoot.tl1.from(mc.image_4, 1.5, { scaleX:.78, scaleY:.78, x: "+=2", y: "-=2", ease:Sine.easeInOut}, "-=1.5")
...
p.nominalBounds = new cjs.Rectangle(-14.7,289.6,309.2,402.19999999999993);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CARTABNDMCOMM_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_.png?1541781914492", id:"O365_CARTABNDMCOMM_USA_160x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
