...
lib.ssMetadata = [
		{name:"O365SMB_OCMREA_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,395,308],[0,310,204,268],[206,310,191,254]]}
];
...
(lib._300x250_bg = function() {
	this.spriteSheet = ss["O365SMB_OCMREA_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(24,40,0.86,0.86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(24,40,164.3,218.5), null);
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(170,30,0.855,0.855);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.lady_fg, new cjs.Rectangle(170,30,174.4,229.2), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-12,-6,0.86,0.86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-12,-6,339.7,264.9), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(55.1,195.1,0.91,0.91,0,0,0,60.5,197.8);
	...
	this.image_2.setTransform(55,195.1,0.93,0.93,0,0,0,59.1,197.8);
	...
	this.image_3.setTransform(55.1,193.7,0.97,0.97,0,0,0,55.1,198);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-10,-4.2,353.3,256.9), null);


// stage content:
(lib.O365SMB_OCMREA_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.07, scaleY:1.07, x: "-=83", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "-=53", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:1, scaleY:1, x: "-=20", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(140,120.8,353.3,256.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMREA_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535015948819", id:"O365SMB_OCMREA_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
