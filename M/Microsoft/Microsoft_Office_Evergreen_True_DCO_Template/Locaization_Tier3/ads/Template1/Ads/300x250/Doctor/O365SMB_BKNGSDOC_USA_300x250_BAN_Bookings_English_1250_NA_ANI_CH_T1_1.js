...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSDOC_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,305,440,339],[0,0,500,303]]}
];
...
(lib._300x250_bg2 = function() {
	this.spriteSheet = ss["O365SMB_BKNGSDOC_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.dr, new cjs.Rectangle(5,15,395.6,239.8), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib._300x250_bg2();
	this.instance.parent = this;
	this.instance.setTransform(1,-18,0.82,0.82);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(1,-18,360.9,278), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_2.setTransform(41.2,250.6,0.9,0.9,0,0,0,41.1,253.1);
	...
	this.image_3.setTransform(21.7,250.1,0.95,0.95,0,0,0,31.6,254.8);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-7.4,-9.1,372.1,264.1), null);


// stage content:
(lib.O365SMB_BKNGSDOC_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			TweenLite.delayedCall(4.2, function(){exportRoot.tlFH.play()})
		
			exportRoot.tl1.to(mc.msft_logo, 1.3, { x: "-=700",	 ease:Power1.easeOut}, "+1.4")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "-=66", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:1, scaleY:1, x: "-=50", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=1")
...
p.nominalBounds = new cjs.Rectangle(142.6,115.9,372.1,264.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSDOC_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535017547612", id:"O365SMB_BKNGSDOC_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
