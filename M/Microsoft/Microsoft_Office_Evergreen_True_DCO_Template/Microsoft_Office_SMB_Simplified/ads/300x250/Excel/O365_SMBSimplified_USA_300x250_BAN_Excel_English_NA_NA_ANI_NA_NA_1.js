...
lib.ssMetadata = [
		{name:"O365_SMBSimplified_USA_300x250_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[0,0,350,197],[642,1322,324,39],[0,1343,323,37],[325,1363,323,36],[0,1382,323,33],[325,1401,322,26],[0,1417,322,17],[649,1401,322,18],[650,1363,322,36],[642,1264,321,56],[320,1264,320,77],[0,1168,318,99],[622,1142,316,120],[622,1001,314,139],[310,1001,310,155],[0,998,308,168],[0,818,306,178],[601,813,304,186],[601,619,301,192],[300,619,299,197],[0,616,298,200],[584,415,296,202],[584,209,294,204],[352,0,292,206],[0,408,290,206],[646,0,290,207],[0,199,290,207],[292,208,290,207],[880,209,120,111]]}
];
...
(lib.excel_budget_laptop = function() {
	this.initialize(ss["O365_SMBSimplified_USA_300x250_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(95.4819,1.6567,0.2955,0.2955);
	...
	this.shape_1.setTransform(87.207,1.6567,0.2955,0.2955);
	...
	this.shape_2.setTransform(81.4146,-0.4711,0.2955,0.2955);
	...
	this.shape_3.setTransform(76.5383,-0.6337,0.2955,0.2955);
	...
	this.shape_4.setTransform(70.8198,-0.6337,0.2955,0.2955);
	...
	this.shape_5.setTransform(61.3406,-0.1682,0.2955,0.2955);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFB900").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_6.setTransform(-33.5327,5.4247,0.2955,0.2955);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_7.setTransform(-44.6964,5.4247,0.2955,0.2955);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_8.setTransform(-33.5327,-5.739,0.2955,0.2955);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_9.setTransform(-44.6964,-5.739,0.2955,0.2955);
	...
	this.shape_10.setTransform(13.9741,-0.5081,0.2955,0.2955);
	...
	this.shape_11.setTransform(127.0817,-0.0352,0.2955,0.2955);
	...
	this.shape_12.setTransform(118.0532,-0.1461,0.2955,0.2955);
	...
	this.shape_13.setTransform(108.8104,-0.1461,0.2955,0.2955);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-49.8,-10.8,180.60000000000002,21.3), null);
...
(lib.ClipGroup_51 = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(34.7177,111.0306,1.5011,1.5011);
	...
	this.shape_3.setTransform(33.6445,109.6743,0.8329,0.8329);
	...
	this.shape_4.setTransform(40.8719,113.5972,1.5011,1.5011);
	...
	this.shape_5.setTransform(40.8597,113.6327,1.5011,1.5011);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(298.05,338.3,0.3349,0.3349,0,0,0,-40,1.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regY:1.4,scaleX:5.5415,scaleY:5.5415},13,cjs.Ease.quadOut).to({x:78.05},12,cjs.Ease.quadInOut).to({_off:true},1).wait(49));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(78.9,331.65,5.5415,5.5415,0,0,0,0.1,0.2);
	...
	this.instance_2.setTransform(300.35,331.65,5.5415,5.5415,0,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({scaleY:2.3668,y:895.45},0).to({x:-674.6},21,cjs.Ease.quadIn).to({_off:true},3).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({scaleY:2.3671,y:895.55},0).wait(2).to({scaleY:2.3867,x:-674.6,y:903.5},21,cjs.Ease.quadIn).to({_off:true},1).wait(1));
...
(lib.icon_teams = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(23.05,30.55,0.8672,0.8672);
...
(lib.graphslaptop = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.txt1},{t:this.txt2}]}).wait(40));
...
(lib.softwarevector = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(542.5525,1310.4556,4.7039,4.7039);
	...
	this.shape_1.setTransform(435.6279,1303.8026,4.7095,4.7095);
	...
	this.shape_14.setTransform(77.8287,1329.8228,4.7095,4.7095);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#3F3F3F").p("Ag1AAIBrAA");
	this.shape_15.setTransform(84.3043,1306.5106,4.7095,4.7095);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#3F3F3F").p("AAAgjIAABI");
	this.shape_16.setTransform(83.2447,1306.1574,4.7095,4.7095);
	...
	this.excel.setTransform(597.55,336.25,0.8666,0.8666,0,0,0,683,383.9);
...
(lib.Phone = function(mode,startPosition,loop) {
	...
	this.screen.setTransform(43.7,23.15,0.0871,0.0871,0,0,0,468.9,181.3);
...
}).prototype = getMCSymbolPrototype(lib.Phone, new cjs.Rectangle(-34.6,-0.2,240.6,133.79999999999998), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#207346").s().p("AoeCjIAAlFIQ+AAIAAFFg");
	this.shape.setTransform(-48.8,-1.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.1,-17.5,108.69999999999999,32.6), null);
...
(lib.MainScreen = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.graphs = new lib.graphslaptop();
	this.graphs.name = "graphs";
	this.graphs.parent = this;
	this.graphs.setTransform(186.55,99.2,0.2885,0.2885,0,0,0,468.8,181.3);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AE2KuIAAvwIKuAAIAAPwg");
	mask.setTransform(99.5765,68.626);

	// Layer_3
	this.instance = new lib.excel_budget_laptop();
	this.instance.parent = this;
	this.instance.setTransform(20.45,-0.65,0.8576,0.8576);
	...
	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AlTHiIAAvDIKnAAIAAPDg");
	this.shape.setTransform(147.95,86.825);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_2
	this.instance_1 = new lib.excel_budget_laptop();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0.65,-0.65,0.8576,0.8576);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.MainScreen, new cjs.Rectangle(0.7,-0.6,321.6,168.9), null);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CDCDCD").s().p("A1XMSIgU4jMArXAAAIgUYjg");
	this.shape_1.setTransform(278.95,-85.225);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(284,3.9,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(43.3,219.35,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(96.4,219.9,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.phone.name = "phone";
	this.phone.parent = this;
	this.phone.setTransform(164.25,193.6,0.6437,0.6437,0,0,0,36.3,66.8);
	...
	this.laptop.setTransform(258.3,218.6,0.6462,0.5686,0,0,0,284.1,25.1);
	...
	this.logo_1.setTransform(50.35,22.6,0.71,0.71,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.logo_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-29.2,0.1,553,263.4), null);


// stage content:
(lib.O365_SMBSimplified_USA_300x250_BAN_Excel_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				// the						headline2
				exportRoot.tl1.from(exportRoot.headline2, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.0");
				
		
				// power					headline3
				exportRoot.tl1.from(exportRoot.headline3, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.0");
				...
				exportRoot.tl1.to(exportRoot.headline5, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.6");
				exportRoot.tl1.to(exportRoot.headline4, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0.01");
		
		
				//to						headline6
				exportRoot.tl1.from(exportRoot.headline6, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.02");
				exportRoot.tl1.from(exportRoot.headline7, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.02");
				...
				//manage					headline7
				exportRoot.tl1.from(exportRoot.headline8, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.02");
		
				
				//manage cash				headline8
				exportRoot.tl1.from(exportRoot.headline9, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.0");
		
		
				//manage cash flow			headline9
				exportRoot.tl1.from(exportRoot.headline10, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.0");
				//exportRoot.tl1.to(exportRoot.headline9, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.4");
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=250", ease:Power4.easeInOut});
				exportRoot.tl1.to(s, 1.6, {x: "-=105", ease:Power4.easeInOut}, "-=1.6");
				...
				exportRoot.tl1.to(exportRoot.headline10, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.6");
		
				exportRoot.tl1.to(cont3D, 1, {x:222, y:"+=27", z:-1000, ease:Power4.easeInOut}, "+=0.5");
		
		
		
				exportRoot.tl1.from(phone, 1.2, {x: "-=380", ease:Power3.easeOut}, "-=1");
				exportRoot.tl1.from(laptop, 1.2, {x: "-=380", ease:Power4.easeOut, onStart:function(){laptop.play();}}, "-=1.2");
		
				
				for (var i = 0; i < exportRoot.headline11.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline11[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut}, "-=1");
				...
				exportRoot.tl1.to(phone.screen.graphs, 0, {alpha:1, ease:Power3.easeOut, onStart:function(){phone.screen.graphs.play(); laptop.Screen.graphs.play()}}, "-=0.5");
...
p.nominalBounds = new cjs.Rectangle(120.8,125,402.99999999999994,138.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_300x250_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_.png?1575298836029", id:"O365_SMBSimplified_USA_300x250_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
