...
(lib.booking_mobile_laptop = function() {
	this.initialize(ss["O365_SMBSimplified_USA_160x600_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-44.4615,0.258,0.8668,0.9731);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-99.2,-15.6,109.5,31.799999999999997), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(145.1,2.8,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.logo_1.setTransform(47.55,23.8,1,1,0,0,0,0.4,0.8);
	...
	this.txtCta.setTransform(98.05,568.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(151.15,569.5,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.phone.name = "phone";
	this.phone.parent = this;
	this.phone.setTransform(37.6,409.85,0.6452,0.6452,0,0,0,36.3,66.8);
	...
	this.laptop.setTransform(123.3,432.55,0.6299,0.5543,0,0,0,283.9,24.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-156.9,0.2,539.1,599.8), null);


// stage content:
(lib.O365_SMBSimplified_USA_160x600_BAN_Bookings_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(cont3D, 1, {x:72, y:"+=118", z:-950, ease:Power4.easeInOut}, "+=0.5");
...
p.nominalBounds = new cjs.Rectangle(-76.9,300,459.1,300);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_160x600_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574944999701", id:"O365_SMBSimplified_USA_160x600_BAN_Bookings_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
