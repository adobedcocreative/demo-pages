...
lib.ssMetadata = [
		{name:"O365_SMBSimplified_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[464,1134,324,39],[612,988,323,37],[612,1027,323,36],[464,1175,323,33],[612,1103,322,26],[464,1230,322,17],[464,1210,322,18],[612,1065,322,36],[322,1404,321,56],[0,1404,320,77],[600,887,318,99],[600,765,316,120],[296,993,314,139],[0,1240,310,155],[592,595,308,168],[292,813,306,178],[590,407,304,186],[644,0,301,192],[590,208,299,197],[292,611,298,200],[292,407,296,202],[0,1034,294,204],[0,199,292,206],[352,0,290,206],[0,616,290,207],[0,825,290,207],[0,407,290,207],[0,0,350,197],[312,1134,150,268],[891,194,120,111]]}
];
...
(lib.Laptop_Base = function() {
	this.initialize(ss["O365_SMBSimplified_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(54).call(this.frame_54).wait(20).call(this.frame_74).wait(1));
...
// stage content:
(lib.O365_SMBSimplified_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=150", ease:Power4.easeInOut}, "+=0.2");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574951986012", id:"O365_SMBSimplified_USA_300x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
