...
var getFeed1 = function(){
  ...
  var url = "https://spreadsheets.google.com/feeds/list/1nish5XJEwgYErcQcCB2__tTu1VSniCP-rw80Uc1au58/1/public/values?alt=json";
      ...
      if (this.readyState == 4 && this.status == 200) {
          ...
          JSONData.feed.entry.map(function(data){
            feedTemplate1.push({
              ...
              "textField6": data['gsx$textfield6']['$t'],
            });
          });
