...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHM_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,404,333],[918,526,100,100],[306,437,100,100],[0,539,100,100],[408,437,100,100],[714,495,100,100],[510,437,100,100],[612,495,100,100],[102,539,100,100],[204,539,100,100],[204,437,100,100],[816,526,100,100],[408,335,100,100],[612,393,100,100],[714,393,100,100],[816,424,100,100],[510,335,100,100],[0,437,100,100],[102,437,100,100],[918,424,100,100],[0,335,100,100],[204,335,100,100],[102,335,100,100],[306,335,100,100],[882,322,100,100],[705,0,221,320],[705,322,175,69],[406,0,297,333]]}
];
...
(lib._300x250_bg = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHM_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.tractor_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-65,-14,0.815,0.815);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.tractor_1, new cjs.Rectangle(-65,-14,242.1,271.4), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-28,-20,0.84,0.84);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-28,-20,339.4,279.7), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(66.7,203.1,0.925,0.925,0,0,0,72.1,205.6);
	...
	this.image_2.setTransform(67.9,203.1,0.94,0.94,0,0,0,72.2,205.6);
	...
	this.image_3.setTransform(70,203,0.97,0.97,0,0,0,72,205.9);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-60.1,-16.1,403.4,271.3), null);


// stage content:
(lib.O365SMB_BKNGSHM_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.05, scaleY:1.05, x: "-=115", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "-=105", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:1, scaleY:1, x: "-=85", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(89.9,108.9,403.4,271.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHM_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535014898127", id:"O365SMB_BKNGSHM_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
