...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,262,333],[487,0,195,333],[861,0,100,100],[888,102,100,100],[786,204,100,100],[786,306,100,100],[684,275,100,100],[366,322,100,100],[888,204,100,100],[264,322,100,100],[888,306,100,100],[684,173,100,100],[0,335,100,100],[684,71,100,100],[102,335,100,100],[786,102,100,100],[468,335,100,100],[408,437,100,100],[570,335,100,100],[672,377,100,100],[306,424,100,100],[774,408,100,100],[204,424,100,100],[0,437,100,100],[102,437,100,100],[876,408,100,100],[264,0,221,320],[684,0,175,69]]}
];
...
(lib._160_bg = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._160_tractor = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.tractor = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib._160_tractor();
	this.instance.parent = this;
	this.instance.setTransform(-14,-54);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.tractor, new cjs.Rectangle(-14,-54,195,333), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(60,-22,0.889,0.889);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(60,-22,232.8,295.9), null);
...
(lib.man_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(133,167,0.89,0.89);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(205.6,181.2,0.824,0.824,4.1,0,0,259.5,26.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(91,-11,0.894,0.894);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(170));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(91,-11,197.8,286.2);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAxKIAA2zMAzFAAAIAAWzgA5iuJMAAAgjAMAzFAAAMAAAAjAg");
	this.shape.setTransform(152.5,117.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// image tractor
	this.image_2 = new lib.tractor();
	this.image_2.name = "image_2";
	this.image_2.parent = this;
	this.image_2.setTransform(11.1,226,0.855,0.855,0,0,0,72.1,205.6);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

	// image man
	this.image_1 = new lib.man_1();
	this.image_1.name = "image_1";
	this.image_1.parent = this;
	this.image_1.setTransform(-5.9,225.4,0.869,0.869,0,0,0,72.1,205.7);
	...
	this.image_3.setTransform(-12.9,227.9,0.897,0.897,0,0,0,72,206);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-62.5,-197.4,378.5,629.2), null);


// stage content:
(lib.O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:0.869, scaleY:0.869, x: "-=12", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:0.855, scaleY:0.855, x: "-=30", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:0.897, scaleY:0.897, x: "-=4", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(17.5,277.6,378.5,629.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534846964024", id:"O365SMB_BKNGSHM_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
