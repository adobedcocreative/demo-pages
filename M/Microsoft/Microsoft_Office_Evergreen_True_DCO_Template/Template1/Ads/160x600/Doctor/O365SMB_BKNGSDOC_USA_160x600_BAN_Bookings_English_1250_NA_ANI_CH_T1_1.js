...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSDOC_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,305,210,301],[0,0,329,303]]}
];
...
(lib._160x600_bg = function() {
	this.spriteSheet = ss["O365SMB_BKNGSDOC_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.dr = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(5,15,0.791,0.791);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.dr, new cjs.Rectangle(5,15,260.3,239.8), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib._160x600_bg();
	this.instance.parent = this;
	this.instance.setTransform(-18,12,0.805,0.805);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-18,12,169.1,242.3), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgOmAzdIAA2yIdNAAIAAWygAumwdMAAAgi/IdMAAMAAAAi/g");
	this.shape.setTransform(82.5,120.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// image dr
	this.image_1 = new lib.dr();
	this.image_1.name = "image_1";
	this.image_1.parent = this;
	this.image_1.setTransform(222.9,184.1,1,1,0,0,0,260,134.3);
	...
	this.image_2.setTransform(221.9,184,1.1,1.1,0,0,0,196.3,164.7);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-32.1,-208.4,260.3,658.7), null);


// stage content:
(lib.O365SMB_BKNGSDOC_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.msft_logo, 1, { x: "-=300",ease:Power1.easeOut}, "+=1.4")
		
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.21, scaleY:1.21, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1.21, scaleY:1.21, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			
		
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=0.7")
...
p.nominalBounds = new cjs.Rectangle(47.9,266.6,260.3,658.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSDOC_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535016179435", id:"O365SMB_BKNGSDOC_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
