...
lib.ssMetadata = [
		{name:"O365SMB_OCMFLO_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[402,0,267,337],[0,0,400,249],[671,0,181,139],[671,223,110,80],[895,246,110,80],[783,246,110,80],[336,421,110,80],[448,421,110,80],[672,492,110,80],[560,469,110,80],[671,141,110,80],[854,82,110,80],[783,164,110,80],[895,164,110,80],[336,339,110,80],[783,328,110,80],[560,387,110,80],[0,251,110,80],[895,328,110,80],[112,333,110,80],[0,333,110,80],[224,333,110,80],[448,339,110,80],[112,415,110,80],[112,251,110,80],[672,410,110,80],[784,410,110,80],[896,410,110,80],[0,415,110,80],[224,415,110,80],[224,251,110,80],[671,305,110,80],[854,0,110,80]]}
];
...
(lib.bg_300x600 = function() {
	this.spriteSheet = ss["O365SMB_OCMFLO_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(185,44,1.027,1.027);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(185,44,186,142.8), null);
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(0,-76,267,337), null);
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(192,214.8,0.72,0.72,0,2.7,-177.3,365.3,68.7);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-17,26);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(163));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-17,26,400,249);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(30.9,1.5,0.92,0.92,0,0,0,10.9,10.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAypIAA2zMAzFAAAIAAWzgA5ivoMAAAgjAMAzFAAAMAAAAjAg");
	this.shape.setTransform(152.5,109.1);
	...
	this.image_1.setTransform(0,226.1,0.91,0.91,0,0,0,87.9,185.8);
	...
	this.image_2.setTransform(181.5,220.7,0.93,0.93,0,0,0,273.1,142);
	...
	this.image_3.setTransform(-56.5,205,0.97,0.97,0,0,0,32.4,162.9);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-95.4,-214.9,411.5,648.2), null);


// stage content:
(lib.O365SMB_OCMFLO_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.mainMC.setTransform(0,177.1,1,1,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.mainMC).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-15.5,262.1,411.5,648.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMFLO_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535016247119", id:"O365SMB_OCMFLO_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
