...
lib.ssMetadata = [
		{name:"O365_OTLK_USA_300x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,812,324,150],[0,0,400,480],[0,482,342,328],[326,812,45,84],[0,964,167,44]]}
];
...
(lib.monitorSmall = function() {
	this.initialize(ss["O365_OTLK_USA_300x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.emailScreen = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A6gOxIAA9hMA1BAAAIAAdhg");
	this.shape_1.setTransform(-0.975,254.125);
...
}).prototype = getMCSymbolPrototype(lib.emailScreen, new cjs.Rectangle(-171,-164,342,512.6), null);
...
(lib.circleAnim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({_off:false},0).to({scaleX:0.1688,scaleY:0.1688},12).to({scaleX:0.2682,scaleY:0.2682,alpha:0},9).to({_off:true},1).wait(7));
...
(lib.screens = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(9).call(this.frame_9).wait(110).call(this.frame_119).wait(20).call(this.frame_139).wait(135).call(this.frame_274).wait(20).call(this.frame_294).wait(47).call(this.frame_341).wait(1));

	// Layer 6 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_231 = new cjs.Graphics().p("A6tfkMAAAg/HMA1bAAAMAAAA/Hg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(231).to({graphics:mask_graphics_231,x:43,y:182}).wait(111));
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.screen.setTransform(116.05,129.35,0.75,0.75,0,0,0,0.1,0.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3bFNIAAqaMAu3AAAIAAKag");
	mask.setTransform(150,393.35);

	// phone_300250.png copy
	this.instance_1 = new lib.phone_300250();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,10.45,0.75,0.8501);
...
}).prototype = getMCSymbolPrototype(lib.Intro, new cjs.Rectangle(0,-79.1,300,521.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.logo.name = "logo";
	this.logo.parent = this;
	this.logo.setTransform(56.9,193,0.312,0.312);
	...
	this.replay_btn.setTransform(284,4.3,0.3475,0.3475,0,0,180);
	...
	this.txtCta.setTransform(227,556,0.4964,0.4964);
	...
	this.cta.setTransform(246.35,553.7,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.device_2.setTransform(243.9,376.75,1.2,1.2,0,0,0,-0.1,-0.2);
	...
	this.device_1.setTransform(151.1,314.1,1.2,1.2,0,0,0,0.1,0.1);
	...
	this.shape.setTransform(149.9975,299.985,0.9872,2.3669);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-95,-4.2,426.3,629.6), null);


// stage content:
(lib.O365_OTLK_USA_300x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.finalframe.from(mc.device_1, 1, {x: "+=364", ease: Power4.easeOut}, "-=.5")
			exportRoot.finalframe.from(mc.device_2, 1, {x: "+=364", ease: Power4.easeOut}, "-=.9")
			exportRoot.finalframe.from(mc.replay_btn, 0.7, {alpha: 0, ease: Power4.easeOut}, "-=0.3")
			...
			exportRoot.phoneO = new TimelineLite();
				exportRoot.phoneO.to(mc.anim, .8, {x: "-=300", ease: Power4.easeIn})
...
p.nominalBounds = new cjs.Rectangle(55,295.8,276.3,329.59999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_OTLK_USA_300x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_.png?1542128644985", id:"O365_OTLK_USA_300x600_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
