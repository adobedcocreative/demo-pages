...
lib.ssMetadata = [
		{name:"O365_MacUsrs_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_", frames: [[0,252,300,250],[0,0,300,250],[0,504,265,166]]}
];
...
(lib.IPhone = function() {
	this.initialize(ss["O365_MacUsrs_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.shapeMC, new cjs.Rectangle(0,0,971,813.9), null);
...
(lib.white = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.shapeMC.cache(-971,-814,1942,1628,2)
	}
	...
	this.shapeMC.setTransform(485.4,406.9,1,1,0,0,0,485.4,406.9);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.4931,scaleY:4.4931,x:299.05,y:339.25},13,cjs.Ease.quadOut).to({x:120.75},12,cjs.Ease.quadInOut).to({_off:true},1).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:300.9},12,cjs.Ease.quadInOut).wait(52));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},12,cjs.Ease.quadInOut).wait(25).to({regY:0.4,scaleX:2.2638,scaleY:2.2638,x:-14.75,y:11.6},21,cjs.Ease.quadInOut).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({x:-674.7},21,cjs.Ease.quadIn).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(53).to({x:-674.7},21,cjs.Ease.quadIn).wait(4));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("Ar5CVIAAkpIXzAAIAAEpg");
	this.shape.setTransform(9.5,1.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-66.6,-13.6,152.3,29.799999999999997), null);
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.iPhone.setTransform(151.05,148.8,0.9443,0.9443,0,0,0,88.2,73.5);
	...
	this.screenMC.setTransform(151,152.1,1,1,0,0,0,71.5,44.8);
	...
	this.laptopMC.setTransform(151.05,152,0.23,0.23,0,0,0,0,0.2);
	...
	this.laptop2.name = "laptop2";
	this.laptop2.parent = this;
	this.laptop2.setTransform(132.15,195.95,0.1359,0.1359,0,0,0,1.1,2.6);
	...
	this.macPro2.setTransform(79.2,169.9,0.9224,0.9224,0,0,0,100.5,84);
	...
	this.macPro.setTransform(145.5,159.05,1,1,0,0,0,100.5,83.8);

	this.timeline.addTween(cjs.Tween.get(this.macPro).wait(1));

}).prototype = getMCSymbolPrototype(lib.Intro, new cjs.Rectangle(-13.5,75.3,268.3,171.60000000000002), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(237.5,220.65,0.4964,0.4964);
	...
	this.cta.setTransform(259.85,218.7,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.anim.setTransform(300,250.2,1,1,0,0,0,300,250.2);

	this.timeline.addTween(cjs.Tween.get(this.anim).wait(1));

	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AFxT0IAAu/IR/AAIx/AAIAAO/I9gAAMAAAgnnMAvfAAAIAAYoIAAO/g");
	this.shape.setTransform(150.025,124.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-13.4,-1.9,354,254), null);


// stage content:
(lib.O365_MacUsrs_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			for (var i = 0; i < exportRoot.headline1.length; i++) {
				exportRoot.tlH1O.to(exportRoot.headline1[i], 0.7, {	x: "-=20", alpha: 0, ease:Power4.easeIn}, "-=0.35");
			}
			...
			for (var i = 0; i < exportRoot.headline2.length; i++) {
				exportRoot.tlH2O.to(exportRoot.headline2[i], 0.7, { x: "-=20",	alpha: 0,ease:Power4.easeIn}, "-=0.35");
			}
			...
			for (var i = 0; i < exportRoot.headline3.length; i++) {
				exportRoot.tlH3O.to(exportRoot.headline3[i], 0.7, {	x: "-=20",	alpha: 0,ease:Power4.easeIn}, "-=0.35");
			}
			exportRoot.tlH3O.stop()	
			
			this.tl1 = new TimelineLite();
		
			exportRoot.tl1.from(mc.replay_btn, 0.7, {alpha: 0,	x: "+=300",	onStart: function(){exportRoot.tlH1.play()},ease: Power4.easeOut}, "-=0.5")
			...
			TweenLite.delayedCall(1.9, function(){mc.anim.laptopMC.play()})
			exportRoot.mainTimeline.from(mc.anim.screenMC, 0.5, {alpha:0, onStart: function(){exportRoot.tlH1I.play()}}, "+=1")
			exportRoot.mainTimeline.to(mc.anim.laptopMC, 0.6, {x:"-=100", alpha:0, ease: Power3.easeIn}, "+=1.6")
			...
			exportRoot.mainTimeline.to(mc.anim.macPro, 0.6, {x:"-=100", alpha:0, ease: Power3.easeIn, onStart: function(){exportRoot.tlH2O.play()}}, "+=1.6")
			...
			exportRoot.mainTimeline.to(mc.anim.iPhone, 0.8, {x:39, y:205, scaleX:0.44, scaleY:0.44, alpha:1, ease: Power1.easeInOut, onStart: function(){exportRoot.tlH3O.play()}}, "+=1.8")
		    exportRoot.mainTimeline.from(mc.anim.macPro2, 0.8, {x:"+=313", y:"-=o", alpha:0, ease: Power1.easeInOut}, "-=0.6")
			exportRoot.mainTimeline.from(mc.anim.laptop2, 0.8, {x:"+=313", y:"-=o", alpha:0, ease: Power1.easeInOut}, "-=0.6")
			TweenLite.delayedCall(12, function(){exportRoot.tlH1.play()})
			TweenLite.delayedCall(12, function(){exportRoot.tl1.play()})
...
p.nominalBounds = new cjs.Rectangle(136.6,123.1,204.00000000000003,129);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_MacUsrs_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_.png?1542203987040", id:"O365_MacUsrs_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_2_atlas_"}
	],
	preloads: []
};
