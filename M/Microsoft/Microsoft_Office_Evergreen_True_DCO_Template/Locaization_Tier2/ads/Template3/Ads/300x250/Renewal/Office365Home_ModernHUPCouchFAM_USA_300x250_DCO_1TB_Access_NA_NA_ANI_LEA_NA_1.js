...
(lib.sofa = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-16,58,0.655,0.655);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-16,58,419.2,201.10000000000002);
...
(lib.cta_bg = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("Ar5CXIAAktIXyAAIAAEtg");
	this.shape.setTransform(76.15,15.125);
...
(lib.background = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#F8F9EF","#F3F4EB","#E5E1D3","#C4BCA5"],[0,0.478,0.82,1],-154.4,0,154.5,0).s().p("A4ITxMAAAgnhMAwRAAAMAAAAnhg");
	this.shape.setTransform(154.475,126.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.background, new cjs.Rectangle(0,0,309,253), null);
...
(lib.cta_background = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.cta_bg.cache(-152,-30,304,60,2)
	}
	...
	this.cta_bg.setTransform(76.2,15.1,1,1,0,0,0,76.2,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_bg).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta_background, new cjs.Rectangle(0,0,152.3,30.3), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_0 = function() {
		this.bg.cache(-309,-253,618,506,2)
	}
	...
	this.bg.name = "bg";
	this.bg.parent = this;
	this.bg.setTransform(154.5,126.5,1,1,0,0,0,154.5,126.5);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(0,0,309,253), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(14.05,0.15,1,1,0,0,0,76.2,15.1);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(152.55,126.55,1,1,0,0,0,154.5,126.5);
...
(lib.Office365Home_ModernHUPCouchFAM_USA_300x250_DCO_1TB_Access_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 1,	x: "-=300",	ease:Power4.easeOut}, "-=0.7");
