...
lib.ssMetadata = [
		{name:"O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,502,335],[0,337,502,335]]}
];
...
(lib.TeamHome = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.TeamHome_300x600_Bg = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.TeamHome_300x600_Bg();
	this.instance.parent = this;
	this.instance.setTransform(-67,-21,0.86,0.86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-67,-21,431.7,288.1), null);
...
(lib.laptop = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-67,-21,0.881,0.881);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.laptop, new cjs.Rectangle(-67,-21,442.3,295.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(282.2,-170.2,0.348,0.348,0,0,180,-0.3,0);
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAvhIAA54MAzFAAAIAAZ4gA5ixuIAA9xMAzFAAAIAAdxg");
	this.shape.setTransform(152.5,127.6);
	...
	this.image_1.setTransform(473.9,-37.6,1.1,1.1,0,0,0,513.9,-69.4);
	...
	this.image_2.setTransform(493.8,-37.6,1.05,1.05,0,0,0,513.8,-69.5);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-165.1,-178,502.4,609.6), null);


// stage content:
(lib.O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "+=40", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(-15.2,297,502.4,609.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535020269642", id:"O365SMB_TMSHOME_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
