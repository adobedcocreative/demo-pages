...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSDOC_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,305,332,339],[0,0,500,303]]}
];
...
(lib._300x600_bg = function() {
	this.spriteSheet = ss["O365SMB_BKNGSDOC_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.dr = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-2,13,0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.dr, new cjs.Rectangle(-2,13,400,242.4), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(27,-19,0.82,0.82);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(27,-19,272.3,278), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAwXIAAx+MAzFAAAIAAR+gA5izIIAA9OMAzFAAAIAAdOg");
	this.shape.setTransform(152.5,122.1);
	...
	this.image_1.setTransform(267,314.1,1,1,0,0,0,259.3,252.2);
	...
	this.image_2.setTransform(267,314.1,1.15,1.15,0,0,0,261.8,255.3);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11,-187.4,416.7,619), null);


// stage content:
(lib.O365SMB_BKNGSDOC_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.22, scaleY:1.22, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1.22, scaleY:1.22, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(139,287.6,416.7,619);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSDOC_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535017709923", id:"O365SMB_BKNGSDOC_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
