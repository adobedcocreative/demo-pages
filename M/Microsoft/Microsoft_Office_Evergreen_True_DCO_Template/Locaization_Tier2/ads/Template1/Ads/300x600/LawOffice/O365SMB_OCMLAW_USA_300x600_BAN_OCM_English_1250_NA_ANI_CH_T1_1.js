...
lib.ssMetadata = [
		{name:"O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,432,369],[0,660,265,138],[0,371,432,287],[267,660,80,76]]}
];
...
(lib.bg_300x600 = function() {
	this.spriteSheet = ss["O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.fg2_300x600_light = function() {
	this.spriteSheet = ss["O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-82,93,0.876,0.876);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.lady_fg, new cjs.Rectangle(-82,93,232.2,120.9), null);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-47,39,0.88,0.88);

	this.instance_1 = new lib.fg2_300x600_light();
	this.instance_1.parent = this;
	this.instance_1.setTransform(129,-39,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(-47,-39,380.2,330.6), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-33,-11,0.854,0.854);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-33,-11,369.1,315.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(283.1,-170.2,0.348,0.348,0,0,180,-0.3,0);
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAvTIAAx/MAzFAAAIAAR/gA5iyEIAA9OMAzFAAAIAAdOg");
	this.shape.setTransform(152.5,127.2);
	...
	this.image_1.setTransform(455.7,346.5,0.9,0.9,0,0,0,237.5,240);
	...
	this.image_2.setTransform(440.7,346.4,0.95,0.95,0,0,0,418.4,317.3);
	...
	this.image_3.setTransform(437.4,336.3,0.97,0.97,0,0,0,431.6,325.3);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-13.2,-178,390.4,607.9), null);


// stage content:
(lib.O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=0.4")
...
p.nominalBounds = new cjs.Rectangle(136.8,297,390.4,607.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535015592451", id:"O365SMB_OCMLAW_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
