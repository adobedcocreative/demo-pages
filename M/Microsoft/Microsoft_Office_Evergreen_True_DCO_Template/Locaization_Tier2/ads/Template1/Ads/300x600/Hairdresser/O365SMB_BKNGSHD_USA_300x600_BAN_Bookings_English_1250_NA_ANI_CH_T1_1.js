...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHD_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,367,314],[0,316,396,275]]}
];
...
(lib.bg_300x600 = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHD_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-25,56,0.945,0.945);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(-25,56,374.2,259.9), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-17,21,0.94,0.94);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-17,21,345,295.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAvvIAAx+MAzFAAAIAAR+gA5iv7IAA/zMAzFAAAIAAfzg");
	this.shape.setTransform(152.5,125.1);
	...
	this.image_1.setTransform(173.7,191,1.2,1.2,0,0,0,173.6,190.9);
	...
	this.image_2.setTransform(217.1,191,1.05,1.05,0,0,0,217,190.9);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-64.6,-180.4,449.1,611), null);


// stage content:
(lib.O365SMB_BKNGSHD_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.1")
...
p.nominalBounds = new cjs.Rectangle(85.4,294.6,449.1,611);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHD_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534845194448", id:"O365SMB_BKNGSHD_USA_300x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
