...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHD_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,277,209,314],[0,0,396,275]]}
];
...
(lib.bg_160x600 = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHD_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-120,51,0.945,0.945);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(-120,51,374.2,259.9), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-15,-1,0.98,0.98);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-15,-1,204.8,307.7), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgOmAzbIAA2zIdNAAIAAWzgAumwaMAAAgjAIdMAAMAAAAjAg");
	this.shape.setTransform(82.5,121.1);
	...
	this.image_1.setTransform(118,248.8,0.85,0.85,0,0,0,118,248.8);
	...
	this.image_2.setTransform(118,248,0.94,0.94,0,0,0,118,248);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-84.3,-207.9,318.1,658.2), null);


// stage content:
(lib.O365SMB_BKNGSHD_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=0.9")
...
p.nominalBounds = new cjs.Rectangle(-4.3,267.1,318.1,658.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHD_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534783252322", id:"O365SMB_BKNGSHD_USA_160x600_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
