...
p.nominalBounds = new cjs.Rectangle(0,0,350,263);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-84,245,0.72,0.72);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-84,245,252,189.4), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-88.5,-3,392.6,608), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_160x600_BAN_Excel_Ease_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 0.8, {  scaleX:1, scaleY:1, x: "-=330", y: "-=0", ease:Power1.easeInOut}, "-=.6")
...
p.nominalBounds = new cjs.Rectangle(-8.5,297.1,384,607.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537301070960", id:"Computer"}
	],
	preloads: []
};
