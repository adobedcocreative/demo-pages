...
(lib.O365_CreateYourBestWork_USA_160x600_BAN_Excel_Ease_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 0.8, {  scaleX:1, scaleY:1, x: "-=230", y: "-=0", ease:Power1.easeInOut, onStart:function(){exportRoot.tl2.play()}}, "-=.6")


			exportRoot.tl1.stop()

			exportRoot.tl2.to(mc.replay_btn, 0.7, {alpha: 1,	x: "-=300",ease: Power4.easeOut}, "-=0.5")
			exportRoot.tl2.to(mc.txtCta, 0.7, { alpha: 1,	x: "-=160",	 ease:Power4.easeOut}, "+=.8");
			exportRoot.tl2.to(mc.cta, 0.7, {	alpha: 1,	x: "-=160",	 ease:Power4.easeOut}, "-=0.7");
