...
p.nominalBounds = new cjs.Rectangle(0,0,398,347);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-76,249);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-76,249,398,347), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-47,-3,352,608), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_300x600_BAN_Excel_Ease_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(103,297.1,352,607.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537203495425", id:"Computer"}
	],
	preloads: []
};
