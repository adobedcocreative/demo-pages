...
p.nominalBounds = new cjs.Rectangle(0,0,400,270);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-78,218,0.95,0.95);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-78,218,380,256.5), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("Ap4CmIAAlLITxAAIAAFLg");
	this.shape.setTransform(45.5,0.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-17.8,-16.3,126.6,33.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hit.setTransform(184.2,336.8,0.496,0.496,0,0,0,0,0.1);
	...
	this.txtCta.setTransform(225.7,556.4,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(217.7,513.7,1,1,0,0,0,2.5,-0.5);
	...
	this.cta.setTransform(199.1,554.4,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.image_1.setTransform(96.1,79.8,1,1,0,0,0,100.6,79.8);
	...
	this.shape.setTransform(150.8,301,1,2.04);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-82.5,-3,387.6,608), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_300x600_BAN_Excel_Ease_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 0.8, {  scaleX:1, scaleY:1, x: "-=500", y: "-=0", ease:Power1.easeInOut, onStart:function(){exportRoot.tl2.play()}}, "-=.6")
...
p.nominalBounds = new cjs.Rectangle(67.5,297.1,387.6,607.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537275278872", id:"Computer"}
	],
	preloads: []
};
