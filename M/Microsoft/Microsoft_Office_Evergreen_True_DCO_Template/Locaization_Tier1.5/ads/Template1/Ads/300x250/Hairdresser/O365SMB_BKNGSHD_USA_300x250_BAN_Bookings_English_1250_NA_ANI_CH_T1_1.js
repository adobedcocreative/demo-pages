...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHD_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,445,314],[0,316,396,275]]}
];
...
(lib.bg_300x250jpgcopy = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHD_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(7,26,0.86,0.86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(7,26,340.6,236.5), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-21,-8,0.86,0.86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-21,-8,382.7,270.1), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(-2.4,-3.5,1,1,0,0,0,-2.4,-1);
	...
	this.image_2.setTransform(-0.7,-2.2,1,1,0,0,0,-0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-21,-10.9,382.7,270.9), null);


// stage content:
(lib.O365SMB_BKNGSHD_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { x: "-=125", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { x: "-=90", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(129,114.1,382.7,270.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHD_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534782753638", id:"O365SMB_BKNGSHD_USA_300x250_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
