...
lib.ssMetadata = [
		{name:"O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,303,373],[0,646,167,137],[0,375,303,269],[169,646,76,72]]}
];
...
(lib.bg_160x600 = function() {
	this.spriteSheet = ss["O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.fg1_160x600 = function() {
	this.spriteSheet = ss["O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.fg1_160x600();
	this.instance.parent = this;
	this.instance.setTransform(42,170,0.893,0.893);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.lady_fg, new cjs.Rectangle(42,170,149.2,122.4), null);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-110,-5,0.889,0.889);

	this.instance_1 = new lib.fg2_160x600();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-294,69,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(-294,-5,272.7,316.1), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-375,-143,0.93,0.93);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-375,-143,281.8,346.9), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A5iRgMAAAgi/MAzFAAAMAAAAi/g");
	this.shape.setTransform(152.5,-104);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A5iLZIAA2xMAzFAAAIAAWxg");
	this.shape_1.setTransform(152.5,360.9);
	...
	this.image_1.setTransform(368.2,340.4,0.85,0.85,0,0,0,321.4,338.3);
	...
	this.image_2.setTransform(352.2,340.3,0.9,0.9,0,0,0,126.3,363.6);
	...
	this.image_3.setTransform(348.3,340.4,0.97,0.97,0,0,0,35.3,234.9);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-49.7,-215.9,365.8,649.8), null);


// stage content:
(lib.O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "-=25", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "-=9", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:1, scaleY:1, x: "-=5", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(30.3,259.1,365.8,649.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535015357953", id:"O365SMB_OCMLAW_USA_160x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
