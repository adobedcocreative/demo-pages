...
lib.ssMetadata = [
		{name:"O365SMB_OCMREA_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,331,336],[0,338,248,325],[250,338,225,300]]}
];
...
(lib.bg_300x600 = function() {
	this.spriteSheet = ss["O365SMB_OCMREA_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(156,33,0.808,0.808);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.lady_fg, new cjs.Rectangle(156,33,200.5,262.7), null);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(13,49,0.811,0.811);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(13,49,182.6,243.5), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-9,-32,0.975,0.975);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-9,-32,322.7,327.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAxJIAAx+MAzFAAAIAAR+gA5iz6IAA9OMAzFAAAIAAdOg");
	...
	this.image_1.setTransform(169.3,314.9,1.2,1.2,0,0,0,154.7,292.1);
	...
	this.image_2.setTransform(143.7,314.2,1.12,1.12,0,0,0,152.7,291.4);
	...
	this.image_3.setTransform(148.7,314.3,1.05,1.05,0,0,0,148.7,293.2);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-16.9,-197.4,428.4,629), null);


// stage content:
(lib.O365SMB_OCMREA_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.05, scaleY:1.05, x: "-=20", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			...
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=0.1")
...
p.nominalBounds = new cjs.Rectangle(133.1,277.6,428.4,629);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMREA_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535019421204", id:"O365SMB_OCMREA_USA_300x600_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
