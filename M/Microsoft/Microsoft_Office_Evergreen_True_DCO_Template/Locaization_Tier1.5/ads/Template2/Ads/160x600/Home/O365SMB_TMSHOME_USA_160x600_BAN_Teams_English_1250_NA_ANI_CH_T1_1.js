...
lib.ssMetadata = [
		{name:"O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,263,262],[0,264,263,262]]}
];
...
(lib.TeamHome = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.TeamHome_160x600_Bg = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.TeamHome_160x600_Bg();
	this.instance.parent = this;
	this.instance.setTransform(178,67);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(178,67,263,262), null);
...
(lib.laptop = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(99,-3,0.939,0.939);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.laptop, new cjs.Rectangle(99,-3,247,246.1), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(30.6,1.5,0.92,0.92,0,0,0,10.9,10.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(142.2,-170.2,0.348,0.348,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(62.3,395.3,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(15.5,348.3);
	...
	this.cta.setTransform(75.5,393.8,0.943,0.943,0,0,0,0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgatA31IAA+YMAzFAAAIAAeYgA4XtQMAAAgqkMAzFAAAMAAAAqkg");
	this.shape.setTransform(142.6,112.5);
	...
	this.image_1.setTransform(-31.9,240,1.1,1.1,0,0,0,167.8,208.4);
	...
	this.image_2.setTransform(18,240,1.05,1.05,0,0,0,251,282.5);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-107.6,-244.8,421.2,714.7), null);


// stage content:
(lib.O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "+=100", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "+=50", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=315",	 ease:Power4.easeOut}, "+=0.5")
...
p.nominalBounds = new cjs.Rectangle(-27.6,230.2,421.2,714.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534841451816", id:"O365SMB_TMSHOME_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
