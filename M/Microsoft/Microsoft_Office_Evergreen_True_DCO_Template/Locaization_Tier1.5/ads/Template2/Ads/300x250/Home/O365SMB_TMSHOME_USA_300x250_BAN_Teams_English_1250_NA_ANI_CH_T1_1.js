...
lib.ssMetadata = [
		{name:"O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,0,400,267],[0,269,400,267]]}
];
...
(lib.TeamHome_300x250_Bg = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.TeamHome_300x250_Front = function() {
	this.spriteSheet = ss["O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
p.nominalBounds = new cjs.Rectangle(-20,117,175.3,114.5);
...
(lib.desk = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.TeamHome_300x250_Front();
	this.instance.parent = this;
	this.instance.setTransform(-45,-12,0.987,0.987);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.desk, new cjs.Rectangle(-45,-12,394.8,263.6), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.TeamHome_300x250_Bg();
	this.instance.parent = this;
	this.instance.setTransform(-38,-13,0.983,0.983);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-38,-13,393.2,262.4), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// image laptop
	this.image_4 = new lib.laptop();
	this.image_4.name = "image_4";
	this.image_4.parent = this;
	this.image_4.setTransform(157.1,27.1,1,1,0,0,0,157.1,27.1);
	...
	// image ppl
	this.image_1 = new lib.desk();
	this.image_1.name = "image_1";
	this.image_1.parent = this;
	this.image_1.setTransform(113.3,-0.1,1.05,1.05,0,0,0,113.3,-0.1);
	...
	this.image_2.setTransform(113.1,9.9,0.97,0.97,0,0,0,118.8,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-52.9,-12.6,414.6,276.7), null);


// stage content:
(lib.O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			TweenLite.delayedCall(3.5, function(){exportRoot.tlFH.play()})
		
		    
			exportRoot.tl1.to(mc.box, 1.3, { y: "-=400",	 ease:Power1.easeOut}, "+1")
			exportRoot.tl1.to(mc.image_1, 1, { scaleX:.87, scaleY:.87, x: "+=0", y: "-=8", ease:Power1.easeInOut}, "-=0.9")
			exportRoot.tl1.to(mc.image_2, 1, { scaleX:.9, scaleY:.9, x: "+=0", y: "-=7", ease:Power1.easeInOut}, "-=1")
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	y: "-=300",	 ease:Power4.easeOut}, "+=0.1")
...
p.nominalBounds = new cjs.Rectangle(97.1,112.4,414.6,276.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535361671966", id:"O365SMB_TMSHOME_USA_300x250_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
