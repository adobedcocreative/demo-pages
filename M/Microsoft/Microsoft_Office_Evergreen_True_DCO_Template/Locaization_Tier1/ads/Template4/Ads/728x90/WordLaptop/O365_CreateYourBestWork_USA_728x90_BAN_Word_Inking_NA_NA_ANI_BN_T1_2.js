...
lib.ssMetadata = [
		{name:"O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_", frames: [[759,251,93,13],[482,291,377,42],[482,335,377,16],[759,61,100,29],[759,92,100,29],[759,0,153,59],[759,123,20,126],[482,0,275,289],[0,0,480,360]]}
];
...
(lib.highlighted = function() {
	this.spriteSheet = ss["O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"];
	this.gotoAndStop(0);
...
(lib.device_animation = function(mode,startPosition,loop) {
	...
	this.frame_88 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "+=40", y: "+=90", scaleX: 0.91, scaleY: 0.91,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_140 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "+=0", y: "-=122", scaleX: 0.91, scaleY: 0.91,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_286 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=152", y: "+=13", scaleX: 0.24, scaleY: 0.24,	ease: Power3.easeInOut}, "-=0");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(88).call(this.frame_88).wait(52).call(this.frame_140).wait(146).call(this.frame_286).wait(23).call(this.frame_309).wait(9).call(this.frame_318).wait(2).call(this.frame_320).wait(1));
	...
	mask_1._off = true;
	var mask_1_graphics_205 = new cjs.Graphics().p("AgfgMIAPgEIAwAdIgPAFg");
	var mask_1_graphics_206 = new cjs.Graphics().p("AgogIIAkgNIAtAhIgiAKg");
	var mask_1_graphics_207 = new cjs.Graphics().p("AgygEIA6gVIArAkIg0APg");
	var mask_1_graphics_208 = new cjs.Graphics().p("Ag7AAIBQgdIAnAnIhIAUg");
	var mask_1_graphics_209 = new cjs.Graphics().p("AhFAEIBmglIAlAqIhbAZg");
	var mask_1_graphics_210 = new cjs.Graphics().p("AhOAIIB7gtIAiAtIhuAeg");
	var mask_1_graphics_211 = new cjs.Graphics().p("AhXAMICRg1IAeAwIiBAjg");
	var mask_1_graphics_212 = new cjs.Graphics().p("AhhAQICng9IAcAzIiVAog");
	var mask_1_graphics_213 = new cjs.Graphics().p("AhLAnIgigWIBTgdIBpggIARATIAMAXIACAIIAAACIinAlg");
	var mask_1_graphics_214 = new cjs.Graphics().p("AhUAqIglgYIBbggIB2gcIAEACIARANIANAaIAAAJIgBABIiXAYIgeAJIgDABg");
	var mask_1_graphics_215 = new cjs.Graphics().p("AiHASIBjgkICDgYIAEABIAXAKIAOAdIgDAKIgBABIinATIggAKIgEACIgXADg");
	var mask_1_graphics_216 = new cjs.Graphics().p("AiVARIBsgoICPgUIAGAAIAaAJIAQAfIgGALIgBAAIi2APIgjAMIgEACIgaAHg");
	var mask_1_graphics_217 = new cjs.Graphics().p("AiiAQIB0gqICigSIAfAHIAQAiIgHALIjIAKIglANIghAOg");
	var mask_1_graphics_218 = new cjs.Graphics().p("AiaAmIgkgVICAgwIAJgBIDAgKIAlAFIADACIAMAlIgDANIgBABIjsAAIgCAAIhRAbg");
	var mask_1_graphics_219 = new cjs.Graphics().p("AjaARICUg3IDogEIArADIAEACIAKAsIAAAQIkRgLIgDAAIheAcIgaADg");
	var mask_1_graphics_220 = new cjs.Graphics().p("Aj4AQICog9IE9AFIAMBGIk6gWIiJAmg");
	var mask_1_graphics_221 = new cjs.Graphics().p("AhkgBIiKAlIgugeIDVhMIFkBBIh2BMg");
	var mask_1_graphics_222 = new cjs.Graphics().p("AiNgUIiKAmIgugdIEChcIGJB7Ij3BUg");
	var mask_1_graphics_223 = new cjs.Graphics().p("Ai2gmIiKAmIgvgdIEvhrIGvC3Il3Bag");
	var mask_1_graphics_224 = new cjs.Graphics().p("AjAgvIiKAnIgugeIFChyIGvDOIlGBjg");
	var mask_1_graphics_225 = new cjs.Graphics().p("AhlCjIgageIhFi9IiGAlIgugeIFChyIGvDOImXB5g");
	var mask_1_graphics_226 = new cjs.Graphics().p("AiyCOIgSjGIiGAlIgugeIFChyIGvDOImTBxIiDAIg");
	var mask_1_graphics_227 = new cjs.Graphics().p("AjxCRIAsjMIiFAlIgugeIFChyIGvDOImYB0Ii+ALg");
	var mask_1_graphics_228 = new cjs.Graphics().p("AlCCRIB9jNIiFAmIgugeIFChyIGvDOImdB2IkJAJg");
	var mask_1_graphics_229 = new cjs.Graphics().p("AkxB8IB3i9IiAAnIgugeIFChxIGvDOImdB2Il0APg");
	var mask_1_graphics_230 = new cjs.Graphics().p("AmwCZICngpIB2iuIh/AmIgugeIFBhxIGwDOImnCBg");
	var mask_1_graphics_231 = new cjs.Graphics().p("AnDBmICmgqICaiZIh7AlIgvgeIFBhxIGwDOIo0DBg");
	var mask_1_graphics_232 = new cjs.Graphics().p("AnQBTICngqICuiGIh3AlIgugeIFBhxIGwDOIo0DBg");
	var mask_1_graphics_233 = new cjs.Graphics().p("AnjAJIC1gJIClhbIhWAWIgugeIFAhxIGxDPIqADag");
	var mask_1_graphics_234 = new cjs.Graphics().p("AnzgxID9AXIB9hBIhWAWIgugeIFBhxIGwDPIp/Dag");
	var mask_1_graphics_235 = new cjs.Graphics().p("AnriPIEJBnIBhgxIhWAWIgugeIFBhxIGwDPIrbDWg");
	var mask_1_graphics_236 = new cjs.Graphics().p("AnrAZIBRggIAiglIBCgeIg5gWIGqh0IGwDPIp/Dag");
	var mask_1_graphics_290 = new cjs.Graphics().p("AlAHMIiqqsIBQghIAigmIBDgeIg6gWILlhyIB1Obg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(205).to({graphics:mask_1_graphics_205,x:171,y:256.2}).wait(1).to({graphics:mask_1_graphics_206,x:171.9,y:255.7}).wait(1).to({graphics:mask_1_graphics_207,x:172.9,y:255.3}).wait(1).to({graphics:mask_1_graphics_208,x:173.8,y:254.9}).wait(1).to({graphics:mask_1_graphics_209,x:174.8,y:254.5}).wait(1).to({graphics:mask_1_graphics_210,x:175.7,y:254.1}).wait(1).to({graphics:mask_1_graphics_211,x:176.6,y:253.7}).wait(1).to({graphics:mask_1_graphics_212,x:177.6,y:253.2}).wait(1).to({graphics:mask_1_graphics_213,x:178.8,y:253.1}).wait(1).to({graphics:mask_1_graphics_214,x:180,y:253}).wait(1).to({graphics:mask_1_graphics_215,x:181.4,y:253.1}).wait(1).to({graphics:mask_1_graphics_216,x:182.8,y:253.2}).wait(1).to({graphics:mask_1_graphics_217,x:184.1,y:253.3}).wait(1).to({graphics:mask_1_graphics_218,x:186.9,y:253.2}).wait(1).to({graphics:mask_1_graphics_219,x:189.7,y:253.2}).wait(1).to({graphics:mask_1_graphics_220,x:192.7,y:253.2}).wait(1).to({graphics:mask_1_graphics_221,x:196.3,y:254.2}).wait(1).to({graphics:mask_1_graphics_222,x:200.4,y:256.1}).wait(1).to({graphics:mask_1_graphics_223,x:204.6,y:257.9}).wait(1).to({graphics:mask_1_graphics_224,x:205.5,y:258.8}).wait(1).to({graphics:mask_1_graphics_225,x:205.5,y:259.9}).wait(1).to({graphics:mask_1_graphics_226,x:205.5,y:259.9}).wait(1).to({graphics:mask_1_graphics_227,x:205.5,y:260.2}).wait(1).to({graphics:mask_1_graphics_228,x:205.5,y:260.2}).wait(1).to({graphics:mask_1_graphics_229,x:203.9,y:260.6}).wait(1).to({graphics:mask_1_graphics_230,x:199.9,y:260.4}).wait(1).to({graphics:mask_1_graphics_231,x:198,y:263.5}).wait(1).to({graphics:mask_1_graphics_232,x:196.7,y:263.5}).wait(1).to({graphics:mask_1_graphics_233,x:194.8,y:264.9}).wait(1).to({graphics:mask_1_graphics_234,x:193.2,y:264.9}).wait(1).to({graphics:mask_1_graphics_235,x:194,y:264.6}).wait(1).to({graphics:mask_1_graphics_236,x:194.1,y:264.9}).wait(54).to({graphics:mask_1_graphics_290,x:194,y:289.9}).wait(20).to({graphics:null,x:0,y:0}).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},205).to({state:[{t:this.instance_1}]},85).to({state:[{t:this.instance_1}]},20).wait(11));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(290).to({_off:false},0).to({y:339.1,alpha:0},20,cjs.Ease.quadInOut).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_3}]},126).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4}]}).wait(321));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(61).to({_off:false},0).wait(75).to({y:212.2},29,cjs.Ease.quadInOut).to({_off:true},110).wait(46));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_0 = new cjs.Graphics().p("A1bbbMAAAgnOMA6yAAAMAAAAnOg");
	var mask_3_graphics_136 = new cjs.Graphics().p("A9ZTiMAAAgnCMA6yAAAMAAAAnCg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:mask_3_graphics_0,x:239.1,y:175.5}).wait(136).to({graphics:mask_3_graphics_136,x:290.1,y:226.1}).wait(185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(136).to({y:213.6},29,cjs.Ease.quadInOut).wait(125).to({y:292.4},20,cjs.Ease.quadInOut).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(321));

	// surface
	this.instance_8 = new lib.Surfacelaptop1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(45,75.1,1.025,1.025);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(985,86.1,0.272,0.272,0,0,0,-40,1.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.49,scaleY:4.49,x:985.1,y:86},13,cjs.Ease.quadOut).to({x:806.8},12,cjs.Ease.quadInOut).to({_off:true},1).wait(76));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EA0sAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_15 = new cjs.Graphics().p("EAzhAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_16 = new cjs.Graphics().p("EAyWAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_17 = new cjs.Graphics().p("EAxMAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_18 = new cjs.Graphics().p("EAwBAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_19 = new cjs.Graphics().p("EAu2AKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_20 = new cjs.Graphics().p("EAtrAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_21 = new cjs.Graphics().p("EAsgAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_22 = new cjs.Graphics().p("EArVAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_23 = new cjs.Graphics().p("EAqLAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_24 = new cjs.Graphics().p("EApAAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_25 = new cjs.Graphics().p("EAn1AKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_26 = new cjs.Graphics().p("EAmqAKiIAAvIMA5GAAAIAAPIg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:702.6,y:67.4}).wait(1).to({graphics:mask_graphics_15,x:695.1,y:67.4}).wait(1).to({graphics:mask_graphics_16,x:687.6,y:67.4}).wait(1).to({graphics:mask_graphics_17,x:680.1,y:67.4}).wait(1).to({graphics:mask_graphics_18,x:672.6,y:67.4}).wait(1).to({graphics:mask_graphics_19,x:665.1,y:67.4}).wait(1).to({graphics:mask_graphics_20,x:657.7,y:67.4}).wait(1).to({graphics:mask_graphics_21,x:650.2,y:67.4}).wait(1).to({graphics:mask_graphics_22,x:642.7,y:67.4}).wait(1).to({graphics:mask_graphics_23,x:635.2,y:67.4}).wait(1).to({graphics:mask_graphics_24,x:627.7,y:67.4}).wait(1).to({graphics:mask_graphics_25,x:620.3,y:67.4}).wait(1).to({graphics:mask_graphics_26,x:612.8,y:67.4}).wait(1).to({graphics:null,x:0,y:0}).wait(76));

	// Layer 3
	this.instance_1 = new lib.MSFT_Logo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(807.4,80.6,4.493,4.493,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.instance_2 = new lib.MSFT_Logo_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(986.9,80.6,4.493,4.493,0,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:986.9},12,cjs.Ease.quadInOut).wait(13).to({_off:false},0).wait(2).to({regX:0,regY:0,scaleX:2.25,scaleY:2.25,x:-16.4,y:11},22,cjs.Ease.quadInOut).wait(40));
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.devices.setTransform(163.3,117.4,0.364,0.364,0,0,0,343.4,250.1);

	this.timeline.addTween(cjs.Tween.get(this.devices).wait(307));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(54.8,53.8,178.9,134.1);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(712.1,4.3,0.348,0.348,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(666.8,46,0.496,0.496);
	...
	this.bg_circle.setTransform(628.1,14.9);
	...
	this.cta.setTransform(685.8,44.1,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.anim.setTransform(202,-54.6);
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg5QAHeIAAu6MByhAAAIAAO6g");
	this.shape.setTransform(364.5,45.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.9,-2,765.9,135.3), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
		    ...
		    exportRoot.tl1.to(mc.anim, 0.7, {alpha: 1,	y: "-=200",ease: Power4.easeOut, onStart:function(){mc.anim.devices.play()}}, "-=0")
			exportRoot.tl1.to(mc.cta, 0.7, {alpha: 1,	x: "-=120",	ease: Power4.easeOut}, "-=0.7");
			exportRoot.tl1.to(mc.txtCta, 0.7, {alpha: 1,	x: "-=120", ease: Power4.easeOut}, "-=0.7");
...
p.nominalBounds = new cjs.Rectangle(362.1,43,765.9,135.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_.png?1537307995411", id:"O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"}
	],
	preloads: []
};
