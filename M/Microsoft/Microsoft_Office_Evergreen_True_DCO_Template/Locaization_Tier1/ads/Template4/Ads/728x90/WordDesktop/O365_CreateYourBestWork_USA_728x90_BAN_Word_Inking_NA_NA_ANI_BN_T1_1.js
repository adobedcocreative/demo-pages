...
lib.ssMetadata = [
		{name:"O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_", frames: [[701,123,93,13],[402,291,377,42],[402,335,377,16],[679,61,100,29],[679,92,100,29],[679,0,153,59],[679,123,20,126],[402,0,275,289],[0,0,400,358]]}
];
...
(lib.highlighted = function() {
	this.spriteSheet = ss["O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.device_animation = function(mode,startPosition,loop) {
	...
	this.frame_286 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=152", y: "+=12", scaleX: 0.24, scaleY: 0.24,	ease: Power3.easeInOut}, "-=0");
	}
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(984.1,86.1,0.272,0.272,0,0,0,-40,1.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.49,scaleY:4.49,x:984.2,y:86},13,cjs.Ease.quadOut).to({x:805.9},12,cjs.Ease.quadInOut).to({_off:true},1).wait(76));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EA0oAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_15 = new cjs.Graphics().p("EAzdAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_16 = new cjs.Graphics().p("EAySAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_17 = new cjs.Graphics().p("EAxHAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_18 = new cjs.Graphics().p("EAv8AKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_19 = new cjs.Graphics().p("EAuyAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_20 = new cjs.Graphics().p("EAtnAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_21 = new cjs.Graphics().p("EAscAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_22 = new cjs.Graphics().p("EArRAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_23 = new cjs.Graphics().p("EAqGAKiIAAvIMA5GAAAIAAPIg");
	var mask_graphics_24 = new cjs.Graphics().p("EAo8AKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_25 = new cjs.Graphics().p("EAnxAKiIAAvIMA5FAAAIAAPIg");
	var mask_graphics_26 = new cjs.Graphics().p("EAmmAKiIAAvIMA5GAAAIAAPIg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:702.1,y:67.4}).wait(1).to({graphics:mask_graphics_15,x:694.6,y:67.4}).wait(1).to({graphics:mask_graphics_16,x:687.2,y:67.4}).wait(1).to({graphics:mask_graphics_17,x:679.7,y:67.4}).wait(1).to({graphics:mask_graphics_18,x:672.2,y:67.4}).wait(1).to({graphics:mask_graphics_19,x:664.7,y:67.4}).wait(1).to({graphics:mask_graphics_20,x:657.2,y:67.4}).wait(1).to({graphics:mask_graphics_21,x:649.8,y:67.4}).wait(1).to({graphics:mask_graphics_22,x:642.3,y:67.4}).wait(1).to({graphics:mask_graphics_23,x:634.8,y:67.4}).wait(1).to({graphics:mask_graphics_24,x:627.3,y:67.4}).wait(1).to({graphics:mask_graphics_25,x:619.8,y:67.4}).wait(1).to({graphics:mask_graphics_26,x:612.4,y:67.4}).wait(1).to({graphics:null,x:0,y:0}).wait(76));

	// Layer 3
	this.instance_1 = new lib.MSFT_Logo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(806.5,80.6,4.493,4.493,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.instance_2 = new lib.MSFT_Logo_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(986.1,80.6,4.493,4.493,0,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:986.1},12,cjs.Ease.quadInOut).wait(13).to({_off:false},0).wait(2).to({regX:0,regY:0,scaleX:2.25,scaleY:2.25,x:-16.4,y:11},22,cjs.Ease.quadInOut).wait(40));
...
p.nominalBounds = new cjs.Rectangle(71,58.5,145.4,130.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.9,-2,765.9,136), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(362.1,43,765.9,136);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_.png?1537303991303", id:"O365_CreateYourBestWork_USA_728x90_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_"}
	],
	preloads: []
};
