...
lib.ssMetadata = [
		{name:"O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_", frames: [[759,251,93,13],[482,291,377,42],[482,335,377,16],[759,92,100,29],[759,61,100,29],[759,0,153,59],[759,123,20,126],[482,0,275,289],[0,0,480,360]]}
];
...
(lib.highlighted = function() {
	this.spriteSheet = ss["O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"];
	this.gotoAndStop(0);
...
(lib.logocopy2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(59).call(this.frame_59).wait(27).call(this.frame_86).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:4.09,scaleY:4.09,x:76.5,y:341.8},13,cjs.Ease.quadOut).to({x:-85.7},12,cjs.Ease.quadInOut).to({_off:true},1).wait(76));
	...
	this.instance_3 = new lib.MSFT_Logo();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-16.3,-550.8,2.246,2.246);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},12).to({state:[{t:this.instance_2}]},15).to({state:[{t:this.instance_3}]},22).to({state:[]},25).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:78.1},12,cjs.Ease.quadInOut).wait(77));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},12,cjs.Ease.quadInOut).wait(15).to({_off:true,regX:0,regY:0,scaleX:2.25,scaleY:2.25,x:-16.3,y:-550.8},22,cjs.Ease.quadInOut).wait(40));
...
(lib.device_animation = function(mode,startPosition,loop) {
	...
	this.frame_85 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "+=162", y: "-=23", scaleX: 1.14, scaleY: 1.14,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_140 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=87", y: "-=0", scaleX: 1.14, scaleY: 1.14,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_290 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=20", y: "+=75", scaleX: 0.6, scaleY: 0.6,	ease: Power3.easeInOut}, "-=0");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(85).call(this.frame_85).wait(55).call(this.frame_140).wait(150).call(this.frame_290).wait(23).call(this.frame_313).wait(9).call(this.frame_322).wait(2).call(this.frame_324).wait(1));
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.devices.setTransform(183.1,130.9,0.314,0.314,0,0,0,287.9,258);

	this.timeline.addTween(cjs.Tween.get(this.devices).wait(307));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(106.8,73.5,207.9,166.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(144.8,4.1,0.348,0.348,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(98.3,570.2,0.496,0.496);
	...
	this.bg_circle.setTransform(59.6,539.4);
	...
	this.cta.setTransform(117.3,568.3,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.anim.setTransform(-103.7,169.9);
	...
	this.shape.setTransform(80.1,302.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-6.6,199.6,617.9), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
		    ...
		    exportRoot.tl1.to(mc.anim, 0.9, {alpha: 1,	x: "-=250",ease: Power4.easeOut, onStart:function(){mc.anim.devices.play()}})
			exportRoot.tl1.to(mc.cta, 0.7, {alpha: 1,	x: "-=120",	ease: Power4.easeOut}, "-=0.9");
			exportRoot.tl1.to(mc.txtCta, 0.7, {alpha: 1,	x: "-=120", ease: Power4.easeOut}, "-=0.9");
...
p.nominalBounds = new cjs.Rectangle(75.8,293.4,199.6,617.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_.png?1537280823801", id:"O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"}
	],
	preloads: []
};
