...
p.nominalBounds = new cjs.Rectangle(0,0,227,198);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-54,268,0.908,0.908);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-54,268,206.2,179.8), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(72.3,873.8,0.23,0.23,0,0,0,-39.6,1.9);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:3.81,scaleY:3.81,y:873.6},13,cjs.Ease.quadOut).to({x:-78.9},12,cjs.Ease.quadInOut).to({_off:true},1).wait(76));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EgO6BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_15 = new cjs.Graphics().p("EgP5BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_16 = new cjs.Graphics().p("EgQ5BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_17 = new cjs.Graphics().p("EgR4BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_18 = new cjs.Graphics().p("EgS4BHfIAAs2MAwYAAAIAAM2g");
	var mask_graphics_19 = new cjs.Graphics().p("EgT3BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_20 = new cjs.Graphics().p("EgU2BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_21 = new cjs.Graphics().p("EgV2BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_22 = new cjs.Graphics().p("EgW1BHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_23 = new cjs.Graphics().p("EgX1BHfIAAs2MAwYAAAIAAM2g");
	var mask_graphics_24 = new cjs.Graphics().p("EgYLBHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_25 = new cjs.Graphics().p("EgYLBHfIAAs2MAwXAAAIAAM2g");
	var mask_graphics_26 = new cjs.Graphics().p("EgYLBHfIAAs2MAwXAAAIAAM2g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:214.1,y:457.5}).wait(1).to({graphics:mask_graphics_15,x:207.8,y:457.5}).wait(1).to({graphics:mask_graphics_16,x:201.4,y:457.5}).wait(1).to({graphics:mask_graphics_17,x:195.1,y:457.5}).wait(1).to({graphics:mask_graphics_18,x:188.8,y:457.5}).wait(1).to({graphics:mask_graphics_19,x:182.4,y:457.5}).wait(1).to({graphics:mask_graphics_20,x:176.1,y:457.5}).wait(1).to({graphics:mask_graphics_21,x:169.7,y:457.5}).wait(1).to({graphics:mask_graphics_22,x:163.4,y:457.5}).wait(1).to({graphics:mask_graphics_23,x:157.1,y:457.5}).wait(1).to({graphics:mask_graphics_24,x:146.6,y:457.5}).wait(1).to({graphics:mask_graphics_25,x:133.9,y:457.5}).wait(1).to({graphics:mask_graphics_26,x:121.2,y:457.5}).wait(1).to({graphics:null,x:0,y:0}).wait(76));

	// Layer 3
	this.instance_1 = new lib.MSFT_Logo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-78.2,869,3.808,3.808,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.instance_2 = new lib.MSFT_Logo_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(73.8,869,3.808,3.808,0,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:73.8},12,cjs.Ease.quadInOut).wait(13).to({_off:false},0).wait(2).to({regY:0.1,scaleX:2.29,scaleY:2.29,x:-15.1,y:11.1},22,cjs.Ease.quadInOut).to({_off:true},1).wait(39));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D83B01").s().p("AolCgIAAk/IRLAAIAAE/g");
	this.shape.setTransform(37.8,0.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-17.1,-15.6,110,31.9), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(144.65,4.3,0.348,0.348,0,0,180,-0.3,0);
	...
	this.hit.setTransform(59.1,351.3,0.496,0.496,0,0,0,0,0.1);
	...
	this.txtCta.setTransform(100.6,570.9,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(92.6,528.2,1,1,0,0,0,2.5,-0.5);
	...
	this.cta.setTransform(74,568.9,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.image_1.setTransform(96.1,79.9,1,1,0,0,0,100.6,79.8);

	this.timeline.addTween(cjs.Tween.get(this.image_1).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgNEAvgMAAAhe/IaJAAMAAABe/g");
	this.shape.setTransform(80.3,301);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-58.5,-3,362.6,608), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_160x600_BAN_Excel_Ease_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 0.8, {  scaleX:1, scaleY:1, x: "-=230", y: "-=0", ease:Power1.easeInOut}, "-=.6")
			exportRoot.tl1.to(mc.txtCta, 0.7, { alpha: 1,	x: "-=160",	 ease:Power4.easeOut}, "+=.8");
			exportRoot.tl1.to(mc.cta, 0.7, {	alpha: 1,	x: "-=160",	 ease:Power4.easeOut, onStart:function(){exportRoot.tl2.play()}}, "-=0.7");
		...
		mc.image_1.x +=230
		mc.txtCta.x += 160; mc.txtCta.alpha = 0
		mc.cta.x += 160; mc.cta.alpha = 0
		mc.replay_btn.x+=300;
	}
...
p.nominalBounds = new cjs.Rectangle(21.5,297.1,354,607.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Computer.png?1537202717992", id:"Computer"}
	],
	preloads: []
};
