...
lib.ssMetadata = [
		{name:"O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_", frames: [[701,123,93,13],[402,291,377,42],[402,335,377,16],[679,61,100,29],[679,92,100,29],[679,0,153,59],[679,123,20,126],[402,0,275,289],[0,0,400,358]]}
];
...
(lib.highlighted = function() {
	this.spriteSheet = ss["O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.device_animation = function(mode,startPosition,loop) {
	...
	this.frame_85 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "+=156", y: "+=15", scaleX: 0.92, scaleY: 0.92,	ease: Power4.easeInOut}, "-=0");
	}
	...
	this.frame_290 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=80", y: "+=40", scaleX: 0.51, scaleY: 0.51,	ease: Power3.easeInOut}, "-=0");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(85).call(this.frame_85).wait(59).call(this.frame_144).wait(146).call(this.frame_290).wait(23).call(this.frame_313).wait(9).call(this.frame_322).wait(2).call(this.frame_324).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(61).to({_off:false},0).wait(79).to({y:212.2},29,cjs.Ease.quadInOut).to({_off:true},110).wait(46));
...
(lib.Intro = function(mode,startPosition,loop) {
	...
	this.devices.setTransform(145.6,130.4,0.506,0.506,0,0,0,287.9,257.9);

	this.timeline.addTween(cjs.Tween.get(this.devices).wait(307));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(45.4,44.5,202.3,181);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-58.3,-6.6,253.8,617.9), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(21.7,293.4,253.8,617.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_.png?1537275584859", id:"O365_CreateYourBestWork_USA_160x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_1_atlas_"}
	],
	preloads: []
};
