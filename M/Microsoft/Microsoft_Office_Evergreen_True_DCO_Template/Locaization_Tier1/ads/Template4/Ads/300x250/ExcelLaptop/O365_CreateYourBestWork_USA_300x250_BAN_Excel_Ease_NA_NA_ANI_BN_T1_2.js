...
(lib.Surfacelaptop1 = function() {
	this.initialize(img.Surfacelaptop1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,262,178);// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Surfacelaptop1();
	this.instance.parent = this;
	this.instance.setTransform(149,75);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(149,75,262,178), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:300.9},12,cjs.Ease.quadInOut).wait(13).to({_off:false},0).wait(2).to({regX:0,regY:0,scaleX:2.25,scaleY:2.25,x:-16.4,y:11},22,cjs.Ease.quadInOut).to({_off:true},1).wait(39));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(68.3,1.2,0.92,0.92,0,0,0,10.9,10.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(44.5,222,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(36.5,179.3,1,1,0,0,0,2.5,-0.5);
	...
	this.cta.setTransform(17.9,220,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.image_1.setTransform(83.5,81,0.89,0.89,0,0,0,100.5,79.9);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-40.8,-3,400.7,298), null);


// stage content:
(lib.O365_CreateYourBestWork_USA_300x250_BAN_Excel_Ease_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 0.8, {  scaleX:.89, scaleY:.89, x: "-=300", y: "-=0", ease:Power1.easeInOut}, "-=.6")
...
p.nominalBounds = new cjs.Rectangle(109.2,122.1,400.7,298);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Surfacelaptop1.png?1536829273667", id:"Surfacelaptop1"}
	],
	preloads: []
};
