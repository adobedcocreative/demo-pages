...
lib.ssMetadata = [
		{name:"O365_CreateYourBestWork_USA_300x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_", frames: [[0,0,410,308],[155,385,93,13],[0,310,377,42],[0,415,377,16],[257,354,100,29],[155,354,100,29],[0,354,153,59],[379,310,20,126],[412,0,275,289]]}
];
...
(lib._300x600_Surfacelaptop1 = function() {
	this.spriteSheet = ss["O365_CreateYourBestWork_USA_300x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"];
	this.gotoAndStop(0);
...
(lib.device_animation = function(mode,startPosition,loop) {
	...
	this.frame_92 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "+=130", y: "-=12", scaleX: 1.14, scaleY: 1.14,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_173 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=50", y: "-=0", scaleX: 1.14, scaleY: 1.14,	ease: Power4.easeInOut}, "-=0");
	}
	this.frame_290 = function() {
		TweenLite.to(exportRoot.mainMC.anim.devices, 1.2, {x: "-=40", y: "+=40", scaleX: 0.80, scaleY: 0.80,	ease: Power3.easeInOut}, "-=0");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(92).call(this.frame_92).wait(81).call(this.frame_173).wait(117).call(this.frame_290).wait(23).call(this.frame_313).wait(9).call(this.frame_322).wait(2).call(this.frame_324).wait(1));
	...
	// surface
	this.instance_8 = new lib._300x600_Surfacelaptop1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(46.5,74.9,1.194,1.194);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(325));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(46.5,74.9,489.7,367.9);
...
p.nominalBounds = new cjs.Rectangle(28,45.1,332.2,252.2);
...
// stage content:
(lib.O365_CreateYourBestWork_USA_300x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CreateYourBestWork_USA_300x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_.png?1537285516255", id:"O365_CreateYourBestWork_USA_300x600_BAN_Word_Inking_NA_NA_ANI_BN_T1_2_atlas_"}
	],
	preloads: []
};
