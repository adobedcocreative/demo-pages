...
lib.ssMetadata = [
		{name:"O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1_atlas_", frames: [[0,0,401,320],[0,322,311,303]]}
];
...
(lib.Video1_bg = function() {
	this.spriteSheet = ss["O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Video1_fgpngcopy = function() {
	this.spriteSheet = ss["O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.Video1_fgpngcopy();
	this.instance.parent = this;
	this.instance.setTransform(6,291,0.669,0.669);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(6,291,208,202.6), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.Video1_bg();
	this.instance.parent = this;
	this.instance.setTransform(-79,273,0.687,0.687);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-79,273,275.5,219.8), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(23.3,1.5,0.92,0.92,0,0,0,10.9,10.6);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-62.1,-15.2,152.3,30.3), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(99.4,551.2,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(64.9,519,1,1,0,0,0,2.5,-0.5);
	...
	this.cta.setTransform(116.8,549.2,0.943,0.943,0,0,0,0.1,0.2);
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgOUAwbIAAx+IcqAAIAAR+gAuUi6MAAAgtgIbrAAMAAAAtgg");
	this.shape.setTransform(80.8,298.9);
	...
	this.image_1.setTransform(40.6,492.9,0.92,0.92,0,0,0,60.6,493.1);
	...
	this.image_2.setTransform(55,493.5,0.97,0.97,0,0,0,60,493.5);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-79.8,-11.1,281.6,619.9), null);


// stage content:
(lib.O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "+=20", y: "+=0", ease:Power1.easeInOut}, "-=0.4")
...
p.nominalBounds = new cjs.Rectangle(0.2,288.9,281.6,619.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1_atlas_.png?1536760169257", id:"O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T1_1_atlas_"}
	],
	preloads: []
};
