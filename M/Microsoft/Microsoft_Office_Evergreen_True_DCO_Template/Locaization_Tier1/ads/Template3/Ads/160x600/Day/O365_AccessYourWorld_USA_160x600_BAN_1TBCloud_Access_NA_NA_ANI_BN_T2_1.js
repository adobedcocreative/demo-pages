...
lib.ssMetadata = [
		{name:"O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T2_1_atlas_", frames: [[0,444,282,226],[0,0,330,442]]}
];
...
(lib.bg = function() {
	this.spriteSheet = ss["O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T2_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-14,281,0.752,0.752);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(-14,281,248.1,332.3), null);
...
(lib.bg_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-87,227);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg_1, new cjs.Rectangle(-87,227,282,226), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(-6.7,533.4,0.8,0.8,0,0,0,11,593);
	...
	this.image_2.setTransform(-0.6,533.4,0.9,0.9,0,0,0,9.9,533.4);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-87.8,-11.1,290.8,619.9), null);


// stage content:
(lib.O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T2_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:.9, scaleY:.9, x: "+=20", y: "+=0", ease:Power1.easeInOut}, "-=0.4")
...
p.nominalBounds = new cjs.Rectangle(-7.8,288.9,290.8,619.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T2_1_atlas_.png?1536843520867", id:"O365_AccessYourWorld_USA_160x600_BAN_1TBCloud_Access_NA_NA_ANI_BN_T2_1_atlas_"}
	],
	preloads: []
};
