...
lib.ssMetadata = [
		{name:"O365SMB_TMSOTG_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,264,258,297],[0,0,324,262],[260,399,120,69],[260,470,120,69],[382,399,120,69],[260,328,120,69],[326,71,120,69],[326,142,120,69],[326,0,120,69],[382,470,120,69],[260,541,120,69],[382,328,120,69],[382,541,120,69],[122,563,120,69],[0,634,120,69],[244,612,120,69],[122,705,120,69],[366,683,120,69],[366,754,120,69],[0,563,120,69],[244,683,120,69],[244,754,120,69],[0,705,120,69],[366,612,120,69],[122,634,120,69],[260,264,214,62]]}
];
...
(lib._300x250_man_bck = function() {
	this.spriteSheet = ss["O365SMB_TMSOTG_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-58,13,1.143,1.143);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-58,13,370.5,299.6), null);
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(57,25,0.92,0.92);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(57,25,237.4,273.3), null);
...
(lib.logo_1 = function(mode,startPosition,loop) {
	...
	var mask_graphics_81 = new cjs.Graphics().p("EhL9CXxMAAAkvhMCXtAAAMAAAEvhg");
	var mask_graphics_82 = new cjs.Graphics().p("EhTXCXxMAAAkvhMCXtAAAMAAAEvhg");
	var mask_graphics_83 = new cjs.Graphics().p("EhatCXxMAAAkvhMCXtAAAMAAAEvhg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:404.6,y:199.1}).wait(1).to({graphics:mask_graphics_15,x:395.6,y:199.1}).wait(1).to({graphics:mask_graphics_16,x:386.6,y:199.1}).wait(1).to({graphics:mask_graphics_17,x:377.6,y:199.1}).wait(1).to({graphics:mask_graphics_18,x:368.5,y:199.1}).wait(1).to({graphics:mask_graphics_19,x:359.5,y:199.1}).wait(1).to({graphics:mask_graphics_20,x:350.5,y:199.1}).wait(1).to({graphics:mask_graphics_21,x:341.5,y:199.1}).wait(1).to({graphics:mask_graphics_22,x:332.4,y:199.1}).wait(1).to({graphics:mask_graphics_23,x:323.4,y:199.1}).wait(1).to({graphics:mask_graphics_24,x:314.4,y:199.1}).wait(1).to({graphics:mask_graphics_25,x:305.4,y:199.1}).wait(1).to({graphics:mask_graphics_26,x:296.4,y:199.1}).wait(1).to({graphics:null,x:0,y:0}).wait(35).to({graphics:mask_graphics_62,x:298,y:339.4}).wait(1).to({graphics:mask_graphics_63,x:296.9,y:339.4}).wait(1).to({graphics:mask_graphics_64,x:293.2,y:339.4}).wait(1).to({graphics:mask_graphics_65,x:286.7,y:339.4}).wait(1).to({graphics:mask_graphics_66,x:277.3,y:339.4}).wait(1).to({graphics:mask_graphics_67,x:264.5,y:339.4}).wait(1).to({graphics:mask_graphics_68,x:248.1,y:339.4}).wait(1).to({graphics:mask_graphics_69,x:227.6,y:339.4}).wait(1).to({graphics:mask_graphics_70,x:202.6,y:339.4}).wait(1).to({graphics:mask_graphics_71,x:172.6,y:339.4}).wait(1).to({graphics:mask_graphics_72,x:137.1,y:339.4}).wait(1).to({graphics:mask_graphics_73,x:95.5,y:339.4}).wait(1).to({graphics:mask_graphics_74,x:47.3,y:339.4}).wait(1).to({graphics:mask_graphics_75,x:-8,y:339.4}).wait(1).to({graphics:mask_graphics_76,x:-70.8,y:339.4}).wait(1).to({graphics:mask_graphics_77,x:-141.3,y:339.4}).wait(1).to({graphics:mask_graphics_78,x:-219.2,y:339.4}).wait(1).to({graphics:mask_graphics_79,x:-303.7,y:339.4}).wait(1).to({graphics:mask_graphics_80,x:-393.6,y:339.4}).wait(1).to({graphics:mask_graphics_81,x:-486.2,y:339.4}).wait(1).to({graphics:mask_graphics_82,x:-533.6,y:339.4}).wait(1).to({graphics:mask_graphics_83,x:-580.6,y:339.4}).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(63).to({regX:485.5,regY:407,x:296.9,y:339.4},0).wait(1).to({x:293.2},0).wait(1).to({x:286.8},0).wait(1).to({x:277.4},0).wait(1).to({x:264.6},0).wait(1).to({x:248.1},0).wait(1).to({x:227.6},0).wait(1).to({x:202.6},0).wait(1).to({x:172.6},0).wait(1).to({x:137.1},0).wait(1).to({x:95.6},0).wait(1).to({x:47.4},0).wait(1).to({x:-8},0).wait(1).to({x:-70.8},0).wait(1).to({x:-141.3},0).wait(1).to({x:-219.1},0).wait(1).to({x:-303.7},0).wait(1).to({x:-393.5},0).wait(1).to({x:-486.9},0).wait(1).to({x:-581.6},0).wait(1).to({regX:485.4,regY:406.9,x:-675.8,y:339.3},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(64).to({regX:485.5,regY:407,x:296.9,y:339.4},0).wait(1).to({x:293.2},0).wait(1).to({x:286.8},0).wait(1).to({x:277.4},0).wait(1).to({x:264.6},0).wait(1).to({x:248.1},0).wait(1).to({x:227.6},0).wait(1).to({x:202.6},0).wait(1).to({x:172.6},0).wait(1).to({x:137.1},0).wait(1).to({x:95.6},0).wait(1).to({x:47.4},0).wait(1).to({x:-8},0).wait(1).to({x:-70.8},0).wait(1).to({x:-141.3},0).wait(1).to({x:-219.1},0).wait(1).to({x:-303.7},0).wait(1).to({x:-393.5},0).wait(1).to({x:-486.9},0).wait(1).to({x:-581.6},0).wait(1).to({regX:485.4,regY:406.9,x:-675.8,y:339.3},0).to({_off:true},2).wait(1));
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAyPIAA53MAzFAAAIAAZ3gA5i0dIAA9xMAzFAAAIAAdxg");
	this.shape.setTransform(152.5,145.1);
	...
	this.image_1.setTransform(138,18,1.06,1.06,0,0,0,155.2,29.5);
	...
	this.image_2.setTransform(148,18,0.97,0.97,0,0,0,148,18);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-51.8,-178,367.8,644.6), null);


// stage content:
(lib.O365SMB_TMSOTG_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1.15, scaleY:1.15, x: "+=10", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			exportRoot.tl1.to(mc.image_2, 1.3, { scaleX:1, scaleY:1, x: "+=5", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
		
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=300",	 ease:Power4.easeOut}, "+=0.3")
...
p.nominalBounds = new cjs.Rectangle(98.2,297,367.8,644.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_TMSOTG_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535015059003", id:"O365SMB_TMSOTG_USA_300x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
