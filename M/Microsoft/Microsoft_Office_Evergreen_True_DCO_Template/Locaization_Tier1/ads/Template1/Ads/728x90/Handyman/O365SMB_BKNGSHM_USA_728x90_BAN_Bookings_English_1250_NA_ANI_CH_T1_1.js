...
lib.ssMetadata = [
		{name:"O365SMB_BKNGSHM_USA_728x90_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[223,245,191,104],[102,453,100,100],[381,351,100,100],[0,393,100,100],[408,453,100,100],[204,453,100,100],[177,351,100,100],[279,351,100,100],[306,453,100,100],[102,555,100,100],[0,495,100,100],[204,555,100,100],[204,657,100,100],[306,657,100,100],[0,699,100,100],[408,555,100,100],[102,657,100,100],[0,597,100,100],[408,657,100,100],[306,555,100,100],[102,759,100,100],[204,759,100,100],[306,759,100,100],[408,759,100,100],[0,801,100,100],[0,0,221,320],[0,322,175,69],[223,0,250,243]]}
];
...
(lib.bg_728x90 = function() {
	this.spriteSheet = ss["O365SMB_BKNGSHM_USA_728x90_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(170,-14,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.people, new cjs.Rectangle(170,-14,175,170.1), null);
...
(lib.grass = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(128,58);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.grass, new cjs.Rectangle(128,58,191,104), null);
...
(lib.man_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(137,158,0.819,0.819);
...
p.nominalBounds = new cjs.Rectangle(99,-4,181.4,260.8);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(56).call(this.frame_56).wait(35).call(this.frame_91).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({scaleX:4.49,scaleY:4.49,x:982.4,y:81.2},13,cjs.Ease.quadOut).to({x:804.1},12,cjs.Ease.quadInOut).to({_off:true},1).wait(65));
	...
	var mask_graphics_86 = new cjs.Graphics().p("Ei2wAbHMAAAg2NMFthAAAMAAAA2Ng");
	var mask_graphics_87 = new cjs.Graphics().p("Ei8WAbHMAAAg2NMFtiAAAMAAAA2Ng");
	var mask_graphics_88 = new cjs.Graphics().p("EjGdAbHMAAAg2NMFtiAAAMAAAA2Ng");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:701.2,y:65.1}).wait(1).to({graphics:mask_graphics_15,x:693.7,y:65.1}).wait(1).to({graphics:mask_graphics_16,x:686.2,y:65.1}).wait(1).to({graphics:mask_graphics_17,x:678.8,y:65.1}).wait(1).to({graphics:mask_graphics_18,x:671.3,y:65.1}).wait(1).to({graphics:mask_graphics_19,x:663.8,y:65.1}).wait(1).to({graphics:mask_graphics_20,x:656.3,y:65.1}).wait(1).to({graphics:mask_graphics_21,x:648.8,y:65.1}).wait(1).to({graphics:mask_graphics_22,x:641.4,y:65.1}).wait(1).to({graphics:mask_graphics_23,x:633.9,y:65.1}).wait(1).to({graphics:mask_graphics_24,x:626.4,y:65.1}).wait(1).to({graphics:mask_graphics_25,x:618.9,y:65.1}).wait(1).to({graphics:mask_graphics_26,x:611.4,y:65.1}).wait(1).to({graphics:null,x:0,y:0}).wait(25).to({graphics:mask_graphics_52,x:991,y:86.1}).wait(1).to({graphics:mask_graphics_53,x:989.2,y:86.1}).wait(1).to({graphics:mask_graphics_54,x:983.7,y:86.1}).wait(1).to({graphics:mask_graphics_55,x:974.6,y:86.1}).wait(1).to({graphics:mask_graphics_56,x:961.8,y:86.1}).wait(1).to({graphics:mask_graphics_57,x:945.4,y:86.1}).wait(1).to({graphics:mask_graphics_58,x:925.4,y:86.1}).wait(1).to({graphics:mask_graphics_59,x:901.7,y:86.1}).wait(1).to({graphics:mask_graphics_60,x:874.4,y:86.1}).wait(1).to({graphics:mask_graphics_61,x:843.4,y:86.1}).wait(1).to({graphics:mask_graphics_62,x:808.8,y:86.1}).wait(1).to({graphics:mask_graphics_63,x:770.5,y:86.1}).wait(1).to({graphics:mask_graphics_64,x:728.6,y:86.1}).wait(1).to({graphics:mask_graphics_65,x:683,y:86.1}).wait(1).to({graphics:mask_graphics_66,x:633.8,y:86.1}).wait(1).to({graphics:mask_graphics_67,x:581,y:86.1}).wait(1).to({graphics:mask_graphics_68,x:524.5,y:86.1}).wait(1).to({graphics:mask_graphics_69,x:464.4,y:86.1}).wait(1).to({graphics:mask_graphics_70,x:400.6,y:86.1}).wait(1).to({graphics:mask_graphics_71,x:333.2,y:86.1}).wait(1).to({graphics:mask_graphics_72,x:262.1,y:86.1}).wait(1).to({graphics:mask_graphics_73,x:187.4,y:86.1}).wait(1).to({graphics:mask_graphics_74,x:109,y:86.1}).wait(1).to({graphics:mask_graphics_75,x:27,y:86.1}).wait(1).to({graphics:mask_graphics_76,x:-58.6,y:86.1}).wait(1).to({graphics:mask_graphics_77,x:-147.9,y:86.1}).wait(1).to({graphics:mask_graphics_78,x:-240.8,y:86.1}).wait(1).to({graphics:mask_graphics_79,x:-337.4,y:86.1}).wait(1).to({graphics:mask_graphics_80,x:-437.6,y:86.1}).wait(1).to({graphics:mask_graphics_81,x:-541.5,y:86.1}).wait(1).to({graphics:mask_graphics_82,x:-649,y:86.1}).wait(1).to({graphics:mask_graphics_83,x:-760.1,y:86.1}).wait(1).to({graphics:mask_graphics_84,x:-874.9,y:86.1}).wait(1).to({graphics:mask_graphics_85,x:-993.4,y:86.1}).wait(1).to({graphics:mask_graphics_86,x:-1115.5,y:86.1}).wait(1).to({graphics:mask_graphics_87,x:-1205.5,y:86.1}).wait(1).to({graphics:mask_graphics_88,x:-1270.2,y:86.1}).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},12).to({state:[]},63).wait(3));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({_off:true,x:984.2},12,cjs.Ease.quadInOut).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({x:-1497.6},36,cjs.Ease.quadIn).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(54).to({x:-1481.3},36,cjs.Ease.quadIn).to({_off:true},1).wait(1));
...
(lib.introAnim = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(37.3,89.8,0.751,0.751,0,0,0,258.6,73.1);
	...
	this.image_2.setTransform(135.3,101.4,0.568,0.568,0,0,0,195,131.6);
	...
	this.image_3.setTransform(97.2,142.9,1.065,1.065,0,0,0,220.2,160.2);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.introAnim, new cjs.Rectangle(-29.2,24.4,231.7,148.1), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AncI6IAAxzMBDBAAAIAARzgEg7kAISIAAxLIUoAAIAARLg");
	this.shape.setTransform(373.8,47.6);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvzHqIAAvTIfnAAIAAPTg");
	mask.setTransform(224.8,46.1);

	// image ppl
	this.anim = new lib.introAnim();
	this.anim.name = "anim";
	this.anim.parent = this;
	this.anim.setTransform(124.5,-46.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-7.5,-9.4,762.6,114.1), null);


// stage content:
(lib.O365SMB_BKNGSHM_USA_728x90_BAN_Bookings_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			TweenLite.delayedCall(2.9, function(){exportRoot.tlFH.play()})
		
			
			exportRoot.tl1.to(mc.anim.image_1, 1.3, { scaleX:.751, scaleY:.751, x: "+=30", y: "+=0", ease:Power1.easeInOut}, "-=0.6")
			exportRoot.tl1.to(mc.anim.image_2, 1.3, { scaleX:.568, scaleY:.568, x: "+=20", y: "+=0", ease:Power1.easeInOut}, "-=1.4")
			exportRoot.tl1.to(mc.anim.image_3, 1.3, { scaleX:1.065, scaleY:1.065, x: "+=0", y: "+=0", ease:Power1.easeInOut}, "-=1.4")
			
			
			exportRoot.tl1.to(mc.bg_circle, 0.7, { alpha: 1,	x: "-=315",	 ease:Power4.easeOut}, "+=0.8")
...
p.nominalBounds = new cjs.Rectangle(356.5,22.6,762.6,148.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_BKNGSHM_USA_728x90_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535015395269", id:"O365SMB_BKNGSHM_USA_728x90_BAN_Bookings_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
