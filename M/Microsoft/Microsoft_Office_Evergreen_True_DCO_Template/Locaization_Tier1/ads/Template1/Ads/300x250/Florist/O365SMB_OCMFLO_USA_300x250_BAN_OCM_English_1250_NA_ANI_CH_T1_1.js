...
lib.ssMetadata = [
		{name:"O365SMB_OCMFLO_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[402,0,374,259],[0,0,400,249],[778,0,181,139],[672,387,110,80],[896,387,110,80],[784,387,110,80],[224,333,110,80],[336,343,110,80],[448,343,110,80],[560,343,110,80],[778,141,110,80],[0,333,110,80],[778,223,110,80],[784,305,110,80],[336,261,110,80],[890,223,110,80],[560,261,110,80],[224,251,110,80],[448,261,110,80],[672,305,110,80],[896,305,110,80],[890,141,110,80],[0,251,110,80],[112,251,110,80],[112,333,110,80],[672,469,110,80],[448,425,110,80],[0,415,110,80],[336,425,110,80],[112,415,110,80],[560,425,110,80],[784,469,110,80],[224,415,110,80]]}
];
...
(lib.bg_300x250 = function() {
	this.spriteSheet = ss["O365SMB_OCMFLO_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(0,-1,374,259), null);
...
(lib.lady_fg = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(162).to({mode:"single"},0).wait(1));
...
(lib.logos_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(64).to({x:-674.7},21,cjs.Ease.quadIn).to({_off:true},1).wait(1));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(33.2,1.2,0.92,0.92,0,0,0,10.9,10.6);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(213.2,222.2,0.496,0.496,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(164.4,180);
	...
	this.cta.setTransform(223.4,220.2,0.943,0.943,0,0,0,0.1,0.2);
	...
	this.image_1.setTransform(55.1,180,0.91,0.91,0,0,0,60.5,197.8);
	...
	this.image_2.setTransform(55,180.2,0.93,0.93,0,0,0,61.8,181.2);
	...
	this.image_3.setTransform(35,180,0.97,0.97,0,0,0,56.7,185.6);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-20,-2.9,368.5,255), null);


// stage content:
(lib.O365SMB_OCMFLO_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			TweenLite.delayedCall(3.3, function(){exportRoot.tlFH.play()})
		
		    
			exportRoot.tl1.to(mc.msft_logo, 1.3, { x: "-=700",	 ease:Power1.easeOut}, "+1")
			...
			exportRoot.tl1.to(mc.image_3, 1.3, { scaleX:1, scaleY:1, x: "-=54", y: "+=2.6", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(130,122.1,368.5,255);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_OCMFLO_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_.png?1535016317323", id:"O365SMB_OCMFLO_USA_300x250_BAN_OCM_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
