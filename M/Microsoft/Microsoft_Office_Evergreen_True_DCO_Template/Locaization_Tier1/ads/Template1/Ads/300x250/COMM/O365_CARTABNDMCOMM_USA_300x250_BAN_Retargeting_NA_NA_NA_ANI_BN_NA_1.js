...
(lib.BG3 = function() {
	this.initialize(ss["O365_CARTABNDMCOMM_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(2.6,6.35,2,2,0,0,0,0.1,0.1);
	...
	this.shape.setTransform(131.95,301.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.logos, new cjs.Rectangle(-146.4,-64.4,556.7,732.3), null);
...
(lib.logos_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({scaleX:4.4931,scaleY:4.4931,x:299.05,y:339.25},13,cjs.Ease.quadOut).to({x:120.75},12,cjs.Ease.quadInOut).to({_off:true},1).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},14).to({state:[{t:this.instance_3}]},12).to({state:[{t:this.instance_3}]},25).to({state:[]},30).wait(3));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({_off:true,x:300.9},12,cjs.Ease.quadInOut).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({x:-674.7},21,cjs.Ease.quadIn).to({_off:true},9).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(53).to({x:-674.7},21,cjs.Ease.quadIn).to({_off:true},9).wait(1));
...
(lib.people = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(177.15,143.4,1,1,0,0,0,18.6,-48.6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(132.75,257.2,1,1.0573,0,16.8852,0,3.3,8.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleY:1,skewX:0,x:140.4},59,cjs.Ease.quadInOut).wait(1));

	// Surface__0000_Hand_L
	this.instance_2 = new lib.Hand_L();
	this.instance_2.parent = this;
	this.instance_2.setTransform(125.05,241.85,1,1.0055,0,5.9548,0,15.6,27.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:15.5,scaleY:1,skewX:0,x:125.85},59,cjs.Ease.quadInOut).wait(1));
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	this.arrow.name = "arrow";
	this.arrow.parent = this;
	this.arrow.setTransform(20.85,1.2,0.92,0.92,0,0,0,10.9,10.6);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-62.1,-14.9,152.3,30.200000000000003), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(205.65,222.2,0.4964,0.4964,0,0,0,2,2.4);
	...
	this.bg_circle.setTransform(164.4,184.95);
	...
	this.cta.setTransform(223.35,220.2,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.msft_logo.setTransform(200.9,20.35,0.3475,0.3475,0,0,0,0.7,2.6);
	...
	this.image_0.setTransform(372.35,-18.1,0.9,0.9,0,0,180,-0.7,0.7);
	...
	this.image_1.setTransform(220.1,-4.6,0.9,0.8999,0,0,180,-2.4,-1);
	...
	this.image_2.setTransform(367.85,-18.1,0.9,0.9,0,0,180,-0.7,0.7);
	...
	this.image_3.setTransform(354.35,-18.1,0.9,0.9,0,0,180,-0.7,0.7);
	...
	this.image_4.setTransform(329.6,-18.1,0.9,0.9,0,0,180,-0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.image_4).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-42.7,-15.1,454.9,504), null);


// stage content:
(lib.O365_CARTABNDMCOMM_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			TweenLite.delayedCall(3.7, function(){exportRoot.tlFH.play()})
			TweenLite.delayedCall(4, function(){exportRoot.tlSH.play()})
			
			this.tl1 = new TimelineLite();
		    
			exportRoot.tl1.from(mc.msft_logo, 1.5, { x: "+=700",	 ease:Power1.easeInOut}, "+1")
			exportRoot.tl1.to(mc.image_0, 1.5, { x: "-=80", y: "+=0", ease:Power1.easeInOut}, "-=1.5")
			exportRoot.tl1.to(mc.image_1, 1.5, { x: "-=80", y: "+=0", ease:Power1.easeInOut, onStart:function(){mc.image_1.gotoAndPlay(1)}}, "-=1.5")
			exportRoot.tl1.to(mc.image_2, 1.5, { x: "-=75", y: "+=0", ease:Power1.easeInOut}, "-=1.5")
			exportRoot.tl1.to(mc.image_3, 1.5, { x: "-=50", y: "+=0", ease:Power1.easeInOut}, "-=1.5")
			exportRoot.tl1.to(mc.image_4, 1.5, { x: "-=10", y: "+=0", ease:Power1.easeInOut}, "-=1.5")	
			...
			exportRoot.tl1.from(mc.msft_logo, .1, { alpha: 1, ease:Power1.easeOut, onStart:function(){mc.image_1.stop(), mc.image_1.head.stop(), mc.image_1.head.head.stop(), mc.image_1.arm.stop()}}, "+5.2")
...
p.nominalBounds = new cjs.Rectangle(107.3,109.9,304.9,379);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_CARTABNDMCOMM_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_.png?1541782040371", id:"O365_CARTABNDMCOMM_USA_300x250_BAN_Retargeting_NA_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
