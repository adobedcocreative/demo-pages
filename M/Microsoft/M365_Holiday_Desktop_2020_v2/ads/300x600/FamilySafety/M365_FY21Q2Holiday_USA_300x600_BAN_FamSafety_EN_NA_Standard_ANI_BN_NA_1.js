...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x600_BAN_FamSafety_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,1612,907]]}
];
...
(lib.mobile = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x600_BAN_FamSafety_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.screen1, new cjs.Rectangle(0,0,806,453.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-71.5862,2.475,1.2071,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-130.3,-13,117.50000000000001,31), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(-13.6,253.3,1,1,0,0,0,174.5,155.4);
	...
	this.txtCta.setTransform(181.7,546.8,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(315.7,543.9,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-188.1,0,806,601.2), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x600_BAN_FamSafety_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-37.5,299.9,653.4,301.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x600_BAN_FamSafety_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602597405618", id:"M365_FY21Q2Holiday_USA_300x600_BAN_FamSafety_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
