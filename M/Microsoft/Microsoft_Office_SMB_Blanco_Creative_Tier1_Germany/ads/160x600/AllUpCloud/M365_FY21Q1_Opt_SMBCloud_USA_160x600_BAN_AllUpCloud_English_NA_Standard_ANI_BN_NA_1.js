...
(lib.excel = function() {
	this.initialize(ss["M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.word_blur = function(mode,startPosition,loop) {
...
(lib.teams_blur = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.blur_exchange = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Teams_screen = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.exchange_screen = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib.M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_.png?1597984161179", id:"M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
