...
lib.ssMetadata = [
		{name:"O365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,0,1200,738],[0,740,519,426]]}
];
...
(lib.exchangescreenpngcopy = function() {
	this.initialize(ss["O365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Screen = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.exchangescreenpngcopy();
...
// stage content:
(lib.O365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_1_atlas_.png?1584450894496", id:"O365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
