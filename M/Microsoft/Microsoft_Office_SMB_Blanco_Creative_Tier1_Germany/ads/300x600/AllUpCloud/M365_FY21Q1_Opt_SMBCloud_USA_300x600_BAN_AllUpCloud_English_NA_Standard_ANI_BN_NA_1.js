...
lib.ssMetadata = [
		{name:"M365_FY21Q1_Opt_SMBCloud_USA_300x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,400,266],[402,0,400,266],[0,268,400,266],[402,268,400,266],[0,536,400,266],[402,536,400,266],[267,1398,264,153],[302,1242,265,154],[584,1072,275,164],[0,1258,265,154],[584,1238,275,164],[0,1072,300,184],[533,1404,264,153],[0,804,400,266],[402,804,400,266],[804,0,120,111],[302,1072,280,168]]}
];
...
(lib.excel = function() {
	this.initialize(ss["M365_FY21Q1_Opt_SMBCloud_USA_300x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-10.15,-10.5,0.9508,0.9508);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen_shad, new cjs.Rectangle(-10.1,-10.5,285.20000000000005,175), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,300,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(131.4,76.9,1,1,0,0,0,140,84);
	this.blur.alpha = 0;
	...
	this.shad.name = "shad";
	this.shad.setTransform(300,184,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.word_screen, new cjs.Rectangle(-10.1,-10.5,285.20000000000005,175), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(133.4,69.15,0.9484,0.9484,0,0,0,167.7,111.5);
	this.blur.alpha = 0;
	...
	this.instance.setTransform(-23.45,-35,0.78,0.78);
...
}).prototype = getMCSymbolPrototype(lib.Teams_screen, new cjs.Rectangle(-25.6,-36.6,318.20000000000005,211.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(269.5,160.8,1,1,0,0,0,274.5,163.5);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_screen, new cjs.Rectangle(-10.1,-10.5,285.20000000000005,175), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(269.9,159.05,1,1,0,0,0,274.5,163.5);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.Outlook_screen, new cjs.Rectangle(-10.1,-10.5,285.20000000000005,175), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(237.5,118.2,0.9484,0.9484,0,0,0,274.2,163.3);
	this.blur.alpha = 0;
	...
	this.instance.setTransform(-22.55,-37.85,0.8,0.8);
...
}).prototype = getMCSymbolPrototype(lib.OneDrive_screen, new cjs.Rectangle(-22.5,-37.8,320,212.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(133.75,69.7,0.9484,0.9484,0,0,0,167.7,111.5);
	this.blur.alpha = 0;
	...
	this.instance.setTransform(-23.45,-34.55,0.78,0.78);
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(299.95,183.8,1.0001,1,0,0,0,299.9,183.8);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.exchange_screen, new cjs.Rectangle(-25.3,-36,318.3,211.6), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(0,0,300,600), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoeCfIAAk9IQ9AAIAAE9g");
	this.shape.setTransform(-45.275,-0.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-99.5,-16.1,108.5,31.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_onedrive.setTransform(331.75,-189.3,0.56,0.56,0,0,0,96.9,45.3);
	...
	this.teams_screen.setTransform(418.1,65.25,0.56,0.56,0,0,0,116.4,80.9);
	...
	this.exchange_screen.setTransform(459.45,-120.7,0.56,0.56,0,0,0,116.4,80.7);
	...
	this.screen_word.setTransform(329.05,-82.95,0.56,0.56,0,0,0,116.4,80.7);
	...
	this.screen_excel.setTransform(436.1,-29.75,0.56,0.56,0,0,0,112.8,80.6);
	...
	this.screen_powerpoint.setTransform(312.4,11.05,0.56,0.56,0,0,0,115,84.7);
	...
	this.screen_outlook.setTransform(287.05,98.25,0.56,0.56,0,0,0,121.1,70.7);

	this.timeline.addTween(cjs.Tween.get(this.screen_outlook).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(213.6,-235.8,344.69999999999993,386.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(284.1,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(240.95,556.05,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(292.45,555.8,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,359.7,600.9), null);


// stage content:
(lib.M365_FY21Q1_Opt_SMBCloud_USA_300x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=200", alpha: 0, ease:Power4.easeOut}, "+=1");
				...
				if (i!=0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "-=200", alpha: 0, ease:Power4.easeOut}, "-=0.7");
								...
								for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline2[i], 0.8, { x: "+=200", alpha: 0, ease:Power4.easeInOut}, "+=1.7");
				...
				if (i!=0) exportRoot.tl1.from(exportRoot.headline4[i], 0.8, { x: "-=200", alpha: 0, ease:Power4.easeOut}, "-=0.7");
								...
								for (var i = 0; i < exportRoot.headline4.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline4[i], 0.8, { x: "+=200", alpha: 0, ease:Power4.easeInOut}, "+=1.5");
		...
		this.tlicons = new TimelineLite();	
				...
				exportRoot.tlicons.from(mc.screens, 3, {scaleX: 1.4, scaleY:1.5, y: "-=50",	ease:Power4.easeOut}, "-=3");
		
				
				
				
				exportRoot.tlicons.from(mc.screens.screen_onedrive, 4, {x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=0");
				exportRoot.tlicons.from(mc.screens.screen_word, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.exchange_screen, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.screen_powerpoint, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_excel, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_outlook, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.teams_screen, 4, { x: "+=250",  y: "+=500",	ease:Quart.easeOut}, "-=3.8");
		
				
				
				////f2
				exportRoot.tlicons.to(mc.screens.teams_screen, 1.2, {scaleX: 1.22, scaleY:1.22, x: "-=70",  y: "-=110",	ease:Power4.easeInOut}, "-=0.8");
				...
				exportRoot.tlicons.to(mc.screens.teams_screen, 1.2, {scaleX: 0.56, scaleY:0.56, x: "+=70",  y: "+=110",	ease:Power4.easeInOut}, "+=1.6");
				exportRoot.tlicons.to(mc.screens.teams_screen.blur, 1.2, {alpha:0.6 ,	ease:Power4.easeInOut}, "-=1.2");
		
				////f3
				exportRoot.tlicons.to(mc.screens.exchange_screen, 1.2, {scaleX: 1.22, scaleY:1.22, x: "-=111",  y: "+=75",	ease:Power4.easeInOut}, "-=1");
				exportRoot.tlicons.to(mc.screens.exchange_screen.blur, 1.2, {alpha:0 ,	ease:Power4.easeInOut}, "-=1.2");
						
				exportRoot.tlicons.to(mc.screens.exchange_screen, 1.2, {scaleX: 0.56, scaleY:0.56, x: "+=111",  y: "-=75",	ease:Power4.easeInOut}, "+=1.6");
				exportRoot.tlicons.to(mc.screens.exchange_screen.blur, 1.2, {alpha:0.6 ,	ease:Power4.easeInOut}, "-=1.2");
		
				////f4
				exportRoot.tlicons.to(mc.screens.screen_onedrive, 1.2, {scaleX: 1.22, scaleY:1.22, x: "-=10",  y: "+=103.5",	ease:Power4.easeInOut}, "-=1");
				exportRoot.tlicons.to(mc.screens.screen_onedrive.blur, 1.2, {alpha:0 ,	ease:Power4.easeInOut}, "-=1.2");
				
				exportRoot.tlicons.to(mc.screens.screen_onedrive, 1.2, {scaleX: 0.56, scaleY:0.56, x: "+=10",  y: "-=103.5",	ease:Power4.easeInOut}, "+=1.7");
...
p.nominalBounds = new cjs.Rectangle(149,300,209.7,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_Opt_SMBCloud_USA_300x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1597857117030", id:"M365_FY21Q1_Opt_SMBCloud_USA_300x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
