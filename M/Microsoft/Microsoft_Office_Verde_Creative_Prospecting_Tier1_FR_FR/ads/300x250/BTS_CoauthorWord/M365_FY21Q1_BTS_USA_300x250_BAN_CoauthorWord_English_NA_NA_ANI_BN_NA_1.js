...
(lib.basicUI = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_300x250_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ribbon = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_68 = new cjs.Graphics().p("AAnITICQgxIC2IRIiQAyg");
	var mask_graphics_69 = new cjs.Graphics().p("AklITIMskYIC2ISIssEXg");
	var mask_graphics_70 = new cjs.Graphics().p("Ao2ITIVQnVIC2ISI1QHUg");
	var mask_graphics_71 = new cjs.Graphics().p("AsRISIcHpqIC3IQI8IJsg");
	var mask_graphics_72 = new cjs.Graphics().p("Au7ISMAhdgLgIC2IRMghdALhg");
	var mask_graphics_73 = new cjs.Graphics().p("Aw7ISMAlegM5IC2IRMgleAM6g");
	var mask_graphics_74 = new cjs.Graphics().p("AyXISMAoWgN4IC2IQMgoVAN5g");
	var mask_graphics_75 = new cjs.Graphics().p("AzUISMAqRgOjIC2IRMgqRAOjg");
	var mask_graphics_76 = new cjs.Graphics().p("Az5ISMArcgO8IC2IQMgrcAO9g");
	var mask_graphics_77 = new cjs.Graphics().p("A0MISMAsCgPKIC2IRMgsCAPKg");
	var mask_graphics_78 = new cjs.Graphics().p("A0TISMAsQgPPIC2IRMgsQAPPg");
	var mask_graphics_79 = new cjs.Graphics().p("A0UIRMAsSgPPIC2IRMgsSAPQg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(68).to({graphics:mask_graphics_68,x:36.5114,y:106.0752}).wait(1).to({graphics:mask_graphics_69,x:70.1141,y:106.0391}).wait(1).to({graphics:mask_graphics_70,x:97.6245,y:106.0096}).wait(1).to({graphics:mask_graphics_71,x:119.6524,y:105.986}).wait(1).to({graphics:mask_graphics_72,x:136.8072,y:105.9676}).wait(1).to({graphics:mask_graphics_73,x:149.6985,y:105.9538}).wait(1).to({graphics:mask_graphics_74,x:158.9353,y:105.9439}).wait(1).to({graphics:mask_graphics_75,x:165.127,y:105.9373}).wait(1).to({graphics:mask_graphics_76,x:168.8826,y:105.9332}).wait(1).to({graphics:mask_graphics_77,x:170.8111,y:105.9312}).wait(1).to({graphics:mask_graphics_78,x:171.5216,y:105.9304}).wait(1).to({graphics:mask_graphics_79,x:171.6351,y:105.9002}).wait(1));

	// top_orange
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDE200").s().p("AvWlDIetAAI8pKIg");
	this.shape.setTransform(133.802,175.3042,0.6439,0.6439);
	...
	mask_1._off = true;
	var mask_1_graphics_68 = new cjs.Graphics().p("AAnITICQgxIC2IRIiQAyg");
	var mask_1_graphics_69 = new cjs.Graphics().p("AklITIMskYIC2ISIssEXg");
	var mask_1_graphics_70 = new cjs.Graphics().p("Ao2ITIVQnVIC2ISI1QHUg");
	var mask_1_graphics_71 = new cjs.Graphics().p("AsRISIcHpqIC3IQI8IJsg");
	var mask_1_graphics_72 = new cjs.Graphics().p("Au7ISMAhdgLgIC2IRMghdALhg");
	var mask_1_graphics_73 = new cjs.Graphics().p("Aw7ISMAlegM5IC2IRMgleAM6g");
	var mask_1_graphics_74 = new cjs.Graphics().p("AyXISMAoWgN4IC2IQMgoVAN5g");
	var mask_1_graphics_75 = new cjs.Graphics().p("AzUISMAqRgOjIC2IRMgqRAOjg");
	var mask_1_graphics_76 = new cjs.Graphics().p("Az5ISMArcgO8IC2IQMgrcAO9g");
	var mask_1_graphics_77 = new cjs.Graphics().p("A0MISMAsCgPKIC2IRMgsCAPKg");
	var mask_1_graphics_78 = new cjs.Graphics().p("A0TISMAsQgPPIC2IRMgsQAPPg");
	var mask_1_graphics_79 = new cjs.Graphics().p("A0UIRMAsSgPPIC2IRMgsSAPQg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(68).to({graphics:mask_1_graphics_68,x:36.5114,y:106.0752}).wait(1).to({graphics:mask_1_graphics_69,x:70.1141,y:106.0391}).wait(1).to({graphics:mask_1_graphics_70,x:97.6245,y:106.0096}).wait(1).to({graphics:mask_1_graphics_71,x:119.6524,y:105.986}).wait(1).to({graphics:mask_1_graphics_72,x:136.8072,y:105.9676}).wait(1).to({graphics:mask_1_graphics_73,x:149.6985,y:105.9538}).wait(1).to({graphics:mask_1_graphics_74,x:158.9353,y:105.9439}).wait(1).to({graphics:mask_1_graphics_75,x:165.127,y:105.9373}).wait(1).to({graphics:mask_1_graphics_76,x:168.8826,y:105.9332}).wait(1).to({graphics:mask_1_graphics_77,x:170.8111,y:105.9312}).wait(1).to({graphics:mask_1_graphics_78,x:171.5216,y:105.9304}).wait(1).to({graphics:mask_1_graphics_79,x:171.6351,y:105.9002}).wait(1));

	// top
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FEF000").s().p("A9tFfMA7bgVGIAAK8Mg5XAUTg");
	this.shape_1.setTransform(193.2887,131.8977,0.6446,0.6446);
	...
	mask_2._off = true;
	var mask_2_graphics_58 = new cjs.Graphics().p("ATvPxIACowIAgAAIgCIwg");
	var mask_2_graphics_59 = new cjs.Graphics().p("ATpPxIACowIAmAAIgCIwg");
	var mask_2_graphics_60 = new cjs.Graphics().p("ATBPxIACowIBOAAIgCIwg");
	var mask_2_graphics_61 = new cjs.Graphics().p("ARWPxIABowIC6AAIgCIwg");
	var mask_2_graphics_62 = new cjs.Graphics().p("AODPwIACowIGMABIgCIwg");
	var mask_2_graphics_63 = new cjs.Graphics().p("AIpPwIACowILmABIgCIwg");
	var mask_2_graphics_64 = new cjs.Graphics().p("ABTPuIACowIS7ADIgCIwg");
	var mask_2_graphics_65 = new cjs.Graphics().p("AkHPsIACowIYVAFIgCIwg");
	var mask_2_graphics_66 = new cjs.Graphics().p("AnZPsIACowIbnAFIgCIwg");
	var mask_2_graphics_67 = new cjs.Graphics().p("ApFPrIACowIdTAGIgCIwg");
	var mask_2_graphics_68 = new cjs.Graphics().p("AptPrIACowId7AGIgCIwg");
	var mask_2_graphics_69 = new cjs.Graphics().p("ApzPrIACowId/AGIgBIwg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_2_graphics_58,x:129.7211,y:100.925}).wait(1).to({graphics:mask_2_graphics_59,x:129.7206,y:100.9251}).wait(1).to({graphics:mask_2_graphics_60,x:129.717,y:100.9251}).wait(1).to({graphics:mask_2_graphics_61,x:129.7072,y:100.9252}).wait(1).to({graphics:mask_2_graphics_62,x:129.6882,y:100.9252}).wait(1).to({graphics:mask_2_graphics_63,x:129.6568,y:100.9253}).wait(1).to({graphics:mask_2_graphics_64,x:129.6142,y:100.9254}).wait(1).to({graphics:mask_2_graphics_65,x:129.5828,y:100.9255}).wait(1).to({graphics:mask_2_graphics_66,x:129.5638,y:100.9255}).wait(1).to({graphics:mask_2_graphics_67,x:129.554,y:100.9255}).wait(1).to({graphics:mask_2_graphics_68,x:129.5504,y:100.9255}).wait(1).to({graphics:mask_2_graphics_69,x:129.4461,y:100.9}).wait(11));

	// bot_orange
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FDE200").s().p("AvKFFIcXqIIB/KIg");
	this.shape_2.setTransform(190.7263,175.4269,0.6446,0.6446);
	...
	mask_3._off = true;
	var mask_3_graphics_58 = new cjs.Graphics().p("ATvPxIACowIAgAAIgCIwg");
	var mask_3_graphics_59 = new cjs.Graphics().p("ATpPxIACowIAmAAIgCIwg");
	var mask_3_graphics_60 = new cjs.Graphics().p("ATBPxIACowIBOAAIgCIwg");
	var mask_3_graphics_61 = new cjs.Graphics().p("ARWPxIABowIC6AAIgCIwg");
	var mask_3_graphics_62 = new cjs.Graphics().p("AODPwIACowIGMABIgCIwg");
	var mask_3_graphics_63 = new cjs.Graphics().p("AIpPwIACowILmABIgCIwg");
	var mask_3_graphics_64 = new cjs.Graphics().p("ABTPuIACowIS7ADIgCIwg");
	var mask_3_graphics_65 = new cjs.Graphics().p("AkHPsIACowIYVAFIgCIwg");
	var mask_3_graphics_66 = new cjs.Graphics().p("AnZPsIACowIbnAFIgCIwg");
	var mask_3_graphics_67 = new cjs.Graphics().p("ApFPrIACowIdTAGIgCIwg");
	var mask_3_graphics_68 = new cjs.Graphics().p("AptPrIACowId7AGIgCIwg");
	var mask_3_graphics_69 = new cjs.Graphics().p("ApzPrIACowId/AGIgBIwg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_3_graphics_58,x:129.7211,y:100.925}).wait(1).to({graphics:mask_3_graphics_59,x:129.7206,y:100.9251}).wait(1).to({graphics:mask_3_graphics_60,x:129.717,y:100.9251}).wait(1).to({graphics:mask_3_graphics_61,x:129.7072,y:100.9252}).wait(1).to({graphics:mask_3_graphics_62,x:129.6882,y:100.9252}).wait(1).to({graphics:mask_3_graphics_63,x:129.6568,y:100.9253}).wait(1).to({graphics:mask_3_graphics_64,x:129.6142,y:100.9254}).wait(1).to({graphics:mask_3_graphics_65,x:129.5828,y:100.9255}).wait(1).to({graphics:mask_3_graphics_66,x:129.5638,y:100.9255}).wait(1).to({graphics:mask_3_graphics_67,x:129.554,y:100.9255}).wait(1).to({graphics:mask_3_graphics_68,x:129.5504,y:100.9255}).wait(1).to({graphics:mask_3_graphics_69,x:129.4461,y:100.9}).wait(11));

	// mid
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FEF000").s().p("A0EFFIiEqIMAqSAAAIB/KIg");
	this.shape_3.setTransform(162.0077,175.4269,0.6446,0.6446);
	...
	mask_4._off = true;
	var mask_4_graphics_29 = new cjs.Graphics().p("An8Q5IJ5jaIC2IRIp5Dag");
	var mask_4_graphics_30 = new cjs.Graphics().p("An8Q5IM8kdIC2IRIs8Edg");
	var mask_4_graphics_31 = new cjs.Graphics().p("ApZQ5IP9lgIC2ISIv9Ffg");
	var mask_4_graphics_32 = new cjs.Graphics().p("Aq3Q5IS5mhIC2IRIy5Ghg");
	var mask_4_graphics_33 = new cjs.Graphics().p("AsTQ5IVxngIC2IRI1xHgg");
	var mask_4_graphics_34 = new cjs.Graphics().p("AtsQ4IYjocIC2IRI4jIdg");
	var mask_4_graphics_35 = new cjs.Graphics().p("AvAQ4IbLpXIC2ISI7LJXg");
	var mask_4_graphics_36 = new cjs.Graphics().p("AwQQ4IdqqNIC3IRI9qKOg");
	var mask_4_graphics_37 = new cjs.Graphics().p("AxaQ4If/rBIC2ISI//LBg");
	var mask_4_graphics_38 = new cjs.Graphics().p("AyfQ4MAiJgLxIC2ISMgiJALxg");
	var mask_4_graphics_39 = new cjs.Graphics().p("AzgQ4MAkKgMdIC3ISMgkKAMdg");
	var mask_4_graphics_40 = new cjs.Graphics().p("A0bQ4MAmAgNGIC3ISMgmAANGg");
	var mask_4_graphics_41 = new cjs.Graphics().p("A1RQ4MAntgNrIC2IRMgntANrg");
	var mask_4_graphics_42 = new cjs.Graphics().p("A2DQ4MApRgONIC2IRMgpRAONg");
	var mask_4_graphics_43 = new cjs.Graphics().p("A2xQ4MAqsgOtIC3ISMgqsAOsg");
	var mask_4_graphics_44 = new cjs.Graphics().p("A3aQ4MAr/gPKIC2ISMgr/APJg");
	var mask_4_graphics_45 = new cjs.Graphics().p("A4BQ4MAtMgPkIC3IRMgtMAPkg");
	var mask_4_graphics_46 = new cjs.Graphics().p("A4kQ4MAuSgP8IC3IRMguSAP8g");
	var mask_4_graphics_47 = new cjs.Graphics().p("A5DQ4MAvRgQSIC2IRMgvRAQSg");
	var mask_4_graphics_48 = new cjs.Graphics().p("A5hQ4MAwMgQmIC3IRMgwMAQmg");
	var mask_4_graphics_49 = new cjs.Graphics().p("A57Q4MAxBgQ4IC2IRMgxBAQ4g");
	var mask_4_graphics_50 = new cjs.Graphics().p("A6TQ4MAxxgRIIC2IQMgxxARJg");
	var mask_4_graphics_51 = new cjs.Graphics().p("A6pQ4MAydgRYIC2IRMgydARYg");
	var mask_4_graphics_52 = new cjs.Graphics().p("A6+Q4MAzGgRlIC3IQMgzGARmg");
	var mask_4_graphics_53 = new cjs.Graphics().p("A7QQ4MAzrgRyIC2IQMgzrARzg");
	var mask_4_graphics_54 = new cjs.Graphics().p("A7gQ4MA0LgR9IC2IQMg0LAR+g");
	var mask_4_graphics_55 = new cjs.Graphics().p("A7vQ3MA0pgSHIC2IRMg0pASIg");
	var mask_4_graphics_56 = new cjs.Graphics().p("A79Q3MA1FgSQIC2IQMg1FASSg");
	var mask_4_graphics_57 = new cjs.Graphics().p("A8JQ3MA1dgSZIC2IRMg1dASag");
	var mask_4_graphics_58 = new cjs.Graphics().p("A8VQ3MA10gSgIC3IQMg10ASig");
	var mask_4_graphics_59 = new cjs.Graphics().p("A8eQ3MA2HgSnIC2IQMg2HASpg");
	var mask_4_graphics_60 = new cjs.Graphics().p("A8nQ3MA2ZgStIC2IQMg2ZASvg");
	var mask_4_graphics_61 = new cjs.Graphics().p("A8vQ3MA2pgSzIC2IRMg2pAS0g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(29).to({graphics:mask_4_graphics_29,x:-50.925,y:161.0502}).wait(1).to({graphics:mask_4_graphics_30,x:-50.8928,y:161.0393}).wait(1).to({graphics:mask_4_graphics_31,x:-41.5364,y:161.0287}).wait(1).to({graphics:mask_4_graphics_32,x:-32.0103,y:161.0182}).wait(1).to({graphics:mask_4_graphics_33,x:-22.7548,y:161.0081}).wait(1).to({graphics:mask_4_graphics_34,x:-13.8526,y:160.9983}).wait(1).to({graphics:mask_4_graphics_35,x:-5.3733,y:160.989}).wait(1).to({graphics:mask_4_graphics_36,x:2.6316,y:160.9802}).wait(1).to({graphics:mask_4_graphics_37,x:10.1296,y:160.972}).wait(1).to({graphics:mask_4_graphics_38,x:17.1071,y:160.9643}).wait(1).to({graphics:mask_4_graphics_39,x:23.5662,y:160.9572}).wait(1).to({graphics:mask_4_graphics_40,x:29.5211,y:160.9507}).wait(1).to({graphics:mask_4_graphics_41,x:34.9946,y:160.9447}).wait(1).to({graphics:mask_4_graphics_42,x:40.0147,y:160.9392}).wait(1).to({graphics:mask_4_graphics_43,x:44.6118,y:160.9342}).wait(1).to({graphics:mask_4_graphics_44,x:48.8174,y:160.9296}).wait(1).to({graphics:mask_4_graphics_45,x:52.6619,y:160.9253}).wait(1).to({graphics:mask_4_graphics_46,x:56.1748,y:160.9215}).wait(1).to({graphics:mask_4_graphics_47,x:59.3832,y:160.918}).wait(1).to({graphics:mask_4_graphics_48,x:62.3126,y:160.9147}).wait(1).to({graphics:mask_4_graphics_49,x:64.9861,y:160.9118}).wait(1).to({graphics:mask_4_graphics_50,x:67.4248,y:160.9091}).wait(1).to({graphics:mask_4_graphics_51,x:69.6478,y:160.9067}).wait(1).to({graphics:mask_4_graphics_52,x:71.6724,y:160.9045}).wait(1).to({graphics:mask_4_graphics_53,x:73.5143,y:160.9024}).wait(1).to({graphics:mask_4_graphics_54,x:75.1875,y:160.9006}).wait(1).to({graphics:mask_4_graphics_55,x:76.7048,y:160.899}).wait(1).to({graphics:mask_4_graphics_56,x:78.0779,y:160.8974}).wait(1).to({graphics:mask_4_graphics_57,x:79.317,y:160.8961}).wait(1).to({graphics:mask_4_graphics_58,x:80.4317,y:160.8949}).wait(1).to({graphics:mask_4_graphics_59,x:81.4306,y:160.8938}).wait(1).to({graphics:mask_4_graphics_60,x:82.3215,y:160.8928}).wait(1).to({graphics:mask_4_graphics_61,x:83.0655,y:160.9002}).wait(19));
	...
	this.shape_5.setTransform(93.1764,238.2269,0.6446,0.6446);
...
p.nominalBounds = new cjs.Rectangle(-67,6,385,310.7);
...
(lib.screenanimation = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.title).wait(17).to({regY:15.2,scaleX:0.7599,scaleY:0.7599,x:107.45,y:147.55},28,cjs.Ease.quadInOut).wait(25).to({regX:38,regY:15.3,x:107.55,y:147.65},0).wait(11).to({regX:37.9,regY:15.2,x:107.45,y:147.55},0).wait(1).to({regX:38,regY:15.3,scaleX:0.7604,scaleY:0.7604,x:107.55,y:147.6},0).wait(1).to({scaleX:0.7612,scaleY:0.7612,y:147.55},0).wait(1).to({scaleX:0.7621,scaleY:0.7621,x:107.65,y:147.5},0).wait(1).to({scaleX:0.7633,scaleY:0.7633,x:107.7,y:147.45},0).wait(1).to({scaleX:0.7647,scaleY:0.7647,x:107.8,y:147.35},0).wait(1).to({scaleX:0.7663,scaleY:0.7663,x:107.9,y:147.25},0).wait(1).to({scaleX:0.7682,scaleY:0.7682,x:108.05,y:147.15},0).wait(1).to({scaleX:0.7703,scaleY:0.7703,x:108.15,y:147.1},0).wait(1).to({scaleX:0.7727,scaleY:0.7727,x:108.3,y:146.9},0).wait(1).to({scaleX:0.7754,scaleY:0.7754,x:108.5,y:146.8},0).wait(1).to({scaleX:0.7783,scaleY:0.7783,x:108.7,y:146.65},0).wait(1).to({scaleX:0.7815,scaleY:0.7815,x:108.9,y:146.5},0).wait(1).to({scaleX:0.785,scaleY:0.785,x:109.15,y:146.3},0).wait(1).to({scaleX:0.7888,scaleY:0.7888,x:109.4,y:146.1},0).wait(1).to({scaleX:0.7929,scaleY:0.7929,x:109.65,y:145.9},0).wait(1).to({scaleX:0.7973,scaleY:0.7973,x:109.9,y:145.7},0).wait(1).to({scaleX:0.802,scaleY:0.802,x:110.2,y:145.4},0).wait(1).to({scaleX:0.807,scaleY:0.807,x:110.5,y:145.2},0).wait(1).to({scaleX:0.8123,scaleY:0.8123,x:110.85,y:144.95},0).wait(1).to({scaleX:0.8179,scaleY:0.8179,x:111.25,y:144.6},0).wait(1).to({scaleX:0.8237,scaleY:0.8237,x:111.6,y:144.3},0).wait(1).to({scaleX:0.8297,scaleY:0.8297,x:112,y:144},0).wait(1).to({scaleX:0.836,scaleY:0.836,x:112.35,y:143.7},0).wait(1).to({scaleX:0.8425,scaleY:0.8425,x:112.8,y:143.35},0).wait(1).to({scaleX:0.8491,scaleY:0.8491,x:113.2,y:143.05},0).wait(1).to({scaleX:0.8558,scaleY:0.8558,x:113.6,y:142.7},0).wait(1).to({scaleX:0.8626,scaleY:0.8626,x:114.1,y:142.35},0).wait(1).to({scaleX:0.8695,scaleY:0.8695,x:114.55,y:141.95},0).wait(1).to({scaleX:0.8764,scaleY:0.8764,x:114.95,y:141.6},0).wait(1).to({scaleX:0.8832,scaleY:0.8832,x:115.4,y:141.25},0).wait(1).to({scaleX:0.8899,scaleY:0.8899,x:115.8,y:140.9},0).wait(1).to({scaleX:0.8966,scaleY:0.8966,x:116.25,y:140.55},0).wait(1).to({scaleX:0.903,scaleY:0.903,x:116.65,y:140.25},0).wait(1).to({scaleX:0.9093,scaleY:0.9093,x:117.05,y:139.9},0).wait(1).to({scaleX:0.9154,scaleY:0.9154,x:117.5,y:139.6},0).wait(1).to({scaleX:0.9213,scaleY:0.9213,x:117.85,y:139.3},0).wait(1).to({scaleX:0.9269,scaleY:0.9269,x:118.2,y:139.05},0).wait(1).to({scaleX:0.9323,scaleY:0.9323,x:118.55,y:138.75},0).wait(1).to({scaleX:0.9374,scaleY:0.9374,x:118.85,y:138.5},0).wait(1).to({scaleX:0.9423,scaleY:0.9423,x:119.15,y:138.2},0).wait(1).to({scaleX:0.9468,scaleY:0.9468,x:119.5,y:138},0).wait(1).to({scaleX:0.9511,scaleY:0.9511,x:119.75,y:137.8},0).wait(1).to({scaleX:0.9551,scaleY:0.9551,x:120,y:137.55},0).wait(1).to({scaleX:0.9588,scaleY:0.9588,x:120.25,y:137.35},0).wait(1).to({scaleX:0.9623,scaleY:0.9623,x:120.45,y:137.2},0).wait(1).to({scaleX:0.9655,scaleY:0.9655,x:120.7,y:137},0).wait(1).to({scaleX:0.9685,scaleY:0.9685,x:120.85,y:136.85},0).wait(1).to({scaleX:0.9711,scaleY:0.9711,x:121.05,y:136.75},0).wait(1).to({scaleX:0.9736,scaleY:0.9736,x:121.2,y:136.65},0).wait(1).to({scaleX:0.9758,scaleY:0.9758,x:121.35,y:136.55},0).wait(1).to({scaleX:0.9778,scaleY:0.9778,x:121.45,y:136.4},0).wait(1).to({scaleX:0.9796,scaleY:0.9796,x:121.55,y:136.35},0).wait(1).to({scaleX:0.9811,scaleY:0.9811,x:121.7,y:136.25},0).wait(1).to({scaleX:0.9825,scaleY:0.9825,x:121.75,y:136.2},0).wait(1).to({scaleX:0.9837,scaleY:0.9837,x:121.85,y:136.1},0).wait(1).to({scaleX:0.9846,scaleY:0.9846,x:121.9,y:136.05},0).wait(1).to({scaleX:0.9854,scaleY:0.9854,x:121.95},0).wait(1).to({scaleX:0.986,scaleY:0.986,y:136},0).wait(1).to({regX:37.9,regY:15.2,scaleX:0.9864,scaleY:0.9864,y:135.85},0).wait(79));
...
// stage content:
(lib.M365_FY21Q1_BTS_USA_300x250_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.5, {x: "+=7",y: "+=58",scaleX: "0.8",scaleY: "0.8", ease:Power3.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "+=0.1");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_300x250_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_.png?1593002141360", id:"M365_FY21Q1_BTS_USA_300x250_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
