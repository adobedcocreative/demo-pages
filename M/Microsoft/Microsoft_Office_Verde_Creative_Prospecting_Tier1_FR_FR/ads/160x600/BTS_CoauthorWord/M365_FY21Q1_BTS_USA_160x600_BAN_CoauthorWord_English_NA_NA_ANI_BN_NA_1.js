...
(lib.basicUI = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_160x600_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.ribbon = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_68 = new cjs.Graphics().p("AlLWFIAVgYIKCIvIgVAYg");
	var mask_graphics_69 = new cjs.Graphics().p("AqUWGIKmsOIKDIvIqmMOg");
	var mask_graphics_70 = new cjs.Graphics().p("AuhWGITA15IKDIvIzAV5g");
	var mask_graphics_71 = new cjs.Graphics().p("Ax5WGIZw9oIKDIuI5wdpg");
	var mask_graphics_72 = new cjs.Graphics().p("A0hWHMAfAgjrIKDIvMgfAAjrg");
	var mask_graphics_73 = new cjs.Graphics().p("A2fWHMAi8goNIKDIvMgi8AoNg");
	var mask_graphics_74 = new cjs.Graphics().p("A36WHMAlygrdIKDIvMglyArdg");
	var mask_graphics_75 = new cjs.Graphics().p("A42WHMAnqgtoIKDIvMgnqAtog");
	var mask_graphics_76 = new cjs.Graphics().p("A5bWHMAo0gu9IKDIvMgo0Au9g");
	var mask_graphics_77 = new cjs.Graphics().p("A5uWHMApagvoIKDIvMgpaAvog");
	var mask_graphics_78 = new cjs.Graphics().p("A51WHMApogv4IKDIvMgpoAv4g");
	var mask_graphics_79 = new cjs.Graphics().p("A52V/MApqgv7IKDIvMgpqAv6g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(68).to({graphics:mask_graphics_68,x:16.5986,y:197.2229}).wait(1).to({graphics:mask_graphics_69,x:49.3592,y:197.2704}).wait(1).to({graphics:mask_graphics_70,x:76.1948,y:197.3095}).wait(1).to({graphics:mask_graphics_71,x:97.6918,y:197.3407}).wait(1).to({graphics:mask_graphics_72,x:114.4392,y:197.365}).wait(1).to({graphics:mask_graphics_73,x:127.0275,y:197.3833}).wait(1).to({graphics:mask_graphics_74,x:136.0492,y:197.3963}).wait(1).to({graphics:mask_graphics_75,x:142.0974,y:197.4051}).wait(1).to({graphics:mask_graphics_76,x:145.7663,y:197.4104}).wait(1).to({graphics:mask_graphics_77,x:147.6504,y:197.4132}).wait(1).to({graphics:mask_graphics_78,x:148.3446,y:197.4142}).wait(1).to({graphics:mask_graphics_79,x:150.0507,y:196.5479}).wait(1));

	// top_orange
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDE200").s().p("AqLCyIUXr0IvRSFg");
	this.shape.setTransform(76.825,322.825);
	...
	// top
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FEF000").s().p("AyAPYMAeygjzIFPDFMgf6Alyg");
	this.shape_1.setTransform(154.512,218.607,1.2397,1.2397);
	...
	mask_1._off = true;
	var mask_1_graphics_58 = new cjs.Graphics().p("AQSLUICWhbIEhHfIiXBbg");
	var mask_1_graphics_59 = new cjs.Graphics().p("AQLLWICdhfIEgHfIidBfg");
	var mask_1_graphics_60 = new cjs.Graphics().p("APYLmIDPh9IEhHeIjQB+g");
	var mask_1_graphics_61 = new cjs.Graphics().p("ANOMQIFXjPIEhHeIlYDQg");
	var mask_1_graphics_62 = new cjs.Graphics().p("AJBNjIJhlwIEgHeIphFxg");
	var mask_1_graphics_63 = new cjs.Graphics().p("ACFPrIQWp5IEhHfIwXJ5g");
	var mask_1_graphics_64 = new cjs.Graphics().p("AnUSjIZnvfIEhHeI5nPgg");
	var mask_1_graphics_65 = new cjs.Graphics().p("AuPUrMAgcgToIEhHfMggdATog");
	var mask_1_graphics_66 = new cjs.Graphics().p("AycV+MAklgWIIEhHdMgkmAWKg");
	var mask_1_graphics_67 = new cjs.Graphics().p("A0mWoMAmtgXaIEhHdMgmuAXcg");
	var mask_1_graphics_68 = new cjs.Graphics().p("A1ZW4MAnggX5IEgHeMgngAX6g");
	var mask_1_graphics_69 = new cjs.Graphics().p("A1jW8MAnogX+IEgHeMgnnAX+g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_1_graphics_58,x:148.05,y:120.2886}).wait(1).to({graphics:mask_1_graphics_59,x:148.04,y:120.5116}).wait(1).to({graphics:mask_1_graphics_60,x:147.9697,y:122.072}).wait(1).to({graphics:mask_1_graphics_61,x:147.779,y:126.3073}).wait(1).to({graphics:mask_1_graphics_62,x:147.4076,y:134.5556}).wait(1).to({graphics:mask_1_graphics_63,x:146.7953,y:148.1553}).wait(1).to({graphics:mask_1_graphics_64,x:145.9646,y:166.6066}).wait(1).to({graphics:mask_1_graphics_65,x:145.3524,y:180.2099}).wait(1).to({graphics:mask_1_graphics_66,x:144.981,y:188.4619}).wait(1).to({graphics:mask_1_graphics_67,x:144.7903,y:192.6996}).wait(1).to({graphics:mask_1_graphics_68,x:144.72,y:194.2609}).wait(1).to({graphics:mask_1_graphics_69,x:144.5,y:194.6404}).wait(11));

	// bot_orange
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FDE200").s().p("AvKFFIcXqIIB/KIg");
	this.shape_2.setTransform(319.2505,333.4075,1.2397,1.2397);
	...
	// mid
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FEF000").s().p("A04GhMAh8gTRIH1CZMgktAXIg");
	this.shape_3.setTransform(145.175,298.925);
	...
	mask_2._off = true;
	var mask_2_graphics_29 = new cjs.Graphics().p("EgMuAumIK+s0IHhGcIq9M0g");
	var mask_2_graphics_30 = new cjs.Graphics().p("EgMtAulIO5xaIHiGcIu5Rbg");
	var mask_2_graphics_31 = new cjs.Graphics().p("EgNKAulISz1/IHiGdIyzV+g");
	var mask_2_graphics_32 = new cjs.Graphics().p("EgPEAukIWo6dIHhGdI2oadg");
	var mask_2_graphics_33 = new cjs.Graphics().p("EgQ8AukIaX+0IHiGdI6Xezg");
	var mask_2_graphics_34 = new cjs.Graphics().p("EgSuAujMAd7gi/IHiGdMgd7Ai/g");
	var mask_2_graphics_35 = new cjs.Graphics().p("EgUbAujMAhVgm+IHiGcMghVAm+g");
	var mask_2_graphics_36 = new cjs.Graphics().p("EgWCAuiMAkjgqvIHiGdMgkjAqvg");
	var mask_2_graphics_37 = new cjs.Graphics().p("EgXjAuiMAnlguQIHiGcMgnlAuQg");
	var mask_2_graphics_38 = new cjs.Graphics().p("EgY9AuhMAqZgxhIHiGcMgqZAxig");
	var mask_2_graphics_39 = new cjs.Graphics().p("EgaQAuhMAs/g0jIHiGbMgs/A0kg");
	var mask_2_graphics_40 = new cjs.Graphics().p("EgbcAuhMAvXg3XIHiGdMgvXA3Wg");
	var mask_2_graphics_41 = new cjs.Graphics().p("EgcjAugMAxlg57IHiGdMgxlA57g");
	var mask_2_graphics_42 = new cjs.Graphics().p("EgdjAugMAzlg8SIHiGdMgzlA8Rg");
	var mask_2_graphics_43 = new cjs.Graphics().p("EgeeAugMA1cg+cIHhGcMg1cA+cg");
	var mask_2_graphics_44 = new cjs.Graphics().p("EgfVAugMA3JhAbIHiGcMg3JBAbg");
	var mask_2_graphics_45 = new cjs.Graphics().p("EggGAufMA4rhCOIHiGcMg4rBCPg");
	var mask_2_graphics_46 = new cjs.Graphics().p("EggzAufMA6FhD4IHiGdMg6FBD4g");
	var mask_2_graphics_47 = new cjs.Graphics().p("EghdAufMA7ZhFZIHiGdMg7ZBFYg");
	var mask_2_graphics_48 = new cjs.Graphics().p("EgiCAufMA8jhGxIHiGdMg8jBGwg");
	var mask_2_graphics_49 = new cjs.Graphics().p("EgilAufMA9phIBIHiGcMg9pBIBg");
	var mask_2_graphics_50 = new cjs.Graphics().p("EgjEAueMA+nhJKIHiGdMg+nBJKg");
	var mask_2_graphics_51 = new cjs.Graphics().p("EgjhAueMA/hhKNIHiGdMg/hBKNg");
	var mask_2_graphics_52 = new cjs.Graphics().p("Egj7AueMBAVhLKIHiGdMhAVBLKg");
	var mask_2_graphics_53 = new cjs.Graphics().p("EgkSAueMBBEhMBIHhGcMhBEBMBg");
	var mask_2_graphics_54 = new cjs.Graphics().p("EgkoAueMBBvhM0IHiGdMhBvBMzg");
	var mask_2_graphics_55 = new cjs.Graphics().p("Egk7AueMBCWhNhIHhGcMhCWBNhg");
	var mask_2_graphics_56 = new cjs.Graphics().p("EglNAueMBC5hOLIHiGdMhC5BOKg");
	var mask_2_graphics_57 = new cjs.Graphics().p("EgldAueMBDZhOwIHiGcMhDZBOwg");
	var mask_2_graphics_58 = new cjs.Graphics().p("EglrAueMBD2hPSIHhGdMhD2BPRg");
	var mask_2_graphics_59 = new cjs.Graphics().p("Egl4AueMBEPhPwIHiGdMhEPBPvg");
	var mask_2_graphics_60 = new cjs.Graphics().p("EgmEAueMBEnhQLIHiGdMhEnBQKg");
	var mask_2_graphics_61 = new cjs.Graphics().p("EgmOAufMBE7hQiIHiGcMhE7BQig");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(29).to({graphics:mask_2_graphics_29,x:-81.475,y:339.4465}).wait(1).to({graphics:mask_2_graphics_30,x:-81.4247,y:339.3884}).wait(1).to({graphics:mask_2_graphics_31,x:-78.465,y:339.3308}).wait(1).to({graphics:mask_2_graphics_32,x:-66.1086,y:339.2744}).wait(1).to({graphics:mask_2_graphics_33,x:-54.1031,y:339.2195}).wait(1).to({graphics:mask_2_graphics_34,x:-42.5558,y:339.1667}).wait(1).to({graphics:mask_2_graphics_35,x:-31.5569,y:339.1165}).wait(1).to({graphics:mask_2_graphics_36,x:-21.1735,y:339.069}).wait(1).to({graphics:mask_2_graphics_37,x:-11.4474,y:339.0245}).wait(1).to({graphics:mask_2_graphics_38,x:-2.3966,y:338.9832}).wait(1).to({graphics:mask_2_graphics_39,x:5.9818,y:338.9449}).wait(1).to({graphics:mask_2_graphics_40,x:13.7062,y:338.9096}).wait(1).to({graphics:mask_2_graphics_41,x:20.8062,y:338.8772}).wait(1).to({graphics:mask_2_graphics_42,x:27.318,y:338.8474}).wait(1).to({graphics:mask_2_graphics_43,x:33.2813,y:338.8202}).wait(1).to({graphics:mask_2_graphics_44,x:38.7366,y:338.7952}).wait(1).to({graphics:mask_2_graphics_45,x:43.7236,y:338.7724}).wait(1).to({graphics:mask_2_graphics_46,x:48.2803,y:338.7516}).wait(1).to({graphics:mask_2_graphics_47,x:52.4422,y:338.7326}).wait(1).to({graphics:mask_2_graphics_48,x:56.2422,y:338.7152}).wait(1).to({graphics:mask_2_graphics_49,x:59.7102,y:338.6994}).wait(1).to({graphics:mask_2_graphics_50,x:62.8736,y:338.6849}).wait(1).to({graphics:mask_2_graphics_51,x:65.7572,y:338.6717}).wait(1).to({graphics:mask_2_graphics_52,x:68.3835,y:338.6597}).wait(1).to({graphics:mask_2_graphics_53,x:70.7727,y:338.6488}).wait(1).to({graphics:mask_2_graphics_54,x:72.9432,y:338.6389}).wait(1).to({graphics:mask_2_graphics_55,x:74.9114,y:338.6299}).wait(1).to({graphics:mask_2_graphics_56,x:76.6925,y:338.6218}).wait(1).to({graphics:mask_2_graphics_57,x:78.2999,y:338.6144}).wait(1).to({graphics:mask_2_graphics_58,x:79.7459,y:338.6078}).wait(1).to({graphics:mask_2_graphics_59,x:81.0416,y:338.6019}).wait(1).to({graphics:mask_2_graphics_60,x:82.1973,y:338.5966}).wait(1).to({graphics:mask_2_graphics_61,x:83.0422,y:338.6965}).wait(19));

	// bottom
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FEF000").s().p("A78V7MAuEg3sIJ1A/Mg35BCkg");
	this.shape_4.setTransform(94.325,422.275);
...
p.nominalBounds = new cjs.Rectangle(-84.5,0,524.2,638.5);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.cta.name = "cta";
	this.cta.setTransform(177.7,567.4,1.136,1.136,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_FY21Q1_BTS_USA_160x600_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.5, {x: "-=0",y: "+=0",scaleX: 0.77,scaleY: 0.77, ease:Power3.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "+=0.1");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_160x600_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_.png?1593012034758", id:"M365_FY21Q1_BTS_USA_160x600_BAN_CoauthorWord_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
