...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2ConsRefresh_USA_728x90_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,462,326]]}
];
...
(lib.BG_UI_300x250_large = function() {
	this.initialize(ss["M365_MobileFY21Q2ConsRefresh_USA_728x90_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ei5JAWyMAAAgtjMFyTAAAMAAAAtjg");
	this.shape.setTransform(6.3,0.025);
...
p.nominalBounds = new cjs.Rectangle(-1178.7,-145.7,2370,291.5);
...
}).prototype = getMCSymbolPrototype(lib.BG_Slide, new cjs.Rectangle(0,0,99.3,70.1), null);
...
}).prototype = getMCSymbolPrototype(lib.BG_shape, new cjs.Rectangle(0,0,728,90), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(84).call(this.frame_84).wait(14).call(this.frame_98).wait(3));
...
p.nominalBounds = new cjs.Rectangle(-879.4,191.6,2370,291.6);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(272.05,-59.05,0.3087,0.3087,0,0,0,0.1,0);
	...
	this.slide.setTransform(247.9,64.5,1,1,0,0,0,82.5,58);
	...
	this.txtCta.setTransform(668.7,54.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(745.25,51.35,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,732.1,90.1), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_728x90_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,365.70000000000005,45.099999999999994);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2ConsRefresh_USA_728x90_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600341236791", id:"M365_MobileFY21Q2ConsRefresh_USA_728x90_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
