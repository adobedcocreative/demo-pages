...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,462,326]]}
];
...
(lib.BG_UI_300x250_large = function() {
	this.initialize(ss["M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.BG_Slide, new cjs.Rectangle(0,0,240.3,169.5), null);
...
}).prototype = getMCSymbolPrototype(lib.BG_shape, new cjs.Rectangle(0,0,300,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.2,scaleX:2.4209,scaleY:2.4209,x:40.4,y:-507.5},41,cjs.Ease.quadInOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.instance_2}]},59).to({state:[{t:this.instance_2}]},41).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({x:303.45,y:368.15,alpha:0},41,cjs.Ease.cubicInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-22.3,2,0.75,0.6881,0,0,0,13.4,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AoOC2IAAlrIQdAAIAAFrg");
	this.shape.setTransform(-57.625,1.875);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.3,-16.3,105.39999999999999,36.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(59.05,196,0.3087,0.3087,0,0,0,0.1,0);
	...
	this.slide.setTransform(105.9,312.65,1,1,0,0,0,82.5,58);
	...
	this.txtCta.setTransform(47.75,563.2,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(125.15,560.3,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.4,0,303.5,600.9), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149.6,300,152.6,300.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600361293202", id:"M365_MobileFY21Q2ConsRefresh_USA_300x600_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
