// JavaScript Document
	...
	bannerData.headline1 = ["<#505050>3D isn’t just|for the|movies","20.2px",15, 42,"22","3 50", "left"];
	bannerData.headline2 = ["<#505050>Create slides that sing|with 3D animations","13.2px",15, 115,"15","3 50", "left"];
