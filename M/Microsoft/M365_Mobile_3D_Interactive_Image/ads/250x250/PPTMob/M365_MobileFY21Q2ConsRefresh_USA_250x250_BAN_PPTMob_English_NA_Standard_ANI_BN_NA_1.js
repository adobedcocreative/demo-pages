...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,323,228]]}
];
...
(lib.BG_UI_250x250 = function() {
	this.initialize(ss["M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A32XwMAAAgvfMAvtAAAMAAAAvfg");
	this.shape.setTransform(148.9,125.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(-3.8,-26.9,305.40000000000003,304), null);


(lib.BG_Slide = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.BG_UI_250x250();
	this.instance.setTransform(-134.2,-90.95);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BG_Slide, new cjs.Rectangle(-134.2,-90.9,323,228), null);


(lib.BG_shape = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.BG_shape, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.bg_sub.cache(-306,-306,620,620,1)
	}
...
}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(-3.8,-26.9,305.40000000000003,304), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-61.782,1.8687,1.0642,1.4798);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.3,-16.3,97.1,36.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(84).call(this.frame_84).wait(14).call(this.frame_98).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.9364,scaleY:2.9364,x:19,y:-57.45},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhMtA/0MAAAh/nMCZbAAAMAAAB/ng");
	this.shape.setTransform(299.8546,340.3912,1,1.2092);
...
p.nominalBounds = new cjs.Rectangle(-200.3,-153.4,992.5,989.9);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(126.45,124.7,0.2553,0.2553,0,0,0,299.7,340.3);
	...
	// BGSlide
	this.slide = new lib.BG_Slide();
	this.slide.name = "slide";
	this.slide.setTransform(231.55,165.2,0.5171,0.5171,0,0,0,83,58.1);
	...
	this.txtCta.setTransform(47.75,215,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(125.15,212.1,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// BG
	this.instance = new lib.BG_shape();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.2,-1.3,301.2,252.70000000000002), null);


// stage content:
(lib.M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(mc.slide, 1.4, { scaleX:0 , scaleY:0,  ease:Power4.easeOut, onStart:function(){exportRoot.meshtl.play()}}, "-=0.4");
						
				this.tlText.from(mc.txtCta, 0.6, { x: "-=150", ease:Power4.easeOut}, "-=0.6");
...
p.nominalBounds = new cjs.Rectangle(123.8,123.7,175.3,127.60000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600341008826", id:"M365_MobileFY21Q2ConsRefresh_USA_250x250_BAN_PPTMob_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
