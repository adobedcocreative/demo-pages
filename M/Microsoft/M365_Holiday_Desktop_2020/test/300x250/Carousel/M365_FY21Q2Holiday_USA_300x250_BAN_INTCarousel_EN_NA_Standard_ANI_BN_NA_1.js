...
(lib.CoffeeCup11 = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.snowflakes_2, new cjs.Rectangle(-134.7,-112.5,269.5,225), null);
...
p.nominalBounds = new cjs.Rectangle(144.7,75.8,131.10000000000002,224.39999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(359.25,123.55,0.5,0.5,-161.0005);

	this.instance_2 = new lib.OvenMit();
	this.instance_2.setTransform(205.75,79.25,0.5,0.5,-89.9895);

	this.instance_3 = new lib.CoffeeCup11();
	this.instance_3.setTransform(182.35,69.1,0.5,0.5,-89.9895);
...
}).prototype = getMCSymbolPrototype(lib.Page, new cjs.Rectangle(144.7,-46.8,185.90000000000003,347), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1_onedrive.setTransform(177.95,162,0.44,0.44,0,0,0,191.6,129.2);

	this.screen_2_onedrive = new lib.Screen_2_OneDrive();
	this.screen_2_onedrive.name = "screen_2_onedrive";
	this.screen_2_onedrive.setTransform(266,129.5,0.44,0.44,0,0,0,291.2,176.6);
	...
	this.screen_1_excel.setTransform(177.95,162,0.44,0.44,0,0,0,191.6,129.2);

	this.screen_2_excel = new lib.Screen_2_Excel();
	this.screen_2_excel.name = "screen_2_excel";
	this.screen_2_excel.setTransform(266,129.5,0.44,0.44,0,0,0,291.2,176.6);
	...
	this.screen_1_word.setTransform(177.95,162,0.44,0.44,0,0,0,191.6,129.2);

	this.screen_2_word = new lib.Screen_2_Word();
	this.screen_2_word.name = "screen_2_word";
	this.screen_2_word.setTransform(266,129.5,0.44,0.44,0,0,0,291.2,176.6);
	...
	this.screen_1_ppt.setTransform(177.95,162,0.44,0.44,0,0,0,191.6,129.2);

	this.screen_2_ppt = new lib.Screen_2_PPT();
	this.screen_2_ppt.name = "screen_2_ppt";
	this.screen_2_ppt.setTransform(266,129.5,0.44,0.44,0,0,0,291.2,176.6);
...
}).prototype = getMCSymbolPrototype(lib.mountain_anim, new cjs.Rectangle(93.7,51.8,295.40000000000003,176.10000000000002), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-20.5,-46.8,985.9,347), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		//hit.mouseEnabled = false;
			...
			var ClickID = 0, PreviousClickID = 0
		...
		this.runBanner = function () {
			...
			mc.txtCta.alpha = 1
				...
				exportRoot.TL_MainIntro.from(indicator, 0.6, {alpha:0, ease:Power3.easeOut, onStart:function(){dot_1.gotoAndPlay("selected", exportRoot.TL_MainText.tweenTo("Out"));}, onComplete:function(){document.querySelector('#dot_Hits').style.visibility = '';}}, "-=0.4");
			...
			document.querySelector('#dot_Hit1').addEventListener("click", function(){
					// amoAdInteraction('Back Click');
					PreviousClickID = ClickID;
					ClickID=0;
					direction = "random";
					exportRoot.selectedOption(ClickID);
			})
			document.querySelector('#dot_Hit2').addEventListener("click", function(){
					// amoAdInteraction('Back Click');
					PreviousClickID = ClickID;
					ClickID=1;
					direction = "random";
			...
			document.querySelector('#dot_Hit3').addEventListener("click", function(){
					// amoAdInteraction('Back Click');
					PreviousClickID = ClickID;
					ClickID=2;
					direction = "random";
			...
			document.querySelector('#dot_Hit4').addEventListener("click", function(){
					// amoAdInteraction('Back Click');
					PreviousClickID = ClickID;
					ClickID=3;
					direction = "random";
			...
			exportRoot.selectedOption = function (subID) {
				...
				if (direction=="next") {
					...
					if (PreviousClickID==0) {dot_1.gotoAndPlay("deselected");}
					if (PreviousClickID==1) {dot_2.gotoAndPlay("deselected");}
					if (PreviousClickID==2) {dot_3.gotoAndPlay("deselected");}
					if (PreviousClickID==3) {dot_4.gotoAndPlay("deselected");}
					if (subID==0) {exportRoot.TL_MainScreen.tweenFromTo("frame"+PreviousClickID, "frame0"),dot_1.gotoAndPlay("selected");}
					if (subID==1) {exportRoot.TL_MainScreen.tweenFromTo("frame"+PreviousClickID, "frame1"),dot_2.gotoAndPlay("selected");}
					if (subID==2) {exportRoot.TL_MainScreen.tweenFromTo("frame"+PreviousClickID, "frame2"),dot_3.gotoAndPlay("selected");}
					if (subID==3) {exportRoot.TL_MainScreen.tweenFromTo("frame"+PreviousClickID, "frame3"),dot_4.gotoAndPlay("selected");}
				}
...
p.nominalBounds = new cjs.Rectangle(129.5,78.2,835.9,222);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1603118977736", id:"M365_FY21Q2Holiday_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
