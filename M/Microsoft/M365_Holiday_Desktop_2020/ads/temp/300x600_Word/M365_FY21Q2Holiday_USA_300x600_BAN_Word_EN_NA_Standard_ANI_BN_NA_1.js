...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x600_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,700,800],[702,0,284,252]]}
];
...
(lib.Desktop = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x600_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-18.8,-68.7,0.2956,0.2956);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.screen_2, new cjs.Rectangle(-18.8,-68.7,206.9,236.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2946,0.2951);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A80000").s().p("AnuCTIAAklIPcAAIAAElg");
	this.shape.setTransform(-54.55,2.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-104,-12.3,98.9,29.400000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regX:0.2,scaleX:2.4168,scaleY:2.4168,x:38.65,y:-509.05},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhMbCYMMAAAkwXMCY3AAAMAAAEwXg");
	this.shape.setTransform(300.725,338.775);
	...
	this.instance_2.setTransform(302.15,340.85,3.2498,7.7358,0,0,0,150,124.9);
...
p.nominalBounds = new cjs.Rectangle(-188.5,-635.2,978.5,1948);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(-21,248.05,2.863,2.8732,0,0,0,0.5,1.1);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(69.55,163.35,2.8632,2.8734,0,0,0,1,1.2);
	...
	this.txtCta.setTransform(234.35,551.05);
	...
	this.cta.name = "cta";
	this.cta.setTransform(307.5,548.45,1.136,1.136,0,0,0,0.2,0.2);

	this.txtCta_1 = new lib.cta();
	this.txtCta_1.name = "txtCta_1";
	this.txtCta_1.setTransform(243.8,363.6,1,1,0,0,0,0.7,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.txtCta_1},{t:this.cta}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-22.4,-37.5,627.6999999999999,679.4), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x600_BAN_Word_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				for (var i = 0; i < exportRoot.headline1.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline1[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=4");
...
p.nominalBounds = new cjs.Rectangle(127.7,262.5,475.59999999999997,379.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x600_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602686591463", id:"M365_FY21Q2Holiday_USA_300x600_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
