...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,582,353],[584,0,383,305]]}
];
...
(lib.ODDesktop1 = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(76.4,123.35,0.51,0.51,0,0,0,0.6,0.9);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(145.6,72.85,0.51,0.51,0,0,0,0.6,0.9);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,443.1,278.5), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,125,291.7,153.39999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602713951387", id:"M365_FY21Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
