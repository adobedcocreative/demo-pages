...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x250_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,578,340],[580,0,284,252]]}
];
...
(lib.Desktop = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x250_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(78.35,116.95,1,0.9998,0,0,0,0.6,0.9);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(132.35,67.3,1,0.9999,0,0,0,0.7,1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,421.7,252.1), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_Word_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,125,270.3,127);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x250_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602686627504", id:"M365_FY21Q2Holiday_USA_300x250_BAN_Word_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
