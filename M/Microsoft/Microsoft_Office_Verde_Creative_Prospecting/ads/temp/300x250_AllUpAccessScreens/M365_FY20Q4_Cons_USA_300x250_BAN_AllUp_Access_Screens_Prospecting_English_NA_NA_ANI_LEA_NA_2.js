...
lib.ssMetadata = [
		{name:"M365_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:8,y:-5.45},14,cjs.Ease.quadInOut).wait(35).to({alpha:0},10,cjs.Ease.quadInOut).wait(1));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CA4925").ss(1,1,1).p("AjCgcIExhkIBUChIkzBgQhWidAEAAg");
	this.shape.setTransform(1.3661,-12.45);
...
p.nominalBounds = new cjs.Rectangle(-19.1,-26.3,123.5,55.5);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.bg_2 = new lib.bg();
	this.bg_2.name = "bg_2";
	this.bg_2.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg_2).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-14.7,-22.6,430.3,285.70000000000005), null);


// stage content:
(lib.M365_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				//exportRoot.tl1.to(mc.bg, 0.1, { alpha:1,	ease:Quart.easeInOut}, "+=0");
...
p.nominalBounds = new cjs.Rectangle(135.3,102.4,280.3,160.70000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1.png?1631631268644", id:"M365_FY20Q4_Cons_USA_300x250_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
