...
lib.ssMetadata = [
		{name:"O365_SMBSimplified_USA_728x90_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_", frames: [[0,0,350,197],[642,1322,324,39],[0,1343,323,37],[325,1363,323,36],[0,1382,323,33],[325,1401,322,26],[0,1417,322,17],[649,1401,322,18],[650,1363,322,36],[642,1264,321,56],[320,1264,320,77],[0,1168,318,99],[622,1142,316,120],[622,1001,314,139],[310,1001,310,155],[0,998,308,168],[0,818,306,178],[601,813,304,186],[601,619,301,192],[300,619,299,197],[0,616,298,200],[584,415,296,202],[584,209,294,204],[352,0,292,206],[0,408,290,206],[292,208,290,207],[646,0,290,207],[0,199,290,207],[880,209,120,111]]}
];
...
(lib.excel_budget_laptop = function() {
	this.initialize(ss["O365_SMBSimplified_USA_728x90_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(97.1395,1.6316,0.2949,0.2949);
	...
	this.shape_1.setTransform(88.8812,1.6316,0.2949,0.2949);
	...
	this.shape_2.setTransform(83.1005,-0.4919,0.2949,0.2949);
	...
	this.shape_3.setTransform(78.234,-0.6542,0.2949,0.2949);
	...
	this.shape_4.setTransform(72.527,-0.6542,0.2949,0.2949);
	...
	this.shape_5.setTransform(63.0669,-0.1896,0.2949,0.2949);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFB900").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_6.setTransform(-31.6153,5.392,0.2949,0.2949);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_7.setTransform(-42.7566,5.392,0.2949,0.2949);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_8.setTransform(-31.6153,-5.7492,0.2949,0.2949);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_9.setTransform(-42.7566,-5.7492,0.2949,0.2949);
	...
	this.shape_10.setTransform(15.7958,-0.5288,0.2949,0.2949);
	...
	this.shape_11.setTransform(128.6756,-0.0569,0.2949,0.2949);
	...
	this.shape_12.setTransform(119.6653,-0.1675,0.2949,0.2949);
	...
	this.shape_13.setTransform(110.4412,-0.1675,0.2949,0.2949);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-47.8,-10.8,180.3,21.3), null);
...
(lib.ClipGroup_51 = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(36.9022,113.3207,1.5,1.5);
	...
	this.shape_3.setTransform(33.6262,109.5939,0.8322,0.8322);
	...
	this.shape_4.setTransform(43.0016,115.9352,1.5,1.5);
	...
	this.shape_5.setTransform(42.9895,115.9706,1.5,1.5);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(51).to({_off:false},0).to({_off:true},24).wait(1));
...
(lib.softwarevector = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(540.8844,1306.6466,4.6882,4.6882);
	...
	this.shape_1.setTransform(434.9192,1301.7852,4.7011,4.7011);
	...
	this.shape_14.setTransform(77.7152,1327.7589,4.7011,4.7011);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#3F3F3F").p("Ag1AAIBrAA");
	this.shape_15.setTransform(84.1793,1304.4884,4.7011,4.7011);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#3F3F3F").p("AAAgjIAABI");
	this.shape_16.setTransform(83.1215,1304.1358,4.7011,4.7011);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#207346").s().p("AofCjIAAlFIQ+AAIAAFFg");
	this.shape.setTransform(-44.7,-1.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-99,-17.6,108.7,32.6), null);
...
(lib.MainScreen = function(mode,startPosition,loop) {
	...
	this.graphs.name = "graphs";
	this.graphs.parent = this;
	this.graphs.setTransform(181.35,96.8,0.2885,0.2885,0,0,0,468.8,181.3);

	this.instance = new lib.excel_budget_laptop();
	this.instance.parent = this;
	this.instance.setTransform(0.65,-0.65,0.8576,0.8576);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.graphs}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.MainScreen, new cjs.Rectangle(0.7,-0.6,316.40000000000003,168.9), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(668.2,60.2,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(721.3,60.75,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.logo_1.setTransform(51.45,23.6,0.71,0.71,0,0,0,0.1,0.1);
	...
	this.shape.setTransform(458.175,46.3);
	...
	this.phone.name = "phone";
	this.phone.parent = this;
	this.phone.setTransform(178.95,63.55,0.342,0.342,0,0,0,36.4,66.8);
	...
	this.laptop.setTransform(223.45,75.2,0.3322,0.2923,0,0,0,284.4,25.3);

	this.timeline.addTween(cjs.Tween.get(this.laptop).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.1,-0.9,730.1999999999999,99.10000000000001), null);


// stage content:
(lib.O365_SMBSimplified_USA_728x90_BAN_Excel_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.graphics.f("blue").dr(0,0,270,50);
		s.x = 245; s.y=34
		s.alpha=0
			//aMask.visible=false
			stage.addChild(s);
			...
			this.tl1 = new TimelineLite();
				...
				// TEXT OUT
				exportRoot.tl1.to(exportRoot.headline1, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.9");
				...
				//of						headline4
				exportRoot.tl1.from(exportRoot.headline4, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
		
					
				//Excel						headline5
				exportRoot.tl1.from(exportRoot.headline5, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
		
				
				// TEXT OUT
				exportRoot.tl1.to(exportRoot.headline4, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.6");
				exportRoot.tl1.to(exportRoot.headline5, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0.01");
				
						//to help						headline6
				exportRoot.tl1.from(exportRoot.headline6, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
				exportRoot.tl1.from(exportRoot.headline7, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
				
				exportRoot.tl1.to(exportRoot.headline6, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.6");
				exportRoot.tl1.to(exportRoot.headline7, 0.01, {alpha: 0, ease:Power4.easeIn}, "-=0.01");
				
				//manage					headline8
				exportRoot.tl1.from(exportRoot.headline8, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
		
				
				//manage cash				headline9
				exportRoot.tl1.from(exportRoot.headline9, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
		
		
				//manage cash flow			headline10
				exportRoot.tl1.from(exportRoot.headline10, 0.1, { x:"+=7", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0");
				...
				exportRoot.tl1.from(cont3D, 1.6, {alpha: 0, rotY: "+=60",x:"+=400",z:-400,ease:Power4.easeInOut}, "+=1");
				exportRoot.tl1.to(s, 1.6, {x: "-=140", ease:Power4.easeInOut}, "-=1.45");
				...
				exportRoot.tl1.to(cont3D, 1, {x:252, y:"+=2", z:-1550, ease:Power4.easeInOut}, "+=0.5");
		
		
		
				exportRoot.tl1.from(phone, 0.6, { x: "+=250", ease:Power3.easeOut}, "-=0.4");
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline11[i], 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut}, "+=0.2");
				...
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "+=50",	ease:Power4.easeOut}, "-=0.5");
...
p.nominalBounds = new cjs.Rectangle(364,44.1,366.29999999999995,54.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_728x90_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_.png?1575244239654", id:"O365_SMBSimplified_USA_728x90_BAN_Excel_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
