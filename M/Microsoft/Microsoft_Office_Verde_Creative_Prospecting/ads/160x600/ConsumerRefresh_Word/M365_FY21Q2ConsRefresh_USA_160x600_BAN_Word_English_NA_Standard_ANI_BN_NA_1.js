...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_160x600_BAN_Word_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//out
				for (var i = 0; i < exportRoot.headline3.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline3[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.3");
				}
			...
			//out
				for (var i = 0; i < exportRoot.headline4.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline4[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.3");
				}		
				for (var i = 0; i < exportRoot.headline5.length; i++) {
			...
			//out
				for (var i = 0; i < exportRoot.headline6.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline6[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.3");
				}		
			...
			//final frame
				for (var i = 0; i < exportRoot.headline13.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline13[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=7.1");
