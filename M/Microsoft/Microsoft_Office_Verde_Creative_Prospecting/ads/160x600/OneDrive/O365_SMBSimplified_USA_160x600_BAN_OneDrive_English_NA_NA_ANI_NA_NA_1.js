...
(lib.Laptop_Base = function() {
	this.initialize(ss["O365_SMBSimplified_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(52.4277,-2.3318,0.208,0.208);
	...
	this.shape_1.setTransform(46.6031,-2.3318,0.208,0.208);
	...
	this.shape_2.setTransform(42.5258,-3.8296,0.208,0.208);
	...
	this.shape_3.setTransform(39.0935,-3.944,0.208,0.208);
	...
	this.shape_4.setTransform(35.0682,-3.944,0.208,0.208);
	...
	this.shape_5.setTransform(28.3959,-3.6164,0.208,0.208);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F9B90E").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_6.setTransform(-38.3847,0.3205,0.208,0.208);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#39A4EE").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_7.setTransform(-46.2428,0.3205,0.208,0.208);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#83BB1E").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_8.setTransform(-38.3847,-7.5376,0.208,0.208);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#EA4E17").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_9.setTransform(-46.2428,-7.5376,0.208,0.208);
	...
	this.shape_10.setTransform(-4.945,-3.8556,0.208,0.208);
	...
	this.shape_11.setTransform(74.6706,-3.5228,0.208,0.208);
	...
	this.shape_12.setTransform(68.3155,-3.6008,0.208,0.208);
	...
	this.shape_13.setTransform(61.8096,-3.6008,0.208,0.208);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-49.8,-11.1,127.1,15), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AogCkIAAlHIRAAAIAAFHg");
	this.shape.setTransform(-45.35,0.425);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-99.8,-15.9,108.89999999999999,32.7), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(99.05,568.9,1,1,0,0,0,0.7,0.1);
	...
	this.cta.setTransform(152.15,569.45,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.phone.name = "phone";
	this.phone.parent = this;
	this.phone.setTransform(37.5,384.45,0.6434,0.6432,0,0,0,36.3,66.8);
	...
	this.laptop.setTransform(126.15,406.8,0.6205,0.546,0,0,0,283.9,24.8);
	...
	this.logo_1.setTransform(66.95,28.1,1,1,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.logo_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-149.8,0.2,531,599.8), null);


// stage content:
(lib.O365_SMBSimplified_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=120", ease:Power4.easeInOut});
				...
				exportRoot.tl1.to(cont3D, 1, {x:70, y:"+=90", z:-1000, ease:Power4.easeInOut}, "+=0.5");
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline15[i], 0.8, { x: "+=300", alpha: 0, ease:Power4.easeOut}, "-=1");
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline16[i], 0.8, { x: "+=300", alpha: 0, ease:Power4.easeOut}, "-=0.6");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline16[i], 0.8, { x: "+=300", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
...
p.nominalBounds = new cjs.Rectangle(-69.8,300,451,300);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_SMBSimplified_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_.png?1574951666023", id:"O365_SMBSimplified_USA_160x600_BAN_OneDrive_English_NA_NA_ANI_NA_NA_1_atlas_"}
	],
	preloads: []
};
