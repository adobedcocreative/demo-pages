...
lib.ssMetadata = [
		{name:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:24.8,y:835.45},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2767,scaleY:2.2767,x:-20.15,y:5.75},33,cjs.Ease.quadInOut).wait(1));
	...
	this.instance_2.setTransform(68.2,2281.7,0.5414,5.7885,0,0,0,485.4,406.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(75).to({scaleY:5.7403,y:2262.05},0).to({regX:484.9,x:67.9,alpha:0},21,cjs.Ease.quadIn).wait(3));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-194.7,-73.6,525.8,1979.6);
...
(lib.laptop_anim = function(mode,startPosition,loop) {
	...
	this.screen_powerpoint.setTransform(166.1,182.3,0.0775,0.0775,0,0,0,323.1,156.7);
	...
	this.screen_onedrive.setTransform(150.3,184.8,0.6932,0.6932,0,0,0,215.2,142.9);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(1.1,85.8,298.29999999999995,198), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.replay_btn.setTransform(143.3,4.3,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(96.05,569.2,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(140.8,569.45,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-29.7,-1.7,471.7,625.1), null);


// stage content:
(lib.Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(mc.screens.screen_onedrive, 0.8, { alpha: 1, onStart:function(){exportRoot.tl1.stop();}}, "-=0");
				...
				exportRoot.tl1.from(mc.screens.screen_onedrive, 2, { alpha: 1}, "-=0");
				
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "+=100",	ease:Power4.easeOut}, "-=1.7");
				exportRoot.tl1.from(mc.cta, 0.7, {alpha: 0, x: "+=100", ease:Power4.easeOut}, "-=1.7");
		...
		this.tlicons2 = new TimelineLite();
				...
				exportRoot.tlicons2.to(mc.screens.screen_powerpoint, 1.2, { 
					x: "+=16",
					y: "-=59",
					scaleX:"0.44", 
					scaleY:"0.44",
...
p.nominalBounds = new cjs.Rectangle(50.3,298.3,391.7,325.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582813043648", id:"Office_FY20Q4_Cons_USA_160x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
