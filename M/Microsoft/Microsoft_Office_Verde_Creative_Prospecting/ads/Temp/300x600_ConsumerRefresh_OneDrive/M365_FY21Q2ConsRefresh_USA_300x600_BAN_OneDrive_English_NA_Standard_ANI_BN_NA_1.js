...
lib.ssMetadata = [
		{name:"M365_FY21Q2ConsRefresh_USA_300x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[1160,0,484,423],[0,0,1158,754]]}
];
...
(lib.mobileonly = function() {
	this.initialize(ss["M365_FY21Q2ConsRefresh_USA_300x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-27.5,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AnwCSIAAkjIPhAAIAAEjg");
	this.shape.setTransform(-61.325,2.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-111,-12.3,99.4,29.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(58.05,195.45,0.3087,0.3087,0,0,0,0.1,0);
	...
	this.screens.setTransform(-7.4,281.95,0.7093,0.7093,0,0,0,192,96.1);
	...
	this.txtCta.setTransform(241.3,558.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(314.5,555.75,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-686.7,0.1,1164.5,600.3), null);


// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//Share Memories
				...
				//this.tlText.from(mc.screens, 1, { x: "+=310", ease:Power4.easeOut}, "-=0.6");
				this.tlText.from(mobile, 1, { alpha:0, x: "+=350", ease:Power4.easeOut}, "-=0.7");
				this.tlText.from(desktop, 1, { alpha:0, x: "+=350", ease:Power4.easeOut}, "-=0.8");
...
p.nominalBounds = new cjs.Rectangle(149,300,327.3,300.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2ConsRefresh_USA_300x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600342556529", id:"M365_FY21Q2ConsRefresh_USA_300x600_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
