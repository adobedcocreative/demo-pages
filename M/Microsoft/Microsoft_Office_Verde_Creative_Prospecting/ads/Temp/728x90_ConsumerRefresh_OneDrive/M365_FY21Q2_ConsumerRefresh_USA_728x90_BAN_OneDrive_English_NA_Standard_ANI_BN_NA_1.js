...
lib.ssMetadata = [
		{name:"M365_FY21Q2_ConsumerRefresh_USA_728x90_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[1160,0,484,423],[0,0,1158,754]]}
];
...
(lib.mobileonly = function() {
	this.initialize(ss["M365_FY21Q2_ConsumerRefresh_USA_728x90_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(712.65,2.55,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(670.65,60.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(743.85,57.65,1.136,1.136,0,0,0,0.2,0.2);
	...
	this.screens.setTransform(440.85,33.65,0.2823,0.2823,0,0,0,193,96.9);

	this.timeline.addTween(cjs.Tween.get(this.screens).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-12.6,729.4,106.5), null);


// stage content:
(lib.M365_FY21Q2_ConsumerRefresh_USA_728x90_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//Share Memories
				...
				//final frame
					...
					if (i==0) this.tlText.from(exportRoot.headline22[i], 0.8, { x: "+=150", alpha: 0, ease:Power4.easeOut}, "+=2.5");
		...
		//		this.tlText.from(mc.screens, 1, {alpha: 0, x: "+=150", ease:Power4.easeOut}, "-=1.1");
				this.tlText.from(mobile, 1, {alpha: 0, x: "+=150", ease:Power4.easeOut}, "-=0.7");
				this.tlText.from(desktop, 1, {alpha: 0, x: "+=150", ease:Power4.easeOut}, "-=0.9");
...
p.nominalBounds = new cjs.Rectangle(364,32.4,363.1,61.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2_ConsumerRefresh_USA_728x90_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600269847028", id:"M365_FY21Q2_ConsumerRefresh_USA_728x90_BAN_OneDrive_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
