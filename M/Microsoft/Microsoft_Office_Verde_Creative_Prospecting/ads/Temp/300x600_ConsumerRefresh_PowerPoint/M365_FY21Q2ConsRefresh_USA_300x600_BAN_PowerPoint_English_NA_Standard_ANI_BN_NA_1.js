...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-27.5,1.4,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	this.cta_glare.setTransform(-42.75,-3.65,1,1,0,0,0,57.4,15.1);
	...
	this.shape.setTransform(-61.325,1.125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-111,-12.3,99.4,26.9), null);
...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x600_BAN_PowerPoint_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				//final frame
					...
					if (i==0) this.tlText.from(exportRoot.headline22[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=9.7");
