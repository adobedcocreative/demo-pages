...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.65,1.15,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A80000").s().p("An2C9IAAl5IPtAAIAAF5g");
	this.shape.setTransform(-59.475,1.225);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.7,-17.7,100.5,37.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(70.5,38.95,0.7525,0.7525,0,0,0,0.1,0.4);
	...
	this.replay_btn.setTransform(303.45,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.65,426.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(123.95,425.65,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.9,0,320.9,480), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_320x480_BAN_ODInt_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(mc.logo, 0.6, { x: "-=150", ease:Power4.easeOut}, "+=0.2");
			
				for (var i = 0; i < exportRoot.headline1.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline1[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.4");
				...
				TweenMax.delayedCall(0.2, function(){exportRoot.videoState="playing"; vid.play();})
...
p.nominalBounds = new cjs.Rectangle(159,240,155.2,208.2);
// library properties:
lib.properties = {
