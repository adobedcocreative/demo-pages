...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2Holiday_USA_320x480_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,381,271]]}
];
...
(lib.Group11 = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_320x480_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.bgLogo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhRPB5GMAAAjyLMCifAAAMAAADyLg");
	this.shape.setTransform(520,775.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bgLogo, new cjs.Rectangle(0,0,1040,1550.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-24.45,-15.2,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BG_Slide, new cjs.Rectangle(-24.4,-15.2,266.7,189.7), null);
...
}).prototype = getMCSymbolPrototype(lib.BG_shape, new cjs.Rectangle(0,0,320,480), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(84).call(this.frame_84).wait(16).call(this.frame_100).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.2,scaleX:2.4209,scaleY:2.4209,x:8.5,y:-284.5},41,cjs.Ease.quadInOut).wait(1));

	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhRPB5GMAAAjyLMCifAAAMAAADyLg");
	this.shape.setTransform(298,363.025);

	this.instance_2 = new lib.bgLogo();
	this.instance_2.setTransform(298,363,1,1,0,0,0,520,775);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.instance_2}]},59).to({state:[{t:this.instance_2}]},40).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({alpha:0},40).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-222,-412,1040,1550.1);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.7,2,0.75,0.6881,0,0,0,13.4,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A80000").s().p("An2C2IAAlrIPtAAIAAFrg");
	this.shape.setTransform(-60.025,1.875);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.3,-16.3,100.6,36.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(69.05,127,0.3087,0.3087,0,0,0,0.1,0);
	...
	this.slide.setTransform(129.75,246.9,1,1,0,0,0,82.5,58);
	...
	this.txtCta.setTransform(254.75,444.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(332.15,441.2,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-0.1,321.5,480.3), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_320x480_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,239.9,160.5,239.99999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2Holiday_USA_320x480_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602724108658", id:"M365_MobileFY21Q2Holiday_USA_320x480_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
