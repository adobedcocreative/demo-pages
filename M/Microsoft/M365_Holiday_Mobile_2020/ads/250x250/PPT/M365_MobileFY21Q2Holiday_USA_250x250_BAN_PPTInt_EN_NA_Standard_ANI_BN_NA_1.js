...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2Holiday_USA_250x250_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,381,271]]}
];
...
(lib.Group11 = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_250x250_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Group11();
	this.instance.setTransform(-18.4,-9.55,0.4839,0.4839);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BG_Slide, new cjs.Rectangle(-18.4,-9.5,184.4,131.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-25.7,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A80000").s().p("AnDC0IAAlnIOHAAIAAFng");
	this.shape.setTransform(-59.4,2.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-104.6,-15.7,90.39999999999999,35.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.slide.setTransform(190.15,151.6,0.9195,0.9195,0,0,0,83,58.4);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.95,210.9,1.136,1.136,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_250x250_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2Holiday_USA_250x250_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602723671670", id:"M365_MobileFY21Q2Holiday_USA_250x250_BAN_PPTInt_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
