...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A80000").s().p("An0CsIAAlXIPoAAIAAFXg");
	this.shape.setTransform(-59.65,2.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.7,-14.8,100.10000000000001,34.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(54.35,23.6,0.7525,0.7525,0,0,0,0.1,0.4);
	...
	this.replay_btn.setTransform(234,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(37.15,214.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(112.95,211.85,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11.9,0,261.9,250), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_250x250_BAN_ODInt_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(113.1,125,131.9,108.69999999999999);
// library properties:
lib.properties = {
