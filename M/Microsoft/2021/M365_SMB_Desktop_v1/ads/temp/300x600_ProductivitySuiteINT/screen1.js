...
lib.ssMetadata = [
		{name:"screen1_atlas_1", frames: [[0,0,413,789]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(110.45,45.45,1.45,1.5,0,0,0,0.3,0.3);
	...
	// VidStatic
	this.instance_1 = new lib.Group23();
	this.instance_1.setTransform(0,0,1.3001,1.3001);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-27,-32,600.4,1200.7), null);
...
p.nominalBounds = new cjs.Rectangle(256,512,281,513.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen1_atlas_1.png?1606843698067", id:"screen1_atlas_1"}
	],
	preloads: []
};
