...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AnxCJIAAkRIPjAAIAAERg");
	this.shape.setTransform(-71.133,2.1644,1.0898,1.2774);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-125.4,-15.3,108.60000000000001,35), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(239.75,551.1,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(317,548.5,1,1,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_300x600_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,150,267.79999999999995);
// library properties:
lib.properties = {
