...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_160x600_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,400,1048]]}
];
...
(lib.bg = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_160x600_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-22.95,0,0.5898,0.5898);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-22.9,0,235.9,618.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(103,571.55,1.2856,1.2856,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(189.75,567.2,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.cubeShadow.setTransform(80.85,511.2,1,1,0,0,0,82.9,-15.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-22.9,0,235.9,618.2), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_160x600_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(57.1,300,155.3,318);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_160x600_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607014714988", id:"M365_FY21Q3SMBRefresh_USA_160x600_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
