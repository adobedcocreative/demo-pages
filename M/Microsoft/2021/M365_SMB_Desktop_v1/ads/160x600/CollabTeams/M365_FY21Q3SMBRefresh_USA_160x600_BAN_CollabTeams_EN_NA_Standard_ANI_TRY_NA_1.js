...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_160x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,320,688]]}
];
...
(lib.bg160x6002x = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_160x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-39.35,2.6,0.8,0.734,0,0,0,13.5,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4B53BC").s().p("AnfCJIAAkRIO/AAIAAERg");
	this.shape.setTransform(-67.925,1.925);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.9,-11.8,96,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(144.8,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(102.35,570.3,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(180.25,568.4,1,1,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// BG
	this.instance_1 = new lib.bg160x6002x();
	this.instance_1.setTransform(0,256.15,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,160.2,600.2), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_160x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,80.1,300.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_160x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606387540701", id:"M365_FY21Q3SMBRefresh_USA_160x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
