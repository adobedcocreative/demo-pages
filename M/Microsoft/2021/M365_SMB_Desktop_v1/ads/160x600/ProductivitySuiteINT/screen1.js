...
lib.ssMetadata = [
		{name:"screen1_atlas_1", frames: [[0,0,243,975]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.Group22pngcopy();
	this.instance.setTransform(0,0,1.0535,1.0503);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,256,1024), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(103.9,44.75,1.45,1.4999,0,0,0,0.4,0.3);
	...
	this.static1.setTransform(112.75,207.8,0.9946,1.005,0,0,0,113.9,207.8);

	this.timeline.addTween(cjs.Tween.get(this.static1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.5,-1,254.6,1029.1), null);
...
p.nominalBounds = new cjs.Rectangle(127.5,511,129.10000000000002,517.0999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen1_atlas_1.png?1606915824413", id:"screen1_atlas_1"}
	],
	preloads: []
};
