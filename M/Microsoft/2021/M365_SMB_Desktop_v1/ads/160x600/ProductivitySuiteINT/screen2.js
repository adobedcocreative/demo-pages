...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,244,984]]}
];
...
p.nominalBounds = new cjs.Rectangle(76,80.8,44,44);
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup121();
	this.instance_1.setTransform(-0.55,-2,1.0534,0.972);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.5,-2,257,956.4), null);
...
p.nominalBounds = new cjs.Rectangle(127.5,509.9,129,517.0000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606915621959", id:"screen2_atlas_1"}
	],
	preloads: []
};
