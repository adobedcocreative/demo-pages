...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,244,984]]}
];
...
p.nominalBounds = new cjs.Rectangle(52,143.1,37.3,37.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	// video
	this.instance_1 = new lib.MaskGroup21();
	this.instance_1.setTransform(-0.4,-2,1.0534,0.972);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.4,-2,257.09999999999997,956.4), null);
...
p.nominalBounds = new cjs.Rectangle(127.6,509.6,129.1,516.9999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606915684086", id:"screen4_atlas_1"}
	],
	preloads: []
};
