...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_300x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,600,848]]}
];
...
(lib.bgimage2x = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_300x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-37.6,1.95,0.95,0.8716,0,0,0,13.4,10.5);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4B53BC").s().p("AoeCyIAAljIQ9AAIAAFjg");
	this.shape.setTransform(-72.8,2.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-127,-15.6,108.5,35.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(32.05,32.3,0.7424,0.7424,0,0,0,0.1,0.4);
	...
	this.txtCta.setTransform(236.8,550.95,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(318.6,549.05,1,1,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// BG
	this.instance_1 = new lib.bgimage2x();
	this.instance_1.setTransform(0.2,176.15,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300.2,600.2), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_300x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.from([mc.cta, mc.txtCta], { duration: 0.6, x: "+=200"}, "+=6.5");
...
p.nominalBounds = new cjs.Rectangle(150,300,150.2,300.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_300x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606387978754", id:"M365_FY21Q3SMBRefresh_USA_300x600_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
