...
lib.ssMetadata = [
		{name:"foreground_atlas_1", frames: [[0,0,1359,1350]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// 300x600 FG.png
	this.instance = new lib._300x600FG();
...
}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(0,0,679.5,675), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Am8CFIAAkJIN6AAIAAEJg");
	this.shape.setTransform(-61.6927,0.5359,1.0269,1.0717);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-107.4,-13.6,91.5,28.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(32,32.3,0.7742,0.7742,0,0,0,0,0.4);
	...
	this.txtCta.setTransform(52.2,551.2,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(128.85,550.3,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.foreground.setTransform(-256.65,67.55,1,1,0,0,0,150.5,124.8);

	this.timeline.addTween(cjs.Tween.get(this.foreground).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-407.1,-57.2,1087,675), null);
...
p.nominalBounds = new cjs.Rectangle(-257.1,242.8,553.2,374.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/foreground_atlas_1.png?1606921945680", id:"foreground_atlas_1"}
	],
	preloads: []
};
