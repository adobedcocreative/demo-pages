...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,426,180]]}
];
...
(lib.bg728x902x = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_728x90_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-38.8,2.6,0.8,0.734,0,0,0,13.5,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4B53BC").s().p("AnbCJIAAkRIO4AAIAAERg");
	this.shape.setTransform(-71.9,2.125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-119.5,-11.6,95.3,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(710.3,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(43.5,60.7,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(120.05,58.1,1,1,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// BG
	this.instance_1 = new lib.bg728x902x();
	this.instance_1.setTransform(514.9,0,0.5,0.5);
...
// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_728x90_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_728x90_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607012920175", id:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
