...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,599,263]]}
];
...
(lib.TeamsCollaborationStoryboard2x = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-40.45,2.85,0.8,0.734,0,0,0,13.5,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4B53BC").s().p("AnpCJIAAkRIPTAAIAAERg");
	this.shape.setTransform(-67.5,2.125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-116.5,-11.6,98,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(240.45,216.65,1.2856,1.2856,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(318.6,214.05,1,1,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606387556689", id:"M365_FY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
