...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(239.75,216.7,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(317,214.1,1,1,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_300x250_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		//		MAIN ANIMATION ///////////////////////
				...
				this.tlText.from(exportRoot.headline4,{duration:0.5, y:"+=20", alpha:0, stagger:0.1});
				this.tlText.from(exportRoot.headline5,{duration:0.5, y:"+=20", alpha:0, stagger:0.1}, "-=0.2");
...
p.nominalBounds = new cjs.Rectangle(150,125,150,104.69999999999999);
// library properties:
lib.properties = {
