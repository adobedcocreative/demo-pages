...
lib.ssMetadata = [
		{name:"M365_AllUpIconsDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[291,0,163,154],[0,0,289,195],[160,197,106,96],[0,197,158,134],[291,156,162,137],[160,295,140,114]]}
];
...
(lib.ExcelIcon = function() {
	this.initialize(ss["M365_AllUpIconsDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btncopy, new cjs.Rectangle(-106.4,-16,107.4,38), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(92,564,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(159,560.5,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_AllUpIconsDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		exportRoot.runBanner = function() {
			...
			exportRoot.tlMain = gsap.timeline();
				...
				exportRoot.tlMain.to(mc.anim.pptIcon, 1.4, { scaleX:.52, scaleY:.52, x: "+=5", y: "+=68", ease:Power3.easeInOut}, "<");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_AllUpIconsDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635254827160", id:"M365_AllUpIconsDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
