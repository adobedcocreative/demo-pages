...
lib.ssMetadata = [
		{name:"M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[58,316,43,57],[231,270,112,87],[0,316,56,50],[231,0,145,268],[0,0,229,314]]}
];
...
(lib.Layer36 = function() {
	this.initialize(ss["M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.popUpsm = function() {
	this.initialize(ss["M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.womanTop_160x600();
	this.instance.setTransform(125.1,0.2,1.25,1.25);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.womanTop, new cjs.Rectangle(0,0,496,393), null);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(207.85,274.525);

	// Layer_2
	this.instance = new lib.uiEndsm();
	this.instance.setTransform(-20,-12,2.0306,2.0306);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.popUpsm();
	this.instance.setTransform(0,0,3.0724,3.0724);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-15,-20,1.5665,1.5665);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.pin, new cjs.Rectangle(-15,-20,67.4,89.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#CFCFCF","#D2D2D2"],[0,1],-242.8,-283,185,154.6).s().p("EgaxA25MAAAhtxMA1jAAAMAAABtxg");
	this.shape.setTransform(171.35,351.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.image_BG, new cjs.Rectangle(0,0,342.7,702.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#737373").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("EgMfAu3IAAwFIY/AAIAAQFgAsfpXMAAAglfIY/AAMAAAAlfg");
	this.shape.setTransform(80,299.875);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.box_Cache, new cjs.Rectangle(0,0,160,599.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgpXCY+MAAAkx7MBSuAAAMAAAEx7g");
	this.shape.setTransform(264.75,979.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bgWhite, new cjs.Rectangle(0,0,529.5,1958.1), null);
...
}).prototype = getMCSymbolPrototype(lib.woman_bg, new cjs.Rectangle(0,0,701,702.5), null);


(lib.uiEnd_plain = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_4
	this.instance = new lib.uiEnd_nopopup_m();
	this.instance.setTransform(152.75,217.15,2.0549,2.0549);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.uiEndsm();
	this.instance_1.setTransform(-20,-12,2.0306,2.0306);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// shadow
	this.instance_2 = new lib.Shadow();
	this.instance_2.setTransform(136.85,276.05,1.002,1.002,0,0,0,125,255.5);
...
}).prototype = getMCSymbolPrototype(lib.uiEnd_plain, new cjs.Rectangle(-20,-12,298,555.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_222.graphics.f("rgba(51,51,51,0)").s().p("AgVBVIAAipIArAAIAACpg");
	this.shape_222.setTransform(-104.675,-143.475);

	this.shape_223 = new cjs.Shape();
	this.shape_223.graphics.f("rgba(71,71,71,0.212)").s().p("AgVFkIAArHIArAAIAALHg");
	this.shape_223.setTransform(-104.675,-116.4);

	this.shape_224 = new cjs.Shape();
	this.shape_224.graphics.f("rgba(88,89,89,0.396)").s().p("AgVJJIAAyRIArAAIAASRg");
	this.shape_224.setTransform(-104.675,-93.5);

	this.shape_225 = new cjs.Shape();
	this.shape_225.graphics.f("rgba(103,103,103,0.545)").s().p("AgVMIIAA4PIArAAIAAYPg");
	this.shape_225.setTransform(-104.675,-74.4);

	this.shape_226 = new cjs.Shape();
	this.shape_226.graphics.f("rgba(114,115,115,0.667)").s().p("AgVOkIAA9HIArAAIAAdHg");
	this.shape_226.setTransform(-104.675,-58.775);

	this.shape_227 = new cjs.Shape();
	this.shape_227.graphics.f("rgba(124,125,125,0.769)").s().p("AgVQhMAAAghCIArAAMAAAAhCg");
	this.shape_227.setTransform(-104.675,-46.25);

	this.shape_228 = new cjs.Shape();
	this.shape_228.graphics.f("rgba(131,132,132,0.843)").s().p("AgVSDMAAAgkFIArAAMAAAAkFg");
	this.shape_228.setTransform(-104.675,-36.5);

	this.shape_229 = new cjs.Shape();
	this.shape_229.graphics.f("rgba(137,138,138,0.902)").s().p("AgVTMMAAAgmXIArAAMAAAAmXg");
	this.shape_229.setTransform(-104.675,-29.175);

	this.shape_230 = new cjs.Shape();
	this.shape_230.graphics.f("rgba(141,142,142,0.941)").s().p("AgVUBMAAAgoBIArAAMAAAAoBg");
	this.shape_230.setTransform(-104.675,-23.925);

	this.shape_231 = new cjs.Shape();
	this.shape_231.graphics.f("rgba(143,144,144,0.973)").s().p("AgVUkMAAAgpHIArAAMAAAApHg");
	this.shape_231.setTransform(-104.675,-20.4);

	this.shape_232 = new cjs.Shape();
	this.shape_232.graphics.f("rgba(145,146,146,0.988)").s().p("AgVU5MAAAgpyIArAAMAAAApyg");
	this.shape_232.setTransform(-104.675,-18.25);

	this.shape_233 = new cjs.Shape();
	this.shape_233.graphics.f("rgba(146,147,147,0.996)").s().p("AgVVFMAAAgqJIArAAMAAAAqJg");
...
p.nominalBounds = new cjs.Rectangle(-143.9,-200.6,196.7,325.3);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(77).call(this.frame_77).wait(42).call(this.frame_119).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({regX:0.2,x:212.45},12,cjs.Ease.quadInOut).wait(39).to({regX:0,regY:0.4,scaleX:2.3978,scaleY:2.3978,x:173.3,y:75.1},33,cjs.Ease.cubicInOut).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.introBg}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},13).to({state:[{t:this.instance_1}]},12).to({state:[]},1).wait(93));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:2.9988,scaleY:2.9988,x:258.6,y:912.95},13,cjs.Ease.quadOut).to({x:91.9},12,cjs.Ease.quadInOut).to({_off:true},1).wait(93));

	// new bg
	this.instance_2 = new lib.bgWhite();
	this.instance_2.setTransform(264.8,979,1,1,0,0,0,264.8,979);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(77).to({alpha:0},33,cjs.Ease.cubicInOut).to({_off:true},1).wait(9));
...
p.nominalBounds = new cjs.Rectangle(44.5,-86,200.4,410.8);
...
}).prototype = getMCSymbolPrototype(lib.boxSign, new cjs.Rectangle(0,0,138.7,107.7), null);
...
}).prototype = getMCSymbolPrototype(lib.box_c, new cjs.Rectangle(0,0,160,599.8), null);
...
}).prototype = getMCSymbolPrototype(lib.white_boxes, new cjs.Rectangle(0,0,160,599.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.boxSign).wait(84).to({visible:true},0).to({regX:15.5,scaleX:0.6,scaleY:0.6018,rotation:0,x:-63.7,y:-79.25},13,cjs.Ease.cubicOut).wait(18).to({regX:14.8,regY:45.8,scaleX:1.0485,scaleY:1.0485,rotation:-28.3515,x:-23.2,y:17.05},51,cjs.Ease.quadOut).wait(49).to({_off:true},1).wait(4).to({_off:false},0).wait(58).to({_off:true},1).wait(216));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-109,-200.6,231,282.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mainAnim_Build).wait(201).to({startPosition:190},0).wait(1).to({regX:23.5,regY:-12.7,scaleX:0.9955,scaleY:0.9955,rotation:0.1472,x:173.8,y:112.6,alpha:0.8914,startPosition:191},0).wait(1).to({scaleX:0.9859,scaleY:0.9859,rotation:0.4595,x:174.4,y:113.4,alpha:0.7854,startPosition:192},0).wait(1).to({scaleX:0.9702,scaleY:0.9702,rotation:0.9722,x:175.4,y:114.65,alpha:0.6849,startPosition:193},0).wait(1).to({scaleX:0.9469,scaleY:0.9469,rotation:1.7307,x:176.95,y:116.35,alpha:0.5919,startPosition:194},0).wait(1).to({scaleX:0.9143,scaleY:0.9143,rotation:2.7916,x:179.05,y:118.75,alpha:0.508,startPosition:195},0).wait(1).to({scaleX:0.8704,scaleY:0.8704,rotation:4.2206,x:181.95,y:121.85,alpha:0.4335,startPosition:196},0).wait(1).to({scaleX:0.8134,scaleY:0.8134,rotation:6.0786,x:185.75,y:125.55,alpha:0.3682,startPosition:197},0).wait(1).to({scaleX:0.7427,scaleY:0.7427,rotation:8.3824,x:190.55,y:129.8,alpha:0.3114,startPosition:198},0).wait(1).to({scaleX:0.661,scaleY:0.661,rotation:11.0415,x:196.25,y:134.25,alpha:0.2623,startPosition:199},0).wait(1).to({scaleX:0.5753,scaleY:0.5753,rotation:13.8335,x:202.45,y:138.35,alpha:0.22,startPosition:200},0).wait(1).to({scaleX:0.4934,scaleY:0.4934,rotation:16.4992,x:208.5,y:141.7,alpha:0.1834,startPosition:201},0).wait(1).to({scaleX:0.4206,scaleY:0.4206,rotation:18.8707,x:214.2,y:144.3,alpha:0.152,startPosition:202},0).wait(1).to({scaleX:0.3584,scaleY:0.3584,rotation:20.897,x:219.15,y:146.15,alpha:0.1249,startPosition:203},0).wait(1).to({scaleX:0.3063,scaleY:0.3063,rotation:22.5955,x:223.55,y:147.5,alpha:0.1017,startPosition:204},0).wait(1).to({scaleX:0.2629,scaleY:0.2629,rotation:24.0076,x:227.2,y:148.55,alpha:0.0818,startPosition:205},0).wait(1).to({scaleX:0.227,scaleY:0.227,rotation:25.1767,x:230.4,y:149.3,alpha:0.0648,startPosition:206},0).wait(1).to({scaleX:0.1974,scaleY:0.1974,rotation:26.1412,x:233,y:149.85,alpha:0.0504,startPosition:207},0).wait(1).to({scaleX:0.1731,scaleY:0.1731,rotation:26.9329,x:235.25,y:150.3,alpha:0.0384,startPosition:208},0).wait(1).to({scaleX:0.1533,scaleY:0.1533,rotation:27.5776,x:237.05,y:150.55,alpha:0.0283,startPosition:209},0).wait(1).to({scaleX:0.1374,scaleY:0.1374,rotation:28.096,x:238.5,y:150.8,alpha:0.0201,startPosition:210},0).wait(1).to({scaleX:0.1248,scaleY:0.1248,rotation:28.5052,x:239.7,y:151,alpha:0.0135,startPosition:211},0).wait(1).to({scaleX:0.1152,scaleY:0.1152,rotation:28.8188,x:240.6,y:151.1,alpha:0.0083,startPosition:212},0).wait(1).to({scaleX:0.1082,scaleY:0.1082,rotation:29.0483,x:241.25,y:151.2,alpha:0.0045,startPosition:213},0).wait(1).to({scaleX:0.1034,scaleY:0.1034,rotation:29.2031,x:241.75,y:151.25,alpha:0.002,startPosition:214},0).wait(1).to({scaleX:0.1007,scaleY:0.1007,rotation:29.2911,x:242,y:151.3,alpha:0.0005,startPosition:215},0).wait(1).to({regX:-43.9,regY:-36.2,scaleX:0.0998,scaleY:0.0998,rotation:29.3191,x:237.25,y:145.9,alpha:0,startPosition:220},0).wait(34).to({startPosition:254},0).to({_off:true},1).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(201).to({_off:false},0).wait(1).to({regX:207.9,regY:274.5,rotation:-28.6024,x:151.9,y:140.55},0).wait(1).to({scaleX:0.5118,scaleY:0.5118,rotation:-28.2962,x:153.1,y:140.75},0).wait(1).to({scaleX:0.5115,scaleY:0.5115,rotation:-27.7935,x:155,y:141.1},0).wait(1).to({scaleX:0.5112,scaleY:0.5112,rotation:-27.0497,x:157.7,y:141.7},0).wait(1).to({scaleX:0.5108,scaleY:0.5108,rotation:-26.0095,x:161.6,y:142.45},0).wait(1).to({scaleX:0.5102,scaleY:0.5102,rotation:-24.6083,x:166.8,y:143.5},0).wait(1).to({scaleX:0.5095,scaleY:0.5095,rotation:-22.7864,x:173.55,y:144.9},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,rotation:-20.5274,x:181.85,y:146.55},0).wait(1).to({regX:138.9,regY:269.2,scaleX:0.5074,scaleY:0.5074,rotation:-17.9201,x:157.3,y:156.7},0).wait(1).to({regX:207.9,regY:274.5,scaleX:0.5063,scaleY:0.5063,rotation:-15.1827,x:201.35,y:150.6,alpha:0.1528},0).wait(1).to({scaleX:0.5052,scaleY:0.5052,rotation:-12.5692,x:210.75,y:152.55,alpha:0.2986},0).wait(1).to({scaleX:0.5043,scaleY:0.5043,rotation:-10.2441,x:219.05,y:154.3,alpha:0.4283},0).wait(1).to({scaleX:0.5034,scaleY:0.5034,rotation:-8.2574,x:226.15,y:155.8,alpha:0.5392},0).wait(1).to({scaleX:0.5027,scaleY:0.5027,rotation:-6.5921,x:232,y:157.1,alpha:0.6321},0).wait(1).to({scaleX:0.5022,scaleY:0.5022,rotation:-5.2076,x:236.8,y:158.1,alpha:0.7094},0).wait(1).to({scaleX:0.5017,scaleY:0.5017,rotation:-4.0614,x:240.9,y:159,alpha:0.7734},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,rotation:-3.1158,x:244.15,y:159.75,alpha:0.8261},0).wait(1).to({scaleX:0.501,scaleY:0.501,rotation:-2.3395,x:246.85,y:160.35,alpha:0.8694},0).wait(1).to({scaleX:0.5007,scaleY:0.5007,rotation:-1.7075,x:249.05,y:160.85,alpha:0.9047},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,rotation:-1.1991,x:250.8,y:161.15,alpha:0.9331},0).wait(1).to({scaleX:0.5003,scaleY:0.5003,rotation:-0.798,x:252.2,y:161.5,alpha:0.9555},0).wait(1).to({scaleX:0.5002,scaleY:0.5002,rotation:-0.4905,x:253.25,y:161.7,alpha:0.9726},0).wait(1).to({scaleX:0.5001,scaleY:0.5001,rotation:-0.2655,x:254.05,y:161.9,alpha:0.9852},0).wait(1).to({rotation:-0.1138,x:254.55,y:162,alpha:0.9937},0).wait(1).to({scaleX:0.5,scaleY:0.5,rotation:-0.0275,x:254.85,y:162.1,alpha:0.9985},0).wait(1).to({regX:139,regY:269,rotation:0,x:220.5,y:159.5,alpha:1},0).wait(34).to({_off:true},1).wait(24));

	// endUi
	this.instance_1 = new lib.uiEnd_plain();
	this.instance_1.setTransform(242.15,363.15,0.5119,0.5119,-28.7468,0,0,138.9,269.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).to({x:119.1,y:155.1},58,cjs.Ease.quintOut).wait(24).to({regX:127.2,regY:264.5,rotation:-28.6024,x:113.15,y:155.85},0).wait(1).to({scaleX:0.5118,scaleY:0.5118,rotation:-28.2963,x:114.25},0).wait(1).to({scaleX:0.5116,scaleY:0.5116,rotation:-27.7935,x:116.05},0).wait(1).to({scaleX:0.5112,scaleY:0.5112,rotation:-27.0498,x:118.65,y:155.95},0).wait(1).to({scaleX:0.5108,scaleY:0.5108,rotation:-26.0097,x:122.3,y:155.9},0).wait(1).to({scaleX:0.5102,scaleY:0.5102,rotation:-24.6085,x:127.2,y:155.95},0).wait(1).to({scaleX:0.5095,scaleY:0.5095,rotation:-22.7868,x:133.65,y:156.1},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,rotation:-20.528,x:141.65,y:156.15},0).wait(1).to({scaleX:0.5074,scaleY:0.5074,rotation:-17.9208,x:150.85,y:156.25},0).wait(1).to({scaleX:0.5063,scaleY:0.5063,rotation:-15.1833,x:160.55,y:156.4},0).wait(1).to({scaleX:0.5052,scaleY:0.5052,rotation:-12.5697,x:169.85,y:156.5},0).wait(1).to({scaleX:0.5043,scaleY:0.5043,rotation:-10.2445,x:178.05,y:156.6},0).wait(1).to({scaleX:0.5034,scaleY:0.5034,rotation:-8.2577,x:185.1,y:156.65},0).wait(1).to({scaleX:0.5027,scaleY:0.5027,rotation:-6.5923,x:191.05,y:156.75},0).wait(1).to({scaleX:0.5022,scaleY:0.5022,rotation:-5.2078,x:196,y:156.8},0).wait(1).to({scaleX:0.5017,scaleY:0.5017,rotation:-4.0616,x:200.1,y:156.9},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,rotation:-3.1159,x:203.45,y:156.95},0).wait(1).to({scaleX:0.501,scaleY:0.501,rotation:-2.3396,x:206.25,y:157},0).wait(1).to({scaleX:0.5007,scaleY:0.5007,rotation:-1.7075,x:208.5,y:157.05},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,rotation:-1.1992,x:210.3,y:157},0).wait(1).to({scaleX:0.5003,scaleY:0.5003,rotation:-0.798,x:211.8},0).wait(1).to({scaleX:0.5002,scaleY:0.5002,rotation:-0.4905,x:212.85,y:157.05},0).wait(1).to({scaleX:0.5001,scaleY:0.5001,rotation:-0.2656,x:213.65},0).wait(1).to({rotation:-0.1138,x:214.2},0).wait(1).to({scaleX:0.5,scaleY:0.5,rotation:-0.0275,x:214.5,y:157.1},0).wait(1).to({regX:139,regY:269,rotation:0,x:220.5,y:159.5},0).wait(34).to({_off:true},1).wait(24));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-21.5,-4.5,396.1,529.5);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(218).call(this.frame_219).wait(41).call(this.frame_260).wait(1).call(this.frame_261).wait(1));

	// buildZoom
	this.buildZoom = new lib.buildZoom("synched",0,false);
	this.buildZoom.name = "buildZoom";
	this.buildZoom.setTransform(133.5,31.5,1,1,0,0,0,91.5,58.5);

	this.timeline.addTween(cjs.Tween.get(this.buildZoom).wait(115).to({startPosition:115},0).to({regX:91.8,scaleX:0.89,scaleY:0.89,x:110.55,y:15.3,startPosition:157},42,cjs.Ease.quintOut).to({regY:58.4,scaleX:0.7796,scaleY:0.7796,x:117.1,y:26.25,startPosition:201},44).to({regX:91.6,scaleX:0.7886,scaleY:0.7886,x:37.25,y:24.05,startPosition:219},18,cjs.Ease.quadInOut).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.womanTop).wait(116).to({alpha:0},13).wait(133));

	// mainAnim_Build
	this.mainAnim_Build = new lib.mainAnim_Build("synched",0,false);
	this.mainAnim_Build.name = "mainAnim_Build";
	this.mainAnim_Build.setTransform(132.45,53.7,0.6727,0.6727,0,0,0,-45.4,-36.1);

	this.timeline.addTween(cjs.Tween.get(this.mainAnim_Build).wait(116).to({startPosition:98},0).to({regX:-45.1,regY:-34.7,scaleX:0.4858,scaleY:0.4858,rotation:-27.6895,x:153.35,y:97.55,alpha:0},22,cjs.Ease.quadInOut).wait(124));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(10.4,-56.9,380.70000000000005,518.7);
...
if (reversed == null) { reversed = false; }
	...
	this.animation.setTransform(83.4,395.7,0.9509,0.9509,0,0,0,148.7,146.9);
	...
	this.bg.name = "bg";
	this.bg.setTransform(84.95,374.2,0.7987,0.7987,0,0,0,149.8,125.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11,0,192.4,604.4), null);


// stage content:
(lib.M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(69,300,112.4,304.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1625248971554", id:"M365_FSDriveReports_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
