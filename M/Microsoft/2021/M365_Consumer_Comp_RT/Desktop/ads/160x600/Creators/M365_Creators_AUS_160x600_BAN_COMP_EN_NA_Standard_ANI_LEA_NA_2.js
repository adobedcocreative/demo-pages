...
lib.ssMetadata = [
		{name:"M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[0,220,200,168],[202,257,167,93],[290,0,204,255],[0,0,288,218],[202,352,168,31],[202,220,52,22],[371,257,38,48],[372,307,38,48],[411,257,40,39]]}
];
...
(lib.base = function() {
	this.initialize(ss["M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Creators_bg_160x6001pngcopy = function() {
	this.initialize(ss["M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.FinalScreen_lg();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:2.9988,scaleY:2.9988,x:258.6,y:912.95},13,cjs.Ease.quadOut).to({x:91.9},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(65).to({_off:false},0).to({regX:0,regY:1,x:250.05,y:327,alpha:0},33,cjs.Ease.cubicInOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-46.9,-110.7,602.1,2172.7);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(213).to({_off:false},0).to({regX:9.7,scaleX:2.0424,scaleY:2.0424,x:279.15,y:144.7},10,cjs.Ease.sineOut).wait(2).to({regX:9.5,regY:10,scaleX:1,scaleY:1,x:278.5,y:144},14,cjs.Ease.sineInOut).to({_off:true},14).wait(11));

	// photo 3 copy
	this.instance_1 = new lib.photo3_1();
	this.instance_1.setTransform(282.45,-6.85,1.3201,1.5333,-3.0131,0,0,26.2,11.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(154).to({_off:false},0).to({regX:26.3,regY:11.1,scaleX:2.2678,scaleY:2.5582,rotation:4.195,x:297.1,y:-64.45},17,cjs.Ease.sineInOut).wait(3).to({regX:26,regY:11,scaleX:2.2644,scaleY:2.5539,rotation:4.1912,x:296.35,y:-64.05},0).wait(1).to({scaleX:2.2538,scaleY:2.5405,rotation:4.1796,x:296.2,y:-61.95},0).wait(1).to({scaleX:2.2356,scaleY:2.5177,rotation:4.1599,x:295.85,y:-58.3},0).wait(1).to({scaleX:2.2099,scaleY:2.4853,rotation:4.1319,x:295.45,y:-53.15},0).wait(1).to({scaleX:2.1765,scaleY:2.4433,rotation:4.0957,x:294.95,y:-46.55},0).wait(1).to({scaleX:2.1359,scaleY:2.3922,rotation:4.0515,x:294.25,y:-38.45},0).wait(1).to({scaleX:2.0884,scaleY:2.3324,rotation:3.9999,x:293.4,y:-29},0).wait(1).to({scaleX:2.0351,scaleY:2.2653,rotation:3.9419,x:292.6,y:-18.4},0).wait(1).to({scaleX:1.9769,scaleY:2.1921,rotation:3.8787,x:291.6,y:-6.85},0).wait(1).to({scaleX:1.9153,scaleY:2.1145,rotation:3.8117,x:290.55,y:5.4},0).wait(1).to({scaleX:1.8516,scaleY:2.0343,rotation:3.7424,x:289.55,y:18.15},0).wait(1).to({scaleX:1.7872,scaleY:1.9532,rotation:3.6724,x:288.4,y:30.85},0).wait(1).to({scaleX:1.7233,scaleY:1.8728,rotation:3.603,x:287.35,y:43.55},0).wait(1).to({scaleX:1.6612,scaleY:1.7946,rotation:3.5354,x:286.35,y:55.9},0).wait(1).to({scaleX:1.6016,scaleY:1.7196,rotation:3.4706,x:285.35,y:67.75},0).wait(1).to({scaleX:1.5452,scaleY:1.6486,rotation:3.4093,x:284.4,y:79},0).wait(1).to({scaleX:1.4924,scaleY:1.5822,rotation:3.3519,x:283.55,y:89.45},0).wait(1).to({scaleX:1.4436,scaleY:1.5207,rotation:3.2988,x:282.7,y:99.2},0).wait(1).to({scaleX:1.3988,scaleY:1.4644,rotation:3.2502,x:282,y:108.1},0).wait(1).to({scaleX:1.3581,scaleY:1.4132,rotation:3.2059,x:281.3,y:116.15},0).wait(1).to({scaleX:1.3215,scaleY:1.3671,rotation:3.1661,x:280.65,y:123.45},0).wait(1).to({scaleX:1.2889,scaleY:1.326,rotation:3.1307,x:280.15,y:130},0).wait(1).to({scaleX:1.2601,scaleY:1.2898,rotation:3.0994,x:279.7,y:135.65},0).wait(1).to({scaleX:1.235,scaleY:1.2582,rotation:3.0721,x:279.25,y:140.65},0).wait(1).to({scaleX:1.2134,scaleY:1.231,rotation:3.0486,x:278.9,y:145},0).wait(1).to({scaleX:1.1952,scaleY:1.2082,rotation:3.0288,x:278.6,y:148.6},0).wait(1).to({scaleX:1.1803,scaleY:1.1893,rotation:3.0126,x:278.35,y:151.55},0).wait(1).to({regX:26.4,regY:11.2,scaleX:1.1683,scaleY:1.1743,rotation:2.9996,x:278.45,y:154.05},0).wait(1).to({regX:26,regY:11,scaleX:1.1406,scaleY:1.1456,rotation:2.5054,x:277.95,y:154.45},0).wait(1).to({scaleX:1.1155,scaleY:1.1196,rotation:2.0583,x:277.85,y:155},0).wait(1).to({scaleX:1.093,scaleY:1.0963,rotation:1.6573,x:277.75,y:155.55},0).wait(1).to({scaleX:1.0731,scaleY:1.0757,rotation:1.3017,y:156.05},0).wait(1).to({scaleX:1.0556,scaleY:1.0576,rotation:0.9907,x:277.7,y:156.45},0).wait(1).to({scaleX:1.0406,scaleY:1.0421,rotation:0.7236,x:277.65,y:156.8},0).wait(1).to({scaleX:1.0281,scaleY:1.0291,rotation:0.4996,x:277.6,y:157.1},0).wait(1).to({scaleX:1.0179,scaleY:1.0185,rotation:0.3179,x:277.55,y:157.35},0).wait(1).to({scaleX:1.01,scaleY:1.0104,rotation:0.1778,y:157.55},0).wait(1).to({scaleX:1.0044,scaleY:1.0046,rotation:0.0786,y:157.7},0).wait(1).to({scaleX:1.0011,scaleY:1.0011,rotation:0.0195,y:157.75},0).wait(1).to({scaleX:1,scaleY:1,rotation:0,x:278,y:158},0).to({_off:true},40).wait(11));

	// maskPhoto3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_137 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_138 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_139 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_140 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_141 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_142 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_143 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_144 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_145 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_146 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_147 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_148 = new cjs.Graphics().p("AGWlPIQPgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_149 = new cjs.Graphics().p("AGplPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_150 = new cjs.Graphics().p("AG7lPIQPgPQgBABAaFYIAaFXIwNANg");
	var mask_graphics_151 = new cjs.Graphics().p("AHOlPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_152 = new cjs.Graphics().p("AHglPIQPgPQgBABAaFYIAaFXIwNANg");
	var mask_graphics_153 = new cjs.Graphics().p("AHzlPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_154 = new cjs.Graphics().p("AIFlPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_155 = new cjs.Graphics().p("AIXlPIQPgPQgBABAaFYIAaFXIwNANg");
	var mask_graphics_156 = new cjs.Graphics().p("AIqlPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_157 = new cjs.Graphics().p("AI8lPIQPgPQgBABAaFYIAaFXIwNANg");
	var mask_graphics_158 = new cjs.Graphics().p("AJPlPIQOgPQgBABAaFYIAbFXIwOANg");
	var mask_graphics_159 = new cjs.Graphics().p("AJhlPIQPgPQgBABAaFYIAaFXIwOANg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(137).to({graphics:mask_graphics_137,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_138,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_139,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_140,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_141,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_142,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_143,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_144,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_145,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_146,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_147,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_148,x:149.6527,y:-5.7501}).wait(1).to({graphics:mask_graphics_149,x:151.4936,y:-5.791}).wait(1).to({graphics:mask_graphics_150,x:153.3345,y:-5.8319}).wait(1).to({graphics:mask_graphics_151,x:155.1754,y:-5.8728}).wait(1).to({graphics:mask_graphics_152,x:157.0163,y:-5.9137}).wait(1).to({graphics:mask_graphics_153,x:158.8572,y:-5.9546}).wait(1).to({graphics:mask_graphics_154,x:160.6982,y:-5.9955}).wait(1).to({graphics:mask_graphics_155,x:162.5391,y:-6.0365}).wait(1).to({graphics:mask_graphics_156,x:164.38,y:-6.0774}).wait(1).to({graphics:mask_graphics_157,x:166.2209,y:-6.1183}).wait(1).to({graphics:mask_graphics_158,x:168.0618,y:-6.1592}).wait(1).to({graphics:mask_graphics_159,x:169.903,y:-6.2001}).wait(1).to({graphics:null,x:0,y:0}).wait(104));

	// photo 3
	this.instance_2 = new lib.photo3_1();
	this.instance_2.setTransform(355.6,-9.15,1.3201,1.5333,-3.0132,0,0,26.2,11.2);
	this.instance_2._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(137).to({_off:false},0).to({x:283,y:-5},11,cjs.Ease.none).to({_off:true},6).wait(110));

	// maskPhoto2 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("AP2lUIGwgFQgBABAaFYIAaFXImuADg");
	var mask_1_graphics_101 = new cjs.Graphics().p("AP2lUIGwgFQgBABAaFYIAaFXImuADg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:149.7252,y:-5.8245}).wait(12).to({graphics:mask_1_graphics_101,x:149.7252,y:-5.8245}).wait(1).to({graphics:null,x:0,y:0}).wait(162));

	// photo 2
	this.instance_3 = new lib.photo_2();
	this.instance_3.setTransform(319.3,-2.35,0.9499,1.067,0,-5.0007,-0.5117,19.3,23.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(91).to({_off:false},0).wait(1).to({regX:19,regY:24,scaleX:0.95,x:318.05,y:-2.15},0).wait(1).to({x:316.4},0).wait(1).to({x:313.9},0).wait(1).to({x:310.5,y:-2.2},0).wait(1).to({x:306.1},0).wait(1).to({x:300.75,y:-2.25},0).wait(1).to({x:294.7,y:-2.3},0).wait(1).to({x:288.4,y:-2.35},0).wait(1).to({x:282.95,y:-2.4},0).wait(1).to({regX:19.3,regY:23.8,scaleX:0.9499,x:279.7,y:-2.65},0).to({regX:19.4,regY:23.7,scaleX:1.4908,scaleY:1.629,skewX:1.9754,skewY:2.6692,x:281.4,y:-30.45},15,cjs.Ease.sineInOut).wait(1).to({regX:19,regY:24,scaleX:1.4905,scaleY:1.6285,skewX:1.9457,skewY:2.6392,x:280.8,y:-29.75},0).wait(1).to({scaleX:1.4894,scaleY:1.6268,skewX:1.8513,skewY:2.5438,x:280.95,y:-29.05},0).wait(1).to({scaleX:1.4875,scaleY:1.6237,skewX:1.6829,skewY:2.3737,x:281.15,y:-27.75},0).wait(1).to({scaleX:1.4845,scaleY:1.6192,skewX:1.4295,skewY:2.1177,x:281.5,y:-25.75},0).wait(1).to({scaleX:1.4803,scaleY:1.6128,skewX:1.0781,skewY:1.7627,x:281.9,y:-23.05},0).wait(1).to({scaleX:1.4749,scaleY:1.6044,skewX:0.613,skewY:1.2928,x:282.55,y:-19.4},0).wait(1).to({scaleX:1.468,scaleY:1.5935,skewX:0.0164,skewY:0.69,x:283.35,y:-14.75},0).wait(1).to({scaleX:1.4592,scaleY:1.5799,skewX:-0.7316,skewY:-0.0657,x:284.3,y:-9},0).wait(1).to({scaleX:1.4484,scaleY:1.5633,skewX:-1.6502,skewY:-0.9938,x:285.5,y:-1.9},0).wait(1).to({scaleX:1.4356,scaleY:1.5433,skewX:-2.7534,skewY:-2.1083,x:286.95,y:6.7},0).wait(1).to({scaleX:1.4205,scaleY:1.52,skewX:-4.0408,skewY:-3.4089,x:288.6,y:16.7},0).wait(1).to({scaleX:1.4036,scaleY:1.4937,skewX:-5.4858,skewY:-4.8689,x:290.5,y:27.9},0).wait(1).to({scaleX:1.3855,scaleY:1.4657,skewX:-7.0293,skewY:-6.4282,x:292.5,y:39.8},0).wait(1).to({scaleX:1.3673,scaleY:1.4375,skewX:-8.5878,skewY:-8.0028,x:294.55,y:51.9},0).wait(1).to({scaleX:1.3498,scaleY:1.4104,skewX:-10.0793,skewY:-9.5097,x:296.5,y:63.45},0).wait(1).to({scaleX:1.3339,scaleY:1.3856,skewX:-11.4458,skewY:-10.8902,x:298.3,y:74.05},0).wait(1).to({scaleX:1.3197,scaleY:1.3636,skewX:-12.6596,skewY:-12.1165,x:299.8,y:83.45},0).wait(1).to({scaleX:1.3073,scaleY:1.3444,skewX:-13.7164,skewY:-13.1842,x:301.25,y:91.65},0).wait(1).to({scaleX:1.2966,scaleY:1.328,skewX:-14.6248,skewY:-14.102,x:302.45,y:98.7},0).wait(1).to({scaleX:1.2876,scaleY:1.3139,skewX:-15.399,skewY:-14.8841,x:303.4,y:104.65},0).wait(1).to({regX:19.4,regY:23.9,scaleX:1.2799,scaleY:1.302,skewX:-16.0541,skewY:-15.546,x:304.65,y:109.2},0).to({regX:19,regY:24,scaleX:1,scaleY:1,skewX:0,skewY:0,x:297.95,y:122},20,cjs.Ease.quadOut).to({_off:true},96).wait(11));

	// maskPhoto1 (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_41 = new cjs.Graphics().p("AP2lUIGwgFQgBABAaFYIAaFXImuADg");
	var mask_2_graphics_54 = new cjs.Graphics().p("AP2lUIGwgFQgBABAaFYIAaFXImuADg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(41).to({graphics:mask_2_graphics_41,x:149.7502,y:-4.9245}).wait(13).to({graphics:mask_2_graphics_54,x:149.7502,y:-4.9245}).wait(1).to({graphics:null,x:0,y:0}).wait(209));

	// photo1 copy
	this.instance_4 = new lib.photo1_1();
	this.instance_4.setTransform(317.1,-5.45,0.9499,1.067,0,-4.0004,-0.5035,19.2,23.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(44).to({_off:false},0).to({regX:19.3,skewX:-5.0007,skewY:-0.5117,x:278.8},10,cjs.Ease.none).to({regX:19.4,regY:23.7,scaleX:1.8608,scaleY:1.9466,skewX:2.7024,skewY:2.4434,x:282,y:-45.85},17,cjs.Ease.sineInOut).wait(1).to({regX:19,regY:24,scaleX:1.8567,scaleY:1.942,skewX:2.6254,skewY:2.3677,x:281,y:-44.35},0).wait(1).to({scaleX:1.8498,scaleY:1.9344,skewX:2.4981,skewY:2.2427,x:280.65,y:-42.7},0).wait(1).to({scaleX:1.8401,scaleY:1.9236,skewX:2.3176,skewY:2.0654,x:280.15,y:-40.45},0).wait(1).to({scaleX:1.8272,scaleY:1.9093,skewX:2.0807,skewY:1.8327,x:279.45,y:-37.45},0).wait(1).to({scaleX:1.8112,scaleY:1.8915,skewX:1.7843,skewY:1.5416,x:278.6,y:-33.7},0).wait(1).to({scaleX:1.7918,scaleY:1.87,skewX:1.4259,skewY:1.1895,x:277.55,y:-29.2},0).wait(1).to({scaleX:1.7689,scaleY:1.8446,skewX:1.0034,skewY:0.7745,x:276.35,y:-23.9},0).wait(1).to({scaleX:1.7425,scaleY:1.8153,skewX:0.5156,skewY:0.2954,x:274.9,y:-17.75},0).wait(1).to({scaleX:1.7126,scaleY:1.782,skewX:-0.037,skewY:-0.2474,x:273.35,y:-10.75},0).wait(1).to({scaleX:1.6792,scaleY:1.7451,skewX:-0.6525,skewY:-0.8519,x:271.55,y:-2.95},0).wait(1).to({scaleX:1.6428,scaleY:1.7046,skewX:-1.3264,skewY:-1.5139,x:269.55,y:5.55},0).wait(1).to({scaleX:1.6035,scaleY:1.661,skewX:-2.0517,skewY:-2.2262,x:267.45,y:14.65},0).wait(1).to({scaleX:1.562,scaleY:1.6149,skewX:-2.8183,skewY:-2.9792,x:265.2,y:24.3},0).wait(1).to({scaleX:1.5189,scaleY:1.5671,skewX:-3.6137,skewY:-3.7606,x:262.9,y:34.4},0).wait(1).to({scaleX:1.4751,scaleY:1.5185,skewX:-4.4234,skewY:-4.5558,x:260.55,y:44.5},0).wait(1).to({scaleX:1.4313,scaleY:1.47,skewX:-5.2315,skewY:-5.3496,x:258.2,y:54.7},0).wait(1).to({scaleX:1.3885,scaleY:1.4224,skewX:-6.0227,skewY:-6.1267,x:255.95,y:64.7},0).wait(1).to({scaleX:1.3474,scaleY:1.3768,skewX:-6.7827,skewY:-6.8733,x:253.7,y:74.3},0).wait(1).to({scaleX:1.3086,scaleY:1.3337,skewX:-7.4996,skewY:-7.5774,x:251.65,y:83.3},0).wait(1).to({scaleX:1.2726,scaleY:1.2937,skewX:-8.164,skewY:-8.23,x:249.7,y:91.7},0).wait(1).to({regX:19.6,regY:23.9,scaleX:1.2398,scaleY:1.2573,skewX:-8.7697,skewY:-8.8249,x:248.5,y:98.8},0).to({regX:19,regY:24,scaleX:1,scaleY:1,skewX:0,skewY:0,x:259,y:122},11,cjs.Ease.quadOut).to({_off:true},150).wait(11));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_195 = new cjs.Graphics().p("AX+PhIAA0UIAcAAIAAUUg");
	var mask_3_graphics_196 = new cjs.Graphics().p("AX5PhIAA0UIAjAAIAAUUg");
	var mask_3_graphics_197 = new cjs.Graphics().p("AXqPgIAA0SIA3AAIAAUSg");
	var mask_3_graphics_198 = new cjs.Graphics().p("AXSPgIAA0RIBXAAIAAURg");
	var mask_3_graphics_199 = new cjs.Graphics().p("AWwPfIAA0OICEAAIAAUOg");
	var mask_3_graphics_200 = new cjs.Graphics().p("AWGPfIAA0MIC8AAIAAUMg");
	var mask_3_graphics_201 = new cjs.Graphics().p("AVUPeIAA0IID/AAIAAUIg");
	var mask_3_graphics_202 = new cjs.Graphics().p("AUaPdIAA0EIFMAAIAAUEg");
	var mask_3_graphics_203 = new cjs.Graphics().p("ATbPcIAA0AIGgAAIAAUAg");
	var mask_3_graphics_204 = new cjs.Graphics().p("ASWPaIAAz6IH8AAIAAT6g");
	var mask_3_graphics_205 = new cjs.Graphics().p("ARNPZIAAz2IJdAAIAAT2g");
	var mask_3_graphics_206 = new cjs.Graphics().p("AQAPYIAAzxILEAAIAATxg");
	var mask_3_graphics_207 = new cjs.Graphics().p("AOyPWIAAzqIMsAAIAATqg");
	var mask_3_graphics_208 = new cjs.Graphics().p("ANkPVIAAzlIOUAAIAATlg");
	var mask_3_graphics_209 = new cjs.Graphics().p("AMWPUIAAzgIP8AAIAATgg");
	var mask_3_graphics_210 = new cjs.Graphics().p("ALKPSIAAzaIRhAAIAATag");
	var mask_3_graphics_211 = new cjs.Graphics().p("AKAPRIAAzVITEAAIAATVg");
	var mask_3_graphics_212 = new cjs.Graphics().p("AI7PQIAAzRIUgAAIAATRg");
	var mask_3_graphics_213 = new cjs.Graphics().p("AH8PPIAAzMIV0AAIAATMg");
	var mask_3_graphics_214 = new cjs.Graphics().p("AHDPOIAAzIIXAAAIAATIg");
	var mask_3_graphics_215 = new cjs.Graphics().p("AGQPNIAAzFIYDAAIAATFg");
	var mask_3_graphics_216 = new cjs.Graphics().p("AFmPMIAAzCIY7AAIAATCg");
	var mask_3_graphics_217 = new cjs.Graphics().p("AFFPLIAAy/IZoAAIAAS/g");
	var mask_3_graphics_218 = new cjs.Graphics().p("AEsPLIAAy+IaJAAIAAS+g");
	var mask_3_graphics_219 = new cjs.Graphics().p("AEePLIAAy9IacAAIAAS9g");
	var mask_3_graphics_220 = new cjs.Graphics().p("AEZPLIAAy9IajAAIAAS9g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_3_graphics_195,x:156.2488,y:99.2749}).wait(1).to({graphics:mask_3_graphics_196,x:156.4131,y:99.2661}).wait(1).to({graphics:mask_3_graphics_197,x:156.9035,y:99.2399}).wait(1).to({graphics:mask_3_graphics_198,x:157.7121,y:99.1968}).wait(1).to({graphics:mask_3_graphics_199,x:158.8264,y:99.1373}).wait(1).to({graphics:mask_3_graphics_200,x:160.2286,y:99.0624}).wait(1).to({graphics:mask_3_graphics_201,x:161.8967,y:98.9734}).wait(1).to({graphics:mask_3_graphics_202,x:163.8044,y:98.8716}).wait(1).to({graphics:mask_3_graphics_203,x:165.9216,y:98.7586}).wait(1).to({graphics:mask_3_graphics_204,x:168.2148,y:98.6362}).wait(1).to({graphics:mask_3_graphics_205,x:170.648,y:98.5063}).wait(1).to({graphics:mask_3_graphics_206,x:173.1827,y:98.371}).wait(1).to({graphics:mask_3_graphics_207,x:175.7791,y:98.2324}).wait(1).to({graphics:mask_3_graphics_208,x:178.396,y:98.0927}).wait(1).to({graphics:mask_3_graphics_209,x:180.9923,y:97.9541}).wait(1).to({graphics:mask_3_graphics_210,x:183.5271,y:97.8188}).wait(1).to({graphics:mask_3_graphics_211,x:185.9602,y:97.689}).wait(1).to({graphics:mask_3_graphics_212,x:188.2535,y:97.5666}).wait(1).to({graphics:mask_3_graphics_213,x:190.3707,y:97.4535}).wait(1).to({graphics:mask_3_graphics_214,x:192.2783,y:97.3517}).wait(1).to({graphics:mask_3_graphics_215,x:193.9464,y:97.2627}).wait(1).to({graphics:mask_3_graphics_216,x:195.3487,y:97.1878}).wait(1).to({graphics:mask_3_graphics_217,x:196.4629,y:97.1284}).wait(1).to({graphics:mask_3_graphics_218,x:197.2716,y:97.0852}).wait(1).to({graphics:mask_3_graphics_219,x:197.762,y:97.059}).wait(1).to({graphics:mask_3_graphics_220,x:197.9763,y:97.0502}).wait(44));

	// bg
	this.instance_5 = new lib.powerpointUI_mc();
	this.instance_5.setTransform(311.5,133.5,1,1,0,0,0,83.5,46.5);
	...
	this.base.name = "base";
	this.base.setTransform(286.6,0.9,0.105,0.1404,-3.0151,0,0,104,82.2);

	this.timeline.addTween(cjs.Tween.get(this.base).wait(1).to({regX:100.1,regY:83.9,scaleX:0.1064,scaleY:0.142,rotation:-3.0132,x:286,y:1.25},0).wait(1).to({scaleX:0.1088,scaleY:0.1446,rotation:-3.0103,x:285.55,y:1.3},0).wait(1).to({regX:104.3,regY:82.2,scaleX:0.112,scaleY:0.1481,rotation:-3.0063,x:285.5,y:1.1},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.1188,scaleY:0.1557,rotation:-3.0036,x:284.05,y:1.4},0).wait(1).to({regX:103.8,regY:82.5,scaleX:0.1272,scaleY:0.165,rotation:-3.0003,x:283.35,y:1},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.133,scaleY:0.1706,rotation:-2.9787,x:281.55,y:1.05},0).wait(1).to({regX:104.2,regY:82.2,scaleX:0.1398,scaleY:0.1771,rotation:-2.9534,x:280.5,y:0.45},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.1477,scaleY:0.1846,rotation:-2.9254,x:278.2,y:0.2},0).wait(1).to({regX:104.2,regY:82.2,scaleX:0.1566,scaleY:0.1932,rotation:-2.8936,x:276.9,y:-0.8},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.1666,scaleY:0.2027,rotation:-2.8586,x:274.15,y:-1.35},0).wait(1).to({regX:104.4,regY:81.9,scaleX:0.1778,scaleY:0.2134,rotation:-2.8196,x:272.55,y:-2.8},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.1901,scaleY:0.2252,rotation:-2.7771,x:269.15,y:-3.25},0).wait(1).to({scaleX:0.2037,scaleY:0.2382,rotation:-2.7305,x:266.3,y:-4.2},0).wait(1).to({regX:104.7,regY:82,scaleX:0.2184,scaleY:0.2523,rotation:-2.6797,x:264.1,y:-5.9},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.2344,scaleY:0.2676,rotation:-2.6242,x:259.55,y:-5.3},0).wait(1).to({regX:104.7,regY:82,scaleX:0.2517,scaleY:0.2841,rotation:-2.5644,x:256.75,y:-5.95},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.2702,scaleY:0.3018,rotation:-2.5007,x:251.95,y:-3.25},0).wait(1).to({regX:104.8,regY:81.9,scaleX:0.2899,scaleY:0.3207,rotation:-2.4327,x:249.4,y:-1.75},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.3109,scaleY:0.3407,rotation:-2.3602,x:244.65,y:2.2},0).wait(1).to({regX:104.8,regY:81.8,scaleX:0.333,scaleY:0.3619,rotation:-2.2837,x:242.5,y:4.8},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.3562,scaleY:0.3841,rotation:-2.2041,x:238,y:10.05},0).wait(1).to({regX:105,regY:81.8,scaleX:0.3805,scaleY:0.4073,rotation:-2.121,x:236.65,y:13.7},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.4057,scaleY:0.4315,rotation:-2.0344,x:232.9,y:20.3},0).wait(1).to({regX:105,regY:81.8,scaleX:0.4317,scaleY:0.4563,rotation:-1.9449,y:25.1},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.4584,scaleY:0.4819,rotation:-1.853,x:230.6,y:32.45},0).wait(1).to({regX:105.1,regY:81.7,scaleX:0.4856,scaleY:0.5079,rotation:-1.7594,x:232.75,y:37.65},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.5132,scaleY:0.5343,rotation:-1.6649,x:231.7,y:45.45},0).wait(1).to({regX:105.2,regY:81.8,scaleX:0.541,scaleY:0.5609,rotation:-1.5698,x:235.7,y:50.9},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.5688,scaleY:0.5875,rotation:-1.4746,x:235.35,y:58.3},0).wait(1).to({regX:105.2,regY:81.8,scaleX:0.5965,scaleY:0.614,rotation:-1.38,x:240.85,y:62.95},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.6238,scaleY:0.6401,rotation:-1.2867,x:240.95,y:69.9},0).wait(1).to({regX:105.2,regY:81.9,scaleX:0.6506,scaleY:0.6657,rotation:-1.1952,x:247.35,y:74},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.6767,scaleY:0.6908,rotation:-1.1055,x:247.65,y:80.25},0).wait(1).to({regX:105.3,regY:81.9,scaleX:0.7021,scaleY:0.7151,rotation:-1.0185,x:254.7,y:83.5},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.7267,scaleY:0.7385,rotation:-0.9344,x:254.8,y:89.2},0).wait(1).to({regX:105.4,regY:82,scaleX:0.7502,scaleY:0.7611,rotation:-0.8535,x:262.35,y:91.85},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.7728,scaleY:0.7826,rotation:-0.776,x:262.15,y:96.9},0).wait(1).to({regX:105.4,regY:82,scaleX:0.7942,scaleY:0.8032,rotation:-0.7021,x:269.85,y:98.75},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.8146,scaleY:0.8226,rotation:-0.6326,x:269.25,y:103},0).wait(1).to({scaleX:0.8338,scaleY:0.841,rotation:-0.567,x:272.65,y:105.65},0).wait(1).to({regX:105.4,regY:82,scaleX:0.8518,scaleY:0.8582,rotation:-0.5053,x:280.35,y:106.4},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.8687,scaleY:0.8744,rotation:-0.4478,x:279.1,y:110.3},0).wait(1).to({regX:105.5,regY:82,scaleX:0.8844,scaleY:0.8894,rotation:-0.3942,x:286.85,y:110.7},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.899,scaleY:0.9034,rotation:-0.345,x:285.3,y:113.8},0).wait(1).to({regX:105.5,regY:82.2,scaleX:0.9125,scaleY:0.9162,rotation:-0.2996,x:293.25,y:113.45},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.9249,scaleY:0.9281,rotation:-0.2576,x:291.05,y:116.1},0).wait(1).to({scaleX:0.9362,scaleY:0.9389,rotation:-0.2192,x:293.5,y:117.1},0).wait(1).to({regX:105.5,regY:82.1,scaleX:0.9465,scaleY:0.9488,rotation:-0.1843,x:300.9,y:116.35},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.9558,scaleY:0.9577,rotation:-0.1526,x:297.85,y:118.65},0).wait(1).to({scaleX:0.9641,scaleY:0.9657,rotation:-0.1241,x:299.85,y:119.15},0).wait(1).to({regX:105.5,regY:82.1,scaleX:0.9715,scaleY:0.9727,rotation:-0.0989,x:306.85,y:117.95},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.978,scaleY:0.9789,rotation:-0.0762,x:303.35,y:120},0).wait(1).to({scaleX:0.9836,scaleY:0.9843,rotation:-0.0565,x:304.85,y:120.3},0).wait(1).to({regX:105.5,regY:82.2,scaleX:0.9884,scaleY:0.9889,rotation:-0.0398,x:311.5,y:118.85},0).wait(1).to({regX:100.1,regY:83.9,scaleX:0.9924,scaleY:0.9928,rotation:-0.0263,x:307.65,y:120.35},0).wait(1).to({scaleX:0.9957,scaleY:0.9959,rotation:-0.0154,x:308.8,y:120.25},0).wait(1).to({regX:105.6,regY:82.2,scaleX:0.9982,scaleY:0.9983,rotation:-0.007,x:315.2,y:118.5},0).to({regX:100,regY:84,scaleX:1,scaleY:1,rotation:0,x:311,y:120},1).to({_off:true},195).wait(11));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(176.9,-97.1,250.4,301.29999999999995);
...
}).prototype = getMCSymbolPrototype(lib.white_boxes, new cjs.Rectangle(60,-82.9,167,257.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.anim.name = "anim";
	this.anim.setTransform(200.4,191.45,0.67,0.67,0,0,0,364.8,151.2);
	...
	// Layer_2
	this.instance = new lib.Creators_bg_160x6001pngcopy();
	this.instance.setTransform(74.45,-10);
...
}).prototype = getMCSymbolPrototype(lib.bg_2, new cjs.Rectangle(23.5,-10,255,255), null);
...
if (reversed == null) { reversed = false; }
	...
	this.endUI.setTransform(127.5,357.5,1,1,0,0,0,125,94.5);
	...
	this.boxes.setTransform(14,448.45,1,1,0,0,0,75,125);
	...
	this.bg.name = "bg";
	this.bg.setTransform(54.55,357,1,1,0,0,0,136.3,106);
	...
	this.bg_1.name = "bg_1";
	this.bg_1.setTransform(80,300,0.5333,2.4,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-62.9,0,321.7,636.5), null);


// stage content:
(lib.M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {	
				...
				this.tl1.to(mc.bg,{duration:1.2, x: "-=100", alpha: 0, ease:Power4.easeInOut}, "+9.8");		
				this.tl1.from(box2,{duration:1, x: "+=165",  ease:Power4.easeOut}, ">-.8");
				this.tl1.from(box1,{duration:1, x: "+=165",  ease:Power4.easeOut}, ">-.8");					
				this.tl1.from(mc.endUI,{duration:1.2, x: "+=200",  ease:Power4.easeOut}, "<+0.5");	
...
p.nominalBounds = new cjs.Rectangle(17.1,300,241.70000000000002,336.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1633418163048", id:"M365_Creators_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
