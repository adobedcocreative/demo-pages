...
lib.ssMetadata = [
		{name:"M365_Editor_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[506,0,229,240],[506,295,60,62],[0,0,504,396],[506,242,121,51]]}
];
...
(lib.bg_img = function() {
	this.initialize(ss["M365_Editor_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.M365_Editor_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_Editor_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1634296188986", id:"M365_Editor_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
