...
lib.ssMetadata = [
		{name:"M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[223,741,221,174],[356,458,91,148],[0,0,376,282],[173,284,222,172],[0,284,171,282],[0,568,234,171],[236,458,118,176],[356,608,120,111],[0,741,221,175]]}
];
...
(lib.Excel = function() {
	this.initialize(ss["M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.ExcelMobile = function() {
	this.initialize(ss["M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(60.8,0,0.3982,0.3982);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(60.8,0,88.00000000000001,69.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-2.65,3.4,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PPTmob, new cjs.Rectangle(-2.6,3.4,35.4,52.800000000000004), null);


(lib.PhotosUImobile_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.PhotosUImobile();
	this.instance.setTransform(2.8,-0.85,0.39,0.39);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PhotosUImobile_1, new cjs.Rectangle(2.8,-0.8,66.7,110), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(31,-5,0.595,0.595);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PhotosUI, new cjs.Rectangle(31,-5,223.7,167.8), null);
...
}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(-17.8,-13.7,117.7,91.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.ExcelMobile();
	this.instance.setTransform(2.2,3.7,0.31,0.31);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ExcelMob, new cjs.Rectangle(2.2,3.7,28.2,45.9), null);


(lib.Excel_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(27.2,21.4,68.5,54.00000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgMkAu8MAAAhd3IZJAAMAAABd3g");
	this.shape.setTransform(80.475,300.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,161,600.8), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(0,0,161,600.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// 2 photosmob
	this.screen2 = new lib.PhotosUImobile_1();
	this.screen2.name = "screen2";
	this.screen2.setTransform(0,93.05,1,1,0,0,0,34.2,56.5);
	...
	this.bg = new lib.bg();
	this.bg.name = "bg";
	this.bg.setTransform(191,-80,1,1,0,0,0,150,125);
	...
	this.screen3.setTransform(151,-114.05,1,1,0,0,0,18.3,27.2);

	this.timeline.addTween(cjs.Tween.get(this.screen3).wait(1));

	// 4
	this.screen4 = new lib.Word_1();
	this.screen4.name = "screen4";
	this.screen4.setTransform(117.1,297.05,1.6298,1.6298,0,0,0,105.8,33.5);

	this.timeline.addTween(cjs.Tween.get(this.screen4).wait(1));

	// 5
	this.screen5 = new lib.Excel_1();
	this.screen5.name = "screen5";
	this.screen5.setTransform(158.4,214.05,1.1863,1.1863,0,0,0,61.5,48.4);

	this.timeline.addTween(cjs.Tween.get(this.screen5).wait(1));

	// 6
	this.screen6 = new lib.Outlook_1();
	this.screen6.name = "screen6";
	this.screen6.setTransform(167.05,-17.95,1.033,1.033,0,0,0,41.1,31.8);
	...
	this.screen7.setTransform(92,-97.95,1,1,0,0,0,37.8,57.6);
	...
	this.screen8.setTransform(96.9,206.55,1.2418,1.2418,0,0,0,16.4,26.7);

	this.timeline.addTween(cjs.Tween.get(this.screen8).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(-31.4,-205,270.5,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-27.2,3,0.7,0.6422,0,0,0,13.3,10.3);
	...
	this.shape.setTransform(-62.2481,2.2574,1.1545,1.53);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-116,-16.6,107.6,37.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(94).call(this.frame_94).wait(3).call(this.frame_97).wait(1).call(this.frame_98).wait(1));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EgOuBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_15 = new cjs.Graphics().p("EgO3BGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_16 = new cjs.Graphics().p("EgPTBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_17 = new cjs.Graphics().p("EgQCBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_18 = new cjs.Graphics().p("EgRDBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_19 = new cjs.Graphics().p("EgSXBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_20 = new cjs.Graphics().p("EgT9BGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_21 = new cjs.Graphics().p("EgVjBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_22 = new cjs.Graphics().p("EgWYBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_23 = new cjs.Graphics().p("EgWYBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_24 = new cjs.Graphics().p("EgWYBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_25 = new cjs.Graphics().p("EgWYBGlIAAoHMAsxAAAIAAIHg");
	var mask_graphics_26 = new cjs.Graphics().p("EgWYBGlIAAoHMAsxAAAIAAIHg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:192.3143,y:451.7458}).wait(1).to({graphics:mask_graphics_15,x:191.3837,y:451.7458}).wait(1).to({graphics:mask_graphics_16,x:188.592,y:451.7458}).wait(1).to({graphics:mask_graphics_17,x:183.9391,y:451.7458}).wait(1).to({graphics:mask_graphics_18,x:177.425,y:451.7458}).wait(1).to({graphics:mask_graphics_19,x:169.0498,y:451.7458}).wait(1).to({graphics:mask_graphics_20,x:158.8134,y:451.7458}).wait(1).to({graphics:mask_graphics_21,x:148.577,y:451.7458}).wait(1).to({graphics:mask_graphics_22,x:137.0906,y:451.7458}).wait(1).to({graphics:mask_graphics_23,x:124.0625,y:451.7458}).wait(1).to({graphics:mask_graphics_24,x:114.7567,y:451.7458}).wait(1).to({graphics:mask_graphics_25,x:109.1732,y:451.7458}).wait(1).to({graphics:mask_graphics_26,x:107.3657,y:451.7458}).wait(1).to({graphics:null,x:0,y:0}).wait(72));

	// Logo
	this.instance = new lib.MSFT_Logo_anim();
	this.instance.setTransform(-138.1,874.65,2.4082,2.4082,0,0,0,0.1,0.2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:34.8},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4387,scaleY:2.4387,x:-14.2,y:7.45},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgohCXyMAAAkvjMBRDAAAMAAAEvjg");
	this.shape.setTransform(72.2,904.55);

	this.instance_1 = new lib.MSFT_logo_sq();
	this.instance_1.setTransform(72.1,877.65,0.1455,0.1455,0,0,0,-39.9,2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:2.4082,scaleY:2.4082,x:72.05,y:877.5},13,cjs.Ease.quadOut).to({x:-61.85},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));
...
p.nominalBounds = new cjs.Rectangle(-188,-66.8,523.1,1955.2);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(56.8,563.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(171.55,560.25,1.136,1.136,0,0,0,0.2,0.2);
	...
	this.replay_btn.setTransform(143,4,0.3475,0.3475,0,0,180,-0.3,0);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-71.4,0,270.5,603.8), null);


// stage content:
(lib.M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.from(screen2, 1.3, { x: "-=0", y: "+=0", alpha: 0, ease:Power4.easeOut}, "-=1.3");
				exportRoot.tl1.from(screen3, 1.3, { x: "+=100", y: "-=90", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen4, 1.3, { x: "+=20", y: "+=130", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen5, 1.3, { x: "+=100", y: "+=20", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen6, 1.3, { x: "+=60", y: "-=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen7, 1.3, { x: "-=100", y: "+=10", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen8, 1.3, { x: "-=100", y: "-=10", alpha: 0, ease:Power4.easeOut}, "<+.1");		
				
				exportRoot.tl1.to(screen1, 1.3, { scaleX:.95, scaleY:.95, x: "+=47", y: "+=42",  ease:Power3.easeInOut}, "+=0.7");
				exportRoot.tl1.to(fade, 1.3, {alpha: 0.5, ease:Power3.easeInOut }, "<");
				exportRoot.tl1.to(screen2, 1.3, { scaleX:.95, scaleY:.95, x: "+=70", y: "+=35",  ease:Power3.easeInOut}, "<+.1");	
				exportRoot.tl1.to(screen3, 1.3, { scaleX:1, scaleY:1, x: "+=24", y: "+=114",  ease:Power3.easeInOut}, "<+.1");		
				exportRoot.tl1.to(screen4, 1.3, { scaleX:1.9, scaleY:1.9, x: "+=4", y: "+=42",  ease:Power3.easeInOut}, "<-.1");		
				exportRoot.tl1.to(screen5, 1.3, { scaleX:1.55, scaleY:1.55, x: "+=6", y: "+=33",  ease:Power3.easeInOut}, "<-.1");	
				exportRoot.tl1.to(screen6, 1.3, { scaleX:1, scaleY:1, x: "+=18", y: "+=77",  ease:Power3.easeInOut}, "<+.1");			
				exportRoot.tl1.to(screen7, 1.3, { x: "-=5", y: "+=130",  ease:Power3.easeInOut}, "<+.1");	
				exportRoot.tl1.to(screen8, 1.3, { x: "+=4", y: "+=30",  ease:Power3.easeInOut, onComplete:function(){exportRoot.rolloverReady = true;}}, "<+.1");					
						
			
				exportRoot.tl1.from(exportRoot.headline1, 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.3");	
				exportRoot.tl1.from(exportRoot.headline2, 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.6");		
			...
			exportRoot.tlRoll = gsap.timeline();
				...
				exportRoot.tlRoll.to(screen1, .4, { scaleX:1.1, scaleY:1.1, x:"-=0", y:"-=0", ease:Power3.easeInOut });	
				exportRoot.tlRoll.to(screen2, .4, { scaleX:1.08, scaleY:1.08, x:"-=12", y:"-=0", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen3, .4, { x:"+=1", y:"-=5", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen4, .4, { x:"-=0", y:"+=5", ease:Power3.easeInOut}, "<");	
				exportRoot.tlRoll.to(screen5, .4, { x:"+=0", y:"+=5", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen6, .4, { x:"+=0", y:"-=8", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen7, .4, { x:"-=1", y:"-=4", ease:Power2.easeInOut}, "<");
				exportRoot.tlRoll.to(screen8, .4, { x:"-=1", y:"+=5", ease:Power2.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(8.6,300,190.5,303.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1611939440759", id:"M365_OneDrive_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
