...
lib.ssMetadata = [
		{name:"M365_OneDriveDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[223,741,221,174],[356,458,91,148],[0,0,376,282],[173,284,222,172],[0,284,171,282],[0,568,234,171],[236,458,118,176],[356,608,120,111],[0,741,221,175]]}
];
...
(lib.Excel = function() {
	this.initialize(ss["M365_OneDriveDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen4.setTransform(44.65,242.45,1.7896,1.7896);
	...
	this.screen5.setTransform(158.5,214.1,0.6826,0.6826,0,0,0,61.6,48.4);
	...
	this.screen6.setTransform(167,-17.85,1.4604,1.4604,0,0,0,41.1,31.7);
	...
	this.screen8.setTransform(95.9,206.55,1.2418,1.2418,0,0,0,16.4,26.7);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.65,3.1,0.9014,0.827,0,0,0,13.4,10.5);
	...
	this.shape.setTransform(-65.2388,2.3482,1.2189,1.5691);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-122,-17,113.6,38.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(0,0,0.3087,0.3087);
	...
	this.txtCta.setTransform(50,563,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-71.4,-31.5,270.5,632.9), null);


// stage content:
(lib.M365_OneDriveDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
		    ...
		    exportRoot.tl1.to(screen4, 1.3, { scale:2.1, x: "-=9", y: "+=33",  ease:Power3.easeInOut}, "<-.1");
		    exportRoot.tl1.to(screen5, 1.3, { scale:.865, x: "+=6", y: "+=33",  ease:Power3.easeInOut}, "<-.1");
		    exportRoot.tl1.to(screen6, 1.3, { scale:1.43, x: "+=18", y: "+=77",  ease:Power3.easeInOut}, "<+.1");
		    exportRoot.tl1.to(screen7, 1.3, { x: "-=5", y: "+=130",  ease:Power3.easeInOut}, "<+.1");
		    exportRoot.tl1.to(screen8, 1.3, { x: "+=5", y: "+=30",  ease:Power3.easeInOut, onComplete:function(){exportRoot.rolloverReady = true;}}, "<+.1");
		    ...
		    exportRoot.tlRoll.to(screen2, .4, { scaleX:1.08, scaleY:1.08, x:"-=13", y:"-=0", ease:Power3.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(8.6,268.5,190.5,332.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_OneDriveDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635157902256", id:"M365_OneDriveDesktop_AUS_160x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
