...
lib.ssMetadata = [
		{name:"M365_AllUpIconsDesktop_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[291,0,163,154],[0,0,289,195],[160,197,106,96],[0,197,158,134],[291,156,162,137],[160,295,140,114]]}
];
...
(lib.ExcelIcon = function() {
	this.initialize(ss["M365_AllUpIconsDesktop_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.cta_arrowcopy, new cjs.Rectangle(-5.4,-4.1,11.2,8.3), null);
...
}).prototype = getMCSymbolPrototype(lib.arrowcopy, new cjs.Rectangle(0,0,11.3,8.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(149.9988,299.0021,1.875,0.9967);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,300,598), null);
...
if (reversed == null) { reversed = false; }
	...
	this.pptIcon.setTransform(0.8,600.8,0.55,0.55,0,0,0,81.7,69.8);
	...
	this.outlookIcon.setTransform(229.8,255.8,0.5985,0.5985,0,0,0,79.9,68.1);
	...
	this.oneNoteIcon.setTransform(81.05,126.7,0.67,0.67,0,0,0,53.9,47.1);
	...
	this.excelIcon.setTransform(176.8,518.85,0.5716,0.5716,0,0,0,82.2,78);
	...
	this.wordIcon.setTransform(-22.2,234.8,0.6173,0.6173,0,0,0,71.5,58.9);

	this.timeline.addTween(cjs.Tween.get(this.wordIcon).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(-66.3,95.2,342.90000000000003,542.5999999999999), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(0,0,300,598), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(71,39.05,0.75,0.75,0,0,0,0.1,0.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,300,598);


(lib.CTA_btncopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-15.35,3.95,0.7084,0.65,0,0,0,13.6,10.7);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AovDIIAAmPIRfAAIAAGPg");
	this.shape.setTransform(-54.4586,3.525,0.9915,0.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btncopy, new cjs.Rectangle(-109.9,-16,111,39.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// CTA
	this.txtCta = new lib.ctacopy();
	this.txtCta.name = "txtCta";
	this.txtCta.setTransform(228,547,1,1,0,0,0,0.7,0.1);

	this.timeline.addTween(cjs.Tween.get(this.txtCta).wait(1));

	// CTA_BG
	this.cta = new lib.CTA_btncopy();
	this.cta.name = "cta";
	this.cta.setTransform(299,543.5,1.136,1.136,0,0,0,0.2,0.2);
	...
	this.replay_btn.setTransform(282,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.anim.name = "anim";
	this.anim.setTransform(150.05,354.05,1,1,0,0,0,103.8,378.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-20,0,342.8,613), null);


// stage content:
(lib.M365_AllUpIconsDesktop_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		exportRoot.runBanner = function() {
		    ...
		    exportRoot.tlMain.from(mc.anim, 1.4, { y: "+=400", ease:Back.easeOut })
		        .from(mc.anim.oneNoteIcon, 1.5, { scaleX:.3, scaleY:.3, y: "+=160", ease:Back.easeOut }, "<+.1")
		        .from(mc.anim.oneNoteIcon, 1.5, { rotation:70, ease:Power2.easeOut }, "<")
		        .from(mc.anim.outlookIcon, 1.4, { scaleX:.3, scaleY:.3, x: "-=20", y: "+=180", ease:Back.easeOut }, "<+.1")
		        .from(mc.anim.outlookIcon, 1.4, { rotation:-50, ease:Power2.easeOut }, "<")
		        .from(mc.anim.wordIcon, 1.4, { scaleX:.3, scaleY:.3, x: "+=20", y: "+=160", ease:Back.easeOut }, "<")
		        .from(mc.anim.wordIcon, 1.4, { rotation:+40, ease:Power2.easeOut }, "<")
		        .from(mc.anim.excelIcon, 1.25, { scaleX:.3, scaleY:.3, x: "-=10", y: "+=360", ease:Back.easeOut }, "<+.1")
		        .from(mc.anim.excelIcon, 1.25, { rotation:-40, ease:Power2.easeOut }, "<")
		        .from(mc.anim.pptIcon, 1.25, { scaleX:.3, scaleY:.3, x: "+=10", y: "+=300", ease:Back.easeOut }, "<")
		        .from(mc.anim.pptIcon, 1.25, { rotation:-60, ease:Power2.easeOut }, "<")
		        .from(mc.anim.oneDriveIcon, 1.3, { scaleX:.25, scaleY:.25, y: "+=600", ease:Back.easeOut}, "<-.05")
		        .from(mc.anim.oneDriveIcon, 1.3, { rotation:+50, ease:Power2.easeOut }, "<");
		
		    exportRoot.tlMain.to(mc.anim, 1.4, { scale:.72, y: "+=22", ease:Power3.easeInOut})
		        .to(mc.anim.oneNoteIcon, 1.4, { x: "+=15", y: "+=34", ease:Power3.easeInOut}, "<")
		        //.to(mc.anim.outlookIcon, 1.4, { x: "+=0", y: "+=0", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.wordIcon, 1.4, { x: "-=20", y: "+=2", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.excelIcon, 1.4, { x: "+=2", y:"-=12", scale:0.5, ease:Power3.easeInOut}, "<")
		        .to(mc.anim.pptIcon, 1.4, { x: "+=6", y: "-=35", scale:.5, ease:Power3.easeInOut}, "<");
		
		
		    exportRoot.tlMain.from(exportRoot.headline1, 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=.8")
		        .from(exportRoot.headline2, 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut, stagger:0.05}, ">-.7");
		    ...
		    exportRoot.tlMain.from(mc.txtCta, 0.7, { alpha: 0, x: "+=100",	ease:Power4.easeOut}, "-=0.5")
		        ...
		        .from(mc.replay_btn, 0.7, { alpha: 0,ease:Power4.easeOut, onStart:function(){exportRoot.isReplay = true; exportRoot.rolloverReady = true;}}, "-=.6");
		    ...
		    exportRoot.tlRoll.to(mc.anim, .4, { scale:.74, ease:Power3.easeInOut })
		        .to(mc.anim.oneNoteIcon, .4, { scale:.62, x:"+=1", y:"-=3", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.outlookIcon, .4, { scale:.52, x:"+=3", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.wordIcon, .4, { scale:.53, x:"-=2", y:"-=1", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.excelIcon, .4, { scale:.52, x:"+=3", y:"+=5", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.pptIcon, .4, { scale:.49, x:"-=2", y:"+=1", ease:Power3.easeInOut}, "<")
		        .to(mc.anim.oneDriveIcon, .4, { scale:.8, ease:Power2.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(130,300,192.8,313);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_AllUpIconsDesktop_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635255073219", id:"M365_AllUpIconsDesktop_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
