...
lib.ssMetadata = [
		{name:"M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[729,270,43,57],[467,270,163,126],[467,0,347,268],[816,0,195,377],[632,270,95,82],[0,0,465,431]]}
];
...
(lib.Layer36 = function() {
	this.initialize(ss["M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.popupsmall = function() {
	this.initialize(ss["M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.womanTop_300x600pngcopy2 = function() {
	this.initialize(ss["M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.womanTop_300x600pngcopy2();
	this.instance.setTransform(50.8,-59.65,0.9308,0.9308);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.womanTop, new cjs.Rectangle(50.8,-59.6,432.9,401.20000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#CFCFCF","#D2D2D2"],[0,1],-456.5,-235.7,347.7,128.8).s().p("EgyUAtuMAAAhbbMBkpAAAMAAABbbg");
	this.shape.setTransform(322.125,292.575);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.image_BG, new cjs.Rectangle(0,0,644.3,585.2), null);


(lib.boxSigncopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.popupsmall();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.boxSigncopy, new cjs.Rectangle(0,0,163,126), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap1DXIAAmtITqAAIAAGtg");
	this.shape.setTransform(48.4,12.85);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.backCTA, new cjs.Rectangle(-14.5,-8.6,125.9,43), null);
...
(lib.woman_bg = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.bg.name = "bg";
	this.bg.setTransform(367.2,351.2,1,1,0,0,0,171.3,351.2);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.woman_bg, new cjs.Rectangle(195.9,0,644.3000000000001,585.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.bg_sub.setTransform(145,295.1,1,1,0,0,0,145,295.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.woman_bg();
...
p.nominalBounds = new cjs.Rectangle(44.5,-86,376.7,342.2);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-7.2,0.3,0.68,0.68,0,0,0,13.6,10.6);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.1,-22.2,125.89999999999999,43), null);
...
if (reversed == null) { reversed = false; }
	...
	this.boxSign.setTransform(-51.5,-120.15,0.5888,0.5906,0,0,0,15.5,46.1);
	this.boxSign.alpha = 0;
	this.boxSign._off = true;

	this.timeline.addTween(cjs.Tween.get(this.boxSign).wait(118).to({_off:false},0).wait(1).to({regX:69.9,regY:54,scaleX:0.6375,scaleY:0.6395,rotation:-2.6215,x:-14.8,y:-106.6,alpha:0.1857},0).wait(1).to({scaleX:0.6847,scaleY:0.6868,rotation:-5.1616,x:-10.4,y:-98.15,alpha:0.3656},0).wait(1).to({scaleX:0.7301,scaleY:0.7323,rotation:-7.6007,x:-6.1,y:-90.35,alpha:0.5383},0).wait(1).to({scaleX:0.7731,scaleY:0.7755,rotation:-9.9187,x:-2.2,y:-83.1,alpha:0.7025},0).wait(1).to({scaleX:0.8136,scaleY:0.8161,rotation:-12.0968,x:1.45,y:-76.45,alpha:0.8568},0).wait(1).to({regX:15.5,regY:46.1,scaleX:0.8512,scaleY:0.8538,rotation:-14.1192,x:-41.85,y:-65.75,alpha:1},0).wait(1).to({regX:69.9,regY:54,scaleX:0.8849,scaleY:0.8876,rotation:-15.9341,x:7.65,y:-65.2},0).wait(1).to({scaleX:0.9155,scaleY:0.9183,rotation:-17.5802,x:10.25,y:-60.55},0).wait(1).to({scaleX:0.943,scaleY:0.9458,rotation:-19.0573,x:12.55,y:-56.4},0).wait(1).to({scaleX:0.9674,scaleY:0.9703,rotation:-20.3708,x:14.55,y:-52.8},0).wait(1).to({scaleX:0.9889,scaleY:0.9919,rotation:-21.5299,x:16.2,y:-49.55},0).wait(1).to({scaleX:1.0078,scaleY:1.0109,rotation:-22.5466,x:17.7,y:-46.9},0).wait(1).to({scaleX:1.0243,scaleY:1.0274,rotation:-23.4342,x:18.95,y:-44.5},0).wait(1).to({scaleX:1.0386,scaleY:1.0418,rotation:-24.2066,x:20.05,y:-42.5},0).wait(1).to({scaleX:1.0511,scaleY:1.0543,rotation:-24.877,x:21,y:-40.75},0).wait(1).to({scaleX:1.0619,scaleY:1.0652,rotation:-25.4582,x:21.75,y:-39.2},0).wait(1).to({scaleX:1.0712,scaleY:1.0745,rotation:-25.9613,x:22.45,y:-38},0).wait(1).to({scaleX:1.0793,scaleY:1.0827,rotation:-26.3967,x:23.1,y:-36.85},0).wait(1).to({scaleX:1.0863,scaleY:1.0897,rotation:-26.7732,x:23.6,y:-35.85},0).wait(1).to({scaleX:1.0924,scaleY:1.0957,rotation:-27.0987,x:24,y:-35.1},0).wait(1).to({scaleX:1.0976,scaleY:1.101,rotation:-27.3799,x:24.4,y:-34.35},0).wait(1).to({scaleX:1.1021,scaleY:1.1055,rotation:-27.6228,x:24.7,y:-33.7},0).wait(1).to({scaleX:1.106,scaleY:1.1094,rotation:-27.8324,x:24.95,y:-33.2},0).wait(1).to({scaleX:1.1094,scaleY:1.1128,rotation:-28.0132,x:25.15,y:-32.7},0).wait(1).to({scaleX:1.1123,scaleY:1.1157,rotation:-28.1688,x:25.45,y:-32.35},0).wait(1).to({scaleX:1.1148,scaleY:1.1182,rotation:-28.3026,x:25.6,y:-32.05},0).wait(1).to({scaleX:1.1169,scaleY:1.1203,rotation:-28.4174,x:25.7,y:-31.75},0).wait(1).to({scaleX:1.1187,scaleY:1.1221,rotation:-28.5156,x:25.85,y:-31.5},0).wait(1).to({scaleX:1.1203,scaleY:1.1237,rotation:-28.5995,x:25.95,y:-31.25},0).wait(1).to({scaleX:1.1216,scaleY:1.125,rotation:-28.6708,x:26.05,y:-31.1},0).wait(1).to({scaleX:1.1227,scaleY:1.1262,rotation:-28.7311,x:26.15,y:-30.9},0).wait(1).to({scaleX:1.1237,scaleY:1.1271,rotation:-28.782,x:26.2,y:-30.8},0).wait(1).to({scaleX:1.1245,scaleY:1.1279,rotation:-28.8246,y:-30.75},0).wait(1).to({scaleX:1.1251,scaleY:1.1286,rotation:-28.86,x:26.3,y:-30.65},0).wait(1).to({scaleX:1.1257,scaleY:1.1291,rotation:-28.8893,x:26.35,y:-30.55},0).wait(1).to({scaleX:1.1261,scaleY:1.1296,rotation:-28.9132,y:-30.5},0).wait(1).to({scaleX:1.1265,scaleY:1.1299,rotation:-28.9325,y:-30.45},0).wait(1).to({scaleX:1.1267,scaleY:1.1302,rotation:-28.9479,x:26.4,y:-30.4},0).wait(1).to({scaleX:1.127,scaleY:1.1304,rotation:-28.9599},0).wait(1).to({scaleX:1.1271,scaleY:1.1306,rotation:-28.9692,x:26.45,y:-30.35},0).wait(1).to({scaleX:1.1273,scaleY:1.1307,rotation:-28.976,x:26.5},0).wait(1).to({scaleX:1.1274,scaleY:1.1308,rotation:-28.981,x:26.45},0).wait(1).to({scaleY:1.1309,rotation:-28.9844},0).wait(1).to({scaleX:1.1275,rotation:-28.9866},0).wait(1).to({scaleY:1.131,rotation:-28.9879},0).wait(1).to({rotation:-28.9886},0).wait(1).to({rotation:-28.9888},0).wait(1).to({regX:15.2,regY:45.9,x:-31.6,y:-8.4},0).wait(105).to({_off:true},1).wait(223));

	// boxSign copy
	this.boxSign_1 = new lib.boxSign();
	this.boxSign_1.name = "boxSign_1";
	this.boxSign_1.setTransform(-52.45,-129.1,0.186,0.186,45,0,0,15.6,46);
	this.boxSign_1.visible = false;

	this.boxSign_2 = new lib.boxSigncopy();
	this.boxSign_2.name = "boxSign_2";
	this.boxSign_2.setTransform(-51.9,-130.25,0.1596,0.1596,45,0,0,15.5,46.1);
	this.boxSign_2._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.boxSign_1}]}).to({state:[{t:this.boxSign_2}]},84).to({state:[{t:this.boxSign_2}]},13).to({state:[{t:this.boxSign_2}]},21).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},1).to({state:[{t:this.boxSign_2}]},105).to({state:[]},1).wait(223));
	this.timeline.addTween(cjs.Tween.get(this.boxSign_2).wait(84).to({_off:false},0).to({regX:15.3,regY:46,scaleX:0.5001,scaleY:0.5015,rotation:0,x:-53,y:-124.35},13,cjs.Ease.cubicOut).wait(22).to({regX:81.5,regY:63,scaleX:0.5423,scaleY:0.5439,rotation:-2.6219,x:-15.3,y:-106.7},0).wait(1).to({scaleX:0.5833,scaleY:0.5849,rotation:-5.1625,x:-10.85,y:-98.2},0).wait(1).to({scaleX:0.6226,scaleY:0.6244,rotation:-7.6021,x:-6.6,y:-90.25},0).wait(1).to({scaleX:0.6599,scaleY:0.6618,rotation:-9.9204,x:-2.6,y:-82.95},0).wait(1).to({scaleX:0.695,scaleY:0.697,rotation:-12.0989,x:1.05,y:-76.25},0).wait(1).to({regX:15.3,regY:45.9,scaleX:0.7276,scaleY:0.7297,rotation:-14.1217,x:-45.4,y:-70.5},0).wait(1).to({regX:81.5,regY:63,scaleX:0.7568,scaleY:0.7591,rotation:-15.937,x:7.35,y:-64.85,alpha:0.7551},0).wait(1).to({scaleX:0.7834,scaleY:0.7857,rotation:-17.5833,x:10,y:-60.15,alpha:0.533},0).wait(1).to({scaleX:0.8071,scaleY:0.8095,rotation:-19.0608,x:12.35,y:-56,alpha:0.3337},0).wait(1).to({scaleX:0.8283,scaleY:0.8307,rotation:-20.3745,x:14.35,y:-52.45,alpha:0.1564},0).wait(1).to({regX:15.2,regY:45.8,scaleX:0.847,scaleY:0.8495,rotation:-21.5338,x:-41.4,y:-42.25,alpha:0},0).wait(1).to({regX:81.5,regY:63,scaleX:0.8634,scaleY:0.8659,rotation:-22.5506,x:17.7,y:-46.5},0).wait(1).to({scaleX:0.8777,scaleY:0.8803,rotation:-23.4382,x:19.05,y:-44.15},0).wait(1).to({scaleX:0.8901,scaleY:0.8928,rotation:-24.2106,x:20.15,y:-42.15},0).wait(1).to({scaleX:0.901,scaleY:0.9036,rotation:-24.8812,x:21.15,y:-40.4},0).wait(1).to({scaleX:0.9103,scaleY:0.913,rotation:-25.4623,x:22,y:-38.9},0).wait(1).to({scaleX:0.9184,scaleY:0.9211,rotation:-25.9655,x:22.7,y:-37.65},0).wait(1).to({scaleX:0.9255,scaleY:0.9282,rotation:-26.4009,x:23.3,y:-36.5},0).wait(1).to({scaleX:0.9315,scaleY:0.9343,rotation:-26.7774,x:23.85,y:-35.55},0).wait(1).to({scaleX:0.9368,scaleY:0.9396,rotation:-27.1029,x:24.25,y:-34.7},0).wait(1).to({scaleX:0.9413,scaleY:0.9441,rotation:-27.3842,x:24.7,y:-34.05},0).wait(1).to({scaleX:0.9452,scaleY:0.948,rotation:-27.6271,x:25,y:-33.45},0).wait(1).to({scaleX:0.9486,scaleY:0.9514,rotation:-27.8368,x:25.3,y:-32.95},0).wait(1).to({scaleX:0.9515,scaleY:0.9543,rotation:-28.0175,x:25.55,y:-32.4},0).wait(1).to({scaleX:0.954,scaleY:0.9569,rotation:-28.1732,x:25.75,y:-32.05},0).wait(1).to({scaleX:0.9562,scaleY:0.959,rotation:-28.307,x:25.9,y:-31.75},0).wait(1).to({scaleX:0.958,scaleY:0.9609,rotation:-28.4218,x:26.05,y:-31.45},0).wait(1).to({scaleX:0.9596,scaleY:0.9625,rotation:-28.52,x:26.2,y:-31.2},0).wait(1).to({scaleX:0.961,scaleY:0.9638,rotation:-28.6039,x:26.3,y:-31.05},0).wait(1).to({scaleX:0.9621,scaleY:0.965,rotation:-28.6751,x:26.4,y:-30.8},0).wait(1).to({scaleX:0.9631,scaleY:0.9659,rotation:-28.7355,x:26.55,y:-30.7},0).wait(1).to({scaleX:0.9639,scaleY:0.9668,rotation:-28.7864,x:26.6,y:-30.55},0).wait(1).to({scaleX:0.9646,scaleY:0.9675,rotation:-28.829,x:26.65,y:-30.45},0).wait(1).to({scaleX:0.9652,scaleY:0.968,rotation:-28.8644,x:26.7,y:-30.35},0).wait(1).to({scaleX:0.9657,scaleY:0.9685,rotation:-28.8937,x:26.75,y:-30.3},0).wait(1).to({scaleX:0.966,scaleY:0.9689,rotation:-28.9176,x:26.7,y:-30.2},0).wait(1).to({scaleX:0.9664,scaleY:0.9692,rotation:-28.9369,x:26.8},0).wait(1).to({scaleX:0.9666,scaleY:0.9695,rotation:-28.9523,y:-30.15},0).wait(1).to({scaleX:0.9668,scaleY:0.9696,rotation:-28.9643,x:26.85},0).wait(1).to({scaleX:0.9669,scaleY:0.9698,rotation:-28.9736,y:-30.1},0).wait(1).to({scaleX:0.9671,scaleY:0.9699,rotation:-28.9805,y:-30.05},0).wait(1).to({scaleY:0.97,rotation:-28.9854,y:-30.1},0).wait(1).to({scaleX:0.9672,rotation:-28.9889},0).wait(1).to({scaleY:0.9701,rotation:-28.9911},0).wait(1).to({scaleX:0.9673,rotation:-28.9923,y:-30.05},0).wait(1).to({rotation:-28.993},0).wait(1).to({rotation:-28.9932},0).wait(1).to({regX:15.2,regY:45.9,x:-37.3,y:-13.6},0).wait(105).to({_off:true},1).wait(223));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-99,-187.3,224.4,248.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mainAnim_Build).wait(190).to({startPosition:190},0).wait(1).to({regX:26.7,regY:-42.9,scaleX:0.998,scaleY:0.998,rotation:0.0844,x:176.7,y:82.2,alpha:0.9255,startPosition:191},0).wait(1).to({scaleX:0.9943,scaleY:0.9943,rotation:0.2415,x:176.75,y:82.35,alpha:0.8519,startPosition:192},0).wait(1).to({scaleX:0.9887,scaleY:0.9887,rotation:0.4815,y:82.65,alpha:0.78,startPosition:193},0).wait(1).to({scaleX:0.9808,scaleY:0.9808,rotation:0.8162,x:176.8,y:83.1,alpha:0.7107,startPosition:194},0).wait(1).to({scaleX:0.9703,scaleY:0.9703,rotation:1.2597,y:83.6,alpha:0.6447,startPosition:195},0).wait(1).to({scaleX:0.9569,scaleY:0.9569,rotation:1.8286,x:176.9,y:84.25,alpha:0.5826,startPosition:196},0).wait(1).to({scaleX:0.9401,scaleY:0.9401,rotation:2.5421,y:85.05,alpha:0.5248,startPosition:197},0).wait(1).to({scaleX:0.9193,scaleY:0.9193,rotation:3.4215,x:176.95,y:86.05,alpha:0.4715,startPosition:198},0).wait(1).to({scaleX:0.8941,scaleY:0.8941,rotation:4.4881,x:177,y:87.1,alpha:0.4225,startPosition:199},0).wait(1).to({scaleX:0.8642,scaleY:0.8642,rotation:5.7601,y:88.35,alpha:0.3779,startPosition:200},0).wait(1).to({scaleX:0.8292,scaleY:0.8292,rotation:7.2444,y:89.65,alpha:0.3373,startPosition:201},0).wait(1).to({scaleX:0.7895,scaleY:0.7895,rotation:8.9262,x:176.9,y:90.95,alpha:0.3005,startPosition:202},0).wait(1).to({scaleX:0.7462,scaleY:0.7462,rotation:10.7601,x:176.85,y:92.2,alpha:0.2672,startPosition:203},0).wait(1).to({scaleX:0.7012,scaleY:0.7012,rotation:12.6705,x:176.65,y:93.3,alpha:0.2371,startPosition:204},0).wait(1).to({scaleX:0.6564,scaleY:0.6564,rotation:14.5691,x:176.5,y:94.15,alpha:0.2098,startPosition:205},0).wait(1).to({scaleX:0.6137,scaleY:0.6137,rotation:16.3796,x:176.25,y:94.75,alpha:0.1852,startPosition:206},0).wait(1).to({scaleX:0.5742,scaleY:0.5742,rotation:18.0522,x:176.15,y:95.15,alpha:0.163,startPosition:207},0).wait(1).to({scaleX:0.5385,scaleY:0.5385,rotation:19.565,x:176,y:95.3,alpha:0.143,startPosition:208},0).wait(1).to({scaleX:0.5067,scaleY:0.5067,rotation:20.9153,x:175.85,y:95.4,alpha:0.1249,startPosition:209},0).wait(1).to({scaleX:0.4785,scaleY:0.4785,rotation:22.1115,x:175.75,y:95.35,alpha:0.1086,startPosition:210},0).wait(1).to({scaleX:0.4536,scaleY:0.4536,rotation:23.167,x:175.65,y:95.2,alpha:0.094,startPosition:211},0).wait(1).to({scaleX:0.4317,scaleY:0.4317,rotation:24.0959,x:175.5,y:95.05,alpha:0.0808,startPosition:212},0).wait(1).to({scaleX:0.4124,scaleY:0.4124,rotation:24.9121,y:94.9,alpha:0.069,startPosition:213},0).wait(1).to({scaleX:0.3955,scaleY:0.3955,rotation:25.6281,x:175.45,y:94.7,alpha:0.0585,startPosition:214},0).wait(1).to({scaleX:0.3808,scaleY:0.3808,rotation:26.2551,x:175.4,y:94.5,alpha:0.0491,startPosition:215},0).wait(1).to({scaleX:0.3678,scaleY:0.3678,rotation:26.8026,x:175.35,y:94.35,alpha:0.0407,startPosition:216},0).wait(1).to({scaleX:0.3566,scaleY:0.3566,rotation:27.2791,y:94.15,alpha:0.0334,startPosition:217},0).wait(1).to({scaleX:0.3469,scaleY:0.3469,rotation:27.6916,y:93.95,alpha:0.0269,startPosition:218},0).wait(1).to({scaleX:0.3385,scaleY:0.3385,rotation:28.0464,x:175.4,y:93.85,alpha:0.0213,startPosition:219},0).wait(1).to({scaleX:0.3314,scaleY:0.3314,rotation:28.3489,x:175.35,y:93.7,alpha:0.0164,startPosition:220},0).wait(1).to({scaleX:0.3253,scaleY:0.3253,rotation:28.6037,x:175.4,y:93.6,alpha:0.0123,startPosition:221},0).wait(1).to({scaleX:0.3204,scaleY:0.3204,rotation:28.8151,x:175.3,y:93.45,alpha:0.0088,startPosition:222},0).wait(1).to({scaleX:0.3163,scaleY:0.3163,rotation:28.9866,x:175.4,alpha:0.006,startPosition:223},0).wait(1).to({scaleX:0.3131,scaleY:0.3131,rotation:29.1213,x:175.35,y:93.3,alpha:0.0038,startPosition:224},0).wait(1).to({scaleX:0.3108,scaleY:0.3108,rotation:29.2222,alpha:0.0021,startPosition:225},0).wait(1).to({scaleX:0.3091,scaleY:0.3091,rotation:29.2916,alpha:0.0009,startPosition:226},0).wait(1).to({scaleX:0.3082,scaleY:0.3082,rotation:29.3318,y:93.25,alpha:0.0002,startPosition:227},0).wait(1).to({regX:-44.6,regY:-36.5,scaleX:0.3079,scaleY:0.3079,rotation:29.3448,x:155,y:84.1,alpha:0,startPosition:220},0).wait(16).to({startPosition:236},0).to({_off:true},1).wait(35));

	// endUi copy 2
	this.instance = new lib.uiEnd();
	this.instance.setTransform(99.95,100.75,0.5119,0.5119,-28.7468,0,0,138.9,269.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(190).to({_off:false},0).wait(1).to({regX:213,regY:273,rotation:-28.6641,x:134.3,y:84.2,alpha:0.0029},0).wait(1).to({rotation:-28.5101,x:134.55,y:84.3,alpha:0.0082},0).wait(1).to({scaleX:0.5117,scaleY:0.5117,rotation:-28.275,x:134.95,y:84.45,alpha:0.0164},0).wait(1).to({scaleX:0.5116,scaleY:0.5116,rotation:-27.9472,x:135.45,y:84.65,alpha:0.0278},0).wait(1).to({scaleX:0.5114,scaleY:0.5114,rotation:-27.5127,x:136.2,y:84.9,alpha:0.0429},0).wait(1).to({scaleX:0.5112,scaleY:0.5112,rotation:-26.9554,x:137.1,y:85.2,alpha:0.0623},0).wait(1).to({scaleX:0.5109,scaleY:0.5109,rotation:-26.2564,x:138.3,y:85.55,alpha:0.0866},0).wait(1).to({scaleX:0.5106,scaleY:0.5106,rotation:-25.395,x:139.7,y:86,alpha:0.1166},0).wait(1).to({scaleX:0.5101,scaleY:0.5101,rotation:-24.3501,x:141.4,y:86.6,alpha:0.1529},0).wait(1).to({scaleX:0.5096,scaleY:0.5096,rotation:-23.104,x:143.45,y:87.35,alpha:0.1963},0).wait(1).to({scaleX:0.509,scaleY:0.509,rotation:-21.65,x:145.7,y:88.25,alpha:0.2469},0).wait(1).to({scaleX:0.5083,scaleY:0.5083,rotation:-20.0024,x:148.35,y:89.15,alpha:0.3042},0).wait(1).to({scaleX:0.5076,scaleY:0.5076,rotation:-18.2059,x:151.1,y:90.25,alpha:0.3667},0).wait(1).to({scaleX:0.5068,scaleY:0.5068,rotation:-16.3345,x:154,y:91.3,alpha:0.4318},0).wait(1).to({scaleX:0.506,scaleY:0.506,rotation:-14.4745,x:156.8,y:92.4,alpha:0.4965},0).wait(1).to({scaleX:0.5053,scaleY:0.5053,rotation:-12.7009,x:159.55,y:93.45,alpha:0.5582},0).wait(1).to({scaleX:0.5046,scaleY:0.5046,rotation:-11.0624,x:161.95,y:94.45,alpha:0.6152},0).wait(1).to({scaleX:0.504,scaleY:0.504,rotation:-9.5805,x:164.1,y:95.3,alpha:0.6667},0).wait(1).to({scaleX:0.5034,scaleY:0.5034,rotation:-8.2577,x:166,y:96.1,alpha:0.7127},0).wait(1).to({scaleX:0.5029,scaleY:0.5029,rotation:-7.0858,x:167.7,y:96.8,alpha:0.7535},0).wait(1).to({scaleX:0.5025,scaleY:0.5025,rotation:-6.0519,x:169.15,y:97.4,alpha:0.7895},0).wait(1).to({scaleX:0.5021,scaleY:0.5021,rotation:-5.1419,x:170.45,y:97.95,alpha:0.8211},0).wait(1).to({scaleX:0.5018,scaleY:0.5018,rotation:-4.3424,x:171.5,y:98.45,alpha:0.8489},0).wait(1).to({scaleX:0.5015,scaleY:0.5015,rotation:-3.6409,x:172.55,y:98.85,alpha:0.8733},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,rotation:-3.0267,x:173.35,y:99.2,alpha:0.8947},0).wait(1).to({scaleX:0.501,scaleY:0.501,rotation:-2.4903,x:174.1,y:99.5,alpha:0.9134},0).wait(1).to({scaleX:0.5008,scaleY:0.5008,rotation:-2.0236,x:174.8,y:99.85,alpha:0.9296},0).wait(1).to({scaleX:0.5007,scaleY:0.5007,rotation:-1.6195,x:175.3,y:100.05,alpha:0.9437},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,rotation:-1.2719,x:175.85,y:100.25,alpha:0.9558},0).wait(1).to({scaleX:0.5004,scaleY:0.5004,rotation:-0.9756,x:176.15,y:100.45,alpha:0.9661},0).wait(1).to({scaleX:0.5003,scaleY:0.5003,rotation:-0.7259,x:176.55,y:100.55,alpha:0.9747},0).wait(1).to({scaleX:0.5002,scaleY:0.5002,rotation:-0.5188,x:176.85,y:100.7,alpha:0.982},0).wait(1).to({rotation:-0.3509,x:177.1,y:100.8,alpha:0.9878},0).wait(1).to({scaleX:0.5001,scaleY:0.5001,rotation:-0.2189,x:177.2,y:100.85,alpha:0.9924},0).wait(1).to({rotation:-0.1201,x:177.35,y:100.95,alpha:0.9958},0).wait(1).to({scaleX:0.5,scaleY:0.5,rotation:-0.0521,x:177.45,alpha:0.9982},0).wait(1).to({rotation:-0.0127,x:177.55,y:101,alpha:0.9996},0).wait(1).to({regX:139,regY:269,rotation:0,x:140.5,y:99.1,alpha:1},0).wait(16).to({_off:true},1).wait(35));

	// endUi
	this.instance_1 = new lib.uiEnd_map();
	this.instance_1.setTransform(223,308.8,0.5119,0.5119,-28.7468,0,0,138.9,269.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).wait(1).to({regX:138.6,regY:277.6,rotation:-28.7466,x:215.25,y:296.35,alpha:0.261},0).wait(1).to({rotation:-28.7464,x:205.9,y:280.45,alpha:0.5155},0).wait(1).to({rotation:-28.7462,x:196.8,y:265,alpha:0.7623},0).wait(1).to({regX:139,regY:269.4,rotation:-28.7461,x:186.15,y:246.35,alpha:1},0).wait(1).to({regX:138.6,regY:277.6,x:180.2,y:237},0).wait(1).to({rotation:-28.7462,x:172.8,y:224.5},0).wait(1).to({x:165.85,y:212.8},0).wait(1).to({rotation:-28.7463,x:159.4,y:201.85},0).wait(1).to({x:153.4,y:191.75},0).wait(1).to({rotation:-28.7464,x:147.9,y:182.45},0).wait(1).to({x:142.85,y:173.95},0).wait(1).to({rotation:-28.7465,x:138.3,y:166.25},0).wait(1).to({x:134.2,y:159.3},0).wait(1).to({x:130.55,y:153.1},0).wait(1).to({rotation:-28.7466,x:127.25,y:147.5},0).wait(1).to({x:124.3,y:142.5},0).wait(1).to({x:121.7,y:138.1},0).wait(1).to({x:119.35,y:134.15},0).wait(1).to({x:117.3,y:130.65},0).wait(1).to({x:115.45,y:127.55},0).wait(1).to({rotation:-28.7467,x:113.8,y:124.75},0).wait(1).to({x:112.35,y:122.3},0).wait(1).to({x:111.05,y:120.15},0).wait(1).to({x:109.95,y:118.25},0).wait(1).to({x:108.9,y:116.5},0).wait(1).to({x:108.05,y:115},0).wait(1).to({x:107.25,y:113.65},0).wait(1).to({x:106.55,y:112.5},0).wait(1).to({x:105.9,y:111.45},0).wait(1).to({x:105.35,y:110.5},0).wait(1).to({x:104.9,y:109.7},0).wait(1).to({x:104.45,y:109},0).wait(1).to({x:104.1,y:108.35},0).wait(1).to({x:103.75,y:107.8},0).wait(1).to({x:103.45,y:107.3},0).wait(1).to({x:103.2,y:106.85},0).wait(1).to({x:103,y:106.5},0).wait(1).to({x:102.8,y:106.2},0).wait(1).to({x:102.65,y:105.9},0).wait(1).to({x:102.5,y:105.65},0).wait(1).to({x:102.35,y:105.45},0).wait(1).to({x:102.25,y:105.25},0).wait(1).to({x:102.15,y:105.1},0).wait(1).to({x:102.1,y:105},0).wait(1).to({x:102.05,y:104.9},0).wait(1).to({x:102,y:104.8},0).wait(1).to({x:101.95,y:104.75},0).wait(1).to({x:101.9,y:104.7},0).wait(1).to({rotation:-28.7468,y:104.65},0).wait(1).to({x:101.85,y:104.6},0).wait(1).to({y:104.55},0).wait(3).to({x:101.8},0).wait(1).to({y:104.5},0).wait(3).to({regX:138.9,regY:269.2,x:99.95,y:100.75},0).wait(13).to({regX:138.6,regY:277.6,rotation:-28.6641,x:102,y:104.55},0).wait(1).to({rotation:-28.5101,x:102.2},0).wait(1).to({scaleX:0.5117,scaleY:0.5117,rotation:-28.275,x:102.5},0).wait(1).to({scaleX:0.5116,scaleY:0.5116,rotation:-27.9472,x:102.95,y:104.5},0).wait(1).to({scaleX:0.5114,scaleY:0.5114,rotation:-27.5127,x:103.55},0).wait(1).to({scaleX:0.5112,scaleY:0.5112,rotation:-26.9554,x:104.3,y:104.55},0).wait(1).to({scaleX:0.5109,scaleY:0.5109,rotation:-26.2564,x:105.25,y:104.45},0).wait(1).to({scaleX:0.5106,scaleY:0.5106,rotation:-25.395,x:106.4},0).wait(1).to({scaleX:0.5101,scaleY:0.5101,rotation:-24.3501,x:107.8,y:104.4},0).wait(1).to({scaleX:0.5096,scaleY:0.5096,rotation:-23.104,x:109.45},0).wait(1).to({scaleX:0.509,scaleY:0.509,rotation:-21.65,x:111.4},0).wait(1).to({scaleX:0.5083,scaleY:0.5083,rotation:-20.0024,x:113.6,y:104.3},0).wait(1).to({scaleX:0.5076,scaleY:0.5076,rotation:-18.2059,x:115.95,y:104.25},0).wait(1).to({scaleX:0.5068,scaleY:0.5068,rotation:-16.3345,x:118.45,y:104.15},0).wait(1).to({scaleX:0.506,scaleY:0.506,rotation:-14.4745,x:120.95,y:104.05},0).wait(1).to({scaleX:0.5053,scaleY:0.5053,rotation:-12.7009,x:123.35,y:104},0).wait(1).to({scaleX:0.5046,scaleY:0.5046,rotation:-11.0624,x:125.55,y:103.9},0).wait(1).to({scaleX:0.504,scaleY:0.504,rotation:-9.5805,x:127.55,y:103.8},0).wait(1).to({scaleX:0.5034,scaleY:0.5034,rotation:-8.2577,x:129.25},0).wait(1).to({scaleX:0.5029,scaleY:0.5029,rotation:-7.0858,x:130.85,y:103.7},0).wait(1).to({scaleX:0.5025,scaleY:0.5025,rotation:-6.0519,x:132.2,y:103.65},0).wait(1).to({scaleX:0.5021,scaleY:0.5021,rotation:-5.1419,x:133.45,y:103.6},0).wait(1).to({scaleX:0.5018,scaleY:0.5018,rotation:-4.3424,x:134.5},0).wait(1).to({scaleX:0.5015,scaleY:0.5015,rotation:-3.6409,x:135.45,y:103.55},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,rotation:-3.0267,x:136.3,y:103.5},0).wait(1).to({scaleX:0.501,scaleY:0.501,rotation:-2.4903,x:137,y:103.45},0).wait(1).to({scaleX:0.5008,scaleY:0.5008,rotation:-2.0236,x:137.6},0).wait(1).to({scaleX:0.5007,scaleY:0.5007,rotation:-1.6195,x:138.15},0).wait(1).to({scaleX:0.5005,scaleY:0.5005,rotation:-1.2719,x:138.65,y:103.35},0).wait(1).to({scaleX:0.5004,scaleY:0.5004,rotation:-0.9756,x:139},0).wait(1).to({scaleX:0.5003,scaleY:0.5003,rotation:-0.7259,x:139.35,y:103.3},0).wait(1).to({scaleX:0.5002,scaleY:0.5002,rotation:-0.5188,x:139.65},0).wait(1).to({rotation:-0.3509,x:139.85,y:103.35},0).wait(1).to({scaleX:0.5001,scaleY:0.5001,rotation:-0.2189,x:140.05,y:103.3},0).wait(1).to({rotation:-0.1201,x:140.15},0).wait(1).to({scaleX:0.5,scaleY:0.5,rotation:-0.0521,x:140.25},0).wait(1).to({rotation:-0.0127,x:140.35},0).wait(1).to({regX:139,regY:269,rotation:0,x:140.5,y:99.1},0).wait(16).to({_off:true},1).wait(35));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-29,-54.5,390,532.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.buildZoom}]}).to({state:[{t:this.instance}]},109).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(109).to({_off:false},0).wait(1).to({regX:163.4,regY:208.6,x:164.4,y:208.6,startPosition:110},0).wait(1).to({startPosition:111},0).wait(1).to({startPosition:112},0).wait(1).to({startPosition:113},0).wait(1).to({startPosition:114},0).wait(1).to({startPosition:115},0).wait(1).to({startPosition:116},0).wait(1).to({startPosition:117},0).wait(1).to({startPosition:118},0).wait(1).to({startPosition:119},0).wait(1).to({startPosition:120},0).wait(1).to({startPosition:121},0).wait(1).to({startPosition:122},0).wait(1).to({startPosition:123},0).wait(1).to({startPosition:124},0).wait(1).to({startPosition:125},0).wait(1).to({startPosition:126},0).wait(1).to({startPosition:127},0).wait(1).to({startPosition:128},0).wait(1).to({startPosition:129},0).wait(1).to({startPosition:130},0).wait(1).to({startPosition:131},0).wait(1).to({startPosition:132},0).wait(1).to({startPosition:133},0).wait(1).to({startPosition:134},0).wait(1).to({startPosition:135},0).wait(1).to({startPosition:136},0).wait(1).to({startPosition:137},0).wait(1).to({regX:91.5,regY:58.5,x:92.5,y:58.5,startPosition:138},0).wait(1).to({regX:163.4,regY:208.6,x:164.4,y:208.6,startPosition:139},0).wait(1).to({startPosition:140},0).wait(1).to({startPosition:141},0).wait(1).to({startPosition:142},0).wait(1).to({startPosition:143},0).wait(1).to({startPosition:144},0).wait(1).to({startPosition:145},0).wait(1).to({startPosition:146},0).wait(1).to({startPosition:147},0).wait(1).to({startPosition:148},0).wait(1).to({startPosition:149},0).wait(1).to({startPosition:150},0).wait(1).to({startPosition:151},0).wait(1).to({startPosition:152},0).wait(1).to({startPosition:153},0).wait(1).to({startPosition:154},0).wait(1).to({startPosition:155},0).wait(1).to({startPosition:156},0).wait(1).to({startPosition:157},0).wait(1).to({startPosition:158},0).wait(1).to({startPosition:159},0).wait(1).to({startPosition:160},0).wait(1).to({startPosition:161},0).wait(1).to({startPosition:162},0).wait(1).to({startPosition:163},0).wait(1).to({startPosition:164},0).wait(1).to({startPosition:165},0).wait(1).to({startPosition:166},0).wait(1).to({startPosition:167},0).wait(1).to({startPosition:168},0).wait(1).to({startPosition:169},0).wait(1).to({startPosition:170},0).wait(1).to({startPosition:171},0).wait(1).to({startPosition:172},0).wait(1).to({startPosition:173},0).wait(1).to({startPosition:174},0).wait(1).to({startPosition:175},0).wait(1).to({startPosition:176},0).wait(1).to({startPosition:177},0).wait(1).to({startPosition:178},0).wait(1).to({startPosition:179},0).wait(1).to({startPosition:180},0).wait(1).to({startPosition:181},0).wait(1).to({startPosition:182},0).wait(1).to({startPosition:183},0).wait(1).to({startPosition:184},0).wait(1).to({startPosition:185},0).wait(1).to({startPosition:186},0).wait(1).to({startPosition:187},0).wait(1).to({startPosition:188},0).wait(1).to({startPosition:189},0).wait(1).to({startPosition:190},0).wait(1).to({startPosition:191},0).wait(1).to({startPosition:192},0).wait(1).to({startPosition:193},0).wait(1).to({startPosition:194},0).wait(1).to({startPosition:195},0).wait(1).to({startPosition:196},0).wait(1).to({startPosition:197},0).wait(1).to({startPosition:198},0).wait(1).to({startPosition:199},0).wait(1).to({startPosition:200},0).wait(1).to({startPosition:201},0).wait(1).to({startPosition:202},0).wait(1).to({startPosition:203},0).wait(1).to({startPosition:204},0).wait(1).to({startPosition:205},0).wait(1).to({startPosition:206},0).wait(1).to({startPosition:207},0).wait(1).to({startPosition:208},0).wait(1).to({startPosition:209},0).wait(1).to({startPosition:210},0).wait(1).to({startPosition:211},0).wait(1).to({startPosition:212},0).wait(1).to({startPosition:213},0).wait(1).to({startPosition:214},0).wait(1).to({startPosition:215},0).wait(1).to({startPosition:216},0).wait(1).to({startPosition:217},0).wait(1).to({startPosition:218},0).wait(1).to({startPosition:219},0).wait(1).to({regX:91.5,regY:58.5,x:92.5,y:58.5,startPosition:220},0).wait(25));

	// Layer_2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A4NXIMAAAguPMAwbAAAMAAAAuPg");
	mask.setTransform(153.025,107.025);
	...
	var maskedShapeInstanceList = [this.womanTop];
	...
	this.mainAnim_Build.name = "mainAnim_Build";
	this.mainAnim_Build.setTransform(119.4,51.15,1.0358,1.0358,0,0,0,-45.4,-36.1);

	var maskedShapeInstanceList = [this.mainAnim_Build];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.mainAnim_Build).wait(116).to({startPosition:98},0).to({regX:-45.5,regY:-36.2,scaleX:0.75,scaleY:0.75,rotation:-27.6943,x:120.85,y:144.8,alpha:0},22,cjs.Ease.quadOut).wait(107));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28,-54.5,390,521.6);
...
if (reversed == null) { reversed = false; }
	...
	this.logoSmall.setTransform(80.35,40.1,0.746,0.746,0,0,0,15.5,1.4);
	...
	this.txtCta.setTransform(227.4,548.1,1,1,0,0,0,36.3,-0.3);
	...
	this.cta.name = "cta";
	this.cta.setTransform(241.25,547.35,1,1,0,0,0,-49.1,0);
	...
	this.animation.setTransform(148.8,368.4,1,1,0,0,0,148.8,146.8);
	...
	this.bg.name = "bg";
	this.bg.setTransform(83.35,349.4,0.7987,0.7987,0,0,0,149.8,125.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.9,0,309.9,600.9), null);


// stage content:
(lib.M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {	
				...
				this.tl1.from(animation,{duration:3,  ease:Power4.easeOut, onStart:function(){mc.animation.play(0);}}, ">+2");
				
		
				
				this.tl1.from(exportRoot.headline1,{duration:0.8, x: "+=100", alpha: 0, stagger: 0.1, ease:Power4.easeOut}, "<-1.8");
				this.tl1.from(exportRoot.headline2,{duration:0.8, x: "+=100", alpha: 0, stagger: 0.1, ease:Power4.easeOut}, ">-.6");
...
p.nominalBounds = new cjs.Rectangle(148.1,300,159.9,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1633966083083", id:"M365_FSDriveReports_AUS_300x600_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
