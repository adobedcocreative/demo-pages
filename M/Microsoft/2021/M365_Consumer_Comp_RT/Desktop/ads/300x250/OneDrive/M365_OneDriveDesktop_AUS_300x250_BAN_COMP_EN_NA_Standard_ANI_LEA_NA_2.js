...
lib.ssMetadata = [
		{name:"M365_OneDriveDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[774,0,221,174],[671,177,91,148],[0,0,376,282],[774,176,222,172],[378,0,171,282],[551,177,118,176],[106,284,120,111],[551,0,221,175],[0,284,104,171]]}
];
...
(lib.Excel = function() {
	this.initialize(ss["M365_OneDriveDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(40,2.5,0.5426,0.5426);
...
if (reversed == null) { reversed = false; }
	...
	this.screen1.setTransform(149.45,125.4,0.95,0.95,0,0,0,113,84.7);
	...
	this.screen2.setTransform(69.85,122.85,1,1,0,0,0,34.2,56.4);
	...
	this.screen3.setTransform(32.95,201.9,1,1,0,0,0,18.3,27.2);
	...
	this.screen4.setTransform(110.95,214.85,1,1,0,0,0,39.8,31.5);
	...
	this.screen5.setTransform(253,233,1,1,0,0,0,61.5,48.4);
	...
	this.screen6.setTransform(248.5,34.25,1,1,0,0,0,41.1,31.8);
	...
	this.screen7.setTransform(158.8,13.2,1,1,0,0,0,33.8,55.6);
	...
	this.screen8.setTransform(27,63.05,1,1,0,0,0,16.4,26.7);

	this.timeline.addTween(cjs.Tween.get(this.screen8).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(0,-42.4,314.5,323.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-14.35,2.95,0.7084,0.65,0,0,0,13.6,10.7);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoTC9IAAl4IQnAAIAAF4g");
	this.shape.setTransform(-52.225,1.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-105.4,-16.9,106.4,37.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4387,scaleY:2.4387,x:-11.2,y:7.45},33,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(17,213.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.95,210.5,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.1,-42.4,315.6,323.9), null);


// stage content:
(lib.M365_OneDriveDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.from(screen1, 1.3, { y: "+=150", alpha: 0, ease:Power4.easeOut}, "+=0");
				exportRoot.tl1.from(screen2, 1.3, { x: "-=150", y: "+=10", alpha: 0, ease:Power4.easeOut}, "-=1.3");
				exportRoot.tl1.from(screen3, 1.3, { x: "-=130", y: "+=90", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen4, 1.3, { x: "-=100", y: "+=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen5, 1.3, { x: "+=100", y: "+=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen6, 1.3, { x: "+=100", y: "-=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen7, 1.3, { x: "+=10", y: "-=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen8, 1.3, { x: "-=100", y: "-=10", alpha: 0, ease:Power4.easeOut}, "<+.1");		
				
				exportRoot.tl1.to(screen1, 1.3, { x: "+=100", y: "+=35",  ease:Power3.easeInOut}, "+=0.7");
				exportRoot.tl1.to(fade, 1.3, {alpha: 0.5, ease:Power3.easeInOut }, "<");
				exportRoot.tl1.to(screen2, 1.3, { x: "+=100", y: "+=35",  ease:Power3.easeInOut}, "<+.1");	
				exportRoot.tl1.to(screen3, 1.3, { x: "+=95", y: "+=25",  ease:Power3.easeInOut}, "<+.1");		
				exportRoot.tl1.to(screen4, 1.3, { x: "+=90", y: "+=30",  ease:Power3.easeInOut}, "<-.1");		
				exportRoot.tl1.to(screen5, 1.3, { x: "+=45", y: "+=20", scaleX:.8, scaleY:.8, ease:Power3.easeInOut}, "<-.1");	
				exportRoot.tl1.to(screen6, 1.3, { x: "+=30", y: "+=60",  ease:Power3.easeInOut}, "<+.1");			
				exportRoot.tl1.to(screen7, 1.3, { x: "+=13", y: "+=85", scaleX:.45, scaleY:.45, ease:Power3.easeInOut}, "<+.1");	
				exportRoot.tl1.to(screen8, 1.3, { x: "+=95", y: "+=100",  ease:Power3.easeInOut, onComplete:function(){exportRoot.rolloverReady = true;}}, "<+.1");
			...
			exportRoot.tlRoll = gsap.timeline();
				...
				exportRoot.tlRoll.to(screen1, .4, { scaleX:1.02, scaleY:1.02, x:"-=0", y:"-=0", ease:Power3.easeInOut });	
				exportRoot.tlRoll.to(screen2, .4, { scaleX:1.06, scaleY:1.06, x:"-=5", y:"-=0", ease:Power3.easeInOut}, "<");
				...
				exportRoot.tlRoll.to(screen7, .4, { x:"-=4", y:"-=4", ease:Power2.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(148.9,82.6,165.6,198.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_OneDriveDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635247214159", id:"M365_OneDriveDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
