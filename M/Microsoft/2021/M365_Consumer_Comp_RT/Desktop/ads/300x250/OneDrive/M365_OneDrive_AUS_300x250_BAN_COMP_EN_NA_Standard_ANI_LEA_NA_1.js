...
lib.ssMetadata = [
		{name:"M365_OneDrive_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[774,0,221,174],[671,177,91,148],[0,0,376,282],[774,176,222,172],[378,0,171,282],[551,177,118,176],[106,284,120,111],[551,0,221,175],[0,284,104,171]]}
];
...
(lib.Excel = function() {
	this.initialize(ss["M365_OneDrive_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.M365_OneDrive_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_OneDrive_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1611938565566", id:"M365_OneDrive_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
