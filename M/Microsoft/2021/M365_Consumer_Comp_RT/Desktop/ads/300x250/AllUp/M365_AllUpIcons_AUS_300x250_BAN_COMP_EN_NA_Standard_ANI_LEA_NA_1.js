...
lib.ssMetadata = [
		{name:"M365_AllUpIcons_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[291,0,163,154],[0,0,289,195],[160,197,106,96],[0,197,158,134],[291,156,162,137],[160,295,140,114]]}
];
...
(lib.ExcelIcon = function() {
	this.initialize(ss["M365_AllUpIcons_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.M365_AllUpIcons_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		exportRoot.runBanner = function() {
			...
			exportRoot.tlMain = gsap.timeline();
				...
				exportRoot.tlMain.from(mc.anim.oneDriveIcon, 1.3, { scaleX:.25, scaleY:.25, y: "+=300", ease:Back.easeOut, onComplete:function(){exportRoot.rolloverReady = true;}}, "<-.05");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_AllUpIcons_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1611934568018", id:"M365_AllUpIcons_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
