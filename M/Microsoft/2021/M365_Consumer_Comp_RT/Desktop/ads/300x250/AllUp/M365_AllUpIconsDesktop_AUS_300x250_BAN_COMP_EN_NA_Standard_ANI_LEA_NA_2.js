...
lib.ssMetadata = [
		{name:"M365_AllUpIconsDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[291,0,163,154],[0,0,289,195],[160,197,106,96],[0,197,158,134],[291,156,162,137],[160,295,140,114]]}
];
...
(lib.ExcelIcon = function() {
	this.initialize(ss["M365_AllUpIconsDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.pptIcon.setTransform(81.95,187.85,0.35,0.35,0,0,0,81.9,69.5);
	...
	this.outlookIcon.setTransform(231.5,86.55,0.35,0.35,0,0,0,79.7,67.7);
	...
	this.oneNoteIcon.setTransform(173.5,36.25,0.42,0.42,0,0,0,53.5,49.1);
	...
	this.excelIcon.setTransform(222,188,0.33,0.33,0,0,0,82,77.6);
	...
	this.wordIcon.setTransform(82.5,63.5,0.41,0.41,0,0,0,71.6,58.4);

	this.timeline.addTween(cjs.Tween.get(this.wordIcon).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(53.2,15.7,205.7,197.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoYC+IAAl7IQxAAIAAF7g");
	this.shape.setTransform(-52.725,3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-106.4,-16,107.4,38), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(42.5,212.4,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.95,209.5,1.136,1.136,0,0,0,0.2,0.2);
	...
	this.anim.name = "anim";
	this.anim.setTransform(85,62,0.8,0.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-2.1,0,302.1,250), null);


// stage content:
(lib.M365_AllUpIconsDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		exportRoot.runBanner = function() {
			...
			exportRoot.tlRoll = gsap.timeline();
				...
				exportRoot.tlRoll.to(mc.anim, .4, { scaleX:.82, scaleY:.82, x:"-=3", y:"-=3", ease:Power3.easeInOut });	
...
p.nominalBounds = new cjs.Rectangle(147.9,125,152.1,125);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_AllUpIconsDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635254902818", id:"M365_AllUpIconsDesktop_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
