// JavaScript Document
	...
	bannerData.headline1 = ["<#505050>Make the|most of|your time","18.3px",167,43,"20","350", "left"];
	bannerData.headline2 = ["<#505050>Build better habits|behind the wheel with|Microsoft Family Safety*","12.2px",167,110,"14","50", "left"];
	bannerData.headline3 = ["<#505050>*App available free; Microsoft 365 |Family subscription unlocks |premium features","7px",167, 161,"8","350", "left"];
