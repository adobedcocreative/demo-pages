...
lib.ssMetadata = [
		{name:"M365_Outlook_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[602,0,300,250],[0,0,600,500],[602,454,152,116],[602,252,284,82],[602,336,161,116],[602,665,301,47],[602,572,172,91],[842,398,107,39],[765,398,75,69],[756,469,188,26],[765,336,89,60],[0,502,600,500]]}
];
...
(lib.stairsScene_bg111 = function() {
	this.initialize(ss["M365_Outlook_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.instance_11 = new lib.stairsScene_bg111();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(175,150.05,0.5,0.5,0,0,0,350,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(77).to({x:151},35,cjs.Ease.quartInOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-24,0,324,250);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-13.45,-7.9,0.85,0.85,0,0,0,13.6,10.7);
	...
	this.cta_glare.setTransform(-84.9,-1.25,1,1,0,0,0,57.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_glare).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("ArEDmIAAnMIWJAAIAAHMg");
	this.shape.setTransform(-49.8,-8.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-120.6,-31.3,141.7,46.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(236.85,219.65);
	...
	this.cta.name = "cta";
	this.cta.setTransform(282.2,219.8,0.9433,0.9433);
	...
	this.logoSmall.setTransform(216.35,23.85,0.746,0.746,0,0,0,15.5,1.4);
	...
	this.bgSide.setTransform(225,125,0.5,1,0,0,0,150,125);
	...
	this.stairAnimation.setTransform(350,300,1,1,0,0,0,350,300);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.9,0,303.09999999999997,252.1), null);


// stage content:
(lib.M365_Outlook_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149.1,125,153.1,127.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_Outlook_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1611963599200", id:"M365_Outlook_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
