...
lib.ssMetadata = [
		{name:"M365_Editor_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[0,398,360,305],[485,398,60,62],[0,0,504,396],[362,398,121,51]]}
];
...
(lib.bgimage = function() {
	this.initialize(ss["M365_Editor_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(21.2162,21.2162,0.3866,0.3866);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_1.setTransform(6.6113,21.2162,0.3866,0.3866);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_2.setTransform(21.2162,6.6113,0.3866,0.3866);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_3.setTransform(6.6113,6.6113,0.3866,0.3866);
	...
	this.shape_5.setTransform(167.1293,14.0539,0.3866,0.3866);
	...
	this.shape_6.setTransform(154.9215,13.9089,0.3866,0.3866);
	...
	this.shape_7.setTransform(142.4625,13.9089,0.3866,0.3866);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-13.4,-2.4,315.5,257.5), null);


// stage content:
(lib.M365_Editor_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_Editor_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1634296007870", id:"M365_Editor_AUS_300x250_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
