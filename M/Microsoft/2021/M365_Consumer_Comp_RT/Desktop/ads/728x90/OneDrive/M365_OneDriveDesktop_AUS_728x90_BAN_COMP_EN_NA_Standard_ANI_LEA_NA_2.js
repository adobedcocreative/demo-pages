...
lib.ssMetadata = [
		{name:"M365_OneDriveDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[619,174,204,153],[396,0,221,174],[502,176,91,148],[619,0,222,172],[0,0,171,282],[843,0,118,176],[173,177,120,111],[173,0,221,175],[396,176,104,171]]}
];
...
(lib.Bitmap1 = function() {
	this.initialize(ss["M365_OneDriveDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.WordMob, new cjs.Rectangle(0,0,67.6,111.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(0,0,79.6,63), null);
...
}).prototype = getMCSymbolPrototype(lib.PPTmob, new cjs.Rectangle(0,0,36.6,54.6), null);
...
}).prototype = getMCSymbolPrototype(lib.PhotosUImobile_1, new cjs.Rectangle(0,0,68.4,112.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(40,2.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PhotosUI, new cjs.Rectangle(40,2.5,204,153), null);
...
}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(0,0,82.2,63.7), null);
...
}).prototype = getMCSymbolPrototype(lib.ExcelMob, new cjs.Rectangle(0,0,32.8,53.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.5566,0.5566);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(0,0,123,96.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg4tAHCIAAuDMBxbAAAIAAODg");
	this.shape.setTransform(363,45);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,726,90), null);
...
}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(0,0,726,90), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen1.setTransform(386.45,76,0.8746,0.8746,0,0,0,113,84.8);
	...
	this.screen2.setTransform(296.95,51.8,0.9111,0.9111,0,0,0,34.3,56.4);
	...
	this.screen3.setTransform(99.85,80.2,1.5371,1.5371,0,0,0,18.4,27.4);
	...
	this.screen5.setTransform(690.05,74.75,1.0986,1.0986,0,0,0,61.5,48.4);
	...
	this.screen6.setTransform(194.85,96.45,1.7592,1.7592,0,0,0,41.1,31.9);
	...
	this.screen7.setTransform(524,110,0.9763,0.9763,0,0,0,33.8,55.6);
	...
	this.screen4.setTransform(588.1,4.85,2.1117,2.1117,0,0,0,39.8,31.6);
	...
	this.screen8.setTransform(205.05,6.1,1.8762,1.8762,0,0,0,16.4,26.7);

	this.timeline.addTween(cjs.Tween.get(this.screen8).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(0,-61.9,757.7,226.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-25.35,2.55,0.7084,0.65,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnLB7IAAj1IOXAAIAAD1g");
	this.shape.setTransform(-55.7139,1.5096,1.0359,1.4235);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.3,-16,95.2,35.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(90).call(this.frame_90).wait(8).call(this.frame_98).wait(1));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("EArYAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_15 = new cjs.Graphics().p("EArJAJYIAAtjMBKuAAAIAANjg");
	var mask_graphics_16 = new cjs.Graphics().p("EAqaAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_17 = new cjs.Graphics().p("EApMAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_18 = new cjs.Graphics().p("EAngAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_19 = new cjs.Graphics().p("EAlUAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_20 = new cjs.Graphics().p("EAipAJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_21 = new cjs.Graphics().p("Af+JYIAAtjMBKvAAAIAANjg");
	var mask_graphics_22 = new cjs.Graphics().p("AdzJYIAAtjMBKuAAAIAANjg");
	var mask_graphics_23 = new cjs.Graphics().p("AcGJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_24 = new cjs.Graphics().p("Aa4JYIAAtjMBKvAAAIAANjg");
	var mask_graphics_25 = new cjs.Graphics().p("AaKJYIAAtjMBKvAAAIAANjg");
	var mask_graphics_26 = new cjs.Graphics().p("AZ6JYIAAtjMBKvAAAIAANjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:755.8967,y:59.9518}).wait(1).to({graphics:mask_graphics_15,x:754.344,y:59.9518}).wait(1).to({graphics:mask_graphics_16,x:749.6858,y:59.9518}).wait(1).to({graphics:mask_graphics_17,x:741.9221,y:59.9518}).wait(1).to({graphics:mask_graphics_18,x:731.0529,y:59.9518}).wait(1).to({graphics:mask_graphics_19,x:717.0782,y:59.9518}).wait(1).to({graphics:mask_graphics_20,x:699.9981,y:59.9518}).wait(1).to({graphics:mask_graphics_21,x:682.9179,y:59.9518}).wait(1).to({graphics:mask_graphics_22,x:668.9432,y:59.9518}).wait(1).to({graphics:mask_graphics_23,x:658.074,y:59.9518}).wait(1).to({graphics:mask_graphics_24,x:650.3103,y:59.9518}).wait(1).to({graphics:mask_graphics_25,x:645.6521,y:59.9518}).wait(1).to({graphics:mask_graphics_26,x:644.1217,y:59.9518}).wait(1).to({graphics:null,x:0,y:0}).wait(72));

	// Logo
	this.instance = new lib.MSFT_Logo_anim();
	this.instance.setTransform(639.25,71.85,4.0184,4.0184,0,0,0,0.1,0.2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:927.95},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4387,scaleY:2.4387,x:-14.2,y:7.45},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.instance_1 = new lib.MSFT_logo_sq();
	this.instance_1.setTransform(990.3,76.75,0.2428,0.2428,0,0,0,-39.6,2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:4.0184,scaleY:4.0184,x:990.2,y:76.7},13,cjs.Ease.quadOut).to({x:766.7},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));
...
p.nominalBounds = new cjs.Rectangle(-188,-64,2359.4,292.5);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(636.6,55.15,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(738.15,52.55,1.136,1.136,0,0,0,0.2,0.2);
	...
	this.replay_btn.setTransform(711.25,4.3,0.3475,0.3475,0,0,180,-0.3,0);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-61.9,757.7,226.1), null);


// stage content:
(lib.M365_OneDriveDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.from(screen1, 1.3, { y: "+=100", alpha: 0, ease:Power4.easeOut}, "+=0");
				exportRoot.tl1.from(screen2, 1.3, { x: "-=5", y: "+=100", alpha: 0, ease:Power4.easeOut}, "-=1.2");
				exportRoot.tl1.from(screen3, 1.3, { x: "-=150", y: "+=10", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen4, 1.3, { x: "+=200", y: "-=100", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen5, 1.3, { x: "+=100", y: "+=20", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen6, 1.3, { x: "-=20", y: "+=60", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen7, 1.3, { x: "+=5", y: "+=80", alpha: 0, ease:Power4.easeOut}, "<+.1");
				exportRoot.tl1.from(screen8, 1.3, { x: "-=20", y: "-=50", alpha: 0, ease:Power4.easeOut}, "<+.1");		
				
				exportRoot.tl1.to(screen2, 1.3, { x: "-=126", y: "-=7", scaleX:0.6, scaleY:0.6, ease:Power3.easeInOut}, "+=0.7");
				exportRoot.tl1.to(fade, 1.3, {alpha: 0.5, ease:Power3.easeInOut }, "<");
				exportRoot.tl1.to(screen1, 1.3, { x: "-=170", y: "-=30", scaleX:0.57, scaleY:0.57, ease:Power3.easeInOut}, "<+.1");
				exportRoot.tl1.to(screen3, 1.3, { x: "+=55", y: "+=5", scaleX:1.1, scaleY:1.1,  ease:Power3.easeInOut}, "<+.1");		
				exportRoot.tl1.to(screen4, 1.3, { x: "-=310", y: "+=8",  scaleX:1.2, scaleY:1.2, ease:Power3.easeInOut}, "<-.1");		
				exportRoot.tl1.to(screen5, 1.3, { x: "-=405", y: "+=0", scaleX:.8, scaleY:.8, ease:Power3.easeInOut}, "<-.1");	
				exportRoot.tl1.to(screen6, 1.3, { x: "-=30", y: "-=80", scaleX:1.1, scaleY:1.1,  ease:Power3.easeInOut}, "<+.1");			
				exportRoot.tl1.to(screen7, 1.3, { x: "+=20", y: "+=100", scaleX:.45, scaleY:.45, ease:Power3.easeInOut}, "<+.1");	
				exportRoot.tl1.to(screen8, 1.3, { x: "-=20", y: "-=150",  ease:Power3.easeInOut, onComplete:function(){exportRoot.rolloverReady = true;}}, "<+.1");					
							
			
				exportRoot.tl1.from(exportRoot.headline1, 0.8, { x: "+=50", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.8");	
				exportRoot.tl1.from(exportRoot.headline2, 0.8, { x: "+=50", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.6");		
			...
			exportRoot.tlRoll = gsap.timeline();
				...
				exportRoot.tlRoll.to(screen1, .4, { scaleX:0.65, scaleY:0.65, x:"-=0", y:"-=0", ease:Power3.easeInOut });	
				exportRoot.tlRoll.to(screen2, .4, { scaleX:0.65, scaleY:0.65, x:"-=5", y:"-=0", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen3, .4, { x:"-=5", y:"+=5", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen4, .4, { x:"+=5", y:"-=5", ease:Power3.easeInOut}, "<");	
				exportRoot.tlRoll.to(screen5, .4, { x:"+=2", y:"+=5", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen6, .4, { x:"-=2", y:"-=5", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(screen7, .4, { x:"-=1", y:"-=4", ease:Power2.easeInOut}, "<");
				exportRoot.tlRoll.to(screen8, .4, { x:"-=5", y:"+=0", ease:Power2.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(364,-16.9,393.70000000000005,181.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_OneDriveDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1634635075745", id:"M365_OneDriveDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
