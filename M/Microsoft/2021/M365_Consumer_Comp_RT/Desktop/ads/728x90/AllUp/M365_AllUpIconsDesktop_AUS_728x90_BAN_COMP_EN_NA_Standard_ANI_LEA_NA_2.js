...
lib.ssMetadata = [
		{name:"M365_AllUpIconsDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[291,0,163,154],[0,0,289,195],[160,197,106,96],[0,197,158,134],[291,156,162,137],[160,295,140,114]]}
];
...
(lib.ExcelIcon = function() {
	this.initialize(ss["M365_AllUpIconsDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.oneDriveIcon.setTransform(151.05,115.45,0.38,0.38,0,0,0,144.9,98.5);
	...
	this.pptIcon.setTransform(-149,143.1,0.35,0.35,0,0,0,81.9,69.5);
	...
	this.outlookIcon.setTransform(343.25,87.85,0.35,0.35,0,0,0,79.7,67.7);
	...
	this.oneNoteIcon.setTransform(173.5,40.25,0.42,0.42,0,0,0,53.5,49.1);
	...
	this.excelIcon.setTransform(459,129.4,0.35,0.35,0,0,0,82.2,77.7);
	...
	this.wordIcon.setTransform(-15.75,93.6,0.36,0.36,0,0,0,71.4,58.6);

	this.timeline.addTween(cjs.Tween.get(this.wordIcon).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ScreensAnim, new cjs.Rectangle(-177.6,19.7,664.9,147.10000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.anim.name = "anim";
	this.anim.setTransform(363.95,45.05,0.8,0.8,0,0,0,152.2,115.7);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-31.7,728,121.7), null);


// stage content:
(lib.M365_AllUpIconsDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		exportRoot.runBanner = function() {
			...
			exportRoot.tlMain = gsap.timeline();
				...
				exportRoot.tlMain.from(mc.anim, 1.4, { y: "+=200", ease:Back.easeOut });	
				exportRoot.tlMain.from(mc.anim.oneNoteIcon, 1.5, { scaleX:.3, scaleY:.3, y: "+=80", ease:Back.easeOut }, "<+.1");
				exportRoot.tlMain.from(mc.anim.oneNoteIcon, 1.5, { rotation:70, ease:Power2.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.outlookIcon, 1.4, { scaleX:.3, scaleY:.3, x: "-=20", y: "+=90", ease:Back.easeOut }, "<+.1");
				exportRoot.tlMain.from(mc.anim.outlookIcon, 1.4, { rotation:-50, ease:Power2.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.wordIcon, 1.4, { scaleX:.3, scaleY:.3, x: "+=20", y: "+=80", ease:Back.easeOut }, "<");	
				exportRoot.tlMain.from(mc.anim.wordIcon, 1.4, { rotation:+40, ease:Power2.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.excelIcon, 1.25, { scaleX:.3, scaleY:.3, x: "-=10", y: "+=180", ease:Back.easeOut }, "<+.1");
				exportRoot.tlMain.from(mc.anim.excelIcon, 1.25, { rotation:-40, ease:Power2.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.pptIcon, 1.25, { scaleX:.3, scaleY:.3, x: "+=10", y: "+=150", ease:Back.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.pptIcon, 1.25, { rotation:-60, ease:Power2.easeOut }, "<");
				exportRoot.tlMain.from(mc.anim.oneDriveIcon, 1.3, { scaleX:.25, scaleY:.25, y: "+=300", ease:Back.easeOut}, "<-.05");
				exportRoot.tlMain.from(mc.anim.oneDriveIcon, 1.3, { rotation:+50, ease:Power2.easeOut }, "<");
		
				exportRoot.tlMain.to(mc.anim, 1.4, { scaleX:.58, scaleY:.58, x: "-=149", y: "-=0", ease:Power3.easeInOut});	
			    exportRoot.tlMain.to(mc.anim.oneNoteIcon, 1.4, { scaleX:.46, scaleY:.46, x: "-=20", y: "+=3", ease:Power3.easeInOut}, "<");
				exportRoot.tlMain.to(mc.anim.outlookIcon, 1.4, { scaleX:.38, scaleY:.38, x: "-=98", y: "-=0", ease:Power3.easeInOut}, "<");
				exportRoot.tlMain.to(mc.anim.wordIcon, 1.4, { scaleX:.38, scaleY:.38, x: "+=88", y: "-=13", ease:Power3.easeInOut}, "<");	
				exportRoot.tlMain.to(mc.anim.excelIcon, 1.4, { scaleX:.39, scaleY:.39, x: "-=220", y: "+=48", ease:Power3.easeInOut}, "<");
				exportRoot.tlMain.to(mc.anim.pptIcon, 1.4, { scaleX:.38, scaleY:.38, x: "+=215", y: "+=40", ease:Power3.easeInOut}, "<");
				
				exportRoot.tlMain.from(exportRoot.headline1, 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=.6");	
				...
				exportRoot.tlMain.from(mc.replay_btn, 0.7, { alpha: 0,ease:Power4.easeOut, onStart:function(){exportRoot.isReplay = true; exportRoot.rolloverReady = true;}}, "-=.6");	
			...
			exportRoot.tlRoll = gsap.timeline();
				...
				exportRoot.tlRoll.to(mc.anim, .4, { scaleX:.62, scaleY:.62, x:"+=2", ease:Power3.easeInOut });	
				exportRoot.tlRoll.to(mc.anim.oneNoteIcon, .4, { scaleX:.38, scaleY:.38, x:"+=1", y:"-=3", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(mc.anim.outlookIcon, .4, { scaleX:.33, scaleY:.33, x:"+=3", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(mc.anim.wordIcon, .4, { scaleX:.38, scaleY:.38, x:"-=2", y:"-=1", ease:Power3.easeInOut}, "<");	
				exportRoot.tlRoll.to(mc.anim.excelIcon, .4, { scaleX:.31, scaleY:.31, x:"+=1", y:"+=2", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(mc.anim.pptIcon, .4, { scaleX:.33, scaleY:.33, x:"-=2", y:"+=1", ease:Power3.easeInOut}, "<");
				exportRoot.tlRoll.to(mc.anim.oneDriveIcon, .4, { scaleX:.45, scaleY:.45, ease:Power2.easeInOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(364,13.3,364,76.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_AllUpIconsDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1635268962723", id:"M365_AllUpIconsDesktop_AUS_728x90_BAN_COMP_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
