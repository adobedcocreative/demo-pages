...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,413,792]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup2();
	this.instance_1.setTransform(0,0,1.2999,1.2929);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,536.9,1024), null);
...
p.nominalBounds = new cjs.Rectangle(256,512,256.20000000000005,512);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606905406572", id:"screen4_atlas_1"}
	],
	preloads: []
};
