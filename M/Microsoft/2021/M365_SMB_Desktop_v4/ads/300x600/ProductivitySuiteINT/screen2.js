...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,413,792]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.MaskGroup21();
	this.instance.setTransform(0,0,1.3015,1.2929);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,537.5,1024), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,538.4,1024), null);
...
p.nominalBounds = new cjs.Rectangle(256,512,281.5,512);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606905331499", id:"screen2_atlas_1"}
	],
	preloads: []
};
