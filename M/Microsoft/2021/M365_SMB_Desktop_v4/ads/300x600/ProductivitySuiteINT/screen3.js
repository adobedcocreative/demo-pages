...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,413,792]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(110.45,45.45,1.45,1.4999,0,0,0,0.3,0.3);
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup1();
	this.instance_1.setTransform(0,0,1.3012,1.2931);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,537.4,1024.1), null);
...
p.nominalBounds = new cjs.Rectangle(256,512,256.70000000000005,512.0999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606905366822", id:"screen3_atlas_1"}
	],
	preloads: []
};
