...
lib.ssMetadata = [
		{name:"foreground_atlas_1", frames: [[0,0,1327,1319]]}
];
...
(lib._160x600FG = function() {
	this.initialize(ss["foreground_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// 300x600 FG.png
	this.instance = new lib._160x600FG();
...
}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(0,0,663.5,659.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-31.5,0.95,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnJByIAAjjIOTAAIAADjg");
	this.shape.setTransform(-61.7,0.525);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-107.4,-10.8,91.5,22.700000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(16,16.3,0.7742,0.7742,0,0,0,0,0.4);
	...
	this.replay_btn.setTransform(143.7,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(38.6,570.65,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(115.25,569.75,1.2127,1.2127,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// BG
	this.foreground = new lib.Bg();
	this.foreground.name = "foreground";
	this.foreground.setTransform(-336.3,76,1,1,0,0,0,150.5,124.8);

	this.timeline.addTween(cjs.Tween.get(this.foreground).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-486.8,-48.8,663.5,659.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var mc = exportRoot1.mainMC
		exportRoot1.replayAnim = "inProgress"
		
		this.initBanner = function (data) {
			
			exportRoot1.isReplay = false;
			exportRoot1.shadowReplay = false;
			...
			var keys = Object.keys(data)
				...
				for (var i in keys) {
					var id = keys[i].substr(0, 4);
						if (id == "head") {
							exportRoot1['' + keys[i]] = new Array()
							exportRoot1.fillHead(data[keys[i]], exportRoot1['' + keys[i]])
						} else if (id == "CTA" && data[keys[i]].length > 1) {
							exportRoot1.fillCta(data[keys[i]])
						} else if (id == "CTAa") {
		...
		this.fillHead = function (txtDetails, aVar) {
			...
			for (var i = 0; i < aSentenceLine.length; i++) {
				...
				exportRoot1.mainMC.txt.addChild(mc);
				aVar.push(mc)
			}
		}
		...
		this.runBanner = function() {
				...
				exportRoot1.tlMain = gsap.timeline({defaults: {ease:Power4.easeOut}});
				
				exportRoot1.tlMain.from(exportRoot1.headline1,{duration:0.8, y: "+=60", alpha: 0, onStart:function(){tlBg.restart(); tlCube.restart();}}, "+=.2");
				exportRoot1.tlMain.to(exportRoot1.headline1,{duration:0.6, y: "-=20", alpha: 0,ease:Power3.easeIn}, "+=7.6");
				
				exportRoot1.tlMain.from(exportRoot1.headline2,{duration:0.8, x: "-=100", alpha: 0, stagger: 0.1 }, "+=0");	
				exportRoot1.tlMain.from(exportRoot1.headline3,{duration:0.8, x: "-=100", alpha: 0, stagger: 0.1 }, "-=.5");
		
				exportRoot1.tlMain.from(mc.cta, { duration: 0.6, x: "-=150"}, "-=0.3");
				exportRoot1.tlMain.from(mc.txtCta, { duration: 0.6, x: "-=150"}, "-=0.6");
				exportRoot1.tlMain.from(mc.replay_btn, { alpha: 0, onStart:function(){exportRoot1.isReplay = true;}}, "-=0.6");
...
p.nominalBounds = new cjs.Rectangle(-406.7,251.3,583.5,359.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/foreground_atlas_1.png?1606923474105", id:"foreground_atlas_1"}
	],
	preloads: []
};
