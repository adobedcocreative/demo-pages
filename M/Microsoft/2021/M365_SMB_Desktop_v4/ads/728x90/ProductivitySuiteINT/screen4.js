...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,945,117]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0,-1,1.0836,1.094);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-1,1024,129), null);
...
p.nominalBounds = new cjs.Rectangle(512,63,512,66.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606910473884", id:"screen4_atlas_1"}
	],
	preloads: []
};
