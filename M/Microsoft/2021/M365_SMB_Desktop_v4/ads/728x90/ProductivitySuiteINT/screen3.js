...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,945,117]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(90.35,39.4,1.2348,1.2283,0,0,0,0.3,0.4);
	...
	this.instance_1.setTransform(-6,-1,1.0953,1.086);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6,-1,1035.1,127.1), null);
...
p.nominalBounds = new cjs.Rectangle(506,63,523.0999999999999,65.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606910480314", id:"screen3_atlas_1"}
	],
	preloads: []
};
