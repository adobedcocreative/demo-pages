...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_ODStorage_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90BG2x = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_728x90_BAN_ODStorage_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._728x90BG2x();
...
if (reversed == null) { reversed = false; }
	...
	this.gradient.setTransform(515.7,83.8,1,0.6704,0,0,0,153,108.2);
	this.gradient.alpha = 0;
	this.gradient.compositeOperation = "overlay";

	this.timeline.addTween(cjs.Tween.get(this.gradient).wait(1));

	// BG
	this.Bg = new lib.Bg();
	this.Bg.name = "Bg";
	this.Bg.setTransform(469.6,337.6,1,1,0,0,0,469.6,337.6);

	this.timeline.addTween(cjs.Tween.get(this.Bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-98.6,728,354.6), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_728x90_BAN_ODStorage_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,364,211);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_728x90_BAN_ODStorage_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607012826302", id:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_ODStorage_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
