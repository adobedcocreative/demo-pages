...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,695,564]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1,0,0.7731,0.7731);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(-1,0,537.3,436), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606484580756", id:"screen4_atlas_1"}
	],
	preloads: []
};
