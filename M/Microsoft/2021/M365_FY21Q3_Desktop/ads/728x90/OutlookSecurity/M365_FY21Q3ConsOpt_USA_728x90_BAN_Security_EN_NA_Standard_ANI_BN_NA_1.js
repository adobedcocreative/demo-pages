...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[682,217,138,108],[682,0,268,215],[822,217,138,108],[682,327,138,108],[822,327,138,108],[0,0,680,435],[0,437,138,108],[280,437,120,111],[140,437,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.OutlookTessNoIcons_scaled = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3 copy
	this.instance = new lib.OutlookTessNoIcons_scaled();
	this.instance.setTransform(104.85,52.85,1.4394,1.4951,-2.9988);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(104.9,1.7,1011.4,700.6999999999999), null);
...
(lib.Excel_Shadow = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.wordXX = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.wordXX, new cjs.Rectangle(98,126.5,254.60000000000002,219.89999999999998), null);
...
(lib.PowerPoint = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(99.6,93.8,1.6738,1.6738);
...
}).prototype = getMCSymbolPrototype(lib.PowerPoint, new cjs.Rectangle(83.9,93.8,254.6,220.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Outlook_1, new cjs.Rectangle(73.1,112.4,256.70000000000005,216.9), null);


(lib.OneNote = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.OneNote, new cjs.Rectangle(84.5,110.5,254.60000000000002,223.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Excel_1, new cjs.Rectangle(75.3,111.9,254.59999999999997,226.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AoXCYIAAkvIQuAAIAAEvg");
	this.shape.setTransform(-27.7,-0.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-81.2,-15.6,107.1,30.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Onenote
	this.instance = new lib.OneNote();
	this.instance.setTransform(398.5,325.3,0.7551,0.7551,0,0,0,220.6,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:220.3,regY:196.7,x:69.85,y:-369.1},191).to({x:41.55,y:-436.3},21).wait(71));

	// Onedrive
	this.instance_1 = new lib.OneDrive_1();
	this.instance_1.setTransform(417.35,176.5,0.7551,0.7551,0,0,0,220.6,196.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:220.3,x:88.7,y:-517.95},191).to({regX:220.5,x:60.5,y:-585.1},21).wait(71));

	// Powerpoint
	this.instance_2 = new lib.PowerPoint();
	this.instance_2.setTransform(554.3,144.35,0.7551,0.7551,0,0,0,220.6,196.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:220.5,x:225.8,y:-550.2},191).to({x:197.45,y:-617.3},21).wait(71));

	// Excel
	this.instance_3 = new lib.Excel_1();
	this.instance_3.setTransform(556.6,279.1,0.7551,0.7551,0,0,0,220.6,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:220.5,regY:196.7,x:228.1,y:-415.35},191).to({x:199.75,y:-482.5},21).wait(71));

	// Outlook
	this.instance_4 = new lib.Outlook_1();
	this.instance_4.setTransform(619.8,409.65,0.7551,0.7551,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:196.7,x:291.35,y:-284.8},191).to({x:263.05,y:-351.9},21).wait(71));

	// outlook
	this.instance_5 = new lib.Outlook_1();
	this.instance_5.setTransform(-112.8,-16.5,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(175).to({_off:false},0).to({regX:220.5,regY:196.5,scaleX:0.4519,scaleY:0.4519,x:-1.55,y:-23.65},22,cjs.Ease.quadOut).wait(86));

	// Word Shadow
	this.instance_6 = new lib.Wordcopy();
	this.instance_6.setTransform(-112.8,-16.5,0.0365,0.0365,0,0,0,219.2,195.9);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(175).to({_off:false},0).to({regX:220.6,regY:196.5,scaleX:0.4519,scaleY:0.4519,x:1.2,y:-33},22,cjs.Ease.quadOut).wait(86));

	// Screen
	this.instance_7 = new lib.Screen();
	this.instance_7.setTransform(748,551.3,1,1,0,0,0,581.6,357.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:537.65,y:102.9},122).to({x:516.65,y:50},38,cjs.Ease.quadOut).to({regX:581.5,regY:357.4,scaleX:0.5698,scaleY:0.5698,x:187.45,y:21.7},27,cjs.Ease.cubicOut).wait(96));

	// Word
	this.instance_8 = new lib.wordXX();
	this.instance_8.setTransform(692.15,219.5,0.7551,0.7551,0,0,0,220.6,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:220.5,regY:196.7,x:363.65,y:-474.95},191).to({x:335.35,y:-542.1},21).wait(71));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-118.1,-695,1400.8,1590.9);
...
if (reversed == null) { reversed = false; }
	...
	this.icons.setTransform(270.05,73,0.4717,0.4149,0,0,0,284.1,24.8);
	...
	this.txtCta.setTransform(669.45,60.45,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,741,434.4), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.from(exportRoot.headline2, 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "+=4.8");
				
				exportRoot.tl1.from(exportRoot.headline3, 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.6");
				
				exportRoot.tl1.from(exportRoot.headline4, 0.8, { x: "+=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.6");
				
				exportRoot.tl1.from([mc.txtCta,mc.cta], 0.7, { alpha: 0, x: "+=100",	ease:Power4.easeOut}, "-=0.5");
...
p.nominalBounds = new cjs.Rectangle(364,45,377,389.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611771857618", id:"M365_FY21Q3ConsOpt_USA_728x90_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
