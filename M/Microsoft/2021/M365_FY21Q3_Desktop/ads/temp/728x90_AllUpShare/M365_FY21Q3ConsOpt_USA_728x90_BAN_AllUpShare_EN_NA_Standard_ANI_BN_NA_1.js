...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_728x90_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[436,0,424,292],[0,302,426,294],[856,294,140,124],[0,0,434,300],[428,302,426,294],[862,0,120,111]]}
];
...
(lib._1Mobile1Desktop2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_728x90_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regY:0.3,scaleX:2.4185,scaleY:2.4185,x:-706.65,y:265.3},41,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.screen_powerpoint.setTransform(235.35,-54.4,0.31,0.31,0,0,0,202.1,140.8);
	...
	this.screen_excel.setTransform(292.1,-78.8,0.31,0.31,0,0,0,186,120.4);
	...
	this.screen_outlook.setTransform(334,-85.6,0.31,0.31,0,0,0,180,127.6);
	...
	this.screen_word.setTransform(231.3,-99.9,0.31,0.31,0,0,0,200.2,119.9);
	...
	this.screen_onedrive.setTransform(277.45,-33,0.31,0.31,0,0,0,170.5,132.1);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(169.3,-137,197.2,156.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AoPCXIAAktIQfAAIAAEtg");
	this.shape.setTransform(-29.125,-0.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-81.9,-16,105.60000000000001,30.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(361.05,49,0.3087,0.3087,0,0,0,288.5,349.9);
	...
	this.screens.setTransform(248.5,138.9,1,1,0,0,0,284.2,24.8);
	...
	this.txtCta.setTransform(670.05,61.05,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-22.9,729.7,156.1), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_728x90_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,22.1,365.70000000000005,111.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_728x90_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611322720352", id:"M365_FY21Q3ConsOpt_USA_728x90_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
