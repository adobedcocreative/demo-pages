...
lib.ssMetadata = [
		{name:"screen3_atlas_", frames: [[0,0,600,500]]}
];
...
(lib.Word_300x250_Display0 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Word_300x250_Display0();
	this.instance.setTransform(0,0,0.8933,0.872);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,536,436), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(95.9,43.35,1.3225,1.436,0,0,0,0.2,0.4);
	...
	this.static3.setTransform(109.15,198.95,0.9573,0.9573,0,0,0,114,207.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-31,-30,573.4,481.9), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_.png?1605915558983", id:"screen3_atlas_"}
	],
	preloads: []
};
