...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[436,0,424,292],[0,302,426,294],[856,294,140,124],[0,0,434,300],[428,302,426,294],[862,0,120,111]]}
];
...
(lib._1Mobile1Desktop2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.ExcelBudgeting2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.OneDriveBalloons2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Screen_Word.png
	this.instance = new lib._1Mobile1Desktop2x();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_screen, new cjs.Rectangle(-33.9,-13.9,457.9,305.9), null);
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_screen, new cjs.Rectangle(-33.9,-13.9,459.9,307.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Screen_Outlook.png
	this.instance = new lib.FSMobile2x();
...
if (reversed == null) { reversed = false; }
	...
	// Screen_OneDrive.png
	this.instance = new lib.OneDriveBalloons2x();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.OneDrive_screen, new cjs.Rectangle(-33.9,-13.9,467.9,313.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Screen_Excel.png
	this.instance = new lib.ExcelBudgeting2x();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Excel_screen, new cjs.Rectangle(-33.9,-13.9,459.9,307.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.3,regY:0.1,scaleX:3.4067,scaleY:3.4067,x:177.55,y:-924.2},41,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.screen_powerpoint.setTransform(84.2,67.95,0.5,0.5,0,0,0,201.8,141.5);
	...
	this.screen_excel.setTransform(179,27.4,0.5,0.5,0,0,0,186.3,120.5);
	...
	this.screen_outlook.setTransform(239.25,153.6,0.5,0.5,0,0,0,180.2,127.9);
	...
	this.screen_word.setTransform(104.9,-21.55,0.5,0.5,0,0,-0.2623,200.3,119.5);
	...
	this.screen_onedrive.setTransform(60.05,142.95,0.5,0.5,0,0,0,170.3,132.5);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(-25.1,-81.8,324,308.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.bg_sub.setTransform(154.8,297.9,1,1,0,0,0,154.8,297.9);
...
if (reversed == null) { reversed = false; }
	...
	this.bg_sub.name = "bg_sub";
	this.bg_sub.setTransform(84,299.4,1,1,0,0,0,84,299.4);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(1.5,-5.65,0.85,0.85,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AoTCWIAAksIQnAAIAAEsg");
	this.shape.setTransform(-29.175,-6.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-82.3,-21.1,106.3,30.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screens.setTransform(149.1,436.2,1,1,0,0,0,180.1,144.8);
	...
	this.bg.name = "bg";
	this.bg.setTransform(151.6,296.2,1,1,0,0,0,151.6,296.2);
	...
	this.txtCta.setTransform(102.05,570.6,1,1,0,0,0,0.1,-0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(139.6,575.95,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-56.1,-13.5,324,627.6), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.tlicons = new TimelineLite();		
				...
				/*//word
				exportRoot.tlicons.from(mc.screens.mobile_word, 4, {scaleX: 1.52, scaleY:1.52, x: "+=200",  y: "-=300",	ease:Quart.easeOut}, "-=0");
				exportRoot.tlicons.from(mc.screens.mobile_word.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.screen_word, 4, {scaleX: 1.52, scaleY:1.52, x: "+=300",  y: "-=400",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.screen_word.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
			
				//ppt
				exportRoot.tlicons.from(mc.screens.mobile_powerpoint, 4, {scaleX: 1, scaleY:1, x: "+=350",  y: "+=400",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.mobile_powerpoint.shad, 4, {alpha:60, x: "+=70",  y: "+=140",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.screen_powerpoint, 4, {scaleX: 1, scaleY:1, x: "+=350",  y: "+=400",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_powerpoint.shad, 4, {alpha:60, x: "+=70",  y: "+=140",	ease:Quart.easeOut}, "-=3.9");
				...
				//OneDrive
				exportRoot.tlicons.from(mc.screens.mobile_onedrive, 4, {x: "+=300", y: "+=400",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.mobile_onedrive.shad, 4, {y: "+=28",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.to(mc.screens.mobile_onedrive.blur, 4, { alpha:0,	ease:Quart.easeInOut}, "-=4");	
				exportRoot.tlicons.from(mc.screens.screen_onedrive, 4, {x: "+=300", y: "+=400",	ease:Quart.easeOut}, "-=3.8");
				...
				//Family
				exportRoot.tlicons.from(mc.screens.family, 4, {x: "+=300", y: "+=400",	ease:Quart.easeOut}, "-=3.3");
				exportRoot.tlicons.from(mc.screens.family.shad, 4, {y: "+=28",	ease:Quart.easeOut}, "-=4");*/
...
p.nominalBounds = new cjs.Rectangle(23.9,286.5,243.99999999999997,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611321893731", id:"M365_FY21Q3ConsOpt_USA_160x600_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
