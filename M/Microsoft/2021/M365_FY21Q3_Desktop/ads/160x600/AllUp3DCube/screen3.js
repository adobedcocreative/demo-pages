...
lib.ssMetadata = [
		{name:"screen3_atlas_", frames: [[0,0,320,1200]]}
];
...
(lib.Word_160x600_Display0 = function() {
...
p.nominalBounds = new cjs.Rectangle(0,0,256,1024);
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Word_160x600_Display0();
	this.instance.setTransform(0,0,0.8,0.7933);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,256,952), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(106.6,44.45,1.45,1.4999,0,0,0,0.4,0.3);
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZCBPDMAAAieFMAyFAAAMAAACeFg");
	this.shape.setTransform(129.925,475.825);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-31,-30,321.3,1120), null);
...
p.nominalBounds = new cjs.Rectangle(97.6,479.4,192.70000000000002,576.5000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_.png?1606176885312", id:"screen3_atlas_"}
	],
	preloads: []
};
