...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_160x600_BAN_Forms_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,833,536],[835,0,267,656]]}
];
...
(lib.screen = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_Forms_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(244,100.2,169.10000000000002,309.3);
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_160x600_BAN_Forms_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_160x600_BAN_Forms_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611758685611", id:"M365_FY21Q3ConsOpt_USA_160x600_BAN_Forms_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
