...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_160x600_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[682,217,138,108],[682,0,268,215],[822,217,138,108],[682,327,138,108],[822,327,138,108],[0,0,680,435],[0,437,138,108],[140,437,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(98.65,60.9,1.4997,1.4997,-4.0014);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(98.7,-10.2,1062.7,721.9000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.3,regY:0.1,scaleX:3.3884,scaleY:3.3884,x:177.65,y:-921.9},41,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(3.5,-0.05,0.6008,0.6008,0,0,0,13.6,10.8);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("ApRC9IAAl6ISjAAIAAF6g");
	this.shape.setTransform(-28.1022,-0.5524,0.891,0.8024);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-81,-15.7,105.9,30.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(191.4,426.2,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-457.45,y:-999.9},191).to({x:-494.95,y:-1088.8},21).wait(72));

	// Onedrive
	this.instance_1 = new lib.OneDrive_1();
	this.instance_1.setTransform(217.7,233.6,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-431.15,y:-1192.5},191).to({x:-468.65,y:-1281.4},21).wait(72));

	// Powerpoint
	this.instance_2 = new lib.PowerPoint();
	this.instance_2.setTransform(416.75,190.95,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-232.1,y:-1235.15},191).to({x:-269.6,y:-1324.05},21).wait(72));

	// Excel
	this.instance_3 = new lib.Excel_1();
	this.instance_3.setTransform(395.4,362,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-253.45,y:-1064.1},191).to({x:-290.95,y:-1153},21).wait(72));

	// Outlook
	this.instance_4 = new lib.Outlook_1();
	this.instance_4.setTransform(479.2,534.9,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:-169.65,y:-891.2},191).to({x:-207.15,y:-980.1},21).wait(72));

	// outlook
	this.instance_5 = new lib.Outlook_1();
	this.instance_5.setTransform(-160.95,-302.5,0.066,0.066,0,0,0,218.2,196.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(162).to({_off:false},0).to({regX:220.3,regY:196.6,scaleX:0.4555,scaleY:0.4555,x:-85.25,y:-343.45},22,cjs.Ease.quadOut).wait(100));

	// Word Shadow
	this.instance_6 = new lib.Wordcopy();
	this.instance_6.setTransform(-160.95,-302.5,0.066,0.066,0,0,0,218.2,196.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(162).to({_off:false},0).to({regX:220.4,regY:196.8,scaleX:0.4555,scaleY:0.4555,x:-82.45,y:-352.85},22,cjs.Ease.quadOut).wait(100));

	// Screen
	this.instance_7 = new lib.Screen();
	this.instance_7.setTransform(536.05,725.1,1,1,0,0,0,581.5,357.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:176.6,y:-67.2},107).to({regX:581.2,regY:357.1,x:115.5,y:-187.55},40,cjs.Ease.quadOut).to({regX:581.3,scaleX:0.5801,scaleY:0.5801,x:105.8,y:-300.15},27,cjs.Ease.cubicOut).wait(110));

	// Word
	this.instance_8 = new lib.wordXX();
	this.instance_8.setTransform(560.05,290.55,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:-88.8,y:-1135.55},191).to({x:-126.3,y:-1224.45},21).wait(72));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-630.9,-1427,1746.9,2505.9);
...
if (reversed == null) { reversed = false; }
	...
	this.icons.setTransform(312.65,747.65,0.6247,0.5668,0,0,0,375.1,404.2);
	...
	this.txtCta.setTransform(102.2,570.8,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(138.2,570.75,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-13.5,779.7,1143.6), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_160x600_BAN_Security_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut},  "+=4.8");
...
p.nominalBounds = new cjs.Rectangle(75.8,286.5,699.7,843.5999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_160x600_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611771555899", id:"M365_FY21Q3ConsOpt_USA_160x600_BAN_Security_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
