...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,945,116]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-4,-1,1.0933,1.093);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4,-1,1033.2,126.8), null);
...
p.nominalBounds = new cjs.Rectangle(508,63,521.2,65.30000000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606910486685", id:"screen2_atlas_1"}
	],
	preloads: []
};
