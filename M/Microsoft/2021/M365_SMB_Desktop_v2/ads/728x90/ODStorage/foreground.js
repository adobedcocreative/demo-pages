...
lib.ssMetadata = [
		{name:"foreground_atlas_1", frames: [[0,0,50,90]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// 300x600 FG.png
	this.instance = new lib._728x90FG();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(0,0,50,90), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnJCOIAAkbIOTAAIAAEbg");
	this.shape.setTransform(-63.0792,0.5857,0.9705,0.7923);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-107.5,-10.6,88.8,22.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(709.9,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(42.3,60.35,1,1,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.95,59.45,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.foreground.setTransform(150.5,124.8,1,1,0,0,0,150.5,124.8);

	this.timeline.addTween(cjs.Tween.get(this.foreground).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11.6,0,739.6,90), null);
...
p.nominalBounds = new cjs.Rectangle(352.3,45,369.40000000000003,45);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/foreground_atlas_1.png?1606945303994", id:"foreground_atlas_1"}
	],
	preloads: []
};
