...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-37.15,2.6,0.8,0.734,0,0,0,13.5,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AoeCvIAAldIQ9AAIAAFdg");
	this.shape.setTransform(-65.4952,2.2087,0.8955,0.8086);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.1,-11.9,97.3,28.299999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(711.6,5.35,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(669.5,61.85,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(746.75,59.25,1,1,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,729.7,90), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_728x90_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		//		MAIN ANIMATION ///////////////////////
				...
				this.tlText.from(exportRoot.headline5,{duration:0.5, y:"+=20", alpha:0, stagger:0.2}, "-=0.2");
...
p.nominalBounds = new cjs.Rectangle(364,45,365.70000000000005,30.400000000000006);
// library properties:
lib.properties = {
