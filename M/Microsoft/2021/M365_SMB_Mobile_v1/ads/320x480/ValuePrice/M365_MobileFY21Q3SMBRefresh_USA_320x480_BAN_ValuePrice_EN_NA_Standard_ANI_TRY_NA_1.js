...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,588,696]]}
];
...
(lib.NewBG = function() {
	this.initialize(ss["M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AzYC+IAMl7MAmZAAAIAMF7g");
	this.shape.setTransform(124.125,12);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadowSub, new cjs.Rectangle(0,-7,248.3,38), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-110.6,-26.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-110.6,-26.5,588,696), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.cubeShadowSub.cache(0,0,250,31,2)
	}
	...
	this.cubeShadowSub.setTransform(119.65,9,0.771,1,0,180,0,123.7,12);

	this.timeline.addTween(cjs.Tween.get(this.cubeShadowSub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadow, new cjs.Rectangle(24.3,-10,191.39999999999998,38), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnmCyIAAljIPMAAIAAFjg");
	this.shape.setTransform(-67.15,2.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.8,-15.6,97.3,35.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(69.8,39,0.7455,0.7455,0,0,0,0.1,0.4);
	...
	this.replay_btn.setTransform(304.1,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(257.9,429.25,1.2856,1.2856,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(346.05,425.3,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.cubeShadow.setTransform(159.65,431.15,1.0593,1,0,0,0,119.7,9.5);
	this.cubeShadow.alpha = 0;
	this.cubeShadow.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.cubeShadow.cache(22,-12,195,42);
	...
	this.Bg = new lib.Bg();
	this.Bg.name = "Bg";
	this.Bg.setTransform(100,72,0.7997,0.7997,0,0,0,150,124.9);

	this.timeline.addTween(cjs.Tween.get(this.Bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-108.4,-49.1,470.29999999999995,556.6), null);


// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.to(exportRoot.headline1,{duration:0.8, y: "-=60", alpha: 0}, "+=7.8");

				this.tlMain.from(exportRoot.headline2,{duration:0.8, y: "+=60", alpha: 0, stagger: 0.1}, "-=.6");
				this.tlMain.from(exportRoot.headline3,{duration:0.8, y: "+=60", alpha: 0}, "-=.7");
...
p.nominalBounds = new cjs.Rectangle(52,191,308.8,316.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607014468002", id:"M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
