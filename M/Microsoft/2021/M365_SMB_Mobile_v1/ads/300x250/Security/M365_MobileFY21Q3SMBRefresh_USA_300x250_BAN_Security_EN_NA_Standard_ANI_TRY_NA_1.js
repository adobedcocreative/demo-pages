...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-68.1555,2.1712,1.0301,1.4453);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-119.5,-17.6,102.7,39.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(239.75,214.7,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(317,212.1,1,1,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,150,108.80000000000001);
// library properties:
lib.properties = {
