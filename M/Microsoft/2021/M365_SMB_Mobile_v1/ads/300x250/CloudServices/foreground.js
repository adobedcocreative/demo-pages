...
lib.ssMetadata = [
		{name:"foreground_atlas_1", frames: [[0,0,379,140]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(110.55,125.05,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300.1,250), null);
...
p.nominalBounds = new cjs.Rectangle(260.2,250,38.900000000000034,-55);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/foreground_atlas_1.png?1606904575404", id:"foreground_atlas_1"}
	],
	preloads: []
};
