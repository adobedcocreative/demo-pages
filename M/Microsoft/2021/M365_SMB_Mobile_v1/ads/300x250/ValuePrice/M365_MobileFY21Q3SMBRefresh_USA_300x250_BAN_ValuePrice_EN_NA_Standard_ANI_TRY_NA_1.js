...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,400,335]]}
];
...
(lib.BG = function() {
	this.initialize(ss["M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-17.4,-1.5,0.8145,0.8145);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-17.4,-1.5,325.79999999999995,272.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(239.5,214.25,1.2856,1.2856,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(327.65,210.3,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.cubeShadow.setTransform(150.1,222.05,1,1,0,0,0,82.9,-15.5);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-17.4,-1.5,325.79999999999995,272.9), null);


// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.to(exportRoot.headline1,{duration:0.8, y: "-=60", alpha: 0}, "+=8");
...
p.nominalBounds = new cjs.Rectangle(132.7,123.5,174.8,147.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607015724065", id:"M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
