...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,427,580]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib._320x480_Frame_2();
	this.instance_1.setTransform(-1,-2,1.2046,1.13);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-2,514.4,655.4), null);
...
p.nominalBounds = new cjs.Rectangle(255,349.9,258.4,357);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606931435728", id:"screen2_atlas_1"}
	],
	preloads: []
};
