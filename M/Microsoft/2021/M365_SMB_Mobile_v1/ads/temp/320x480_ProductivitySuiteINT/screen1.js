...
lib.ssMetadata = [
		{name:"screen1_atlas_1", frames: [[0,0,458,622]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib._320x480_Frame_1();
	this.instance_1.setTransform(-3,-3,1.129,1.06);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-3,-3,517.1,659.3), null);
...
p.nominalBounds = new cjs.Rectangle(253,348.8,261.1,361.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen1_atlas_1.png?1606931445498", id:"screen1_atlas_1"}
	],
	preloads: []
};
