...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,319,321]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(124.9,60.2,1.7261,1.7015,0,0,0,0.5,0.6);
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup15();
	this.instance_1.setTransform(-1,-5,1.61,1.6139);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-5,513.6,518.2), null);
...
p.nominalBounds = new cjs.Rectangle(255,251,257.6,262.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606992465350", id:"screen3_atlas_1"}
	],
	preloads: []
};
