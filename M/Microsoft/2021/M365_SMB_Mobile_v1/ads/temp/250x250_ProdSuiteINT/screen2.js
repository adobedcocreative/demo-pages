...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,319,326]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup14();
	this.instance_1.setTransform(-2,-2,1.6156,1.5799);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-2,-2,515.4,515.1), null);
...
p.nominalBounds = new cjs.Rectangle(254,254,259.4,259.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606992463970", id:"screen2_atlas_1"}
	],
	preloads: []
};
