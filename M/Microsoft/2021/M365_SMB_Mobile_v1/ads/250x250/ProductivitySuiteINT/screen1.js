...
lib.ssMetadata = [
		{name:"screen1_atlas_1", frames: [[0,0,317,325]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(124.9,60.2,1.7262,1.7015,0,0,0,0.5,0.6);
	...
	// VidStatic
	this.instance_1 = new lib.Group26();
	this.instance_1.setTransform(-7,-1,1.6774,1.6353);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-7,-1,531.8,531.5), null);
...
p.nominalBounds = new cjs.Rectangle(249,255,275.79999999999995,275.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen1_atlas_1.png?1606925649920", id:"screen1_atlas_1"}
	],
	preloads: []
};
