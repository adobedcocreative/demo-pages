...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_250x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,500,500]]}
];
...
(lib.WordMobileStatic250x250 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_250x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.05,3.4,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(66.95,25.2,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(42.2,215.4,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(120.55,210.6,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// Image
	this.instance_1 = new lib.WordMobileStatic250x250();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-21.8,0,271.8,250), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_250x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(103.2,125,146.8,124.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_250x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605957335391", id:"M365_MobileFY21Q3NewYear_USA_250x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
