...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,538,1024]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.MaskGroup32x();
...
if (reversed == null) { reversed = false; }
	...
	this.static4.setTransform(114,207.8,1,1,0,0,0,114,207.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606235947003", id:"screen4_atlas_1"}
	],
	preloads: []
};
