...
lib.ssMetadata = [
		{name:"screen2_atlas_", frames: [[0,0,320,1200]]}
];
...
(lib.OneDrive_160x600_Display0 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.OneDrive_160x600_Display0();
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.static2.setTransform(114,207.8,1,1,0,0,0,114,207.8);

	this.timeline.addTween(cjs.Tween.get(this.static2).wait(1));

	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgY7BPeMAAAie7MAx4AAAMAAACe7g");
	this.shape.setTransform(129.3,478.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-31,-30,320,1120), null);
...
(lib.screen2 = function(mode,startPosition,loop) {
	...
	this.mainMC.setTransform(62.8,67.55,1,1.0759,0,0,0,62.8,62.8);
...
p.nominalBounds = new cjs.Rectangle(97.7,479.7,191.3,582.3999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_.png?1606176887568", id:"screen2_atlas_"}
	],
	preloads: []
};
