...
function frame0Anim() {
    ...
    exportRoot.runBanner = function() {
        ...
        this.tlAnim.to(exportRoot.headline1,{
            ...
            .set(mc.slides, {scale:1, x:0, y:0})
            .from(mc.slides, {duration: 1, alpha:0}, "<0.2")
            .from(mc.nav, {duration:1, alpha:0}, "<")
            .from(mc.slides.sub_slides, {duration:3, y:exportRoot.slidePositions[4]-50}, "<")
            ...
            .to(mc.slides, {duration:0.5, scale:1, x:0, y:0, ease:"power2.inOut",
                onStart: function () {
                    ...
                    for(s=1; s<=exportRoot.nSlide; s++) {
                        if(s!=exportRoot.selectedSlide) gsap.to(mc.slides.sub_slides["slide"+s], {duration:0.5, alpha:0})
                    }
                },
                onComplete: function () {
            ...
            .to(mc.slides,{duration:0.1,
                onStart: function () {showLoading(1);},
                onComplete: function () {
