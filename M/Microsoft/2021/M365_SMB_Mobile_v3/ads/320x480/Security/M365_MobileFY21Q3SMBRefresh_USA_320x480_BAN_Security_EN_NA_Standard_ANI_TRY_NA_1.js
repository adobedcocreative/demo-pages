...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-74.0608,2.1461,1.1479,1.5511);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-131.3,-19.1,114.50000000000001,42.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(304,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(251.5,428.15,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(336.3,425.55,1,1,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,159.2,208.60000000000002);
// library properties:
lib.properties = {
