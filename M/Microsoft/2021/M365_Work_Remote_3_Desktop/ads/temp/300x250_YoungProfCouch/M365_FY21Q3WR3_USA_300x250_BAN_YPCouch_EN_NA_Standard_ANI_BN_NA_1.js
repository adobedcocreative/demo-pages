...
lib.ssMetadata = [
		{name:"M365_FY21Q3WR3_USA_300x250_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[1508,0,684,1003],[2194,0,670,1003],[0,1005,915,610],[917,1005,915,610],[2866,0,783,522],[0,1617,783,522],[0,0,752,1003],[754,0,752,1003],[1834,1005,915,610],[2751,1005,915,610],[785,1617,783,522],[1570,1617,783,522]]}
];
...
(lib.background2blur = function() {
	this.initialize(ss["M365_FY21Q3WR3_USA_300x250_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.fg3blur, new cjs.Rectangle(0,0,457.5,305), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.foreground2blur();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.FG2blur, new cjs.Rectangle(0,0,376,501.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.foreground1blur();
	this.instance.setTransform(8.05,6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.f1blur, new cjs.Rectangle(8.1,6,391.5,261), null);
...
}).prototype = getMCSymbolPrototype(lib.bg3blur, new cjs.Rectangle(0,0,457.5,305), null);


(lib.bg2blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.background2blur();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.bg2blur, new cjs.Rectangle(0,0,342,501.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.background1blur();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.b1blur, new cjs.Rectangle(0,0,391.5,261), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},49,cjs.Ease.cubicInOut).wait(20).to({startPosition:0},0).to({x:-848.75,alpha:0.4492},31,cjs.Ease.cubicIn).wait(3));
...
}).prototype = getMCSymbolPrototype(lib.FG3, new cjs.Rectangle(0,0,457.5,305), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(164.5,160.5,1,1,0,0,0,164.5,160.5);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.f2FG, new cjs.Rectangle(0,0,376,501.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// blur
	this.blur = new lib.bg2blur();
	this.blur.name = "blur";
	this.blur.setTransform(157.5,242,1,1,0,0,0,164.5,242);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.f2bg, new cjs.Rectangle(-7,0,342,501.5), null);
...
}).prototype = getMCSymbolPrototype(lib.f1FG, new cjs.Rectangle(0,-0.5,391.9,261.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(230,156.5,1,1,0,0,0,230,156.5);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.f1BG, new cjs.Rectangle(0,0,391.5,261), null);
...
}).prototype = getMCSymbolPrototype(lib.BG3, new cjs.Rectangle(0,0,457.5,305), null);
...
if (reversed == null) { reversed = false; }
	...
	this.s_logo_w.setTransform(53.05,22.95,0.7282,0.7282,0,0,0,0.1,0.5);
	...
	this.s_logo.setTransform(53.05,22.95,0.7282,0.7282,0,0,0,0.1,0.5);
	...
	this.sliders2.setTransform(-58.1,0);
	...
	this.sliders.setTransform(-58.1,0);
	...
	this.FG3.name = "FG3";
	this.FG3.setTransform(163.35,89.6,1,1,0,0,0,216,117.8);

	this.BG3 = new lib.BG3();
	this.BG3.name = "BG3";
	this.BG3.setTransform(165.6,117.1,1,1,0,0,0,216,144);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.BG3},{t:this.FG3}]}).wait(1));

	// f2
	this.FG2 = new lib.f2FG();
	this.FG2.name = "FG2";
	this.FG2.setTransform(74.8,-15.95,0.9113,0.9113,0,0,0,86.7,85);

	this.BG2 = new lib.f2bg();
	this.BG2.name = "BG2";
	this.BG2.setTransform(155.25,113.55,0.9295,0.9295,0,0,0,155,232.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.BG2},{t:this.FG2}]}).wait(1));

	// f1
	this.FG1 = new lib.f1FG();
	this.FG1.name = "FG1";
	this.FG1.setTransform(188.1,125,1,1,0,0,0,220.5,125);
	...
	this.BG1.name = "BG1";
	this.BG1.setTransform(188.5,147,1,1,0,0,0,220.5,147);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-640.7,-102.5,1047.8000000000002,466.1), null);


// stage content:
(lib.M365_FY21Q3WR3_USA_300x250_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tl1 = gsap.timeline({default:{ease:"power4.out"}});
				...
				this.tl1.from(mc.sliders.front, 1, {x: "+=400"}, "+=0.4");
				this.tl1.from(mc.sliders.back, 1, {x: "+=400"}, "-=0.9");
		...
		// 1st text
				...
				this.tl1.from(exportRoot.headline1, 0.2, { y: "+=0", alpha: 0}, "-=0.6");
				this.tl1.to(exportRoot.headline1, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
					
				this.tl1.from(exportRoot.headline2, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline2, 0.2, { y: "+=0", alpha: 0}, "+=0.2");
			
				this.tl1.from(exportRoot.headline3, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline3, 0.2, { y: "+=0", alpha: 0}, "+=0.5");
				
				this.tl1.from(exportRoot.headline4, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline4, 0.2, { y: "+=0", alpha: 0}, "+=0.2");
				
				this.tl1.from(exportRoot.headline5, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline5, 0.2, { y: "+=0", alpha: 0}, "+=0.8");
		...
		////////////////
				...
				this.tl1.to(mc.BG2, 1.5, {x: "-=6", ease:Power2.easeInOut}, "-=1.5");
				
				this.tl1.to(mc.FG2.blur, 1, {alpha:0}, "-=1");
				this.tl1.to(mc.BG2.blur, 1, {alpha:0}, "-=1");
		
				
				this.tl1.from(mc.sliders2.front, 1, {x: "+=400"}, "+=1");
				this.tl1.from(mc.sliders2.back, 1, {x: "+=400"}, "-=0.9");
				this.tl1.to(mc.s_logo, 0.5, {alpha:1}, "-=0.45");
				this.tl1.to(mc.s_logo_w, 0.5, {alpha:0}, "-=0.5");
		
				this.tl1.to(mc.FG2, 1, {x: "-=18", ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.BG2, 1, {x: "-=9", ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.FG2.blur, 1, {alpha:1, ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.BG2.blur, 1, {alpha:1, ease:Power2.easeInOut}, "-=1.5");
		
				
		// 2nd text	
				this.tl1.from(exportRoot.headline6, 0.2, { y: "+=0", alpha: 0}, "-=0.6");
				this.tl1.to(exportRoot.headline6, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
					
				this.tl1.from(exportRoot.headline7, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline7, 0.2, { y: "+=0", alpha: 0}, "+=0.2");
			
				this.tl1.from(exportRoot.headline8, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline8, 0.2, { y: "+=0", alpha: 0}, "+=0.5");
				
				this.tl1.from(exportRoot.headline9, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline9, 0.2, { y: "+=0", alpha: 0}, "+=0.2");
				
				this.tl1.from(exportRoot.headline10, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline10, 0.2, { y: "+=0", alpha: 0}, "+=0.2");
				
				this.tl1.from(exportRoot.headline11, 0.2, { y: "+=0", alpha: 0}, "-=0.2");
				this.tl1.to(exportRoot.headline11, 0.2, { y: "+=0", alpha: 0}, "+=0.8");
		/////////////
				...
				this.tl1.to(mc.FG3.blur, 1, {alpha:0}, "-=1");
				this.tl1.to(mc.BG3.blur, 1, {alpha:0}, "-=1");
				...
				this.tl1.to(mc.FG3, 1.5, {x:"+=9.85",y:"+=0.8", ease:Power2.easeInOut}, "-=1.5");
		
				
				
				
				this.tl1.from(exportRoot.headline20, {duration:0.8, y: "+=30", alpha: 0, stagger:0.2}, "-=0.6");
				this.tl1.from(exportRoot.headline30, {duration:0.8, y: "+=30", alpha: 0}, "-=0.6");
		
		
				
				this.tl1.from([mc.cta,mc.txtCta], 0.6, { x: "-=150"}, "-=1");
...
p.nominalBounds = new cjs.Rectangle(-57.5,22.5,463.4,341);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3WR3_USA_300x250_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1613381776259", id:"M365_FY21Q3WR3_USA_300x250_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
