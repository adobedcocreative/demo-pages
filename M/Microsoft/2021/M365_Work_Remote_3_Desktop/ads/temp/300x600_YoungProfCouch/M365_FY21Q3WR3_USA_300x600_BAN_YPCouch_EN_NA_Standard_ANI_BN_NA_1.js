...
lib.ssMetadata = [
		{name:"M365_FY21Q3WR3_USA_300x600_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,915,610],[917,0,915,610],[2398,612,429,434],[2829,612,429,434],[1214,612,590,617],[0,612,605,883],[1834,0,915,610],[2751,0,915,610],[1806,612,590,617],[607,612,605,883]]}
];
...
(lib.background3blur = function() {
	this.initialize(ss["M365_FY21Q3WR3_USA_300x600_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.fg3blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.foreground3blur();
	this.instance.setTransform(-228.75,-152.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.fg3blur, new cjs.Rectangle(-228.7,-152.5,915,610), null);


(lib.FG2blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.img2_blur();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.FG2blur, new cjs.Rectangle(0,0,605,883), null);


(lib.f1blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.fg1_blurpngcopy();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.f1blur, new cjs.Rectangle(0,0,590,617), null);
...
(lib.bg3blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.background3blur();
	this.instance.setTransform(-228.75,-152.5);
...
}).prototype = getMCSymbolPrototype(lib.bg3blur, new cjs.Rectangle(-228.7,-152.5,915,610), null);
...
(lib.b1blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.bg1_blur();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.b1blur, new cjs.Rectangle(0,0,429,434), null);
...
(lib.MSFT_Logo_anim_white = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer 1
	this.ms = new lib.ms_white();
	this.ms.name = "ms";
	this.ms.setTransform(14.7,1.2,1.017,1.017);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEBA00").s().p("AgyAzIAAhlIBlAAIAABlg");
	this.shape.setTransform(-34.0961,7.3539,1.017,1.017);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#03A5EA").s().p("AgyAzIAAhlIBlAAIAABlg");
	this.shape_1.setTransform(-45.588,7.3539,1.017,1.017);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7CBB01").s().p("AgyAzIAAhlIBlAAIAABlg");
	this.shape_2.setTransform(-34.0961,-4.138,1.017,1.017);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AgyAzIAAhlIBlAAIAABlg");
	this.shape_3.setTransform(-45.588,-4.138,1.017,1.017);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.ms}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.MSFT_Logo_anim_white, new cjs.Rectangle(-50.8,-9.3,134.6,21.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(225.5,126.3,1,1,0,0,0,225.5,126.3);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.FG3, new cjs.Rectangle(-228.7,-152.5,915,610), null);
...
if (reversed == null) { reversed = false; }
	...
	// blur
	this.blur = new lib.FG2blur();
	this.blur.name = "blur";
	this.blur.setTransform(143.3,254.3,1,1,0,0,0,294.3,468.3);
	this.blur.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.blur).wait(1));

	// Layer_1
	this.instance = new lib.foreground21();
	this.instance.setTransform(-151,-214);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.f2FG, new cjs.Rectangle(-151,-214,605,883), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.blur = new lib.f1blur();
	this.blur.name = "blur";
	this.blur.setTransform(-194,-48.7,1,1,0,0,0,230,133.3);
	this.blur.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.blur).wait(1));

	// Layer_1
	this.instance = new lib.foreground11();
	this.instance.setTransform(-424,-182);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.f1FG, new cjs.Rectangle(-424,-182,590,617), null);
...
if (reversed == null) { reversed = false; }
	...
	// blur
	this.blur = new lib.b1blur();
	this.blur.name = "blur";
	this.blur.setTransform(-30,-15.9,1.4,1.4,0,0,0,230,156.5);
	this.blur.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.blur).wait(1));

	// Layer_1
	this.instance = new lib.background11();
	this.instance.setTransform(-352,-235,1.4,1.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.f1BG, new cjs.Rectangle(-352,-235,600.6,607.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},49,cjs.Ease.cubicInOut).wait(19).to({startPosition:0},0).to({x:-863.6,alpha:0.4492},31,cjs.Ease.cubicIn).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	// blur
	this.blur = new lib.bg3blur();
	this.blur.name = "blur";
	this.blur.setTransform(225.5,153.5,1,1,0,0,0,225.5,153.5);
	this.blur.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.BG3, new cjs.Rectangle(-228.7,-152.5,915,610), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_1 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_2 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_3 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_4 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_5 = new cjs.Graphics().p("EgtzAu4MAAAhdtMBbnAAAMAAABdtg");
	var mask_graphics_6 = new cjs.Graphics().p("EgtzAu4MAAAhdsMBbnAAAMAAABdsg");
	var mask_graphics_7 = new cjs.Graphics().p("EgtyAu3MAAAhdpMBblAAAMAAABdpg");
	var mask_graphics_8 = new cjs.Graphics().p("EgtxAu3MAAAhdmMBbjAAAMAAABdmg");
	var mask_graphics_9 = new cjs.Graphics().p("EgtwAu2MAAAhdiMBbhAAAMAAABdig");
	var mask_graphics_10 = new cjs.Graphics().p("EgtvAu1MAAAhdcMBbfAAAMAAABdcg");
	var mask_graphics_11 = new cjs.Graphics().p("EgtsAu0MAAAhdUMBbZAAAMAAABdUg");
	var mask_graphics_12 = new cjs.Graphics().p("EgtpAuyMAAAhdJMBbTAAAMAAABdJg");
	var mask_graphics_13 = new cjs.Graphics().p("EgtlAuvMAAAhc7MBbLAAAMAAABc7g");
	var mask_graphics_14 = new cjs.Graphics().p("EgtgAusMAAAhcpMBbBAAAMAAABcpg");
	var mask_graphics_15 = new cjs.Graphics().p("EgtaAupMAAAhcVMBa1AAAMAAABcVg");
	var mask_graphics_16 = new cjs.Graphics().p("EgtTAukMAAAhb6MBanAAAMAAABb6g");
	var mask_graphics_17 = new cjs.Graphics().p("EgtKAufMAAAhbbMBaVAAAMAAABbbg");
	var mask_graphics_18 = new cjs.Graphics().p("EgtAAuZMAAAha1MBaBAAAMAAABa1g");
	var mask_graphics_19 = new cjs.Graphics().p("EgszAuRMAAAhaIMBZnAAAMAAABaIg");
	var mask_graphics_20 = new cjs.Graphics().p("EgskAuIMAAAhZUMBZJAAAMAAABZUg");
	var mask_graphics_21 = new cjs.Graphics().p("EgsTAt+MAAAhYYMBYnAAAMAAABYYg");
	var mask_graphics_22 = new cjs.Graphics().p("EgsAAtyMAAAhXSMBYBAAAMAAABXSg");
	var mask_graphics_23 = new cjs.Graphics().p("EgrpAtlMAAAhWCMBXTAAAMAAABWCg");
	var mask_graphics_24 = new cjs.Graphics().p("EgrQAtVMAAAhUmMBWhAAAMAAABUmg");
	var mask_graphics_25 = new cjs.Graphics().p("EgqzAtEMAAAhS/MBVnAAAMAAABS/g");
	var mask_graphics_26 = new cjs.Graphics().p("EgqSAswMAAAhRLMBUlAAAMAAABRLg");
	var mask_graphics_27 = new cjs.Graphics().p("EgptAsaMAAAhPIMBTbAAAMAAABPIg");
	var mask_graphics_28 = new cjs.Graphics().p("EgpEAsBMAAAhM1MBSJAAAMAAABM1g");
	var mask_graphics_29 = new cjs.Graphics().p("EgoWArmMAAAhKTMBQtAAAMAAABKTg");
	var mask_graphics_30 = new cjs.Graphics().p("EgnlArIMAAAhHjMBPLAAAMAAABHjg");
	var mask_graphics_31 = new cjs.Graphics().p("Egm3AqsMAAAhFAMBNvAAAMAAABFAg");
	var mask_graphics_32 = new cjs.Graphics().p("EgmOAqUMAAAhCvMBMdAAAMAAABCvg");
	var mask_graphics_33 = new cjs.Graphics().p("EglpAp9MAAAhArMBLTAAAMAAABArg");
	var mask_graphics_34 = new cjs.Graphics().p("EglJApqMAAAg+3MBKTAAAMAAAA+3g");
	var mask_graphics_35 = new cjs.Graphics().p("EgkrApYMAAAg9PMBJXAAAMAAAA9Pg");
	var mask_graphics_36 = new cjs.Graphics().p("EgkSApJMAAAg70MBIlAAAMAAAA70g");
	var mask_graphics_37 = new cjs.Graphics().p("Egj7Ao7MAAAg6kMBH3AAAMAAAA6kg");
	var mask_graphics_38 = new cjs.Graphics().p("EgjoAovMAAAg5eMBHRAAAMAAAA5eg");
	var mask_graphics_39 = new cjs.Graphics().p("EgjXAolMAAAg4iMBGvAAAMAAAA4ig");
	var mask_graphics_40 = new cjs.Graphics().p("EgjIAocMAAAg3tMBGRAAAMAAAA3tg");
	var mask_graphics_41 = new cjs.Graphics().p("Egi8AoVMAAAg3BMBF5AAAMAAAA3Bg");
	var mask_graphics_42 = new cjs.Graphics().p("EgixAoOMAAAg2bMBFjAAAMAAAA2bg");
	var mask_graphics_43 = new cjs.Graphics().p("EgioAoJMAAAg18MBFRAAAMAAAA18g");
	var mask_graphics_44 = new cjs.Graphics().p("EgihAoFMAAAg1iMBFDAAAMAAAA1ig");
	var mask_graphics_45 = new cjs.Graphics().p("EgibAoBMAAAg1MMBE3AAAMAAAA1Mg");
	var mask_graphics_46 = new cjs.Graphics().p("EgiWAn+MAAAg07MBEtAAAMAAAA07g");
	var mask_graphics_47 = new cjs.Graphics().p("EgiSAn8MAAAg0tMBElAAAMAAAA0tg");
	var mask_graphics_48 = new cjs.Graphics().p("EgiPAn6MAAAg0iMBEfAAAMAAAA0ig");
	var mask_graphics_49 = new cjs.Graphics().p("EgiNAn4MAAAg0aMBEbAAAMAAAA0ag");
	var mask_graphics_50 = new cjs.Graphics().p("EgiLAn3MAAAg0UMBEXAAAMAAAA0Ug");
	var mask_graphics_51 = new cjs.Graphics().p("EgiKAn3MAAAg0QMBEVAAAMAAAA0Qg");
	var mask_graphics_52 = new cjs.Graphics().p("EgiJAn2MAAAg0NMBETAAAMAAAA0Ng");
	var mask_graphics_53 = new cjs.Graphics().p("EgiIAn2MAAAg0LMBERAAAMAAAA0Lg");
	var mask_graphics_54 = new cjs.Graphics().p("EgiIAn2MAAAg0KMBERAAAMAAAA0Kg");
	var mask_graphics_55 = new cjs.Graphics().p("EgiIAn2MAAAg0JMBERAAAMAAAA0Jg");
	var mask_graphics_56 = new cjs.Graphics().p("EgiIAn1MAAAg0IMBERAAAMAAAA0Ig");
	var mask_graphics_57 = new cjs.Graphics().p("EgiIAn1MAAAg0IMBERAAAMAAAA0Ig");
	var mask_graphics_58 = new cjs.Graphics().p("EgiIAn1MAAAg0IMBERAAAMAAAA0Ig");
	var mask_graphics_59 = new cjs.Graphics().p("EgiIAn2MAAAg0JMBERAAAMAAAA0Jg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:49.6947,y:299.9926}).wait(1).to({graphics:mask_graphics_1,x:49.6948,y:299.9926}).wait(1).to({graphics:mask_graphics_2,x:49.6957,y:299.9921}).wait(1).to({graphics:mask_graphics_3,x:49.6999,y:299.9902}).wait(1).to({graphics:mask_graphics_4,x:49.711,y:299.985}).wait(1).to({graphics:mask_graphics_5,x:49.7344,y:299.974}).wait(1).to({graphics:mask_graphics_6,x:49.777,y:299.9541}).wait(1).to({graphics:mask_graphics_7,x:49.8472,y:299.9212}).wait(1).to({graphics:mask_graphics_8,x:49.9549,y:299.8708}).wait(1).to({graphics:mask_graphics_9,x:50.1114,y:299.7975}).wait(1).to({graphics:mask_graphics_10,x:50.3298,y:299.6952}).wait(1).to({graphics:mask_graphics_11,x:50.6246,y:299.5572}).wait(1).to({graphics:mask_graphics_12,x:51.0117,y:299.3759}).wait(1).to({graphics:mask_graphics_13,x:51.5087,y:299.1432}).wait(1).to({graphics:mask_graphics_14,x:52.1346,y:298.8501}).wait(1).to({graphics:mask_graphics_15,x:52.91,y:298.487}).wait(1).to({graphics:mask_graphics_16,x:53.857,y:298.0435}).wait(1).to({graphics:mask_graphics_17,x:54.9992,y:297.5086}).wait(1).to({graphics:mask_graphics_18,x:56.3618,y:296.8706}).wait(1).to({graphics:mask_graphics_19,x:57.9715,y:296.1168}).wait(1).to({graphics:mask_graphics_20,x:59.8564,y:295.2341}).wait(1).to({graphics:mask_graphics_21,x:62.0463,y:294.2086}).wait(1).to({graphics:mask_graphics_22,x:64.5725,y:293.0257}).wait(1).to({graphics:mask_graphics_23,x:67.4676,y:291.6699}).wait(1).to({graphics:mask_graphics_24,x:70.766,y:290.1254}).wait(1).to({graphics:mask_graphics_25,x:74.5036,y:288.3752}).wait(1).to({graphics:mask_graphics_26,x:78.7176,y:286.4019}).wait(1).to({graphics:mask_graphics_27,x:83.4469,y:284.1872}).wait(1).to({graphics:mask_graphics_28,x:88.7319,y:281.7124}).wait(1).to({graphics:mask_graphics_29,x:94.6146,y:278.9576}).wait(1).to({graphics:mask_graphics_30,x:100.9725,y:275.9803}).wait(1).to({graphics:mask_graphics_31,x:106.8552,y:273.2256}).wait(1).to({graphics:mask_graphics_32,x:112.1403,y:270.7508}).wait(1).to({graphics:mask_graphics_33,x:116.8696,y:268.5361}).wait(1).to({graphics:mask_graphics_34,x:121.0836,y:266.5628}).wait(1).to({graphics:mask_graphics_35,x:124.8211,y:264.8126}).wait(1).to({graphics:mask_graphics_36,x:128.1195,y:263.268}).wait(1).to({graphics:mask_graphics_37,x:131.0147,y:261.9123}).wait(1).to({graphics:mask_graphics_38,x:133.5408,y:260.7293}).wait(1).to({graphics:mask_graphics_39,x:135.7307,y:259.7039}).wait(1).to({graphics:mask_graphics_40,x:137.6156,y:258.8212}).wait(1).to({graphics:mask_graphics_41,x:139.2253,y:258.0674}).wait(1).to({graphics:mask_graphics_42,x:140.5879,y:257.4293}).wait(1).to({graphics:mask_graphics_43,x:141.7302,y:256.8944}).wait(1).to({graphics:mask_graphics_44,x:142.6772,y:256.451}).wait(1).to({graphics:mask_graphics_45,x:143.4526,y:256.0879}).wait(1).to({graphics:mask_graphics_46,x:144.0785,y:255.7948}).wait(1).to({graphics:mask_graphics_47,x:144.5755,y:255.5621}).wait(1).to({graphics:mask_graphics_48,x:144.9626,y:255.3808}).wait(1).to({graphics:mask_graphics_49,x:145.2573,y:255.2428}).wait(1).to({graphics:mask_graphics_50,x:145.4757,y:255.1405}).wait(1).to({graphics:mask_graphics_51,x:145.6323,y:255.0672}).wait(1).to({graphics:mask_graphics_52,x:145.7399,y:255.0168}).wait(1).to({graphics:mask_graphics_53,x:145.8101,y:254.9839}).wait(1).to({graphics:mask_graphics_54,x:145.8527,y:254.9639}).wait(1).to({graphics:mask_graphics_55,x:145.8762,y:254.953}).wait(1).to({graphics:mask_graphics_56,x:145.8873,y:254.9478}).wait(1).to({graphics:mask_graphics_57,x:145.8914,y:254.9458}).wait(1).to({graphics:mask_graphics_58,x:145.8923,y:254.9454}).wait(1).to({graphics:mask_graphics_59,x:145.818,y:254.9732}).wait(1));

	// FG3
	this.FG3 = new lib.FG3();
	this.FG3.name = "FG3";
	this.FG3.setTransform(-25.8,444.7,1,1,0,0,0,136.1,300.8);
	this.FG3.alpha = 0;

	var maskedShapeInstanceList = [this.FG3];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.FG3).to({regX:136.3,regY:300.9,scaleX:0.6547,scaleY:0.6547,x:46.85,y:428.65},59,cjs.Ease.quartInOut).wait(1));

	// BG3
	this.BG3 = new lib.BG3();
	this.BG3.name = "BG3";
	this.BG3.setTransform(-25.8,444.7,1,1,0,0,0,136.1,300.8);
	this.BG3.alpha = 0;

	var maskedShapeInstanceList = [this.BG3];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.BG3).to({regX:136,regY:300.9,scaleX:0.6614,scaleY:0.6614,x:45.25,y:431.25},59,cjs.Ease.quartInOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-243.5,0.1,607.9,599.9);
...
if (reversed == null) { reversed = false; }
	...
	// Logo_white
	this.s_logo_w = new lib.MSFT_Logo_anim_white();
	this.s_logo_w.name = "s_logo_w";
	this.s_logo_w.setTransform(69.45,39.4,0.7405,0.7405,0,0,0,0.1,0.6);

	this.timeline.addTween(cjs.Tween.get(this.s_logo_w).wait(1));

	// Logo_gray
	this.s_logo = new lib.MSFT_Logo_anim();
	this.s_logo.name = "s_logo";
	this.s_logo.setTransform(69.45,39.4,0.7405,0.7405,0,0,0,0.1,0.6);
	...
	this.FG2.name = "FG2";
	this.FG2.setTransform(124,202.5,0.6898,0.6898,0,0,0,86.7,85.2);

	this.FG2_1 = new lib.f2FG();
	this.FG2_1.name = "FG2_1";
	this.FG2_1.setTransform(130.5,153.65,0.757,0.757,0,0,0,86.9,85.2);
	this.FG2_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.FG2_1},{t:this.FG2}]}).wait(1));

	// f3
	this.f3 = new lib.f3();
	this.f3.name = "f3";
	this.f3.setTransform(40.6,40.6,1,1,0,0,0,40.6,40.6);
	...
	this.FG1.name = "FG1";
	this.FG1.setTransform(491.6,305,1,1,0,0,0,220.5,125);
	...
	this.BG1.name = "BG1";
	this.BG1.setTransform(421.3,379.05,1,1,0,0,0,220.5,147);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-390.6,-72.8,915,687.8), null);


// stage content:
(lib.M365_FY21Q3WR3_USA_300x600_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				mc.FG2.blur.alpha = 1;
				mc.f3.FG3.alpha = 0;
				mc.f3.FG3.blur.alpha = 1;
				mc.f3.BG3.alpha = 0;
				mc.f3.BG3.blur.alpha = 1;
				
				this.tl1 = new TimelineLite();
				
				this.tl1.to(mc.FG1.blur, 2, {alpha:0, ease:Power2.easeInOut}, "-=0.5");
				this.tl1.to(mc.BG1.blur, 2, {alpha:0, ease:Power2.easeInOut}, "-=2");
				this.tl1.to(mc.s_logo_w, 0.5, {alpha:1, ease:Power2.easeInOut}, "-=1");
				this.tl1.from(mc.FG1, 2, {x: "+=15", ease:Power2.easeOut}, "-=1.5");
				this.tl1.from(mc.BG1, 2, {x: "+=2", ease:Power2.easeOut}, "-=2");
				...
				this.tl1.to(mc.FG1, 1, {x: "-=100", ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.BG1, 1, {x: "-=70", ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.FG1.blur, 1, {alpha:1, ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.BG1.blur, 1, {alpha:1, ease:Power2.easeInOut}, "-=1.5");
		...
		////////////////
				...
				this.tl1.to(mc.FG2, 1.5, {x: "-=25", ease:Power2.easeInOut}, "-=1");
				
				this.tl1.to(mc.FG2.blur, 1, {alpha:0}, "-=1");
				...
				this.tl1.to(mc.FG2, 1, {x: "-=45", ease:Power2.easeInOut}, "-=1.5");
				this.tl1.to(mc.FG2.blur, 1, {alpha:1, ease:Power2.easeInOut}, "-=1.5");
		...
		/////////////
				...
				this.tl1.to(mc.f3.FG3.blur, 1, {alpha:0, ease:Power4.easeOut}, "-=1");
				this.tl1.to(mc.f3.BG3.blur, 1, {alpha:0, ease:Power4.easeOut}, "-=1");
...
p.nominalBounds = new cjs.Rectangle(-239.3,227.2,762,387.59999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3WR3_USA_300x600_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1613386727844", id:"M365_FY21Q3WR3_USA_300x600_BAN_YPCouch_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
