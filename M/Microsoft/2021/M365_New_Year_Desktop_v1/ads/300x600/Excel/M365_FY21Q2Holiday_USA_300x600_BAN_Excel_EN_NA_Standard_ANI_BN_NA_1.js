...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,1146,674],[1148,0,548,486]]}
];
...
(lib.Desktop = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.screen1, new cjs.Rectangle(0,0,548,486), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(65).to({scaleY:7.7359},0).to({scaleY:7.7358,alpha:0},15).wait(19));
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(52.6,321,0.4999,0.5,0,0,0,174.8,155.3);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(66.8,128.75,1,1,0,0,0,0.8,1.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(315,548,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-34.8,0,673.8,601.2), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(115.4,299.9,521.5,301.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602667633943", id:"M365_FY21Q2Holiday_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
