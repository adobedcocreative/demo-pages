// JavaScript Document
	...
	bannerData.headline1 = ["<#FFFFFF>Start fresh with |Microsoft 365","28px",150, 226,"30","350", "center"];
	bannerData.headline2 = ["<#FFFFFF>Start reaching your money goals |with smart features","14px",150, 295,"16","350", "center"];
	bannerData.CTA = ["<#107C41>LEARN MORE","14px",-1,0,"19","300", "left"];
