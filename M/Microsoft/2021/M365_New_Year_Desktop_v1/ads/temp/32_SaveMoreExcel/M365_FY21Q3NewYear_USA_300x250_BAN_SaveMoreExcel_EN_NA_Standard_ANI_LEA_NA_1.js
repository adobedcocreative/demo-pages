...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-60.525,2.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-111.7,-10,102.4,24.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(40).to({regX:15.4,regY:1.4,scaleX:4.9244,scaleY:4.9244,x:296.6,y:337.25,alpha:0.9922},0).wait(1).to({scaleX:4.9093,scaleY:4.9093,x:294.95,y:335.25,alpha:0.9775},0).wait(1).to({scaleX:4.8868,scaleY:4.8868,x:292.45,y:332.35,alpha:0.9557},0).wait(1).to({scaleX:4.8562,scaleY:4.8562,x:289.1,y:328.3,alpha:0.926},0).wait(1).to({scaleX:4.8171,scaleY:4.8171,x:284.8,y:323.15,alpha:0.8881},0).wait(1).to({scaleX:4.7689,scaleY:4.7689,x:279.5,y:316.85,alpha:0.8413},0).wait(1).to({scaleX:4.7111,scaleY:4.7111,x:273.15,y:309.2,alpha:0.7852},0).wait(1).to({scaleX:4.6433,scaleY:4.6433,x:265.7,y:300.3,alpha:0.7194},0).wait(1).to({scaleX:4.5652,scaleY:4.5652,x:257.1,y:290.05,alpha:0.6437},0).wait(1).to({scaleX:4.4768,scaleY:4.4768,x:247.4,y:278.4,alpha:0.5579},0).wait(1).to({scaleX:4.3782,scaleY:4.3782,x:236.5,y:265.45,alpha:0.4623},0).wait(1).to({scaleX:4.2701,scaleY:4.2701,x:224.65,y:251.25,alpha:0.3574},0).wait(1).to({scaleX:4.1536,scaleY:4.1536,x:211.85,y:235.9,alpha:0.2443},0).wait(1).to({scaleX:4.0301,scaleY:4.0301,x:198.25,y:219.65,alpha:0.1245},0).wait(1).to({regX:0.1,regY:0.2,scaleX:3.9018,scaleY:3.9018,x:124.5,y:198.15,alpha:0},0).wait(1).to({regX:15.4,regY:1.4,scaleX:3.7603,scaleY:3.7603,x:168.55,y:184.15},0).wait(1).to({scaleX:3.6189,scaleY:3.6189,x:153,y:165.55},0).wait(1).to({scaleX:3.4803,scaleY:3.4803,x:137.75,y:147.35},0).wait(1).to({scaleX:3.347,scaleY:3.347,x:123.05,y:129.8},0).wait(1).to({scaleX:3.2208,scaleY:3.2208,x:109.15,y:113.2},0).wait(1).to({scaleX:3.1034,scaleY:3.1034,x:96.2,y:97.75},0).wait(1).to({scaleX:2.9956,scaleY:2.9956,x:84.35,y:83.6},0).wait(1).to({scaleX:2.8981,scaleY:2.8981,x:73.6,y:70.75},0).wait(1).to({scaleX:2.8109,scaleY:2.8109,x:64,y:59.3},0).wait(1).to({scaleX:2.734,scaleY:2.734,x:55.5,y:49.2},0).wait(1).to({scaleX:2.667,scaleY:2.667,x:48.1,y:40.4},0).wait(1).to({scaleX:2.6097,scaleY:2.6097,x:41.8,y:32.85},0).wait(1).to({scaleX:2.5614,scaleY:2.5614,x:36.55,y:26.5},0).wait(1).to({scaleX:2.5218,scaleY:2.5218,x:32.2,y:21.3},0).wait(1).to({scaleX:2.4901,scaleY:2.4901,x:28.7,y:17.1},0).wait(1).to({scaleX:2.4661,scaleY:2.4661,x:26.05,y:13.95},0).wait(1).to({scaleX:2.4491,scaleY:2.4491,x:24.15,y:11.7},0).wait(1).to({regX:0.1,regY:0.3,scaleX:2.4387,scaleY:2.4387,x:-14.2,y:7.45},0).wait(1));

	// mask white (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_14 = new cjs.Graphics().p("AyYelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_15 = new cjs.Graphics().p("AyrelIAAwoMBbtAAAIAAQog");
	var mask_1_graphics_16 = new cjs.Graphics().p("AzlelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_17 = new cjs.Graphics().p("A1EelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_18 = new cjs.Graphics().p("A3JelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_19 = new cjs.Graphics().p("A51elIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_20 = new cjs.Graphics().p("A9HelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_21 = new cjs.Graphics().p("EggYAelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_22 = new cjs.Graphics().p("EgjEAelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_23 = new cjs.Graphics().p("EglJAelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_24 = new cjs.Graphics().p("EgmoAelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_25 = new cjs.Graphics().p("EgniAelIAAwoMBbuAAAIAAQog");
	var mask_1_graphics_26 = new cjs.Graphics().p("Egn1AelIAAwoMBbuAAAIAAQog");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_1_graphics_14,x:469.3539,y:195.7095}).wait(1).to({graphics:mask_1_graphics_15,x:467.448,y:195.7095}).wait(1).to({graphics:mask_1_graphics_16,x:461.7303,y:195.7095}).wait(1).to({graphics:mask_1_graphics_17,x:452.2008,y:195.7095}).wait(1).to({graphics:mask_1_graphics_18,x:438.8594,y:195.7095}).wait(1).to({graphics:mask_1_graphics_19,x:421.7063,y:195.7095}).wait(1).to({graphics:mask_1_graphics_20,x:400.7414,y:195.7095}).wait(1).to({graphics:mask_1_graphics_21,x:379.7765,y:195.7095}).wait(1).to({graphics:mask_1_graphics_22,x:362.6233,y:195.7095}).wait(1).to({graphics:mask_1_graphics_23,x:349.282,y:195.7095}).wait(1).to({graphics:mask_1_graphics_24,x:339.7525,y:195.7095}).wait(1).to({graphics:mask_1_graphics_25,x:334.0348,y:195.7095}).wait(1).to({graphics:mask_1_graphics_26,x:332.1289,y:195.7095}).wait(1).to({graphics:null,x:0,y:0}).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4387,scaleY:2.4387,x:-14.2,y:7.45},33,cjs.Ease.quadInOut).wait(1));
	...
	this.instance_2.setTransform(298.45,338.35,0.2981,0.2981,0,0,0,-39.9,1.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:4.9325,scaleY:4.9325,x:298.4},13,cjs.Ease.quadOut).to({x:24.15},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(235.05,220.4,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,303.1,252.1), null);


// stage content:
(lib.M365_FY21Q3NewYear_USA_300x250_BAN_SaveMoreExcel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,125,152.2,127);
// library properties:
lib.properties = {
