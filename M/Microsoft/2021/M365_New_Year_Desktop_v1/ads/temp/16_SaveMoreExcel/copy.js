// JavaScript Document
	...
	bannerData.headline1 = ['<#FFFFFF>Start fresh with |Microsoft 365','18px',80, 219,'20','350', 'center']	['<#FFFFFF>Start reaching your |money goals with |smart features','11px',80, 266,'13','350', 'center']
	bannerData.CTA = ['<#107C41>LEARN MORE','12px',-1,0,'16','300', 'left']
