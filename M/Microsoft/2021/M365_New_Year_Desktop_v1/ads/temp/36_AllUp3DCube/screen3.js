...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,300,600]]}
];
...
(lib.Word_300x600_Display0 = function() {
...
p.nominalBounds = new cjs.Rectangle(0,0,512,1024);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.Word_300x600_Display0();
	this.instance.setTransform(0,0,1.7933,1.7067);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,538,1024), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(110.3,45.45,1.45,1.4999,0,0,0,0.2,0.3);
	...
	this.txt.name = "txt";
	this.txt.setTransform(73.75,70.5,1.0461,1,0,0,0,70.5,70.5);
	...
	this.video.setTransform(0,0,2.0976,2);
	...
	this.static3.setTransform(114,207.8,1,1,0,0,0,114,207.8);

	this.timeline.addTween(cjs.Tween.get(this.static3).wait(1));

	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EguZBUnMAAAipNMBczAAAMAAACpNg");
	this.shape.setTransform(268.95,515.425);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-28,-33,601,1200), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mainMC.setTransform(0,0,0.954,1);
...
p.nominalBounds = new cjs.Rectangle(229.3,485.9,310.59999999999997,571.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606235963263", id:"screen3_atlas_1"}
	],
	preloads: []
};
