...
lib.ssMetadata = [
		{name:"M365_FY21Q2Holiday_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,584,354],[0,356,496,366]]}
];
...
(lib.PPTDesktop = function() {
	this.initialize(ss["M365_FY21Q2Holiday_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_1.setTransform(101,128.4,0.53,0.53,0,0,0,0.7,1);

	this.screen_2 = new lib.screen_2();
	this.screen_2.name = "screen_2";
	this.screen_2.setTransform(149.2,54.8,0.54,0.54,0,0,0,0.7,1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,465.2,252.1), null);


// stage content:
(lib.M365_FY21Q2Holiday_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,125,313.7,127);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2Holiday_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602713072665", id:"M365_FY21Q2Holiday_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
