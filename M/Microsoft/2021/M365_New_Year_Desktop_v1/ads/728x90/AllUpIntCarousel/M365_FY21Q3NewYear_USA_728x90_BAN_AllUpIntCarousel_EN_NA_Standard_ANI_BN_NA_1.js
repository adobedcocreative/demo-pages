	...
	this.frame_0 = function() {
		...
		this.runBanner = function () {
			...
			//mc.cta.ctaBg.cache(0,0,200,80,2);
				...
				exportRoot.TL_MainIntro.from(mc.cta, 0.6, {x: "+=110", ease:Power3.easeOut}, "-=0.2");
				...
				exportRoot.TL_MainText1.to(exportRoot.mainMC.cta, 0, { x:"-=828", y:"+=6"}, "-=1");
				exportRoot.TL_MainText1.to(exportRoot.mainMC.txtCta, 0, { x:"-=828", y:"+=6"}, "-=1");
				...
				exportRoot.TL_MainText1.to(exportRoot.mainMC.cta, 0, { x:"+=828", y:"-=6"}, "-=.2");
				exportRoot.TL_MainText1.to(exportRoot.mainMC.txtCta, 0, { x:"+=828", y:"-=6"}, "-=.2");
				...
				exportRoot.TL_MainText2.to(exportRoot.mainMC.cta, 0, { x:"-=828", y:"+=6", onComplete:function(){exportRoot.mainMC.cta.ctaBg1.visible = false; exportRoot.mainMC.cta.arrow0.visible = false; exportRoot.mainMC.cta.ctaBg2.visible = true; exportRoot.mainMC.cta.arrow2.visible = true;}}, "-=1");
				exportRoot.TL_MainText2.to(exportRoot.mainMC.txtCta, 0, { x:"-=828", y:"+=6", easel: {tint: "#107c41", tintAmount: 1}}, "-=1");
				...
				exportRoot.TL_MainText2.to(exportRoot.mainMC.cta, 0, { x:"+=828", y:"-=6", onStart:function(){exportRoot.mainMC.cta.ctaBg1.visible = true; exportRoot.mainMC.cta.arrow0.visible = true; exportRoot.mainMC.cta.ctaBg2.visible = false; exportRoot.mainMC.cta.arrow2.visible = false;}}, "-=.2");
				exportRoot.TL_MainText2.to(exportRoot.mainMC.txtCta, 0, { x:"+=828", y:"-=6", easel: {tint: "#FFFFFF", tintAmount: 0}}, "-=.2");
				...
				exportRoot.TL_MainText3.to(exportRoot.mainMC.cta, 0, { x:"-=828", y:"+=6", onComplete:function(){exportRoot.mainMC.cta.ctaBg1.visible = false; exportRoot.mainMC.cta.arrow0.visible = false; exportRoot.mainMC.cta.ctaBg2.visible = true; exportRoot.mainMC.cta.arrow3.visible = true;}}, "-=1");
				exportRoot.TL_MainText3.to(exportRoot.mainMC.txtCta, 0, { x:"-=828", y:"+=6", easel: {tint: "#185ABD", tintAmount: 1}}, "-=1");
				...
				exportRoot.TL_MainText3.to(exportRoot.mainMC.cta, 0, { x:"+=828", y:"-=6", onStart:function(){exportRoot.mainMC.cta.ctaBg1.visible = true; exportRoot.mainMC.cta.arrow0.visible = true; exportRoot.mainMC.cta.ctaBg2.visible = false; exportRoot.mainMC.cta.arrow3.visible = false;}}, "-=.2");
				exportRoot.TL_MainText3.to(exportRoot.mainMC.txtCta, 0, { x:"+=828", y:"-=6", easel: {tint: "#FFFFFF", tintAmount: 0}}, "-=.2");
				...
				exportRoot.TL_MainText4.to(exportRoot.mainMC.cta, 0, { x:"-=828", y:"+=6", onComplete:function(){exportRoot.mainMC.cta.ctaBg1.visible = false; exportRoot.mainMC.cta.arrow0.visible = false; exportRoot.mainMC.cta.ctaBg2.visible = true; exportRoot.mainMC.cta.arrow4.visible = true;}}, "-=1");
				exportRoot.TL_MainText4.to(exportRoot.mainMC.txtCta, 0, { x:"-=828", y:"+=6", easel: {tint: "#c43e1c", tintAmount: 1}}, "-=1");
				...
				exportRoot.TL_MainText4.to(exportRoot.mainMC.cta, 0, { x:"+=828", y:"-=6", onStart:function(){exportRoot.mainMC.cta.ctaBg1.visible = true; exportRoot.mainMC.cta.arrow0.visible = true; exportRoot.mainMC.cta.ctaBg2.visible = false; exportRoot.mainMC.cta.arrow4.visible = false;}}, "-=.2");
				exportRoot.TL_MainText4.to(exportRoot.mainMC.txtCta, 0, { x:"+=828", y:"-=6", easel: {tint: "#FFFFFF", tintAmount: 0}}, "-=.2");
