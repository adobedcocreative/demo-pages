...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3WR3_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,400,250],[0,252,400,250],[0,504,400,250],[0,756,400,250]]}
];
...
(lib._300x250_f1 = function() {
	this.initialize(ss["M365_MobileFY21Q3WR3_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AobDNIAAmZIQ3AAIAAGZg");
	this.shape.setTransform(54,13.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(0,-6.9,108,41), null);
...
if (reversed == null) { reversed = false; }
	...
	this.nav.name = "nav";
	this.nav.setTransform(227,222.75,1.0212,1.0212,0,0,0,59,5.9);
...
// stage content:
(lib.M365_MobileFY21Q3WR3_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				exportRoot.tlSubHeadMove.to(exportRoot.subheadline1, .5, { y: "-=19", ease:Power2.easeInOut});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3WR3_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1613406534978", id:"M365_MobileFY21Q3WR3_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
