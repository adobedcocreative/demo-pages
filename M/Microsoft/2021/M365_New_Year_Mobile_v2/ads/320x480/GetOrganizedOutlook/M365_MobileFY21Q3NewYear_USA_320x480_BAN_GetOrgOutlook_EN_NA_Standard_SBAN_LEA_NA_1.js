...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_320x480_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,640,960]]}
];
...
(lib.Outlook_Mobile_320x480 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_320x480_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.65,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	this.shape.setTransform(-46.85,2.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-106.2,-16.2,118.7,37.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(81.95,41.2,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txt.name = "txt";
	this.txt.setTransform(70.65,70.15,1,1,0,0,0,70.5,70.5);
	...
	this.txtCta.setTransform(249.5,428,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(327.85,424.4,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BGImg
	this.instance_1 = new lib.Outlook_Mobile_320x480();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,341.8,480), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_320x480_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,239.7,181.8,240.10000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_320x480_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605879391221", id:"M365_MobileFY21Q3NewYear_USA_320x480_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
