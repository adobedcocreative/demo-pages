...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,600,500]]}
];
...
(lib.WordMobileStatic300x250 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_300x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-65.75,1.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-125.1,-17,118.69999999999999,37.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(66.65,25.2,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(42.2,213.9,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(120.55,211.1,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// Image
	this.instance_1 = new lib.WordMobileStatic300x250();
...
// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_300x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_300x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605957175946", id:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_GrowCareerWord_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
