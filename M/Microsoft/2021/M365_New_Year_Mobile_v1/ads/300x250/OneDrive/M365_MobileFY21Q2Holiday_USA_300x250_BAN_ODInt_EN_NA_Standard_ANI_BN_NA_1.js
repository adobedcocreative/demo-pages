...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.cta.name = "cta";
	this.cta.setTransform(112.95,211.75,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11.9,0,311.9,250), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_300x250_BAN_ODInt_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(138.1,125,156.4,108.69999999999999);
// library properties:
lib.properties = {
