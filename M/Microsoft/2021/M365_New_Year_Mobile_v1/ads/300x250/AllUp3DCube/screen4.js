...
lib.ssMetadata = [
		{name:"screen4_atlas_", frames: [[0,0,600,500]]}
];
...
(lib.Powerpoint_300x250_Display0 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Powerpoint_300x250_Display0();
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txt.name = "txt";
	this.txt.setTransform(67.5,67.8,0.9573,0.9573,0,0,0,70.5,70.8);
	...
	this.static4.setTransform(109.15,198.95,0.9573,0.9573,0,0,0,114,207.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_.png?1605915953083", id:"screen4_atlas_"}
	],
	preloads: []
};
