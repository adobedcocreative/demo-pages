...
lib.ssMetadata = [
		{name:"screen2_atlas_", frames: [[0,0,600,500]]}
];
...
(lib.OneDrive_Desktop_300x2500 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.OneDrive_Desktop_300x2500();
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.static2.setTransform(109.15,198.95,0.9573,0.9573,0,0,0,114,207.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-31.6,-31.6,574.4,483.5), null);
...
(lib.screen2 = function(mode,startPosition,loop) {
	...
	this.mainMC.setTransform(62.7,67.75,1,1.0784,0,0,0,62.7,62.8);
...
p.nominalBounds = new cjs.Rectangle(229.2,197.1,310.7,290.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_.png?1605915566493", id:"screen2_atlas_"}
	],
	preloads: []
};
