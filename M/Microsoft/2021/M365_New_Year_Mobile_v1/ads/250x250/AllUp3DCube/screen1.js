...
lib.ssMetadata = [
		{name:"screen1_atlas_", frames: [[0,0,432,444]]}
];
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,1.1852,1.1532);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,512,512), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(123.85,59.75,1.7162,1.8299,0,0,0,0.5,0.4);
	...
	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgshAsaMAAAhYzMBZDAAAMAAABYzg");
	this.shape.setTransform(257,258.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-38.9,-31.8,590,589.9), null);
...
(lib.screen1 = function(mode,startPosition,loop) {
	...
	this.mainMC.setTransform(0,0.45);
...
p.nominalBounds = new cjs.Rectangle(228,230,314,312.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen1_atlas_.png?1606171386789", id:"screen1_atlas_"}
	],
	preloads: []
};
