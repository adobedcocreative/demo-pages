...
lib.ssMetadata = [
		{name:"screen2_atlas_", frames: [[0,0,500,500]]}
];
...
(lib.OneDrive_Desktop_250x2500 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.OneDrive_Desktop_250x2500();
	this.instance.setTransform(1,0,1.024,1.024);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(1,0,512,512), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_.png?1606171393365", id:"screen2_atlas_"}
	],
	preloads: []
};
