...
(lib.CoffeeCup11 = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Desktop_Images_0000s_0002_ExcelDesktop = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.Mobile_Images_0000s_0002_ExcelMobile = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(13);
}).prototype = p = new cjs.Sprite();
...
(lib.white = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(149.9973,125.0495,0.9176,1.1012);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.white, new cjs.Rectangle(12.4,-12.6,275.3,275.3), null);
...
(lib.snowflakes_2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(32.75,-112.5);

	this.instance_1 = new lib.snowflakegroup1();
	this.instance_1.setTransform(-134.75,23.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.snowflakes_2, new cjs.Rectangle(-134.7,-112.5,224.5,225), null);
...
(lib.snowflakes_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-43,-44.5);
...
(lib.Screen_2_Excel = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Desktop_Images_0000s_0002_ExcelDesktop();
...
(lib.Screen_1_Excel = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Mobile_Images_0000s_0002_ExcelMobile();
...
(lib.option_hit_round = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.008)").s().p("AiGCHQgagagOgfQgPgigBgnIAAgJQAChMA2g2QADgEAFgDIAFgFQAygqBEgCIAIAAQAnABAiAPQAYAKAVASIAMAMIAGAGQAyA2AABKQAABPg4A4Qg4A4hPAAQhOAAg4g4g");
	this.shape.setTransform(14.225,14.225);
...
p.nominalBounds = new cjs.Rectangle(-4.8,-4.8,38.099999999999994,38.099999999999994);
...
(lib.object_2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.enlargedonedrive();
	this.instance.setTransform(170.05,75.8,0.5,0.5,7.001);

	this.instance_1 = new lib.enlargeexcel();
	this.instance_1.setTransform(170.05,75.8,0.5,0.5,7.001);

	this.instance_2 = new lib.Enlargedworld();
	this.instance_2.setTransform(170.05,75.8,0.5,0.5,7.001);

	this.instance_3 = new lib.Enlargedppt();
	this.instance_3.setTransform(170.05,75.8,0.5,0.5,7.001);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).wait(1));

	// shadow
	this.instance_4 = new lib.enlargedshadow();
	this.instance_4.setTransform(221.7,83.15,0.5,0.5,7.001);
...
p.nominalBounds = new cjs.Rectangle(142.2,53.3,133.60000000000002,246.89999999999998);
...
(lib.object_1 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(373.75,128.55,0.5,0.5,-161.0005);

	this.instance_2 = new lib.OvenMit();
	this.instance_2.setTransform(216.75,71.75,0.5,0.5,-89.9895);

	this.instance_3 = new lib.CoffeeCup11();
	this.instance_3.setTransform(221.45,59.45,0.5,0.5,-89.9895);
...
p.nominalBounds = new cjs.Rectangle(175.2,-46.8,233.40000000000003,216);
...
(lib.Btn_Expand = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,2,0,3).p("AAAAAIAAAaAAaAAIgaAAAAAgZIAAAZIgZAA");
...
}).prototype = getMCSymbolPrototype(lib.Btn_Expand, new cjs.Rectangle(0,0,29.5,29.5), null);
...
(lib.Page = function(mode,startPosition,loop) {
	...
	this.Btn_return.setTransform(225.4,219.5,1,1,0,0,0,14.8,14.8);
	...
	this.obj2.name = "obj2";
	this.obj2.setTransform(281.6,259.1,1,1,0,0,0,316.6,243.1);
	...
	this.obj1.name = "obj1";
	this.obj1.setTransform(79.35,228.5,1,1,0,0,0,127.8,219.5);

	this.timeline.addTween(cjs.Tween.get(this.obj1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Page, new cjs.Rectangle(109.7,-37.8,172.5,354), null);
...
(lib.mountain_anim = function(mode,startPosition,loop) {
	...
	this.indicator.setTransform(177.8,221.5,1,1,0,0,0,58.8,5.5);

	this.btn_expand = new lib.Btn_Expand();
	this.btn_expand.name = "btn_expand";
	this.btn_expand.setTransform(219.8,183.8,1,1,0,0,0,14.8,14.8);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A9ITiMAAAgnDMA6RAAAMAAAAnDg");
	mask.setTransform(185.525,125);

	// Onedrive
	this.screen_1_onedrive = new lib.Screen_1_OneDrive();
	this.screen_1_onedrive.name = "screen_1_onedrive";
	this.screen_1_onedrive.setTransform(178.6,169.2,0.4092,0.4092,0,0,0,191.8,129.3);

	this.screen_2_onedrive = new lib.Screen_2_OneDrive();
	this.screen_2_onedrive.name = "screen_2_onedrive";
	this.screen_2_onedrive.setTransform(260.5,139,0.4092,0.4092,0,0,0,291.4,176.7);
	...
	this.screen_1_excel.setTransform(178.6,169.2,0.4092,0.4092,0,0,0,191.8,129.3);

	this.screen_2_excel = new lib.Screen_2_Excel();
	this.screen_2_excel.name = "screen_2_excel";
	this.screen_2_excel.setTransform(260.5,139,0.4092,0.4092,0,0,0,291.4,176.7);
	...
	this.screen_1_word.setTransform(178.6,169.2,0.4092,0.4092,0,0,0,191.8,129.3);

	this.screen_2_word = new lib.Screen_2_Word();
	this.screen_2_word.name = "screen_2_word";
	this.screen_2_word.setTransform(260.5,139,0.4092,0.4092,0,0,0,291.4,176.7);
	...
	this.screen_1_ppt.setTransform(178.6,169.2,0.4092,0.4092,0,0,0,191.8,129.3);

	this.screen_2_ppt = new lib.Screen_2_PPT();
	this.screen_2_ppt.name = "screen_2_ppt";
	this.screen_2_ppt.setTransform(260.5,139,0.4092,0.4092,0,0,0,291.4,176.7);
...
}).prototype = getMCSymbolPrototype(lib.mountain_anim, new cjs.Rectangle(100.1,66.7,272,160.5), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EhFuBFwMAAAiLfMCLdAAAMAAACLfg");
	var mask_1_graphics_51 = new cjs.Graphics().p("EhFmBFnMAAAiLNMCLNAAAMAAACLNg");
	var mask_1_graphics_52 = new cjs.Graphics().p("EhFmBFnMAAAiLNMCLNAAAMAAACLNg");
	var mask_1_graphics_53 = new cjs.Graphics().p("EhFmBFnMAAAiLNMCLNAAAMAAACLNg");
	var mask_1_graphics_54 = new cjs.Graphics().p("EhFmBFoMAAAiLPMCLNAAAMAAACLPg");
	var mask_1_graphics_55 = new cjs.Graphics().p("EhFnBFoMAAAiLPMCLPAAAMAAACLPg");
	var mask_1_graphics_56 = new cjs.Graphics().p("EhFnBFoMAAAiLPMCLPAAAMAAACLPg");
	var mask_1_graphics_57 = new cjs.Graphics().p("EhFoBFpMAAAiLRMCLRAAAMAAACLRg");
	var mask_1_graphics_58 = new cjs.Graphics().p("EhFpBFqMAAAiLTMCLTAAAMAAACLTg");
	var mask_1_graphics_59 = new cjs.Graphics().p("EhFqBFrMAAAiLVMCLVAAAMAAACLVg");
	var mask_1_graphics_60 = new cjs.Graphics().p("EhFrBFsMAAAiLXMCLXAAAMAAACLXg");
	var mask_1_graphics_61 = new cjs.Graphics().p("EhFsBFtMAAAiLZMCLZAAAMAAACLZg");
	var mask_1_graphics_62 = new cjs.Graphics().p("EhFtBFuMAAAiLbMCLbAAAMAAACLbg");
	var mask_1_graphics_63 = new cjs.Graphics().p("EhFuBFwMAAAiLfMCLdAAAMAAACLfg");
	var mask_1_graphics_64 = new cjs.Graphics().p("EhFwBFxMAAAiLhMCLhAAAMAAACLhg");
	var mask_1_graphics_65 = new cjs.Graphics().p("EhFyBFzMAAAiLlMCLlAAAMAAACLlg");
	var mask_1_graphics_66 = new cjs.Graphics().p("EhFzBF1MAAAiLpMCLnAAAMAAACLpg");
	var mask_1_graphics_67 = new cjs.Graphics().p("EhF1BF3MAAAiLtMCLrAAAMAAACLtg");
	var mask_1_graphics_68 = new cjs.Graphics().p("EhF3BF5MAAAiLxMCLvAAAMAAACLxg");
	var mask_1_graphics_69 = new cjs.Graphics().p("EhF5BF7MAAAiL1MCLzAAAMAAACL1g");
	var mask_1_graphics_70 = new cjs.Graphics().p("EhJuBF9MAAAiL5MCL4AAAMAAACL5g");
	var mask_1_graphics_71 = new cjs.Graphics().p("EhQcBF/MAAAiL9MCL9AAAMAAACL9g");
	var mask_1_graphics_72 = new cjs.Graphics().p("EhXeBGCMAAAiMDMCMCAAAMAAACMDg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:298.931,y:338.1527}).wait(51).to({graphics:mask_1_graphics_51,x:297.9903,y:337.3685}).wait(1).to({graphics:mask_1_graphics_52,x:295.7905,y:337.3729}).wait(1).to({graphics:mask_1_graphics_53,x:289.1911,y:337.3862}).wait(1).to({graphics:mask_1_graphics_54,x:278.192,y:337.4082}).wait(1).to({graphics:mask_1_graphics_55,x:262.7933,y:337.4391}).wait(1).to({graphics:mask_1_graphics_56,x:242.995,y:337.4788}).wait(1).to({graphics:mask_1_graphics_57,x:218.797,y:337.5274}).wait(1).to({graphics:mask_1_graphics_58,x:190.1994,y:337.5848}).wait(1).to({graphics:mask_1_graphics_59,x:157.2022,y:337.651}).wait(1).to({graphics:mask_1_graphics_60,x:119.8054,y:337.726}).wait(1).to({graphics:mask_1_graphics_61,x:78.0089,y:337.8099}).wait(1).to({graphics:mask_1_graphics_62,x:31.8128,y:337.9025}).wait(1).to({graphics:mask_1_graphics_63,x:-18.7829,y:338.004}).wait(1).to({graphics:mask_1_graphics_64,x:-73.7782,y:338.1144}).wait(1).to({graphics:mask_1_graphics_65,x:-133.1732,y:338.2335}).wait(1).to({graphics:mask_1_graphics_66,x:-196.9678,y:338.3615}).wait(1).to({graphics:mask_1_graphics_67,x:-265.162,y:338.4984}).wait(1).to({graphics:mask_1_graphics_68,x:-337.7559,y:338.644}).wait(1).to({graphics:mask_1_graphics_69,x:-414.7494,y:338.7985}).wait(1).to({graphics:mask_1_graphics_70,x:-471.904,y:338.9618}).wait(1).to({graphics:mask_1_graphics_71,x:-514.9189,y:339.1339}).wait(1).to({graphics:mask_1_graphics_72,x:-559.8954,y:339.8032}).wait(3));
...
p.nominalBounds = new cjs.Rectangle(-1119.8,-108.8,1865.1,896.8);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.snowflakes_1.setTransform(206.6,44.55);
	...
	this.snowflakes_2.setTransform(114.25,113.05);
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-20.5,0,270.5,250), null);
...
(lib.CTA_btn = function(mode,startPosition,loop) {
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("Ao8DdIAAm4IR5AAIAAG4g");
	this.shape.setTransform(-32.725,-0.75);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-90,-22.8,114.6,44.1), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.logo_intro.setTransform(41.95,30.85,0.28,0.28,0,0,0,0.6,0);
	...
	this.hit_shrink.setTransform(220.55,215.1,1.0595,1.0595,0,0,0,9.5,10);
	...
	this.txtCta.setTransform(38.5,214.45,0.9555,0.9555,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(81.2,214.7,0.9013,0.9013,0,0,0,0.1,0.2);
	...
	this.no_hit.setTransform(189.45,224,0.6103,0.212,0,0,0,150,125);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-20.5,-37.8,985.9,354), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function () {
			...
			mc.txtCta.alpha = 1
				...
				exportRoot.TL_MainIntro.from(mc.cta, 0.6, {x: "-=300", ease:Power3.easeOut}, "-=0.6");
				exportRoot.TL_MainIntro.from(mc.txtCta, 0.6, {x: "-=300", ease:Power3.easeOut}, "-=0.6");
				...
				exportRoot.TL_MainExpand.to(no_hit, 0.1, {x: "+=110", ease:Power3.easeIn}, "-=0.1");
				...
				exportRoot.TL_MainExpand.from(mc.Enlarged.obj2, 1, {x: "-=35",y: "+=200", ease:Power2.easeOut}, "-=0.4");
				...
				for (var i = 0; i < exportRoot.enlarged_1_2.length; i++) {
					...
					if (i!=0) exportRoot.TL_MainText1.to(exportRoot.enlarged_1_2[i], 0.3, { alpha: 0, ease:Power3.easeOut, onComplete:function(){exportRoot.TL_MainText.tweenFromTo("In", "Out");}}, "-=0.3");
				}
				...
				for (var i = 0; i < exportRoot.enlarged_2_2.length; i++) {
					...
					if (i!=0) exportRoot.TL_MainText2.to(exportRoot.enlarged_2_2[i], 0.3, { alpha: 0, ease:Power3.easeOut, onComplete:function(){exportRoot.TL_MainText.tweenFromTo("In", "Out");}}, "-=0.3");
				}
				...
				for (var i = 0; i < exportRoot.enlarged_3_2.length; i++) {
					...
					if (i!=0) exportRoot.TL_MainText3.to(exportRoot.enlarged_3_2[i], 0.3, { alpha: 0, ease:Power3.easeOut, onComplete:function(){exportRoot.TL_MainText.tweenFromTo("In", "Out");}}, "-=0.3");
				}
				...
				for (var i = 0; i < exportRoot.enlarged_4_2.length; i++) {
					...
					if (i!=0) exportRoot.TL_MainText4.to(exportRoot.enlarged_4_2[i], 0.3, { alpha: 0, ease:Power3.easeOut, onComplete:function(){exportRoot.TL_MainText.tweenFromTo("In", "Out");}}, "-=0.3");
				}
...
p.nominalBounds = new cjs.Rectangle(104.5,87.2,860.9,229);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_.png?1605025355250", id:"M365_MobileFY21Q2Holiday_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
