...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q2Holiday_USA_320x480_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_", frames: [[956,1376,137,243],[0,666,582,353],[584,666,582,353],[0,1021,582,353],[584,1021,582,353],[0,0,323,664],[325,0,323,664],[650,0,323,664],[1300,0,109,424],[975,0,323,664],[0,1376,420,214],[1168,1100,265,232],[1168,1334,265,232],[422,1376,265,232],[689,1376,265,232],[1168,666,216,432],[1300,426,184,215],[1411,0,86,89],[1411,182,57,47],[1411,91,86,89]]}
];
...
(lib.CoffeeCup11 = function() {
	this.initialize(ss["M365_MobileFY21Q2Holiday_USA_320x480_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.snowflakes_2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(77.75,-112.5);

	this.instance_1 = new lib.snowflakegroup1();
	this.instance_1.setTransform(-134,204);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.snowflakes_2, new cjs.Rectangle(-134,-112.5,268.8,405.5), null);
...
(lib.shadow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,0.7948,0.7948);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.shadow, new cjs.Rectangle(0,0,86.7,337), null);
...
(lib.option_hit = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(10,10,1.5,1.5);
	this.shape._off = true;
...
p.nominalBounds = new cjs.Rectangle(-12.5,-12.5,45,45);
...
(lib.object_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(215.1,-54.7,0.56,0.56);

	this.instance_1 = new lib.firtwigandpineconeswhitebackgroundVUE4NYF();
	this.instance_1.setTransform(379.85,135.1,0.5994,0.5994,-161.1674);

	this.instance_2 = new lib.OvenMit();
	this.instance_2.setTransform(201.6,102,0.65,0.65,-89.9973);

	this.instance_3 = new lib.CoffeeCup11();
	this.instance_3.setTransform(204.7,86.2,0.74,0.74,-89.9941);
...
p.nominalBounds = new cjs.Rectangle(141.6,-67.5,279.70000000000005,254.7);
...
(lib.Btn_Expand = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,2,0,3).p("AAAAAIAAAnAAnAAIgnAAAAAgmIAAAmIgmAA");
...
(lib.object_2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(92.4,185,0.4998,0.4998,-7.0532);

	this.instance_1 = new lib.Enlargedexcel();
	this.instance_1.setTransform(92.4,185,0.4998,0.4998,-7.0532);

	this.instance_2 = new lib.Enlargedword();
	this.instance_2.setTransform(92.4,185,0.4998,0.4998,-7.0532);

	this.instance_3 = new lib.Enlargedppt();
	this.instance_3.setTransform(92.4,185,0.4998,0.4998,-7.0532);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).wait(1));

	// shadow
	this.instance_4 = new lib.shadow();
	this.instance_4.setTransform(141.4,363.1,0.9996,0.9996,-7.0532,0,0,43.3,168.6);
...
p.nominalBounds = new cjs.Rectangle(77.8,165.2,216.8,370.3);
...
(lib.mountain_anim = function(mode,startPosition,loop) {
	...
	this.indicator.setTransform(216.7,426.55,1.3,1.3,0,0,0,59,5.8);

	this.btn_expand = new lib.Btn_Expand();
	this.btn_expand.name = "btn_expand";
	this.btn_expand.setTransform(273.15,337.2,1,1,0,0,0,14.8,14.8);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EgiwAiTMAAAhElMBFhAAAMAAABElg");
	mask.setTransform(222.525,259.475);

	// Onedrive
	this.screen_1_onedrive = new lib.Screen_1_OneDrive();
	this.screen_1_onedrive.name = "screen_1_onedrive";
	this.screen_1_onedrive.setTransform(147,313.2,0.6799,0.6799,0,0,0,191.6,129.3);

	this.screen_2_onedrive = new lib.Screen_2_OneDrive();
	this.screen_2_onedrive.name = "screen_2_onedrive";
	this.screen_2_onedrive.setTransform(285.55,263.05,0.6799,0.6799,0,0,0,291.2,176.7);
	...
	this.screen_1_excel.setTransform(147,313.2,0.6799,0.6799,0,0,0,191.6,129.3);

	this.screen_2_excel = new lib.Screen_2_Excel();
	this.screen_2_excel.name = "screen_2_excel";
	this.screen_2_excel.setTransform(285.55,263.05,0.6799,0.6799,0,0,0,291.2,176.7);
	...
	this.screen_1_word.setTransform(147,313.2,0.6799,0.6799,0,0,0,191.6,129.3);

	this.screen_2_word = new lib.Screen_2_Word();
	this.screen_2_word.name = "screen_2_word";
	this.screen_2_word.setTransform(285.55,263.05,0.6799,0.6799,0,0,0,291.2,176.7);
	...
	this.screen_1_ppt.setTransform(147,313.2,0.6799,0.6799,0,0,0,191.6,129.3);

	this.screen_2_ppt = new lib.Screen_2_PPT();
	this.screen_2_ppt.name = "screen_2_ppt";
	this.screen_2_ppt.setTransform(285.55,263.05,0.6799,0.6799,0,0,0,291.2,176.7);
...
}).prototype = getMCSymbolPrototype(lib.mountain_anim, new cjs.Rectangle(16.8,142.9,428.3,290.70000000000005), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EhL/ByAMAAAjj/MCX/AAAMAAADj/g");
	var mask_1_graphics_51 = new cjs.Graphics().p("EhL1BxyMAAAjjjMCXrAAAMAAADjjg");
	var mask_1_graphics_52 = new cjs.Graphics().p("EhL2BxyMAAAjjjMCXtAAAMAAADjjg");
	var mask_1_graphics_53 = new cjs.Graphics().p("EhL2BxyMAAAjjjMCXtAAAMAAADjjg");
	var mask_1_graphics_54 = new cjs.Graphics().p("EhL2BxzMAAAjjlMCXtAAAMAAADjlg");
	var mask_1_graphics_55 = new cjs.Graphics().p("EhL3Bx0MAAAjjnMCXvAAAMAAADjng");
	var mask_1_graphics_56 = new cjs.Graphics().p("EhL3Bx1MAAAjjpMCXvAAAMAAADjpg");
	var mask_1_graphics_57 = new cjs.Graphics().p("EhL4Bx2MAAAjjrMCXxAAAMAAADjrg");
	var mask_1_graphics_58 = new cjs.Graphics().p("EhL5Bx3MAAAjjtMCXzAAAMAAADjtg");
	var mask_1_graphics_59 = new cjs.Graphics().p("EhL6Bx4MAAAjjvMCX1AAAMAAADjvg");
	var mask_1_graphics_60 = new cjs.Graphics().p("EhL7Bx6MAAAjjzMCX3AAAMAAADjzg");
	var mask_1_graphics_61 = new cjs.Graphics().p("EhL8Bx8MAAAjj3MCX5AAAMAAADj3g");
	var mask_1_graphics_62 = new cjs.Graphics().p("EhL+Bx+MAAAjj7MCX9AAAMAAADj7g");
	var mask_1_graphics_63 = new cjs.Graphics().p("EhL/ByAMAAAjj/MCX/AAAMAAADj/g");
	var mask_1_graphics_64 = new cjs.Graphics().p("EhMBByDMAAAjkFMCYDAAAMAAADkFg");
	var mask_1_graphics_65 = new cjs.Graphics().p("EhMCByGMAAAjkLMCYFAAAMAAADkLg");
	var mask_1_graphics_66 = new cjs.Graphics().p("EhMEByIMAAAjkPMCYJAAAMAAADkPg");
	var mask_1_graphics_67 = new cjs.Graphics().p("EhMGByLMAAAjkVMCYNAAAMAAADkVg");
	var mask_1_graphics_68 = new cjs.Graphics().p("EhMJByPMAAAjkdMCYTAAAMAAADkdg");
	var mask_1_graphics_69 = new cjs.Graphics().p("EhMLBySMAAAjkjMCYXAAAMAAADkjg");
	var mask_1_graphics_70 = new cjs.Graphics().p("EhM3ByWMAAAjkrMCYcAAAMAAADkrg");
	var mask_1_graphics_71 = new cjs.Graphics().p("EhTlByaMAAAjkzMCYhAAAMAAADkzg");
	var mask_1_graphics_72 = new cjs.Graphics().p("EhanByeMAAAjk7MCYmAAAMAAADk7g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:298.9399,y:341.2348}).wait(51).to({graphics:mask_1_graphics_51,x:297.9992,y:340.4446}).wait(1).to({graphics:mask_1_graphics_52,x:295.7994,y:340.4491}).wait(1).to({graphics:mask_1_graphics_53,x:289.2,y:340.4625}).wait(1).to({graphics:mask_1_graphics_54,x:278.2009,y:340.4847}).wait(1).to({graphics:mask_1_graphics_55,x:262.8022,y:340.5159}).wait(1).to({graphics:mask_1_graphics_56,x:243.0039,y:340.556}).wait(1).to({graphics:mask_1_graphics_57,x:218.8059,y:340.605}).wait(1).to({graphics:mask_1_graphics_58,x:190.2083,y:340.663}).wait(1).to({graphics:mask_1_graphics_59,x:157.2111,y:340.7298}).wait(1).to({graphics:mask_1_graphics_60,x:119.8143,y:340.8055}).wait(1).to({graphics:mask_1_graphics_61,x:78.0178,y:340.8902}).wait(1).to({graphics:mask_1_graphics_62,x:31.8218,y:340.9838}).wait(1).to({graphics:mask_1_graphics_63,x:-18.774,y:341.0862}).wait(1).to({graphics:mask_1_graphics_64,x:-73.7693,y:341.1976}).wait(1).to({graphics:mask_1_graphics_65,x:-133.1643,y:341.3179}).wait(1).to({graphics:mask_1_graphics_66,x:-196.9589,y:341.4471}).wait(1).to({graphics:mask_1_graphics_67,x:-265.1531,y:341.5852}).wait(1).to({graphics:mask_1_graphics_68,x:-337.7469,y:341.7323}).wait(1).to({graphics:mask_1_graphics_69,x:-414.7404,y:341.8882}).wait(1).to({graphics:mask_1_graphics_70,x:-491.9867,y:342.0531}).wait(1).to({graphics:mask_1_graphics_71,x:-535.0122,y:342.2268}).wait(1).to({graphics:mask_1_graphics_72,x:-580,y:342.8979}).wait(3));
...
p.nominalBounds = new cjs.Rectangle(-1160,-389.9,1945.4,1465.4);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.snowflakes_1.setTransform(251.55,44.55);
	...
	this.snowflakes_2.setTransform(131.25,113.05);
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-2.7,0,322.7,480), null);
...
(lib.Page = function(mode,startPosition,loop) {
	...
	this.Btn_return.setTransform(277.7,384.7,1.4,1.4,0,0,0,14.8,14.8);
...
}).prototype = getMCSymbolPrototype(lib.Page, new cjs.Rectangle(77.8,-39.7,258.3,575.2), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.hit_shrink.setTransform(272.05,379.55,1.0595,1.0595,0,0,0,9.5,10);
	...
	this.txtCta.setTransform(37.75,429.1,0.9555,0.9555,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(81.1,429.2,0.9013,0.9013,0,0,0,0.1,0.2);
	...
	this.no_hit.setTransform(215.35,412.65,0.6292,0.1096,0,0,0,150.1,125);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-9.2,-39.7,974.6,575.2), null);


// stage content:
(lib.M365_MobileFY21Q2Holiday_USA_320x480_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function () {
			...
			mc.txtCta.alpha = 1
				...
				exportRoot.TL_MainExpand.from(mc.Enlarged.obj2, 1, {x: "+=60",y: "+=400", ease:Power2.easeOut}, "-=0.4");
...
p.nominalBounds = new cjs.Rectangle(150.8,200.3,814.5999999999999,335.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q2Holiday_USA_320x480_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_.png?1605025460511", id:"M365_MobileFY21Q2Holiday_USA_320x480_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
