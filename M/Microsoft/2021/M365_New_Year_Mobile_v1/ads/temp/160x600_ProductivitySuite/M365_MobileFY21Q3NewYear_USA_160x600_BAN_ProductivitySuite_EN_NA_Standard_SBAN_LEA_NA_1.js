...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_160x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,320,1200]]}
];
...
(lib.Outlook_Productivity_160x600 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_160x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(65.7,24.95,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(89.85,549.4,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(168.2,546.6,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BGImg
	this.instance_1 = new lib.Outlook_Productivity_160x600();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,160.7,600), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_160x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,80.69999999999999,299.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_160x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605903932619", id:"M365_MobileFY21Q3NewYear_USA_160x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
