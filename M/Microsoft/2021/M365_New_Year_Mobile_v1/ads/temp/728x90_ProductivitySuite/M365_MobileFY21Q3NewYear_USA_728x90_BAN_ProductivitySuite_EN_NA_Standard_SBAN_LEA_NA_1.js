...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_728x90_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,1456,180]]}
];
...
(lib.Outlook_Productivity_728x90 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_728x90_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(657.35,55.25,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(735.7,52.45,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BGImg
	this.instance_1 = new lib.Outlook_Productivity_728x90();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,728.2,90), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_728x90_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,364.20000000000005,45);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_728x90_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605905134446", id:"M365_MobileFY21Q3NewYear_USA_728x90_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
