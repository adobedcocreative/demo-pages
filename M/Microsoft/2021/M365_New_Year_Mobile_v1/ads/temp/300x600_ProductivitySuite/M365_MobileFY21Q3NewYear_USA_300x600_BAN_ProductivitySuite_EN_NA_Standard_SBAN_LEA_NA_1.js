...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_300x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,600,1200]]}
];
...
(lib.Outlook_Productivity_300x600 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_300x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.05,2.4,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoRCxIAAlhIQjAAIAAFhg");
	this.shape.setTransform(-59.4,1.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-112.4,-16.2,106,35.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(81.3,41.75,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(229.55,549.4,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(307.9,546.6,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BGImg
	this.instance_1 = new lib.Outlook_Productivity_300x600();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300.4,600), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_300x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,150.39999999999998,299.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_300x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605904647892", id:"M365_MobileFY21Q3NewYear_USA_300x600_BAN_ProductivitySuite_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
