...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,600,500]]}
];
...
(lib.OneDrive_Safety_300x250_Mobile = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_300x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.setTransform(10.75,12.1);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.05,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ApRC5IAAlyISjAAIAAFyg");
	this.shape.setTransform(-65.75,2.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-125.1,-16.2,118.69999999999999,37.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(65.95,25.2,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(41.9,215.3,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(120.25,210.5,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BG
	this.instance_1 = new lib.OneDrive_Safety_300x250_Mobile();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-22.1,0,322.1,250), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_300x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(127.9,125,172.1,124.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_300x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1606335463784", id:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
