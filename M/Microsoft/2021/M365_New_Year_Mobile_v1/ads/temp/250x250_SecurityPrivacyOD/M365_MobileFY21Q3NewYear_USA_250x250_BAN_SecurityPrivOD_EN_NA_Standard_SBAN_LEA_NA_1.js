...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_250x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,500,500]]}
];
...
(lib.OneDrive_Safety_250x250_Mobile = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_250x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.05,2.9,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(65.9,25.15,0.7431,0.7432,0,0,0,67.2,12.4);
	...
	this.txtCta.setTransform(41.9,214.5,1,1,0,0,0,0.7,0.1);
	...
	// BG
	this.instance_1 = new lib.OneDrive_Safety_250x250_Mobile();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-22.1,0,272.1,250), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_250x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(102.9,125,147.1,124.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_250x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1606335903723", id:"M365_MobileFY21Q3NewYear_USA_250x250_BAN_SecurityPrivOD_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
