...
(lib.excelDesktop300x6002x = function() {
	this.initialize(ss["M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(104.2875,4.825,1,1,0,0,180);
...
}).prototype = getMCSymbolPrototype(lib.Page_indicator, new cjs.Rectangle(-7.3,-1.2,115.2,12.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub1.name = "sub1";
	this.sub1.setTransform(30.2,72.4,1,1,0,0,0,30.2,50.4);
...
if (reversed == null) { reversed = false; }
	...
	this.sub4.name = "sub4";
	this.sub4.setTransform(138.6,133.2,1,1,0,0,0,20.6,19.2);
...
if (reversed == null) { reversed = false; }
	...
	this.hitNext.setTransform(258.1,220.1,1.8387,2.8876);
...
// stage content:
(lib.M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1619014884072", id:"M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
