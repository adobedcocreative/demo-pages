...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[184,0,270,206],[0,0,182,306]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(53,372,0.606,0.606);

	this.instance_2 = new lib.WordDesktop();
	this.instance_2.setTransform(139,330,1.18,1.18);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1615291153789", id:"screen3_atlas_1"}
	],
	preloads: []
};
