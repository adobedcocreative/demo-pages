...
(lib.excelDesktop300x6002x = function() {
	this.initialize(ss["M365_MobileFY21Q4Opt_USA_320x480_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(104.3375,4.825,1,1,0,0,180);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.dot_1},{t:this.dot_2},{t:this.dot_3},{t:this.dot_4},{t:this.dot_5},{t:this.dot_6}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Page_indicator, new cjs.Rectangle(-7.3,-1.2,115.3,12.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub1.name = "sub1";
	this.sub1.setTransform(30.2,88.9,1,1,0,0,0,30.2,50.4);
...
if (reversed == null) { reversed = false; }
	...
	this.sub4.name = "sub4";
	this.sub4.setTransform(176.05,151.85,1.495,1.495,0,0,0,20.6,19.2);
...
}).prototype = getMCSymbolPrototype(lib.bgScreens, new cjs.Rectangle(17,148.1,351.5,231.20000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitNext.setTransform(275.4,428.2,1.8387,2.8876);
	...
	this.cta.name = "cta";
	this.cta.setTransform(0.2,413.4,1,1,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_MobileFY21Q4Opt_USA_320x480_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q4Opt_USA_320x480_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1619015125366", id:"M365_MobileFY21Q4Opt_USA_320x480_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
