...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(16.7,215.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,212.75,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-2,0,375.3,252.1), null);


// stage content:
(lib.M365_MobileFY21Q4ConsRefresh_USA_300x250_BAN_AllUp_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(148,125,153.2,127);
// library properties:
lib.properties = {
