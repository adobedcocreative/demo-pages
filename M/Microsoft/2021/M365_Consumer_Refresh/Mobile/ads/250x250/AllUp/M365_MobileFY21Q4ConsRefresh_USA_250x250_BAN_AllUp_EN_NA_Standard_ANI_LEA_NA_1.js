...
}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,250,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.bg_sub.cache(0,0,250,250,1)
	}
	...
	this.bg_sub.setTransform(398.95,327.05,4.068,3.9751,0,0,0,150,124.8);

	this.timeline.addTween(cjs.Tween.get(this.bg_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(-211.2,-169,1017,993.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-25.85,2.1,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.7599,scaleY:2.7599,x:35.9,y:-39.8},33,cjs.Ease.quadInOut).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhMtBL+MAAAiX7MCZbAAAMAAACX7g");
	this.shape.setTransform(299.85,340.425);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(65).to({scaleX:3.2498,scaleY:3.2498,x:299.45,y:342.25},0).to({alpha:0},15).wait(19));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-874.5,-613.3,3305.1,3229.5);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(125.3,126.05,0.27,0.27,0,0,0,299.4,340.6);
	...
	this.replay_btn.setTransform(234.3,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.15,214.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.5,212.5,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-12.5,-11.5,274.5,268.8), null);


// stage content:
(lib.M365_MobileFY21Q4ConsRefresh_USA_250x250_BAN_AllUp_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(112.5,113.5,148.7,143.7);
// library properties:
lib.properties = {
