...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,311,239],[313,0,189,317]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(344,81,0.56,0.56);

	this.instance_2 = new lib.excelDesktop();
	this.instance_2.setTransform(249,220,0.98,0.98);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-5.1,-4.2,558.9,521.3000000000001), null);
...
p.nominalBounds = new cjs.Rectangle(250.9,251.8,302.9,265.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1615290653357", id:"screen4_atlas_1"}
	],
	preloads: []
};
