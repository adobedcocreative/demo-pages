...
(lib.excelDesktop300x6002x = function() {
	this.initialize(ss["M365_MobileFY21Q4ConsRefresh_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.img7Sub1, new cjs.Rectangle(0,0,78.9,135.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2774,0.2774);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img6Sub2, new cjs.Rectangle(0,0,176.9,134.8), null);
...
}).prototype = getMCSymbolPrototype(lib.img6Sub1, new cjs.Rectangle(0,0,61,103.7), null);
...
}).prototype = getMCSymbolPrototype(lib.img5Sub2, new cjs.Rectangle(0,0,168.4,129.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2957,0.2957);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2942,0.2942);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img4Sub2, new cjs.Rectangle(0,0,164.7,125.7), null);
...
}).prototype = getMCSymbolPrototype(lib.img4Sub1, new cjs.Rectangle(0,0,58,97), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.3002,0.3002);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img3Sub1, new cjs.Rectangle(0,0,58,95.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub1.name = "sub1";
	this.sub1.setTransform(111.9,64.8,1,1,0,0,0,47.9,81.8);

	this.timeline.addTween(cjs.Tween.get(this.sub1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img7, new cjs.Rectangle(64,-17,78.9,135.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub2.name = "sub2";
	this.sub2.setTransform(129.5,72.45,1,1,0,0,0,88.5,67.4);

	this.sub1 = new lib.img6Sub1();
	this.sub1.name = "sub1";
	this.sub1.setTransform(28.5,76.9,1,1,0,0,0,30.5,51.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sub1},{t:this.sub2}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img6, new cjs.Rectangle(-2,5.1,203.7,122.30000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub2.name = "sub2";
	this.sub2.setTransform(129.2,65.7,1,1,0,0,0,84.2,64.7);

	this.sub1 = new lib.img5Sub1();
	this.sub1.name = "sub1";
	this.sub1.setTransform(27.3,74.4,1,1,0,0,0,30.3,50.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sub1},{t:this.sub2}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img5, new cjs.Rectangle(-3,1,207.8,122.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub2.name = "sub2";
	this.sub2.setTransform(126.65,64.3,1,1,0,0,0,82.4,62.8);

	this.sub1 = new lib.img4Sub1();
	this.sub1.name = "sub1";
	this.sub1.setTransform(25.9,72.5,1,1,0,0,0,28.9,48.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sub1},{t:this.sub2}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img4, new cjs.Rectangle(-3,1.5,205.8,121.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub2.name = "sub2";
	this.sub2.setTransform(127.25,65.8,1,1,0,0,0,83,65.8);

	this.sub1 = new lib.img3Sub1();
	this.sub1.name = "sub1";
	this.sub1.setTransform(24.9,72.4,1,1,0,0,0,28.9,47.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sub1},{t:this.sub2}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.img3, new cjs.Rectangle(-4,0,209.7,128.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub2.name = "sub2";
	this.sub2.setTransform(129.4,63.1,1,1,0,0,0,82.4,63.1);
...
}).prototype = getMCSymbolPrototype(lib.img2, new cjs.Rectangle(0,0,211.7,125.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub6.name = "sub6";
	this.sub6.setTransform(73.6,67.15,0.89,0.89,0,0,0,34.7,23.5);

	this.sub5 = new lib.img1Sub5();
	this.sub5.name = "sub5";
	this.sub5.setTransform(133.65,41.95,0.89,0.89,0,0,0,20.2,17.2);

	this.sub4 = new lib.img1Sub4();
	this.sub4.name = "sub4";
	this.sub4.setTransform(123.35,118.65,0.89,0.89,0,0,0,20.6,19.3);

	this.sub3 = new lib.img1Sub3();
	this.sub3.name = "sub3";
	this.sub3.setTransform(72.05,11.4,0.89,0.89,0,0,0,14,12.8);

	this.sub2 = new lib.img1Sub2();
	this.sub2.name = "sub2";
	this.sub2.setTransform(44.9,122.25,0.89,0.89,0,0,0,20.5,17.4);

	this.sub1 = new lib.img1Sub1();
	this.sub1.name = "sub1";
	this.sub1.setTransform(16,61.2,0.89,0.89,0,0,0,18,14.8);
...
}).prototype = getMCSymbolPrototype(lib.img1, new cjs.Rectangle(0,0,151.5,137.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.img7.name = "img7";
	this.img7.setTransform(210,135.55,1.01,1.01,0,0,0,106.6,63.1);
	...
	this.img6.name = "img6";
	this.img6.setTransform(252.75,133.1,1,1,0,0,0,106.5,63.1);
	...
	this.img5.name = "img5";
	this.img5.setTransform(239.2,136.05,1,1,0,0,0,106.5,63.1);
	...
	this.img4.name = "img4";
	this.img4.setTransform(239.2,136.05,1,1,0,0,0,106.5,63.1);
	...
	this.img3.name = "img3";
	this.img3.setTransform(215.9,136.05,1,1,0,0,0,106.5,63.1);
	...
	this.img2.name = "img2";
	this.img2.setTransform(236.5,137.1,1,1,0,0,0,106.5,63.1);
	...
	this.img1.name = "img1";
	this.img1.setTransform(211,121.1,1,1,0,0,0,85,77.1);

	this.timeline.addTween(cjs.Tween.get(this.img1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bgScreens, new cjs.Rectangle(105.4,44,242.49999999999997,157.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(89.65,14.95,0.7084,0.65,0,0,0,13.6,10.7);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AocDIIAAmPIQ5AAIAAGPg");
	this.shape.setTransform(54.125,15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(0,-5,108.3,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hitPrev.setTransform(115.95,215.3,1.7325,2.5981,0,0,0,-0.1,0.2);
	...
	this.nav.name = "nav";
	this.nav.setTransform(180.35,216.2,0.9189,0.9189,0,0,0,59.1,6.1);
	...
	this.hit.name = "hit";
	this.hit.setTransform(125,125,15.6246,15.4324);
	...
	this.txtCta.setTransform(0.2,214.6,1,1,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(0.3,200.3,1,1,0,0,0,0.3,0.3);
	...
	this.screens.setTransform(105.4,100.15,1,1,0,0,0,124,94.6);

	this.timeline.addTween(cjs.Tween.get(this.screens).wait(1));

	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#F4F4F4","#DBDBDD"],[0,1],53.1,0,0,53.1,0,125).s().p("AzhTiMAAAgnDMAnDAAAMAAAAnDg");
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-7.9,-7.1,337.09999999999997,265.3), null);


// stage content:
(lib.M365_MobileFY21Q4ConsRefresh_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(125,125,203.3,124.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q4ConsRefresh_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1615566095670", id:"M365_MobileFY21Q4ConsRefresh_USA_250x250_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
