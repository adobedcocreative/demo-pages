...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q4Opt_USA_250x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[581,0,551,423],[1879,0,123,116],[1677,342,189,317],[581,425,539,412],[1663,661,208,141],[192,443,187,312],[1868,420,84,77],[0,0,579,441],[1879,224,121,103],[1677,0,200,340],[1879,118,123,104],[1134,0,541,430],[0,443,190,313],[1122,432,539,412],[1879,329,108,89],[381,443,182,306]]}
];
...
(lib.excelDesktop300x6002x = function() {
	this.initialize(ss["M365_MobileFY21Q4Opt_USA_250x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(104.3875,4.825,1,1,0,0,180);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.dot_1},{t:this.dot_2},{t:this.dot_3},{t:this.dot_4},{t:this.dot_5},{t:this.dot_6},{t:this.shape_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Page_indicator, new cjs.Rectangle(-7.3,-1.2,125.8,13.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.sub1.name = "sub1";
	this.sub1.setTransform(27.2,74.4,1,1,0,0,0,30.2,50.4);
...
if (reversed == null) { reversed = false; }
	...
	this.sub4.name = "sub4";
	this.sub4.setTransform(123.35,118.55,0.89,0.89,0,0,0,20.6,19.2);
...
if (reversed == null) { reversed = false; }
	...
	this.hitNext.setTransform(227.75,215.05,1.6544,2.5982,0,0,0,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.hitPrev},{t:this.hitNext},{t:this.hit1},{t:this.hit2},{t:this.hit3},{t:this.hit4},{t:this.hit5},{t:this.hit6}]}).wait(1));
	...
	this.cta.name = "cta";
	this.cta.setTransform(0.2,200.3,1,1,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,329.2,250), null);


// stage content:
(lib.M365_MobileFY21Q4Opt_USA_250x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
		...
		this.runBanner = function() {
			...
			exportRoot.tl6.pause();
				...
				exportRoot.nextScene = function() {
					...
					if(prevSelection==0) {prevSelection=6;}
				...
				exportRoot.tlText.to([exportRoot.headline1,exportRoot.headline2,exportRoot.headline3,exportRoot.headline4,exportRoot.headline5,exportRoot.headline6,mc.screens.img1,mc.screens.img2,mc.screens.img3,mc.screens.img4,mc.screens.img5,mc.screens.img6], 0, { alpha: 0, onStart:function(){exportRoot.nextScene();}});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q4Opt_USA_250x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1619015010911", id:"M365_MobileFY21Q4Opt_USA_250x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
