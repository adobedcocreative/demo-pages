...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(68.8,570.8,1,1,0,0,0,0.7,0.1);
...
// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_160x600_BAN_Outlook_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=6");
				...
				this.tlText.from(mc.cta, { duration: 0.8, x: "+=200", onComplete:function(){exportRoot.videoState="reset"}}, "-=0.6");
