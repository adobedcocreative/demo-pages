...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:24.95},12,cjs.Ease.quadInOut).wait(39).to({alpha:0},19,cjs.Ease.quadInOut).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(65).to({alpha:0},19).wait(15));
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(54.05,23.35,0.7422,0.7422,0,0,0,0.3,0.5);
...
// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_160x600_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=6.4");
