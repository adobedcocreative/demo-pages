...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.25,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnNB7IAAj1IObAAIAAD1g");
	this.shape.setTransform(-57.975,2.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-104.1,-10.2,92.3,24.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:24.95},12,cjs.Ease.quadInOut).wait(39).to({scaleX:3.1008,scaleY:3.1008,alpha:0},15,cjs.Ease.none).wait(19));
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(67.55,570.8,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-14.3,-3.3,188.3,607.3), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_160x600_BAN_PPT_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			//	this.tlText.to(mc.logo_intro.logoWhite, { duration: 0.6, alpha: 1}, "-=0.6");
				...
				this.tlText.to(logo, { duration: 0.8, alpha: 1}, "+=8");	
...
p.nominalBounds = new cjs.Rectangle(65.7,296.6,107.7,307.19999999999993);
// library properties:
lib.properties = {
