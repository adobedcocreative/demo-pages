...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-59.225,2.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.4,-9.1,102.4,24.1), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6.3,-1,308.40000000000003,252.1), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_Outlook_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				exportRoot.headline3.alpha=1
		
				this.tlText = gsap.timeline({defaults: {ease:Power4.easeOut}});
		
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=6.5");		
...
p.nominalBounds = new cjs.Rectangle(143.7,124,157.5,127);
// library properties:
lib.properties = {
