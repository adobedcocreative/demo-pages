...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnmB9IAAj5IPNAAIAAD5g");
	this.shape.setTransform(-61.775,1.95);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.4,-10.5,97.30000000000001,25), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(54.45,23.3,0.7422,0.7422,0,0,0,0.2,0.5);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,218.15,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6.3,-0.5,308.40000000000003,252.1), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_Word_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=8.1");	
...
p.nominalBounds = new cjs.Rectangle(143.7,124.5,157.5,127);
// library properties:
lib.properties = {
