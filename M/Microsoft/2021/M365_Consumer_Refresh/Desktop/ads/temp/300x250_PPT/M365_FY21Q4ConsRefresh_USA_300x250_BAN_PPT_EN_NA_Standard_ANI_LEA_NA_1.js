...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.4,-9.7,102.5,24.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(17.05,219.9,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,217.45,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-11.9,-1,314,252.1), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=7.6");	
...
p.nominalBounds = new cjs.Rectangle(138.1,124,163.1,127);
// library properties:
lib.properties = {
