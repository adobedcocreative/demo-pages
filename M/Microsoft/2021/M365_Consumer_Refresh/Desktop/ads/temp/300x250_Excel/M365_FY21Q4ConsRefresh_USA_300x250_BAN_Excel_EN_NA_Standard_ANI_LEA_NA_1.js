...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,218.25,1.136,1.136,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=6.1");	
