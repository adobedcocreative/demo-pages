...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:24.95},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.3999,scaleY:2.3999,x:-13.75,y:6.7},33,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(144.1,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(68.05,570.8,1,1,0,0,0,0.7,0.1);
...
// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_160x600_BAN_AllUp_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
