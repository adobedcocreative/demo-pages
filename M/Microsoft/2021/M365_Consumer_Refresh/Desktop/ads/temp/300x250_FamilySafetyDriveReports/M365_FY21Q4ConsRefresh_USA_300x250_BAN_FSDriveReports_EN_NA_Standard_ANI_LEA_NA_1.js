...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.25,3.8,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnOB4IAAjwIOcAAIAADwg");
	this.shape.setTransform(-58.85,2.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-105.1,-9.1,92.5,24.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({alpha:0},18,cjs.Ease.quadInOut).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(65).to({alpha:0},18).wait(16));
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(54.05,23.15,0.7422,0.7422,0,0,0,0.3,0.5);
	...
	this.txtCta.setTransform(17.05,220.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.9,216.75,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-1,303.1,256.6), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_FSDriveReports_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149,124,152.2,127);
// library properties:
lib.properties = {
