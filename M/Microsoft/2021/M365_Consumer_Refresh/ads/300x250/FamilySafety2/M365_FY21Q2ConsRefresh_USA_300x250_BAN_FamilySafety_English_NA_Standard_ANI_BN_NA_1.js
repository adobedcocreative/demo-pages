...
lib.ssMetadata = [
		{name:"M365_FY21Q2ConsRefresh_USA_300x250_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,788,639]]}
];
...
(lib.FSTessellatedScreen = function() {
	this.initialize(ss["M365_FY21Q2ConsRefresh_USA_300x250_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.FSTessellatedScreen();
...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(136.25,218.25,1.136,1.136,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_FY21Q2ConsRefresh_USA_300x250_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				for (var i = 0; i < exportRoot.headline3.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline3[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.4");
				}		
				...
				for (var i = 0; i < exportRoot.headline4.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline4[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.6");
				}
				for (var i = 0; i < exportRoot.headline5.length; i++) {
				...
				for (var i = 0; i < exportRoot.headline8.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline8[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "+=0.6");
				}
				for (var i = 0; i < exportRoot.headline9.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline9[i], 0.1, { alpha: 0, ease:Power4.easeOut}, "-=0.1");
				}
				...
				for (var i = 0; i < exportRoot.headline10.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline10[i], 0.6, { alpha: 0, ease:Power4.easeOut}, "+=0.6");
				}
				for (var i = 0; i < exportRoot.headline11.length; i++) {
					if (i==0) this.tlText.to(exportRoot.headline11[i], 0.6, { alpha: 0, ease:Power4.easeOut, onStart:function(){exportRoot.videoState="playing"; vid.play(); }}, "-=0.6");
				}
				...
				for (var i = 0; i < exportRoot.headline12.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline12[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.8");
					if (i!=0) this.tlText.from(exportRoot.headline12[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
				for (var i = 0; i < exportRoot.headline13.length; i++) {
					if (i==0) this.tlText.from(exportRoot.headline13[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.6");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2ConsRefresh_USA_300x250_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1600792271710", id:"M365_FY21Q2ConsRefresh_USA_300x250_BAN_FamilySafety_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
