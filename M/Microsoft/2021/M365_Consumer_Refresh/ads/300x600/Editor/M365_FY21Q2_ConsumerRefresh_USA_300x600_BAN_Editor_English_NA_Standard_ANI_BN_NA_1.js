...
lib.ssMetadata = [
		{name:"M365_FY21Q2_ConsumerRefresh_USA_300x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q2_ConsumerRefresh_USA_300x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.8,3.7,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("Am5B2IAAjrINyAAIAADrg");
	this.shape.setTransform(-59.25,2.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-103.4,-9.1,88.30000000000001,23.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(152.65,332.85,0.7458,0.597,0,-28.3396,-17.0391,107.9,-133.6);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(152.85,333.95,0.7458,0.7458,0,0,0,124,79.7);
	...
	this.txtCta.setTransform(236.35,553.6,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-135.3,0,631.5,705.1), null);


// stage content:
(lib.M365_FY21Q2_ConsumerRefresh_USA_300x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.2, {x: "+=13",y: "+=4",scaleX: "0.697",scaleY: "0.558", ease:Power4.easeInOut}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, {x: "+=13",y: "+=4",scaleX: "0.697",scaleY: "0.697", ease:Power4.easeInOut}, "-=1.2");
				...
				exportRoot.tl1.to(screen, 1.2, {x: "-=13",y: "-=4",scaleX: "0.746",scaleY: "0.597", ease:Power4.easeInOut}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, {x: "-=13",y: "-=4",scaleX: "0.746",scaleY: "0.746", ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(38.2,300,458,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2_ConsumerRefresh_USA_300x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1599133195707", id:"M365_FY21Q2_ConsumerRefresh_USA_300x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
