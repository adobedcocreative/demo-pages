...
// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_160x600_BAN_Word_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(logo, { duration: 0.8, alpha: 0}, "+=8.4");
