...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.05,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("An/B4IAAjwIP/AAIAADwg");
	this.shape.setTransform(-64.325,2.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.5,-9.1,102.4,24.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(54.5,23.3,0.7422,0.7422,0,0,0,0.3,0.5);
	...
	this.txtCta.setTransform(17,220.25,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(118.55,217.5,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-12.9,-1,315,252.1), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_OD_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(137.1,124,164.1,127);
// library properties:
lib.properties = {
