...
lib.ssMetadata = [
		{name:"M365_FY21Q2_ConsumerRefresh_USA_160x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q2_ConsumerRefresh_USA_160x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#439AC7").ss(1.3,2,1).p("Ah2gIIDtAAAh2AJIDtAA");
...
if (reversed == null) { reversed = false; }
	...
	this.words.setTransform(142.3,-103.7,1.3343,1.3343,0,0,0,15.8,17.7);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(81.7,296.4,0.4006,0.3205,0,-28.3137,-17.0228,108,-132.2);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(81,297.6,0.4014,0.4014,0,0,0,124.5,80.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-61.6,-13.5,327.20000000000005,627.6), null);


// stage content:
(lib.M365_FY21Q2_ConsumerRefresh_USA_160x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(screen, 1.2, { ease:Power4.easeInOut}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, { ease:Power4.easeInOut}, "-=1.2");
				exportRoot.tl1.to(screen.blur, 1.4, {alpha :1,ease:Power4.easeInOut}, "-=1.4");
		
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "1.9",scaleY: "1.9", x: "-=10",y: "-=20",ease:Power4.easeInOut,onComplete:function(){screen.popup.gotoAndPlay(0);}}, "-=1.2");
				exportRoot.tl1.to(screen.popup.popup_shdw, 1.4, {x: "-=10",y: "+=10",alpha :0.5,ease:Power4.easeInOut}, "-=1.4");
				exportRoot.tl1.to(pencil, 1.4, {rotation: -15,scaleX: "1.1",scaleY: "1.1", x: "-=60",y: "+=90",ease:Power4.easeInOut}, "-=1.4");
				...
				exportRoot.tl1.to(pencil, 0.8, {y: "+=75",x: "-=20",ease:Power4.easeInOut}, "+=0.0");
				...
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "0.98",scaleY: "0.98", x: "+=10",y: "+=20",ease:Power4.easeInOut}, "-=0.4");
...
p.nominalBounds = new cjs.Rectangle(18.4,286.5,247.20000000000002,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2_ConsumerRefresh_USA_160x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1.png?1599129373672", id:"M365_FY21Q2_ConsumerRefresh_USA_160x600_BAN_Editor_English_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
