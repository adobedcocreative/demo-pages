...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.2638,scaleY:2.2638,x:-636.4,y:273.8},29,cjs.Ease.quadInOut).wait(5));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EirIAU/MAAAgp9MFWQAAAMAAAAp9g");
	this.shape.setTransform(299.85,340.4);
...
p.nominalBounds = new cjs.Rectangle(-795.4,-68.2,2190.5,815.6);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.95,0.55,0.68,0.68,0,0,0,13.6,10.6);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AoMCLIAAkVIQZAAIAAEVg");
	this.shape.setTransform(-57.2,0.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.7,-13.6,105.10000000000001,27.799999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(266.7,-68.55,0.334,0.334,0,0,0,0.5,-0.3);
	...
	this.logo.name = "logo";
	this.logo.setTransform(65.2,23.9,0.7545,0.7545,0,0,0,15.3,1.4);
	...
	this.txtCta.setTransform(637.3,60.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(735.65,59.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,732.5,90.1), null);


// stage content:
(lib.M365_FY21Q4Opt_USA_728x90_BAN_PartnerBenefitsIcons_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.to(mc.logo_intro,{duration:0.6, alpha: 0, ease:Power3.easeIn}, "<-.3");

				this.tlText.from(mc.logo,{duration:0.6, alpha: 0, ease:Power3.easeIn}, ">+4.2");

				this.tlText.from(exportRoot.headline2,{duration:1.2, x: "+=50", alpha: 0, stagger: 0.05, ease:Power4.easeOut}, "<+0.6");
...
p.nominalBounds = new cjs.Rectangle(364,45,366.20000000000005,45.099999999999994);
// library properties:
lib.properties = {
