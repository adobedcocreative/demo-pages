...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.4439,scaleY:2.4439,x:-13.45,y:6.25},29,cjs.Ease.quadInOut).wait(5));
...
p.nominalBounds = new cjs.Rectangle(-191.1,-68.2,982,817);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-63.175,0.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.1,-13.5,103.89999999999999,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(213.8,220.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(311.4,219.8);
...
// stage content:
(lib.M365_FY21Q4Opt_USA_300x250_BAN_PartnerBenefitsIcons_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
