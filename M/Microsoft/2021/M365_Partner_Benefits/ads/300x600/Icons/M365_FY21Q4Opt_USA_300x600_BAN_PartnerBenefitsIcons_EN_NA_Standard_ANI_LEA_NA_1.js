...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regX:0.2,scaleX:2.6399,scaleY:2.6399,x:78.55,y:-436.1},29,cjs.Ease.quadInOut).wait(5));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhGoCL4MAAAkXvMCNRAAAMAAAEXvg");
	this.shape.setTransform(299.9,340.55);
...
p.nominalBounds = new cjs.Rectangle(-152.1,-554.7,904.1,1790.5);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ApcCsIAAlXIS5AAIAAFXg");
	this.shape.setTransform(-53.7,-0.175);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.2,-17.4,121,34.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(51.3,186.6,0.335,0.335,0,0,0,0.5,0);
	...
	this.logo.name = "logo";
	this.logo.setTransform(90.5,41.4,0.8849,0.8849,0,0,0,15.4,1.4);
	...
	this.txtCta.setTransform(196.8,551.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(296.4,550.95);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,303.2,600.6), null);


// stage content:
(lib.M365_FY21Q4Opt_USA_300x600_BAN_PartnerBenefitsIcons_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(mc.cta, { duration: 0.8, x: "+=200", onComplete:function(){exportRoot.videoState="reset"}}, "-=0.4");
...
p.nominalBounds = new cjs.Rectangle(150,300,152.3,300.29999999999995);
// library properties:
lib.properties = {
