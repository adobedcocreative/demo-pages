...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3SMBRefresh_USA_250x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,400,335]]}
];
...
(lib.BG = function() {
	this.initialize(ss["M365_MobileFY21Q3SMBRefresh_USA_250x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AtVCbIAIk1IabAAIAIE1g");
	this.shape.setTransform(83.825,12.75);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadowSub, new cjs.Rectangle(-1.6,-2.7,170.9,31), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-50.25,18.75,0.8646,0.8881);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-50.2,18.8,337.2,282.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.cubeShadowSub.cache(0,0,190,31,2)
	}
	...
	this.cubeShadowSub.setTransform(83.4,-11,0.9,1,0,180,0,83.4,14.5);

	this.timeline.addTween(cjs.Tween.get(this.cubeShadowSub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadow, new cjs.Rectangle(6.9,-24.7,153.79999999999998,31), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-40.2,2.85,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Am9CkIAAlHIN6AAIAAFHg");
	this.shape.setTransform(-63,2.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-107.5,-13.9,89.1,32.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(53.8,22.9,0.7455,0.7455,0,0,0,0.1,0.4);
	...
	this.replay_btn.setTransform(233.2,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(190.7,214.25,1.2856,1.2856,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(276.3,210.3,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.cubeShadow.setTransform(124.5,218.55,1,1,0,0,0,82.9,-15.5);
	this.cubeShadow.alpha = 0;
	this.cubeShadow.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.cubeShadow.cache(5,-27,158,35);
	...
	this.Bg = new lib.Bg();
	this.Bg.name = "Bg";
	this.Bg.setTransform(179.2,32.2,0.975,0.975,0,0,0,182.8,52.1);

	this.timeline.addTween(cjs.Tween.get(this.Bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-48,-0.3,328.8,275.3), null);


// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_250x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.to(exportRoot.headline1,{duration:0.8, y: "-=60", alpha: 0}, "+=7.1");

				this.tlMain.from(exportRoot.headline2,{duration:0.8, y: "+=60", alpha: 0, stagger: 0.1}, "-=.6");
				this.tlMain.from(exportRoot.headline3,{duration:0.8, y: "+=60", alpha: 0, stagger: 0.1}, "-=.7");
				this.tlMain.to(mc.Bg,{duration:2, y: "-=10", x: "+=7", scale: "0.86", ease:Power4.easeInOut}, "-=2");


				this.tlMain.from(mc.cta, { duration: 0.6, x: "+=200"}, "-=0.7");
				this.tlMain.from(mc.txtCta, { duration: 0.6, x: "+=200"}, "-=0.7");
...
p.nominalBounds = new cjs.Rectangle(77.1,124.7,202.79999999999998,150.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3SMBRefresh_USA_250x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1607015642048", id:"M365_MobileFY21Q3SMBRefresh_USA_250x250_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
