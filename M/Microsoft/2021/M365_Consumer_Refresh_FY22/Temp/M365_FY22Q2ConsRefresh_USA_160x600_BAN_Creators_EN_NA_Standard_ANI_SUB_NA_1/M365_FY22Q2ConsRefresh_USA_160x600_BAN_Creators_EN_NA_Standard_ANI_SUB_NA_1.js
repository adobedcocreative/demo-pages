...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-32.8,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1379D2").s().p("AodB6IAAjyIQ7AAIAADyg");
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(143.85,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(38.45,550.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(191.1,547.6,1.4179,1.4179,0,0,0,0.3,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-176.5,0,384.4,600), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_160x600_BAN_Creators_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,91.9,267.5);
// library properties:
lib.properties = {
