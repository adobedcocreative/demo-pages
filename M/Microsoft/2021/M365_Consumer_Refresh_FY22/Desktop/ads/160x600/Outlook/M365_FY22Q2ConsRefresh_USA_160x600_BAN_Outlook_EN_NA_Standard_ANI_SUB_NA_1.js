...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(40.9,550.4,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(191.6,547.85,1.41,1.41,0,0,0,0.3,0.4);
...
// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_160x600_BAN_Outlook_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,92.5,267.5);
// library properties:
lib.properties = {
