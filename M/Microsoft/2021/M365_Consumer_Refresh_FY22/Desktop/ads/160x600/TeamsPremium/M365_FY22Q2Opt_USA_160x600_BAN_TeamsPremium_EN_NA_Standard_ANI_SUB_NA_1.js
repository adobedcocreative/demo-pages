...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ApmCgIAAk/ITNAAIAAE/g");
	this.shape.setTransform(-69.825,2.525);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-131.3,-13.4,123.00000000000001,31.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(35.55,552.15,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(170,548.75,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY22Q2Opt_USA_160x600_BAN_TeamsPremium_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,79.80000000000001,269.29999999999995);
// library properties:
lib.properties = {
