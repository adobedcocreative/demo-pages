// JavaScript Document
	...
	bannerData.headline1 = ["<#505050>Put your|finances in|order","20.5px",80, 70,"22","3 50", "center", "Segoe Pro"];
	
	bannerData.headline2 = ["<#FFFFFF>Budget for|success with|Money in Excel","20.5px",16, 48,"25","3 50", "left", "Segoe Pro"];
	
	bannerData.CTA = ["<#044F30>Subscribe now","14px",-2,1,"50","300", "left", "Segoe Pro"];
