...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(180.15,550.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(333.05,547.85,1.4179,1.4179,0,0,0,0.3,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,348.6,600), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_300x600_BAN_Creators_EN_NA_Standard_ANI_SUB_NA_1= function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,163.39999999999998,267.70000000000005);
// library properties:
lib.properties = {
