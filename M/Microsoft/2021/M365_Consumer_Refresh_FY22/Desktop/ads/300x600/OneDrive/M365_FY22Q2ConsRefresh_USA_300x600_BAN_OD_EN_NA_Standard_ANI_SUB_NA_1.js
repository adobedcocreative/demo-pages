...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(176.6,551.25,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(311.35,548.8,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,301.4,600), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_300x600_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,150.39999999999998,267.79999999999995);
// library properties:
lib.properties = {
