...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0043B3").s().p("AgNAqIAfgfIhJAAIAAgUIBJAAIggggIAaAAIAsApIgsAqg");
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(180.7,550.4,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(331.4,547.85,1.41,1.41,0,0,0,0.3,0.4);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,312.9,600), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_300x600_BAN_Outlook_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,161.89999999999998,267.5);
// library properties:
lib.properties = {
