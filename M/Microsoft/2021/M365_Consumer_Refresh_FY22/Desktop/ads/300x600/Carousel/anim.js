function frame0(){
	...
	//logo animation
        ...
        //1st icons animation
        exportRoot.tlText.to(exportRoot.mainMC.nav.icon5, .6, { x:"+=114", scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-0.8")
            .to(exportRoot.mainMC.nav.icon5, .3, {y:399, ease:Power1.easeInOut},"<+.3")
            .to(exportRoot.mainMC.nav.icon4, .7, { x:"+=114", scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.2")
            .to(exportRoot.mainMC.nav.icon4, .3, {y:352, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon3, .8, { x:"+=114", scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon3, .4, {y:306, ease:Power1.easeInOut},"<+.5")
            .to(exportRoot.mainMC.nav.icon2, .9, { x:"+=114", scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.4")
            .to(exportRoot.mainMC.nav.icon2, .5, {y:260, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon1, 1, { x:"+=114", scale:.76, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon1, .6, {y:212, ease:Power1.easeInOut, onComplete:function(){timer1.play();}},"<+.4");
