...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ApfCaIAAkzITAAAIAAEzg");
	this.shape.setTransform(-69.15,1.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-130,-14.1,121.7,30.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(604.8,46.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(739.75,44.05,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,730.1,240.3), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_728x90_BAN_ExcelBudget_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,363.79999999999995,17.799999999999997);
// library properties:
lib.properties = {
