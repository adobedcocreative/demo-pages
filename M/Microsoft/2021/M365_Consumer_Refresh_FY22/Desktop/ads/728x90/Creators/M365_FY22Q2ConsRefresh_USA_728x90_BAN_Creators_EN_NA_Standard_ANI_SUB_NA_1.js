...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1379D2").s().p("AqCCRIAAkhIUFAAIAAEhg");
	this.shape.setTransform(-72.675,2.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-136.9,-12.2,128.5,29.099999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(607.2,45.55,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(742.65,43.1,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,732.9,90), null);


// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_728x90_BAN_Creators_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,366.6,17);
// library properties:
lib.properties = {
