...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.85,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AptCjIAAlGITbAAIAAFGg");
	this.shape.setTransform(-68.9,2.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-131.1,-13.8,124.39999999999999,32.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(606.4,47.05,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(739.85,44.05,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY22Q2Opt_USA_728x90_BAN_TeamsPremium_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,365.70000000000005,20.200000000000003);
// library properties:
lib.properties = {
