...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AnnB5IAAjyIPPAAIAADyg");
	this.shape.setTransform(-67.072,2.3,1.1107,1);
...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(138.25,218.65,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_300x250_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,145.2,109.69999999999999);
// library properties:
lib.properties = {
