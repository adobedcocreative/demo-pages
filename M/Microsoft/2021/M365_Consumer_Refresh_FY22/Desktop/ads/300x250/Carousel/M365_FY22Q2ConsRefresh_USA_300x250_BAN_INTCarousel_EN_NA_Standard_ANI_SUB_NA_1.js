...
}).prototype = getMCSymbolPrototype(lib.scene4BG, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-2,-2.45,0.26,0.26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.scene4_UI_Reflection, new cjs.Rectangle(-87.4,-9.8,311.9,60.099999999999994), null);
...
}).prototype = getMCSymbolPrototype(lib.scene3BG, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AqZAzIAAhwIUzAAIAAB7g");
	mask.setTransform(150.725,191.325);

	// reflection
	this.reflection = new lib.scene4_UI_Reflection();
	this.reflection.name = "reflection";
	this.reflection.setTransform(150.6,235.15,0.9633,0.9633,0,0,0,68.8,45.1);
	this.reflection.alpha = 0.5;
	this.reflection.compositeOperation = "hard-light";

	var maskedShapeInstanceList = [this.reflection];
...
}).prototype = getMCSymbolPrototype(lib.Scene4, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(146.5,141.8,1,1,0,0,0,146.5,141.8);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("ArECxIABl1IWIAAIAAGJg");
	mask.setTransform(152.1,216.775);
...
}).prototype = getMCSymbolPrototype(lib.Scene5, new cjs.Rectangle(0,0,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.Scene3, new cjs.Rectangle(0,0,300,250), null);
...
// stage content:
(lib.M365_FY22Q2ConsRefresh_USA_300x250_BAN_INTCarousel_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
