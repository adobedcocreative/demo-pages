...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(16,222.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(136.75,219.6,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.2,0,301.2,251), null);


// stage content:
(lib.M365_FY22Q2Opt_USA_300x250_BAN_TeamsPremium_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(148.8,125,146.39999999999998,110.69999999999999);
// library properties:
lib.properties = {
