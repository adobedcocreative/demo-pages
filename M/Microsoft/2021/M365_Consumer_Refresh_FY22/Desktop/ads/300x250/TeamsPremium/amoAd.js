var amoAd = (function(){
  ...
  function init() {
   ...
   // bannerData.headline2 = eval(bannerData.textField3);
    bannerData.ctaText = bannerData.ctaText.replace('<br>', '\n');
  	...
  	CTAFont = (Boolean(parseFloat(CTAFont)) ? parseFloat(CTAFont) : 12.3) + 'px';
  	bannerData.ctaText = bannerData.ctaText.split('|')[0];
  	bannerData.CTA = bannerData.ctaText ? ['<#141953>' + bannerData.ctaText,CTAFont,0,0,"50","300", "left", "Segoe Pro"] : '';
    resizeCTA();
    fireImpression();
