...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.5,0.1,300,250), null);


// stage content:
(lib.M365_MobileFY22Q2ConsRefresh_USA_300x250_BAN_PPT_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,145.2,109.19999999999999);
// library properties:
lib.properties = {
