function frame0(){
    ...
    exportRoot.runBanner = function() {
        ...
        exportRoot.gotoNextNav = function() {
            for (var i=1;i<=maxNav;i++) {
                //deselected
                if (nav["icon"+i].scaleX > 1) gsap.to(nav["icon"+i], 1, {scaleX:.7, scaleY:.7, ease:Power4.easeInOut});
            }
            //selected
            gsap.to(nav["icon"+exportRoot.currentSelection], 1, {scaleX:1.01, scaleY:1.01, ease:Power4.easeInOut});
        }
	...
	exportRoot.tl5.pause();
        ...
        exportRoot.tlText.to(exportRoot.mainMC.nav.icon5, .6, { x:264, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-0.8")
            .to(exportRoot.mainMC.nav.icon5, .3, {y:180, ease:Power1.easeInOut},"<+.3")
            .to(exportRoot.mainMC.nav.icon4, .7, { x:264, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.2")
            .to(exportRoot.mainMC.nav.icon4, .3, {y:148, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon3, .8, { x:264, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon3, .4, {y:116, ease:Power1.easeInOut},"<+.5")
            .to(exportRoot.mainMC.nav.icon2, .9, { x:264, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.4")
            .to(exportRoot.mainMC.nav.icon2, .5, {y:84, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon1, 1, { x:264, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon1, .6, {y:52, ease:Power1.easeInOut, onComplete:function(){timer1.play();}},"<+.4");
