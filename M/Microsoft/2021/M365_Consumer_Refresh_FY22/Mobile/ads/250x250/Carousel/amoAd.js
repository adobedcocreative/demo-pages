var amoAd = (function(){
  ...
  function init() {
    ...
    bannerData.ctaText = bannerData.ctaText.replace('<br>', '\n');
  	...
  	CTAFont = (Boolean(parseFloat(CTAFont)) ? parseFloat(CTAFont) : 16.1) + 'px';
  	bannerData.ctaText = bannerData.ctaText.split('|')[0];
  	bannerData.CTA = bannerData.ctaText ? ['<#0078D4>' + bannerData.ctaText,CTAFont,0,1,"50","300", "left", "Segoe Pro"] : '';
    window.smartNames = [];
