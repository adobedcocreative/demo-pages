function frame0(){
    ...
    exportRoot.runBanner = function() {
            ...
            if(type===undefined){
				for (var i=1;i<=maxNav;i++) {
					//deselected
						...
						if (nav["icon" + i].scale > 0.9) gsap.to(nav["icon" + i], 1, {scale: .7, ease: Power4.easeInOut});
					}
				//selected
					gsap.to(nav["icon" + exportRoot.currentSelection], 1, {scale: 1, ease: Power4.easeInOut});


					centerPosition = 135;
					//navHeight = nav.icon1.y+nav.icon5.y+25;

					if (exportRoot.currentSelection==1) centerPosition = 110;
					if (exportRoot.currentSelection==5) centerPosition = 164;
		...
		exportRoot.jiggleStop = function(id, repeatValue) {
			...
			gsap.to([nav.icon2.sub,nav.icon3.sub,nav.icon4.sub,nav.icon5.sub], {duration: 0, scaleX: 1, scaleY: 1, ease:Sine.easeInOut});
	...
	exportRoot.tl1.from(mc.screens.img1.icon, 1, { y: "+=100", alpha: 0});
	exportRoot.tl1.from(mc.screens.img1.ui, 1, { y: "+=60", alpha: 0},"<");
	exportRoot.tl1.from(mc.screens.img1.reflection, 1, { alpha: 0},"<");
	exportRoot.tl1.add("mid");
	exportRoot.tl1.to(mc.screens.img1.icon, 1, { y:  "-=100", alpha: 0});
	exportRoot.tl1.to(mc.screens.img1.ui, 1, { y:  "-=60", alpha: 0},"<");
	...
	exportRoot.tl2.from(mc.screens.img2.icon, 1, { y: "+=100", alpha: 0});
	exportRoot.tl2.from(mc.screens.img2.ui, 1, { y: "+=60", alpha: 0},"<");
	exportRoot.tl2.from(mc.screens.img2.reflection, 1, { alpha: 0},"<");
	exportRoot.tl2.add("mid");
	exportRoot.tl2.to(mc.screens.img2.icon, 1, { y:  "-=100", alpha: 0});
	exportRoot.tl2.to(mc.screens.img2.ui, 1, { y:  "-=60", alpha: 0},"<");
	...
	exportRoot.tl3.from(mc.screens.img3.icon, 1, { y: "+=100", alpha: 0});
	exportRoot.tl3.from(mc.screens.img3.ui, 1, { y: "+=60", alpha: 0},"<");
	exportRoot.tl3.from(mc.screens.img3.reflection, 1, { y: "-=60", alpha: 0},"<");
	...
	exportRoot.tl4.from(mc.screens.img4.icon, 1, { y: "+=100", alpha: 0});
	exportRoot.tl4.from(mc.screens.img4.ui, 1, { y: "+=60", alpha: 0},"<");
	exportRoot.tl4.from(mc.screens.img4.reflection, 1, { alpha: 0},"<");
	exportRoot.tl4.add("mid");
	exportRoot.tl4.to(mc.screens.img4.icon, 1, { y:  "-=100", alpha: 0});
	exportRoot.tl4.to(mc.screens.img4.ui, 1, { y:  "-=60", alpha: 0},"<");
	...
	exportRoot.tl5.from(mc.screens.img5.icon, 1, { y: "+=100", alpha: 0});
	exportRoot.tl5.from(mc.screens.img5.ui, 1, { y: "+=60", alpha: 0},"<");
	exportRoot.tl5.from(mc.screens.img5.reflection, 1, { alpha: 0},"<");
	exportRoot.tl5.add("mid");
	exportRoot.tl5.to(mc.screens.img5.icon, 1, { y:  "-=100", alpha: 0});
	exportRoot.tl5.to(mc.screens.img5.ui, 1, { y:  "-=60", alpha: 0},"<");
	...
	exportRoot.tl5.pause();
        ...
        exportRoot.tlText = gsap.timeline()
            ...
            .to([mc.screens.img1.ui], 0, { alpha: 1, y:118})
            .to([mc.screens.img1.icon], 0, { alpha: 1, y:91})
            .to([mc.screens.img1.reflection], 0, { alpha: .5, y:210})
        ...
        exportRoot.tlText.from(exportRoot.mainMC.nav, 2, {scaleX:1.2, scaleY:1.2,  ease:Power2.easeOut},">+.3")
			...
			.to(exportRoot.mainMC.introBG, 1.4, {x:"+=350",  ease:Power2.easeInOut},"<+1")
        ...
        exportRoot.tlText.to(exportRoot.mainMC.nav.icon5, .6, { x:245, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-0.8")
            .to(exportRoot.mainMC.nav.icon5, .3, {y:237, ease:Power1.easeInOut},"<+.3")
            .to(exportRoot.mainMC.nav.icon4, .7, { x:245, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.2")
            .to(exportRoot.mainMC.nav.icon4, .3, {y:205, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon3, .8, { x:245, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon3, .4, {y:173, ease:Power1.easeInOut},"<+.5")
            .to(exportRoot.mainMC.nav.icon2, .9, { x:245, scaleX:.7, scaleY:.7, ease:Power1.easeInOut},"<-.4")
            .to(exportRoot.mainMC.nav.icon2, .5, {y:142, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon1, 1, { x:245, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon1, .6, {y:110, ease:Power1.easeInOut, onComplete:function(){
                timer1.play();
                exportRoot.mainMC.nav.gotoAndStop(2);
		    }},"<+.4");
