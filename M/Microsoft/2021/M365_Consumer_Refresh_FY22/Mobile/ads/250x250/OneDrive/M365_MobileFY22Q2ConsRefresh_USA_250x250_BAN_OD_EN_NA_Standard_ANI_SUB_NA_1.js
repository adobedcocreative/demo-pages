...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-14.2,2.4,0.7,0.6422,0,0,0,13.6,10.7);
	...
	this.shape.setTransform(-59.3,2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-121.8,-17,125,38), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(234.65,3.95,0.3475,0.3475,0,0,180,-0.3,0);
...
// stage content:
(lib.M365_MobileFY22Q2ConsRefresh_USA_250x250_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(124.7,125,120.99999999999999,109.19999999999999);
// library properties:
lib.properties = {
