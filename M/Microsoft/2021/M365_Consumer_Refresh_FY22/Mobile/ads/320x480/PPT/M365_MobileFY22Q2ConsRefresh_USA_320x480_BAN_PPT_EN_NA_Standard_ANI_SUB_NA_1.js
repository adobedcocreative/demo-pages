...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(303.15,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(195.35,427.45,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(316.55,425,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,320.9,480), null);


// stage content:
(lib.M365_MobileFY22Q2ConsRefresh_USA_320x480_BAN_PPT_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,159.89999999999998,208.5);
// library properties:
lib.properties = {
