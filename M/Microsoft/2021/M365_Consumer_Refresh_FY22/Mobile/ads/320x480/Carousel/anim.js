function frame0(){
    ...
    exportRoot.runBanner = function() {
        ...
        exportRoot.gotoNextNav = function(type) {
            if(type===undefined) {
                for (var i = 1; i <= maxNav; i++) {
                    //deselected
                    if (nav["icon" + i].scale > 0.75) gsap.to(nav["icon" + i], 1, {scale: .53, ease: Power4.easeInOut});
                }
                //selected
                gsap.to(nav["icon" + exportRoot.currentSelection], 1, {scale: .76, ease: Power4.easeInOut});
                //for moving the nav
                    /*navHeight = nav.icon1.y+nav.icon5.y+42;
                    movingGap = 45 - nav["icon" + exportRoot.currentSelection].y;
            ...
            if(type==1) {
                for (var i = 2; i <= maxNav; i++) {
                    gsap.to(nav["icon" + i], 1, {scale: .602, ease: Power4.easeInOut});
                }
            }
        }
		...
		exportRoot.jiggle = function(id, repeatValue) {
			...
			exportRoot["tlJiggle"+id].to(nav["icon"+id].sub, {duration: 0.625, scale: .6, ease:Sine.easeInOut});
		...
		exportRoot.jiggleStop = function(id, repeatValue) {
			...
			gsap.to([nav.icon2.sub,nav.icon3.sub,nav.icon4.sub,nav.icon5.sub], {duration: 0.625, scale: 1, ease:Sine.easeInOut});
	...
	exportRoot.tl1.from(mc.screens.img1.icon, 1, { y: "+=200", alpha: 0});
	exportRoot.tl1.from(mc.screens.img1.ui, 1, { y: "+=120", alpha: 0},"<");
	exportRoot.tl1.from(mc.screens.img1.reflection, 1, { alpha: 0},"<");
	exportRoot.tl1.add("mid");
	exportRoot.tl1.to(mc.screens.img1.icon, 1, { y:  "-=200", alpha: 0});
	exportRoot.tl1.to(mc.screens.img1.ui, 1, { y:  "-=120", alpha: 0},"<");
	...
	exportRoot.tl2.from(mc.screens.img2.icon, 1, { y: "+=200", alpha: 0});
	exportRoot.tl2.from(mc.screens.img2.ui, 1, { y: "+=120", alpha: 0},"<");
	exportRoot.tl2.from(mc.screens.img2.reflection, 1, { alpha: 0},"<");
	exportRoot.tl2.add("mid");
	exportRoot.tl2.to(mc.screens.img2.icon, 1, { y:  "-=200", alpha: 0});
	exportRoot.tl2.to(mc.screens.img2.ui, 1, { y:  "-=120", alpha: 0},"<");
	...
	exportRoot.tl3.from(mc.screens.img3.icon, 1, { y: "+=200", alpha: 0});
	exportRoot.tl3.from(mc.screens.img3.ui, 1, { y: "+=120", alpha: 0},"<");
	exportRoot.tl3.from(mc.screens.img3.reflection, 1, { alpha: 0},"<");
	exportRoot.tl3.add("mid");
	exportRoot.tl3.to(mc.screens.img3.icon, 1, { y:  "-=200", alpha: 0});
	exportRoot.tl3.to(mc.screens.img3.ui, 1, { y:  "-=120", alpha: 0},"<");
	...
	exportRoot.tl4.from(mc.screens.img4.icon, 1, { y: "+=200", alpha: 0});
	exportRoot.tl4.from(mc.screens.img4.ui, 1, { y: "+=120", alpha: 0},"<");
	exportRoot.tl4.from(mc.screens.img4.reflection, 1, { alpha: 0},"<");
	exportRoot.tl4.add("mid");
	exportRoot.tl4.to(mc.screens.img4.icon, 1, { y:  "-=200", alpha: 0});
	exportRoot.tl4.to(mc.screens.img4.ui, 1, { y:  "-=120", alpha: 0},"<");
	...
	exportRoot.tl5.from(mc.screens.img5.icon, 1, { y: "+=200", alpha: 0});
	exportRoot.tl5.from(mc.screens.img5.ui, 1, { y: "+=120", alpha: 0},"<");
	exportRoot.tl5.from(mc.screens.img5.reflection, 1, { alpha: 0},"<");
	exportRoot.tl5.add("mid");
	exportRoot.tl5.to(mc.screens.img5.icon, 1, { y:  "-=200", alpha: 0});
	exportRoot.tl5.to(mc.screens.img5.ui, 1, { y:  "-=120", alpha: 0},"<");
	...
	//logo animation
        ...
        var yValues = headlines.map(function(headline) { return exportRoot[headline].map(function(item){
            return item.y;
          }); 
        });
        exportRoot.nextScene = function() {
            ...
            exportRoot.tlNext.to(mc.screens["img"+exportRoot.currentSelection], 0, { y:exportRoot["init_img"+exportRoot.currentSelection+"_y"]+initOffset,ease:Power2.easeInOut, alpha: 1});
            ...
            for (i=0; i<exportRoot["headline"+exportRoot.currentSelection].length; i++) {
                exportRoot.tlNext.to(exportRoot["headline" + exportRoot.currentSelection][i], 0, {
                    y: yValues[exportRoot.currentSelection - 1][i] + initOffset / 5,
                    alpha: 0
                });
            }
            ...
            for (i=0; i<exportRoot["headline"+prevSelection].length; i++) {
                exportRoot.tlNext.to(exportRoot["headline" + prevSelection][i], 0.4, {
                    y: yValues[prevSelection - 1][i] - initOffset / 3,
                    alpha: 0,
                    ease: Power2.easeIn,
                    //stagger: 0.03
                }, "<");
            ...
            for (i=0; i<exportRoot["headline"+exportRoot.currentSelection].length; i++) {
                exportRoot.tlNext.to(exportRoot["headline" + exportRoot.currentSelection][i], 0.5, {
                    y: yValues[exportRoot.currentSelection - 1][i],
                    alpha: 1,
                    ease: Power3.easeOut,
                    //stagger: 0.03
                }, ((i!=0) ? "<+0.06" : ">+.3"));
        ...
        exportRoot.tlText = gsap.timeline()
            ...
            .to([mc.screens.img1.ui], 0, { alpha: 1, y:213})
            .to([mc.screens.img1.icon], 0, { alpha: 1, y:221})
            .to([mc.screens.img1.reflection], 0, { alpha: .5, y:430})
        ...
        exportRoot.tlText.from(exportRoot.mainMC.nav, 2, {scaleX:1.2, scaleY:1.2,  ease:Power2.easeOut},">+.3")
			...
			.to(exportRoot.mainMC.introBG, 1.4, {x:"+=380",  ease:Power2.easeInOut},"<+1")
        ...
        //1st icons animation
        exportRoot.tlText.to(exportRoot.mainMC.nav.icon5, .6, { x:281, scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-0.8")
            .to(exportRoot.mainMC.nav.icon5, .3, {y:334, ease:Power1.easeInOut},"<+.3")
            .to(exportRoot.mainMC.nav.icon4, .7, { x:281, scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.2")
            .to(exportRoot.mainMC.nav.icon4, .3, {y:288, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon3, .8, { x:281, scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon3, .4, {y:241, ease:Power1.easeInOut},"<+.5")
            .to(exportRoot.mainMC.nav.icon2, .9, { x:281, scaleX:.53, scaleY:.53, ease:Power1.easeInOut},"<-.4")
            .to(exportRoot.mainMC.nav.icon2, .5, {y:195, ease:Power1.easeInOut},"<+.4")
            .to(exportRoot.mainMC.nav.icon1, 1, { x:281, scale:.76, ease:Power1.easeInOut},"<-.3")
            .to(exportRoot.mainMC.nav.icon1, .6, {y:148, ease:Power1.easeInOut, onComplete:function(){timer1.play();}},"<+.4");
