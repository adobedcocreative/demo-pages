...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.55,-1.2,0.8128,0.7113,0,0,0,13.5,10.7);
	...
	this.shape.setTransform(-59.048,-1.9969,1.0543,1.2716);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.5,-17.4,102.9,30.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(276.15,579.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(276.15,579.55,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.txtCta.setTransform(15.05,551.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(125.9,552.75,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.1,4.9,296,587.4), null);


// stage content:
(lib.M365_FY21Q4SMBCustStories_USA_300x600_BAN_TonysChoco_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,145.2,292);
// library properties:
lib.properties = {
