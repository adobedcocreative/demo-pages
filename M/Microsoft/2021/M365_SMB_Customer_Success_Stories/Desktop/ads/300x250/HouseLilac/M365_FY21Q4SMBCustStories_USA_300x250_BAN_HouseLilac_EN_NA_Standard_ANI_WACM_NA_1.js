...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6.3,4.9,302.40000000000003,235.4), null);


// stage content:
(lib.M365_FY21Q4SMBCustStories_USA_300x250_BAN_HouseLilac_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(143.7,125,151.5,115.1);
// library properties:
lib.properties = {
