...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6.3,0,379.6,252.1), null);


// stage content:
(lib.M365_FY21Q4ConsRefresh_USA_300x250_BAN_AllUp_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(143.7,125,157.5,127);
// library properties:
lib.properties = {
