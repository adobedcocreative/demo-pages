...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(276.15,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(276.15,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.2,4.9,296.3,235.4), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_300x250_BAN_TonysChoco_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(149.8,125,145.39999999999998,115.1);
// library properties:
lib.properties = {
