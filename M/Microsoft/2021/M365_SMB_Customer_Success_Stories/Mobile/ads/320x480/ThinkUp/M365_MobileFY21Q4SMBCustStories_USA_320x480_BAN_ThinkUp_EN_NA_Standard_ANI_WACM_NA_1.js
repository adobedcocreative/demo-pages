...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoPC5IAAlxIQfAAIAAFxg");
	this.shape.setTransform(-62.375,1.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.1,-16.5,105.5,37), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(298.8,460.05,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(298.8,460.05,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(303.6,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.55,427,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(131.2,424.3,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,320,480), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_320x480_BAN_ThinkUp_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		*/
				this.tlText.from(mc.cta, { duration: 0.6, x: "-=200", ease:Power3.easeOut, onComplete:function(){exportRoot.videoState="reset"}}, "<+.5");
				this.tlText.from(mc.txtCta, { duration: 0.6, x: "-=200", ease:Power3.easeOut}, "<");
...
p.nominalBounds = new cjs.Rectangle(160,240,154.39999999999998,232.5);
// library properties:
lib.properties = {
