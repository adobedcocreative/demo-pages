...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(290.25,435.35,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(290.25,435.35,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(298.2,9.05,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.55,427.25,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(130.4,424.9,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.2,10,310.2,438.4), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_320x480_BAN_TonysChoco_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(mc.cta, { duration: 0.6, x: "-=200", onComplete:function(){exportRoot.videoState="reset"}}, "<+.3");
				this.tlText.from(mc.txtCta, { duration: 0.6, x: "-=200"}, "<");
...
p.nominalBounds = new cjs.Rectangle(159.8,240,149.2,208.2);
// library properties:
lib.properties = {
