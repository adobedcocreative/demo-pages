...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-25.05,2.6,0.6903,0.6333,0,0,0,13.3,10.6);
	...
	this.shape.setTransform(-61.6983,2.5574,1.0738,1.5057);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.1,-15.7,104.8,36.599999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(226.15,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(226.15,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(234.8,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(16.7,212.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(129.75,210.2,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.1,0,373.40000000000003,250), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_250x250_BAN_CliftonCoffee_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(124.9,125,120.9,115.1);
// library properties:
lib.properties = {
