...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAFAqIAggfIhvAAIAAgUIBvAAIghggIAbAAIAsApIgsAqg");
	this.shape.setTransform(-1.725,0.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cta_arrow, new cjs.Rectangle(-9.2,-4.1,15,8.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAFAqIAggfIhvAAIAAgUIBvAAIghggIAbAAIAsApIgsAqg");
	this.shape.setTransform(3.725,4.175);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.arrow, new cjs.Rectangle(-3.8,0,15.100000000000001,8.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(12).to({_off:false},0).to({x:2.15},8,cjs.Ease.get(1)).wait(1).to({regX:3.7,x:0.1},0).wait(1).to({x:-0.55},0).wait(1).to({x:-1.5},0).wait(1).to({x:-2.3},0).wait(1).to({x:-2.8},0).wait(1).to({regX:5.6,x:-1.05},0).wait(1).to({regX:3.7,x:-2.85},0).wait(1).to({x:-2.5},0).wait(1).to({x:-2.05},0).wait(1).to({x:-1.65},0).wait(1).to({x:-1.4},0).wait(1).to({regX:5.6,x:0.55},0).wait(1).to({regX:3.7,x:-1.35},0).wait(1).to({x:-1.5},0).wait(1).to({x:-1.65},0).wait(1).to({x:-1.8},0).wait(1).to({x:-1.9},0).wait(1).to({regX:5.6,x:-0.05},0).wait(1).to({regX:3.7,x:-1.9},0).wait(1).to({x:-1.85},0).wait(1).to({x:-1.8},0).wait(1).to({x:-1.75},0).wait(1).to({regX:5.6,x:0.15},0).wait(10));
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoMC+IAAl6IQZAAIAAF6g");
	this.shape.setTransform(-62.275,2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.7,-16.9,104.9,37.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(225.65,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(225.65,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(233.15,4.05,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.55,213.15,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(130.4,210.8,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-0.2,5,245.2,235.3), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_250x250_BAN_TonysChoco_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(exportRoot.subhead1,{
						duration:0.8,
						y: "+=30", alpha: 0,
						ease:Power3.easeOut,
						}, "<+.3");
				...
				this.tlText.to(exportRoot.headline1,{
						duration:0.5,
						alpha: 0,
						ease:Power3.easeIn,
						}, "+=2.5");
						
				this.tlText.to(exportRoot.subhead1,{
						duration:0.5,
						alpha: 0,
						ease:Power3.easeIn,
						}, "<");
						
				this.tlText.from(mc.mute_btn_wht,{duration: 0.6, alpha: 0, ease:Power3.easeInOut}, "<");
				//this.tlText.to(mc.mute_btn_blk,{duration: 0.6, alpha: 0, ease:Power3.easeInOut}, "<");
				...
				/*this.tlText.from(exportRoot.subhead2,{
						duration:0.8,
						y: "+=30", alpha: 0,
						stagger: 0.05,
						ease:Power3.easeOut,
				...
				this.tlText.from(mc.cta, { duration: 0.6, x: "-=150", onComplete:function(){exportRoot.videoState="reset"}}, "<+.3");
				this.tlText.from(mc.txtCta, { duration: 0.6, x: "-=150"}, "<");
				this.tlText.from(mc.replay_btn, 1, { alpha: 0, onStart:function(){exportRoot.isReplay = true;}}, "-=0.6");
				
				this.tlText.to(mc.mute_btn_wht,{duration: 0.6, alpha: 0, ease:Power3.easeInOut}, "+=4");
				this.tlText.to(mc.mute_btn_blk,{duration: 0.6, alpha: 1, ease:Power3.easeInOut}, "+=4");
				//this.tlText.pause();
		}
	}
...
p.nominalBounds = new cjs.Rectangle(124.8,125,119.39999999999999,115.1);
// library properties:
lib.properties = {
