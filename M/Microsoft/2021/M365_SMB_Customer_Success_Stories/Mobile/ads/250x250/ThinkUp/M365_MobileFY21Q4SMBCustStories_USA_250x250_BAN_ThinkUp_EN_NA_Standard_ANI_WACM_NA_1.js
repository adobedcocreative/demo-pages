...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(226.25,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(226.25,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(231.6,3.95,0.3475,0.3475,0,0,180,-0.3,0);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,250,250), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_250x250_BAN_ThinkUp_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(125,125,117.6,115.1);
// library properties:
lib.properties = {
