...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-15.7,-4.55,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AooC7IAAl1IRRAAIAAF1g");
	this.shape.setTransform(-54.2008,-5.2501);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.4,-23.9,110.5,37.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(296.45,458.4,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(296.45,458.4,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(304.95,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.05,426.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,432.55,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-5.2,0,378.5,480), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_320x480_BAN_CliftonCoffee_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(154.8,240,160.89999999999998,230.89999999999998);
// library properties:
lib.properties = {
