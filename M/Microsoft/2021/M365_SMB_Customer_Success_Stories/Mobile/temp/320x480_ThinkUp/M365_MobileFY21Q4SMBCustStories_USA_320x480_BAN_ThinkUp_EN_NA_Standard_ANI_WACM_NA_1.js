...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/								
				this.tlText.from(mc.cta, { duration: 0.6, x: "-=150", ease:Power3.easeOut, onComplete:function(){exportRoot.videoState="reset"}}, "<+.5");
				this.tlText.from(mc.txtCta, { duration: 0.6, x: "-=150", ease:Power3.easeOut}, "<");
