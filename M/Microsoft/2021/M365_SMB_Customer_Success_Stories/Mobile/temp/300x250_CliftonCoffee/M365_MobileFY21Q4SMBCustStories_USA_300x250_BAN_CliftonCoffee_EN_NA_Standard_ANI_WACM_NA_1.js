...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-16.15,-4.55,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	this.shape.setTransform(-55.2484,-5.2492,1.1322,1.5391);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-110.5,-23.9,110.5,37.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(17.05,212.8,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,218.75,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-6.4,0,379.7,250), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_300x250_BAN_CliftonCoffee_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(143.6,125,151.6,115.1);
// library properties:
lib.properties = {
