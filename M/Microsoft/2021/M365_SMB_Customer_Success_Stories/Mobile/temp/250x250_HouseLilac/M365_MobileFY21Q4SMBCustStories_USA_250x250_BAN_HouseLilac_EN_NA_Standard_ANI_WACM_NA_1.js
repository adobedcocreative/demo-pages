...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AoIC5IAAlxIQRAAIAAFxg");
	this.shape.setTransform(-62.8,1.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.9,-16.5,104.2,37), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(225.5,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.timeline.addTween(cjs.Tween.get(this.mute_btn_wht).wait(1));

	// mute_btn
	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(225.5,227.55,0.7758,0.7758,0,0,180,-18.6,16.6);

	this.timeline.addTween(cjs.Tween.get(this.mute_btn_blk).wait(1));

	// replay
	this.replay_btn = new lib.replay_btn();
	this.replay_btn.name = "replay_btn";
	this.replay_btn.setTransform(233.65,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(16.05,212.85,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(131.2,210.15,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.5,4.9,245,235.4), null);


// stage content:
(lib.M365_MobileFY21Q4SMBCustStories_USA_250x250_BAN_HouseLilac_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlText.from(mc.cta, { duration: 0.6, x: "-=150", onComplete:function(){exportRoot.videoState="reset"}}, "<+.5");
...
p.nominalBounds = new cjs.Rectangle(125,125,119.69999999999999,115.1);
// library properties:
lib.properties = {
