...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,640,960]]}
];
...
(lib.OneDrive_320x480_Display0 = function() {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.OneDrive_320x480_Display0();
...
if (reversed == null) { reversed = false; }
	...
	this.static2.setTransform(182.25,282.3,1.6,1.3584,0,0,0,113.9,207.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-28,-29,570,800), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606236969895", id:"screen2_atlas_1"}
	],
	preloads: []
};
