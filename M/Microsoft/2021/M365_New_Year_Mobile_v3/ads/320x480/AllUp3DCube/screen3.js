...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,640,960]]}
];
...
(lib.Word_320x480_Display0 = function() {
...
p.nominalBounds = new cjs.Rectangle(0,0,256,352);
...
p.nominalBounds = new cjs.Rectangle(0,0,512,704);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Word_320x480_Display0();
...
}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,320,480), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(94.95,37.8,1.28,1.27,0,0,0,0.2,0.3);
	...
	this.txt.name = "txt";
	this.txt.setTransform(70.5,65.3,1,0.9262,0,0,0,70.5,70.5);
	...
	this.video.setTransform(0,0,2,1.8524);
	...
	this.static3.setTransform(182.25,282.3,1.6,1.3584,0,0,0,113.9,207.8);

	this.timeline.addTween(cjs.Tween.get(this.static3).wait(1));

	// BG
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgshA3nMAAAhvNMBZDAAAMAAABvNg");
	this.shape.setTransform(257,329.85);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-28,-28,570,796), null);
...
if (reversed == null) { reversed = false; }
	...
	this.mainMC.setTransform(0,0,1,1.0818);
...
p.nominalBounds = new cjs.Rectangle(228,323.8,314,418.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606236951621", id:"screen3_atlas_1"}
	],
	preloads: []
};
