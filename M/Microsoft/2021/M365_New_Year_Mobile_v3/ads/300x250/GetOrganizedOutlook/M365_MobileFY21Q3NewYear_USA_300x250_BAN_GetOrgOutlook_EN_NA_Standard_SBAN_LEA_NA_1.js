...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,600,500]]}
];
...
(lib.Outlook_Mobile_300x250 = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_300x250_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("ApRC5IAAlyISjAAIAAFyg");
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(42.2,212.9,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(120.55,210.1,1.136,1.136,0,0,0,0.2,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// BGImg
	this.instance_1 = new lib.Outlook_Mobile_300x250();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-21.8,0,321.8,250), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_300x250_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(128.2,125,171.8,124.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_300x250_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1.png?1605903528685", id:"M365_MobileFY21Q3NewYear_USA_300x250_BAN_GetOrgOutlook_EN_NA_Standard_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
