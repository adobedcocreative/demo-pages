...
lib.ssMetadata = [
		{name:"screen4_atlas_", frames: [[0,0,500,500]]}
];
...
(lib.Powerpoint_250x250_Display0 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Powerpoint_250x250_Display0();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_.png?1606171397856", id:"screen4_atlas_"}
	],
	preloads: []
};
