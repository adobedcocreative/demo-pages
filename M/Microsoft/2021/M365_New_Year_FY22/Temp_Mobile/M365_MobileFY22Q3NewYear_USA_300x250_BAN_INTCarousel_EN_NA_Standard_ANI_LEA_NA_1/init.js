...
function frame0() {
    ...
    exportRoot.slideWidth = 408;
    exportRoot.slidesGap = 100;
    exportRoot.slideInitialGap = 89;
    exportRoot.nSlide = 5;
    ...
    exportRoot.frontRibbon_movement = 440;
    exportRoot.backRibbon_movement = 50;
    exportRoot.finalCopyPosition = 16;

    stage.mouseChildren = true;


    //nav callBack
    mc.nav_l.on("click", function(){navBehavior(exportRoot.selectedSlide - 1,1,0); });
    mc.nav_r.on("click", function(){navBehavior(exportRoot.selectedSlide + 1,1,1); });
