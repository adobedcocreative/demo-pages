...
function changeSlide(direction) {
    ...
    cst.to(exportRoot["headline"+exportRoot.selectedSlide],{duration:0.1,alpha:0, x:(direction)? exportRoot.width/2 : -1*exportRoot.width/3, stagger:0.01, overwrite:true, })
        ...
        for(let i = 1; i<=exportRoot.nSlide; i++) {
            if(i!= exportRoot.selectedSlide) {
                cst.to(exportRoot["headline" + i], {
                    ...
                    x: (direction) ? -1*exportRoot.width/3 : exportRoot.width/2,
