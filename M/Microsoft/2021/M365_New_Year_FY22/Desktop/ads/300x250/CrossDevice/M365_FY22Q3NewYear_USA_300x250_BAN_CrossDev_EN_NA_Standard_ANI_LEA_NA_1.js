...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(112.2,233.6,1,1,0,0,0,0.7,0.1);
...
// stage content:
(lib.M365_FY22Q3NewYear_USA_300x250_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(36.6,105.1,258.59999999999997,130);
// library properties:
lib.properties = {
