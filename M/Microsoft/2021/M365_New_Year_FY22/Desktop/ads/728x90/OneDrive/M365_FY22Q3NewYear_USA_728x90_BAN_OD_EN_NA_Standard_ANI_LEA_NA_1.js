...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0E64AE").s().p("AnnCMIAAkXIPPAAIAAEXg");
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(157.35,204.55,0.6158,0.5649,0,0,0,13.6,10.7);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(0,190,265,30), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(713.15,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(650.95,61.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(527.15,-171.75,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-192,828.7,282), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_728x90_BAN_OD_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,-146.9,462.1,220.9);
// library properties:
lib.properties = {
