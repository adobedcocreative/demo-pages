...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#225E3E").s().p("AnnCMIAAkXIPPAAIAAEXg");
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(159.25,204.7,0.5749,0.5275,0,0,0,13.7,10.7);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(84.4,191.7,97.69999999999999,28.100000000000023), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(711.15,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(653,61.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(526.75,-171.65,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-191.9,828.7,281.9), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_728x90_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
