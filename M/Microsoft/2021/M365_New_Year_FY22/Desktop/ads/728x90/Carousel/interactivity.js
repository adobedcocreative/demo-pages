    ...
    gsap.to(exportRoot.mainMC.frontRibbon,
        {
            ...
            onUpdate: function () {
                ...
                if(exportRoot.mainMC.frontRibbon.hue<50 || exportRoot.mainMC.frontRibbon.hue>100 ) {
                    ...
                    exportRoot.mainMC.frontRibbon.filters[1] = new createjs.ColorMatrixFilter(matrix);
                }
            }
        });
...
function changeSlide(direction) {
    ...
    cst.to(exportRoot["headline"+exportRoot.selectedSlide],{duration:0.1,alpha:0, x:(direction)? 630 : exportRoot.width/2, stagger:0.01, overwrite:true, })
        ...
        for(let i = 1; i<=exportRoot.nSlide; i++) {
            if(i!= exportRoot.selectedSlide) {
                cst.to(exportRoot["headline" + i], {
                    ...
                    x: (direction) ? exportRoot.width/2 : 630,
