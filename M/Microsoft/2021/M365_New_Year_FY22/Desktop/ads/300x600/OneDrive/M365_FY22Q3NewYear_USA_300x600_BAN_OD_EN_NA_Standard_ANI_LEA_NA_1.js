...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(106.75,575.55,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(12.05,343.55,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-101.9,0,402.4,600), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_300x600_BAN_OD_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(48.3,300,246.89999999999998,278.20000000000005);
// library properties:
lib.properties = {
