...
(lib.EONEDRIVE_DESKTOP_LOGO_FRONT_NOLOGO_01 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_6"]);
	this.gotoAndStop(0);
...
(lib.EXCEL_DESKTOP_LOGO_FRONT_01 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ribbontop0 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ribbontop142 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ribbontop188 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ribbontop232 = function() {
	this.initialize(ss["M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CCFF").s().p("EgXbAu4MAAAgt2IETAAIAAnrIkTAAMAAAgoOMAu3AAAMAAAAoOIkqAAIAAH2IEqAAMAAAAtrg");
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.7},12,cjs.Ease.quadInOut).wait(39).to({regX:0.2,scaleX:2.8839,scaleY:2.8839,x:63.25,y:63.45},33,cjs.Ease.cubicInOut).wait(1));

	// widows_icon
	this.instance_1 = new lib.MSFT_logo_sq();
	this.instance_1.setTransform(299.1,905.95,0.2981,0.2981,0,0,0,-39.9,1.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:-40,regY:1.4,scaleX:4.9325,scaleY:4.9325,x:299.05},14,cjs.Ease.quadOut).to({x:24.8},12,cjs.Ease.quadInOut).to({_off:true},1).wait(72));

	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("EhMdCYNMAAAkwZMCY7AAAMAAAEwZg");
	this.shape.setTransform(301.475,904.425);

	this.instance_2 = new lib.Tween3("synched",0);
	this.instance_2.setTransform(301.45,904.4,1,2.3525);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(191.35,25.95,0.68,0.68,0,0,0,13.6,10.6);
	...
	this.CTAbg.setTransform(150.4,26.8,1,1.5411,0,0,0,150.4,17.4);

	this.timeline.addTween(cjs.Tween.get(this.CTAbg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ctabg, new cjs.Rectangle(0,0,300.8,53.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.nav_l.setTransform(4.7,282.3,1.1463,1.1463,0,0,0,16.8,16.8);
	new cjs.ButtonHelper(this.nav_l, 0, 1, 2, false, new lib.nav(), 3);

	this.nav_r = new lib.nav();
	this.nav_r.name = "nav_r";
	this.nav_r.setTransform(295.5,282.35,1.1463,1.1463,180,0,0,16.7,16.7);
	...
	this.txtCta.setTransform(106.9,575.05);
	...
	this.cta.name = "cta";
	this.cta.setTransform(149.9,566.25,1,1,0,0,0,150.4,17.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMc, new cjs.Rectangle(-44,-0.5,1595.8,602.9), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(106,299.5,1445.8,302.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1638467660699", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"},
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_2.png?1638467660700", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"},
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_3.png?1638467660700", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_3"},
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_4.png?1638467660700", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_4"},
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_5.png?1638467660701", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_5"},
		{src:"images/M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_6.png?1638467660702", id:"M365_FY22Q3NewYear_USA_300x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_6"}
	],
	preloads: []
};
