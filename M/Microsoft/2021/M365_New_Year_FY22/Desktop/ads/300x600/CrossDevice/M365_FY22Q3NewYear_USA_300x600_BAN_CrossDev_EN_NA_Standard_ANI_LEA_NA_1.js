...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(283.2,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(105.9,575.55,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(11.8,343.3,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-102.2,5,397.2,573.2), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_300x600_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(48.1,300,246.00000000000003,277.9);
// library properties:
lib.properties = {
