...
function frame0() {
    ...
    exportRoot.runBanner = function() {
		...
		this.tlAnim.from([mc.cta,mc.txtCta], { duration: 0.8, alpha: 0}, "+=1.5");		
		...
		//f2 copy
		   this.tlAnim.from(exportRoot.headline2,{
            duration:0.8,
            y: "+=20", alpha: 0,stagger: 0.05,	
            ease:Power2.easeOut,
        }, "-=.4");
		
        this.tlAnim.to(exportRoot.headline2,{
            duration:0.8,
            y: "-=20", alpha: 0,
            ease:Power2.easeOut,
        }, "+=2.5");
	...
	//final frame copy
        ...
        //this.tlAnim.from([mc.cta,mc.txtCta], { duration: 0.8, alpha: 0}, "<+4.4");
