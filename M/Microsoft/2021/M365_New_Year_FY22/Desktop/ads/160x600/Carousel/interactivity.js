    ...
    gsap.to(exportRoot.mainMC.frontRibbon,
        {
            ...
            onUpdate: function () {
                ...
                exportRoot.mainMC.frontRibbon2.bg.cache(-2, -2, 804, 66);
                if(exportRoot.mainMC.frontRibbon.hue<50 || exportRoot.mainMC.frontRibbon.hue>100 ) {
                    ...
                    exportRoot.mainMC.frontRibbon2.bg.filters[1] = new createjs.ColorMatrixFilter(matrix);
                }
            }
        });
    gsap.to(exportRoot.mainMC.backRibbon,
        {
            ...
            onUpdate: function () {
                ...
                exportRoot.mainMC.backRibbon2.cache(-2, -2, 424, 66);
                if(exportRoot.mainMC.frontRibbon.hue<50 || exportRoot.mainMC.frontRibbon.hue>100 ) {
                    ...
                    exportRoot.mainMC.backRibbon2.filters[1] = new createjs.ColorMatrixFilter(matrix)
                }
            }
        });
}
...
function ribbonMovement(nColor) {
        ...
        gsap.to([exportRoot.mainMC.frontRibbon, exportRoot.mainMC.frontRibbon2], {
            x: exportRoot.start_frontRibbon - (exportRoot.frontRibbon_movement / exportRoot.nSlide) * (nColor + 1),
            duration: 1.2, ease: "power2.inOut"
        });
        gsap.to([exportRoot.mainMC.backRibbon, exportRoot.mainMC.backRibbon2], {
            x: exportRoot.start_backRibbon - (exportRoot.backRibbon_movement / exportRoot.nSlide) * (nColor + 1),
            duration: 1.2, ease: "power2.inOut"
        });

        if(nColor==2) {
            gsap.to([exportRoot.mainMC.frontRibbon2, exportRoot.mainMC.backRibbon2], {
                alpha:0,
                duration: 1.2, ease: "power2.inOut"
            });
        } else {
        ...
        for(let i = 1; i<=exportRoot.nSlide; i++) {
            if(i!= exportRoot.selectedSlide) {
                cst.to(exportRoot["headline" + i], {
                    ...
                    x: (direction) ? 0-50 : exportRoot.width+50,
