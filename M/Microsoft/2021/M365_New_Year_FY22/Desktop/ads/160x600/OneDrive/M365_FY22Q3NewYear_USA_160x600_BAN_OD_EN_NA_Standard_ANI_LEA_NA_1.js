...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(145.85,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(37.2,576.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-57.75,343.35,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-171.7,0,331.7,600), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_160x600_BAN_OD_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-91.2,300,248.3,278);
// library properties:
lib.properties = {
