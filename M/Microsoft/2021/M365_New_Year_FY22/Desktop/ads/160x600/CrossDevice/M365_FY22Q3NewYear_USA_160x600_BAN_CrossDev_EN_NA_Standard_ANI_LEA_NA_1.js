...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(36.9,575.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-57.2,343.25,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-171.2,5,326.2,573.1), null);


// stage content:
(lib.M365_FY22Q3NewYear_USA_160x600_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-90.6,300,245,277.9);
// library properties:
lib.properties = {
