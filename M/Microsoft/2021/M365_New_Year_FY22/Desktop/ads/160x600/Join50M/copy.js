// JavaScript Document
	...
	bannerData.headline1 = ['<#505050>50 million people|discovered how to|get more done','17px',80, 265,'18','350', 'center', 'Segoe Pro'];
	bannerData.headline2 = ['<#505050>Start now','18px',79, 108,'20','350', 'center', 'Segoe Pro'];
		
	bannerData.CTA = ['<#ffffff>Learn more','14px',0,0,'50','300', 'left', 'Segoe Pro'];
