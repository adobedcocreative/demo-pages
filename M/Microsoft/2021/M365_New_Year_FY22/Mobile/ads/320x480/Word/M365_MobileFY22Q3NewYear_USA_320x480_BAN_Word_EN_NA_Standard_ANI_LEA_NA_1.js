...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-73.7,0.7,394.2,480), null);


// stage content:
(lib.M365_MobileFY22Q3NewYear_USA_320x480_BAN_Word_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
