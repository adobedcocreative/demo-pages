...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(155.3,204.75,0.9,0.9,0,0,0,13.6,10.9);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(305.3,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(95.9,452.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(40.3,219.9,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-73.7,0,393.7,480), null);


// stage content:
(lib.M365_MobileFY22Q3NewYear_USA_320x480_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(86.5,240,229.60000000000002,216.2);
// library properties:
lib.properties = {
