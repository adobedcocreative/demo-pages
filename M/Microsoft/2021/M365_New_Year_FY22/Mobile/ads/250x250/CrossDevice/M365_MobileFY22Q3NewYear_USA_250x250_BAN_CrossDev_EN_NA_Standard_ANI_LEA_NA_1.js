...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(155.1,204.8,0.7,0.7,0,0,0,13.6,10.8);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(235.15,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(69.1,227.8,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-0.7,-5.9,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-114.7,-26.1,364.7,276.1), null);


// stage content:
(lib.M365_MobileFY22Q3NewYear_USA_250x250_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(10.7,98.9,235.5,130.9);
// library properties:
lib.properties = {
