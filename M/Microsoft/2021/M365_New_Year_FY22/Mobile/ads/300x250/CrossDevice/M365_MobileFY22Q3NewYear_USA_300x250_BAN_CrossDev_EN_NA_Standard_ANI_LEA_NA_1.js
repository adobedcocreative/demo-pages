...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(181.15,200.2,0.7,0.7,0,0,0,13.6,10.8);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(106.8,228.8,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(0.25,0.35,1.1359,1.1367,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-113.7,-19.9,413.7,269.9), null);


// stage content:
(lib.M365_MobileFY22Q3NewYear_USA_300x250_BAN_CrossDev_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(36.6,105.1,258.59999999999997,125.70000000000002);
// library properties:
lib.properties = {
