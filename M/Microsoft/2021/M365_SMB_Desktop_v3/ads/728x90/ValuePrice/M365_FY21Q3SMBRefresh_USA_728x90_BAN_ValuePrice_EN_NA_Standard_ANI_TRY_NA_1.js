...
lib.ssMetadata = [
		{name:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,860,300]]}
];
...
(lib.SMB_COVID_Response_200917_1185 = function() {
	this.initialize(ss["M365_FY21Q3SMBRefresh_USA_728x90_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AtBCbIAIk1IZzAAIAIE1g");
	this.shape.setTransform(83.4263,15.5001);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadowSub, new cjs.Rectangle(0,0,166.9,31), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.SMB_COVID_Response_200917_1185();
	this.instance.setTransform(392.85,-12.45,0.398,0.398);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EDF0E9").s().p("Eg6yAJUIAAynMB1kAAAIAASng");
	this.shape.setTransform(367.25,45.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-9,-14,752.5,121), null);
...
if (reversed == null) { reversed = false; }
	...
	this.cubeShadowSub.setTransform(83.4,-10,0.9,1,0,180,0,83.4,10);

	this.timeline.addTween(cjs.Tween.get(this.cubeShadowSub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cubeShadow, new cjs.Rectangle(8.4,-31,150.1,31), null);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AmRB1IAAjpIMjAAIAADpg");
	this.shape.setTransform(-64.625,2.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-104.8,-9,80.4,23.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(712.1,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(39.2,62.45,1.2856,1.2856,0,0,0,0.2,0.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(125.95,58.1,1.2127,1.2127,0,0,0,0.2,0.2);
	...
	this.cubeShadow.setTransform(275.5,115.95,1,1,0,0,0,82.9,-15.5);
	this.cubeShadow.alpha = 0;
	this.cubeShadow.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.cubeShadow.cache(6,-33,154,35);

	this.timeline.addTween(cjs.Tween.get(this.cubeShadow).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-9,-14,752.5,151.5), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_728x90_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.from(exportRoot.headline1,{duration:0.8, y: "+=60", alpha: 0, stagger: 0.1, onStart:function(){tlCube.restart();}}, "+=.2");
				this.tlMain.to(exportRoot.headline1,{duration:0.8, y: "-=60", alpha: 0}, "+=7.9");
...
p.nominalBounds = new cjs.Rectangle(355.1,31,386.1,106.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3SMBRefresh_USA_728x90_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606923134570", id:"M365_FY21Q3SMBRefresh_USA_728x90_BAN_ValuePrice_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
