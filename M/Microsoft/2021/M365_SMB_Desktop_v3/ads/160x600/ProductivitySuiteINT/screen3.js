...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,245,984]]}
];
...
p.nominalBounds = new cjs.Rectangle(50,200.7,35.8,35.80000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(107.05,43.1,1.4724,1.4139,0,0,0,0.6,0.5);
	...
	this.txt.name = "txt";
	this.txt.setTransform(70.5,70.5,1,0.9,0,0,0,70.5,70.5);

	this.timeline.addTween(cjs.Tween.get(this.txt).wait(1));

	// VidStatic
	this.instance_1 = new lib.MaskGroup11();
	this.instance_1.setTransform(-1,-3,1.0506,0.973);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-3,257.4,957.4), null);
...
p.nominalBounds = new cjs.Rectangle(127,508.5,129.39999999999998,518.0999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606915647703", id:"screen3_atlas_1"}
	],
	preloads: []
};
