...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-66.65,2.125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-116.5,-11.6,99.7,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(143.65,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(103.5,570.2,1,1,0,0,0,0.8,0.2);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(180.75,567.6,1,1,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,163.8,600), null);


// stage content:
(lib.M365_FY21Q3SMBRefresh_USA_160x600_BAN_Security_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,83.69999999999999,283);
// library properties:
lib.properties = {
