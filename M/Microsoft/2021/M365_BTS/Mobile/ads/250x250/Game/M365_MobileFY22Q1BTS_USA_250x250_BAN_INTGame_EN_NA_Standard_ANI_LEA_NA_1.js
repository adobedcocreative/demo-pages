...
lib.ssMetadata = [
		{name:"M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[0,0,300,400],[302,0,300,400],[604,0,300,400],[906,0,300,400],[0,402,300,400],[302,402,300,400],[604,402,300,400],[906,402,300,400],[0,804,300,400],[302,804,300,400],[1208,0,284,272],[1208,274,284,272],[1208,548,284,272],[927,822,284,272],[1213,822,284,272],[604,1048,284,272],[0,1206,284,272],[286,1206,284,272],[890,1096,284,272],[572,1322,284,272],[1176,1096,284,272],[0,1480,284,272],[286,1480,284,272],[858,1370,284,272],[572,1596,284,272],[1144,1370,284,272],[0,1754,284,272],[286,1754,284,272],[858,1644,284,272],[572,1870,284,272],[1144,1644,284,272],[0,2028,284,272],[286,2028,284,272],[858,1918,284,272],[572,2144,284,272],[1144,1918,284,272],[0,2302,284,272],[286,2302,284,272],[0,2576,284,272],[286,2576,284,272],[572,2418,284,272],[572,2692,284,272],[858,2192,284,272],[1144,2192,284,272],[858,2466,284,272],[1144,2466,284,272],[604,804,321,242]]},
		{name:"M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2", frames: [[713,1236,100,100],[815,1236,100,100],[917,1236,100,100],[1204,1322,100,100],[1306,1322,100,100],[0,1325,100,100],[1019,1335,100,100],[102,1338,100,100],[204,1338,100,100],[713,1338,100,100],[815,1338,100,100],[917,1338,100,100],[529,1345,100,100],[306,1383,100,100],[408,1383,100,100],[529,1236,100,107],[0,0,284,272],[286,0,284,272],[572,0,284,272],[858,0,284,272],[1144,0,284,272],[0,274,284,272],[286,274,284,272],[572,274,284,272],[858,274,284,272],[1144,274,284,272],[0,548,284,272],[286,548,284,272],[1323,806,170,170],[203,822,170,170],[375,822,170,170],[1323,978,170,170],[0,981,170,170],[1088,991,170,170],[172,994,170,170],[344,994,170,170],[516,1064,170,170],[688,1064,170,170],[860,1064,170,170],[1260,1150,170,170],[0,1153,170,170],[1032,1163,170,170],[172,1166,170,170],[1088,806,233,183],[572,548,256,256],[344,1236,183,145],[830,548,256,256],[0,822,201,157],[1088,548,256,256],[1346,655,120,120],[572,806,256,256],[631,1236,80,132],[1346,548,141,105],[830,806,256,256]]}
];
...
(lib.applev2_001 = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.bagpackcameramovs_1_0070 = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(160.9,9.9,0.4194,0.4197,0,57.1708,56.9263,-0.1,-0.8);
...
}).prototype = getMCSymbolPrototype(lib.pptScreen, new cjs.Rectangle(0,-1,172.1,122), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("AzhTiMAAAgnDMAnDAAAMAAAAnDg");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-11.85,178.45,0.361,0.5176,0,0,0,159.7,240.2);
...
p.nominalBounds = new cjs.Rectangle(-69.5,-3.2,113.9,186.7);
...
if (reversed == null) { reversed = false; }
	...
	this.i_pencil.setTransform(89.3,-32.6,1,1,0,0,0,19,33.5);

	this.i_banana = new lib.banana();
	this.i_banana.name = "i_banana";
	this.i_banana.setTransform(194.65,-65.6,1,1,0,0,0,25,34.5);

	this.i_ppt = new lib.ppticon();
	this.i_ppt.name = "i_ppt";
	this.i_ppt.setTransform(44.4,-35.15,1,1,0,0,0,50,50);

	this.i_apple1 = new lib.apple1();
	this.i_apple1.name = "i_apple1";
	this.i_apple1.setTransform(179.8,-35.15,0.8,0.8,0,0,0,25,34.5);

	this.i_onedrive = new lib.onedriveicon();
	this.i_onedrive.name = "i_onedrive";
	this.i_onedrive.setTransform(137.95,-27.35,1,1,0,0,0,50,50);
...
p.nominalBounds = new cjs.Rectangle(-19.5,-100.1,274.2,136.8);
...
if (reversed == null) { reversed = false; }
	...
	this.i_apple2.setTransform(157.8,-34.1,1,1,0,0,0,25,26.9);

	this.i_excel = new lib.excelicon();
	this.i_excel.name = "i_excel";
	this.i_excel.setTransform(215.05,-36.25,1,1,0,0,0,50,50);

	this.i_onedrive = new lib.onedriveicon();
	this.i_onedrive.name = "i_onedrive";
	this.i_onedrive.setTransform(103.45,-27.8,1,1,0,0,0,50,50);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.i_onedrive},{t:this.i_excel},{t:this.i_apple2},{t:this.i_word}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icongroup2, new cjs.Rectangle(-23.2,-100.2,302.3,136.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.i_banana = new lib.banana();
	this.i_banana.name = "i_banana";
	this.i_banana.setTransform(102.7,-64.7,1,1,0,0,0,25,34.5);
	...
	this.i_word = new lib.wordicon();
	this.i_word.name = "i_word";
	this.i_word.setTransform(211.35,-36.05,1,1,0,0,0,64,64);
	...
	this.i_ppt = new lib.ppticon();
	this.i_ppt.name = "i_ppt";
	this.i_ppt.setTransform(121,-33.8,1,1,0,0,0,50,50);
...
}).prototype = getMCSymbolPrototype(lib.icongroup1, new cjs.Rectangle(-23.3,-100,298.7,136.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.excel.setTransform(271,210,0.8008,0.8008,0,0,0,89.5,68.9);
	...
	this.oneDrive.setTransform(220.3,19.15,0.9,0.9,0,0,0,63.9,49.6);

	this.outlook = new lib.outlook();
	this.outlook.name = "outlook";
	this.outlook.setTransform(48.2,217.15,0.9,0.9,0,0,0,65.8,50.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.outlook},{t:this.oneDrive}]}).wait(54));

	// PptMob
	this.pptMob = new lib.pptMob();
	this.pptMob.name = "pptMob";
	this.pptMob.setTransform(47.75,161.85,1,1,0,0,0,26.4,45.4);
	...
	this.pptScreen.setTransform(157,159.5,1,1,0,0,0,114.2,85);
	...
	this.word.name = "word";
	this.word.setTransform(26.85,127.05,0.9,0.9,0,0,0,51.8,37.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_34 = new cjs.Graphics().p("AmDPvQhugvgthvQgthuAuhvQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAtBvgwBuQguBuhvAsMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_35 = new cjs.Graphics().p("AmHPwQhugugshvQgthvAuhvQAwhuBugsMAh/gNuQBvgtBtAuQBvAvAtBvQAtBvgwBuQguBuhvAtMgh+ANvQg2AWg2AAQg5AAg5gZg");
	var mask_graphics_36 = new cjs.Graphics().p("AmUP2QhugvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAtBvgwBuQguBthvAtMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_37 = new cjs.Graphics().p("AmxQBQhtgugthvQgthvAuhvQAwhuBvgsMAh+gNuQBvgtBtAuQBwAwAsBuQAtBvgwBuQguBuhuAtMgh/ANvQg2AWg2AAQg5AAg5gZg");
	var mask_graphics_38 = new cjs.Graphics().p("AnjQWQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBtAvQBwAvAsBvQAtBvgwBtQguBuhuAtMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_39 = new cjs.Graphics().p("AomQxQhugugthvQgthvAuhvQAwhuBvgtMAh+gNuQBvgsBuAuQBvAvAtBvQAtBvgwBtQguBvhvAtMgh+ANvQg2AVg2AAQg5AAg5gYg");
	var mask_graphics_40 = new cjs.Graphics().p("ApoRMQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAsBvgvBtQguBuhvAtMgh+ANvQg2AWg3AAQg5AAg5gYg");
	var mask_graphics_41 = new cjs.Graphics().p("AqbRhQhugvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAtBvgwBtQguBuhvAtMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_42 = new cjs.Graphics().p("ArDRxQhugvgshuQgthvAuhvQAvhuBvgtMAh/gNuQBvgtBtAvQBvAvAtBvQAtBvgwBtQguBvhvAsMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_43 = new cjs.Graphics().p("AriR9QhtgugthvQgthvAuhvQAwhuBvgtMAh+gNtQBvgtBuAuQBvAvAtBvQAsBugvBuQguBvhvAtMgh+ANvQg2AWg3AAQg5AAg5gZg");
	var mask_graphics_44 = new cjs.Graphics().p("Ar5SHQhugvgthuQgthvAuhvQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAtBugwBuQguBvhvAsMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_45 = new cjs.Graphics().p("AsMSPQhugvgshvQgthvAuhuQAwhuBugtMAh/gNuQBvgtBtAvQBvAvAtBvQAtBugwBuQguBuhvAtMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_46 = new cjs.Graphics().p("AsbSVQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBtAvQBwAvAsBvQAtBugvBuQguBuhvAtMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_47 = new cjs.Graphics().p("AsmSZQhugugthvQgshvAuhvQAvhuBvgtMAh/gNtQBugtBuAuQBvAvAtBvQAtBugwBuQguBvhvAtMgh+ANvQg2AVg2AAQg5AAg5gYg");
	var mask_graphics_48 = new cjs.Graphics().p("AsvSdQhugvgshvQgthuAuhvQAvhuBvgtMAh/gNuQBvgtBtAvQBvAvAtBvQAtBugwBuQguBvhvAsMgh+ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_49 = new cjs.Graphics().p("As2SgQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBtAvQBwAvAsBvQAtBugwBuQgtBuhvAtMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_50 = new cjs.Graphics().p("As7SiQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBuAuQBvAwAtBvQAsBugvBuQguBuhvAtMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_51 = new cjs.Graphics().p("As+SjQhtgvgthvQgthuAuhvQAwhuBvgtMAh+gNuQBvgtBtAvQBwAvAsBvQAtBugwBuQguBvhuAsMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_52 = new cjs.Graphics().p("AtASkQhtgvgthvQgthvAuhuQAwhuBvgtMAh+gNuQBvgtBtAvQBwAvAtBvQAsBugvBuQguBuhvAtMgh/ANvQg2AWg2AAQg5AAg5gYg");
	var mask_graphics_53 = new cjs.Graphics().p("AtBSjQhugvgthvQgthuAuhvQAwhuBvgtMAh+gNuQBvgtBuAvQBvAvAtBvQAtBugwBuQguBvhvAsMgh+ANvQg2AWg2AAQg5AAg5gYg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(34).to({graphics:mask_graphics_34,x:219.0553,y:103.1064}).wait(1).to({graphics:mask_graphics_35,x:218.6907,y:103.2549}).wait(1).to({graphics:mask_graphics_36,x:217.3531,y:103.799}).wait(1).to({graphics:mask_graphics_37,x:214.5045,y:104.9577}).wait(1).to({graphics:mask_graphics_38,x:209.5079,y:106.9902}).wait(1).to({graphics:mask_graphics_39,x:202.7515,y:109.7385}).wait(1).to({graphics:mask_graphics_40,x:196.2345,y:112.3895}).wait(1).to({graphics:mask_graphics_41,x:191.0478,y:114.4992}).wait(1).to({graphics:mask_graphics_42,x:187.0842,y:116.1115}).wait(1).to({graphics:mask_graphics_43,x:184.0334,y:117.3525}).wait(1).to({graphics:mask_graphics_44,x:181.6558,y:118.3196}).wait(1).to({graphics:mask_graphics_45,x:179.788,y:119.0795}).wait(1).to({graphics:mask_graphics_46,x:178.3179,y:119.6774}).wait(1).to({graphics:mask_graphics_47,x:177.167,y:120.1456}).wait(1).to({graphics:mask_graphics_48,x:176.2782,y:120.5071}).wait(1).to({graphics:mask_graphics_49,x:175.6087,y:120.7795}).wait(1).to({graphics:mask_graphics_50,x:175.1258,y:120.9759}).wait(1).to({graphics:mask_graphics_51,x:174.804,y:121.1068}).wait(1).to({graphics:mask_graphics_52,x:174.6228,y:121.1805}).wait(1).to({graphics:mask_graphics_53,x:174.4553,y:121.1064}).wait(1));

	// Layer_3 copy 3
	this.instance = new lib.scribble5Sub();
	this.instance.setTransform(144.75,196.5,0.9736,0.9736,0,0,0,42.2,17.2);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(25).to({graphics:mask_1_graphics_25,x:-49.2411,y:87.4626}).wait(1).to({graphics:mask_1_graphics_26,x:-46.2103,y:87.8816}).wait(1).to({graphics:mask_1_graphics_27,x:-37.4146,y:89.0961}).wait(1).to({graphics:mask_1_graphics_28,x:-23.7148,y:90.9878}).wait(1).to({graphics:mask_1_graphics_29,x:-6.4522,y:93.3714}).wait(1).to({graphics:mask_1_graphics_30,x:12.6837,y:96.0137}).wait(1).to({graphics:mask_1_graphics_31,x:31.8195,y:98.656}).wait(1).to({graphics:mask_1_graphics_32,x:49.0821,y:101.0397}).wait(1).to({graphics:mask_1_graphics_33,x:62.7819,y:102.9313}).wait(1).to({graphics:mask_1_graphics_34,x:71.5776,y:104.1459}).wait(1).to({graphics:mask_1_graphics_35,x:74.1589,y:104.6376}).wait(19));

	// Layer_3 copy 2
	this.instance_1 = new lib.scribble4Sub();
	this.instance_1.setTransform(129.95,164.2,0.9736,0.9736,0,0,0,57.5,16.4);
	...
	mask_2._off = true;
	var mask_2_graphics_19 = new cjs.Graphics().p("AmuKlQhng7gfh0QgfhzA8hoQA8hoB0gfMAjXgJdQB0gfBnA7QBoA9AfBzQAfBzg8BoQg8BnhzAfMgjYAJfQgnAKgmAAQhKAAhFgog");
	var mask_2_graphics_20 = new cjs.Graphics().p("AnOKuQhng8gfhzQgfhzA8hpQA8hnB0gfMAjXgJeQB0gfBnA8QBoA8AfB0QAfBzg8BnQg8BohzAfMgjYAJeQgnALgmAAQhKAAhFgog");
	var mask_2_graphics_21 = new cjs.Graphics().p("AooLGQhmg7gfh0QgfhzA7hpQA8hnB0gfMAjYgJeQBzgfBnA8QBpA8AfB0QAeBzg8BnQg7Boh0AfMgjXAJeQgoALglAAQhKAAhGgog");
	var mask_2_graphics_22 = new cjs.Graphics().p("AqpLpQhng8gfhzQgfhzA7hpQA9hnBzgfMAjYgJeQBzgfBnA8QBpA8AfB0QAfBzg9BmQg7Bph0AfMgjXAJeQgnALgmAAQhKAAhFgog");
	var mask_2_graphics_23 = new cjs.Graphics().p("As5MQQhng8gfhzQgfh0A7hoQA9hnBzgfMAjYgJeQBzgfBnA8QBpA8AfBzQAfB0g9BmQg7BohzAfMgjYAJfQgnALgmAAQhKAAhFgog");
	var mask_2_graphics_24 = new cjs.Graphics().p("Au7MyQhng7gfhzQgfh0A7hoQA9hnB0gfMAjXgJeQB0gfBnA7QBoA9AfBzQAfBzg9BnQg7BohzAfMgjYAJfQgnAKgmAAQhKAAhFgog");
	var mask_2_graphics_25 = new cjs.Graphics().p("AwVNLQhng8gfhzQgeh0A7hoQA8hnB0gfMAjXgJeQB0gfBnA8QBoA8AfBzQAfBzg8BnQg8BohzAfMgjYAJfQgnALgmAAQhKAAhFgog");
	var mask_2_graphics_26 = new cjs.Graphics().p("Aw1NTQhng7gfh0QgfhzA8hoQA8hoB0gfMAjXgJdQB0gfBnA7QBoA9AfBzQAfByg8BoQg8BohzAfMgjYAJfQgnAKgmAAQhKAAhFgog");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(19).to({graphics:mask_2_graphics_19,x:226.8775,y:71.7161}).wait(1).to({graphics:mask_2_graphics_20,x:223.6743,y:72.5779}).wait(1).to({graphics:mask_2_graphics_21,x:214.6979,y:74.992}).wait(1).to({graphics:mask_2_graphics_22,x:201.7265,y:78.4804}).wait(1).to({graphics:mask_2_graphics_23,x:187.3294,y:82.3523}).wait(1).to({graphics:mask_2_graphics_24,x:174.3581,y:85.8407}).wait(1).to({graphics:mask_2_graphics_25,x:165.3816,y:88.2548}).wait(1).to({graphics:mask_2_graphics_26,x:162.1775,y:89.1161}).wait(28));

	// Layer_3 copy
	this.instance_2 = new lib.scribble3Sub();
	this.instance_2.setTransform(132.95,132.4,0.9736,0.9736,0,0,0,60.6,16.8);
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(12).to({graphics:mask_3_graphics_12,x:-45.4385,y:58.7087}).wait(1).to({graphics:mask_3_graphics_13,x:-41.6476,y:59.1344}).wait(1).to({graphics:mask_3_graphics_14,x:-30.7321,y:60.3613}).wait(1).to({graphics:mask_3_graphics_15,x:-14.0086,y:62.2411}).wait(1).to({graphics:mask_3_graphics_16,x:6.5058,y:64.5469}).wait(1).to({graphics:mask_3_graphics_17,x:28.3368,y:67.0007}).wait(1).to({graphics:mask_3_graphics_18,x:48.8512,y:69.3065}).wait(1).to({graphics:mask_3_graphics_19,x:65.5747,y:71.1862}).wait(1).to({graphics:mask_3_graphics_20,x:76.4902,y:72.4131}).wait(1).to({graphics:mask_3_graphics_21,x:79.6115,y:72.8337}).wait(33));

	// Layer_3
	this.instance_3 = new lib.scribble2sub();
	this.instance_3.setTransform(133.65,103.5,0.9736,0.9736,0,0,0,59.8,13.2);
	...
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AitHUQhjhCgXh1QgYh1BChkQBDhiB2gXMAj5gHKQB1gXBjBCQBkBDAXB1QAYB1hEBjQhBBjh2AXMgj6AHKQgeAGgcAAQhUAAhKgyg");
	var mask_4_graphics_1 = new cjs.Graphics().p("AiyHUQhjhCgXh1QgYh1BChkQBDhiB2gXMAj5gHKQB1gXBjBCQBkBDAXB1QAYB1hEBjQhBBjh2AXMgj6AHKQgeAGgcAAQhUAAhKgyg");
	var mask_4_graphics_2 = new cjs.Graphics().p("AjDHUQhjhCgXh1QgXh1BBhkQBEhiB1gXMAj5gHKQB1gXBjBCQBkBDAYB1QAXB1hDBjQhCBjh1AXMgj6AHKQgeAGgdAAQhTAAhLgyg");
	var mask_4_graphics_3 = new cjs.Graphics().p("AjjHUQhjhCgXh1QgYh1BChkQBDhiB1gXMAj6gHKQB1gXBjBCQBkBDAXB1QAYB1hEBjQhBBjh2AXMgj5AHKQgeAGgdAAQhUAAhKgyg");
	var mask_4_graphics_4 = new cjs.Graphics().p("AkYHUQhjhBgYh2QgXh1BChkQBDhiB1gXMAj5gHKQB2gXBiBCQBlBDAXB1QAXB1hDBjQhCBjh1AXMgj5AHKQgeAGgdAAQhUAAhKgyg");
	var mask_4_graphics_5 = new cjs.Graphics().p("AlqHVQhihCgYh2QgXh1BChkQBDhiB1gXMAj5gHKQB2gXBiBBQBlBEAXB1QAXB1hDBjQhCBjh1AXMgj5AHKQgeAGgeAAQhTAAhLgxg");
	var mask_4_graphics_6 = new cjs.Graphics().p("AndHVQhjhCgXh2QgYh1BChkQBDhiB1gXMAj6gHKQB1gYBjBCQBkBDAYB2QAXB1hDBjQhCBjh1AXMgj6AHKQgeAGgdAAQhUAAhKgxg");
	var mask_4_graphics_7 = new cjs.Graphics().p("ApuHVQhjhCgXh2QgXh1BBhkQBEhiB1gXMAj5gHKQB2gYBjBCQBkBDAXB2QAYB1hEBjQhBBjh2AXMgj5AHKQgfAGgdAAQhTAAhLgxg");
	var mask_4_graphics_8 = new cjs.Graphics().p("AsCHaQhihCgYh1QgXh1BChkQBDhiB1gYMAj6gHKQB1gXBjBCQBkBDAYB1QAXB1hDBkQhCBjh1AXMgj6AHKQgeAGgdAAQhUAAhLgyg");
	var mask_4_graphics_9 = new cjs.Graphics().p("At+H1QhjhCgXh1QgYh1BChkQBDhkB2gWMAj6gHKQB1gXBjBCQBkBDAYB1QAXB1hDBjQhCBjh1AYMgj7AHKQgeAGgdAAQhUAAhKgyg");
	var mask_4_graphics_10 = new cjs.Graphics().p("AvdIKQhjhCgXh2QgXh1BBhkQBEhjB1gXMAj6gHKQB1gXBjBCQBlBDAXB1QAXB1hDBjQhCBkh1AXMgj6AHKQgfAGgdAAQhTAAhLgxg");
	var mask_4_graphics_11 = new cjs.Graphics().p("AwiIYQhjhCgXh1QgYh1BChkQBDhjB2gYMAj6gHJQB1gXBjBCQBkBDAYB1QAXB1hDBjQhCBjh1AYMgj7AHKQgeAGgdAAQhUAAhKgyg");
	var mask_4_graphics_12 = new cjs.Graphics().p("AxUIjQhjhCgXh1QgXh1BBhlQBEhjB1gXMAj6gHJQB2gYBiBCQBlBDAXB2QAYB1hEBiQhBBkh2AXMgj6AHLQgeAGgeAAQhTAAhLgyg");
	var mask_4_graphics_13 = new cjs.Graphics().p("Ax2IrQhjhCgYh2QgXh1BChkQBDhjB1gYMAj7gHJQB1gXBjBCQBkBDAYB1QAXB1hDBiQhCBlh1AXMgj7AHKQgeAGgdAAQhUAAhKgxg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:257.4207,y:27.3841}).wait(1).to({graphics:mask_4_graphics_1,x:256.9267,y:27.5968}).wait(1).to({graphics:mask_4_graphics_2,x:255.2539,y:28.316}).wait(1).to({graphics:mask_4_graphics_3,x:252.0292,y:29.7025}).wait(1).to({graphics:mask_4_graphics_4,x:246.7165,y:31.9868}).wait(1).to({graphics:mask_4_graphics_5,x:238.6049,y:35.4744}).wait(1).to({graphics:mask_4_graphics_6,x:227.0703,y:40.4338}).wait(1).to({graphics:mask_4_graphics_7,x:212.6283,y:46.6432}).wait(1).to({graphics:mask_4_graphics_8,x:197.882,y:52.4145}).wait(1).to({graphics:mask_4_graphics_9,x:185.4537,y:55.0895}).wait(1).to({graphics:mask_4_graphics_10,x:175.9989,y:57.1245}).wait(1).to({graphics:mask_4_graphics_11,x:169.0821,y:58.6133}).wait(1).to({graphics:mask_4_graphics_12,x:164.1254,y:59.6801}).wait(1).to({graphics:mask_4_graphics_13,x:160.6667,y:60.4239}).wait(41));

	// Layer_2
	this.instance_4 = new lib.scribble1();
	this.instance_4.setTransform(137.1,77.95,0.9736,0.9736,0,0,0,63.3,13.3);
...
p.nominalBounds = new cjs.Rectangle(-19.7,7.1,312.4,235.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-27.7603,1,0.7869,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-153.6,-21,251.8,44.1), null);
...
}).prototype = getMCSymbolPrototype(lib.icons, new cjs.Rectangle(-23.3,-100.2,302.40000000000003,136.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("AzhTiMAAAgnDMAnDAAAMAAAAnDg");
	this.shape.setTransform(175.4519,-331.6051);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cta1st, new cjs.Rectangle(50.5,-456.6,250,250.00000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(219.8,229.45,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(152.95,229);
	...
	this.bagRevolveMasked.setTransform(117.95,222.85,0.8343,0.8343,0,0,0,87.8,116.7);
	...
	this.trackObject.setTransform(105.25,422.6);
	...
	this.score_MC.setTransform(60.6,88.9);
	...
	this.gameMain.setTransform(101.65,224.7,0.8343,0.8342,0,0,0,67.8,119.2);
	...
	this.playTxt.setTransform(124.7,103.65,1,1,0,0,0,0.7,0.1);
	...
	this.playBtn.setTransform(126.5,86.4);
	...
	this.txtLearn.setTransform(230,229.45,1,1,0,0,0,0.7,0.1);

	this.cta1 = new lib.cta1st();
	this.cta1.name = "cta1";
	this.cta1.setTransform(-49.95,456.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-596.3,-100.2,1116.1999999999998,428.2), null);


// stage content:
(lib.M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(101.7,24.8,418.2,303.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1623230668169", id:"M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"},
		{src:"images/M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2.png?1623230668169", id:"M365_MobileFY22Q1BTS_USA_250x250_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"}
	],
	preloads: []
};
