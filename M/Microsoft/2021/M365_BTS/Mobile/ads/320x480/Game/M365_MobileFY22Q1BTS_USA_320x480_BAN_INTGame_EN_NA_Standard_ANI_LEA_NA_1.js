...
lib.ssMetadata = [
		{name:"M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[457,0,300,400],[0,339,300,400],[759,0,300,400],[1061,0,300,400],[302,402,300,400],[0,741,300,400],[604,402,300,400],[906,402,300,400],[302,804,300,400],[0,1143,300,400],[1208,402,284,272],[1208,676,284,272],[961,950,284,272],[604,1079,284,272],[302,1206,284,272],[890,1224,284,272],[588,1353,284,272],[302,1480,284,272],[0,1545,284,272],[1176,1224,284,272],[874,1498,284,272],[588,1627,284,272],[286,1754,284,272],[0,1819,284,272],[1160,1498,284,272],[874,1772,284,272],[572,1901,284,272],[286,2028,284,272],[0,2093,284,272],[1160,1772,284,272],[858,2046,284,272],[572,2175,284,272],[286,2302,284,272],[0,2367,284,272],[1144,2046,284,272],[0,2641,284,272],[286,2576,284,272],[572,2449,284,272],[572,2723,284,272],[858,2320,284,272],[1144,2320,284,272],[858,2594,284,272],[1144,2594,284,272],[604,804,355,273],[0,0,455,337]]},
		{name:"M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2", frames: [[1005,1424,100,100],[172,1449,100,100],[274,1449,100,100],[1380,1451,100,100],[0,1453,100,100],[1107,1487,100,100],[1209,1487,100,100],[1005,1526,100,100],[903,1533,100,100],[781,1546,100,100],[102,1551,100,100],[204,1551,100,100],[306,1551,100,100],[1311,1553,100,100],[0,1555,100,100],[903,1424,100,107],[0,0,284,272],[286,0,284,272],[572,0,284,272],[858,0,284,272],[1144,0,284,272],[0,274,284,272],[286,274,284,272],[572,274,284,272],[858,274,284,272],[1144,274,284,272],[0,548,284,272],[286,548,284,272],[572,548,284,272],[858,548,284,272],[1144,548,284,272],[1290,971,170,170],[520,1080,170,170],[692,1080,170,170],[864,1080,170,170],[1036,1080,170,170],[1208,1143,170,170],[520,1252,170,170],[692,1252,170,170],[864,1252,170,170],[1036,1252,170,170],[265,1277,170,170],[0,1281,170,170],[1208,1315,170,170],[437,1424,170,170],[609,1424,170,170],[1380,1324,117,125],[0,822,256,256],[265,1080,253,195],[258,822,256,256],[0,1080,263,199],[516,822,256,256],[781,1424,120,120],[774,822,256,256],[1380,1143,103,179],[1290,822,207,147],[1032,822,256,256]]}
];
...
(lib.applev2_001 = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.bagpackcameramovs_1_0070 = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.word, new cjs.Rectangle(0,0,103.5,73.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(0.025,-182.386,1,2.5604);
...
p.nominalBounds = new cjs.Rectangle(-72.6,-422.2,145.3,479.7);
...
if (reversed == null) { reversed = false; }
	...
	// doodle
	this.instance = new lib.Doodle312x();
	this.instance.setTransform(200.75,-18.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_1
	this.instance_1 = new lib.PPT2x();
...
}).prototype = getMCSymbolPrototype(lib.pptScreen, new cjs.Rectangle(0,-18.7,259.3,187.2), null);
...
}).prototype = getMCSymbolPrototype(lib.pptMob, new cjs.Rectangle(0,0,51.5,89.5), null);
...
}).prototype = getMCSymbolPrototype(lib.outlook, new cjs.Rectangle(0,0,131.5,99.5), null);
...
}).prototype = getMCSymbolPrototype(lib.oneDrive, new cjs.Rectangle(0,0,126.5,97.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F7FE0").s().p("AhMGPQgegdAAgpQAAgqAfgbQAegbAuAAQAvAAAdAcQAeAbAAApQAAArgdAbQgeAcgvAAQguAAgfgcgAhLCYIgWpCIDCAAIgXJCg");
	this.shape.setTransform(88.125,8.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0F7FE0").s().p("AkpE9Qhxh1AAi9QAAjGBzh7QBzh7C+AAQCzgBBwB3QBuB2AADAQABDFhzB6Qh0B4i4AAQi1AAhxh1gAiZjEQg6BLgBB6QABB9A6BIQA7BJBeAAQBiAAA5hGQA6hHgBh9QAAiCg3hJQg4hIhhAAQhiAAg7BKg");
	this.shape_1.setTransform(23.05,7.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#0F7FE0").s().p("Aj9FDQh1hxAAjEQAAjGCAh8QB/h+DUABQCFgBBmAmIAACxQhig4iMAAQh1AAhKBNQhKBMAAB/QAACBBDBHQBCBHBwAAQBEAAAogTIAAilIioAAIAAiVIFlAAIAAGlQh7BGi3AAQjJAAh1hvg");
	this.shape_2.setTransform(-66.3,7.7);
...
p.nominalBounds = new cjs.Rectangle(-109.8,-81.8,219.7,163.6);
...
}).prototype = getMCSymbolPrototype(lib.excel, new cjs.Rectangle(0,0,177.5,136.5), null);
...
}).prototype = getMCSymbolPrototype(lib.BG, new cjs.Rectangle(0,0,320,480), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F7FE0").s().p("AlOHqIAAjJQBqBNCNAAQBXAAAygmQAxgmAAhEQAAhHg9gmQg8gmhrAAIhfAAIAAiwIBXAAQDNAAAAiIQAAiBidAAQhpAAhkBFIAAi9QBvg4CTAAQCgAABaBIQBZBJAAB0QAADNjQA0IAAAEQBvAOBABCQBBBDAABhQAACUhsBVQhrBWi9AAQijAAhmg1g");
	this.shape.setTransform(1.075,9.625);
...
p.nominalBounds = new cjs.Rectangle(-45.2,-101.7,90.4,203.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F7FE0").s().p("AleIWIAAi0IEtkgQBahWAlg7QAlg7AAhCQAAiQibgBQiIAAh7BsIAAjLQCJhZCrAAQChAABbBSQBaBQAACJQAAC4jdDEIjXDAIAAAEIGpAAIAADAg");
	this.shape.setTransform(-0.075,8.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F7FE0").s().p("AlIIWIAAi3IDZAAIAAqNIjfAwIAAi8IHFhbIAAN0IDYAAIAAC3g");
	this.shape.setTransform(2.225,8.7);
...
if (reversed == null) { reversed = false; }
	...
	// button
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0E7FE0").s().p("ApKD0IAAnmISVAAIAAHmg");
	this.shape.setTransform(0.025,16.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// BG
	this.instance = new lib.BG();
	this.instance.setTransform(0.25,178.45,0.4486,0.4593,0,0,0,159.8,240.2);
...
p.nominalBounds = new cjs.Rectangle(-71.4,-8.2,143.5,296.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(159.95,216.65,1.4,1.4);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(119).to({_off:false},0).to({scaleX:1,scaleY:1,x:160,y:216.7,alpha:1},5,cjs.Ease.quadOut).wait(1));

	// 1
	this.instance_1 = new lib._1("synched",0);
	this.instance_1.setTransform(159.95,213.4,1.4,1.4);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(79).to({_off:false},0).to({scaleX:1,scaleY:1,x:160,y:213.45,alpha:1},5,cjs.Ease.quadOut).wait(35).to({startPosition:0},0).to({alpha:0},5,cjs.Ease.cubicInOut).wait(1));

	// 2
	this.instance_2 = new lib._2("synched",0);
	this.instance_2.setTransform(159.95,213.4,1.3999,1.4142);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(39).to({_off:false},0).to({scaleX:1,scaleY:1,x:160,y:213.45,alpha:1},5,cjs.Ease.quadOut).wait(35).to({startPosition:0},0).to({alpha:0},5,cjs.Ease.cubicInOut).wait(41));

	// 3
	this.instance_3 = new lib._3("synched",0);
	this.instance_3.setTransform(159.95,213.4,1.4,1.4);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:1,scaleY:1,x:160,y:213.45,alpha:1},4,cjs.Ease.quadOut).wait(35).to({startPosition:0},0).to({alpha:0},5,cjs.Ease.cubicInOut).wait(81));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(6.2,69.5,307.5,287.8);
...
if (reversed == null) { reversed = false; }
	...
	this.oneDrive.setTransform(294.9,63.75,1,1,0,0,0,63.5,49);
	...
	this.excel.setTransform(316.15,407.35,1,1,0,0,0,89,68.5);
	...
	this.outlook.setTransform(47.4,385.6,1,1,0,0,0,66,50);
	...
	this.word.name = "word";
	this.word.setTransform(13,178.05,1,1,0,0,0,52,37);
	...
	this.pptMob.setTransform(49.2,273.2,1,1,0,0,0,26,45);
	...
	this.pptScreen.setTransform(167.55,251.8,1,1,0,0,0,114,84.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_34 = new cjs.Graphics().p("Ar3ZFQiehDhAigQhAifBCigQBEieCghAMAw4gTwQCghACdBDQCgBEBBCfQBACghECdQhDCfifBBMgw4ATwQhOAfhOAAQhSAAhSgig");
	var mask_graphics_35 = new cjs.Graphics().p("Ar8ZHQiehDhAigQhBifBCifQBFifCghAMAw4gTwQCghACdBDQCgBEBBCfQBACghFCdQhCCfifBBMgw5ATwQhNAghOAAQhSAAhSgjg");
	var mask_graphics_36 = new cjs.Graphics().p("AsPZPQiehDhAigQhBifBCigQBFieCfhAMAw5gTwQCfhACeBDQCgBEBACfQBBCghFCdQhCCfigBBMgw4ATwQhOAfhNAAQhSAAhSgig");
	var mask_graphics_37 = new cjs.Graphics().p("As4ZfQiehDhAifQhBigBCifQBFieCfhBMAw5gTvQCfhBCeBDQCgBEBACgQBBCfhFCdQhCCgigBAMgw4ATxQhOAfhNAAQhSAAhSgjg");
	var mask_graphics_38 = new cjs.Graphics().p("AuAZ8QiehDhAifQhBigBCifQBFieCghBMAw4gTvQCfhACeBCQCgBEBACgQBBCehFCfQhCCfifBAMgw5ATxQhNAfhOAAQhSAAhSgjg");
	var mask_graphics_39 = new cjs.Graphics().p("AvhakQiehDhAigQhBifBCigQBFieCfhAMAw5gTwQCfhACeBDQCgBEBACfQBBCfhFCeQhCCfigBBMgw4ATwQhOAghNAAQhSAAhSgjg");
	var mask_graphics_40 = new cjs.Graphics().p("Aw/bKQiehDhAigQhBifBDifQBEifCghAMAw4gTwQCghACdBDQCgBEBBCfQBACfhFCeQhCCfifBBMgw5ATwQhNAghOAAQhSAAhSgjg");
	var mask_graphics_41 = new cjs.Graphics().p("AyKboQidhDhBifQhAigBCifQBFieCfhBMAw4gTvQCghBCeBDQCgBEBACgQBACehECeQhCCgigBAMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_42 = new cjs.Graphics().p("AzDb/QidhDhBifQhAigBCifQBFieCfhBMAw5gTvQCfhBCeBDQCgBEBACgQBACehECeQhCCgigBAMgw4ATxQhOAfhOAAQhSAAhSgjg");
	var mask_graphics_43 = new cjs.Graphics().p("AzvcRQidhDhBifQhAigBCifQBFifCfhAMAw5gTvQCfhBCeBDQCgBEBACeQBBCghFCeQhCCgigBAMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_44 = new cjs.Graphics().p("A0RcfQidhDhBigQhAifBCifQBFifCfhAMAw4gTwQCghACeBDQCgBEBACeQBACghECeQhCCfigBBMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_45 = new cjs.Graphics().p("A0scqQidhDhBigQhAifBCigQBFieCfhAMAw5gTwQCfhACeBDQCgBEBACeQBBCghFCeQhCCfigBBMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_46 = new cjs.Graphics().p("A1BcyQidhDhBifQhAigBCifQBFieCfhBMAw4gTvQCghBCeBDQCgBEBACfQBACfhECfQhCCfigBAMgw4ATxQhOAfhOAAQhSAAhSgjg");
	var mask_graphics_47 = new cjs.Graphics().p("A1Rc5QiehDhAifQhBigBCifQBFifCfhAMAw5gTvQCfhBCeBDQCgBEBACeQBBCghFCeQhCCgifBAMgw5ATwQhOAghNAAQhSAAhSgjg");
	var mask_graphics_48 = new cjs.Graphics().p("A1ec+QiehDhAifQhBigBDifQBEieCghBMAw4gTvQCghBCdBDQCgBEBBCfQBACfhFCeQhCCgifBAMgw5ATxQhNAfhOAAQhSAAhSgjg");
	var mask_graphics_49 = new cjs.Graphics().p("A1odCQidhDhBifQhAigBCifQBFieCfhBMAw4gTvQCghBCeBDQCgBEBACfQBACfhECeQhCCgigBAMgw4ATxQhOAfhOAAQhSAAhSgjg");
	var mask_graphics_50 = new cjs.Graphics().p("A1vdFQidhDhBigQhAifBCifQBFifCfhAMAw5gTvQCfhBCeBDQCgBEBACeQBBCghFCeQhCCfigBBMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_51 = new cjs.Graphics().p("A1zdHQiehDhAigQhBifBCifQBFifCghAMAw4gTwQCfhACeBDQCgBEBACeQBBCghFCeQhCCfifBBMgw5ATwQhNAghOAAQhSAAhSgjg");
	var mask_graphics_52 = new cjs.Graphics().p("A12dIQidhDhBigQhAifBCifQBEifCghAMAw4gTwQCghACdBDQCgBEBBCeQBACghECeQhCCfigBBMgw4ATwQhOAghOAAQhSAAhSgjg");
	var mask_graphics_53 = new cjs.Graphics().p("A14dIQiehDhAigQhAifBCigQBEieCghAMAw4gTwQCghACdBDQCgBEBBCeQBACghECeQhDCfifBBMgw4ATwQhOAfhOAAQhSAAhSgig");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(34).to({graphics:mask_graphics_34,x:295.0012,y:163.947}).wait(1).to({graphics:mask_graphics_35,x:294.4764,y:164.1595}).wait(1).to({graphics:mask_graphics_36,x:292.5529,y:164.9399}).wait(1).to({graphics:mask_graphics_37,x:288.4566,y:166.6015}).wait(1).to({graphics:mask_graphics_38,x:281.2715,y:169.5162}).wait(1).to({graphics:mask_graphics_39,x:271.5557,y:173.4574}).wait(1).to({graphics:mask_graphics_40,x:262.1841,y:177.2589}).wait(1).to({graphics:mask_graphics_41,x:254.7256,y:180.2845}).wait(1).to({graphics:mask_graphics_42,x:249.0258,y:182.5966}).wait(1).to({graphics:mask_graphics_43,x:244.6388,y:184.3762}).wait(1).to({graphics:mask_graphics_44,x:241.2198,y:185.7631}).wait(1).to({graphics:mask_graphics_45,x:238.5338,y:186.8527}).wait(1).to({graphics:mask_graphics_46,x:236.4198,y:187.7102}).wait(1).to({graphics:mask_graphics_47,x:234.7648,y:188.3816}).wait(1).to({graphics:mask_graphics_48,x:233.4866,y:188.9001}).wait(1).to({graphics:mask_graphics_49,x:232.5239,y:189.2906}).wait(1).to({graphics:mask_graphics_50,x:231.8296,y:189.5723}).wait(1).to({graphics:mask_graphics_51,x:231.3668,y:189.76}).wait(1).to({graphics:mask_graphics_52,x:231.1063,y:189.8657}).wait(1).to({graphics:mask_graphics_53,x:230.9012,y:189.847}).wait(1));

	// Layer_3 copy 3
	this.instance = new lib.scribble5Sub();
	this.instance.setTransform(167.85,313.6,1.4007,1.4007,0,0,0,42.1,16.9);
	this.instance._off = true;
	...
	mask_1._off = true;
	var mask_1_graphics_25 = new cjs.Graphics().p("AXoV2MgyugOGQilguhViXQhUiVAuilQAuilCVhWQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguClQguCmiXBUQhhA3hoAAQg4AAg6gQg");
	var mask_1_graphics_26 = new cjs.Graphics().p("AXoV8MgyugOGQilguhViXQhUiVAuilQAuilCVhWQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguCmQguCliXBUQhhA3hoAAQg4AAg6gQg");
	var mask_1_graphics_27 = new cjs.Graphics().p("AXoWOMgyugOHQilguhViXQhUiVAuilQAuilCVhWQCWhTCmAuMAyuAOGQClAuBUCUQBWCXguCmQguCmiXBTQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_28 = new cjs.Graphics().p("AXoWpMgyugOHQilguhViXQhUiVAuilQAuilCVhVQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguClQguCmiXBTQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_29 = new cjs.Graphics().p("AXoXLMgyugOGQilguhViXQhUiVAuimQAuikCVhWQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguCmQguCliXBUQhhA4hoAAQg4AAg6gRg");
	var mask_1_graphics_30 = new cjs.Graphics().p("AXoXyMgyugOHQilguhViXQhUiVAuimQAuikCVhWQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguCmQguCliXBUQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_31 = new cjs.Graphics().p("AXoYYMgyugOHQilguhViXQhUiVAuimQAuikCVhWQCWhTCmAuMAyuAOFQClAuBUCVQBWCXguCmQguCliXBUQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_32 = new cjs.Graphics().p("AXoY6MgyugOHQilguhViXQhUiVAuilQAuimCVhVQCWhTCmAuMAyuAOGQClAuBUCUQBWCYguClQguCmiXBTQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_33 = new cjs.Graphics().p("AXoZVMgyugOHQilguhViXQhUiUAuimQAuilCVhVQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguClQguCmiXBTQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_34 = new cjs.Graphics().p("AXoZnMgyugOHQilguhViXQhUiVAuilQAuimCVhVQCWhTCmAuMAyuAOFQClAuBUCVQBWCXguCmQguCliXBUQhhA4hoAAQg4AAg6gQg");
	var mask_1_graphics_35 = new cjs.Graphics().p("AXoZtMgyugOGQilguhViXQhUiVAuimQAuilCVhVQCWhUCmAuMAyuAOGQClAuBUCVQBWCXguClQguCmiXBUQhhA3hoAAQg4AAg6gQg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(25).to({graphics:mask_1_graphics_25,x:-111.5153,y:141.4425}).wait(1).to({graphics:mask_1_graphics_26,x:-107.1537,y:142.0458}).wait(1).to({graphics:mask_1_graphics_27,x:-94.4957,y:143.7954}).wait(1).to({graphics:mask_1_graphics_28,x:-74.7803,y:146.5203}).wait(1).to({graphics:mask_1_graphics_29,x:-49.9375,y:149.9539}).wait(1).to({graphics:mask_1_graphics_30,x:-22.3991,y:153.7602}).wait(1).to({graphics:mask_1_graphics_31,x:5.1393,y:157.5664}).wait(1).to({graphics:mask_1_graphics_32,x:29.9821,y:161}).wait(1).to({graphics:mask_1_graphics_33,x:49.6974,y:163.725}).wait(1).to({graphics:mask_1_graphics_34,x:62.3555,y:165.4745}).wait(1).to({graphics:mask_1_graphics_35,x:66.4847,y:166.1425}).wait(19));

	// Layer_3 copy 2
	this.instance_1 = new lib.scribble4Sub();
	this.instance_1.setTransform(146.55,267.3,1.4007,1.4007,0,0,0,57.4,16.3);
	this.instance_1._off = true;
	...
	mask_2._off = true;
	var mask_2_graphics_19 = new cjs.Graphics().p("AszRrQiVhWgsimQgtimBViWQBYiVCmgsMAy5gNoQCmgtCUBWQCWBXAtCmQAsCmhXCTQhVCWimAtMgy5ANpQg4APg3AAQhqAAhjg5g");
	var mask_2_graphics_20 = new cjs.Graphics().p("AtiR3QiUhWgsimQgtimBViWQBYiUCmgtMAy5gNoQCmgsCUBVQCWBXAtCmQAsCmhXCUQhVCWimAsMgy5ANpQg4APg3AAQhqAAhkg5g");
	var mask_2_graphics_21 = new cjs.Graphics().p("AvjSaQiUhWgsimQgtimBViWQBYiVCmgsMAy5gNoQCmgtCUBWQCWBXAtCmQAsClhXCVQhVCVimAtMgy5ANpQg4APg3AAQhqAAhkg5g");
	var mask_2_graphics_22 = new cjs.Graphics().p("AydTMQiVhWgsimQgtimBViWQBYiVCmgsMAy5gNoQCmgsCUBVQCWBXAtCmQAsClhXCVQhVCWimAsMgy5ANpQg4APg3AAQhqAAhjg5g");
	var mask_2_graphics_23 = new cjs.Graphics().p("A1tUDQiUhVgsimQgtimBViWQBYiVCmgsMAy5gNoQCmgtCUBWQCWBWAtCnQAsClhXCUQhVCWimAtMgy5ANpQg4APg3AAQhqAAhkg6g");
	var mask_2_graphics_24 = new cjs.Graphics().p("A4nU1QiUhVgtimQgsimBViWQBXiVCmgsMAy5gNoQCmgtCUBWQCXBXAsCmQAtClhYCUQhVCWimAtMgy5ANpQg4APg3AAQhqAAhjg6g");
	var mask_2_graphics_25 = new cjs.Graphics().p("A6pVYQiUhVgsimQgtinBViVQBYiVCmgtMAy5gNoQCmgsCUBVQCWBXAtClQAsCmhXCVQhVCWimAtMgy5ANoQg4AQg3AAQhqAAhkg6g");
	var mask_2_graphics_26 = new cjs.Graphics().p("A7XVlQiUhWgsimQgtimBViWQBYiVCmgsMAy5gNoQCmgtCUBWQCWBXAtClQAsCmhXCUQhVCWimAtMgy5ANpQg4APg3AAQhqAAhkg5g");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(19).to({graphics:mask_2_graphics_19,x:306.2972,y:118.7925}).wait(1).to({graphics:mask_2_graphics_20,x:301.6862,y:120.0305}).wait(1).to({graphics:mask_2_graphics_21,x:288.7661,y:123.499}).wait(1).to({graphics:mask_2_graphics_22,x:270.096,y:128.5111}).wait(1).to({graphics:mask_2_graphics_23,x:249.3737,y:134.0741}).wait(1).to({graphics:mask_2_graphics_24,x:230.7036,y:139.0862}).wait(1).to({graphics:mask_2_graphics_25,x:217.7835,y:142.5547}).wait(1).to({graphics:mask_2_graphics_26,x:213.1722,y:143.7925}).wait(28));

	// Layer_3 copy
	this.instance_2 = new lib.scribble3Sub();
	this.instance_2.setTransform(150.9,221.45,1.4007,1.4007,0,0,0,60.5,16.6);
	this.instance_2._off = true;
	...
	mask_3._off = true;
	var mask_3_graphics_12 = new cjs.Graphics().p("AYXPfMgzegLQQioglheiSQhciPAkioQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");
	var mask_3_graphics_13 = new cjs.Graphics().p("AYXPlMgzegLQQiogkheiTQhciPAkioQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");
	var mask_3_graphics_14 = new cjs.Graphics().p("AYXP2MgzegLPQioglheiSQhciPAkioQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgLg");
	var mask_3_graphics_15 = new cjs.Graphics().p("AYXQRMgzegLPQioglheiSQhciPAkioQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgLg");
	var mask_3_graphics_16 = new cjs.Graphics().p("AYXQyMgzegLPQioglheiSQhciQAkinQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgLg");
	var mask_3_graphics_17 = new cjs.Graphics().p("AYXRWMgzegLQQioglheiSQhciQAkinQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");
	var mask_3_graphics_18 = new cjs.Graphics().p("AYXR3MgzegLQQiogkheiTQhciQAkinQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");
	var mask_3_graphics_19 = new cjs.Graphics().p("AYXSSMgzegLQQioglheiSQhciQAkinQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");
	var mask_3_graphics_20 = new cjs.Graphics().p("AYXSjMgzegLPQioglheiSQhciQAkinQAlioCQheQCShcCoAlMAzeALOQCoAlBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgLg");
	var mask_3_graphics_21 = new cjs.Graphics().p("AYXSqMgzegLQQiogkheiSQhciQAkinQAlioCQhfQCShcCoAlMAzeALPQCoAkBdCQQBeCSglCoQglCoiSBcQhoBEh0AAQgtAAgvgKg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(12).to({graphics:mask_3_graphics_12,x:-106.1115,y:100.0942}).wait(1).to({graphics:mask_3_graphics_13,x:-100.6579,y:100.7055}).wait(1).to({graphics:mask_3_graphics_14,x:-84.955,y:102.4657}).wait(1).to({graphics:mask_3_graphics_15,x:-60.8966,y:105.1625}).wait(1).to({graphics:mask_3_graphics_16,x:-31.3847,y:108.4706}).wait(1).to({graphics:mask_3_graphics_17,x:0.0212,y:111.9909}).wait(1).to({graphics:mask_3_graphics_18,x:29.5331,y:115.299}).wait(1).to({graphics:mask_3_graphics_19,x:53.5915,y:117.9958}).wait(1).to({graphics:mask_3_graphics_20,x:69.2944,y:119.7559}).wait(1).to({graphics:mask_3_graphics_21,x:74.3385,y:120.4192}).wait(33));

	// Layer_3
	this.instance_3 = new lib.scribble2sub();
	this.instance_3.setTransform(151.75,180,1.4007,1.4007,0,0,0,59.7,13.1);
	...
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AnDKiQiOhfghipQgiioBfiQQBgiOCpghMAzpgKTQCoghCOBfQCRBgAhCpQAiCohhCPQheCPipAhMgzpAKTQgrAIgqAAQh5AAhrhHg");
	var mask_4_graphics_1 = new cjs.Graphics().p("AnKKiQiOhfgiipQghioBeiQQBhiOCpghMAzpgKTQCoghCOBfQCRBgAhCpQAiCohhCPQhfCPioAhMgzpAKTQgsAIgpAAQh5AAhrhHg");
	var mask_4_graphics_2 = new cjs.Graphics().p("AniKiQiOhfgiipQghioBeiQQBhiOCpghMAzpgKTQCoghCOBfQCRBgAhCpQAiCohhCPQhfCPioAhMgzpAKTQgsAIgqAAQh4AAhrhHg");
	var mask_4_graphics_3 = new cjs.Graphics().p("AoQKiQiPhfghipQgiioBfiQQBhiOCoghMAzpgKTQCpghCOBfQCQBgAiCpQAhCohgCPQhfCPipAhMgzpAKTQgrAIgqAAQh4AAhrhHg");
	var mask_4_graphics_4 = new cjs.Graphics().p("ApdKwQiOhfgiipQghioBeiQQBhiOCpghMAzpgKTQCogiCOBfQCRBhAhCoQAiCphhCOQheCPipAiMgzpAKTQgsAIgqAAQh4AAhrhHg");
	var mask_4_graphics_5 = new cjs.Graphics().p("ArSLJQiOhfgiipQghioBeiQQBhiOCpghMAzpgKTQCpgiCOBfQCQBhAiCoQAhCphhCOQheCPipAiMgzpAKTQgsAIgpAAQh5AAhrhHg");
	var mask_4_graphics_6 = new cjs.Graphics().p("At4LsQiOhegiipQgiipBfiQQBhiOCoghMAzqgKTQCpghCOBfQCQBgAiCpQAhCohgCPQhfCPipAiMgzpAKSQgsAJgqAAQh4AAhrhIg");
	var mask_4_graphics_7 = new cjs.Graphics().p("AxIMZQiOhfgiioQgiipBfiQQBhiPCoghMAzqgKSQCpgiCOBfQCQBhAiCoQAiCphhCNQhfCRioAhMgzqAKTQgsAJgqAAQh4AAhrhIg");
	var mask_4_graphics_8 = new cjs.Graphics().p("A0dNHQiOhfgiipQghioBeiQQBhiPCpgiMAzqgKSQCpghCOBfQCQBgAiCpQAhCohgCOQhfCQipAiMgzqAKTQgrAIgqAAQh5AAhrhHg");
	var mask_4_graphics_9 = new cjs.Graphics().p("A3QNtQiOhfgiioQghipBeiQQBhiPCpghMAzqgKSQCpgiCOBfQCQBgAiCpQAiCphhCNQhfCQioAiMgzrAKTQgrAJgqAAQh5AAhrhIg");
	var mask_4_graphics_10 = new cjs.Graphics().p("A5YOKQiOhegiipQgiipBfiQQBhiOCogiMAzrgKSQCpgiCOBfQCQBhAiCoQAiCphhCNQhfCRioAhMgzrAKTQgsAJgqAAQh4AAhrhIg");
	var mask_4_graphics_11 = new cjs.Graphics().p("A68OgQiOhfgiipQghioBeiQQBhiPCpgiMAzrgKSQCogiCOBfQCRBhAiCoQAhCohhCPQheCQipAhMgzrAKUQgrAIgqAAQh5AAhrhHg");
	var mask_4_graphics_12 = new cjs.Graphics().p("A8DOvQiPhfghioQgiipBfiQQBhiPCoghMAzrgKTQCpghCOBfQCRBgAhCpQAiCnhhCPQhfCQioAiMgzrAKTQgsAJgqAAQh4AAhrhIg");
	var mask_4_graphics_13 = new cjs.Graphics().p("A81O6QiOhfgiipQgiioBfiQQBhiPCpgiMAzrgKSQCogiCOBfQCRBhAhCoQAiCohhCPQheCQipAhMgzrAKUQgsAIgpAAQh5AAhrhHg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:350.2,y:70.6771}).wait(1).to({graphics:mask_4_graphics_1,x:349.4891,y:70.9829}).wait(1).to({graphics:mask_4_graphics_2,x:347.0828,y:72.0168}).wait(1).to({graphics:mask_4_graphics_3,x:342.4439,y:74.0098}).wait(1).to({graphics:mask_4_graphics_4,x:334.8013,y:75.9218}).wait(1).to({graphics:mask_4_graphics_5,x:323.1326,y:78.4315}).wait(1).to({graphics:mask_4_graphics_6,x:306.5397,y:82.0003}).wait(1).to({graphics:mask_4_graphics_7,x:285.7644,y:86.4686}).wait(1).to({graphics:mask_4_graphics_8,x:264.5513,y:91.0311}).wait(1).to({graphics:mask_4_graphics_9,x:246.6729,y:94.8763}).wait(1).to({graphics:mask_4_graphics_10,x:233.0719,y:97.8016}).wait(1).to({graphics:mask_4_graphics_11,x:223.1218,y:99.9417}).wait(1).to({graphics:mask_4_graphics_12,x:215.9913,y:101.4753}).wait(1).to({graphics:mask_4_graphics_13,x:211.0162,y:102.5445}).wait(41));

	// Layer_2
	this.instance_4 = new lib.scribble1();
	this.instance_4.setTransform(156.65,143.2,1.4007,1.4007,0,0,0,63.2,13.2);
...
p.nominalBounds = new cjs.Rectangle(-39,14.8,443.7,460.59999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(93.8,1.3,0.68,0.68,0,0,0,13.6,10.6);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(203.5,-1,0.68,0.68,0,0,0,13.6,10.6);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(53,120,204,0)").ss(1,1,1).p("AAACdIAAk5");
	this.shape.setTransform(-160.65,7.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F2F2F2").s().p("EgZBAljMAAAhLFMAyDAAAMAAABLFg");
	this.shape_1.setTransform(160.15,-216.325);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cta1st, new cjs.Rectangle(-161.6,-456.6,481.9,480.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logoGrey.name = "logoGrey";
	this.logoGrey.setTransform(30,31.5,0.223,0.223);
	...
	this.countDown.setTransform(159.7,256.75,0.6688,0.6688,0,0,0,159.8,240.2);
	...
	this.txtPlayAgain.setTransform(23.5,457.75,1,1,0,0,0,0.7,0.1);

	this.txtCta = new lib.cta();
	this.txtCta.name = "txtCta";
	this.txtCta.setTransform(289,457.45,1,1,0,0,0,0.7,0.1);//218.45
	...
	this.cta.name = "cta";
	this.cta.setTransform(205.05,457);
	...
	this.bagRevolveMasked.setTransform(175.6,417.9,0.8343,0.8343,0,0,0,87.7,116.7);
	...
	this.score_MC.setTransform(112.1,108.6);
	...
	this.gameMain.setTransform(159.1,419.8,0.8343,0.8342,0,0,0,67.8,119.2);
	...
	this.playTxt.setTransform(159.95,139.15,1,1,0,0,0,0.7,0.1);
	...
	this.playBtn.setTransform(159.95,122.7);
	...
	this.txtLearn.setTransform(154.7,455.3,1,1,0,0,0,0.7,0.1);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(53,120,204,0)").ss(1,1,1).p("Am2hYINtAAQAyAAAAAyIAABNQAAAygyAAIttAAQgyAAAAgyIAAhNQAAgyAyAAg");
	this.shape.setTransform(160.575,456.125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.cta1},{t:this.txtLearn}]}).wait(1));
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-161.1,-100.2,1827.3,623.3000000000001), null);


// stage content:
(lib.M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-1.2,139.8,708.9000000000001,383.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1622732907743", id:"M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"},
		{src:"images/M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2.png?1622732907744", id:"M365_MobileFY22Q1BTS_USA_320x480_BAN_INTGame_EN_NA_Standard_ANI_LEA_NA_1_atlas_2"}
	],
	preloads: []
};
