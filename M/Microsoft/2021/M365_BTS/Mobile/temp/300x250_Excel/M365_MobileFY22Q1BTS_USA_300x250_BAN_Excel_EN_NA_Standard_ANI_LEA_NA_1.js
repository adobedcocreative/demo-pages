...
lib.ssMetadata = [
		{name:"M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[0,0,500,333],[0,335,400,266],[502,0,86,80],[0,603,200,284],[402,335,198,300],[202,603,150,150]]}
];
...
(lib.Excelscreen = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.excelBudgeting_desktopUI_barGraph = function() {
	this.initialize(ss["M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.mobile_new = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.finalFrame_ui();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mobile_new, new cjs.Rectangle(0,0,198,300), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CCCCCC").s().p("AgEQjMAAAghFIAJAAMAAAAhFg");
	this.shape.setTransform(0.5,105.925);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.lines, new cjs.Rectangle(0,0,1,211.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(12.9,15,0.6427,0.6427);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ak/GeQheAAAAheIAAp/QAAheBeAAIJ/AAQBeAAAABeIAAJ/QAABeheAAg");
...
}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(0,0,82.8,82.8), null);
...
}).prototype = getMCSymbolPrototype(lib.end_UI, new cjs.Rectangle(0,0,375,249.6), null);
...
(lib.desktopUiBarGraphBg = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.excelBudgeting_desktopUI_barGraph();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.desktopUiBarGraphBg, new cjs.Rectangle(0,0,200,284), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#499F66").s().p("AiuGeQhQgjg/g+Qg9g+gjhQQgjhUAAhbQAAhaAjhUQAjhQA9g+QA/g+BQgjQBTgjBbAAQBcAABTAjQBQAjA/A+QA9A+AiBQQAkBUAABaQAABbgkBUQgiBQg9A+Qg/A+hQAjQhTAjhcAAQhbAAhTgjgAh6kiQg5AYgrArQhdBdgBCCQABCDBdBdQBbBcCDAAQCDAABchcQBehdAAiDQAAiChehdQhchciDAAQg/AAg7AZg");
...
}).prototype = getMCSymbolPrototype(lib.cp_light_cache, new cjs.Rectangle(0,0,89.8,89.8), null);
...
}).prototype = getMCSymbolPrototype(lib.chartpie_c, new cjs.Rectangle(0,0,89.8,89.8), null);
...
(lib.grey_line = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(0,105.9,1,1,0,0,0,0.5,105.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.grey_line, new cjs.Rectangle(-0.5,0,1,211.9), null);


(lib.graph_paper = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.line = new lib.grey_line();
	this.line.name = "line";
	this.line.setTransform(106.05,142.7,1,1.065,89.9992,0,0,0.1,105.8);

	this.instance = new lib.grey_line();
	this.instance.setTransform(106,8.55,1,1.065,89.9992,0,0,0,105.9);

	this.instance_1 = new lib.grey_line();
	this.instance_1.setTransform(106.05,23.55,1,1.065,89.9992,0,0,0.1,105.9);

	this.instance_2 = new lib.grey_line();
	this.instance_2.setTransform(106,38.45,1,1.065,89.9992,0,0,0.1,105.9);

	this.instance_3 = new lib.grey_line();
	this.instance_3.setTransform(106,53.35,1,1.065,89.9992,0,0,0.1,105.9);

	this.instance_4 = new lib.grey_line();
	this.instance_4.setTransform(106,68.25,1,1.065,89.9992,0,0,0.1,105.9);

	this.instance_5 = new lib.grey_line();
	this.instance_5.setTransform(106.05,83.15,1,1.065,89.9992,0,0,0.1,105.9);

	this.instance_6 = new lib.grey_line();
	this.instance_6.setTransform(106.05,98,1,1.065,89.9992,0,0,0.1,105.8);

	this.instance_7 = new lib.grey_line();
	this.instance_7.setTransform(106.05,112.9,1,1.065,89.9992,0,0,0.1,105.8);

	this.instance_8 = new lib.grey_line();
	this.instance_8.setTransform(106.1,127.8,1,1.065,89.9992,0,0,0.1,105.8);

	this.instance_9 = new lib.grey_line();
	this.instance_9.setTransform(135.35,105.9,1,1,0,0,0,0,105.9);

	this.instance_10 = new lib.grey_line();
	this.instance_10.setTransform(150.25,105.9,1,1,0,0,0,0,105.9);

	this.instance_11 = new lib.grey_line();
	this.instance_11.setTransform(165.15,105.9,1,1,0,0,0,0,105.9);

	this.instance_12 = new lib.grey_line();
	this.instance_12.setTransform(180.05,105.9,1,1,0,0,0,0,105.9);

	this.instance_13 = new lib.grey_line();
	this.instance_13.setTransform(194.95,105.9,1,1,0,0,0,0,105.9);

	this.instance_14 = new lib.grey_line();
	this.instance_14.setTransform(209.85,105.9,1,1,0,0,0,0,105.9);

	this.instance_15 = new lib.grey_line();
	this.instance_15.setTransform(1.25,105.9,1,1,0,0,0,0,105.9);

	this.instance_16 = new lib.grey_line();
	this.instance_16.setTransform(16.15,105.9,1,1,0,0,0,0,105.9);

	this.instance_17 = new lib.grey_line();
	this.instance_17.setTransform(31.05,105.9,1,1,0,0,0,0,105.9);

	this.instance_18 = new lib.grey_line();
	this.instance_18.setTransform(45.95,105.9,1,1,0,0,0,0,105.9);

	this.instance_19 = new lib.grey_line();
	this.instance_19.setTransform(60.85,105.9,1,1,0,0,0,0,105.9);

	this.instance_20 = new lib.grey_line();
	this.instance_20.setTransform(75.75,105.9,1,1,0,0,0,0,105.9);

	this.instance_21 = new lib.grey_line();
	this.instance_21.setTransform(90.65,105.9,1,1,0,0,0,0,105.9);

	this.instance_22 = new lib.grey_line();
	this.instance_22.setTransform(105.55,105.9,1,1,0,0,0,0,105.9);

	this.instance_23 = new lib.grey_line();
	this.instance_23.setTransform(120.45,105.9,1,1,0,0,0,0,105.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.line}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.graph_paper, new cjs.Rectangle(-6.9,0,225.8,211.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({alpha:0},33).to({_off:true},1).wait(1));
...
}).prototype = getMCSymbolPrototype(lib.chartpie_light, new cjs.Rectangle(0,0,89.8,89.8), null);
...
}).prototype = getMCSymbolPrototype(lib.chartpie, new cjs.Rectangle(0,0,89.8,89.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// grid
	this.grid = new lib.graph_paper();
	this.grid.name = "grid";
	this.grid.setTransform(-1.45,178.8,1,1,0,0,0,106,105.9);

	this.timeline.addTween(cjs.Tween.get(this.grid).wait(73));
	...
	var mask_1_graphics_46 = new cjs.Graphics().p("AQiJ4MgjegJ3Qh0ggg8hpQg6hoAgh0QAgh0Bog8QBqg6BzAgMAjeAJ2QB0AgA7BoQA8BqghB0QggB0hpA6QhEAnhJAAQgnAAgogLg");
	...
	var mask_1_graphics_49 = new cjs.Graphics().p("AQiK+MgjegJ4Qh0ggg8hoQg6hoAgh0QAgh0Bog8QBqg7BzAhMAjeAJ2QB0AgA7BoQA8BqghB0QggB0hpA6QhEAnhJAAQgnAAgogLg");
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(44).to({graphics:mask_1_graphics_44,x:-91.8408,y:62.6754}).wait(1).to({graphics:mask_1_graphics_45,x:-88.7897,y:63.0983}).wait(1).to({graphics:mask_1_graphics_46,x:-79.9352,y:64.3246}).wait(1).to({graphics:mask_1_graphics_47,x:-66.1439,y:66.2347}).wait(1).to({graphics:mask_1_graphics_48,x:-48.7659,y:68.6415}).wait(1).to({graphics:mask_1_graphics_49,x:-29.5022,y:71.3095}).wait(1).to({graphics:mask_1_graphics_50,x:-10.2385,y:73.9775}).wait(1).to({graphics:mask_1_graphics_51,x:7.1395,y:76.3844}).wait(1).to({graphics:mask_1_graphics_52,x:20.9308,y:78.2945}).wait(1).to({graphics:mask_1_graphics_53,x:29.7854,y:79.5208}).wait(1).to({graphics:mask_1_graphics_54,x:32.7092,y:79.9254}).wait(19));
	...
	mask_2._off = true;
	var mask_2_graphics_38 = new cjs.Graphics().p("AqCItQhog8gfh0Qgfh1A8hoQA9hoB0gfMAjmgJiQB0gfBnA8QBqA8AfB1QAfB0g9BoQg8Boh0AgMgjmAJhQgnALgmAAQhKAAhGgog");
	...
	var mask_2_graphics_40 = new cjs.Graphics().p("Ar9ItQhng8gfh0Qgfh1A7hoQA9hoB0gfMAjmgJiQB0gfBoA8QBpA8AfB1QAfB0g9BoQg7Boh1AgMgjlAJhQgoALgmAAQhKAAhGgog");
	...
	var mask_2_graphics_45 = new cjs.Graphics().p("A0EJbQhog8gfh0Qgfh0A7hpQA9hoB1gfMAjlgJiQB0gfBoA8QBpA9AfB0QAfB0g9BoQg7Bph0AeMgjmAJiQgnALgmAAQhLAAhFgog");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(38).to({graphics:mask_2_graphics_38,x:207.3173,y:33.9277}).wait(1).to({graphics:mask_2_graphics_39,x:204.0927,y:35.6608}).wait(1).to({graphics:mask_2_graphics_40,x:195.0573,y:40.5167}).wait(1).to({graphics:mask_2_graphics_41,x:182.0007,y:47.5336}).wait(1).to({graphics:mask_2_graphics_42,x:167.509,y:55.3218}).wait(1).to({graphics:mask_2_graphics_43,x:154.4525,y:61.0062}).wait(1).to({graphics:mask_2_graphics_44,x:145.4171,y:63.4342}).wait(1).to({graphics:mask_2_graphics_45,x:141.3061,y:64.3007}).wait(28));
	...
	var mask_3_graphics_32 = new cjs.Graphics().p("ARCIYMgj/gH3Qh2gahChlQhAhlAah2QAZh1BlhCQBmhAB2AZMAj/AH4QB2AZBBBkQBBBmgZB2QgaB1hmBBQhJAvhRAAQggAAghgHg");
	...
	var mask_4_graphics_23 = new cjs.Graphics().p("Ar8HeQhlhDgYh4QgYh3BDhmQBFhkB3gYMAkogHUQB3gXBlBDQBmBEAYB4QAYB3hFBlQhDBlh3AYMgknAHUQgfAGgeAAQhVAAhMgzg");
	...
	var mask_4_graphics_26 = new cjs.Graphics().p("AvoHcQhkhDgYh3QgYh3BDhmQBEhjB3gYMAkbgHRQB3gYBlBDQBlBEAYB3QAYB3hFBlQhCBkh3AYMgkbAHRQgfAGgeAAQhUAAhMgyg");
	...
	var mask_4_graphics_29 = new cjs.Graphics().p("AzlHZQhkhDgYh2QgXh2BChlQBEhjB2gYMAkOgHOQB3gYBjBDQBmBEAXB2QAYB2hEBkQhCBkh3AYMgkOAHOQgeAGgeAAQhUAAhLgyg");
	...
	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(19).to({graphics:mask_4_graphics_19,x:211.6847,y:-9.4163}).wait(1).to({graphics:mask_4_graphics_20,x:211.3224,y:-9.2726}).wait(1).to({graphics:mask_4_graphics_21,x:210.0949,y:-8.7868}).wait(1).to({graphics:mask_4_graphics_22,x:207.7286,y:-7.8502}).wait(1).to({graphics:mask_4_graphics_23,x:203.8302,y:-6.3072}).wait(1).to({graphics:mask_4_graphics_24,x:197.8779,y:-3.9514}).wait(1).to({graphics:mask_4_graphics_25,x:189.4138,y:-0.6014}).wait(1).to({graphics:mask_4_graphics_26,x:178.8163,y:3.593}).wait(1).to({graphics:mask_4_graphics_27,x:167.9955,y:7.8758}).wait(1).to({graphics:mask_4_graphics_28,x:158.8757,y:11.4853}).wait(1).to({graphics:mask_4_graphics_29,x:151.9378,y:14.2313}).wait(1).to({graphics:mask_4_graphics_30,x:146.8622,y:16.2402}).wait(1).to({graphics:mask_4_graphics_31,x:141.5589,y:17.6798}).wait(1).to({graphics:mask_4_graphics_32,x:136.5612,y:18.6839}).wait(41));
...
p.nominalBounds = new cjs.Rectangle(-114.4,-14.8,301.5,299.6);
...
if (reversed == null) { reversed = false; }
	...
	this.popRight.setTransform(17.15,0.2,1.1304,1.1304,0,0,0,4.8,11.6);
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-122.1,-21.6,145.79999999999998,43.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// %
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#367148").s().p("");
	this.shape.setTransform(57.475,43.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(30));

	// number
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#367148").s().p("");
	this.shape_1.setTransform(40.65,43.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#367148").s().p("AAYBcIAAgpIhWAAIBjiOIAEAAIAAB9IAWAAIAAARIgWAAIAAApgAgdAiIA1AAIAAhMg");
	this.shape_2.setTransform(26.7,43.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#367148").s().p("AghBVIAvhKQgKAEgHAAQgWAAgPgPQgPgQAAgWQABgQAGgMQAIgNANgHQANgIAPAAQAPAAANAHQAMAIAHANQAIANAAAOQAAAMgFAMQgFAMgLAQIg2BSgAgahBQgLALAAAQQAAAPALAMQALALAPAAQAQAAALgLQALgMAAgPQAAgQgLgLQgMgLgPAAQgPAAgLALg");
	this.shape_3.setTransform(40.5,43.575);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#367148").s().p("AgfBVQgOgKgIgUQgHgTgBgkQAAgjAIgTQAIgUAOgKQAOgKARAAQAQAAAPAKQAOAKAIAVQAJAUgBAhQABAigJAUQgHAUgPALQgPAKgQAAQgRAAgOgKgAgWhFQgKAIgGAQQgFAQgBAdQABAfAFAQQAGAPAKAIQALAIALAAQALAAALgIQAKgHAGgQQAGgTAAgcQABgagHgRQgFgSgLgIQgLgIgLAAQgMAAgKAIg");
	this.shape_4.setTransform(40.65,43.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#367148").s().p("AgoBPQgPgNgDgWIASAAQADALAFAGQAFAHAIAEQAJAEAIAAQARAAANgOQAMgNAAgVQAAgSgLgKQgMgLgSAAQgPAAgYAJIARhZIBOAAIAAARIg/AAIgJAxQALgDAJAAQAYAAAQAQQAQAPAAAaQAAASgIAPQgIAPgOAIQgOAHgSAAQgVAAgQgNg");
	this.shape_5.setTransform(26.65,43.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#367148").s().p("Ag8BcIBEhKQAVgWAGgLQAGgKAAgMQAAgPgLgMQgLgLgRABQgQAAgMALQgLALgCAWIgRAAQABgbARgRQARgRAYAAQAZgBAQARQAPAPAAAXQAAAPgHANQgIAMgVAXIgsAxIBSAAIAAARg");
	this.shape_6.setTransform(40.575,43.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#367148").s().p("AgoBPQgPgNgDgWIASAAQADALAFAGQAFAHAIAEQAJAEAIAAQARAAANgOQAMgNAAgVQAAgSgLgKQgMgLgSAAQgPAAgYAJIARhZIBOAAIAAARIg/AAIgJAxQALgDAJAAQAYAAAQAQQAQAPAAAaQAAASgIAPQgIAPgOAIQgOAHgSAAQgVAAgQgNg");
	this.shape_7.setTransform(26.65,43.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#367148").s().p("AgcBYQgMgIgIgNQgGgNgBgOQAAgLAFgNQAFgMALgQIA2hSIAOAKIgvBKQAKgEAHAAQAWAAAPAPQAPAQAAAWQgBAQgGAMQgIANgNAHQgNAIgPAAQgPAAgNgHgAgaAMQgLALAAAQQAAAQALALQALALAPAAQAPAAAMgLQALgLAAgQQAAgQgLgLQgMgLgPAAQgPAAgLALg");
	this.shape_8.setTransform(27,43.575);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#367148").s().p("Ag1BVIBSifIhVAAIAAgRIBxAAIhfC3g");
	this.shape_9.setTransform(27.275,43.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#367148").s().p("AAFBaIAAiiIgbAAIALgRIAiAAIAACzg");
	this.shape_10.setTransform(39.575,43.575);
	...
	this.shape_11.setTransform(40.625,43.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2,p:{x:26.7}},{t:this.shape_1}]}).to({state:[{t:this.shape_2,p:{x:26.7}},{t:this.shape_3}]},3).to({state:[{t:this.shape_5,p:{x:26.65}},{t:this.shape_4}]},3).to({state:[{t:this.shape_5,p:{x:26.65}},{t:this.shape_6}]},3).to({state:[{t:this.shape_7},{t:this.shape_5,p:{x:40.6}}]},3).to({state:[{t:this.shape_8},{t:this.shape_4}]},3).to({state:[{t:this.shape_8},{t:this.shape_5,p:{x:40.6}}]},2).to({state:[{t:this.shape_9},{t:this.shape_4}]},2).to({state:[{t:this.shape_9},{t:this.shape_10}]},3).to({state:[{t:this.shape_9},{t:this.shape_11}]},2).to({state:[{t:this.shape_9},{t:this.shape_2,p:{x:40.65}}]},2).wait(4));
...
p.nominalBounds = new cjs.Rectangle(0,0,89.8,89.8);
...
if (reversed == null) { reversed = false; }
	...
	// barsBg
	this.instance = new lib.desktopUiBarGraphBg();
	this.instance.setTransform(307.5,128.15,0.4437,0.4437,0,0,0,100.3,142.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bars, new cjs.Rectangle(0,0,375,249.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.circle_anim.setTransform(60.9,56.7,1,1,0,0,0,44.9,44.9);

	this.timeline.addTween(cjs.Tween.get(this.circle_anim).wait(1));

	// circle light
	this.instance = new lib.chartpie_light();
	this.instance.setTransform(60.9,56.7,1,1,0,0,0,44.9,44.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// white frame
	this.instance_1 = new lib.white_sq();
	this.instance_1.setTransform(61.4,56.5,1,1,0,0,0,51.1,51.5);
...
}).prototype = getMCSymbolPrototype(lib.countdown, new cjs.Rectangle(0.5,4.1,130.6,123.80000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.icon.name = "icon";
	this.icon.setTransform(88,44.55,1,1,0,0,0,41.4,41.4);
	...
	this.countdown.setTransform(129.8,136.2,1,1,0,0,0,33.8,26.2);
	...
	this.bars.name = "bars";
	this.bars.setTransform(426.9,147.2,1,1,0,0,0,345.9,114.2);
	...
	this.shadow3.setTransform(393.8,169.9,0.9768,1.3835,0,0,0,65.3,62.1);
	...
	this.end_UI.setTransform(268.5,157.8,1,1,0,0,0,187.5,124.8);

	this.timeline.addTween(cjs.Tween.get(this.end_UI).wait(1));

	// screen
	this.instance = new lib.Excelscreen();
	this.instance.setTransform(81,33,0.75,0.75);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(51.8,211.7,1,1,0,0,0,36.3,-0.3);
	...
	this.cta.name = "cta";
	this.cta.setTransform(53,212.25,1,1,0,0,0,-49.1,0);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// mobile_new
	this.mobile = new lib.mobile_new();
	this.mobile.name = "mobile";
	this.mobile.setTransform(187.5,174.5,0.5,0.5,0,0,0,99,149);
	...
	this.screen.setTransform(155.9,127.6,1,1,0,0,0,236.9,160.6);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-179.8,-32.6,746.2,401.70000000000005), null);


// stage content:
(lib.M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {	
				...
				/*this.tl1.to(mc.anim,{duration:1.5, x: "-=310", ease:Power3.easeInOut}, "+=.5");
			...
			this.tl1.from(exportRoot,{duration:0.1, onComplete:function(){ mc.anim.spreadsheet.play();}}, "<+.7");	
		...
		*/
			...
			//	this.tl1.to(mc.anim,{duration:1.5, scaleX:4, scaleY:4, alpha: 0, ease:Power3.easeInOut}, "+=0.2");	
				//this.tl1.from(mc.screen,{duration:1.5, ease:Power3.easeInOut}, "+=0.2");	
				
				//countdown pop up
				this.tl1.to(mc.screen.countdown,{duration:1, scaleX:1.3, scaleY:1.3, ease:Power3.easeInOut},"+=0.2");
				...
				//bar chart pop up
				this.tl1.to(mc.screen,{duration:1.5, scaleX:0.57, scaleY:0.57, x: "-=20", y: "+=22", ease:Power3.easeInOut}, ">0.9");
				this.tl1.from(mc.scribble.grid,{duration:1, alpha: 0, ease:Power3.easeInOut}, "<");			
				...
				this.tl1.to(mc.screen.countdown,{duration:1.5, scaleX:1, scaleY:1, ease:Power3.easeInOut}, "<");
				this.tl1.to(mc.screen.countdown.shadow,{duration:1, alpha: 0, ease:Power3.easeInOut}, "<");	
				
				this.tl1.to(mc.screen.bars,{duration:1, scaleX:1.95, scaleY:1.95, ease:Power3.easeInOut}, "<.7");
				...
				//this.tl1.from(mc.bang, {duration:.6,scaleX: .5, scaleY: .5, alpha:0, ease:Back.easeOut}, ">-.2");	
				this.tl1.from(mc.bang, {duration:.6 ,scaleX: .5, scaleY: .5, alpha:0, ease:Back.easeOut, onStart:function(){mc.bang.play();}}, "<");		
				
				//final frame
				this.tl1.to(mc.screen,{duration:1.2, x:"-=290", ease:Power3.easeInOut}, ">0.7");
				this.tl1.to(mc.bang, {duration:1.2, x:"-=290", ease:Power3.easeInOut, onStart:function(){mc.bang.play();}}, "<");		
				this.tl1.to(mc.screen.bars,{duration:1.2, scaleX:1, scaleY:1, ease:Power3.easeInOut}, "<");
				this.tl1.to(mc.screen.shadow3,{duration:1, alpha: 0, ease:Power3.easeInOut}, "<");		
				this.tl1.from(mc.screen.end_UI,{duration:.2, alpha:0, ease:Power3.easeOut}, ">-1.8");
				...
				this.tl1.from(mc.mobile,{duration:1.2, y:"+=300", ease:Power3.easeInOut}, ">-1");		
...
p.nominalBounds = new cjs.Rectangle(94.2,92.4,332.8,243.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1622820549033", id:"M365_MobileFY22Q1BTS_USA_300x250_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
