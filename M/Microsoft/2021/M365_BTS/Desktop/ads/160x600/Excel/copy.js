// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Cash in on smart |budgeting this |semester ','18.5px',80,188,'20','100', 'center']

	bannerData.headline1 = ['<#737373>Be a |budget |wiz','32px',80,70,'34','350','center']

	bannerData.CTA = ['<#FFFFFF>Learn more','12.2px',4,-2,'50','300', 'left']
