...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("AAKBPIABgbQATABAOgLQAPgLAFgTQAFgRgIgRQgJgQgQgJQgQgIgTAFQgRAEgLAOQgMAPAAARIAaAAIgnAnIgngnIAaAAQAAgaARgWQARgWAbgGQAagGAaAMQAZAMAMAZQALAagHAaQgHAbgWARQgWAQgaAAIgCAAg");
	this.shape.setTransform(-0.0176,0.0534);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-34.65,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	// button white
	this.mute_btn_wht = new lib.mute_btn();
	this.mute_btn_wht.name = "mute_btn_wht";
	this.mute_btn_wht.setTransform(141.15,540.35,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.mute_btn_blk.setTransform(141.15,540.35,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(143.95,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(71.35,570.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(183.7,567.95,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(58,4.9,110.9,578.1), null);


// stage content:
(lib.M365_FY21Q4SMBCustStories_USA_160x600_BAN_TonysChoco_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,88.30000000000001,282.79999999999995);
// library properties:
lib.properties = {
