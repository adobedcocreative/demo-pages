...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-33.65,1.6,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.mute_btn_wht.setTransform(23.15,71.5,0.7758,0.7758,0,0,180,-18.6,16.6);
	this.mute_btn_wht.alpha = 0;

	this.mute_btn_blk = new lib.mute_btn();
	this.mute_btn_blk.name = "mute_btn_blk";
	this.mute_btn_blk.setTransform(23.15,71.5,0.7758,0.7758,0,0,180,-18.6,16.6);
	...
	this.replay_btn.setTransform(711.4,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(640.1,61.1,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(749.5,58.7,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(8.3,4.9,726.4000000000001,79.3), null);


// stage content:
(lib.M365_FY21Q4SMBCustStories_USA_728x90_BAN_HouseLilac_EN_NA_Standard_ANI_WACM_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,368.29999999999995,39.099999999999994);
// library properties:
lib.properties = {
