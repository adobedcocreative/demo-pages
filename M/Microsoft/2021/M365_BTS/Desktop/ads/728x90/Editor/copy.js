// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Write with confidence where you write most','18.1px',335,34,'24','350', 'left']
	
	bannerData.headline1 = ['<#737373>More polish|in less time','28.2px',455,13,'30','50', 'center']
