// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Practice speeches with|real-time feedback','17.8px',150,88,'20','350', 'center']
	bannerData.headline1 = ['<#737373>Perfect your|public speaking','32px',150,36,'30','50', 'center']

	//bannerData.headline1 = ['<#737373>Finish group|projects in a flash','30px',150,33,'32','50', 'center']
