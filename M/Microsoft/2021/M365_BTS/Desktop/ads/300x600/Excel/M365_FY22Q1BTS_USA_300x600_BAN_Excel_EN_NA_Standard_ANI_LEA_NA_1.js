...
lib.ssMetadata = [
		{name:"M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1", frames: [[152,604,60,123],[0,0,500,333],[0,335,400,267],[214,604,86,80],[402,335,178,277],[0,604,150,150]]}
];
...
(lib.ExcelMobileUniversityBudgetAndroid1 = function() {
	this.initialize(ss["M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Excelscreen11111 = function() {
	this.initialize(ss["M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.end_UI, new cjs.Rectangle(0,0,375,250.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Excelscreen11111();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.barBG, new cjs.Rectangle(0,0,500,333), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.instance = new lib.ExcelMobileUniversityBudgetAndroid1();
	this.instance.setTransform(35,67,0.6333,0.6343);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Shadow
	this.instance_1 = new lib.MobileShadow();
	this.instance_1.setTransform(9.15,62.85,0.379,0.379);
...
}).prototype = getMCSymbolPrototype(lib.mobile, new cjs.Rectangle(9.2,62.9,67.39999999999999,104.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(37.35,58.5,2.4059,2.4059,0,0,0,0.1,0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.7},12,cjs.Ease.quadInOut).wait(39).to({_off:true,regY:0.5,scaleX:2.4059,scaleY:2.4059,x:37.35,y:58.5},33,cjs.Ease.cubicInOut).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	this.graph3.setTransform(151.45,245.6,1.0175,1.0175,0,0,0,6.8,36.2);
	...
	this.graph2.setTransform(134.2,245.6,1.0175,1.0175,0,0,0,9.3,49.6);
	...
	this.graph1.setTransform(117.05,245.7,1.0175,1.0175,0,0,0,6.7,28.7);
	...
	this.spreadsheet.setTransform(105.95,187.5,1.0175,1.0175,0,0,0,45,47.2);
	...
	this.square3.setTransform(78.85,200.75,1.0175,1.0175,0,0,0,9.7,25.8);

	this.square2 = new lib.square2();
	this.square2.name = "square2";
	this.square2.setTransform(118.8,157.2,1.0175,1.0175,0,0,0,23.4,9.6);

	this.square1 = new lib.square1();
	this.square1.name = "square1";
	this.square1.setTransform(78.85,157.2,1.0175,1.0175,0,0,0,9.7,9.6);
	...
	this.lineR3.name = "lineR3";
	this.lineR3.setTransform(159.4,262.15,1.4335,1.4335,-100.442,0,0,14.6,0.1);

	this.lineR2 = new lib.line_1();
	this.lineR2.name = "lineR2";
	this.lineR2.setTransform(175.6,252,1.4335,1.4335,-131.443,0,0,14.5,0.1);

	this.lineR1 = new lib.line_1();
	this.lineR1.name = "lineR1";
	this.lineR1.setTransform(183,236.75,1.4337,1.4337,-171.4502,0,0,14.7,0);

	this.lineL3 = new lib.line_1();
	this.lineL3.name = "lineL3";
	this.lineL3.setTransform(66,125.55,1.4336,1.4336,85.4365,0,0,14.8,0);

	this.lineL2 = new lib.line_1();
	this.lineL2.name = "lineL2";
	this.lineL2.setTransform(48.55,132.3,1.4336,1.4336,54.436,0,0,14.9,-0.1);

	this.lineL1 = new lib.line_1();
	this.lineL1.name = "lineL1";
	this.lineL1.setTransform(39.4,146.6,1.4337,1.4337,14.4329,0,0,15,0.1);
	...
	this.line1.setTransform(-120.6,292.25,1.5835,1.5835,0,0,0,129.3,21.4);

	this.timeline.addTween(cjs.Tween.get(this.line1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.squiggle_anim, new cjs.Rectangle(-369,104,573.2,225), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(45.05,45.05,1.0033,1.0028,0,0,0,44.9,44.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,90.1,90);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(140.7,93.7,0.75,0.75,0,0,0,187.6,124.9);
...
if (reversed == null) { reversed = false; }
	...
	this.circle_anim.setTransform(61.15,57.05,1.0029,1.0028,0,0,0,45,44.9);

	this.timeline.addTween(cjs.Tween.get(this.circle_anim).wait(1));

	// circle light
	this.instance = new lib.chartpie_light();
	this.instance.setTransform(61.15,57.05,1.0033,1.0028,0,0,0,45,44.9);
	...
	this.shadow = new lib.shadow();
	this.shadow.name = "shadow";
	this.shadow.setTransform(66.05,66.1,1.0023,1.002,0,0,0,64.9,62);
	this.shadow.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.countdown, new cjs.Rectangle(0.4,4,130.7,124), null);
...
if (reversed == null) { reversed = false; }
	...
	this.end_UI.setTransform(268.75,157.6,1,1,0,0,0,187.5,124.8);
	...
	this.countdown.setTransform(129.85,136.25,1.0019,1.002,0,0,0,33.8,26.2);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(142.55,552.6,1,1,0,0,0,36.3,-0.3);
	...
	this.screen.setTransform(125.25,289.65,0.798,0.798,0,0,0,236.8,160.7);
	...
	this.logo.name = "logo";
	this.logo.setTransform(169.05,135.65,0.57,0.57,0,0,0,240.5,181.6);
	...
	this.phone.setTransform(26.75,375.75,0.9933,1.0005,0,0,0,50.1,102.7);
	...
	this.bang.name = "bang";
	this.bang.setTransform(244.5,229.4,1,1,0,0,0,3.5,39.7);
	...
	this.anim.name = "anim";
	this.anim.setTransform(463.15,252.55,1,1,0,0,0,115,197);
	...
	this.scribble.name = "scribble";
	this.scribble.setTransform(153.4,358.25,1.5593,1.5593,0,0,0,93.1,104);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-41,-0.5,593.4,641.5), null);


// stage content:
(lib.M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		mc.screen.end_UI.visible = false;
		...
		this.runBanner = function() {	
				...
				this.tl1.from(mc.screen,{duration:1.5, scaleX:0.5, scaleY:0.5, alpha: 0, ease:Power3.easeInOut, onComplete:function(){mc.screen.countdown.circBG.visible = true;}}, "<");
				...
				//bar chart pop up
				this.tl1.to(mc.screen,{duration:1.5, scaleX:0.60, scaleY:0.60, x: "+=2", y: "+=8", ease:Power3.easeInOut}, ">0.9");
				...
				this.tl1.to(mc.screen.bars,{duration:1, scaleX:1.95, scaleY:1.95, ease:Power3.easeInOut, onStart:function(){; mc.screen.bars.visible = true;}}, "<.7");
				...
				//final frame
				this.tl1.to(mc.screen,{duration:1.2, scaleX:.6, scaleY:.6, x: "+=30", y: "+=68", ease:Power3.easeInOut}, ">0.7");
				this.tl1.to(mc.bang, {duration:1.2,alpha: 0, x:"+=30", y:"+=68", scaleX: .6, scaleY: .6, ease:Power3.easeInOut, onStart:function(){mc.bang.play();}}, "<");		
				...
				this.tl1.from(mc.screen.end_UI,{duration:.2, alpha:0, ease:Power3.easeOut, onStart:function(){mc.screen.end_UI.visible = true;}}, ">-0.1");
...
p.nominalBounds = new cjs.Rectangle(109,299.5,443.4,341.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1622834300850", id:"M365_FY22Q1BTS_USA_300x600_BAN_Excel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
