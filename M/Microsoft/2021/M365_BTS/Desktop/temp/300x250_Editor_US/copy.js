// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Write with confidence where you write most','12px',150,49,'20','350', 'center']
	
	bannerData.headline1 = ['<#737373>More polish|in less time','37.3px',150,35,'37','50', 'center']
