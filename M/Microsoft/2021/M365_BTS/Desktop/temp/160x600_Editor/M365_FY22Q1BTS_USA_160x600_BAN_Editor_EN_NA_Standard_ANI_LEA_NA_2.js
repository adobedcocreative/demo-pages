...
lib.ssMetadata = [
		{name:"M365_FY22Q1BTS_USA_160x600_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[754,810,137,21],[754,745,112,63],[632,745,120,124],[0,0,734,508],[0,510,630,420],[632,510,189,126],[0,932,628,419],[632,638,157,105],[632,871,155,56],[630,932,136,320]]}
];
...
(lib.angledShadowSml = function() {
	this.initialize(ss["M365_FY22Q1BTS_USA_160x600_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(21.1187,21.8187,0.3867,0.3867);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00A4EF").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_1.setTransform(6.5121,21.8187,0.3867,0.3867);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7FBA00").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_2.setTransform(21.1187,7.2121,0.3867,0.3867);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F25022").s().p("AiqCrIAAlVIFVAAIAAFVg");
	this.shape_3.setTransform(6.5121,7.2121,0.3867,0.3867);
	...
	this.shape_5.setTransform(167.0491,14.6556,0.3867,0.3867);
	...
	this.shape_6.setTransform(154.8399,14.5106,0.3867,0.3867);
	...
	this.shape_7.setTransform(142.3793,14.5106,0.3867,0.3867);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(73).call(this.frame_73).wait(29).call(this.frame_102).wait(30).call(this.frame_132).wait(31).call(this.frame_163).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.editorCursorEnd).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.editorCursor).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.socialScreenEnd).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.wordScreen).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.socialScreen).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.angledShadow1},{t:this.angledShadow2}]}).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.laptop).wait(164));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-12.2,379.2,415.2);
...
// stage content:
(lib.M365_FY22Q1BTS_USA_160x600_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {	
				...
				this.tl1.from(mc.laptop,{duration:.8, scaleX:.5, scaleY:.5, y:"+=300", ease:Power2.easeOut}, "<");
				...
				//this.tl1.to(mc.laptop.wordScreen,{duration:.4, rotation:"+=10", ease:Power2.easeIn}, ">+2");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY22Q1BTS_USA_160x600_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1622814418632", id:"M365_FY22Q1BTS_USA_160x600_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
