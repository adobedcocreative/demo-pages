// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Stay on task|with work,|school—all of it','18.3px',80,188,'20','350', 'center']
	bannerData.headline1 = ['<#737373>Stay on|top of|your|schedule','32px',76,72,'34','50', 'center']
