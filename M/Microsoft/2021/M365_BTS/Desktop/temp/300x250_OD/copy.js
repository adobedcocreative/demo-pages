// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Automatically backup* with|up to 1 TB of cloud storage','17.8px',150,85,'20','350', 'center']
	bannerData.intro2 = ['<#505050>*User must enable backup feature. Files must be saved in|Desktop, Pictures, or Documents folders on Windows PCs only.','8px',150,142,'9','350', 'center']

	bannerData.headline1 = ['<#737373>OneDrive has|your back(up)','32px',150,36,'30','50', 'center']
