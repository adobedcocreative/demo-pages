...
(lib.angledShadow = function() {
	this.initialize(ss["M365_FY22Q1BTS_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.cta.name = "cta";
	this.cta.setTransform(80.2,569.8,1,1,0,0,0,-50.8,-0.2);
...
// stage content:
(lib.M365_FY22Q1BTS_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY22Q1BTS_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1.png?1622712427780", id:"M365_FY22Q1BTS_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
