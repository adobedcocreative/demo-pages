...
lib.ssMetadata = [
		{name:"M365_FY22Q1BTS_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[632,908,137,21],[754,724,112,63],[632,724,120,124],[0,0,734,508],[0,510,630,420],[632,510,157,105],[0,932,628,419],[632,617,157,105],[632,850,155,56],[630,932,136,320]]}
];
...
(lib.angledShadowSml = function() {
	this.initialize(ss["M365_FY22Q1BTS_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(-260.2,0,627.2,254);
...
// stage content:
(lib.M365_FY22Q1BTS_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {	
				...
				this.tl1.from(mc.laptop.editorCursor, {duration:.8, y:"+=50", ease:Sine.easeInOut}, "<");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY22Q1BTS_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1622808017785", id:"M365_FY22Q1BTS_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
