// JavaScript Document
	...
	bannerData.intro1 = ['<#505050>Cash in on smart |budgeting this semester ','18.5px',250,24,'20','100', 'center']

	bannerData.headline1 = ['<#737373>Be a budget wiz','28px',468,28,'36','350','center']

	bannerData.CTA = ['<#FFFFFF>Learn more','12.2px',-2,-1,'50','300', 'center']
