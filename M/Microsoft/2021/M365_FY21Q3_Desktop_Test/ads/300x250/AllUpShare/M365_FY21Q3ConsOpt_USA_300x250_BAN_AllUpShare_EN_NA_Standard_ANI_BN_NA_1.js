...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[436,0,424,292],[0,302,426,294],[856,294,140,124],[0,0,434,300],[428,302,426,294],[862,0,120,111]]}
];
...
(lib._1Mobile1Desktop2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.PowerPointPositive2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance = new lib.PowerPointPositive2x();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4326,scaleY:2.4326,x:-15.75,y:8.75},33,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.screen_powerpoint.setTransform(228.9,-58.4,0.5,0.5,0,0,0,201.8,141.2);
	...
	this.screen_excel.setTransform(321.8,-99,0.5,0.5,0,0,0,186,120.4);
	...
	this.screen_outlook.setTransform(378,15.8,0.5,0.5,0,0,0,180,127.6);
	...
	this.screen_word.setTransform(251.05,-140.1,0.5,0.5,0,0,0,200.1,119.8);
	...
	this.screen_onedrive.setTransform(198.2,2.1,0.5,0.5,0,0,0,170.4,132.2);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(113,-200,328.8,286), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-13.95,1.05,0.85,0.85,0,0,0,13.6,10.7);
	...
	this.cta_glare.setTransform(-61.5,-1.25,1,1,0,0,0,57.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_glare).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("ApvCTIAAklITfAAIAAElg");
	this.shape.setTransform(-60.05,0.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-122.4,-14.2,124.7,29.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screens.setTransform(253.2,213.8,1,1,0,0,0,284.2,24.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-18,-11,428.8,286), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(132,114,278.8,161);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611322214188", id:"M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
