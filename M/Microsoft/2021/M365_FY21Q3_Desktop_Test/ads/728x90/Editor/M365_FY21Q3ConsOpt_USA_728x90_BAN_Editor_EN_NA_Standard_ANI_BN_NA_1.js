...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[602,441,350,300],[602,743,220,140],[0,441,600,500],[824,856,72,74],[824,743,120,111],[0,0,726,439]]}
];
...
(lib.interfaceCreateAPostShadow = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// image
	this.instance = new lib.M365_Q3Optimization_Editor2f11();
...
}).prototype = getMCSymbolPrototype(lib.interfaceReference, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgBAUIgBgEIAAgWIgGAAIAAgFIAGAAIAAgLIAFAAIAAALIAGAAIAAAFIgGAAIAAAUIAAADIACABIADgBIAAAEIgFABQgDAAgBgCg");
	this.shape.setTransform(529.625,251.4);
	...
	this.shape_1.setTransform(526.625,251.875);
	...
	this.shape_2.setTransform(522.675,251.875);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgSAZIAAgxIAYAAQAFAAADADQAFAEAAAIQAAAGgFAEQgEACgFAAIgRAAIAAAWgAgMgBIAPAAQAKAAAAgIQAAgJgJAAIgQAAg");
	this.shape_3.setTransform(518.4,251.05);

	this.instance = new lib.interfaceClosebtn();
	this.instance.setTransform(537.55,18.1,0.6111,0.8919,0,0,0,0.1,0.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAAAYQAAAAgBgBQAAAAgBAAQAAgBAAAAQAAgBAAAAQgBgCAAgFIAAgUIgFAAIAAgFIAFAAIAAgJIAFgEIAAANIAGAAIAAAFIgGAAIAAAUIAAADIACACIACAAIACAAIABAFIgEABIgFgBg");
	this.shape_4.setTransform(301.2,22.175);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(298.425,22.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgMAOQgEgFAAgJQAAgJAFgFQAFgEAGAAQAIAAAEAFQAFAEAAAJQAAAGgDAFQgBAEgFACQgEACgEAAQgHAAgFgFgAgHgJQgDADAAAGQAAAHADAEQADADAEAAQAEAAADgDQAEgEAAgHQAAgGgEgDQgDgEgEAAQgEAAgDAEg");
	this.shape_6.setTransform(294.75,22.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgPAaIAAgyIAGAAIAAAFQACgDACgBQADgBACgBQAFABAEACQADACACAEQACAFAAAFQAAAGgCADQgCAEgEADQgEACgEAAQgCAAgCgBIgEgDIAAASgAgGgQQgDAEAAAGQAAAHADADQADADADABQAEgBADgDQADgEAAgGQAAgHgDgEQgDgDgEAAQgDAAgDAEg");
	this.shape_7.setTransform(290.925,23.45);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(284.975,22.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgLAOQgFgFAAgJQAAgIAFgFQAFgFAGAAQAIAAAEAFQAFAFAAAIIAAABIgaAAQAAAGADAEQADADAEAAQADAAACgCQADgCABgDIAHAAQgCAGgEADQgEADgGAAQgHAAgFgFgAgGgKQgDACAAAFIATAAQAAgEgCgCQgDgEgFAAQgDAAgDADg");
	this.shape_9.setTransform(279.125,22.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAAAYQgBAAAAgBQAAAAgBAAQAAgBAAAAQAAgBAAAAQgCgCAAgFIAAgUIgEAAIAAgFIAEAAIAAgJIAGgEIAAANIAGAAIAAAFIgGAAIAAAUIAAADIABACIADAAIACAAIABAFIgFABIgEgBg");
	this.shape_10.setTransform(276.25,22.175);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(273.275,22.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgLAOQgFgFAAgJQAAgIAFgFQAFgFAGAAQAIAAAEAFQAFAFAAAIIAAABIgaAAQAAAGADAEQADADAEAAQADAAACgCQADgCABgDIAHAAQgCAGgEADQgEADgGAAQgHAAgFgFgAgGgKQgDACAAAFIATAAQAAgEgCgCQgDgEgFAAQgDAAgDADg");
	this.shape_12.setTransform(269.375,22.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgJASIAAgjIAGAAIAAAGIADgGIAEgBQADAAADACIgDAGQAAAAgBgBQAAAAgBAAQAAAAgBAAQAAAAgBAAQAAAAgBAAQAAAAgBAAQAAAAgBAAQAAABAAAAIgCADIgBAHIAAASg");
	this.shape_13.setTransform(266.55,22.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgLAXQgFgEgDgGQgCgGAAgHQAAgIADgFQADgGAFgDQAGgDAFAAQAIAAAFAEQAFADACAIIgGABQgCgFgDgDQgEgDgFABQgFAAgDACQgEADgCAFQgBAFAAAEQAAAGABAEQACAFAEADQAEACAEAAQAFAAAEgDQAEgDABgGIAHABQgCAIgFAEQgGAFgIAAQgHAAgFgDg");
	this.shape_14.setTransform(262.625,22.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#0378B4").s().p("AQoTVQgVAAAAgXIAAiKQAAgYAVAAIE0AAQAVAAAAAYIAACKQAAAXgVAAgA3bw0IAAigMAu3AAAIAACgg");
	this.shape_15.setTransform(402,137.775);
	...
	this.shape_16.graphics.f().s("#707070").ss(1,1,1).p("A3gzgMAvBAAAMAAAAnBMgvBAAAg");
	this.shape_16.setTransform(402,138.825);

	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(1));

	// bg white vector
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("A3gDJIAAmRMAvBAAAIAAGRg");
	this.shape_17.setTransform(402,34.075);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.writingInterface).to({regX:150.7,regY:127,scaleX:0.3127,scaleY:0.2853,skewX:-32.0752,skewY:-17.0316,x:155.45,y:70.2},38,cjs.Ease.quartInOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-0.6,-39.7,509.40000000000003,400.7);
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1611753257253", id:"M365_FY21Q3ConsOpt_USA_728x90_BAN_Editor_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
