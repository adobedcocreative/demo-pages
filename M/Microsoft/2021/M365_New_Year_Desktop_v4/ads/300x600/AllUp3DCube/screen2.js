...
lib.ssMetadata = [
		{name:"screen2_atlas_1", frames: [[0,0,298,600]]}
];
...
(lib.OneDrive_300x600_Display0 = function() {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.OneDrive_300x600_Display0();
	this.instance.setTransform(0,0,1.8064,1.7067);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.static2, new cjs.Rectangle(0,0,538.3,1024), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-29,-31,599.5,1199.1), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen2_atlas_1.png?1606235930737", id:"screen2_atlas_1"}
	],
	preloads: []
};
