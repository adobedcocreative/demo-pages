...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_2_atlas_1", frames: [[436,0,424,292],[0,302,426,294],[856,294,140,124],[0,0,434,300],[428,302,426,294],[862,0,120,111]]}
];
...
(lib._1Mobile1Desktop2x = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Word_screen, new cjs.Rectangle(0,0,424,292), null);
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_screen, new cjs.Rectangle(0,0,426,294), null);
...
}).prototype = getMCSymbolPrototype(lib.Outlook_screen, new cjs.Rectangle(0,0,140,124), null);
...
}).prototype = getMCSymbolPrototype(lib.OneDrive_screen, new cjs.Rectangle(0,0,434,300), null);
...
}).prototype = getMCSymbolPrototype(lib.Excel_screen, new cjs.Rectangle(0,0,426,294), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.4326,scaleY:2.4326,x:-15.75,y:8.5},33,cjs.Ease.quadInOut).wait(1));
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_2_atlas_1.png?1628584020301", id:"M365_FY21Q3ConsOpt_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
