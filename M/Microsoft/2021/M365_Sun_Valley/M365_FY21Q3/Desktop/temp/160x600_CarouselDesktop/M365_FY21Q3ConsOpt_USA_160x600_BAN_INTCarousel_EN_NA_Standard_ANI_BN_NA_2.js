...
lib.ssMetadata = [
		{name:"M365_FY21Q3ConsOpt_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_2_atlas_1", frames: [[1310,577,137,243],[294,569,506,300],[802,580,506,300],[294,871,506,300],[844,0,292,578],[802,882,393,266],[802,1150,393,266],[0,0,541,321],[1197,882,216,432],[1138,0,290,575],[0,889,198,272],[0,323,292,564],[0,1173,393,266],[294,323,207,184],[543,0,299,567],[395,1173,393,266]]}
];
...
(lib.CoffeeCup11 = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Screen_2_Excel, new cjs.Rectangle(10,20,506,300), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.008)").s().p("AiJCKQgagbgOgfQgQgjgBgnIAAgKQAChOA3g3IAIgHIAGgFQAzgrBFgCIAJAAQAnABAjAQQAYAKAWASIAMAMIAHAHQAyA3AABLQAABRg5A5Qg5A5hRAAQhQAAg5g5g");
	this.shape.setTransform(13.725,14.175);
...
p.nominalBounds = new cjs.Rectangle(-5.7,-5.3,38.900000000000006,39);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(92,58.2,0.6299,0.63,-13.9972);

	this.instance_1 = new lib.ExcelMobileAppIcon2x1111();
	this.instance_1.setTransform(92,58.5,0.6301,0.63,-13.9989);

	this.instance_2 = new lib.WordMobileAppIcon2x111();
	this.instance_2.setTransform(92,59.15,0.6322,0.6321,-13.8215);

	this.instance_3 = new lib.PPTMobileAppIcon2x111();
	this.instance_3.setTransform(92,58.5,0.63,0.63,-13.9999);
...
p.nominalBounds = new cjs.Rectangle(92,14,269.2,397.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(120.55,-53.85,0.54,0.54);

	this.instance_1 = new lib.plant();
	this.instance_1.setTransform(122.5,-14,0.5,0.5);

	this.instance_2 = new lib.tray();
	this.instance_2.setTransform(135.55,-32.6,0.54,0.54);

	this.instance_3 = new lib.CoffeeCup11();
	this.instance_3.setTransform(144.15,-29.95,0.4561,0.4561);
...
p.nominalBounds = new cjs.Rectangle(32,-53.8,215.4,639.8);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,2,0,3).p("AgDg4Ig5A4IA5A5AA9g4Ig5A4IA5A5");
	...
	// white outline
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhyByQgvgvAAhDQAAhCAvgwQAwgvBCAAQBDAAAvAvQAwAwAABCQAABDgwAvQgvAwhDAAQhCAAgwgwg");
	this.shape_2.setTransform(14.775,14.775);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Btn_Return, new cjs.Rectangle(-1.4,-1.4,32.4,32.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// plus sign new
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(2,2,0,3).p("AAAAAIg/AAABAAAIhAAAIAABAAAAg/IAAA/");
	this.shape.setTransform(14.975,14.325);
...
}).prototype = getMCSymbolPrototype(lib.Btn_Expand, new cjs.Rectangle(-1.4,-1.4,32.4,32.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0078D4").ss(1,2,0,3).p("AHsgyIAzAyIgzAzAnrgyIgzAyIAzAz");
...
if (reversed == null) { reversed = false; }
	...
	this.Btn_return.setTransform(160.5,530.55,1.0068,1.0068,0,0,0,14.8,14.9);
	...
	this.obj2.name = "obj2";
	this.obj2.setTransform(220.1,382.35,1,1,0,0,0,316.6,243.1);
...
}).prototype = getMCSymbolPrototype(lib.Page, new cjs.Rectangle(-4.5,-38.8,264.9,587.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.indicator.setTransform(87.15,468.5,1.1623,1.1623,0,0,0,59.1,6);

	this.btn_expand = new lib.Btn_Expand();
	this.btn_expand.name = "btn_expand";
	this.btn_expand.setTransform(131.85,303.6,1,1,0,0,0,15,14.9);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egd9AvHMAAAheNMA78AAAMAAABeNg");
	mask.setTransform(174.35,266.125);

	// Onedrive
	this.screen_1_onedrive = new lib.Screen_1_OneDrive();
	this.screen_1_onedrive.name = "screen_1_onedrive";
	this.screen_1_onedrive.setTransform(84.55,302.05,0.57,0.57,0,0,0,185.2,135.2);

	this.screen_2_onedrive = new lib.Screen_2_OneDrive();
	this.screen_2_onedrive.name = "screen_2_onedrive";
	this.screen_2_onedrive.setTransform(202.2,255.9,0.57,0.57,0,0,0,291.6,177);
	...
	this.screen_1_excel.setTransform(88.2,298.8,0.57,0.57,0,0,0,191.6,129.5);

	this.screen_2_excel = new lib.Screen_2_Excel();
	this.screen_2_excel.name = "screen_2_excel";
	this.screen_2_excel.setTransform(202.1,255.75,0.57,0.57,0,0,0,291.4,176.8);
	...
	this.screen_1_word.setTransform(88.2,298.85,0.57,0.57,0,0,0,191.6,129.6);

	this.screen_2_word = new lib.Screen_2_Word();
	this.screen_2_word.name = "screen_2_word";
	this.screen_2_word.setTransform(202.1,255.75,0.57,0.57,0,0,0,291.4,176.8);
	...
	this.screen_1_ppt.setTransform(88.05,299,0.57,0.57,0,0,0,191.5,129.4);

	this.screen_2_ppt = new lib.Screen_2_PPT();
	this.screen_2_ppt.name = "screen_2_ppt";
	this.screen_2_ppt.setTransform(202.1,255.75,0.57,0.57,0,0,0,291.4,176.8);
...
}).prototype = getMCSymbolPrototype(lib.mountain_anim, new cjs.Rectangle(-17.5,166.4,347.6,308.20000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-3.65,-0.15,0.85,0.85,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D7").s().p("AolCeIAAk7IRLAAIAAE7g");
	this.shape.setTransform(-41.975,-0.75);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-97,-16.5,110.1,31.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.hit_shrink.setTransform(128.1,530.35,0.9961,0.9961,0,0,0,12.6,14);
	...
	this.txtCta.setTransform(45,570.95,0.9555,0.9555,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(86.55,570.75,0.9013,0.9013,0,0,0,0.1,0.2);
	...
	this.logo_1.setTransform(16.35,16.1,1.0595,1.0595,0,0,0,-52.2,-23.4);
	...
	this.Enlarged.setTransform(713.55,125,1,1,0,0,0,745,125);
	...
	this.no_hit.setTransform(79.45,487.65,0.6292,0.1096,0,0,0,150.1,125);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-36.1,-38.8,1001.5,642.4), null);


// stage content:
(lib.M365_FY21Q3ConsOpt_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function () {
			...
			mc.txtCta.alpha = 1
				...
				exportRoot.TL_MainIntro.from(screen_1_onedrive, 1.1, {x: "+=240",y: "+=360", ease:Power2.easeOut, ease:Power2.easeOut, onStart:function(){screen_1_onedrive.visible = true}});		
				exportRoot.TL_MainIntro.from(screen_2_onedrive, 1, {x: "+=240",y: "+=360", ease:Power3.easeOut, ease:Power2.easeOut, onStart:function(){screen_2_onedrive.visible = true}}, "-=0.85");		
...
p.nominalBounds = new cjs.Rectangle(43.9,261.2,921.5,342.40000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_2_atlas_1.png?1631613042784", id:"M365_FY21Q3ConsOpt_USA_160x600_BAN_INTCarousel_EN_NA_Standard_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
