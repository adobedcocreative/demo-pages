...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_2_atlas_1", frames: [[294,323,137,243],[294,569,506,300],[802,580,506,300],[294,871,506,300],[844,0,292,578],[802,882,393,266],[802,1150,393,266],[0,0,541,321],[1197,882,216,432],[1138,0,290,575],[0,889,198,272],[0,323,292,564],[0,1173,393,266],[1197,1316,202,126],[543,0,299,567],[395,1173,393,266]]}
];
...
(lib.CoffeeCup11 = function() {
	this.initialize(ss["M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(201,0,0.5,0.5);

	this.instance_2 = new lib.tray();
	this.instance_2.setTransform(200,0,0.5,0.5);

	this.instance_3 = new lib.CoffeeCup11();
	this.instance_3.setTransform(215.35,69.1,0.5,0.5,-89.9895);
...
p.nominalBounds = new cjs.Rectangle(160.7,-46.8,233.40000000000003,216);
...
if (reversed == null) { reversed = false; }
	...
	this.Btn_return.setTransform(275.9,219.5,1,1,0,0,0,14.8,14.8);
	...
	this.obj1.name = "obj1";
	this.obj1.setTransform(127.8,219.5,1,1,0,0,0,127.8,219.5);

	this.timeline.addTween(cjs.Tween.get(this.obj1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Page, new cjs.Rectangle(136,-46.8,194.60000000000002,351.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.btn_expand.setTransform(252.8,172.8,1,1,0,0,0,14.8,14.8);
...
if (reversed == null) { reversed = false; }
	...
	this.hit_shrink.setTransform(271.05,214.6,1.0595,1.0595,0,0,0,9.5,10);
	...
	this.txtCta.setTransform(38.5,221,0.9555,0.9555,0,0,0,0.8,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(81.2,221.25,0.9013,0.9013,0,0,0,0.1,0.2);
	...
	this.hit_expand.setTransform(248.1,167.55,1.0595,1.0595,0,0,0,9.5,10);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-9.1,-46.8,974.5,351.3), null);


// stage content:
(lib.M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(140.9,78.2,824.5,226.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_2_atlas_1.png?1631614349466", id:"M365_MobileFY21Q4Opt_USA_300x250_BAN_ConsRefreshCaro_EN_NA_Standard_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
