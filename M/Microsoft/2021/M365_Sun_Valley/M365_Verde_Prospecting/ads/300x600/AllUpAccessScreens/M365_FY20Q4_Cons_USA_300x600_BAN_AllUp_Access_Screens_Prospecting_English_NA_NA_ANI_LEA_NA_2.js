...
lib.ssMetadata = [
		{name:"M365_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1", frames: [[0,1066,124,156],[0,0,800,531],[0,533,800,531],[126,1066,120,111]]}
];
...
(lib.handpointercursor = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:7.9,y:-6.55},14,cjs.Ease.quadInOut).wait(35).to({alpha:0},10,cjs.Ease.quadInOut).wait(1));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CA4925").ss(1,1,1).p("AjCgcIExhkIBUChIkzBgQhWidAEAAg");
	this.shape.setTransform(1.2661,-13.55);
...
p.nominalBounds = new cjs.Rectangle(-19.2,-27.4,123.60000000000001,56.599999999999994);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05,y:832.75},12,cjs.Ease.quadInOut).wait(39).to({scaleX:2.2,scaleY:2.2,x:23.7,y:51.75},33,cjs.Ease.quadInOut).wait(1));
	...
	this.instance_2.setTransform(297.95,2254.65,1,5.7086,0,0,0,485.4,406.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(75).to({regY:406.9,scaleY:5.7085,y:2255.2,alpha:0},21,cjs.Ease.quadIn).wait(3));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-187.4,-67.6,970.9,1953.1999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_powerpoint.setTransform(281.35,186.35,0.1272,0.1272,0,0,0,321.1,153.7);
	...
	this.screen_onedrive.setTransform(254.8,190.5,1.1583,1.1583,0,0,0,215.2,142.8);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(5.6,25.1,498.4,330.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(234.95,555.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(279.7,555.85,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.bg = new lib.bg();
	this.bg.name = "bg";
	this.bg.setTransform(150,300.75,1,2.406,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-25.3,0,498.5,623.4), null);


// stage content:
(lib.M365_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(124.7,300,348.5,323.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1.png?1631631492461", id:"M365_FY20Q4_Cons_USA_300x600_BAN_AllUp_Access_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
