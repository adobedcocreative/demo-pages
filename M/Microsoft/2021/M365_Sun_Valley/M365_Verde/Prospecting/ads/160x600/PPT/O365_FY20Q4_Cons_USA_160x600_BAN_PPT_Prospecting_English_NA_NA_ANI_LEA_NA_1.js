...
lib.ssMetadata = [
		{name:"O365_FY20Q4_Cons_USA_160x600_BAN_PPT_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_", frames: [[612,709,138,108],[612,492,268,215],[752,709,138,108],[612,819,138,108],[752,819,138,108],[741,0,138,108],[0,492,610,374],[0,0,739,490],[741,220,120,111],[741,110,138,108]]}
];
...
(lib.Aimes = function() {
	this.initialize(ss["O365_FY20Q4_Cons_USA_160x600_BAN_PPT_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Word_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(100.95,112.7,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Word_1, new cjs.Rectangle(101,112.7,231,180.8), null);
...
(lib.Wordcopy2 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(211.05,236.7,0.95,0.95,0,0,0,134.1,107.5);
...
}).prototype = getMCSymbolPrototype(lib.Wordcopy2, new cjs.Rectangle(83.7,112.7,254.60000000000002,226.2), null);
...
(lib.Powerpoint_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(91.05,113.3,1.6738,1.6738);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.Outlook_shadow();
	this.instance_1.setTransform(204.45,231,0.95,0.95,0,0,0,134.1,107.5);
	this.instance_1.alpha = 0.1992;
...
}).prototype = getMCSymbolPrototype(lib.Powerpoint_1, new cjs.Rectangle(77.1,113.3,254.6,219.89999999999998), null);
...
(lib.icon_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-68.55,y:-461.3},149).wait(1).to({regX:204.3,regY:223.2,x:-87.65,y:-439.95},0).wait(1).to({x:-90.6,y:-445.1},0).wait(1).to({x:-93.55,y:-450.25},0).wait(1).to({x:-96.55,y:-455.45},0).wait(1).to({x:-99.55,y:-460.65},0).wait(1).to({x:-102.6,y:-465.95},0).wait(1).to({x:-105.65,y:-471.25},0).wait(1).to({x:-108.75,y:-476.65},0).wait(1).to({x:-111.9,y:-482.05},0).wait(1).to({x:-115.05,y:-487.55},0).wait(1).to({x:-118.25,y:-493.1},0).wait(1).to({x:-121.5,y:-498.75},0).wait(1).to({x:-124.75,y:-504.45},0).wait(1).to({x:-128.1,y:-510.2},0).wait(1).to({x:-131.45,y:-516.1},0).wait(1).to({x:-134.9,y:-522.05},0).wait(1).to({x:-138.4,y:-528.1},0).wait(1).to({x:-141.95,y:-534.25},0).wait(1).to({x:-145.55,y:-540.55},0).wait(1).to({x:-149.25,y:-546.95},0).wait(1).to({x:-153,y:-553.5},0).wait(1).to({x:-156.85,y:-560.2},0).wait(1).to({x:-160.8,y:-567.05},0).wait(1).to({x:-164.8,y:-574.05},0).wait(1).to({x:-168.95,y:-581.25},0).wait(1).to({x:-173.2,y:-588.65},0).wait(1).to({x:-177.6,y:-596.25},0).wait(1).to({x:-182.1,y:-604.1},0).wait(1).to({x:-186.75,y:-612.15},0).wait(1).to({x:-191.6,y:-620.55},0).wait(1).to({x:-196.55,y:-629.2},0).wait(1).to({x:-201.75,y:-638.2},0).wait(1).to({x:-207.1,y:-647.5},0).wait(1).to({x:-212.7,y:-657.2},0).wait(1).to({x:-218.5,y:-667.35},0).wait(1).to({x:-224.6,y:-677.9},0).wait(1).to({x:-230.95,y:-688.95},0).wait(1).to({x:-237.6,y:-700.5},0).wait(1).to({x:-244.6,y:-712.65},0).wait(1).to({x:-251.95,y:-725.4},0).wait(1).to({x:-259.65,y:-738.85},0).wait(1).to({x:-267.8,y:-753},0).wait(1).to({x:-276.4,y:-767.95},0).wait(1).to({x:-285.5,y:-783.75},0).wait(1).to({x:-295.1,y:-800.45},0).wait(1).to({x:-305.3,y:-818.1},0).wait(1).to({x:-316.05,y:-836.8},0).wait(1).to({x:-327.45,y:-856.6},0).wait(1).to({x:-339.5,y:-877.55},0).wait(1).to({regX:220.5,regY:196.8,x:-336.05,y:-926.1},0).to({_off:true},1).wait(1));

	// PowerPoint
	this.instance_4 = new lib.Wordcopy2();
	this.instance_4.setTransform(700.25,607.15,1,1,0,0,0,220.5,196.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:130.5,y:-340.3},149).wait(1).to({regX:210.9,regY:225.8,x:118,y:-316.4},0).wait(1).to({x:115.05,y:-321.5},0).wait(1).to({x:112.1,y:-326.7},0).wait(1).to({x:109.1,y:-331.9},0).wait(1).to({x:106.1,y:-337.15},0).wait(1).to({x:103.05,y:-342.4},0).wait(1).to({x:100,y:-347.75},0).wait(1).to({x:96.9,y:-353.15},0).wait(1).to({x:93.8,y:-358.6},0).wait(1).to({x:90.65,y:-364.1},0).wait(1).to({x:87.45,y:-369.7},0).wait(1).to({x:84.2,y:-375.3},0).wait(1).to({x:80.95,y:-381.05},0).wait(1).to({x:77.65,y:-386.85},0).wait(1).to({x:74.25,y:-392.7},0).wait(1).to({x:70.85,y:-398.7},0).wait(1).to({x:67.35,y:-404.75},0).wait(1).to({x:63.8,y:-410.95},0).wait(1).to({x:60.2,y:-417.25},0).wait(1).to({x:56.5,y:-423.65},0).wait(1).to({x:52.75,y:-430.25},0).wait(1).to({x:48.9,y:-436.95},0).wait(1).to({x:45,y:-443.8},0).wait(1).to({x:40.95,y:-450.85},0).wait(1).to({x:36.8,y:-458.05},0).wait(1).to({x:32.55,y:-465.45},0).wait(1).to({x:28.2,y:-473.1},0).wait(1).to({x:23.7,y:-480.95},0).wait(1).to({x:19.05,y:-489.05},0).wait(1).to({x:14.25,y:-497.45},0).wait(1).to({x:9.25,y:-506.15},0).wait(1).to({x:4.1,y:-515.15},0).wait(1).to({x:-1.25,y:-524.5},0).wait(1).to({x:-6.85,y:-534.25},0).wait(1).to({x:-12.65,y:-544.4},0).wait(1).to({x:-18.75,y:-555},0).wait(1).to({x:-25.1,y:-566.05},0).wait(1).to({x:-31.75,y:-577.65},0).wait(1).to({x:-38.7,y:-589.85},0).wait(1).to({x:-46.05,y:-602.65},0).wait(1).to({x:-53.75,y:-616.1},0).wait(1).to({x:-61.9,y:-630.3},0).wait(1).to({x:-70.5,y:-645.3},0).wait(1).to({x:-79.55,y:-661.1},0).wait(1).to({x:-89.15,y:-677.85},0).wait(1).to({x:-99.3,y:-695.55},0).wait(1).to({x:-110.05,y:-714.3},0).wait(1).to({x:-121.4,y:-734.15},0).wait(1).to({x:-133.45,y:-755.15},0).wait(1).to({regX:220.5,regY:196.8,x:-136.6,y:-806.4},0).to({_off:true},1).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-656.5,-1336.5,1474.5,2085.7);
...
// stage content:
(lib.O365_FY20Q4_Cons_USA_160x600_BAN_PPT_Prospecting_English_NA_NA_ANI_LEA_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_FY20Q4_Cons_USA_160x600_BAN_PPT_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_.png?1582374641324", id:"O365_FY20Q4_Cons_USA_160x600_BAN_PPT_Prospecting_English_NA_NA_ANI_LEA_NA_1_atlas_"}
	],
	preloads: []
};
