...
lib.ssMetadata = [
		{name:"M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1", frames: [[0,186,264,153],[302,0,265,154],[569,0,265,154],[302,156,265,154],[0,0,300,184],[569,156,264,153],[835,156,120,111]]}
];
...
(lib.Screen_Excel11 = function() {
	this.initialize(ss["M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Screen_shadcopy4, new cjs.Rectangle(0,0,300,184), null);
...
}).prototype = getMCSymbolPrototype(lib.Screen_shadcopy3, new cjs.Rectangle(0,0,300,184), null);
...
}).prototype = getMCSymbolPrototype(lib.Screen_shadcopy2, new cjs.Rectangle(0,0,300,184), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screen_onedrive.setTransform(228.05,-156.05,0.255,0.255,0,0,0,117.2,78.5);
...
// stage content:
(lib.M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1.png?1630676835074", id:"M365_FY20Q4_Cons_USA_728x90_BAN_AllUp_AI_Screens_Prospecting_English_NA_NA_ANI_LEA_NA_2_atlas_1"}
	],
	preloads: []
};
