...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_300x250_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,1200,738],[0,740,519,426]]}
];
...
(lib.exchangescreen = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_300x250_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.exchangescreen();
	this.instance.setTransform(30.3,48.45,0.5095,0.5095);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(30.3,48.5,611.4000000000001,376), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(40.75,219.45,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1.9,-0.5,445,262.9), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_300x250_BAN_Exchange_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		*/
				...
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "-=150",	ease:Power4.easeOut}, "-=0.55");
...
p.nominalBounds = new cjs.Rectangle(148.1,124.5,295,137.89999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_300x250_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1630682118122", id:"M365_FY20Q4_SMB_USA_300x250_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
