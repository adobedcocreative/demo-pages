...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_iconpngcopy4 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Teams_screen11111 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Teams_screen11111();
...
// stage content:
(lib.M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.tl1 = new gsap.timeline();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=200",y:"+=50", ease:Power4.easeInOut},"+=0.5");
				exportRoot.tl1.to(s, 1.6, {x: "-=100", ease:Power4.easeInOut}, "-=1.6");
				exportRoot.tl1.to(exportRoot.headline11, 1.6, {alpha: 0, ease:Power4.easeIn}, "-=1.4");	
				...
				exportRoot.tl1.from(exportRoot.headline12, 0.8, { x: "-=100", alpha: 0, ease:Power4.easeOut, stagger:0.1}, "-=0.5")
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1637600871170", id:"M365_FY20Q4_SMB_USA_300x250_BAN_OneDrive_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
