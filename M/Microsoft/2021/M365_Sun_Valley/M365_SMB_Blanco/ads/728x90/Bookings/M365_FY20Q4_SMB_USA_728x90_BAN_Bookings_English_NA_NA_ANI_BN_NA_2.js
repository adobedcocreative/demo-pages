...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_728x90_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,990,657],[0,659,393,295]]}
];
...
(lib.Bookings2 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_728x90_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Bookings2();
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(219.25,42.05,0.316,0.316,0,0,0,330.6,218.8);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-27.1,728.6,139), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_728x90_BAN_Bookings_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline12, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.25");
...
p.nominalBounds = new cjs.Rectangle(364,17.9,364.6,93.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_728x90_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631629907867", id:"M365_FY20Q4_SMB_USA_728x90_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
