...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,1200,738],[0,740,519,426]]}
];
...
(lib.exchangescreen11 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.exchangescreen11();
	this.instance.setTransform(29.4,48.5,0.5095,0.5095);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(29.4,48.5,611.4,376), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-145.5,-11,169.6,139.2), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-10.9,728.6,284.5), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=200",y:"+=100", ease:Power4.easeInOut});
...
p.nominalBounds = new cjs.Rectangle(364,34.1,364.6,73.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1630682341082", id:"M365_FY20Q4_SMB_USA_728x90_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
