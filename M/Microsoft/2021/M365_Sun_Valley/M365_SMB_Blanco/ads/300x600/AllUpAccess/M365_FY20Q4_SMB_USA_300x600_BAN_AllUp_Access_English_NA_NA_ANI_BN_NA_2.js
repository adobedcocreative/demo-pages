...
(lib.booking = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_300x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.bookings_screen.setTransform(458.3,18.35,0.44,0.44,0,0,0,116.5,80.5);
	...
	this.teams_screen.setTransform(472.15,-60.9,0.44,0.44,0,0,0,116.2,80.7);
	...
	this.exchange_screen.setTransform(383.85,-100.25,0.44,0.44,0,0,0,116.2,80.7);
	...
	this.screen_word.setTransform(281.45,-68.45,0.44,0.44,0,0,0,116.2,80.7);
	...
	this.screen_excel.setTransform(367.15,-28.55,0.44,0.44,0,0,0,112.6,80.8);
	...
	this.screen_powerpoint.setTransform(270,4.3,0.44,0.44,0,0,0,114.8,84.8);
	...
	this.screen_outlook.setTransform(353.8,43.65,0.44,0.44,0,0,0,120.9,70.5);
	...
	this.screen_onedrive.setTransform(285.25,-155.8,0.44,0.44,0,0,0,96.8,45.4);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(204.6,-195.1,348.6,282.6), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,0,354.6,600.9), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_300x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.tlicons = new TimelineLite();	
				...
				exportRoot.tlicons.from(mc.screens.screen_excel, 4, {scaleX: 1.5, scaleY:1.5, x: "+=350",  y: "+=250",	ease:Quart.easeOut}, "-=3.9");
				...
				exportRoot.tlicons.from(mc.screens.screen_powerpoint, 4, {scaleX: 1, scaleY:1, x: "+=350",  y: "+=400",	ease:Quart.easeOut}, "-=3.8");
				...
				exportRoot.tlicons.from(mc.screens.screen_word, 4, {scaleX: 1.52, scaleY:1.52, x: "+=300",  y: "-=400",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_word.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.exchange_screen, 4, {scaleX: 1.5, scaleY:1.5, x: "+=300",  y: "-=400",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.exchange_screen.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.teams_screen, 4, {scaleX: 1.2, scaleY:1.4, x: "+=300",  y: "-=400",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.teams_screen.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.bookings_screen, 4, {scaleX: 1.4, scaleY:1.4, x: "+=300",  y: "-=400",	ease:Quart.easeOut}, "-=3.8");
...
p.nominalBounds = new cjs.Rectangle(149,300,204.60000000000002,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_300x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631626419196", id:"M365_FY20Q4_SMB_USA_300x600_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
