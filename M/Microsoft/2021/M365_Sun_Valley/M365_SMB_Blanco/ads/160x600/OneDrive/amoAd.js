var amoAd = (function(){
  ...
  function init() {
    ...
    bannerData.headline6 = getValue();
    bannerData.headline7 = getValue();
    bannerData.headline8 = getValue(2);
    bannerData.headline9 = getValue(3);
    bannerData.headline10 = getValue(4);
    bannerData.headline11 = getValue(5);
    bannerData.headline12 = eval(bannerData.textField2);
