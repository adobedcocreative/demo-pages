...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,1200,738],[0,740,519,426]]}
];
...
(lib.exchangescreen1 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.exchangetilepngcopy = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.exchangescreen1();
	this.instance.setTransform(29.3,49.45,0.5095,0.5095);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Screen, new cjs.Rectangle(29.3,49.5,611.4000000000001,376), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_8
	this.instance = new lib.exchangetilepngcopy();
	this.instance.setTransform(-127.65,-94.65,0.7873,0.7873);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon_teams, new cjs.Rectangle(-127.6,-94.6,408.6,335.4), null);
...
(lib.bg_c = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.bg_c, new cjs.Rectangle(0,0,160,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.tile_sub.setTransform(-60.65,61.25,0.2599,0.2599,0,0,0,76.8,79.7);

	this.timeline.addTween(cjs.Tween.get(this.tile_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-113.8,16,106.3,87.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(33).to({regX:0.2,scaleX:3.2298,scaleY:3.2298,x:166.65,y:-920.35},41,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.bg.cache(-160,-600,320,1200,2)
	}
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(83.35,569.95,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(134.85,569.7,0.9433,0.9433,0,0,0,0.1,0.2);
	...
	this.screen.setTransform(132.95,318.5,0.4489,0.4489,0,0,0,329.8,219.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-4.2,-13.5,276.7,627.6), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				//				headline4
				exportRoot.tl1.from(exportRoot.headline4, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.01");
				
				exportRoot.tl1.to(exportRoot.headline4, 0.01, {alpha: 0, ease:Power4.easeIn}, "+=0.3");
		
						//				headline5
				exportRoot.tl1.from(exportRoot.headline5, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "-=0.01");
				...
				//				headline6
				exportRoot.tl1.from(exportRoot.headline6, 0.1, { x:"+=5", y:"-=2.5",scaleX:.85, scaleY:.85, alpha: 0, ease:Back.easeOut}, "+=0");
				...
				exportRoot.tl1.from(cont3D, 1.6, {rotY: "+=60",x:"+=120", ease:Power4.easeInOut},"+=0.5");
				exportRoot.tl1.to(s, 1.6, {x: "-=160", ease:Power4.easeInOut}, "-=1.6");
				exportRoot.tl1.to(exportRoot.headline6, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.3");
				...
				exportRoot.tl1.to(cont3D, 1, {x:80, y:"+=49", z:-400, ease:Power4.easeInOut}, "+=0.5");
		...
		*/
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline10[i], 0.8, { x: "+=300", alpha: 0, ease:Power4.easeOut}, "-=0.5");
		...
		*/
				...
				exportRoot.tl1.from(mc.txtCta, 0.7, { alpha: 0, x: "+=150",	ease:Power4.easeOut}, "-=0.4");
...
p.nominalBounds = new cjs.Rectangle(75.8,286.5,196.7,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1630682199365", id:"M365_FY20Q4_SMB_USA_160x600_BAN_Exchange_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
