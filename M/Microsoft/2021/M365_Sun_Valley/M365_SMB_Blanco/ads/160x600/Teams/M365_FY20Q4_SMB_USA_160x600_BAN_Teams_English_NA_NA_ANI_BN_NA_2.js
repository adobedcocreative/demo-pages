...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_160x600_BAN_Teams_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,440,393,295],[0,0,660,438]]}
];
...
(lib.teams_icon = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_160x600_BAN_Teams_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-101,-73.7,0.9982,0.9982);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon_teams, new cjs.Rectangle(-101,-73.7,392.3,294.5), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_mc, new cjs.Rectangle(-105.7,25.3,102,76.5), null);
...
// stage content:
(lib.M365_FY20Q4_SMB_USA_160x600_BAN_Teams_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		s.alpha=0
			...
			this.tl1 = new TimelineLite();
				...
				exportRoot.tl1.to(exportRoot.headline8, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.3");
				exportRoot.tl1.to(exportRoot.headline9, 1.6, {x: "+=150", ease:Power4.easeInOut}, "-=1.6");
				exportRoot.tl1.to(cont3D, 1, {x:80, y:"+=49", z:-400, ease:Power4.easeInOut}, "+=0.2");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_160x600_BAN_Teams_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631624337157", id:"M365_FY20Q4_SMB_USA_160x600_BAN_Teams_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
