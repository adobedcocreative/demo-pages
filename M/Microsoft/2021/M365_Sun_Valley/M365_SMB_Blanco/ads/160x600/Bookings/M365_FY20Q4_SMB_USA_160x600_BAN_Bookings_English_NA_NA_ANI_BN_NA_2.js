...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_160x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,659,393,295],[0,0,990,657]]}
];
...
(lib.teams_icon = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_160x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(132.45,318.05,0.451,0.451,0,0,0,329.3,219.6);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-17.3,-13.5,300,627.6), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_160x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(62.7,286.5,220,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_160x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631629702035", id:"M365_FY20Q4_SMB_USA_160x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
