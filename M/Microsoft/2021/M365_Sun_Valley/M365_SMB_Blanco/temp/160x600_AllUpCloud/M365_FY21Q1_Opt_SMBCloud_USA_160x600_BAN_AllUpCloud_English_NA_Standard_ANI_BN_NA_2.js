...
lib.ssMetadata = [
		{name:"M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_2_atlas_1", frames: [[0,0,400,266],[402,0,400,266],[0,268,400,266],[402,268,400,266],[0,536,400,266],[402,536,400,266],[267,1398,264,153],[302,1242,265,154],[584,1072,275,164],[0,1258,265,154],[584,1238,275,164],[0,1072,300,184],[533,1404,264,153],[0,804,400,266],[402,804,400,266],[804,0,120,111],[302,1072,280,168]]}
];
...
(lib.excel = function() {
	this.initialize(ss["M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.one_drive_blur();
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(131.85,78.5,1,1,0,0,0,140,84);
	this.blur.alpha = 0;
	...
	this.shad.name = "shad";
	this.shad.setTransform(266.75,177.05,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.word_screen, new cjs.Rectangle(-13.6,-5.5,285.70000000000005,177.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(132.55,68.7,1.007,1.007,0,0,0,167.8,111.5);
	this.blur.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.blur).wait(1));

	// Screen_Word.png
	this.instance = new lib.teams1111();
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(264.1,175.95,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Teams_screen, new cjs.Rectangle(-36.4,-43.6,337.9,224.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(269.7,159.9,1,1,0,0,0,274.5,163.5);
	this.blur.alpha = 0;
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(267.35,178.05,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Powerpoint_screen, new cjs.Rectangle(-13,-3.6,285.7,176.29999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(269.75,158.75,1,1,0,0,0,274.5,163.5);
	this.blur.alpha = 0;
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(264.5,176.65,1,1,0,0,0,300,184);

	this.shad_1 = new lib.Screen_shad();
	this.shad_1.name = "shad_1";
	this.shad_1.setTransform(268,172.05,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shad_1},{t:this.shad}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Outlook_screen, new cjs.Rectangle(-15.9,-8.6,289.2,179.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(243.55,119.95,1.007,1.007,0,0,0,274.4,163.3);
	this.blur.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.blur).wait(1));

	// Screen_OneDrive.png
	this.instance = new lib.one_drive();
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(269.65,177.3,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get(this.shad).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.OneDrive_screen, new cjs.Rectangle(-32.7,-44.5,337.9,224.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.blur.name = "blur";
	this.blur.setTransform(132.55,69.1,1.007,1.007,0,0,0,167.8,111.5);
	this.blur.alpha = 0;
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(263.45,174.35,1,1,0,0,0,300,184);

	this.shad_1 = new lib.Screen_shad();
	this.shad_1.name = "shad_1";
	this.shad_1.setTransform(269.3,166.55,1,1,0,0,0,300,184);

	this.shad_2 = new lib.Screen_shad();
	this.shad_2.name = "shad_2";
	this.shad_2.setTransform(275.8,170.1,1,1,0,0,0,300,184);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shad_2},{t:this.shad_1},{t:this.shad}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.exchange_screen, new cjs.Rectangle(-36.4,-43.2,337.9,224.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.Screen_Excel1();
	...
	this.shad = new lib.Screen_shad();
	this.shad.name = "shad";
	this.shad.setTransform(269.15,180.05,1,1,0,0,0,300,184);

	this.shad_1 = new lib.Screen_shad();
	this.shad_1.name = "shad_1";
	this.shad_1.setTransform(266.05,170.1,1,1,0,0,0,300,184);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("Ap2CfIAAk9ITtAAIAAE9g");
	this.shape.setTransform(-36.4,-0.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-99.5,-16.1,126.3,31.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Teams
	this.teams_screen = new lib.Teams_screen();
	this.teams_screen.name = "teams_screen";
	this.teams_screen.setTransform(341.8,-11.55,0.4079,0.4079,0,0,0,116.5,80.5);

	this.timeline.addTween(cjs.Tween.get(this.teams_screen).wait(1));

	// OneDrive
	this.screen_onedrive = new lib.OneDrive_screen();
	this.screen_onedrive.name = "screen_onedrive";
	this.screen_onedrive.setTransform(239.55,-215.25,0.4079,0.4079);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	// Exchange
	this.exchange_screen = new lib.exchange_screen();
	this.exchange_screen.name = "exchange_screen";
	this.exchange_screen.setTransform(326.45,-180.1,0.4079,0.4079);

	this.timeline.addTween(cjs.Tween.get(this.exchange_screen).wait(1));

	// Word
	this.screen_word = new lib.word_screen();
	this.screen_word.name = "screen_word";
	this.screen_word.setTransform(230.25,-150.45,0.4079,0.4079);
	...
	this.screen_excel.setTransform(311.1,-113.55,0.4079,0.408);
	...
	this.screen_powerpoint.setTransform(217.75,-85.4,0.4079,0.4079);
	...
	this.screen_outlook.setTransform(245.9,13.15,0.4079,0.4079,0,0,0,121,70.4);

	this.timeline.addTween(cjs.Tween.get(this.screen_outlook).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(190.1,-233.4,259.4,287.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.screens.setTransform(-199.55,405.45);
	...
	this.replay_btn.setTransform(144.1,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(102,570.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(153.5,570.5,0.9433,0.9433,0,0,0,0.1,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-9.4,-13.5,259.3,627.6), null);


// stage content:
(lib.M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "+=0.5");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
						
				for (var i = 0; i < exportRoot.headline1.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline1[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "+=1.2");
				if (i!=0) exportRoot.tl1.to(exportRoot.headline1[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "-=0.7");
				}
				
				//f2
								for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.4");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline2[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		
								for (var i = 0; i < exportRoot.headline2.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline2[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "+=1.7");
				if (i!=0) exportRoot.tl1.to(exportRoot.headline2[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "-=0.7");
				}
		
				//f3
								for (var i = 0; i < exportRoot.headline3.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline3[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.4");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline3[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		
								for (var i = 0; i < exportRoot.headline3.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline3[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "+=1.7");
				if (i!=0) exportRoot.tl1.to(exportRoot.headline3[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "-=0.7");
				}
		
				//f4
								for (var i = 0; i < exportRoot.headline4.length; i++) {
				if (i==0) exportRoot.tl1.from(exportRoot.headline4[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.4");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline4[i], 0.8, { x: "-=160", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		
								for (var i = 0; i < exportRoot.headline4.length; i++) {
				if (i==0) exportRoot.tl1.to(exportRoot.headline4[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "+=2");
				if (i!=0) exportRoot.tl1.to(exportRoot.headline4[i], 0.8, { x: "+=160", alpha: 0, ease:Power4.easeInOut}, "-=0.7");
				}
		...
		this.tlicons = new TimelineLite();	
				...
				exportRoot.tlicons.from(mc.screens, 2, {y: "-=50",	ease:Power4.easeOut}, "-=1.9");
				...
				exportRoot.tlicons.from(mc.screens.exchange_screen, 3, {x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=2.9");
				...
				exportRoot.tlicons.from(mc.screens.teams_screen, 3, {x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=2.8");
				
				//f2
				exportRoot.tlicons.to(mc.screens.teams_screen, 1.2, {scaleX: 0.79, scaleY:0.79, x: "-=46",  y: "-=70",	ease:Power4.easeInOut}, "+=0.2");
				...
				exportRoot.tlicons.to(mc.screens.exchange_screen.blur, 1.2, {alpha:0.6 ,	ease:Power4.easeInOut}, "-=1.2");
		
				exportRoot.tlicons.to(mc.screens.teams_screen, 1.2, {scaleX: 0.36, scaleY:0.36, x: "+=46",  y: "+=70",	ease:Power4.easeInOut}, "+=1.8");
				exportRoot.tlicons.to(mc.screens.teams_screen.blur, 1.2, {alpha:0.6 ,	ease:Power4.easeInOut}, "-=1.2");
		
				//f3
				exportRoot.tlicons.to(mc.screens.exchange_screen, 1.2, {scaleX: 0.79, scaleY:0.79, x: "-=123",  y: "+=35",	ease:Power4.easeInOut}, "-=1");
				exportRoot.tlicons.to(mc.screens.exchange_screen.blur, 1.2, {alpha:0 ,	ease:Power4.easeInOut}, "-=1.2");
		
				
				exportRoot.tlicons.to(mc.screens.exchange_screen, 1.2, {scaleX: 0.36, scaleY:0.36, x: "+=123",  y: "-=35",	ease:Power4.easeInOut}, "+=2");
				exportRoot.tlicons.to(mc.screens.exchange_screen.blur, 1.2, {alpha:0.6 ,	ease:Power4.easeInOut}, "-=1.2");
		
				//f4
				exportRoot.tlicons.to(mc.screens.screen_onedrive, 1.2, {scaleX: 0.79, scaleY:0.79, x: "-=40",  y: "+=71",	ease:Power4.easeInOut}, "-=1");
				exportRoot.tlicons.to(mc.screens.screen_onedrive.blur, 1.2, {alpha:0 ,	ease:Power4.easeInOut}, "-=1.2");
				
				exportRoot.tlicons.to(mc.screens.screen_onedrive, 1.2, {scaleX: 0.36, scaleY:0.36, x: "+=40",  y: "-=71",	ease:Power4.easeInOut}, "+=2");
				...
				exportRoot.tlicons.to(mc.screens.teams_screen.blur, 1.2, {alpha:0 ,	ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(70.6,286.5,179.3,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_2_atlas_1.png?1631620826106", id:"M365_FY21Q1_Opt_SMBCloud_USA_160x600_BAN_AllUpCloud_English_NA_Standard_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
