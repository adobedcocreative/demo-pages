...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_300x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,990,657],[0,659,393,295]]}
];
...
(lib.Bookings2 = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_300x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(274.65,320.5,0.963,0.963,0,0,0,329.9,219.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-43,0,635.5,600.9), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_300x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(107,300,485.5,300.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_300x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631180390936", id:"M365_FY20Q4_SMB_USA_300x600_BAN_Bookings_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
