...
lib.ssMetadata = [
		{name:"M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1", frames: [[0,0,400,266],[402,0,400,266],[0,268,400,266],[402,268,400,266],[0,536,400,266],[402,536,400,266],[0,804,400,266],[0,1258,264,153],[302,1238,265,154],[302,1072,275,164],[569,1238,265,154],[579,1072,275,164],[0,1072,300,184],[266,1394,264,153],[402,804,400,266],[804,0,120,111]]}
];
...
(lib.booking = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.booking_blur = function() {
	this.initialize(ss["M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.screen_booking_blur = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.booking_blur();

	this.instance_1 = new lib.excel_blur();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.screen_booking_blur, new cjs.Rectangle(0,0,400,266), null);
...
}).prototype = getMCSymbolPrototype(lib.Excel_screen, new cjs.Rectangle(-33.9,-43.1,337.29999999999995,223.1), null);


(lib.bookings_screen = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.blur = new lib.screen_booking_blur();
	this.blur.name = "blur";
	this.blur.setTransform(198,94,0.839,0.839,0,0,0,274.4,163.5);
	this.blur.alpha = 0.6016;
...
}).prototype = getMCSymbolPrototype(lib.bookings_screen, new cjs.Rectangle(-35.2,-43.1,338.59999999999997,223.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Bookings
	this.bookings_screen = new lib.bookings_screen();
	this.bookings_screen.name = "bookings_screen";
	this.bookings_screen.setTransform(456.05,-329.6,0.2,0.2,0,0,0,116.5,80.5);

	this.timeline.addTween(cjs.Tween.get(this.bookings_screen).wait(1));

	// Teams
	this.teams_screen = new lib.Teams_screen();
	this.teams_screen.name = "teams_screen";
	this.teams_screen.setTransform(463.75,-360.55,0.2,0.2,0,0,0,117,80);
	...
	this.exchange_screen.setTransform(423.3,-379.25,0.2,0.2,0,0,0,116.5,80.5);
	...
	this.screen_word.setTransform(378.35,-364.85,0.2,0.2,0,0,0,116.2,80.5);
	...
	this.screen_excel.setTransform(418.05,-347.05,0.2,0.2,0,0,0,112.8,80.8);
	...
	this.screen_powerpoint.setTransform(372.65,-332.75,0.2,0.2,0,0,0,114.8,84.5);
	...
	this.screen_outlook.setTransform(410.15,-314.95,0.2,0.2,0,0,0,130.8,77.2);
	...
	this.screen_onedrive.setTransform(391.05,-397.1,0.2,0.2,0,0,0,146.8,76.8);

	this.timeline.addTween(cjs.Tween.get(this.screen_onedrive).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.laptop_anim, new cjs.Rectangle(342.9,-421.2,157.5,124.89999999999998), null);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,-15.8,728.3,124.89999999999999), null);


// stage content:
(lib.M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.tlicons = new TimelineLite();	
				...
				mc.screens.screen_outlook.blur.alpha = 0;
				mc.screens.screen_onedrive.blur.alpha = 0;
				mc.screens.screen_excel.blur.alpha = 0;
				mc.screens.screen_powerpoint.blur.alpha = 0;
				mc.screens.bookings_screen.blur.alpha = 0;
				
				exportRoot.tlicons.to(mc.screens, 0.1, {alpha:1}, "=0");
				exportRoot.tlicons.from(mc.screens, 3, {scaleX: 1.5, scaleY:1.5, y: "-=50",	ease:Power4.easeOut}, "-=4");
				
				exportRoot.tlicons.from(mc.screens.screen_outlook, 4, {x: "+=100",  y: "+=120",	ease:Quart.easeOut}, "-=0");
				...
				exportRoot.tlicons.from(mc.screens.screen_onedrive, 4, {scaleX: 0.6, scaleY:0.6, x: "-=200", y: "+=380",	ease:Quart.easeOut}, "-=3.9");
				...
				exportRoot.tlicons.from(mc.screens.screen_excel, 4, {scaleX: .5, scaleY:.5, x: "+=675",  y: "+=400",	ease:Quart.easeOut}, "-=3.9");
				exportRoot.tlicons.from(mc.screens.screen_excel.shad, 4, {alpha:40, x: "+=60",  y: "+=120",	ease:Quart.easeOut}, "-=4");
				//exportRoot.tlicons.from(mc.screens.screen_excel.blur, 4, {alpha:40, x: "+=60",  y: "+=120",	ease:Quart.easeOut}, "-=4");
				//exportRoot.tlicons.to(mc.screens.screen_excel.blur, 4, { alpha:0,	ease:Quart.easeInOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.screen_powerpoint, 4, { x: "+=798",  y: "+=60",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_powerpoint.shad, 4, {alpha:40, x: "+=70",  y: "+=140",	ease:Quart.easeOut}, "-=4");
				//exportRoot.tlicons.to(mc.screens.screen_powerpoint.blur, 4, { alpha:0,	ease:Quart.easeInOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.screen_word, 4, {scaleX: 1.5, scaleY:1.5, x: "+500",  y: "+=300",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.screen_word.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
		
				exportRoot.tlicons.from(mc.screens.bookings_screen, 4, {scaleX: 1.5, scaleY:1.5, x: "+500",  y: "+=300",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.bookings_screen.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				//exportRoot.tlicons.to(mc.screens.bookings_screen.blur, 4, {alpha:0,	ease:Quart.easeInOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.exchange_screen, 4, {scaleX: .6, scaleY: .6, x: "+=400",  y: "+=120",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.exchange_screen.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
				exportRoot.tlicons.from(mc.screens.teams_screen, 4, {scaleX: 1.3, scaleY:1.3, x: "+400",  y: "+=300",	ease:Quart.easeOut}, "-=3.8");
				exportRoot.tlicons.from(mc.screens.teams_screen.shad, 4, {alpha:20, x: "+=150",  y: "+=300",	ease:Quart.easeOut}, "-=4");
...
p.nominalBounds = new cjs.Rectangle(364,29.2,364.29999999999995,79.89999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1.png?1631626612483", id:"M365_FY20Q4_SMB_USA_728x90_BAN_AllUp_Access_English_NA_NA_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
