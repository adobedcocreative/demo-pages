...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(159.9999,239.9998,1.0667,1.92);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht_sub, new cjs.Rectangle(0,0,320,480), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.bg_sub.cache(0,0,320,480,1)
	}
	...
	this.bg_sub.setTransform(140,10,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.bg_sub).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg_wht, new cjs.Rectangle(-10,-115,320,480), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-26.25,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0078D4").s().p("AnnCtIAAlZIPPAAIAAFZg");
	this.shape.setTransform(-57.85,1.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-106.6,-15.9,97.6,34.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).to({x:222.05},12,cjs.Ease.quadInOut).wait(39).to({regY:0.3,scaleX:2.4387,scaleY:2.4387,x:5.25,y:-311.25},33,cjs.Ease.quadInOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-220.4,-437.7,1039.9,1559.9);
...
if (reversed == null) { reversed = false; }
	...
	this.logo_intro.setTransform(68,135,0.3087,0.3087,0,0,0,0.1,0);
	...
	this.replay_btn.setTransform(304.3,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(15.95,425.7,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(119.4,423.35,1.136,1.136,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-2,-0.1,322.9,481.40000000000003), null);


// stage content:
(lib.M365_MobileFY21Q4ConsRefresh_USA_320x480_BAN_AllUp_EN_NA_Standard_ANI_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(158,239.9,161.89999999999998,241.29999999999998);
// library properties:
lib.properties = {
