...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,414,254]]}
];
...
(lib.ExcelDesktopMobile = function() {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(101.55,45.95,1.38,1.3799,0,0,0,0.4,0.7);
	...
	// img
	this.instance_1 = new lib.ExcelDesktopMobile();
	this.instance_1.setTransform(186,138,0.95,0.95);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-29.7,-29,609,478.1), null);
...
p.nominalBounds = new cjs.Rectangle(250.9,219.6,328.4,232.50000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1614249900456", id:"screen4_atlas_1"}
	],
	preloads: []
};
