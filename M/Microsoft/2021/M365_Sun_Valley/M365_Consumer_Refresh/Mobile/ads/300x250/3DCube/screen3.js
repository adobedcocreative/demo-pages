...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,568,424],[570,0,159,324]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,368,212);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-29.7,-29,646.7,478.1), null);
...
p.nominalBounds = new cjs.Rectangle(250.9,219.6,366.1,232.50000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1631888686908", id:"screen3_atlas_1"}
	],
	preloads: []
};
