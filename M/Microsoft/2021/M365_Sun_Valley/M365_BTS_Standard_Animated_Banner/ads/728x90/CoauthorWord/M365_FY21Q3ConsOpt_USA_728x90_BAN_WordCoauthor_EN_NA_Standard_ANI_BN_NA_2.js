...
(lib.basicUI111111 = function() {
	this.initialize(ss["M365_FY21Q3ConsOpt_USA_728x90_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.basicUI111111();
	this.instance.setTransform(0,0,0.5,0.5);
...
// stage content:
(lib.M365_FY21Q3ConsOpt_USA_728x90_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = gsap.timeline();
				...
				exportRoot.tl1.to(screen, 1.5, {x: "-=108",y: "+=12",scaleX: 0.748,scaleY: 0.748, ease:Power3.easeInOut}, "+=0.1");
...
p.nominalBounds = new cjs.Rectangle(364,1,366.9,108.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q3ConsOpt_USA_728x90_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_2_atlas_1.png?1628512569801", id:"M365_FY21Q3ConsOpt_USA_728x90_BAN_WordCoauthor_EN_NA_Standard_ANI_BN_NA_2_atlas_1"}
	],
	preloads: []
};
