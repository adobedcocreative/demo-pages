...
lib.ssMetadata = [
		{name:"M365_FY21Q1_BTS_USA_300x600_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1", frames: [[0,373,119,120],[502,0,500,333],[243,373,31,32],[0,0,500,371],[121,373,120,111],[502,335,500,333]]}
];
...
(lib.avatar = function() {
	this.initialize(ss["M365_FY21Q1_BTS_USA_300x600_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#439AC7").ss(1.3,2,1).p("Ah2AJIDtAAAh2gIIDtAA");
	this.shape.setTransform(11.9,0.875);
...
if (reversed == null) { reversed = false; }
	...
	this.words.setTransform(143.95,-107.75,1.3196,1.3196,0,0,0,15.7,17.7);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.5,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
...
if (reversed == null) { reversed = false; }
	...
	this.screen.setTransform(179.55,285.55,0.7524,0.6023,0,-28.3396,-17.04,107.8,-133.6);
	...
	this.shadow.name = "shadow";
	this.shadow.setTransform(179.8,286.5,0.7524,0.7524,0,0,0,124,79.6);
	...
	this.txtCta.setTransform(232.55,552.6,1,1,0,0,0,0.7,0.1);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-135.3,0,661.5,705.1), null);


// stage content:
(lib.M365_FY21Q1_BTS_USA_300x600_BAN_Editor_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			this.tl1 = new TimelineLite();
				...
				if (i==0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "+=0.2");
				if (i!=0) exportRoot.tl1.from(exportRoot.headline1[i], 0.8, { x: "-=150", alpha: 0, ease:Power4.easeOut}, "-=0.7");
				}
		
						
				exportRoot.tl1.from(screen, 1.4, {  x: "+=350",y: "+=350",	ease:Power4.easeOut}, "-=0.9");
				exportRoot.tl1.from(shadow, 1.4, {  x: "+=350",y: "+=350",	ease:Power4.easeOut}, "-=1.4");
				...
				exportRoot.tl1.to(screen, 1.2, {x: "-=25",y: "+=6",scaleX: "0.634",scaleY: "0.507", ease:Power4.easeInOut}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, {x: "-=25",y: "+=6",scaleX: "0.634",scaleY: "0.634", ease:Power4.easeInOut}, "-=1.2");
				exportRoot.tl1.to(screen.blur, 1.4, {alpha :1,ease:Power4.easeInOut}, "-=1.4");
		
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "1.9",scaleY: "1.9", x: "-=9",y: "-=25",ease:Power4.easeInOut,onComplete:function(){screen.popup.gotoAndPlay(0);}}, "-=1");
				exportRoot.tl1.to(screen.popup.popup_shdw, 1.4, {x: "-=10",y: "+=10",alpha :0.5,ease:Power4.easeInOut}, "-=1.4");
				
				exportRoot.tl1.to(pencil, 1.4, {rotation: -15,scaleX: "1.07",scaleY: "1.07", x: "-=40",y: "+=80",ease:Power4.easeInOut}, "-=1.4");
				...
				exportRoot.tl1.to(pencil, 0.8, {y: "+=80",x: "-=20",ease:Power4.easeInOut}, "+=0.0");
		
				exportRoot.tl1.to(screen.words, 1.8, {y: "-=107",ease:Power4.easeInOut}, "-=0.8");		
				...
				exportRoot.tl1.to(screen.popup, 1.4, {scaleX: "0.98",scaleY: "0.98", x: "+=9",y: "+=25",ease:Power4.easeInOut}, "-=0.4");
				...
				exportRoot.tl1.to(pencil, 1.4, {rotation: 0,scaleX: "0.21",scaleY: "0.21", x: "+=60",y: "-=160",ease:Power4.easeInOut}, "-=1.4");
		
				exportRoot.tl1.to(screen, 1.2, {x: "+=5",y: "+=10",scaleX: "0.735",scaleY: "0.588", ease:Power4.easeInOut,onStart:function(){ribbon.gotoAndPlay(0);}}, "-=1");
				exportRoot.tl1.to(shadow, 1.2, {x: "+=5",y: "+=10",scaleX: "0.735",scaleY: "0.735", ease:Power4.easeInOut}, "-=1.2");
...
p.nominalBounds = new cjs.Rectangle(14.7,300,511.50000000000006,405.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q1_BTS_USA_300x600_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1.png?1593017240020", id:"M365_FY21Q1_BTS_USA_300x600_BAN_Editor_English_NA_NA_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
