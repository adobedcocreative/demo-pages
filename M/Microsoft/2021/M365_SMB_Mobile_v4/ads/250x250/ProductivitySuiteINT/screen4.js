...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,319,321]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// VidStatic
	this.instance_1 = new lib.MaskGroup16();
	this.instance_1.setTransform(-1,-6,1.6105,1.6142);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-6,513.8,518.2), null);
...
p.nominalBounds = new cjs.Rectangle(255,250,257.79999999999995,262.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606992466694", id:"screen4_atlas_1"}
	],
	preloads: []
};
