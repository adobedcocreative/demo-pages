...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,711,500]]}
];
...
(lib.ImageFull = function() {
	this.initialize(ss["M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.ImageFull();
	this.instance.setTransform(-55.3,207.7,0.5566,0.5566);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Bg, new cjs.Rectangle(-55.3,207.7,395.7,278.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-40.4,2.8,0.66,0.6055,0,0,0,13.5,10.6);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4B53BC").s().p("Ao9DSIAAmjIR7AAIAAGjg");
	this.shape.setTransform(-75.975,1.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-133.3,-19.5,114.70000000000002,42), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(32.15,32.25,0.7424,0.7424,0,0,0,0.1,0.4);
	...
	this.replay_btn.setTransform(303.2,4,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(17.2,428.5,1.2856,1.2856,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(132.75,426,1,1,0,0,0,0.2,0.3);
	...
	this.Bg = new lib.Bg();
	this.Bg.name = "Bg";
	this.Bg.setTransform(150,126.6,1,1,0,0,0,150,125);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F2F2F2").s().p("A5vTiMAAAgnDMAzfAAAMAAAAnDg");
	this.shape.setTransform(164.8,125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.Bg}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-55.3,0,395.7,487.6), null);


// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
				...
				this.tlMain.from(exportRoot.headline1,{
					duration:0.8, 
					y: "+=60", 
					alpha: 0, 
					stagger: 0.1, 
					onStart:function(){tlCube.restart();}
				}, "+=.2");
				
				this.tlMain.from([mc.cta, mc.txtCta], { duration: 0.6, x: "-=150"}, "+=6.5");
...
p.nominalBounds = new cjs.Rectangle(104.7,240,235.7,247.60000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606744437972", id:"M365_MobileFY21Q3SMBRefresh_USA_320x480_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
