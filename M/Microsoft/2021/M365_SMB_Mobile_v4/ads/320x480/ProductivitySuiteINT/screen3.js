...
lib.ssMetadata = [
		{name:"screen3_atlas_1", frames: [[0,0,427,579]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(94.05,40.2,1.28,1.1991,0,0,0,0.3,0.4);
	...
	// VidStatic
	this.instance_1 = new lib._320x480_Frame_3();
	this.instance_1.setTransform(-1,-2,1.2048,1.134);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-1,-2,514.5,656.6), null);
...
p.nominalBounds = new cjs.Rectangle(255,349.9,258.5,358.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_1.png?1606931426897", id:"screen3_atlas_1"}
	],
	preloads: []
};
