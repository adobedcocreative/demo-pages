...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1", frames: [[0,0,599,263]]}
];
...
(lib.TeamsCollaborationStoryboard2x = function() {
	this.initialize(ss["M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(240.45,214.45,1.2856,1.2856,0,0,0,0.8,0.2);
	...
	this.cta.name = "cta";
	this.cta.setTransform(318.6,211.95,1,1,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300,251.6), null);


// stage content:
(lib.M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1.png?1606736255272", id:"M365_MobileFY21Q3SMBRefresh_USA_300x250_BAN_CollabTeams_EN_NA_Standard_ANI_TRY_NA_1_atlas_1"}
	],
	preloads: []
};
