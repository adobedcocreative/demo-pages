...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("ApuC5IAAlxITdAAIAAFxg");
	this.shape.setTransform(-71.025,2.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-133.3,-16.4,124.60000000000001,36.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(196.7,427.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(331.45,424.5,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY22Q2Holiday_USA_320x480_BAN_CrossDevice_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,160.3,207.39999999999998);
// library properties:
lib.properties = {
