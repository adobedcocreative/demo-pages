...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-29.15,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("ApwC8IAAl3IThAAIAAF3g");
	this.shape.setTransform(-73.475,2.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-136,-16.5,125.1,37.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(303.15,4.05,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(197.2,427.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(334.3,424.65,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,321.6,480), null);


// stage content:
(lib.M365_MobileFY22Q2Holiday_USA_320x480_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,160.60000000000002,208.2);
// library properties:
lib.properties = {
