...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(176.3,218.65,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(310.95,215.75,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,301.1,250), null);


// stage content:
(lib.M365_MobileFY22Q2Holiday_USA_300x250_BAN_AllUpShare_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,150.10000000000002,114);
// library properties:
lib.properties = {
