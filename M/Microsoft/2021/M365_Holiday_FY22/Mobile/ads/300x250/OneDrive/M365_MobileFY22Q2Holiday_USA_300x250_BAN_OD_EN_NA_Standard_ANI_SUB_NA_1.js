...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(175.5,218.3,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(315.3,215.3,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,300.4,250), null);


// stage content:
(lib.M365_MobileFY22Q2Holiday_USA_300x250_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,149.5,113.9);
// library properties:
lib.properties = {
