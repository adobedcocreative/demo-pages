...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(144,213.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(265.05,210.75,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_MobileFY22Q2Holiday_USA_250x250_BAN_CrossDevice_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(125,125,124.69999999999999,108.9);
// library properties:
lib.properties = {
