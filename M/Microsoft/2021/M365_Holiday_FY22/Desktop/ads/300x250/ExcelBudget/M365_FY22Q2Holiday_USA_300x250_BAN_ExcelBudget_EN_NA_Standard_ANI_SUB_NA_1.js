...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(196.2,220.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(316.95,217.6,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0.5,0.6,301.6,250), null);


// stage content:
(lib.M365_FY22Q2Holiday_USA_300x250_BAN_ExcelBudget_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,125,151.10000000000002,108.69999999999999);
// library properties:
lib.properties = {
