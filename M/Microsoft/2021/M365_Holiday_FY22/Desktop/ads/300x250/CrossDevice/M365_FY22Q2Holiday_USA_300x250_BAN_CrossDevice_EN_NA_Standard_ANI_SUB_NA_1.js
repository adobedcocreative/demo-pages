...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,302.1,250), null);


// stage content:
(lib.M365_FY22Q2Holiday_USA_300x250_BAN_CrossDevice_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
