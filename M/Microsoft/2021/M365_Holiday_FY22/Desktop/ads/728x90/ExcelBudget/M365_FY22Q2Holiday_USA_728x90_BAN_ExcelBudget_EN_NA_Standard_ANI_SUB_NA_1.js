...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("AoMB6IAAjyIQZAAIAADyg");
	this.shape.setTransform(-63.603,2.3,0.9977,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-115.9,-9.8,104.60000000000001,24.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(623.15,60.5,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(743.3,57.5,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,730.2,90), null);


// stage content:
(lib.M365_FY22Q2Holiday_USA_728x90_BAN_ExcelBudget_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,363.9,28.599999999999994);
// library properties:
lib.properties = {
