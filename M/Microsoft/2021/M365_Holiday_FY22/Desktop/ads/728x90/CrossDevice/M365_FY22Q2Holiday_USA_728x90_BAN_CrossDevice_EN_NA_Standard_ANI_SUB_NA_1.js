...
if (reversed == null) { reversed = false; }
	...
	this.arrow.name = "arrow";
	this.arrow.setTransform(-24.5,2.6,0.6158,0.5649,0,0,0,13.6,10.7);
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("AoYB6IAAjyIQxAAIAADyg");
...
}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-114.2,-9.8,107.4,24.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(621.3,61.3,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(739.35,57.4,1.136,1.136,0,0,0,0.2,0.2);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,731.3,240.3), null);


// stage content:
(lib.M365_FY22Q2Holiday_USA_728x90_BAN_CrossDevice_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(364,45,365,28.5);
// library properties:
lib.properties = {
