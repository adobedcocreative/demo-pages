...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("ApZCJIAAkRISzAAIAAERg");
	this.shape.setTransform(-68.425,2.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-128.6,-11.4,120.39999999999999,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.replay_btn.setTransform(145,3.95,0.3475,0.3475,0,0,180,-0.3,0);
	...
	this.txtCta.setTransform(52.2,571.45,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(169.2,568.4,1.0152,1.0152,0,0,0,0.2,0.4);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,160.6,600), null);


// stage content:
(lib.M365_FY22Q2Holiday_USA_160x600_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,80.1,284.1);
// library properties:
lib.properties = {
