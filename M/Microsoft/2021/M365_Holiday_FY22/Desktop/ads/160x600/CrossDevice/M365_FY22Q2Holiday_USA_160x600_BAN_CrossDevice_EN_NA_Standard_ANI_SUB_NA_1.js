...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("AoZB9IAAj5IQzAAIAAD5g");
	this.shape.setTransform(-62.675,2.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-116.5,-10,107.7,25), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(51.55,570.75,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(171.6,567.6,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY22Q2Holiday_USA_160x600_BAN_CrossDevice_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(80,300,80.80000000000001,284.20000000000005);
// library properties:
lib.properties = {
