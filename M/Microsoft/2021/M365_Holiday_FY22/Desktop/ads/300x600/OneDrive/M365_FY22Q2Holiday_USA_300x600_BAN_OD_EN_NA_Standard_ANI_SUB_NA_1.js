...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#058475").s().p("AorCJIAAkRIRXAAIAAERg");
	this.shape.setTransform(-66.15,2.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-121.8,-11.4,111.3,27.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(175.9,552,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(313.7,547.75,1.2498,1.2498,0,0,0,0.2,0.3);
...
// stage content:
(lib.M365_FY22Q2Holiday_USA_300x600_BAN_OD_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,149.39999999999998,267.29999999999995);
// library properties:
lib.properties = {
