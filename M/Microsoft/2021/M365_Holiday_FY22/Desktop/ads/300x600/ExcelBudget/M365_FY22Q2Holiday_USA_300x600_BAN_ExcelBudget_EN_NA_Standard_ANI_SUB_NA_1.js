...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-70.007,2.3031,1.1321,1.284);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-131.3,-13.3,122.70000000000002,31.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(175.9,551.6,1,1,0,0,0,0.7,0.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(311.4,548.6,1.136,1.136,0,0,0,0.2,0.2);
...
// stage content:
(lib.M365_FY22Q2Holiday_USA_300x600_BAN_ExcelBudget_EN_NA_Standard_ANI_SUB_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(150,300,150.39999999999998,268.5);
// library properties:
lib.properties = {
