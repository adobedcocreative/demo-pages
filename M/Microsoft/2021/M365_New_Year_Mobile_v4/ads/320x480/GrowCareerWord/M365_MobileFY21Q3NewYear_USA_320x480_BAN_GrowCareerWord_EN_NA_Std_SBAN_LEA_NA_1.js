...
lib.ssMetadata = [
		{name:"M365_MobileFY21Q3NewYear_USA_320x480_BAN_GrowCareerWord_EN_NA_Std_SBAN_LEA_NA_1_atlas_1", frames: [[0,0,640,960]]}
];
...
(lib.WordMobileStatic320x480pngcopy = function() {
	this.initialize(ss["M365_MobileFY21Q3NewYear_USA_320x480_BAN_GrowCareerWord_EN_NA_Std_SBAN_LEA_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.arrow.setTransform(10.75,11.75);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AoAC5IAAlyIQBAAIAAFyg");
	this.shape.setTransform(-57.775,2.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA_btn, new cjs.Rectangle(-109.1,-16.2,102.69999999999999,37.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txtCta.setTransform(253,428.55,1,1,0,0,0,0.7,0.1);

	this.cta = new lib.CTA_btn();
	this.cta.name = "cta";
	this.cta.setTransform(331.35,424.45,1.136,1.136,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cta},{t:this.txtCta}]}).wait(1));

	// Image
	this.instance_1 = new lib.WordMobileStatic320x480pngcopy();
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(0,0,323.8,480), null);


// stage content:
(lib.M365_MobileFY21Q3NewYear_USA_320x480_BAN_GrowCareerWord_EN_NA_Std_SBAN_LEA_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(160,240,163.7,239.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_MobileFY21Q3NewYear_USA_320x480_BAN_GrowCareerWord_EN_NA_Std_SBAN_LEA_NA_1_atlas_1.png?1606145436406", id:"M365_MobileFY21Q3NewYear_USA_320x480_BAN_GrowCareerWord_EN_NA_Std_SBAN_LEA_NA_1_atlas_1"}
	],
	preloads: []
};
