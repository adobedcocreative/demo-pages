...
lib.ssMetadata = [
		{name:"screen4_atlas_1", frames: [[0,0,640,960]]}
];
...
(lib.Powerpoint_320x480_Display0 = function() {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.Powerpoint_320x480_Display0();
...
if (reversed == null) { reversed = false; }
	...
	this.static4.setTransform(182.25,282.3,1.6,1.3584,0,0,0,113.9,207.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen4_atlas_1.png?1606236934007", id:"screen4_atlas_1"}
	],
	preloads: []
};
