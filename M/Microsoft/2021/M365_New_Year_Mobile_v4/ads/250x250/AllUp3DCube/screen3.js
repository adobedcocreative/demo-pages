...
lib.ssMetadata = [
		{name:"screen3_atlas_", frames: [[0,0,500,500]]}
];
...
(lib.Word_250x250_Display0 = function() {
...
(lib.static2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Word_250x250_Display0();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/screen3_atlas_.png?1606171395659", id:"screen3_atlas_"}
	],
	preloads: []
};
