...
lib.ssMetadata = [
		{name:"M365_FY21Q2WorkRemote2_USA_300x250_BAN_YPDog_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,800,613],[3208,0,594,455],[1604,0,800,533],[2206,535,600,400],[0,615,600,400],[602,615,600,400],[2808,914,600,400],[802,0,800,613],[3208,457,589,455],[2406,0,800,533],[3410,914,600,400],[1604,535,600,410]]}
];
...
(lib.bg = function() {
	this.initialize(ss["M365_FY21Q2WorkRemote2_USA_300x250_BAN_YPDog_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-27,2.1,0.4649,0.4649);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-54,0.3,0.4764,0.4764);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-57,-1.5,0.4139,0.4139);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-37.1,0.35,0.4147,0.4147);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(15,19.35,0.6313,0.6313);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-23.1,19.25,0.6414,0.6414);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2WorkRemote2_USA_300x250_BAN_YPDog_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602240217494", id:"M365_FY21Q2WorkRemote2_USA_300x250_BAN_YPDog_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
