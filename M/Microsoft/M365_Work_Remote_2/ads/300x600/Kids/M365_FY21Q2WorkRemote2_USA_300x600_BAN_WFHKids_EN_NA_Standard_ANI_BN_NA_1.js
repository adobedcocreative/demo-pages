...
lib.ssMetadata = [
		{name:"M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHKids_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[3248,0,624,600],[664,602,586,600],[664,0,644,600],[0,0,662,638],[1252,602,586,600],[1310,0,644,600],[3070,602,617,507],[1840,602,586,600],[1956,0,644,600],[2428,602,640,532],[0,640,624,499],[2602,0,644,600]]}
];
...
(lib.BG = function() {
	this.initialize(ss["M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHKids_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.img2_bg, new cjs.Rectangle(0,0,624,499), null);
...
}).prototype = getMCSymbolPrototype(lib.f1_blur_fg1, new cjs.Rectangle(0,0,640,532), null);
...
}).prototype = getMCSymbolPrototype(lib.f1_blur_bg, new cjs.Rectangle(0,0,662,638), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f2_blur_fg.setTransform(22.2,249.65,1,1,0,0,0,172.3,129.6);
...
}).prototype = getMCSymbolPrototype(lib.f2FG, new cjs.Rectangle(-150.1,0,624,619.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f1_blur_fg.setTransform(161.45,117.75,1,1,0,0,0,170.2,129.1);
...
}).prototype = getMCSymbolPrototype(lib.f1FG, new cjs.Rectangle(-8.7,-11.3,640,532), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f1_blur_bg.setTransform(151.4,111.15,1,1,0,0,0,170.2,129.1);
...
}).prototype = getMCSymbolPrototype(lib.f1BG, new cjs.Rectangle(-18.8,-17.9,662,638), null);
...
if (reversed == null) { reversed = false; }
	...
	this.FG1.name = "FG1";
	this.FG1.setTransform(-68.65,218.4,1,1,0,0,0,220.5,125);
	...
	this.BG1.name = "BG1";
	this.BG1.setTransform(-71.05,147,1,1,0,0,0,220.5,147);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-310.3,-17.9,793.3,638), null);


// stage content:
(lib.M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHKids_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-159.3,282.1,640.8,337.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHKids_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602238795226", id:"M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHKids_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
