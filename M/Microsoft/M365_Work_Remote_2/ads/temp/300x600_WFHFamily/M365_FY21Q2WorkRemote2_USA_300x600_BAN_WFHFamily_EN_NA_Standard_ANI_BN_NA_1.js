...
lib.ssMetadata = [
		{name:"M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHFamily_EN_NA_Standard_ANI_BN_NA_1_atlas_1", frames: [[0,0,764,600],[1806,602,455,600],[3064,0,600,600],[766,0,764,600],[2263,602,455,600],[0,602,600,600],[1532,0,764,600],[2720,602,455,600],[602,602,600,600],[2298,0,764,600],[3177,602,455,600],[1204,602,600,600]]}
];
...
(lib.bg = function() {
	this.initialize(ss["M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHFamily_EN_NA_Standard_ANI_BN_NA_1_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.f3_blur_fg.setTransform(90.7,138.3,1,1,0,0,0,207.7,138.3);
...
}).prototype = getMCSymbolPrototype(lib.FG3, new cjs.Rectangle(-117,0,600,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f2_blur_fg.setTransform(57.3,129.6,1,1,0,0,0,172.3,129.6);
...
}).prototype = getMCSymbolPrototype(lib.f2FG, new cjs.Rectangle(-115,0,455,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f2_blur_bg.setTransform(57.3,129.6,1,1,0,0,0,172.3,129.6);
...
}).prototype = getMCSymbolPrototype(lib.f2bg, new cjs.Rectangle(-115,0,455,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f1_blur_fg.setTransform(-79.8,129.1,1,1,0,0,0,170.2,129.1);
...
}).prototype = getMCSymbolPrototype(lib.f1FG, new cjs.Rectangle(-250,0,764,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f1_blur_bg.setTransform(-79.8,129.1,1,1,0,0,0,170.2,129.1);
...
}).prototype = getMCSymbolPrototype(lib.f1BG, new cjs.Rectangle(-250,0,764,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.f3_blur_bg.setTransform(90.7,138.3,1,1,0,0,0,207.7,138.3);
...
}).prototype = getMCSymbolPrototype(lib.BG3, new cjs.Rectangle(-117,0,600,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.FG3.name = "FG3";
	this.FG3.setTransform(54.1,362.1,1,1,0,0,0,54.1,362.1);
	this.FG3.alpha = 0;
	...
	this.BG3.name = "BG3";
	this.BG3.setTransform(54.1,362.1,1,1,0,0,0,54.1,362.1);
	this.BG3.alpha = 0;
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-250,-2.6,764,606.1), null);


// stage content:
(lib.M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHFamily_EN_NA_Standard_ANI_BN_NA_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		/////////////
				...
				this.tl1.to(mc.BG3, 1.5, {scale: 0.555,x:"+=19",y:"+=14", ease:Power2.easeInOut}, "+=1");
				this.tl1.to(mc.FG3, 1.5, {scale: 0.555,x:"+=27",y:"+=14", ease:Power2.easeInOut}, "-=1.5");
...
p.nominalBounds = new cjs.Rectangle(-99.2,297.3,611.6,305.99999999999994);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHFamily_EN_NA_Standard_ANI_BN_NA_1_atlas_1.png?1602236881230", id:"M365_FY21Q2WorkRemote2_USA_300x600_BAN_WFHFamily_EN_NA_Standard_ANI_BN_NA_1_atlas_1"}
	],
	preloads: []
};
