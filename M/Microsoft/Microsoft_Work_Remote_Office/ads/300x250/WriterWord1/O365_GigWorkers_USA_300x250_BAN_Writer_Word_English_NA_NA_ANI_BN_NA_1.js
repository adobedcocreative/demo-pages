...
lib.ssMetadata = [
		{name:"O365_GigWorkers_USA_300x250_BAN_Writer_Word_English_NA_NA_ANI_BN_NA_1_atlas_", frames: [[0,699,200,264],[202,699,249,117],[0,0,350,250],[0,252,271,250],[0,504,312,193]]}
];
...
(lib.bush_300x600 = function() {
	this.initialize(ss["O365_GigWorkers_USA_300x250_BAN_Writer_Word_English_NA_NA_ANI_BN_NA_1_atlas_"]);
	this.gotoAndStop(0);
...
(lib.white = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EhL2AapMAAAg1RMCXtAAAMAAAA1Rg");
	this.shape.setTransform(485.475,170.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.white, new cjs.Rectangle(0,0,971,341), null);
...
(lib.bushes = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFD","rgba(254,255,250,0)"],[0,1],3.3,64.4,3.3,86.2).s().p("Egu5ANVIAA6pMBdzAAAIAAapg");
	this.shape.setTransform(298.525,-58.625);
	...
	this.instance.parent = this;
	this.instance.setTransform(399,0);

	this.instance_1 = new lib.bush_300x600();
	this.instance_1.parent = this;
	this.instance_1.setTransform(199,0);
...
(lib.scene3 = function(mode,startPosition,loop) {
	...
	this.bg.name = "bg";
	this.bg.parent = this;
	this.bg.setTransform(89.7,165.8,0.6,0.5999,0,0,0,199.5,132);
	this.bg.filters = [new cjs.ColorFilter(0.68, 0.68, 0.68, 1, 81.6, 81.6, 81.6, 0)];
	this.bg.cache(-4,-146,605,412);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = getMCSymbolPrototype(lib.scene3, new cjs.Rectangle(-31,0.3,360.4,250.7), null);
...
(lib.logos = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(298,338.5,0.3351,0.3351,0,0,0,-39.7,1.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regX:-40,regY:1.4,scaleX:5.5415,scaleY:5.5415,x:298.05,y:337.75},13,cjs.Ease.quadOut).to({x:78.15},12,cjs.Ease.quadInOut).to({_off:true},1).wait(48));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_14 = new cjs.Graphics().p("AmofFIAAysMBGZAAAIAASsg");
	var mask_graphics_15 = new cjs.Graphics().p("Am4fFIAAysMBGZAAAIAASsg");
	var mask_graphics_16 = new cjs.Graphics().p("AnmfFIAAysMBGZAAAIAASsg");
	var mask_graphics_17 = new cjs.Graphics().p("AozfFIAAysMBGZAAAIAASsg");
	var mask_graphics_18 = new cjs.Graphics().p("AqefFIAAysMBGZAAAIAASsg");
	var mask_graphics_19 = new cjs.Graphics().p("AspfFIAAysMBGZAAAIAASsg");
	var mask_graphics_20 = new cjs.Graphics().p("AvSfFIAAysMBGZAAAIAASsg");
	var mask_graphics_21 = new cjs.Graphics().p("Ax7fFIAAysMBGZAAAIAASsg");
	var mask_graphics_22 = new cjs.Graphics().p("A0GfFIAAysMBGZAAAIAASsg");
	var mask_graphics_23 = new cjs.Graphics().p("A1xfFIAAysMBGZAAAIAASsg");
	var mask_graphics_24 = new cjs.Graphics().p("A2+fFIAAysMBGZAAAIAASsg");
	var mask_graphics_25 = new cjs.Graphics().p("A3sfFIAAysMBGZAAAIAASsg");
	var mask_graphics_26 = new cjs.Graphics().p("A38fFIAAysMBGZAAAIAASsg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:408.0654,y:198.9084}).wait(1).to({graphics:mask_graphics_15,x:406.5275,y:198.9084}).wait(1).to({graphics:mask_graphics_16,x:401.914,y:198.9084}).wait(1).to({graphics:mask_graphics_17,x:394.2247,y:198.9084}).wait(1).to({graphics:mask_graphics_18,x:383.4598,y:198.9084}).wait(1).to({graphics:mask_graphics_19,x:369.6192,y:198.9084}).wait(1).to({graphics:mask_graphics_20,x:352.7029,y:198.9084}).wait(1).to({graphics:mask_graphics_21,x:335.7866,y:198.9084}).wait(1).to({graphics:mask_graphics_22,x:321.9459,y:198.9084}).wait(1).to({graphics:mask_graphics_23,x:311.181,y:198.9084}).wait(1).to({graphics:mask_graphics_24,x:303.4918,y:198.9084}).wait(1).to({graphics:mask_graphics_25,x:298.8782,y:198.9084}).wait(1).to({graphics:mask_graphics_26,x:297.3404,y:198.9084}).wait(1).to({graphics:null,x:0,y:0}).wait(48));

	// Layer 3
	this.instance_1 = new lib.MSFT_Logocopy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(78.9,331.1,5.5415,5.5415,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.instance_2 = new lib.MSFT_Logo_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(300.35,331.1,5.5415,5.5415,0,0,0,0.1,0.2);
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_51 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_52 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_53 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_54 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_55 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_56 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_57 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_58 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_59 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_60 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_61 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_62 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_63 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_64 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_65 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_66 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_67 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_68 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_69 = new cjs.Graphics().p("EhL2A/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_70 = new cjs.Graphics().p("EhMxA/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_71 = new cjs.Graphics().p("EhTfA/lMAAAh/JMCXtAAAMAAAB/Jg");
	var mask_1_graphics_72 = new cjs.Graphics().p("EhaiA/lMAAAh/JMCXsAAAMAAAB/Jg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:298.0324,y:339.3251}).wait(51).to({graphics:mask_1_graphics_51,x:298.0324,y:339.3251}).wait(1).to({graphics:mask_1_graphics_52,x:295.8292,y:339.3251}).wait(1).to({graphics:mask_1_graphics_53,x:289.2197,y:339.3251}).wait(1).to({graphics:mask_1_graphics_54,x:278.2038,y:339.3251}).wait(1).to({graphics:mask_1_graphics_55,x:262.7816,y:339.3251}).wait(1).to({graphics:mask_1_graphics_56,x:242.953,y:339.3251}).wait(1).to({graphics:mask_1_graphics_57,x:218.7181,y:339.3251}).wait(1).to({graphics:mask_1_graphics_58,x:190.0769,y:339.3251}).wait(1).to({graphics:mask_1_graphics_59,x:157.0292,y:339.3251}).wait(1).to({graphics:mask_1_graphics_60,x:119.5753,y:339.3251}).wait(1).to({graphics:mask_1_graphics_61,x:77.7149,y:339.3251}).wait(1).to({graphics:mask_1_graphics_62,x:31.4483,y:339.3251}).wait(1).to({graphics:mask_1_graphics_63,x:-19.2247,y:339.3251}).wait(1).to({graphics:mask_1_graphics_64,x:-74.3041,y:339.3251}).wait(1).to({graphics:mask_1_graphics_65,x:-133.7898,y:339.3251}).wait(1).to({graphics:mask_1_graphics_66,x:-197.6819,y:339.3251}).wait(1).to({graphics:mask_1_graphics_67,x:-265.9803,y:339.3251}).wait(1).to({graphics:mask_1_graphics_68,x:-338.6851,y:339.3251}).wait(1).to({graphics:mask_1_graphics_69,x:-415.7962,y:339.3251}).wait(1).to({graphics:mask_1_graphics_70,x:-491.398,y:339.3251}).wait(1).to({graphics:mask_1_graphics_71,x:-534.3599,y:339.3251}).wait(1).to({graphics:mask_1_graphics_72,x:-579.525,y:339.3251}).wait(3));

	// Layer 3
	this.instance_3 = new lib.MSFT_Logo_anim();
	this.instance_3.parent = this;
	this.instance_3.setTransform(300.35,331.1,5.5415,5.5415,0,0,0,0.1,0.2);
...
p.nominalBounds = new cjs.Rectangle(-1159,-67.6,1942.5,814);
...
p.nominalBounds = new cjs.Rectangle(-49,0,378.5,485.7);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.txtCta.setTransform(231.8,221.7,0.9,0.9,0,0,0,0.8,0.1);
	...
	this.cta.setTransform(278.8,223.15,0.8489,0.8489,0,0,0,0.2,0.3);
...
}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-49,-1.4,378.5,601.4), null);


// stage content:
(lib.O365_GigWorkers_USA_300x250_BAN_Writer_Word_English_NA_NA_ANI_BN_NA_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(101,123.6,228.5,476.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365_GigWorkers_USA_300x250_BAN_Writer_Word_English_NA_NA_ANI_BN_NA_1_atlas_.png?1566379946568", id:"O365_GigWorkers_USA_300x250_BAN_Writer_Word_English_NA_NA_ANI_BN_NA_1_atlas_"}
	],
	preloads: []
};
