  ...
  xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
          ...
          JSONData.feed.entry.map(function(data){
            ...
            feedTemplate1.push({
              "Ad Size": data['gsx$adsize']['$t'],
              "Frame_1_LogoImage": data['gsx$frame1logoimage']['$t'],
              "Frame_2_BgImage": data['gsx$frame2bgimage']['$t'],
              "Country": data['gsx$country']['$t'],
              "Smart Names": data['gsx$smartnames']['$t'],
              "Frame_2_LogoImage": data['gsx$frame2logoimage']['$t'],
              "Frame_3_BgImage": data['gsx$frame3bgimage']['$t'],
              "Frame_3_LogoImage": data['gsx$frame3logoimage']['$t'],
              "Frame_2_Text": data['gsx$frame2text']['$t'],
              "Frame_3_Text": data['gsx$frame3text']['$t'],
              "Frame_4_Text": data['gsx$frame4text']['$t'],
