var loadAdditionalContent = function(overlayDuration){
  ...
  var overlayHeadline = adContent[0].overlayDescription.split('|')[2].split('^')[0];
  var overlaySubHeadline = adContent[0].overlayDescription.split('|')[2].split('^')[1];
  var overlayCTAColor = adContent[0].overlayDescription.split('|')[2].split('^').length >= 4 ? adContent[0].overlayDescription.split('|')[2].split('^')[2] : '#000';
  ...
  '<div id="overlayHeadline" class="text-left SegoeUIRegular" style="position:absolute;top:46px;left:15px;width:270px;height:36px;font-size:23px;font-weight:bold;-webkit-transform:translateX(0%);transform:translateX(0%);-webkit-transition:transform 0.5s ease-out 0s;transition:transform 0.5s ease-out 0s;"><span>' + overlayHeadline + '</span></div>'+
  '<div id="overlaySubHeadline" class="text-top-left SegoeUISemilight" style="position:absolute;top:89px;left:15px;width:270px;height:40px;font-size:12px;font-weight:bold;line-height:1.2;-webkit-transform:translateX(0%);transform:translateX(0%);-webkit-transition:transform 0.5s ease-out 0.25s;transition:transform 0.5s ease-out 0.25s;"><span>' + overlaySubHeadline + '</span></div>'+
