var loadAdditionalContent = function(overlayDuration){
  ...
  var overlayHeadline = adContent[0].overlayDescription.split('|')[1].split('^')[0];
  var overlaySubHeadline = adContent[0].overlayDescription.split('|')[1].split('^')[1];
  var overlayCTAColor = adContent[0].overlayDescription.split('|')[1].split('^').length >= 4 ? adContent[0].overlayDescription.split('|')[1].split('^')[2] : '#000';
